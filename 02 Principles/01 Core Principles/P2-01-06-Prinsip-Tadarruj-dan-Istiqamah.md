...
flowchart TD
    subgraph TransformasiTadarrujIstiqamah["TRANSFORMASI METODOLOGI PEMBIASAAN ADAB"]
        PolaInstanLama["TUNTUTAN INSTAN & SANKSI KERAS (LAMA)<br/>• Target raksasa mendadak; membebani psikologis.<br/>• Memicu sindrom kejenuhan akut (Futuwr).<br/>• Ketaatan temporer yang cepat lenyap."]
        
        PolaTadarrujTUMBUH["SUNNAH TADARRUJ & ISTIQAMAH (TUMBUH)<br/>• Pentahapan syariat & Kaizen Micro-Habits.<br/>• Pembiasaan 66 hari otomatisasi sirkuit otak.<br/>• Istiqamah berkelanjutan: Adwamuha wa In Qalla."]
...
```mermaid
flowchart TD
    subgraph ArsitekturTadarrujIstiqamahTUMBUH["ARSITEKTUR TADARRUJ & ISTIQAMAH TUMBUH"]
        
        TI1_Sayap["1. PENTAHAPAN DOSIS ADAB (Gradual Scaffolding)<br/>Penyesuaian target ibadah & belajar sesuai tangga kematangan santri."]
        
        TI2_Sayap["2. HABITUASI SIRKUIT 66-HARI (Neural Pathways)<br/>Penguncian rutinitas mikro harian menjadi watak adab otomatis (Malakah)."]
        
        TI3_Sayap["3. MANAJEMEN ANTI-FUTUWR (Resilience & Renewal)<br/>Penjagaan ritme energi jiwa, relaksasi sehat, & penguatan motivasi ruhiyah."]
        
        TI1_Sayap <===> TI2_Sayap <===> TI3_Sayap
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolAntiFutuwr["PROTOKOL PENANGANAN FASE FUTUWR"]
        DeteksiDini["1. DETEKSI DINI: Memantau Santri yang Menunjukkan Penurunan Motivasi, Murung, / Nilai Turun"]
        --> DialogEmpati["2. DIALOG EMPATI: Musyrif Mengajak Ngobrol Santai dari Hati ke Hati Tanpa Menghakimi"]
        --> JedaRelaksasi["3. JEDA RELAKSASI: Memberikan Waktu Istirahat Berkualitas, Olahraga, & Asupan Gizi Sehat"]
        --> ResetMikro["4. RESET TARGET MIKRO: Menata Ulang Target Belajar Menjadi Langkah Kecil yang Membahagiakan"]
    end
```
...
Penerapan konsep **P2-01-06: PRINSIP TADARRUJ DAN ISTIQAMAH (GRADUALISM & ENDURING CONTINUITY)** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
