...
```mermaid
graph TD
    WV["01 PHILOSOPHY<br/>Ru'yatul Islam lil-Wujud & Hakikat Fitrah"] 
...
```mermaid
graph TD
    Master["P2-01: CORE PRINCIPLES INDUK (Konstitusi 7 Pilar Nilai TUMBUH)"]
    
    Master --> P1["P2-01-01: Prinsip Triad Pertumbuhan Simbiotik (Santri, Musyrif, Lembaga)"]
    Master --> P2["P2-01-02: Prinsip Kemuliaan Fitrah & Martabat Insan (QS. 17:70 & Zero Humiliation)"]
    Master --> P3["P2-01-03: Prinsip Keteladanan Qudwah-First (Lisanul Hal & Mirror Neurons)"]
    Master --> P4["P2-01-04: Prinsip Disiplin Restoratif Firm & Kind (Ketegasan Syar'i & Kasih Sayang)"]
    Master --> P5["P2-01-05: Prinsip Sistemik Multi-Tier PBIS Berbasis Data (Piramida 80-15-5 & 4W 1H)"]
    Master --> P6["P2-01-06: Prinsip Tadarruj & Istiqamah (Gradualisme Ilahiah & Habit 66-Hari)"]
    Master --> P7["P2-01-07: Sintesis Core Principles & Piagam Konstitusi Nilai TUMBUH"]
```
...
```mermaid
graph LR
    subgraph PenjalaranSubDomain["PENJALARAN 6 CORE PRINCIPLES KE 6 SUB-DOMAIN"]
        CP["01 CORE PRINCIPLES (Induk Konstitusi)"]
        
        CP --> DP["02 DESIGN PRINCIPLES (P2-02)"]
        CP --> LP["03 LEARNING PRINCIPLES (P2-03)"]
        CP --> DevP["04 DEVELOPMENT PRINCIPLES (P2-04)"]
        CP --> AP["05 ASSESSMENT PRINCIPLES (P2-05)"]
        CP --> IP["06 INTERVENTION PRINCIPLES (P2-06)"]
        CP --> ImpP["07 IMPLEMENTATION PRINCIPLES (P2-07)"]
    end
```
