...
```mermaid
flowchart TD
    subgraph PosisiPrinciplesTUMBUH["POSISI DOMAIN 02 PRINCIPLES DALAM EKOSISTEM"]
        D1["01 PHILOSOPHY<br/>Ru'yatul Islam lil-Wujud & Hakikat Fitrah"] 
        ==> D2["02 PRINCIPLES<br/>Konstitusi Nilai & Hukum Baku Pembinaan"]
        
        D2 ==> D3["03 CAPACITY FRAMEWORK (10 Kapasitas Insan & Matriks J1-J4)"]
        D2 ==> D4["04 PROGRESSION FRAMEWORK (Tangga Kemandirian Santri)"]
        D2 ==> D5["05 ASSESSMENT FRAMEWORK (Asesmen Autentik & Rubrik BARS)"]
        D2 ==> D6["06-11 PRAKSIS FRAMEWORKS (Intervensi PBIS, Konseling, Asrama, & Digital)"]
    end
```
...
```mermaid
flowchart TD
    subgraph MasterArsitekturCorePrinciplesTUMBUH["MASTER ARSITEKTUR CORE PRINCIPLES TUMBUH"]
        
        subgraph EmpatPilarKonseptualMasterCore["EMPAT PILAR KONSEPTUAL KONSTITUSI NILAI"]
            CP_M1["1. PERLINDUNGAN MARTABAT & EKOSISTEM (Sanctity & Triad)<br/>Memuliakan fitrah santri (Zero Humiliation) & menjamin kesehatan musyrif."]
            CP_M2["2. KETELADANAN INTEGRITAS PROFETIK (Qudwah First)<br/>Pendidik memimpin di shaf terdepan; bebas standar ganda kedisiplinan."]
            CP_M3["3. METODOLOGI RESTORATIF BERADAB (Firm & Kind)<br/>Ketegasan aturan tanpa kekerasan; Connection Before Correction."]
            CP_M4["4. ARSITEKTUR DATA & PENTAHAPAN (PBIS & Tadarruj)<br/>Piramida Multi-Tier (80-15-5), analitik 4W 1H, & habituasi 66-hari."]
        end
        
        subgraph ManifestasiPraksisTataKelolaCore["MANIFESTASI PRAKSIS TATA KELOLA 24 JAM"]
            M1_CP["• Piagam Perlindungan Santri & Shift Kerja 7 Jam."]
            M2_CP["• SOP Logbook PBIS Terenkripsi & Anti-Tajassus."]
            M3_CP["• Dewan Majelis Syura & Audit Mutu Tahunan."]
        end
        
        EmpatPilarKonseptualMasterCore <===> ManifestasiPraksisTataKelolaCore
    end
```
...
```mermaid
flowchart TD
    subgraph PenjalaranPrinsipKeLanjutan["PENJALARAN KONSTITUSIONAL KE SUB-DOMAIN LANJUTAN"]
        CoreMaster["P2-01: CORE PRINCIPLES (Konstitusi Nilai Induk)"]
        
        CoreMaster ==> P2_02["P2-02: Design Principles<br/>(Prinsip UbD, Tata Ruang CPTED Terang, Sanitasi 5S, & SOP)"]
        CoreMaster ==> P2_03["P2-03: Learning Principles<br/>(Prinsip Cognitive Load Theory, Spaced Retrieval, & SRL)"]
        CoreMaster ==> P2_04["P2-04: Development Principles<br/>(Prinsip Neurosains Remaja, In Loco Parentis, & CASEL SEL)"]
        CoreMaster ==> P2_05["P2-05: Assessment Principles<br/>(Prinsip Asesmen Autentik, Rubrik BARS, & Tabayyun 360)"]
        CoreMaster ==> P2_06["P2-06: Intervention Principles<br/>(Prinsip Multi-Tier PBIS 4:1, FBA ABC, & Restoratif Ishlah)"]
        CoreMaster ==> P2_07["P2-07: Implementation Principles<br/>(Prinsip Kotter 8-Step, Diklat Musyrif, & Mutu PDCA)"]
    end
```
...
Penerapan konsep **P2-01: PRINSIP UTAMA (CORE PRINCIPLES) EKOSISTEM TUMBUH (MASTER DOKTRIN KONSTITUSI NILAI)** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
