...
```mermaid
flowchart TD
    subgraph TransformasiQudwahFirst["TRANSFORMASI PARADIGMA KETELADANAN PENDIDIK"]
        PolaStandarGandaLama["KEMUNAFIKAN PEDAGOGIS & RETORIKA (LAMA)<br/>• Banyak ceramah di podium; minim teladan amal nyata.<br/>• Standar ganda: Aturan hanya mengikat santri.<br/>• Menumbuhkan sinisme & krisis kepercayaan santri."]
        
        PolaQudwahTUMBUH["QUDWAH-FIRST & LISANUL HAL (TUMBUH)<br/>• Keteladanan visual mendahului instruksi kata.<br/>• Aturan mengikat pendidik lebih ketat daripada santri.<br/>• Resonansi mirror neurons: Karakter menular alami."]
        
        PolaStandarGandaLama ==>|DIREKONSTRUKSI MENJADI| PolaQudwahTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturQudwahFirstTUMBUH["ARSITEKTUR KETELADANAN QUDWAH-FIRST TUMBUH"]
        
        Q1_Sayap["1. KEHADIRAN SHAF TERDEPAN (Frontline Modeling)<br/>Pendidik terdepan dalam ibadah, tepat waktu, kebersihan, & keluhuran tutur kata."]
        
        Q2_Sayap["2. ELIMINASI STANDAR GANDA (Zero Double-Standards)<br/>Penegakan disiplin universal: Aturan mengikat pendidik lebih ketat daripada santri."]
        
        Q3_Sayap["3. AUDIT INTEGRITAS 360 DERAJAT (Integrity Assurance)<br/>Evaluasi keteladanan berkala oleh pimpinan, rekan sejawat, & umpan balik santri."]
...
```mermaid
flowchart TD
    subgraph ProtokolAuditIntegritas["PROTOKOL AUDIT INTEGRITAS PENDIDIK BERKALA"]
        SelfAudit["1. MUHASABAH MANDIRI PEKANAN: Pengisian Lembar Refleksi Qudwah Pribadi oleh Musyrif"]
        --> PeerReview["2. EVALUASI SEJAWAT: Masukan Konstruktif Antar-Musyrif dalam Halaqah Tarbiyah Pekanan"]
        --> StudentFeedback["3. KOTAK UMPAN BALIK SANTRI: Penilaian Persepsi Keteladanan Guru Secara Anonim Terenkripsi"]
        --> CoachingMudir["4. DIALOG COACHING MUDIR: Sesi Pendampingan Takzim bagi Pendidik yang Perlu Peningkatan Qudwah"]
    end
```
...
Penerapan konsep **P2-01-03: PRINSIP KETELADANAN QUDWAH-FIRST (MODELING PRECEDES INSTRUCTION)** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
