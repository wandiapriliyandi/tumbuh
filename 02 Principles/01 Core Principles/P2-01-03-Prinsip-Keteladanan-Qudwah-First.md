...
- [BAGIAN II: TEMUAN RISET, FORMULASI KONSEPTUAL & PEMBAHASAN](#bagian-ii-temuan-riset-formulasi-konseptual--pembahasan)
  - [1. Formulasi Konseptual: Prinsip Qudwah-First (Lisanul Hal)](#1-formulasi-konseptual-prinsip-qudwah-first-lisanul-hal)
...
```mermaid
graph TD
    A["Gugatan Otoritas Guru (Pihak A):<br/>'Tugas guru hanya menyampaikan ilmu, guru tidak wajib sempurna mengamalkannya!'"]
    --> B1["Tinjauan Nash QS. Ash-Shaff 2-3:<br/>Kabura maqtan 'indallahi an taqulu ma la taf'alun (Murka besar bagi penuntut tanpa amal)."]
    A --> B2["Tinjauan Hadits Nabi:<br/>Ulama yang tidak mengamalkan ilmunya seperti lilin: membakar diri sendiri."]
    A --> B3["Tinjauan Psikologi Kredibilitas:<br/>Ketidaksesuaian ucapan & perbuatan melahirkan sinisme moral pada santri."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Qudwah-First adalah syarat mutlak keberkahan ilmu & efektivitas pendidikan."]
```
...
```mermaid
graph TD
    A["Gugatan Sains Kognitif (Pihak A):<br/>'Bagaimana mekanisme biologis otak santri meniru perilaku pendidik?'"]
    --> B1["Tinjauan Social Learning Theory (Bandura, 1977):<br/>Observational Learning: Manusia belajar adab via Modeling, Retention, Reproduction, & Motivation."]
    A --> B2["Tinjauan Neurosains Mirror Neurons (Rizzolatti, 1996):<br/>Sel saraf cermin di otak menembakkan sinyal meniru ekspresi & adab guru secara otomatis."]
    A --> B3["Tinjauan Teori Kredibilitas Sumber (Hovland):<br/>Trustworthiness guru melipatgandakan kepatuhan sukarela santri."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Keteladanan visual adalah jalur tercepat pembentukan sirkuit saraf adab di otak."]
```
...
```mermaid
graph TD
    subgraph LimaDimensiQudwah["LIMA STANDAR WAJIB QUDWAH HASANAH TUMBUH"]
        Q1["1. QUDWAH IBADAH & SPRITUAL<br/>Hadir di shaf pertama masjid sebelum adzan; istiqamah tahajjud & tilawah"]
        Q2["2. QUDWAH LISAN & ADAB BICARA<br/>Tutur kata santun, bebas makian, tidak sarkasme, & menjaga rahasia santri"]
        Q3["3. QUDWAH KEBERSIHAN & FISIK<br/>Pakaian rapi wangi, kamar bersih, & aktif memungut sampah"]
        Q4["4. QUDWAH REGULASI EMOSI<br/>Tenang saat marah, tidak membanting barang, mendengarkan, & pemaaf"]
        Q5["5. QUDWAH WAKTU & INTEGRITAS<br/>Tepat waktu mengajar, menepati janji, & transparan amanah dana"]
    end
```
...
```mermaid
graph TD
    A["Gugatan Feodalisme Hak Istimewa (Pihak A):<br/>'Guru memiliki hak istimewa (privilege) untuk melanggar aturan yang diberlakukan kepada santri!'"]
    --> B1["Tinjauan Fiqh Keadilan Syar'i:<br/>Hukum syariat berlaku universal tanpa kasta darah atau status sosial."]
    A --> B2["Tinjauan Psikologi Sinisme Moral:<br/>Standar ganda melahirkan kepahitan batin & kebencian santri pada otoritas agama."]
    A --> B3["Tinjauan Zero Double-Standards TUMBUH:<br/>Aturan adab, kerapian, & kebersihan mengikat guru dan santri secara setara."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Integritas kepemimpinan tegak saat guru menjadi orang pertama yang patuh aturan."]
```
...
```mermaid
flowchart TD
    Survey["SURVEI EVALUASI INTEGRITAS PENDIDIK SEMESTERAN<br/>(Instrumen Digital Anonim & Terenkripsi bagi Santri)"]
    --> Analysis["ANALISIS DATA INDEKS KEHANGATAN & KETELADANAN<br/>(Skor 1-5 pada 5 Dimensi Qudwah: Ibadah, Lisan, Bersih, Emosi, Waktu)"]
    
    Analysis --> Feedback["SESI REFLEKSI PERSONAL 1-ON-1 DENGAN GURU SENIOR<br/>Membahas area perbaikan diri tanpa membuka identitas santri penilai."]
    
    Feedback --> Growth["RENCANA PENGEMBANGAN INTEGRITAS DIRI (PDIP)<br/>Coaching berkala, pelatihan komunikasi asertif, & sertifikasi Qudwah."]
```
...
```mermaid
flowchart TD
    A["Gugatan Pembudayaan Karakter (Pihak A):<br/>'Bagaimana menyatukan seluruh elemen qudwah ini menjadi kultur hidup nyata pesantren 24 jam?'"]
    --> B1["Pilar 1: Shalat Berjamaah Berbaris Shaf Terdepan<br/>Seluruh asatidz & musyrif mengisi shaf pertama masjid mendahului santri."]
    B1 --> B2["Pilar 2: Gerakan Operasi Semut Bersama (Qudwah Sanitasi)<br/>Pimpinan pondok ikut menyapu halaman bersama santri setiap Jumat pagi."]
    B2 --> B3["Pilar 3: Majelis Sapaan Pagi & Relational Praise 4:1<br/>Musyrif menyambut santri dengan salam, senyuman, & apresiasi tulus."]
    B3 --> C["Titik Temu Konsensus:<br/>Budaya Qudwah-First memancarkan Bi'ah Shalihah yang menenteramkan jiwa."]
```
...
*Bagian ini memuat pembahasan temuan penelitian, formulasi model teoretis, dan sintesis konseptual Qudwah-First,* matriks 5 standar keteladanan, matriks Zero Double-Standards, dan protokol audit integritas pendidik.*

---

### 1. Formulasi Konseptual: Prinsip Qudwah-First (Lisanul Hal)
...
```mermaid
graph LR
    subgraph MatriksLimaStandarQudwah["LIMA STANDAR WAJIB QUDWAH HASANAH"]
        D1["1. QUDWAH IBADAH<br/>• Hadir masjid sebelum adzan<br/>• Mengisi shaf terdepan<br/>• Istiqamah tahajjud & rawatib"]
        D2["2. QUDWAH LISAN<br/>• Tutur kata santun & lembut<br/>• Bebas makian, ghibah, & sarkas<br/>• Menjaga rahasia konseling"]
        D3["3. QUDWAH KEBERSIHAN<br/>• Pakaian rapi, bersih, wangi<br/>• Kamar musyrif percontohan<br/>• Memungut sampah di jalan"]
        D4["4. QUDWAH EMOSI<br/>• Tenang saat menghadapi krisis<br/>• Tidak membanting barang<br/>• Pemaaf & mendengarkan empati"]
        D5["5. QUDWAH INTEGRITAS<br/>• Tepat waktu mengajar & rapat<br/>• Menepati janji pada santri<br/>• Kawasan 100% Bebas Rokok"]
    end
```
...
```mermaid
flowchart TD
    DataInput["DATA MASUK: Survei Anonim Santri, Observasi Pimpinan, & Logbook PBIS"]
    --> Review["TAHAP 1: REVIEW KOMITE ETIK MA'HAD (Setiap Akhir Semester)<br/>Menganalisis skor 5 dimensi qudwah seluruh dewan guru & musyrif."]
    
    Review --> KasusRingan{"APAKAH SKOR MEMENUHI STANDAR (> 80%)?"}
    KasusRingan -- YA --> Reward["PEMBERIAN APRESIASI & PENGHARGAAN MUSYRIF TELADAN QUDWAH"]
    KasusRingan -- TIDAK / PELANGGARAN RINGAN --> Coaching["TAHAP 2: COACHING PERSONAL 1-ON-1<br/>Sesi refleksi tertutup bersama kiai/guru senior; penyusunan rencana perbaikan diri (PDIP)."]
    
    Coaching --> AuditUlang["AUDIT ULANG DALAM 30 HARI<br/>Pemantauan perbaikan perilaku di asrama & kelas."]
    
    Review -- PELANGGARAN BERAT (KEKERASAN/ROKOK/MAKI) --> Sanksi["TAHAP 3: SIDANG MAJELIS ETIK<br/>Penerbitan Surat Peringatan Keras (SP), pemotongan insentif, atau penonaktifan tugas pengasuhan."]
```
