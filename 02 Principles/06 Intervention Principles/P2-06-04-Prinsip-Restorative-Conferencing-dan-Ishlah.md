...
```mermaid
flowchart TD
    subgraph TransformasiKeadilanPesantren["TRANSFORMASI PARADIGMA PENEGAKAN DISIPLIN"]
        RetributifLama["PARADIGMA RETRIBUTIF PEMBALASAN (LAMA)<br/>• Fokus pada penderitaan pelaku (Hukuman fisik & caci maki).<br/>• Korban diabaikan; lemari/barang rusak tidak diganti.<br/>• Memicu dendam permusuhan & alienasi sosial santri."]
        
        RestoratifTUMBUH["PARADIGMA RESTORATIF ISHLAH AL-BAIN (TUMBUH)<br/>• Fokus pada pemulihan luka korban & perbaikan kerusakan (4R).<br/>• Pelaku bertanggung jawab aktif merestitusi kerugian.<br/>• Hubungan ukhuwah pulih utuh; reintegrasi tanpa stigma."]
        
        RetributifLama ==>|TRANSFORMASI ISHLAH NABAWIYYAH| RestoratifTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Pembalasan Mutlak (Pihak A):<br/>'Santri yang bersalah harus dibalas setimpal sampai menangis kesakitan; tidak ada damai-damaian dalam penegakan aturan pondok!'"]
    --> B1["Tinjauan Al-Qur'an Surah Al-Hujurat: 9–10:<br/>Perintah mutlak mendamaikan perselisihan (Fa ashlihu bainahuma bil-'adl wa aqshithu) atas dasar Ukhuwah."]
    A --> B2["Tinjauan Al-Qur'an Surah An-Nisa: 128 & Al-Baqarah: 237:<br/>Kaidah Qur'ani 'Wash-Shulhu Khair' (Perdamaian itu jauh lebih baik) & keutamaan memaafkan (Al-'Afwu)."]
    A --> B3["Tinjauan Hadits Shahih Bukhari 2699 & Tirmidzi 1352:<br/>'Ash-Shulhu ja'izun baina al-muslimin' (Perdamaian adalah sah di antara kaum muslimin selama tidak menghalalkan yang haram)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Ishlah al-Bain dan pemulihan ukhuwah adalah maqashid tertinggi dalam penanganan konflik syar'i."]
```
...
```mermaid
graph TD
    subgraph TigaPertanyaanRestoratifZehr["TIGA PERTANYAAN KUNCI KEADILAN RESTORATIF (HOWARD ZEHR)"]
        Q1["1. SIAPA YANG TELAH TERLUKA / DIRUGIKAN DALAM PERISTIWA INI?<br/>(Mengidentifikasi dampak nyata pada korban & komunitas asrama)."]
        
        Q2["2. APA SAJA KEBUTUHAN DAN HAK PEMULIHAN MEREKA SAAT INI?<br/>(Kebutuhan rasa aman, perbaikan barang yang rusak, & pemulihan nama baik)."]
        
        Q3["3. SIAPA YANG MEMIKUL KEWAJIBAN & BAGAIMANA CARA MEMPERBAIKINYA?<br/>(Pelaku mengambil tanggung jawab nyata merestitusi kerugian secara terhormat)."]
...
```mermaid
graph TD
    subgraph FormulaKonsekuensi4RTUMBUH["FORMULA KONSEKUENSI LOGIS 4R"]
        R1["1. RELATED (Relevan Berhubungan Langsung)<br/>Konsekuensi memiliki kaitan logis dengan pelanggaran.<br/>Contoh: Mencoret dinding asrama -> Mengecat ulang dinding tersebut."]
        
        R2["2. RESPECTFUL (Menghormati Martabat Insani)<br/>Ditetapkan tanpa nada memaki, tanpa kekerasan fisik, & tanpa mempermalukan di depan publik."]
        
        R3["3. REASONABLE (Masuk Akal & Proporsional)<br/>Beban perbaikan terjangkau oleh kapasitas usia santri tanpa menzalimi waktu tidur/belajar."]
        
        R4["4. RESTORATIVE (Memulihkan Kerusakan & Relasi)<br/>Mengembalikan hak korban dan menyambung kembali persaudaraan dengan ikhlas."]
...
```mermaid
flowchart TD
    subgraph AlurKonferensiRestoratif5Tahap["5 TAHAPAN BAKU KONFERENSI RESTORATIF ISHLAH"]
        T1_Step["1. PRA-KONFERENSI PERSIAPAN TERPISAH (PRE-CONFERENCE)<br/>Fasilitator musyrif bertemu korban & pelaku secara terpisah untuk memastikan kesiapan dialog."]
        
        T2_Step["2. PEMBUKAAN LINGKARAN ISHLAH & PEMBACAAN ADAB DIALOG<br/>Fasilitator membuka pertemuan duduk melingkar dengan doa, tasmi' ayat ukhuwah, & aturan bicara."]
        
        T3_Step["3. EKSPLORASI DAMPAK (NARRATIVE OF IMPACT)<br/>Pelaku menceritakan apa yang terjadi; Korban menyampaikan perasaan & kerugian yang dialami."]
        
        T4_Step["4. PERUMUSAN KESEPAKATAN RESTITUSI (REPAIR AGREEMENT)<br/>Kedua pihak merumuskan tindakan ganti rugi 4R & menandatangani Piagam Ishlah."]
        
        T5_Step["5. PENUTUPAN & RITUAL REINTEGRASI KOMUNITAS (NO-STIGMA WELCOME)<br/>Pelukan ukhuwah, makan bersama, dan penyambutan kembali ke kamar tanpa label negatif."]
        
        T1_Step --> T2_Step --> T3_Step --> T4_Step --> T5_Step
    end
```
...
```mermaid
flowchart TD
    T1["1. PRA-KONFERENSI TERPISAH (PRE-CONFERENCE INTERVIEW)<br/>Musyrif konselor memastikan pelaku siap mengakui kesalahan & korban siap berdialog."]
    
    T2["2. PEMBUKAAN LINGKARAN ISHLAH (CIRCLE OPENING)<br/>Duduk melingkar setara; fasilitator membaca doa & menegakkan tata tertib dialog santun."]
    
    T3["3. SESI NARASI KEJADIAN & EKSPLORASI DAMPAK (HEARING STORIES)<br/>Pelaku: 'Apa yang terjadi? Apa yang kamu pikirkan saat itu?'<br/>Korban: 'Bagaimana perasaanmu? Apa dampak terbesar bagimu?'."]
    
    T4["4. PERUMUSAN AKSI RESTITUSI 4R & PENANDATANGANAN PIAGAM<br/>Menyepakati rincian ganti rugi, jadwal pelaksanaan, & batas waktu tuntas."]
