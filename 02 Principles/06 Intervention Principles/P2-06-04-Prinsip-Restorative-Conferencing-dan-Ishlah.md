...
```mermaid
flowchart TD
    subgraph TransformasiParadigmaKeadilan["TRANSFORMASI PARADIGMA KEADILAN DISIPLIN"]
        PolaRetributifLama["DISIPLIN RETRIBUTIF BALAS DENDAM (LAMA)<br/>• Fokus menimpakan derita pada pelaku.<br/>• Hak korban diabaikan; relasi rusak permanen.<br/>• Melahirkan permusuhan & dendam turun-temurun."]
        
        PolaRestoratifTUMBUH["KEADILAN RESTORATIF & ISHLAH AL-BAIN (TUMBUH)<br/>• Fokus pulihkan luka korban & perbaiki kerusakan.<br/>• Konsekuensi Logis 4R: Related, Respectful, Reasonable, Restorative.<br/>• Konferensi Lingkaran Ishlah & Reintegrasi tanpa stigma."]
...
```mermaid
flowchart TD
    subgraph ArsitekturRestoratifTUMBUH["ARSITEKTUR RESTORATIVE CONFERENCING & ISHLAH"]
        
        R1_Sayap["1. FORMULA KONSEKUENSI 4R (Logical 4R Consequences)<br/>Related (Relevan), Respectful (Bermartabat), Reasonable (Wajar), & Restorative (Memulihkan)."]
        
        R2_Sayap["2. KONFERENSI LINGKARAN ISHLAH (Restorative Conferencing Circle)<br/>Forum dialog 5 fase: Buka Hati -> Validasi Luka -> Penyesalan -> Kesepakatan -> Ishlah."]
        
        R3_Sayap["3. REINTEGRASI BEBAS STIGMA (No-Stigma Reintegration)<br/>Penghapusan label buruk, pemulihan nama baik, & sambutan hangat komunitas asrama."]
...
```mermaid
flowchart TD
    subgraph SOPKonferensiRestoratifIshlah["SOP KONFERENSI LINGKARAN RESTORATIF ISHLAH"]
        PraKonferensi["1. PRA-KONFERENSI (Persiapan Privat): Fasilitator Bertemu Korban & Pelaku Secara Terpisah"]
        --> PembukaanLingkaran["2. PEMBUKAAN LINGKARAN: Duduk Melingkar Sejajar & Menetapkan Aturan Saling Menghormati"]
        --> EksplorasiPerasaan["3. DIALOG EMPATIK: Pelaku Menceritakan Fakta -> Korban Menyampaikan Dampak Lukanya"]
        --> PerumusanAksi4R["4. PERUMUSAN KESEPAKATAN 4R: Pelaku Menawarkan Tindakan Perbaikan Ganti Rugi Nyata"]
        --> PenandatangananIshlah["5. PENUTUPAN & ISHLAH: Penandatanganan Piagam Ishlah, Doa Bersama, & Salaman Hangat"]
    end
```
