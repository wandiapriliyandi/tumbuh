...
```mermaid
flowchart TD
    subgraph ArsitekturSintesisInterventionPrinciples["6 PILAR INTERVENSI PERILAKU SANTRI TUMBUH"]
        P1["PILAR 1: MULTI-TIER PBIS (P2-06-01)<br/>• Kontinum 3 Tingkat: Tier 1 (80-90%), Tier 2 (10-15%), Tier 3 (1-5%).<br/>• Program CICO & rasio apresiasi 4:1."]
        
        P2["PILAR 2: FUNCTIONAL BEHAVIOR ASSESSMENT (P2-06-02)<br/>• Model ABC (Antecedent - Behavior - Consequence).<br/>• BIP & Replacement Behavior."]
        
        P3["PILAR 3: DE-ESKALASI KRISIS & AL-HILM (P2-06-03)<br/>• Ketenangan Co-Regulation & Protokol 3R Bruce Perry.<br/>• Zero Physical Restraint & Safe Zone."]
        
        P4["PILAR 4: RESTORATIVE ISHLAH AL-BAIN (P2-06-04)<br/>• Whole-School Restorative Justice & Konsekuensi Logis 4R.<br/>• Lingkaran Ishlah memulihkan hak korban."]
        
        P5["PILAR 5: INTERVENSI KRISIS & SIBER (P2-06-05)<br/>• Hifzhun Nafs, Kotak Tabayyun pelaporan aman, & anti-cyberbullying."]
        
        P6["PILAR 6: REINTEGRASI & ANTI-STIGMA (P2-06-06)<br/>• At-Taubatu Tajubbu Ma Qablaha, Clean Slate Protocol, & Reintegrative Shaming."]
        ...
        Pusat["TERWUJUDNYA SISTEM DISIPLIN RESTORATIF YANG MENDIDIK TANGGUNG JAWAB, MEMULIHKAN UKHUWAH, & BEBAS KEKERASAN"]
...
```mermaid
graph TD
    subgraph TriadSimbiotikDalamIntervensi["TRIAD PERTUMBUHAN SIMBIOTIK DALAM INTERVENSI RESTORATIF"]
        Santri["1. SANTRI TUMBUH<br/>• Belajar dari kesalahan secara terhormat.<br/>• Memiliki resiliensi moral & empati pada korban.<br/>• Reintegrasi tanpa label 'anak nakal'."]
        
        Musyrif["2. MUSYRIF / ASATIDZ TUMBUH<br/>• Menguasai protokol de-eskalasi & FBA profesional.<br/>• Terbebas dari rasa marah & burnout yang merusak.<br/>• Dihormati santri sebagai pembimbing yang adil."]
        
        Pesantren["3. PESANTREN / LEMBAGA TUMBUH<br/>• Menjadi zona aman bebas kekerasan & intimidasi.<br/>• Angka drop-out / pengusiran santri turun drastis 0%.<br/>• Menjadi rujukan model madrasah ramah anak."]
...
```mermaid
graph LR
    subgraph JembatanKeImplementationPrinciples["JEMBATAN STRATEGIS MENUJU SUB-DOMAIN 07"]
        Intervention["06 INTERVENTION PRINCIPLES (PROTOKOL MULTI-TIER, ISHLAH, & REINTEGRASI)<br/>Menetapkan prinsip FBA, De-eskalasi 3R, CICO, Konsekuensi 4R, & Clean Slate."]
        
        Implementation["07 IMPLEMENTATION PRINCIPLES (STANDARISASI OPERASIONAL 24 JAM)<br/>Menetapkan SOP implementasi lapangan, manajemen perubahan budaya, audit kepatuhan, & skalabilitas lembaga."]
        
        Intervention ==>|MENJADI STANDAR TINDAKAN YANG DIOPERASIONALKAN DI| Implementation
    end
```
...
```mermaid
flowchart TD
    subgraph SiklusPenjaminanMutuIntervensiTUMBUH["SIKLUS PENJAMINAN MUTU INTERVENSI RESTORATIF"]
        AuditCICO["1. AUDIT EFEKTIVITAS CICO & DATA TIER 2 (PEKANAN)<br/>Tim PBIS mengevaluasi kartu keberhasilan santri bimbingan harian."]
        
        SupervisiFBA["2. SUPERVISI KLINIS DOKUMEN FBA-BIP TIER 3 (BULANAN)<br/>Konselor Senior BK meninjau ketepatan analisis fungsi & target restitusi."]
        
        SimulasiDeEskalasi["3. DRILL SIMULASI DE-ESKALASI KRISIS MUSYRIF (SEMESTERAN)<br/>Latihan berkala penanganan amuk santri & de-eskalasi verbal 3R."]
        
        AuditRestoratif["4. AUDIT KEPUASAN KORBAN & REINTEGRASI ISHLAH (AKHIR SEMESTER)<br/>Memastikan tidak ada dendam laten atau pengucilan sosial di asrama."]
        
        AuditCICO --> SupervisiFBA --> SimulasiDeEskalasi --> AuditRestoratif --> AuditCICO
    end
```
