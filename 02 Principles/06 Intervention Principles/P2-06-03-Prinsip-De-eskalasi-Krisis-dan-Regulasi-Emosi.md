...
```mermaid
flowchart TD
    subgraph TransformasiPenangananKrisis["TRANSFORMASI MANAJEMEN KRISIS EMOSI"]
        PolaKasarLama["ESKALASI BERSAMA & PENGUNCIAN FISIK (LAMA)<br/>• Musyrif membalas berteriak & melotot.<br/>• Memiting/memukul santri ke lantai.<br/>• Memicu trauma, cedera fisik, & gugatan pidana."]
        
        PolaDeEskalasiTUMBUH["DE-ESKALASI 3R & SIFAT AL-HILM (TUMBUH)<br/>• Sifat Al-Hilm & Al-Anah (HR. Muslim No. 17).<br/>• Protokol 3R Bruce Perry: Regulate -> Relate -> Reason.<br/>• Zero Restraint SOP: Tenang, aman, & restoratif."]
        
        PolaKasarLama ==>|DIREKONSTRUKSI MENJADI| PolaDeEskalasiTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturDeEskalasiTUMBUH["ARSITEKTUR DE-ESKALASI KRISIS & REGULASI EMOSI"]
        
        D1_Sayap["1. KO-REGULASI AL-HILM (Adult Nervous System Co-Regulation)<br/>Ketenangan batin musyrif, nada suara rendah, & jarak aman fisik 2 meter."]
        
        D2_Sayap["2. SIKLUS 3R BRUCE PERRY (Regulate -> Relate -> Reason)<br/>Stabilisasi detak jantung, validasi empati batin, & penalaran logis solutif."]
        
        D3_Sayap["3. KEBIJAKAN ZERO RESTRAINT (Zero Physical Restraint SOP)<br/>Pengharaman mutlak pemitingan fisik, borgol, isolasi gelap, & pemukulan."]
        
        D1_Sayap <===> D2_Sayap <===> D3_Sayap
    end
```
...
```mermaid
flowchart TD
    subgraph Protokol3R_Perry["PROTOKOL 3R DE-ESKALASI KRISIS"]
        Regulate["1. REGULATE (Fisik): Tarik Nafas Dalam, Duduk Rileks di Lantai, Basuh Air Wudhu, Jaga Hening"]
        --> Relate["2. RELATE (Hati): Validasi Perasaan Santri ('Ustadz Paham Antum Sedang Marah & Sedih')"]
        --> Reason["3. REASON (Akal): Setelah Nafas Normal, Diskusikan Konsekuensi Logis Restoratif (4R) & Solusi"]
    end
```
