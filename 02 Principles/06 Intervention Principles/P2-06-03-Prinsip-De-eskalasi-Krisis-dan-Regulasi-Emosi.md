...
```mermaid
flowchart TD
    subgraph TransformasiPenangananKrisis["TRANSFORMASI RESPON KRISIS EMOSI ASRAMA"]
        EskalasiKekerasan["RESPON ESKALASI MEMBALAS MARAH (LAMA)<br/>• Musyrif membalas membentak & mendekat mengintimidasi.<br/>• Memicu amuk fisik, cedera santri, & risiko pidana hukum.<br/>• Trauma batin kronis & dendam permusuhan."]
        
        DeEskalasiTUMBUH["PROTOKOL DE-ESKALASI 3R & AL-HILM (TUMBUH)<br/>• Musyrif menjaga ketenangan sistem saraf (Co-Regulation).<br/>• Menjalankan 3R: Regulate (Tenangkan) -> Relate -> Reason.<br/>• Menjamin keselamatan fisik 100% tanpa kekerasan."]
        
        EskalasiKekerasan ==>|TRANSFORMASI PROTOKOL DE-ESKALASI| DeEskalasiTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Kemarahan Pendidik (Pihak A):<br/>'Kalau santri membangkang dan berteriak, guru harus lebih keras berteriak agar wibawanya tidak diinjak-injak!'"]
    --> B1["Tinjauan Hadits Shahih Muslim 17:<br/>Pujian Rasulullah SAW kepada Asyaj Abdul Qais: 'Inna fika khashlataini yuhibbuhumallah: Al-Hilmu wal-Anah' (Ketenangan batin & kehati-hatian)."]
    A --> B2["Tinjauan Hadits Sunan Abu Dawud 4782:<br/>Terapi fisik marah Nabawi: Mengubah postur (berdiri -> duduk -> berbaring) & berwudhu air dingin."]
    A --> B3["Tinjauan Ihya 'Ulumiddin Imam Al-Ghazali (Kitab Dzammil Ghadhab):<br/>Marah adalah bara api setan di dalam kalbu; memadamkannya wajib dengan kelemahlembutan & air wudhu."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Ketenangan batin (Al-Hilm) dan de-eskalasi adalah sunnah kepemimpinan tertinggi para Nabi."]
```
...
```mermaid
flowchart TD
    subgraph TigaLangkah3RBrucePerry["PROTOKOL 3R BRUCE D. PERRY (NEUROSEQUENTIAL MODEL)"]
        R1["1. REGULATE (Tenangkan Batang Otak & Sensori Fisik)<br/>• Turunkan stimulasi sensori; beri ruang gerak aman.<br/>• Atur pernapasan, ajak duduk, & berikan air wudhu/minum.<br/>• JANGAN MENASIHATI ATAU BERDEBAT DI TAHAP INI!"]
        
        R2["2. RELATE (Hubungkan Sistem Limbik dengan Empati Hangat)<br/>• Gunakan nada suara rendah, lembut, & bersahabat.<br/>• Validasi perasaan santri: 'Ustadz tahu kamu sedang sedih/marah'.<br/>• Hadirkan rasa aman emosional (Safe Haven)."]
        
        R3["3. REASON (Ajak Korteks Prefrontal Berpikir Logis)<br/>• Dilakukan HANYA setelah detak jantung santri normal & tenang.<br/>• Diskusikan apa yang terjadi secara reflektif.<br/>• Rumuskan solusi perbaikan & konsekuensi logis 4R bersama."]
...
```mermaid
graph TD
    subgraph EnamFaseSiklusKrisisColvin["6 FASE SIKLUS KRISIS PERILAKU (GEOFF COLVIN)"]
        F1["Fase 1: CALM (Tenang) -> Pencegahan Universal Tier 1 & Rasio 4:1."]
        F2["Fase 2: TRIGGER (Pemicu) -> Deteksi rasa tersinggung, kelelahan, atau ejekan."]
        F3["Fase 3: AGITATION (Agitasi) -> Gerakan tubuh gelisah, memutus kontak mata."]
        F4["Fase 4: ACCELERATION (Akselerasi) -> Nada suara tinggi, memaki, mengancam."]
        F5["Fase 5: PEAK (Puncak Krisis) -> Amuk fisik, melempar benda -> FOKUS KESELAMATAN FISIK."]
        F6["Fase 6: DE-ESCALATION & RECOVERY -> Energi turun, menangis -> Rekonstruksi Restoratif."]
...
```mermaid
graph LR
    subgraph KomparasiResponMusyrif["CO-ESCALATION (DESTRUKTIF) VS CO-REGULATION (RESTORATIF)"]
        CoEsc["CO-ESCALATION (Salah):<br/>Musyrif ikut marah, membentak, & memukul.<br/>-> Otak santri membaca ancaman mematikan.<br/>-> Ledakan perlawanan fisik massal."]
        
        CoReg["CO-REGULATION (TUMBUH):<br/>Musyrif mengatur napas, merendahkan suara, & tenang.<br/>-> Ketenangan musyrif menular ke saraf santri.<br/>-> Amigdala santri mereda damai."]
        
        CoEsc -.->|TRANSFORMASI KETENANGAN HILM| CoReg
    end
```
...
```mermaid
graph TD
    subgraph AlurProtokol3RPesantren["SOP 3R PENANGANAN EMOSI SANTRI TUMBUH"]
        R1_Step["1. REGULATE (5–15 Menit Awal)<br/>• Jaga jarak 2–3 meter; posisi tubuh menyamping (Non-Threatening Stance).<br/>• Ajak santri duduk di lantai & mengambil napas dalam 4-7-8.<br/>• Tawarkan berwudhu dengan air dingin mengalir."]
        
        R2_Step["2. RELATE (10–20 Menit Pasca-Tenang)<br/>• Musyrif duduk sejajar dengan santri.<br/>• Gunakan kalimat validasi: 'Ustadz tahu kamu sedang sangat terluka'.<br/>• Berikan segelas teh manis hangat; dengarkan tanpa menyela."]
        
        R3_Step["3. REASON (Keesokan Harinya / Pasca-Tidur Nyenyak)<br/>• Konselor BK memfasilitasi dialog analisis motif (FBA).<br/>• Membimbing santri merumuskan tindakan perbaikan nyata (4R Restitution).<br/>• Menutup dengan doa ishlah dan pelukan kehangatan ukhuwah."]
        
        R1_Step ==> R2_Step ==> R3_Step
    end
```
...
```mermaid
flowchart TD
    Krisis["TERJADI INSIDEN KRISIS EMOSI / PERKELAHIAN FISIK ASRAMA"]
    
    L1["LANGKAH 1: AMANKAN AREA & EVAKUASI (SAFETY BUFFER ZONE)<br/>Musyrif memerintahkan santri lain keluar kamar; tutup pintu pembatas."]
    
    L2["LANGKAH 2: AKTIFKAN SIKAP TENANG BERWIBAWA (CO-REGULATION STANCE)<br/>Musyrif merendahkan bahu, telapak tangan terbuka ke bawah, nada suara tenang."]
    
    L3["LANGKAH 3: DE-ESKALASI VERBAL MINIMALIS (3–5 KATA SEDERHANA)<br/>'Kamu aman di sini. Tarik napas. Kita duduk bersama'."]
    
    L4["LANGKAH 4: TRANSISI MEDIS & RUANG NYAMAN (CALMING ROOM)<br/>Pindahkan santri ke Ruang Relaksasi Konseling BK untuk pendinginan penuh."]
