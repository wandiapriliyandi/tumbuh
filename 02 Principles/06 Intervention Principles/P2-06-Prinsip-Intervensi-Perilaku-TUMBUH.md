...
```mermaid
flowchart TD
    subgraph PosisiInterventionPrinciplesTUMBUH["POSISI SUB-DOMAIN 06 INTERVENTION PRINCIPLES"]
        D2_05["02.05 ASSESSMENT PRINCIPLES<br/>(Asesmen Autentik, Rubrik BARS, Triangulasi 360, Portofolio Formatif, & Feedback 3F)"]
        ==> D2_06["02.06 INTERVENTION PRINCIPLES<br/>(Multi-Tier PBIS, FBA, De-Eskalasi 3R, Ishlah, Anti-Bullying, & Clean Slate)"]
        
        D2_06 ==> D2_07["02.07 IMPLEMENTATION PRINCIPLES<br/>(SOP Lapangan, Manajemen Perubahan, & Standarisasi Pengasuhan)"]
    end
```
...
```mermaid
flowchart TD
    subgraph MasterArsitekturInterventionPrinciplesTUMBUH["MASTER ARSITEKTUR INTERVENTION PRINCIPLES TUMBUH"]
        
        subgraph EmpatPilarKonseptualMasterIntervene["EMPAT PILAR KONSEPTUAL INTERVENSI"]
            IP_M1["1. SISTEM PBIS MULTI-TIER & CICO (Proactive Prevention)<br/>Pencegahan 3 lapis, mentoring harian CICO, & pembiasaan rasio 4:1."]
            IP_M2["2. DIAGNOSIS FBA & DE-ESKALASI 3R (Neuro-Functional Care)<br/>Bedah motif ABC, modifikasi lingkungan, & regulasi amarah tanpa kekerasan fisik."]
            IP_M3["3. KEADILAN RESTORATIF ISHLAH 4R (Restorative Reconciliation)<br/>Konsekuensi logis 4R, Lingkaran Ishlah, & pemulihan hak korban."]
            IP_M4["4. PERLINDUNGAN SIBER & CLEAN SLATE (Safeguarding & Reintegration)<br/>Kotak Tabayyun rahasia, Tim CRA, & pemutihan rekam jejak tanpa stigma."]
        end
        
        subgraph ManifestasiPraksisTataKelolaIntervene["MANIFESTASI PRAKSIS INTERVENSI RESTORATIF 24 JAM"]
            M1_IP["• Program CICO Harian (Subuh, Siang, Malam) & Ruang Tenang Asrama."]
            M2_IP["• Tim Crisis Response Asrama (CRA) & Kanal Tabayyun Digital."]
            M3_IP["• Konferensi Lingkaran Ishlah & Upacara Penerimaan Kembali Komunal."]
        end
        
        EmpatPilarKonseptualMasterIntervene <===> ManifestasiPraksisTataKelolaIntervene
    end
```
...
```mermaid
flowchart TD
    subgraph PenjalaranInterventionKeImplementation["PENJALARAN DARI INTERVENSI KE STANDARISASI IMPLEMENTASI"]
        InterveneMaster["P2-06: INTERVENTION PRINCIPLES (Manajemen Krisis & Bimbingan Restoratif)"]
        
        InterveneMaster ==> P2_07_01["P2-07-01: Arsitektur Ekosistem Pengasuhan 24 Jam"]
        InterveneMaster ==> P2_07_02["P2-07-02: Standarisasi Kompetensi & Beban Kerja Musyrif"]
        InterveneMaster ==> P2_07_03["P2-07-03: Tata Kelola SOP & Manajemen Krisis Lembaga"]
        InterveneMaster ==> P2_07_04["P2-07-04: Manajemen Perubahan & Skalabilitas Institusi"]
        InterveneMaster ==> P2_07_05["P2-07-05: Sintesis Implementation Principles & Grand Ekosistem"]
    end
```
