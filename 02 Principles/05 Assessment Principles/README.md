...
```mermaid
graph TD
    Assessment["SUB-DOMAIN 05: ASSESSMENT PRINCIPLES (PRINSIP ASESMEN - 6 MONOGRAF)"]
    
    Assessment --> Master["P2-05: Assessment Principles TUMBUH Master (Monograf Induk Sub-Domain 05)"]
    Assessment --> M1["P2-05-01: Prinsip Asesmen Autentik & Observasi Alami (Wiggins & McTighe, 3 Lokus 24 Jam)"]
    Assessment --> M2["P2-05-02: Prinsip Rubrik Perilaku Objektif BARS (Smith & Kendall, Kappa >= 0.80)"]
    Assessment --> M3["P2-05-03: Prinsip Triangulasi Data Multi-Sumber (Tabayyun 360: Musyrif, Guru, Self, & Peer)"]
    Assessment --> M4["P2-05-04: Prinsip Portofolio Pertumbuhan Formatif (Laporan Naratif & Student-Led Conferences)"]
    Assessment --> M5["P2-05-05: Prinsip Feedback Konstruktif & Muhasabah (Feed-Up/Back/Forward & Zero Shaming)"]
    Assessment --> M6["P2-05-06: Sintesis Assessment Principles TUMBUH (Grand Charter Keadilan Asesmen)"]
```
