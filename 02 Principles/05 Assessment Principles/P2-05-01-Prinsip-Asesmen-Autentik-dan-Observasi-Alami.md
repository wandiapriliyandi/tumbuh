...
- [BAGIAN II: KODIFIKASI BAKU HASIL RISET & KESIMPULAN FORMAL](#bagian-ii-kodifikasi-baku-hasil-riset--kesimpulan-formal)
  - [1. Deklarasi Doktrin Baku: Prinsip Asesmen Autentik dan Observasi Alami Pesantren TUMBUH](#1-deklarasi-doktrin-baku-prinsip-asesmen-autentik-dan-observasi-alami-pesantren-tumbuh)
...
```mermaid
flowchart TD
    subgraph TransformasiEvaluasiAkhlak["TRANSFORMASI ASESMEN ADAB SANTRI"]
        KertasKering["ASESMEN KERTAS FORMAL (LAMA)<br/>• Ujian pilihan ganda adab di atas kertas meja ujian.<br/>• Hanya mengukur hafalan teks; kepatuhan semu sesaat.<br/>• Melahirkan santri munafik (tahu teori tapi nihil adab)."]
        
        AutentikTUMBUH["ASESMEN AUTENTIK OBSERVASI ALAMI (TUMBUH)<br/>• Pengamatan perilaku nyata di 3 lokus asrama 24 jam.<br/>• Menilai Malakah (tindakan spontan tanpa kepura-puraan).<br/>• Melahirkan Insan Adabi dengan integritas lahir-batin."]
        
        KertasKering ==>|TRANSFORMASI ASESMEN AUTENTIK| AutentikTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Asesmen Formal (Pihak A):<br/>'Cukup nilai akhlak santri dari lembar ujian tertulis dan keaktifannya menjawab pertanyaan guru di kelas!'"]
    --> B1["Tinjauan Ihya 'Ulumiddin Imam Al-Ghazali:<br/>Definisi Khuluq sebagai Malakah (kondisi batin yang melahirkan perbuatan spontan tanpa perlu berpikir panjang)."]
    A --> B2["Tinjauan Atsar Sayyidina Umar bin Khattab RA (Riwayat Al-Baihaqi):<br/>Penolakan rekomendasi orang yang hanya terlihat khusyuk shalat; wajib diuji lewat Uang, Safar, & Tetangga."]
    A --> B3["Tinjauan Kaidah Fiqhiyyah:<br/>'Al-Hukmu bil-Af'ali la bil-Aqwali' (Penilaian hakiki didasarkan pada perbuatan nyata, bukan sekadar ucapan lisan)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Karakter adab hanya dapat dinilai secara shahih melalui observasi tindakan nyata dalam kehidupan sehari-hari."]
```
...
```mermaid
graph TD
    subgraph KonvergensiWigginsCairns["SINTESIS ASESMEN AUTENTIK DI ASRAMA"]
        Wiggins["AUTHENTIC ASSESSMENT (GRANT WIGGINS & JAY MCTIGHE):<br/>• Menguji kompetensi dalam konteks dunia nyata yang bermakna.<br/>• Menilai unjuk kerja langsung, bukan sekadar tes proksi kertas.<br/>• Kriteria keberhasilan transparan & berbasis bukti otentik."]
        
        Cairns["IN-VIVO NATURALISTIC OBSERVATION (ROBERT B. CAIRNS):<br/>• Pengamatan perilaku manusia dalam ekologi aslinya 24 jam.<br/>• Menghilangkan rekayasa laboratorium yang kaku.<br/>• Menangkap dinamika sosial spontan tanpa bias manipulasi."]
...
```mermaid
graph TD
    subgraph TigaLokusObservasiAsrama["3 LOKUS OBSERVASI PERILAKU ADAB NYATA (24 JAM)"]
        Lokus1["1. LOKUS IBADAH & SAKRAL (Masjid, Tempat Wudhu, Shalat)<br/>• Kerapian menata sandal di batas suci (Adab Thaharah).<br/>• Tertib antre air wudhu tanpa mencipratkan air.<br/>• Kekhusyukan zikir & ketenangan menyimak khutbah."]
        
        Lokus2["2. LOKUS KOMUNAL ASRAMA (Kamar Tidur, Meja Makan, Jemuran)<br/>• Inisiatif merapikan kasur & lemari baju sendiri.<br/>• Berbagi lauk makan nampan dengan mendahulukan teman.<br/>• Tanggung jawab menuntaskan tugas piket kebersihan kamar."]
        
        Lokus3["3. LOKUS SOSIAL & AKADEMIK (Kelas, Lapangan Olahraga, Kantin)<br/>• Kejujuran dalam ujian & kesantunan bertutur kata kepada guru.<br/>• Sportivitas saat bertanding futsal & menolong lawan yang jatuh.<br/>• Perlindungan kepada adik kelas (Zero Bullying)."]
        
        Lokus1 --- Lokus2 --- Lokus3
    end
```
...
```mermaid
graph LR
    subgraph MitigasiEfekHawthorne["MITIGASI EFEK HAWTHORNE (PENGAMATAN BERETIKA)"]
        Salah["OBSERVASI INTIMIDATIF (KELIRU):<br/>• Musyrif berdiri membawa clipboard di depan pintu kamar.<br/>• Santri merasa dimata-matai; bersikap manis palsu.<br/>• Memicu kepatuhan semu (Efek Hawthorne)."]
        
        Benar["OBSERVASI PARTICIPATORY ALAMI (TUMBUH):<br/>• Musyrif ikut makan bersama & membersihkan masjid.<br/>• Pengamatan mengalir alami dalam interaksi keakraban.<br/>• Pencatatan logbook digital dilakukan pasca-interaksi."]
        
        Salah -.->|TRANSFORMASI OBSERVASI EMPATIK| Benar
    end
```
...
### 1. Deklarasi Doktrin Baku: Prinsip Asesmen Autentik dan Observasi Alami Pesantren TUMBUH

```
===================================================================================================
             PIAGAM DOKTRIN BAKU ASESMEN AUTENTIK DAN OBSERVASI ALAMI PESANTREN
                          SUB-DOMAIN 05: ASSESSMENT PRINCIPLES — EKOSISTEM TUMBUH
===================================================================================================

BISMILLAHIRRAHMANIRRAHIM. DENGAN MENEGAKKAN KEADILAN TIMBANGAN MIZAN DAN SUNNAH TABAYYUN NABAWIYYAH,
EKOSISTEM PENDIDIKAN PESANTREN TUMBUH DENGAN INI MENETAPKAN DOKTRIN BAKU PENGUKURAN KARAKTER:

1. DOKTRIN ASESMEN BERBASIS UNJUK KERJA ADAB NYATA (AUTHENTIC ADAB PERFORMANCE):
   Menolak segala bentuk evaluasi akhlak semata-mata berbasis ujian kertas pilihan ganda.
   Karakter santri dinilai dari internalisasi adab nyata (Malakah) yang termanifestasi dalam rutinitas 24 jam.

2. PENETAPAN TIGA LOKUS UTAMA OBSERVASI ALAMI DI PESANTREN:
   Pengamatan perilaku difokuskan secara proporsional pada 3 lokus ekologis: Lokus Ibadah (Masjid/Wudhu),
   Lokus Komunal Asrama (Kamar/Meja Makan/Piket), dan Lokus Sosial-Akademik (Madrasah/Lapangan Olahraga).

3. PENERAPAN OBSERVASI ALAMI BERETIKA (ETHICAL UNOBTRUSIVE OBSERVATION):
   Musyrif wajib melakukan pengamatan secara natural, bersahabat, dan menyatu dalam dinamika santri,
   mengharamkan pengawasan intimidatif yang memicu kepatuhan semu sesaat (Efek Hawthorne).

4. KEWAJIBAN PENCATATAN BERBASIS DATA REAL-TIME LOGBOOK PBIS:
   Menghapus penilaian kepribadian berbasis asumsi ingatan akhir semester. Mewajibkan pencatatan bukti
   perilaku positif harian dalam sistem logbook digital PBIS guna menjamin objektivitas dan keadilan data.
===================================================================================================
```
...
| :--- | :--- | :--- | :--- |
| **1. Lokus Ibadah & Sakral** | Waktu Subuh, Maghrib, Isya, dan Halaqah Qur'an di Masjid. | • Menata sandal menghadap keluar di batas suci secara rapi.<br/>• Mengantre tempat wudhu dengan tenang dan hemat air.<br/>• Khusyuk tilawah Qur'an dan tidak bercanda saat adzan. | *Fast-Tap Logging* di Logbook Digital Musyrif pasca jamaah masjid.[^10] |
| **2. Lokus Komunal Asrama** | Kehidupan kamar tidur, makan nampan bersama, piket lorong. | • Merapikan sprei kasur & melipat selimut tanpa disuruh.<br/>• Mendahulukan teman mengambil lauk makan nampan.<br/>• Menuntaskan giliran menyapu kamar & membuang sampah. | *Room Inspection Checklist* saat apel pagi & pemantauan makan malam. |
| **3. Lokus Sosial & Akademik** | Kelas madrasah, lapangan olahraga sore, antrean kantin. | • Bertutur kata santun (*Nir-Kekerasan Verbal*) kepada kawan.<br/>• Sportivitas saat bertanding futsal & membantu kawan jatuh.<br/>• Menjaga adab terhadap asatidz & menyapa ramah tamu pondok. | *Teacher Formative Incident Log* & pengamatan pembina olahraga. |
...
```mermaid
flowchart TD
    Obs1["1. KEHADIRAN AKTIF YANG MENYATU (PARTICIPATORY PRESENCE)<br/>Musyrif duduk bersama santri saat makan, menyapa ramah di lorong, & ikut olahraga."]
    
    Obs2["2. OBSERVASI DISKRET TANPA GANGGUAN (UNOBTRUSIVE MONITORING)<br/>Musyrif menyimak interaksi sosial spontan santri tanpa memegang buku catatan besar."]
    
    Obs3["3. PENCATATAN DIGITAL SEGERA SETELAH INTERAKSI (LOGGING WITHIN 30 MIN)<br/>Musyrif membuka smartphone dan mencatat apresiasi perilaku santri di aplikasi PBIS."]
    
    Obs4["4. UMPAN BALIK APRESIATIF LANGSUNG (IMMEDIATE POSITIVE FEEDBACK)<br/>Musyrif menepuk pundak santri: 'Ustadz senang melihat caramu berbagi lauk tadi malam'."]
...
```mermaid
graph LR
    subgraph AlurDataAsesmenPBISTUMBUH["ALUR INTEGRASI DATA OBSERVASI AUTENTIK PBIS"]
        Input1["Observasi Musyrif Asrama (Kamar & Masjid)"] --> Engine["DASHBOARD LOGBOOK PBIS DIGITAL TUMBUH"]
        Input2["Observasi Guru Madrasah (Kelas & Lab)"] --> Engine
        Input3["Catatan Refleksi Diri Santri (Jurnal Malam)"] --> Engine
        
        Engine --> Output1["1. Grafik Tren Adab Santri Real-Time"]
        Engine --> Output2["2. Deteksi Dini Kebutuhan Intervensi Tier 2"]
        Engine --> Output3["3. Portofolio Laporan Naratif Orang Tua"]
    end
```
