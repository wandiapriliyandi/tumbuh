...
```mermaid
flowchart TD
    subgraph TransformasiAsesmenKarakter["TRANSFORMASI ASESMEN ADAB & KARAKTER"]
        PolaKertasLama["UJIAN KERTAS PILIHAN GANDA (LAMA)<br/>• Hafalan teori adab di atas kertas.<br/>• Nilai rapor 100 tapi perilaku asrama kasar.<br/>• Melahirkan kepalsuan perilaku (kemunafikan)."]
        
        PolaAutentikTUMBUH["ASESMEN AUTENTIK & OBSERVASI ALAMI (TUMBUH)<br/>• Menguji Malakah spontan (Al-Ghazali & Sayyidina Umar).<br/>• Observasi 3 lokus nyata: Ibadah, Komunal, & Sosial.<br/>• Etis bebas Hawthorne Effect & tanpa tajassus."]
        
        PolaKertasLama ==>|DIREKONSTRUKSI MENJADI| PolaAutentikTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturAsesmenAutentikTUMBUH["ARSITEKTUR ASESMEN AUTENTIK & OBSERVASI ALAMI"]
        
        O1_Sayap["1. OBSERVASI 3 LOKUS ALAMI (Naturalistic Multi-Loci Observation)<br/>Pengamatan adab spontan di lokus ibadah, komunal asrama, & interaksi sosial."]
        
        O2_Sayap["2. ETIKA OBSERVASI BEBAS HAWTHORNE (Ethical Unobtrusive Observation)<br/>Pengamatan wajar tanpa intimidasi, bebas tajassus, & perlindungan satrul 'aurah."]
        
        O3_Sayap["3. INTEGRASI LOGBOOK DIGITAL PBIS (Real-Time PBIS Logging)<br/>Pencatatan cepat apresiasi 4:1 & insiden perilaku dalam dashboard digital musyrif."]
        
        O1_Sayap <===> O2_Sayap <===> O3_Sayap
    end
```
...
```mermaid
flowchart LR
    subgraph AlurLoggingObservasi["ALUR LOGBOOK OBSERVASI DIGITAL PBIS"]
        PengamatanAlami["1. Pengamatan Adab Spontan di Lokus Asrama"]
        --> InputApresiasi["2. Input Fast-Tap Apresiasi 4:1 di Aplikasi (<30s)"]
        --> AgregasiData["3. Agregasi Dashboard Analitik Pertumbuhan Santri"]
        --> UmpanBalik["4. Umpan Balik Formatif Refleksi Santri Mingguan"]
    end
```
