...
```mermaid
flowchart TD
    subgraph ModelFeedbackReflektifTUMBUH["MODEL UMPAN BALIK REFLEKTIF BERADAB TUMBUH"]
        Observasi["1. OBSERVASI PERILAKU OBJEKTIF & LOGBOOK PBIS<br/>Musyrif mencatat data faktual tanpa prasangka buruk (Su'uzhan)."]
        
        SesiPrivat["2. SESI DIALOG EMPAT MATA (KHULAWIYYAH AMAN):<br/>• Menasihati secara rahasia (Nasihat Imam Syafi'i).<br/>• Feed-Up, Feed-Back, & Feed-Forward."]
        
        Muhasabah["3. REFLEKSI DIRI SANTRI (SELF-ASSESSMENT):<br/>Santri mengevaluasi niat dan tindakannya lewat Jurnal Muhasabah."]
        
        AksiNyata["4. RENCANA AKSI PERBAIKAN KONKRET & APRESIASI:<br/>Santri berkomitmen memperbaiki adab; musyrif memantau dengan doa."]
        
        Observasi ==> SesiPrivat ==> Muhasabah ==> AksiNyata
    end
```
...
```mermaid
graph TD
    A["Gugatan Asesmen Punitif (Pihak A):<br/>'Santri yang melanggar adab harus diumumkan namanya di depan masjid biar kapok dan malu!'"]
    --> B1["Tinjauan Hadits Shahih Muslim No. 55:<br/>'Ad-Dinu an-Nashihatu' (Agama Islam ini adalah nasihat yang tulus dan memurnikan niat)."]
    A --> B2["Tinjauan Sya'ir Adab Imam Asy-Syafi'i:<br/>'Ta'ammadni bi nush-hika fil infiradi, wa jannibni an-nasiihata fil jamaa'ah' (Nasihatilah aku saat bersendirian secara empat mata, dan jauhkan aku dari menasihati di hadapan khalayak umum karena itu bentuk penghinaan)."]
    A --> B3["Tinjauan Sunnah Menutup Aib Muslim (HR. Muslim No. 2699):<br/>'Man satara musliman satarahullahu fiddunya wal akhirah' (Barangsiapa menutupi aib seorang muslim, Allah tutupi aibnya di dunia dan akhirat)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Asesmen dan evaluasi santri wajib dijalankan secara privat, santun, dan memuliakan martabat."]
```
...
```mermaid
flowchart TD
    subgraph SOPDialogAsesmenReflektif["SOP SESI DIALOG ASESMEN REFLEKTIF ASRAMA"]
        UndanganHangat["1. UNDANGAN PRIVAT HANGAT OLEH MUSYRIF<br/>Musyrif mengundang santri ke ruang konseling asrama dengan ramah."]
        
        ApresiasiAwal["2. APRESIASI KEMAJUAN & REVIEW JURNAL MUHASABAH<br/>Musyrif membuka sesi dengan memuji ikhtiar positif santri selama 2 pekan."]
        
        EksplorasiReflektif["3. DIALOG FEED-BACK & FEED-FORWARD DUA ARAH<br/>Membahas area yang perlu diperbaiki berdasarkan data logbook PBIS & solusi santri."]
        
        PaktaKomitmen["4. PENETAPAN TARGET MIKRO & DOA PENUTUP BERSAMA<br/>Menyepakati 1 target adab prioritas untuk 2 pekan ke depan diakhiri doa tulus."]
        
        UndanganHangat --> ApresiasiAwal --> EksplorasiReflektif --> PaktaKomitmen
    end
```
