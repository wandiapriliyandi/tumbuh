...
```mermaid
flowchart TD
    subgraph TransformasiPolaUmpanBalik["TRANSFORMASI POLA UMPAN BALIK EVALUASI"]
        PolaShamingLama["PUBLIC SHAMING & CELAAN (LAMA)<br/>• Pelanggaran diumumkan di mikrofon/papan aib.<br/>• Memicu rasa malu beracun (Toxic Shame).<br/>• Melahirkan pemberontakan bawah tanah."]
        
        PolaFeedbackTUMBUH["FEEDBACK KONSTRUKTIF & DIALOG PRIVAT (TUMBUH)<br/>• Nasihat Sirriyyah Imam Syafi'i (Dialog 4 Mata).<br/>• Feed-Up, Feed-Back, & Feed-Forward (Hattie).<br/>• Jurnal Muhasabah Diri Malam 10 Menit."]
        
        PolaShamingLama ==>|DIREKONSTRUKSI MENJADI| PolaFeedbackTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturFeedbackTUMBUH["ARSITEKTUR UMPAN BALIK KONSTRUKTIF TUMBUH"]
        
        F1_Sayap["1. MODEL 3F HATTIE-TIMPERLEY (Feed-Up, Feed-Back, Feed-Forward)<br/>Kejelasan target adab, deskripsi data faktual PBIS, & rencana perbaikan konkret."]
        
        F2_Sayap["2. DIALOG EMPAT MATA SIRRIYYAH (Private Empathetic Dialogue)<br/>Nasihat rahasia empat mata, zero public shaming, & perlindungan martabat santri."]
        
        F3_Sayap["3. HABITUASI MUHASABAH MANDIRI (Autonomous Self-Assessment)<br/>Jurnal muhasabah malam 10 menit menumbuhkan muraqabatullah internal seumur hidup."]
        
        F1_Sayap <===> F2_Sayap <===> F3_Sayap
    end
```
...
```mermaid
flowchart TD
    subgraph SOPDialogAsesmenReflektif["SOP SESI DIALOG ASESMEN DWI-MINGGUAN (15 MENIT)"]
        PersiapanData["1. PERSIAPAN DATA (3 Menit): Musyrif Menelaah Logbook PBIS & Jurnal Muhasabah Santri"]
        --> ApresiasiPencapaian["2. APRESIASI TULUS (4 Menit): Membuka Sesi dengan Mengakui 2 Keberhasilan Adab Santri"]
        --> EksplorasiAkarMasalah["3. EKSPLORASI REFLEKTIF (5 Menit): Berdialog Dua Arah Membedah Tantangan Santri Tanpa Marah"]
        --> KesepakatanFeedForward["4. KESEPAKATAN FEED-FORWARD (3 Menit): Santri Menuliskan 1 Target Perbaikan untuk 2 Pekan Depan"]
    end
```
