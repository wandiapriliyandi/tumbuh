...
```mermaid
flowchart TD
    subgraph PosisiAssessmentPrinciplesTUMBUH["POSISI SUB-DOMAIN 05 ASSESSMENT PRINCIPLES"]
        D2_04["02.04 DEVELOPMENT PRINCIPLES<br/>(Neurosains Remaja, In Loco Parentis, Tangga J1–J4, CASEL SEL, Identitas, Grit)"]
        ==> D2_05["02.05 ASSESSMENT PRINCIPLES<br/>(Asesmen Autentik, Rubrik BARS, Triangulasi 360, Portofolio Formatif, Feedback 3F)"]
        
        D2_05 ==> D2_06["02.06 INTERVENTION PRINCIPLES<br/>(Intervensi Multi-Tier PBIS, CICO Mentoring, De-Eskalasi, & Restorative Care)"]
        D2_05 ==> D2_07["02.07 IMPLEMENTATION PRINCIPLES"]
    end
```
...
```mermaid
flowchart TD
    subgraph MasterArsitekturAssessmentPrinciplesTUMBUH["MASTER ARSITEKTUR ASSESSMENT PRINCIPLES TUMBUH"]
        
        subgraph EmpatPilarKonseptualMasterAssess["EMPAT PILAR KONSEPTUAL ASESMEN"]
            AP_M1["1. VALIDITAS AUTENTIK 3 LOKUS (Ecological Validity & Malakah)<br/>Uji tindakan nyata di lokus ibadah, komunal, & sosial 24 jam bebas efek Hawthorne."]
            AP_M2["2. NERACA BARS & RELIABILITAS TINGGI (Objective Measurement)<br/>Jangkar perilaku konkret 4 level; kalibrasi bulanan Cohen's Kappa > 0.80."]
            AP_M3["3. TRIANGULASI 360 & TABAYYUN (Multi-Source Triangulation)<br/>Integrasi 4 lensa (Musyrif, Guru, Self, Peer); Sidang Tabayyun diskrepansi data."]
            AP_M4["4. PORTOFOLIO NARATIF & FEEDBACK 3F (Formative Empowerment)<br/>Laporan naratif 3 pilar, Student-Led Conferences, & dialog empat mata sirriyyah."]
        end
        
        subgraph ManifestasiPraksisTataKelolaAssess["MANIFESTASI PRAKSIS EVALUASI KARAKTER 24 JAM"]
            M1_AP["• Logbook Digital Fast-Tap Musyrif & Kartu Apresiasi Ukhuwah."]
            M2_AP["• Dashboard Analitik Pertumbuhan PBIS & Sidang Tabayyun Bulanan."]
            M3_AP["• Sesi Student-Led Conferences & Jurnal Muhasabah Malam 10m."]
        end
        
        EmpatPilarKonseptualMasterAssess <===> ManifestasiPraksisTataKelolaAssess
    end
```
...
```mermaid
flowchart TD
    subgraph PenjalaranAssessmentKeIntervention["PENJALARAN DARI ASESMEN KE INTERVENSI MULTI-TIER"]
        AssessMaster["P2-05: ASSESSMENT PRINCIPLES (Psikometri Karakter & Evaluasi Berkeadilan)"]
        
        AssessMaster ==> P2_06_01["P2-06-01: Arsitektur Intervensi Multi-Tier SW-PBIS"]
        AssessMaster ==> P2_06_02["P2-06-02: Protokol Mentoring CICO Tier 2"]
        AssessMaster ==> P2_06_03["P2-06-03: Functional Behavior Assessment (FBA)"]
        AssessMaster ==> P2_06_04["P2-06-04: Restorative Justice & Pemulihan Ukhuwah (Ishlah)"]
        AssessMaster ==> P2_06_05["P2-06-05: Sintesis Intervention Principles & Grand Intervensi"]
    end
```
...
Penerapan konsep **P2-05: ASSESSMENT PRINCIPLES (PRINSIP ASESMEN KARAKTER) EKOSISTEM TUMBUH (MASTER DOKTRIN EVALUASI ADAB BERKEADILAN)** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
