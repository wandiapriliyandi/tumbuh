...
```mermaid
flowchart TD
    subgraph TransformasiPelaporanKarakter["TRANSFORMASI SISTEM PELAPORAN ADAB SANTRI"]
        RaporKering["RAPOR HURUF KERING (LAMA)<br/>• Huruf 'C' atau angka '65' tanpa penjelasan kontekstual.<br/>• Memicu kemarahan orang tua, rasa malu santri, & keputusasaan.<br/>• Tidak memberikan panduan perbaikan konkret."]
        
        PortofolioTUMBUH["PORTOFOLIO PERTUMBUHAN NARATIF (TUMBUH)<br/>• Narasi deskriptif 3 pilar (Kekuatan, Proses, & Kemitraan).<br/>• Visualisasi grafik tren logbook PBIS & portofolio karya adab.<br/>• Student-Led Conference memuliakan martabat santri & orang tua."]
        
        RaporKering ==>|TRANSFORMASI PELAPORAN BERADAB| PortofolioTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Keringkasan Rapor (Pihak A):<br/>'Cukup tulis huruf A, B, C saja di rapor biar praktis; guru tidak punya waktu menulis narasi panjang untuk ratusan santri!'"]
    --> B1["Tinjauan Al-Qur'an Surah Al-Kahfi: 49:<br/>Karakter Kitab Catatan Amal Ilahi: 'La yughadiru shaghiratan wala kabiratan illa ahshaha' (Mencatat detail tanpa menzalimi hal kecil maupun besar)."]
    A --> B2["Tinjauan Al-Qur'an Surah Al-Zalzalah: 7–8:<br/>Keadilan penyajian setiap zarrah kebaikan dan keburukan secara transparan."]
    A --> B3["Tinjauan Hadits Nabi SAW (HR. Bukhari 69):<br/>'Yassiru wala tu'assiru, wa basysyiru wala tunaffiru' (Mudahkanlah dan jangan persulit, gembirakanlah dan jangan membuat lari/putus asa)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Pelaporan perkembangan santri wajib bersifat rinci, transparan, mendidik, & membangkitkan optimisme (Tabsyir)."]
```
...
```mermaid
graph TD
    subgraph ArsitekturPortofolioDigitalPBIS["KOMPONEN PORTOFOLIO PERTUMBUHAN FORMATIF DIGITAL"]
        Grafik["1. VISUALISASI GRAFIK TREN ADAB PBIS<br/>Grafik garis 180 hari yang menunjukkan peningkatan frekuensi perilaku positif santri."]
        
        Artefak["2. ARTEFAK KARYA OTENTIK SANTRI<br/>Koleksi rekaman tasmi' Al-Qur'an, tulisan Bahsul Masail, & karya khidmah asrama."]
        
        Refleksi["3. LEMBAR REFLEKSI DIRI SANTRI (MUHASABAH)<br/>Esai reflektif santri tentang pembelajaran adab paling berharga semester ini."]
        
        NarasiGuru["4. LAPORAN NARATIF DESKRIPTIF ASATIDZ & MUSYRIF<br/>Sintesis apresiatif yang memandu peta jalan perbaikan semester depan."]
        
        Grafik --- Artefak --- Refleksi --- NarasiGuru
    end
```
...
```mermaid
graph TD
    subgraph TigaPilarLaporanNaratifTUMBUH["STRUKTUR 3 PILAR LAPORAN NARATIF BERADAB"]
        Pilar1["PILAR 1: APRESIASI KEKUATAN NYATA (STRENGTH-BASED APPRECIATION)<br/>Membuka laporan dengan menyebutkan 2–3 perilaku adab luhur yang konsisten."]
        
        Pilar2["PILAR 2: AREA YANG SEDANG BERPROSES (AREAS OF ACTIVE GROWTH)<br/>Menjelaskan tantangan adab yang sedang dibimbing tanpa menggunakan label negatif."]
        
        Pilar3["PILAR 3: REKOMENDASI KEMITRAAN RUMAH (COLLABORATIVE HOME PLAN)<br/>Menyajikan langkah konkret yang dapat dilakukan orang tua saat masa liburan."]
...
```mermaid
flowchart TD
    subgraph AlurStudentLedConferences["ALUR KONFERENSI PORTOFOLIO YANG DIPIMPIN SANTRI (30 MENIT)"]
        Fase1["1. PEMBUKAAN OLEH SANTRI (5 Menit)<br/>Santri menyambut orang tuanya, membacakan tilawah Qur'an, & menata meja presentasi."]
        
        Fase2["2. PRESENTASI PORTOFOLIO OLEH SANTRI (15 Menit)<br/>Santri memaparkan grafik adabnya, memamerkan karya terbaik, & mengakui hal yang perlu diperbaiki."]
        
        Fase3["3. TANGGAPAN AFIRMATIF ORANG TUA & DUKUNGAN GURU (7 Menit)<br/>Orang tua memberikan pelukan & apresiasi; Guru/Musyrif memperkuat poin kemajuan."]
        
        Fase4["4. PENANDATANGANAN IKRAR TARGET BERSAMA SEMESTER DEPAN (3 Menit)<br/>Santri, Orang Tua, dan Musyrif menandatangani Piagam Komitmen Adab Bersama."]
...
```mermaid
flowchart TD
    SOP1["1. PERSIAPAN DIRI SANTRI (1 PEKAN SEBELUM RAPOR)<br/>Santri memilih 3 artefak terbaik & menyusun lembar refleksi portofolio."]
    
    SOP2["2. SIMULASI PRESENTASI DI HALAQAH KAMAR<br/>Santri berlatih mempresentasikan portofolio di hadapan musyrif & teman sekamar."]
    
    SOP3["3. PELAKSANAAN KONFERENSI 3 PIHAK DI AULA MADRASAH (30 MENIT)<br/>Santri memimpin pemaparan di hadapan orang tua; Musyrif mendampingi suportif."]
    
    SOP4["4. REFLEKSI PENUTUP & DOA KEBERKAHAN KELUARGA<br/>Orang tua memberikan doa restu & keluarga pulang dengan kebahagiaan hati."]
