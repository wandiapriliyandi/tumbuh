...
```mermaid
flowchart TD
    subgraph TransformasiPelaporanKarakter["TRANSFORMASI PELAPORAN ADAB & KARAKTER"]
        PolaHurufLama["VONIS HURUF KERING (LAMA)<br/>• Huruf 'Akhlak: C' tanpa penjelasan narasi.<br/>• Mempermalukan santri & memicu kemarahan wali.<br/>• Hubungan pesantren-keluarga defensif tegang."]
        
        PolaPortofolioTUMBUH["PORTOFOLIO FORMATIF & NARATIF (TUMBUH)<br/>• Laporan Naratif 3 Bagian: Kekuatan, Proses, & Mitra.<br/>• Visualisasi Analitik Tren Logbook PBIS.<br/>• Student-Led Conference: Santri presentasi mandiri."]
        
        PolaHurufLama ==>|DIREKONSTRUKSI MENJADI| PolaPortofolioTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturPortofolioTUMBUH["ARSITEKTUR PORTOFOLIO PERTUMBUHAN FORMATIF"]
        
        P1_Sayap["1. DOKUMENTASI ARTEFAK DIGITAL (Digital E-Portfolio Architecture)<br/>Rekam jejak jurnal muhasabah, setoran tahfizh, karya khidmah, & refleksi diri."]
        
        P2_Sayap["2. LAPORAN NARATIF 3 PILAR (Narrative Progress Reporting)<br/>Apresiasi kekuatan fitrah, area proses pendampingan, & panduan kemitraan rumah."]
        
        P3_Sayap["3. STUDENT-LED CONFERENCES (Student Agency Empowerment)<br/>Santri mempresentasikan portofolionya sendiri kepada orang tua & asatidz."]
        
        P1_Sayap <===> P2_Sayap <===> P3_Sayap
    end
```
...
```mermaid
flowchart TD
    subgraph SOPStudentLedConference["SOP STUDENT-LED CONFERENCES (SLC)"]
        PembukaanHalaqah["1. PEMBUKAAN: Orang Tua Duduk Bersama Santri & Musyrif di Meja Halaqah Khusus"]
        --> PresentasiSantri["2. PRESENTASI SANTRI (15 Menit): Santri Membuka Portofolio & Menceritakan Capaian serta Perjuangannya"]
        --> ApresiasiDialogWali["3. DIALOG APRESIATIF WALI: Orang Tua Memberikan Pelukan, Pujian Usaha, & Menanyakan Rencana Esok"]
        --> PenandatangananKomitmen["4. KOMITMEN TIGA PIHAK: Santri, Wali, & Musyrif Menandatangani Rencana Aksi Kemitraan Semester Depan"]
    end
```
