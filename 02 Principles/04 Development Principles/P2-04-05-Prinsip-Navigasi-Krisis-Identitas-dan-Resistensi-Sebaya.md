...
```mermaid
flowchart TD
    subgraph TransformasiDinamikaSebaya["TRANSFORMASI PEMBINAAN IDENTITAS & SEBAYA"]
        PolaGengLama["POLARISASI GENG EKSKLUSIF & HAZING (LAMA)<br/>• Geng kedaerahan & feodalisme senioritas.<br/>• Melanggar aturan demi pengakuan status geng.<br/>• Perundungan junior di sudut gelap asrama."]
        
        PolaUkhuwahTUMBUH["IDENTITAS INSAN ADABI & UKHUWAH (TUMBUH)<br/>• Bimbingan 4 Status Identitas Erikson & Marcia.<br/>• Kanalisasi energi ke dakwah, karya, & khidmah.<br/>• Brotherhood Circle: Asrama inklusif tanpa sekat daerah."]
        
        PolaGengLama ==>|DIREKONSTRUKSI MENJADI| PolaUkhuwahTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturIdentitasTUMBUH["ARSITEKTUR PEMBINAAN IDENTITAS & UKHUWAH TUMBUH"]
        
        H1_Sayap["1. PENDAMPINGAN MORATORIUM POSITIF (Identity Scaffolding)<br/>Ruang eksplorasi bakat, dialog kritis mencari kebenaran, & role model asatidz."]
        
        H2_Sayap["2. DEKONSTRUKSI GENG & ERADIKASI PRIMORDIALISME (Anti-'Ashabiyyah)<br/>Penataan kamar multikultural & pembubaran kelompok eksklusif tanpa kekerasan."]
        
        H3_Sayap["3. KANALISASI AKTUALISASI DIRI (Positive Self-Actualization)<br/>Pemberdayaan organisasi dakwah, riset sains, seni hadrah, & olahraga sunnah."]
        
        H1_Sayap <===> H2_Sayap <===> H3_Sayap
    end
```
...
```mermaid
flowchart TD
    subgraph SOPPembubaranGengAsrama["SOP PENCEGAHAN & PEMBUBARAN GENG EKSKLUSIF"]
        DeteksiDini["1. DETEKSI DINI: Pemetaan Sosiometri Asrama untuk Menemukan Indikasi Kelompok Eksklusif Tertutup"]
        --> DialogTokohKunci["2. DIALOG RESPECTFUL: Musyrif Mengajak Dialog Tokoh Kunci Geng Tanpa Menghakimi"]
        --> RestrukturisasiAmanah["3. RESTRUKTURISASI AMANAH: Menyalurkan Potensi Pengaruh Tokoh ke Dalam Kepanitiaan Resmi Pondok"]
        --> PembiasaanMultikultural["4. HABITUASI UKHUWAH: Rotasi Kamar Campuran Lintas Daerah & Program Ta'aruf Asrama"]
    end
```
