...
```mermaid
flowchart TD
    subgraph TransformasiKarakterSEL["TRANSFORMASI PEMBINAAN ADAB & KECERDASAN EMOSI"]
        PolaKeringLama["FORMALISME MORALITAS KERING (LAMA)<br/>• Adab sebatas materi hafalan ujian kertas.<br/>• Santri pintar tapi mudah meledak emosi & bully.<br/>• Konflik diselesaikan lewat pemukulan fisik."]
        
        PolaSELTUMBUH["INTEGRASI CASEL SEL & TAZKIYATUN NAFS (TUMBUH)<br/>• 5 Kompetensi CASEL diselaraskan maqashid syar'i.<br/>• Latihan regulasi emosi, empati ukhuwah, & ishlah.<br/>• Mediasi Lingkaran Restoratif 4 langkah."]
        
        PolaKeringLama ==>|DIREKONSTRUKSI MENJADI| PolaSELTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturSEL_TUMBUH["LIMA PILAR INTEGRASI CASEL SEL & ADAB ISLAMI TUMBUH"]
        
        K1["1. KESADARAN DIRI & MURAQABAH (Self-Awareness)<br/>Mengenali emosi hati, menyadari kelemahan diri, & muraqabatullah 24 jam."]
        
        K2["2. KENDALI DIRI & MUJAHADAH (Self-Management)<br/>Regulasi amarah (sabar), kendali hawa nafsu, & istiqamah belajar mandiri."]
        
        K3["3. EMPATI SOSIAL & UKHUWAH (Social Awareness)<br/>Husnuzhan, peka kesulitan teman sekamar, & menolak perundungan."]
        
        K4["4. ADAB RELASI & ISHLAH (Relationship Skills)<br/>Komunikasi santun, mendengar aktif, kerja sama tim, & mendamaikan konflik."]
        
        K5["5. HIKMAH KEPUTUSAN SYAR'I (Responsible Decision-Making)<br/>Menimbang maslahat-mudharat, tanggung jawab moral, & orientasi akhirat."]
...
```mermaid
flowchart TD
    subgraph ProtokolMediasiRestoratif["PROTOKOL MEDIASI LINGKARAN RESTORATIF 4 LANGKAH"]
        L1["1. DENGARKAN PERSPEKTIF: Setiap Pihak Menjelaskan Kronologi & Perasaannya Tanpa Disela"]
        --> L2["2. REFLEKSI DAMPAK: Mengidentifikasi Siapa Saja yang Terluka Akibat Emosi Sesaat Tersebut"]
        --> L3["3. ISHLAH & RESTITUSI: Permohonan Maaf Tulus Saling Berjabat Tangan & Ganti Rugi Kerusakan"]
        --> L4["4. KESEPAKATAN TERTULIS: Merumuskan Komitmen Tata Krama Kamar yang Ditandatangani Bersama"]
    end
```
