...
```mermaid
flowchart TD
    subgraph IntegrasiCASELdanTazkiyah["INTEGRASI CASEL SEL DENGAN KHAZANAH TURATS ISLAM"]
        SEL["5 KOMPETENSI CASEL SEL GLOBAL<br/>(Self-Awareness, Self-Management, Social Awareness, Relationship Skills, Decision-Making)"]
        
        Turats["KHAZANAH TAZKIYATUN NAFS & AKHLAK ISLAM<br/>(Muraqabatullah, Mujahadatun Nafs, Empati Ukhuwah, Ishlah al-Bain, Hikmah Syar'i)"]
        
        SEL <===>|INTEGRASI PARADIGMA TAUHID| Turats
        
        InsanAdabi["TERWUJUDNYA INSAN ADABI DENGAN KECERDASAN EMOSIONAL & KESUCIAN KALBU"]
        
        SEL & Turats ==> InsanAdabi
    end
```
...
```mermaid
graph TD
    A["Gugatan Dikotomi Emosi-Agama (Pihak A):<br/>'Santri itu cukup rajin ibadah ritual saja, tidak perlu belajar teori kecerdasan emosi barat seperti SEL!'"]
    --> B1["Tinjauan Hadits Shahih Tirmidzi 2459:<br/>'Al-Kayyisu man dana nafsahu wa 'amila lima ba'dal mawt' (Orang yang cerdas hakiki adalah yang mampu mengendalikan jiwanya & beramal untuk akhirat)."]
    A --> B2["Tinjauan Ihya 'Ulumiddin Imam Al-Ghazali (Kitab Riyadhatin Nafs):<br/>Penyucian jiwa dari penyakit marah (Ghadhab), sombong (Kibr), dengki (Hasad), & cinta pujian (Riya')."]
    A --> B3["Tinjauan Hadits Bukhari 6116:<br/>'Laisa asy-syadidu bish-shura'ah...' (Bukanlah orang kuat itu yang menang gulat, melainkan yang mampu mengendalikan dirinya saat marah)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Kecerdasan emosi & penguasaan diri adalah inti ajaran akhlak kenabian Islam."]
```
...
```mermaid
graph TD
    subgraph LimaKompetensiCASELdanTurats["5 INTEGRASI CASEL SEL & KHANZANAH ISLAM"]
        K1["1. SELF-AWARENESS (Kesadaran Diri)<br/>===> MURAQABATULLAH & MA'RIFATUN NAFS<br/>Mengenali emosi diri, kekuatan fitrah, & merasa diawasi Allah."]
        
        K2["2. SELF-MANAGEMENT (Manajemen Diri)<br/>===> MUJAHADATUN NAFS & SHABAR<br/>Mengendalikan amarah, menunda kesenangan sesaat, & disiplin ibadah."]
        
        K3["3. SOCIAL AWARENESS (Kesadaran Sosial)<br/>===> EMPATI UKHUWAH & HUSNUZHAN<br/>Memahami perasaan teman sekamar, empati sosial, & menolak ghibah."]
        
        K4["4. RELATIONSHIP SKILLS (Keterampilan Relasi)<br/>===> ADAB PERGAULAN & ISHLAH AL-BAIN<br/>Komunikasi santun, kerja sama nampan, & mendamaikan konflik."]
        
        K5["5. RESPONSIBLE DECISION-MAKING<br/>===> HIKMAH SYAR'I & WARA'<br/>Mengambil keputusan berlandaskan hukum syariat & maslahat umat."]
...
```mermaid
flowchart TD
    subgraph SkenarioSEL24Jam["INTEGRASI SEL DALAM RITME ASRAMA 24 JAM"]
        Pagi["SUBUH & PAGI: SELF-AWARENESS & MANAGEMENT<br/>Dzikir pagi (Muraqabah), merapikan kasur mandiri, & menata niat belajar."]
        
        Siang["SIANG HARI: RESPONSIBLE DECISION-MAKING<br/>Manajemen waktu istirahat Qailulah, antre kantin tertib, & menjaga lisan di kelas."]
        
        Sore["SORE HARI: SOCIAL AWARENESS & RELATIONSHIP SKILLS<br/>Olahraga beregu sportivitas, berbagi air wudhu, & menyapa adik kelas ramah."]
        
        Malam["MALAM HARI: ISHLAH AL-BAIN & MUHASABAH KALBU<br/>Makan nampan bersama, lingkaran adab kamar, & muhasabah 10 menit sebelum tidur."]
...
```mermaid
graph LR
    subgraph RubrikObservasiAdabSEL["RUBRIK ASESMEN PERILAKU SEL-ISLAMI (PBIS TIER 1)"]
        Level1["Tingkat 1: Perlu Bimbingan (Emerging)<br/>Masih sering tersulut amarah saat diejek teman; butuh bantuan de-eskalasi."]
        
        Level2["Tingkat 2: Berkembang (Developing)<br/>Mampu menahan diri saat marah setelah diingatkan; mulai mampu meminta maaf."]
        
        Level3["Tingkat 3: Mandiri Beradab (Proficient)<br/>Secara mandiri mampu menenangkan diri, beristighfar, & memaafkan teman."]
        
        Level4["Tingkat 4: Penggerak Ihsan (Exemplary)<br/>Menjadi mediator juru damai (Mushlih) saat melihat teman lain berselisih."]
...
| :--- | :--- | :--- | :--- |
| **1. Self-Awareness**<br/>*(Kesadaran Diri)* | **Muraqabatullah & Ma'rifatun Nafs** (Kesadaran selalu diawasi Allah & memahami diri). | Mampu mengidentifikasi emosi yang sedang dirasakan (sedih, marah, cemas) dan mengakui kelemahan diri dengan jujur. | QS. Qaf [50]: 16 (*"Kami lebih dekat kepadanya daripada urat lehernya"*).[^10] |
| **2. Self-Management**<br/>*(Manajemen Diri)* | **Mujahadatun Nafs & Ash-Shabr** (Pengendalian hawa nafsu & kesabaran aktif). | Mampu menahan diri dari membentak saat marah, disiplin bangun Subuh mandiri, dan tekun muraja'ah Al-Qur'an. | HR. Bukhari No. 6116 (*"Orang kuat adalah yang mampu menguasai dirinya saat marah"*). |
...
```mermaid
graph TD
    subgraph SkenarioPembiasaanSEL24Jam["SKENARIO PEMBIASAAN ADAB SEL 24 JAM"]
        S1["SKENARIO 1: ANTREAN KAMAR MANDI SUBUH (Self-Management)<br/>Santri melatih sabar antre, menghormati hak teman, & tidak menggedor pintu kasar."]
        
        S2["SKENARIO 2: MAKAN NAMPAN BERSAMA (Social Awareness & Relationship Skills)<br/>Santri makan dari sisi terdekat, mendahulukan lauk untuk teman, & bersyukur bersama."]
        
        S3["SKENARIO 3: DISKUSI KELAS BAHSUL MASAIL (Responsible Decision-Making)<br/>Santri berani menyampaikan argumen fiqh dengan adab ikhtilaf tanpa mencela pendapat teman."]
        
        S4["SKENARIO 4: LINGKARAN REFLEKSI KAMAR MALAM (Self-Awareness & Ishlah)<br/>Santri saling memaafkan sebelum tidur & mengevaluasi adab harian dengan bimbingan musyrif."]
...
```mermaid
flowchart TD
    Tahap1["1. FASE DE-ESKALASI & PENDINGINAN (COOLING DOWN 15 MENIT)<br/>Musyrif memisahkan santri yang berselisih ke ruangan tenang; berwudhu bersama."]
    
    Tahap2["2. SESI MENDENGARKAN PERSPEKTIF BERGANTIAN (HEARING THE STORIES)<br/>Setiap santri menceritakan apa yang terjadi tanpa disela & tanpa saling memaki."]
    
    Tahap3["3. EKSPLORASI DAMPAK EMOSI & EMPATI (EXPLORING THE IMPACT)<br/>Musyrif bertanya: 'Bagaimana perasaanmu saat terjadi hal itu? Apa akibatnya bagi temanmu?'."]
    
    Tahap4["4. PERUMUSAN KESEPAKATAN ISHLAH & RESTITUSI BERSAMA (AGREEMENT FOR REPAIR)<br/>Kedua santri merumuskan cara memperbaiki keadaan, berjabat tangan tulus, & menandatangani piagam ishlah."]
