...
## *Sitemap Induk & Navigasi Monograf Neurosains Remaja, In Loco Parentis, Tangga T1–T4, CASEL SEL, Krisis Identitas, & Resiliensi Grit (7 Monograf Terpadu)*
...
Sub-Domain `04 Development Principles` menetapkan prinsip-prinsip ilmiah perkembangan psikologis dan neurobiologis santri remaja, pengasuhan pengganti orang tua (*In Loco Parentis*), diferensiasi pembinaan Tangga TUMBUH (T1–T4), integrasi keterampilan sosial-emosional (CASEL SEL), navigasi krisis identitas sebaya, dan pembinaan daya juang grit:

```mermaid
graph TD
    Development["SUB-DOMAIN 04: DEVELOPMENT PRINCIPLES (PRINSIP PERKEMBANGAN - 7 MONOGRAF)"]
    
    Development --> Master["P2-04: Development Principles TUMBUH Master (Monograf Induk Sub-Domain 04)"]
    Development --> M1["P2-04-01: Prinsip Maturitas Neurosains Remaja (Dual-Systems Model & PFC Eksternal)"]
    Development --> M2["P2-04-02: Prinsip Keterikatan Aman & In Loco Parentis (Attachment Theory & Safe Haven)"]
    Development --> M3["P2-04-03: Prinsip Progresi Tangga TUMBUH T1–T4 (Diferensiasi T1 s/d T4)"]
    Development --> M4["P2-04-04: Prinsip Integrasi CASEL SEL & Karakter Islami (5 Pilar CASEL & Ishlah)"]
    Development --> M5["P2-04-05: Prinsip Navigasi Identitas & Dinamika Sebaya (Khawikhum & Ukhuwah Nampan)"]
    Development --> M6["P2-04-06: Prinsip Resiliensi & Grit Santri Tahfizh (Mujahadah & Anti-Futuwr)"]
    Development --> M7["P2-04-07: Sintesis Development Principles TUMBUH (Grand Charter Maturasi Fitrah)"]
```
...
| **03** | [**`P2-04-03-Prinsip-Progresi-Tangga-TUMBUH-T1-T4.md`**](./P2-04-03-Prinsip-Progresi-Tangga-TUMBUH-T1-T4.md) | Prinsip Progresi Tangga TUMBUH T1–T4 | Konsep *Marahil al-'Umr* (Mumayyiz, Murahiq, Bulugh); diferensiasi pengasuhan berjenjang T1 (Tertib), T2 (Unggul), T3 (Mandiri), dan T4 (Bijak); eliminasi senioritas feodal (9 Catatan Kaki). |
