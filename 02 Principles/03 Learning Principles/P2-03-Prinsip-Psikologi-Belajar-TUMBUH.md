...
```mermaid
flowchart TD
    subgraph PosisiLearningPrinciplesTUMBUH["POSISI SUB-DOMAIN 03 LEARNING PRINCIPLES"]
        D2_02["02.02 DESIGN PRINCIPLES<br/>(Arsitektur Kurikulum, Asrama Sehat CPTED, SOP Musyrif, Sanitasi WASH)"]
        ==> D2_03["02.03 LEARNING PRINCIPLES<br/>(Didaktik Kognitif, Tahfizh Mutqin, Metakognisi, Kagan PIES, Diferensiasi)"]
        
        D2_03 ==> D2_04["02.04 DEVELOPMENT PRINCIPLES<br/>(Tahapan Maturasi Fitrah, Regulasi Emosi, & Pembinaan Adab)"]
        D2_03 ==> D2_05["02.05-07 ASSESSMENT, INTERVENTION, & IMPLEMENTATION"]
    end
```
...
```mermaid
flowchart TD
    subgraph MasterArsitekturLearningPrinciplesTUMBUH["MASTER ARSITEKTUR LEARNING PRINCIPLES TUMBUH"]
        
        subgraph EmpatPilarKonseptualMasterLearning["EMPAT PILAR KONSEPTUAL PEMBELAJARAN"]
            LP_M1["1. EFISIENSI KOGNISI & MEMORI MUTQIN (Cognitive Architecture)<br/>Kelola beban kognitif (CLT), Dual Coding, Spaced Retrieval, & Tahfizh 3 Lapis."]
            LP_M2["2. KEMANDIRIAN METAKOGNITIF (Autonomous Self-Regulation)<br/>Muhasabatun Nafs, Siklus SRL 3 Fase, Growth Mindset, & Muraqabatullah."]
            LP_M3["3. DIDAKTIK DIALOGIS & ASESMEN FORMATIF (Interactive Engagement)<br/>Tanya jawab Nabawi, Kagan PIES (100% aktif), Exit Tickets, & Actionable Feedback."]
            LP_M4["4. KEADILAN DIFERENSIASI FITRAH (Differentiated Inclusivity)<br/>Mura'at Ahwal, ZPD Scaffolding, Klinik Tier 2, & Zero Stigmatization."]
        end
        
        subgraph ManifestasiPraksisTataKelolaLearning["MANIFESTASI PRAKSIS KELAS & HALAQAH 24 JAM"]
            M1_LP["• RPP 45 Menit Ramah Kognisi & Papan Tulis Dual Coding."]
            M2_LP["• Jadwal Tahfizh 3 Lapis & Hak Tidur Konsolidasi 7 Jam."]
            M3_LP["• Jurnal Muhasabah Malam 10m & Klinik Akademik Ba'da Ashar."]
        end
        
        EmpatPilarKonseptualMasterLearning <===> ManifestasiPraksisTataKelolaLearning
    end
```
...
```mermaid
flowchart TD
    subgraph PenjalaranLearningKeDevelopment["PENJALARAN DARI PEMBELAJARAN KE PENGEMBANGAN SANTRI"]
        LearningMaster["P2-03: LEARNING PRINCIPLES (Didaktik Kognitif & Pedagogi Beradab)"]
        
        LearningMaster ==> P2_04_01["P2-04-01: Neurosains Perkembangan Otak Remaja Pesantren"]
        LearningMaster ==> P2_04_02["P2-04-02: Prinsip Pengasuhan Asrama In Loco Parentis"]
        LearningMaster ==> P2_04_03["P2-04-03: Integrasi CASEL Social-Emotional Learning (SEL)"]
        LearningMaster ==> P2_04_04["P2-04-04: Psikologi Kognitif & Ketahanan Mental Remaja (Grit)"]
        LearningMaster ==> P2_04_05["P2-04-05: Sintesis Development Principles & Grand Maturasi"]
    end
```
