...
```mermaid
graph TD
    Learning["SUB-DOMAIN 03: LEARNING PRINCIPLES (PRINSIP PEMBELAJARAN - 6 MONOGRAF)"]
    
    Learning --> Master["P2-03: Learning Principles TUMBUH Master (Monograf Induk Sub-Domain 03)"]
    Learning --> M1["P2-03-01: Prinsip Kognitif & Beban Belajar (Cognitive Load Theory & Dual Coding)"]
    Learning --> M2["P2-03-02: Prinsip Retensi Memori & Hafalan Mutqin (Spaced Retrieval & Tahfizh 3 Lapis)"]
    Learning --> M3["P2-03-03: Prinsip Metakognisi & Kemandirian Santri (Self-Regulated Learning & Mindset)"]
    Learning --> M4["P2-03-04: Prinsip Didaktik Interaktif & Asesmen Formatif (Kagan PIES & Exit Tickets)"]
    Learning --> M5["P2-03-05: Prinsip Diferensiasi & Inklusi Santri (Tomlinson Differentiated & Tiered Tasks)"]
    Learning --> M6["P2-03-06: Sintesis Learning Principles TUMBUH (Grand Charter Pedagogi Beradab)"]
```
