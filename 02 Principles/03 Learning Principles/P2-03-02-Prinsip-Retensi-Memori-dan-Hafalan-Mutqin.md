...
```mermaid
flowchart TD
    subgraph TransformasiMetodologiTahfizh["TRANSFORMASI METODOLOGI HAFALAN TAHFIZH"]
        PolaCrammingLama["CRAMMING MARATON & ILUSI CEPAT (LAMA)<br/>• Menghafal maraton semalam tanpa muraja'ah.<br/>• Lupa 70% dalam 24 jam (Ebbinghaus Curve).<br/>• Hafalan hilang total dalam 6 bulan pasca-wisuda."]
        
        PolaMutqinTUMBUH["SPACED RETRIEVAL & TAHFIZH 3 LAPIS (TUMBUH)<br/>• Ziyadah (1/2 lembar) + Sabqi (5 lembar) + Manzil (1 juz).<br/>• Konsolidasi hipokampus via Slow-Wave Sleep 7 jam.<br/>• Testing Effect: Hafalan Mutqin melekat seumur hidup."]
        
        PolaCrammingLama ==>|DIREKONSTRUKSI MENJADI| PolaMutqinTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturTahfizhMutqinTUMBUH["ARSITEKTUR TAHFIZH MUTQIN 3 LAPIS TUMBUH"]
        
        T1_Sayap["1. ZIYADAH TERUKUR (Targeted New Memorization)<br/>Dosis hafalan baru 0.5–1 halaman/hari berbasis talaqqi tahsin makharijul huruf."]
        
        T2_Sayap["2. SABQI HARIAN (Immediate Short-Term Retrieval)<br/>Muraja'ah 5 halaman terakhir yang baru disetor setiap hari sebelum ziyadah baru."]
        
        T3_Sayap["3. MANZIL ROTASI BERKALA (Long-Term Spaced Consolidation)<br/>Muraja'ah hafalan lama minimal 1 juz/hari dengan rotasi berkala berbasis Leitner Box."]
...
```mermaid
flowchart LR
    subgraph SpacedRetrievalLeitner["INTERVAL SPACED RETRIEVAL TAHFIZH"]
        H1["Hari ke-1:<br/>Setoran Ziyadah"]
        --> H3["Hari ke-3:<br/>Sabqi 1"]
        --> H7["Hari ke-7:<br/>Sabqi 2"]
        --> H14["Hari ke-14:<br/>Manzil Box 1"]
        --> H30["Hari ke-30:<br/>Manzil Box 2 (Mutqin)"]
    end
```
