...
```mermaid
flowchart TD
    subgraph TransformasiDidaktikInteraktif["TRANSFORMASI DIDAKTIK KELAS PESANTREN"]
        PolaMonologLama["MONOLOG SATU ARAH & VONIS SUMATIF (LAMA)<br/>• Guru ceramah 90 menit; 80% santri mengantuk/pasif.<br/>• Hanya 2-3 santri depan yang aktif dipanggil.<br/>• Ujian sumatif kering tanpa umpan balik perbaikan."]
        
        PolaInteraktifTUMBUH["DIDAKTIK DIALOGIS & ASESMEN FORMATIF (TUMBUH)<br/>• Dialogis Nabawi: Tanya-jawab pemantik & analogi amtsal.<br/>• Kagan PIES (Think-Pair-Share): 100% santri aktif.<br/>• Exit Tickets & Actionable Feedback harian."]
        
        PolaMonologLama ==>|DIREKONSTRUKSI MENJADI| PolaInteraktifTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturDidaktikTUMBUH["ARSITEKTUR DIDAKTIK INTERAKTIF & ASESMEN FORMATIF"]
        
        D1_Sayap["1. DIALOGIS PROFETIK PEMANTIK NALAR (Prophetic Dialogue)<br/>Tanya jawab pemantik, analogi perumpamaan amtsal, & studi kasus kontekstual."]
        
        D2_Sayap["2. KOOPERATIF SEREMPAK PIES (Simultaneous Engagement)<br/>Struktur Kagan (Think-Pair-Share, RallyRobin, RoundRobin) melibatkan 100% santri."]
        
        D3_Sayap["3. ASESMEN FORMATIF RESPONSIF (Actionable Formative Loop)<br/>Exit Tickets harian, papan mini refleksi, & umpan balik deskriptif bebas vonis angka."]
