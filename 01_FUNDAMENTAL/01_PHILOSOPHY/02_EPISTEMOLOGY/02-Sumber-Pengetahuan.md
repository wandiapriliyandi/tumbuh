...
```mermaid
graph TD
    Pilar["6 PILAR SUMBER PENGETAHUAN TUMBUH"]
    
    Pilar --> S1["1. Wahyu Ilahi (Al-Qur'an & Sunnah)<br/>Fondasi normatif: nilai, aqidah, hukum moral, & tujuan hidup."]
    Pilar --> S2["2. Akal Budi ('Aql)<br/>Alat memahami, menalar, mengkritisi, & menarik hikmah."]
    Pilar --> S3["3. Pengamatan & Indera (Hawas)<br/>Menangkap fakta fisik, perilaku kasat mata, & realitas asrama."]
    Pilar --> S4["4. Riset & Sains Empiris<br/>Menguji efektivitas cara, hubungan kausal, & dinamika psikologi."]
    Pilar --> S5["5. Kesaksian / Khabar (Testimony)<br/>Laporan guru, dokumen kitab, rekam jejak, & data lapangan."]
    Pilar --> S6["6. Pengalaman Praktisi (Kearifan Asrama)<br/>Wawasan lapangan para pengasuh senior dalam memahami santri."]
```
