# Pedoman & Aturan Baku Agen Ekosistem TUMBUH Pesantren

Dokumen ini adalah aturan induk (*Master Repository Rules*) yang mengikat seluruh agen, sub-agen, dan proses pengerjaan di repositori **TUMBUH**.
...
## 3. Dewan Keilmuan Aktif (25 Custom Skills di `.agents/skills/`)
...
- `pakar-penulis-novel-tarbiyah-tumbuh` (Skill Ke-25: Master Novelis Tarbiyah Pesantren, Sastra Naratif Sinematik 50+ Paragraf Per Sub-Bab untuk Serial 12 Buku)
...
- `pakar-validasi-sitasi-dan-bibliografi` (Skill Ke-24: Verifikasi Autentisitas Teks Turats, Takhrij Hadits, APA 7th, & Footnotes 1-to-1)
