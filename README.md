...
```mermaid
graph TD
    TriadRoot["Triad Pertumbuhan Simbiotik TUMBUH"]
    TriadRoot --> SantriGrowth["1. Santri Tumbuh<br/>Fitrah suci, adab, regulasi diri, & tangga perkembangan T1-T4."]
    TriadRoot --> EducatorGrowth["2. Guru & Musyrif Tumbuh<br/>Kompetensi pedagogi, konseling empatis, keikhlasan, keteladanan Qudwah, & terlindungi dari burnout."]
    TriadRoot --> SystemGrowth["3. Sistem Lembaga Tumbuh<br/>Organisasi pembelajar berbasis data PBIS, SOP terpadu 24-jam, & bebas mutlak dari intimidasi."]
```
