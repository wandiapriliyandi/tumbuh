...
Menetapkan prinsip pengelolaan nomor **P0–Pn** agar identifier Probe tetap stabil, mudah dirujuk, tidak menimbulkan ambiguitas, dan mampu mempertahankan lineage dokumentasi dari waktu ke waktu.

---

## 1. Titik Berangkat

P6 menetapkan bahwa nomor P adalah identifier dan urutan dokumenter, bukan hierarki atau ukuran kematangan.

P7 menetapkan bahwa P baru muncul ketika terbentuk unit inquiry yang berbeda secara substantif, sedangkan perubahan editorial tetap menjadi revisi terhadap P yang sama.
...
P7 telah menetapkan bahwa P baru didasarkan pada unit inquiry baru.
...
P7 telah membedakan revisi dari inquiry baru.
...
P8 menetapkan prinsip stabilitas identifier, tetapi belum menentukan **mekanisme governance pemberian nomor secara operasional**: siapa yang menetapkan nomor, bagaimana konflik nomor ditangani, dan bagaimana status lifecycle dicatat secara formal.

Pertanyaan tersebut merupakan lapisan governance dokumentasi yang dapat dibahas berikutnya.
