...
P10–P11 menetapkan bahwa lifecycle sebuah Probe dapat berubah tanpa mengubah identity-nya.

P12 menetapkan bahwa metadata perlu distandarkan untuk menjaga traceability.
...
Contohnya, P12 dapat secara langsung melanjutkan P10 meskipun P11 berada di antaranya secara dokumenter.
...
```text
P13 lebih tinggi dari P8
P13 lebih benar dari P8
P13 lebih matang dari P8
```
...
Dokumentasi P13 sebaiknya dapat menjelaskan:
...
Dengan begitu pembaca dapat memahami mengapa P13 menjadi identity baru tanpa menganggap P8 telah diubah menjadi P13.
...
Pada kasus B, P13 memperoleh identity sendiri dan harus memiliki hubungan lineage ke P8.
...
Ini memperkuat keputusan P6 dan P8 bahwa numbering tidak menggantikan relationship.
...
P12 tetap berlaku: format teknis final belum dikunci.
...
> “Apakah P13 benar-benar follow-up dari P8?”

adalah pertanyaan semantik dan intelektual.

Automation dapat memeriksa bahwa `P8` ada.
...
P13 menetapkan prinsip dan vocabulary konseptual untuk lineage serta relations.

P13 **belum menetapkan schema metadata teknis final**, belum menentukan visualisasi graph tertentu, dan belum menentukan apakah seluruh relation harus diwajibkan atau hanya digunakan ketika relevan.
