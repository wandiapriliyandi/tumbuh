# P18 — Bagaimana Namespace, Path, dan Identity Probe Dikelola ketika Struktur Folder Berubah?
...
P3 menetapkan bahwa angka Romawi pada `PROBE/I`, `PROBE/II`, dan seterusnya merupakan **pengelompokan dokumentasi**, bukan klasifikasi teoritis.

P8 menetapkan bahwa P-number adalah identity yang stabil.

P16 menetapkan bahwa path dapat berubah tanpa mengubah identity.

P17 menetapkan bahwa identity, versioning, dan path merupakan concern yang berbeda.
...
Selama unit inquiry tetap sama, identity `P18` tetap.
...
Karena P3 menetapkan Roman grouping sebagai dokumentasi, maka:
...
Jika P18 berpindah dari `PROBE/I` ke namespace lain, tidak otomatis terjadi:
...
P18 tidak menjadi P baru hanya karena rumahnya berubah.
...
P13 menetapkan bahwa relation sebaiknya mengacu pada P-number.
...
P14 menetapkan index sebagai navigation layer.
...
Tetapi identity P18 tidak berubah.
...
Identifier tetap P18, sementara link dapat menunjuk ke lokasi terkini.
...
P3 secara eksplisit menetapkan bahwa Roman grouping merupakan pengelompokan dokumentasi.
...
Sesuai P7, P baru dibutuhkan ketika **unit inquiry berubah secara substantif**.
...
P18 hanya menetapkan pemisahan konseptual antara **identity, namespace, dan path** serta prinsip bahwa perubahan struktur tidak boleh otomatis dianggap sebagai perubahan inquiry.
