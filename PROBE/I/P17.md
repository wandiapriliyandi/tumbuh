...
P0 menetapkan bahwa V2 merupakan ruang evolusi arsitektur.

P8 menetapkan bahwa P-number adalah identity yang stabil.

P16 menetapkan bahwa schema dan struktur repository dapat berevolusi tanpa harus mengubah identity dan lineage Probe.
...
Sedangkan perubahan isi P17 tercatat melalui revision Git dan, jika diperlukan, metadata version tertentu.
...
P17 tetap P17 selama unit inquiry-nya tetap sama.
...
Perubahan editorial atau revisi inquiry yang masih berada dalam unit inquiry yang sama tetap merupakan revisi P17.

P7 tetap menjadi dasar untuk menentukan kapan inquiry baru membutuhkan P baru.
...
juga tidak dapat menggantikan identity P17.
...
P11 menetapkan lifecycle Probe:
...
```text
P17 — Pembedaan Versioning Schema, Repository, dan Identity Probe
```
...
P16 sudah menetapkan bahwa path bersifat replaceable selama identity dan lineage tetap traceable.
...
P17 belum menetapkan aturan semver final untuk TUMBUH.
...
Renumbering hanya demi menyesuaikan schema akan melanggar prinsip stability of identity dari P8.
...
Aturan paling penting P17 adalah:
...
P17 hanya menetapkan **pemisahan konsep** agar keputusan teknis berikutnya tidak mencampurkan identity, version, lifecycle, decision, path, dan revision.
