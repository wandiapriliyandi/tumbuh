# P9 — Bagaimana Governance P0–Pn Dilakukan?

## Tujuan

Menetapkan prinsip governance dokumentasi **P0–Pn** agar pemberian nomor, perubahan, hubungan antar-Probe, dan status dokumentasi dapat berlangsung secara konsisten tanpa menjadikan proses inquiry terlalu birokratis.

---

## 1. Titik Berangkat

P6 menetapkan bahwa `P` adalah identifier Probe dan angka P0–Pn merupakan urutan dokumenter.

P7 menetapkan kapan sebuah inquiry layak menjadi P baru.

P8 menetapkan bahwa identifier harus unik, stabil, tidak didaur ulang, serta dibedakan dari versioning dan lokasi file.
...
Governance P0–Pn terutama mengatur **integritas dokumentasi**, bukan menentukan hasil inquiry.
...
Governance P0–Pn harus memenuhi lima prinsip utama:
...
Karena aturan P0–Pn relatif terstruktur, sebagian pemeriksaan dapat diotomatisasi.
...
Secara sederhana, governance P0–Pn dapat diringkas menjadi tiga lapisan:
...
P9 telah menetapkan prinsip governance minimum, tetapi belum menetapkan **prosedur operasional lengkap untuk lifecycle sebuah Probe**, termasuk kapan status berubah, bagaimana review dilakukan pada tahap berbeda, dan bagaimana perubahan substantif dicatat secara konsisten.

Hal tersebut dapat menjadi inquiry berikutnya.

---

# Decision

**PASS — GOVERNANCE P0–Pn HARUS MENJAGA INTEGRITAS DOKUMENTASI TANPA MENJADI BOTTLENECK INQUIRY**

Keputusan P9:

> **Governance P0–Pn berfungsi menjaga identity, numbering, lineage, status, dan integritas repository. Penilaian apakah suatu inquiry merupakan P baru tetap merupakan judgment inquiry, sedangkan pemeriksaan struktural dapat dibantu automation. Governance harus cukup kuat untuk menjaga traceability tetapi cukup ringan agar tidak menghambat eksplorasi dan perubahan keputusan.**
