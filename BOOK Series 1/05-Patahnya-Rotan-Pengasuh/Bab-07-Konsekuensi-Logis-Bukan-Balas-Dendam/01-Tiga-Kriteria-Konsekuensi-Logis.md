...
Dalam perumusan pedoman tata tertib restoratif di Pesantren Darul Adab, Ustadz Salman dan Ustadz Ridwan menetapkan standar emas pembeda antara hukuman punitif dan konsekuensi logis: **Prinsip Tiga R (*Related, Respectful, Reasonable*)**. ```mermaid
graph TD
    Hukuman["HUKUMAN PUNITIF (BALAS DENDAM)<br/>• Tidak berhubungan dengan pelanggaran (e.g. terlambat sholat disuruh lari keliling lapangan).<br/>• Merendahkan martabat santri (bentakan/kekerasan).<br/>• Berlebihan & memicu dendam emosional."]
    Konsekuensi["KONSEKUENSI LOGIS RESTORATIF (3R)<br/>• Related: Berhubungan langsung dengan konteks pelanggaran.<br/>• Respectful: Diberikan dengan adab tanpa merendahkan.<br/>• Reasonable: Masuk akal & sesuai kapasitas perkembangan anak."] Hukuman -.->|Ditinggalkan Total| Konsekuensi
...
* Waktu pembersihan disesuaikan dengan jam luang sore hari agar tidak mengganggu jam belajar madrasah (*Reasonable*). Penerapan prinsip 3R ini membuat santri memahami hubungan sebab-akibat yang nyata antara perbuatan mereka dan dampaknya bagi lingkungan, menanamkan nilai tanggung jawab moral yang rasional dan bermartabat.
