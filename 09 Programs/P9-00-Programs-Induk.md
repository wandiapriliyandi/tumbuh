...
```mermaid
graph LR
    P900["P9-00 Programs Induk"]
    P900 --> S01["01 Core Programs (Tahfizh & Diniyyah)"]
    P900 --> S02["02 Character Programs (SEL & PBIS)"]
    P900 --> S03["03 Leadership Programs (Servant Leadership T4)"]
    P900 --> S04["04 Institutional Programs (Parenting & Musyrif Academy)"]
    P900 --> S05["05 Special Programs (Tier 2/3 & Reintegration)"]
```
