...
```mermaid
graph TD
    CoreEco["Ekosistem Program Pembinaan 24-Jam TUMBUH"]
    CoreEco --> CoreProg["1. Core Programs (Tahfizh Mutqin, Dirasah Islamiyah, & Bahasa Arab)"]
    CoreEco --> CharProg["2. Character Programs (CASEL SEL, Mujahadah, & PBIS Points)"]
    CoreEco --> LeadProg["3. Leadership Programs (Servant Leadership T4 & 8 Sekbid OSIS)"]
    CoreEco --> InstProg["4. Institutional Programs (Sekolah Orang Tua & Musyrif Academy)"]
    CoreEco --> SpecProg["5. Special Programs (Matrikulasi, CICO Tier 2, BIP Tier 3, & Reintegration)"]
```
