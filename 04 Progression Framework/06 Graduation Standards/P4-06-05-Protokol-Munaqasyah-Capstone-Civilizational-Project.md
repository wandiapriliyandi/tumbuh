...
```mermaid
flowchart TD
    subgraph TransformasiKaryaAkhir["REKONSTRUKSI KARYA AKHIR KELULUSAN SANTRI"]
        SkripsiMenaraGading["KARYA TEORI MENARA GADING (TRADISIONAL)<br/>• Kompilasi teori internet tanpa dampak sosial.<br/>• Berakhir menjadi tumpukan kertas berdebu.<br/>• Tanpa pengujian produk riil di masyarakat."]
        
        TUMBUH["CAPSTONE CIVILIZATIONAL PROJECT (TUMBUH)<br/>• Integrasi 'Amal Shalih Muta'addi & Design Thinking.<br/>• Solusi riil bagi desa binaan: Filtrasi air, sanitasi, dakwah.<br/>• Sidang Munaqasyah Terbuka bersama Kyai & Tokoh Desa."]
        
        SkripsiMenaraGading ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsAmalMutaaddiSalaf["DOKTRIN AMAL MUTA'ADDI TURATS"]
        HaditsKhairunnaas["HR. Ath-Thabarani:<br/>خَيْرُ النَّاسِ أَنْفَعُهُمْ لِلنَّاسِ<br/>(Sebaik-baik Manusia Adalah yang Paling Bermanfaat Bagi Manusia Lainnya!)"] --> Inti["Hakikat Capstone Project:<br/>Mewujudkan Ilmu yang Bermanfaat ('Ilmun Yuntafa'u Bih) Melalui Karya Solusi Nyata Bagi Umat"]
        Izzuddin["Al-'Izz bin Abdis Salam (Qawa'idul Ahkam):<br/>Tujuan Syariat Adalah Menghadirkan Maslahat & Menolak Mafsadat Bagi Makhluk"] --> Inti
        IbnQayyim["Ibnu Qayyim (Madarijus Salikin):<br/>Ibadah Khidmah Sosial Adalah Puncak Kematangan Spiritual"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsDesignThinkingServiceLearning["SINTESIS DESIGN THINKING & SERVICE LEARNING"]
        StanfordDesignThinking["Design Thinking Framework (d.school):<br/>• 1. Empathize (Menyelami kesulitan warga desa).<br/>• 2. Define (Merumuskan akar masalah).<br/>• 3. Ideate (Merancang alternatif solusi inovatif).<br/>• 4. Prototype (Membangun purwarupa alat/modul).<br/>• 5. Test (Uji coba lapangan & iterasi)."]
        
        ServiceLearningBringle["Service-Learning Assessment (Bringle & Hatcher):<br/>• Mengintegrasikan pengabdian masyarakat bermakna dengan refleksi akademik kritis."]
        
        AuthenticDemonstrationWiggins["Authentic Defense (Grant Wiggins):<br/>• Ujian kelayakan di hadapan panel ahli & penerima manfaat riil."]
        
        StanfordDesignThinking & ServiceLearningBringle & AuthenticDemonstrationWiggins ==> StandarCapstoneTUMBUH["PROTOKOL CAPSTONE PROJECT"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurEkspedisiDesa6Bulan["LIMA TAHAP EKSPEDISI CAPSTONE PROJECT"]
        Bulan1["BULAN 1-2 (EMPATI & ASESMEN): Santri tinggal di desa binaan, memetakan masalah, & seminar proposal."]
        Bulan3["BULAN 3-4 (PROTOTYPING & EKSEKUSI): Santri membuat instalasi teknologi / modul pembelajaran desa."]
        Bulan5["BULAN 5 (TESTING & PENYERAHAN): Uji keberfungsian solusi, pelatihan warga desa, & serah terima proyek."]
        Bulan6["BULAN 6 (SIDANG MUNAQASYAH): Sidang terbuka di hadapan dewan penguji multidisipliner."]
...
```mermaid
flowchart TD
    subgraph ProtokolSidangMunaqasyah["PROTOKOL SIDANG MUNAQASYAH TERBUKA"]
        Step1["1. PRESENTASI MULTIMEDIA 20 MENIT: TIM SANTRI MENYAJIKAN DATA EMPIRIS & VIDEO LAPANGAN<br/>• Tim menunjukkan video operasional kompor biogas yang menyala stabil melayani dapur santri."]
        
        Step2["2. SESI TANYA-JAWAB KRITIS 30 MENIT OLEH DEWAN PENGUJI (GURU BESAR SAINS & KYAI FIQH)<br/>• Santri menjawab tuntas pertanyaan keamanan sensor kebocoran gas & dalil fiqh kesucian energi dari limbah (*Thaharah*)."]
        
        Step3["3. TESTIMONI LANGSUNG KEPALA DAPUR ASRAMA TENTANG DAMPAK PENGHEMATAN BIAYA<br/>• Kepala dapur mengonfirmasi proyek berhasil menghemat 30% konsumsi tabung gas elpiji asrama."]
        
        Step4["4. PENGESAHAN KELULUSAN DENGAN PREDIKAT 'MUMTAZ SYARAF' (NILAI 96.0)<br/>• Dewan penguji menandatangani Berita Acara Kelulusan; inovasi santri dipatenkan sebagai aset wakaf pesantren."]
...
```mermaid
flowchart LR
    Etape1["1. EMPATHIZE<br/>Observasi 14 Hari di Desa"]
    --> Etape2["2. DEFINE<br/>Seminar Proposal Masalah"]
    --> Etape3["3. PROTOTYPE<br/>Rancang Bangun Solusi Riil"]
    --> Etape4["4. TESTING<br/>Uji Dampak Lapangan"]
    --> Etape5["5. DEFENSE<br/>Sidang Munaqasyah Terbuka"]
```
