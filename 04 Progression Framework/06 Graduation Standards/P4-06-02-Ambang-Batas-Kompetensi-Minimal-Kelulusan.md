...
```mermaid
flowchart TD
    subgraph TransformasiStandarKelulusan["REKONSTRUKSI STANDAR KELULUSAN PESANTREN"]
        IjazahFormalitas["IJAZAH FORMALITAS & INFLASI NILAI (TRADISIONAL)<br/>• Nilai dikatrol demi angka kelulusan 100%.<br/>• Mengabaikan kemandirian ibadah & adab riil.<br/>• Ijazah kehilangan marwah integritas keilmuan."]
        
        TUMBUH["AMBANG BATAS KOMPETENSI MINIMAL (TUMBUH)<br/>• 4 Ranah Wajib: Ruhiyah, Kognitif, Karakter PBIS, & Khidmah.<br/>• Criterion-Referenced Mastery: Skor mutlak berbasis bukti.<br/>• Ijazah & Transkrip Karakter 360 Terverifikasi Mutqin."]
        
        IjazahFormalitas ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsSyuruthulIjazahSalaf["DOKTRIN SYURUTHUL IJAZAH TURATS"]
        HaditsIsnad["Atsar Abdullah bin Al-Mubarak:<br/>الْإِسْنَادُ مِنَ الدِّينِ، وَلَوْلَا الْإِسْنَادُ لَقَالَ مَنْ شَاءَ مَا شَاءَ<br/>(Sanad Itu Bagian dari Agama; Jikalau Bukan Karena Sanad Niscaya Siapapun Akan Berkata Sekehendak Hatinya!)"] --> Inti["Hakikat Standar Kelulusan:<br/>Ijazah Adalah Persaksian Amanah Syar'i yang Haram Diberikan Kepada yang Belum Layak"]
        Nawawi["Imam An-Nawawi (At-Tibyan):<br/>Syarat Kelulusan Qari' Al-Qur'an: Menjaga Hafalan Mutqin & Mengamalkan Adab"] --> Inti
        KhatibBaghdadi["Al-Khatib Al-Baghdadi (Al-Kifayah):<br/>Larangan Keras Memberikan Ijazah Palsu / Menoleransi Ketidakmampuan"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPengukuranABKM["SINTESIS CRITERION-REFERENCED STANDARDS"]
        PophamCriterionModel["Criterion-Referenced Testing (Popham, 2014):<br/>• Mengukur kinerja santri terhadap standar kompetensi eksplisit yang telah ditetapkan sebelumnya (Pre-determined Cut-Off).<br/>• Meniadakan sistem ranking persaingan; seluruh santri yang mencapai ambang batas berhak lulus."]
        
        MinimumCompetencyStandards["Minimal Competency Testing (Madaus):<br/>• Menjamin tidak adanya defisit keterampilan dasar kritis pada seluruh lulusan."]
        
        AuthenticDemonstration["Authentic Performance Demonstration:<br/>• Uji praktik lisan (Tasmi' & Munaqasyah) dan karya fisik nyata (Capstone Project)."]
        
        PophamCriterionModel & MinimumCompetencyStandards & AuthenticDemonstration ==> StandarABKMTUMBUH["AMBANG BATAS KELULUSAN (ABKM)"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurVerifikasiYudisiumKelulusan["ALUR VERIFIKASI YUDISIUM KELULUSAN"]
        AuditSistem["1. SYSTEM CLEARANCE SIM: Pengecekan otomatis hafalan mutqin, presensi 95%, & logbook 210 jam."]
        MunaqasyahPenguji["2. SIDANG MUNAQASYAH PENGUJI: Uji tasmi' Al-Qur'an, baca kitab gundul, & presentasi Capstone."]
        SidangDewanKyai["3. SIDANG PLENO YUDISIUM DEWAN KYAI: Pengesahan kelulusan resmi atau rujukan Bootcamp."]
        PenerbitanIjazah["4. PENERBITAN IJAZAH & TRANSKRIP TKS-360: Penandatanganan dokumen kelulusan resmi."]
        
        AuditSistem --> MunaqasyahPenguji --> SidangDewanKyai --> PenerbitanIjazah
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolTahfizhBootcamp["PROTOKOL REMEDIASI PRA-WISUDA TIER 2"]
        Tahap1["1. PENAHANAN DOKUMEN IJAZAH DALAM PLENO YUDISIUM DENGAN STATUS 'REMEDIASI TAHFIZH'<br/>• Dewan Kyai menegaskan: 'Ijazah TUMBUH adalah amanah kemuliaan Al-Qur'an; hafalan wajib mutqin sebelum wisuda'."]
        
        Tahap2["2. IKUT SERTA PROGRAM 'DAURAH TAHFIZH INTENSIF KARANTINA 21 HARI'<br/>• Santri T masuk asrama karantina tahfizh khusus: Fokus muraja'ah 8 jam per hari bersama muhaffizh senior."]
        
        Tahap3["3. UJI TASMI' SEKALI DUDUK (BIL GHAIB) 5 JUZ DI HADAPAN DEWAN MUHAFFIZH<br/>• Santri T melantunkan 5 juz Al-Qur'an tanpa salah harakat & lulus dengan nilai Mumtaz (96.0)."]
        
        Tahap4["4. PENGESAHAN KELULUSAN PARIPURNA & PENYERAHAN IJAZAH RESMI DI PANGGUNG WISUDA<br/>• Santri T diwisuda dengan predikat kehormatan Khadimul Ummah & hafalan Al-Qur'an mutqin seumur hidup."]
...
```mermaid
flowchart TD
    subgraph EmpatRanahAmbangBatasMutlak["EMPAT PILAR AMBANG BATAS KELULUSAN (ABKM)"]
        R1["I. RANAH RUHIYAH & TAHFIZH<br/>• Hafalan minimal 7–10 Juz Mutqin (Reguler) / 30 Juz (Takhassus).<br/>• Kemandirian Shalat Berjamaah Shaf Awal & Qiyamullail $\ge 95\%$."]
        
        R2["II. RANAH KOGNITIF TURATS & SAINS<br/>• Qira'ah & I'rab Kitab Kuning Gundul (Matan Fiqh/Hadits).<br/>• Rapor Kelulusan Madrasah/Sekolah $\ge 80.0$ & Skor TOEFL/TOAFL $\ge 475$."]
        
        R3["III. RANAH AFEKTIF 10 MUWASHAFAT PBIS<br/>• Indeks Komposit Karakter (IKK) $\ge 3.50$ (Skala 4.00) pada Form TKS-360.<br/>• Bebas dari catatan pelanggaran adab berat (0% Rekam Jejak Kekerasan)."]
        
        R4["IV. RANAH PSIKOMOTORIK & KHIDMAH CAPSTONE<br/>• Akumulasi Logbook Khidmah Sosial $\ge 210\text{ Jam}$ sepanjang 6 tahun.<br/>• Kelulusan Sidang Munaqasyah Capstone Civilizational Project ($\ge 85.0$)."]
