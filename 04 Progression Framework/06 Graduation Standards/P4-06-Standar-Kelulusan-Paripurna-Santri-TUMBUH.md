...
flowchart TD
    subgraph GugusGraduationStandards["STRUKTUR 6 MONOGRAF STANDAR KELULUSAN PARIPURNA"]
        ...
        subgraph SERTIFIKASIDANTRACER["II. TRANSKRIP RESMI & CONTINUOUS IMPROVEMENT"]
            M03["[P4-06-03] Sistem Sertifikasi & Transkrip Karakter PBIS<br/>• Official Form TKS-360 | SHA-256 Cryptographic QR Verification"]
            M04["[P4-06-04] Sistem Tracer Study & Continuous Improvement<br/>• Pelacakan T+1, T+3, T+5 | Deming PDCA Cycle & SROI Karakter"]
        end

        subgraph CAPSTONEDANVALIDASI["III. MUNAQASYAH CAPSTONE & META-VALIDASI"]
            M05["[P4-06-05] Protokol Munaqasyah Capstone Civilizational Project<br/>• Sidang Terbuka Karya Desa Binaan | Design Thinking Stanford"]
            M06["[P4-06-06] Sintesis & Validasi Standar Kelulusan Paripurna<br/>• Validitas Konkuren r = 0.894, Composite Reliability CR = 0.931, & ISO 21001"]
        end

        PROFILTRANSKRIP ==> SERTIFIKASIDANTRACER ==> CAPSTONEDANVALIDASI
    end
```
