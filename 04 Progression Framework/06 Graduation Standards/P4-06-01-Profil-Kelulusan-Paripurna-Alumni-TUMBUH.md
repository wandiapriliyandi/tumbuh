...
```mermaid
flowchart TD
    subgraph TransformasiProfilLulusan["REKONSTRUKSI PROFIL KELULUSAN PESANTREN"]
        LulusanTerkotak["PROFIL PARSIAL & DIKOTOMIS (TRADISIONAL)<br/>• Teknokrasi pragmatis atau isolasi tradisional.<br/>• Kehampaan spiritual & ketiadaan kepemimpinan khidmah.<br/>• Gagap menghadapi tantangan peradaban modern."]
        
        TUMBUH["INSAN KAMIL KHADIMUL UMMAH (TUMBUH)<br/>• 3 Pilar: Integritas Ruhiyah, Penguasaan Sains-Turats, & Khidmah.<br/>• 21st Century Skills (4Cs) & Literasi Teknologi Global.<br/>• Siap Memimpin & Mengabdi di Seluruh Penjuru Dunia."]
        
        LulusanTerkotak ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsInsanKamilSalaf["DOKTRIN INSAN KAMIL DALAM TURATS"]
        AyatKhalifah["QS. Al-Baqarah [2]: 30:<br/>إِنِّي جَاعِلٌ فِي الْأَرْضِ خَلِيفَةً<br/>(Sesungguhnya Aku Hendak Menjadikan Seorang Khalifah Pemimpin di Muka Bumi!)"] --> Inti["Hakikat Profil Lulusan:<br/>Pribadi Paripurna yang Memadukan Penghambaan Ikhlas Kepada Allah dengan Pengelolaan Kemakmuran Peradaban"]
        Ghazali["Al-Ghazali (Mizanul Amal):<br/>Kesempurnaan Manusia Adalah Mengintegrasikan 'Ilm (Akal), 'Amal (Ibadah), & Akhlaq (Adab)"] --> Inti
        Jili["Al-Jili (Al-Insan Al-Kamil):<br/>Manifestasi Sempurna Sifat-Sifat Mulia Kenabian dalam Kehidupan Nyata"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsGraduateAttributes4Cs["SINTESIS GRADUATE ATTRIBUTES & 4Cs SKILLS"]
        GraduateAttributes["Graduate Attributes Framework (Barrie, 2006):<br/>• Kompetensi transformatif menyeluruh yang melampaui konten mata pelajaran: Global Citizenship, Lifelong Learning, & Ethical Leadership."]
        
        Skills4Cs["21st Century Skills (Partnership for 21st Century Learning):<br/>• 1. Critical Thinking & Problem Solving.<br/>• 2. Creativity & Innovation.<br/>• 3. Collaboration & Team Leadership.<br/>• 4. Communication & Cultural Agility."]
        
        SelfDeterminationDeci["Autonomous Self-Regulation (Deci & Ryan):<br/>• Kemandirian intrinsik yang kokoh dalam menjaga prinsip moral tanpa pengawasan."]
        
        GraduateAttributes & Skills4Cs & SelfDeterminationDeci ==> StandarProfilTUMBUH["PROFIL LULUSAN PARIPURNA"]
    end
```
...
```mermaid
flowchart LR
    J1["JENJANG J1 (Kelas 7)<br/>Fondasi Adaptasi & Kemandirian Fisik"]
    --> J2["JENJANG J2 (Kelas 8)<br/>Habituasi Ibadah & Disiplin 5S"]
    --> J3["JENJANG J3 (Kelas 9–10)<br/>Kematangan SEL & Khidmah Desa"]
    --> J4["JENJANG J4 (Kelas 11–12)<br/>Servant Leadership & Capstone Project"]
    --> Alumni["ALUMNI PARIPURNA<br/>Insan Kamil Khadimul Ummah"]
```
...
```mermaid
flowchart TD
    subgraph ProtokolTransisiAlumni["PROTOKOL TRANSISI KELULUSAN TIER 1"]
        Step1["1. RETREAT INTENSIF 'MUHASABAH TRANSISI PERADABAN' BERSAMA PIMPINAN PESANTREN<br/>• Pimpinan menegaskan: 'Kalian dididik bukan untuk bersembunyi di menara gading, melainkan untuk menjadi garam & lentera di tengah masyarakat'."]
        
        Step2["2. PENYUSUNAN DOKUMEN PERSONAL LIFE-MISSION BLUEPRINT 10 TAHUN<br/>• Santri M merancang rencana studi universitas, target menjaga muraja'ah 30 juz, & program dakwah profesi."]
        
        Step3["3. MENTORSHIP SATU-PADA-SATU BERSAMA ALUMNI SENIOR YANG SUKSES BERKARIR GLOBAL<br/>• Alumni membagikan pengalaman nyata menjaga shalat jamaah & integritas moral di universitas top dunia."]
        
        Step4["4. PENGUKUHAN SUMPAH ALUMNI KHADIMUL UMMAH & KESIAPAN TRANSISI 100%<br/>• Kecemasan sirna; Santri M melangkah wisuda dengan mantap, percaya diri, & siap memimpin di kampus."]
...
```mermaid
flowchart TD
    subgraph TigaPilarProfilKelulusan["TIGA PILAR PROFIL LULUSAN ALUMNI TUMBUH"]
        P1["I. PILAR INTEGRITAS RUHIYAH & ADAB<br/>• Salimul Aqidah bertauhid murni, Shahihul Ibadah istiqomah, & Matinul Khuluq beradab.<br/>• Hafizh Al-Qur'an mutqin & teguh menjaga muru'ah penuntut ilmu."]
        
        P2["II. PILAR KECERDASAN SAINS & TURATS<br/>• Menguasai literasi kitab kuning Turats & metodologi sains-teknologi modern.<br/>• Nalar kritis (Critical Thinking), bilingual aktif (Arab-Inggris), & pemecah masalah (Problem Solver)."]
        
        P3["III. PILAR KEPEMIMPINAN KHIDMAH & PERADABAN<br/>• Berjiwa pelayan umat (Servant Leader), mandiri finansial halal, & anti-feodalisme.<br/>• Menghasilkan karya nyata pengabdian masyarakat (Capstone Project)."]
