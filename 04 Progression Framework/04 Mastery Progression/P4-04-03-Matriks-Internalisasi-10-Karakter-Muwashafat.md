...
```mermaid
flowchart TD
    subgraph TransformasiMatriksKarakter["REKONSTRUKSI MATRIKS 10 KARAKTER MUWASHAFAT"]
        SloganAbstrak["SLOGAN INDAH TANPA MATRIKS OPERASIONAL (TRADISIONAL)<br/>• Target karakter hanya retorika di dinding.<br/>• Tanpa indikator pembeda antara kelas 7 & kelas 12.<br/>• Evaluasi karakter subjektif & tidak terekam resmi."]
        
        TUMBUH["MATRIKS MASTER 10 KARAKTER MUWASHAFAT (TUMBUH)<br/>• 40 Sel Indikator Operasional Lintas Jenjang J1–J4.<br/>• Ranah Afektif Krathwohl: Receiving -> Characterization.<br/>• Transkrip Karakter Santri 360 (TKS-360) Terverifikasi."]
...
```mermaid
flowchart TD
    subgraph SainsAfektifDanKarakter["SINTESIS KRATHWOHL & LICKONA"]
        KrathwohlAffective["Krathwohl's Affective Taxonomy (1964):<br/>• 1. Receiving (Menerima nilai adab).<br/>• 2. Responding (Merespon & mempraktikkan).<br/>• 3. Valuing (Menghargai nilai sebagai prinsip).<br/>• 4. Organizing (Menata prioritas nilai).<br/>• 5. Characterization (Karakter mendarah daging)."]
        
        LickonaTriad["Lickona's Moral Triad (1991):<br/>• Moral Knowing -> Moral Feeling -> Moral Action."]
        
        BanduraSelfEfficacy["Self-Efficacy in Character Formation:<br/>• Keyakinan diri santri dalam mempertahankan akhlak mulia di tengah tantangan."]
        
        KrathwohlAffective & LickonaTriad & BanduraSelfEfficacy ==> StandarMatriksTUMBUH["MATRIKS 10 KARAKTER MUWASHAFAT"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaEkologi10Karakter24Jam["REKAYASA 10 KARAKTER DALAM JADWAL ASRAMA"]
        PagiSpiritual["SUBUH-PAGI: Salimul Aqidah, Shahihul Ibadah, & Haritsun Ala Waqtih (Munajat & Tahfizh)."]
        SiangKognitif["SIANG: Mutsaqqaful Fikr & Munazhzham fi Syuunih (Madrasah & Manajemen 5S)."]
        SoreFisik["SORE: Qawiyyul Jism, Matinul Khuluq, & Qadirun Alal Kasb (Bela Diri & Koperasi)."]
        MalamSosial["MALAM: Mujahadatun Linafsih & Nafi'un Lighairih (Muhasabah & Tutor Sebaya)."]
        
        PagiSpiritual ~~~ SiangKognitif ~~~ SoreFisik ~~~ MalamSosial
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRekalibrasiKarakter["PROTOKOL REKALIBRASI KARAKTER TIER 3"]
        Tahap1["1. MEDIASI RESTORATIF & PENGINGAT MAQAM KESATRIA OLEH GURU BESAR BELA DIRI<br/>• Pelatih bela diri menegur: 'Pendekar Thifan sejati membela yang lemah (*Himayatudh Dhu'afa*), bukan menindas sesama muslim'."]
        
        Tahap2["2. PENUGASAN KHUSUS MENJADI 'GUARDIAN SEKURITI ADIK KELAS' DI ASRAMA J1<br/>• Santri D ditugaskan mengawal & melindungi adik kelas baru saat jam belajar malam & menyeberang jalan."]
        
        Tahap3["3. WORKSHOP PENGENDALIAN AMARAH (IDARATUL GHADHAB) BERSAMA KONSELOR BK<br/>• Santri D dilatih teknik relaksasi wudhu & zikir peredam emosi saat merasa tersinggung."]
        
        Tahap4["4. HASIL KESEIMBANGAN KARAKTER KSATRIA BERADAB (INSAN KAMIL)<br/>• Sikap intimidasi lenyap 100%; Santri D menjadi pelindung yang sangat dihormati & dicintai seluruh adik kelas."]
...
```mermaid
flowchart TD
    subgraph ArsitekturSepuluhKarakter["EMPAT PILAR 10 KARAKTER MUWASHAFAT TUMBUH"]
        PilarRuh["I. PILAR INTEGRITAS RUHIYAH<br/>• 1. Salimul Aqidah (Aqidah Bersih & Murni).<br/>• 2. Shahihul Ibadah (Ibadah Shahih Sesuai Sunnah).<br/>• 3. Mujahadatun Linafsih (Pengendalian Hawa Nafsu)."]
        
        PilarFisik["II. PILAR KELAYAKAN RAGA & WAKTU<br/>• 4. Qawiyyul Jism (Fisik Kuat, Bugar, & Sehat).<br/>• 5. Haritsun Ala Waqtih (Manajemen Waktu Efisien).<br/>• 6. Munazhzham fi Syuunih (Keteraturan Hidup 5S)."]
        
        PilarAkal["III. PILAR KECERDASAN & KEMANDIRIAN<br/>• 7. Mutsaqqaful Fikr (Wawasan Luas & Kritis).<br/>• 8. Qadirun Alal Kasb (Kemandirian Finansial Halal)."]
        
        PilarSosial["IV. PILAR AKHLAK & KEMANFAATAN SOSIAL<br/>• 9. Matinul Khuluq (Akhlak Mulia & Beradab).<br/>• 10. Nafi'un Lighairih (Bermanfaat Bagi Peradaban Umat)."]
        
        PilarRuh ~~~ PilarFisik ~~~ PilarAkal ~~~ PilarSosial
    end
```
