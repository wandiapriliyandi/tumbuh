...
```mermaid
flowchart TD
    subgraph TransformasiKontinuumAdab["REKONSTRUKSI KONTINUUM ADAB THALABUL ILMI"]
        AdabFormalisme["FORMALISME SEMU & KESOMBONGAN ILMU (TRADISIONAL)<br/>• Menunduk di depan kyai, mengumpat di belakang.<br/>• Meremehkan kawan yang lambat & mendebat kusir.<br/>• Kitab diletakkan sembarangan & dilangkahi."]
        
        TUMBUH["KONTINUUM ADAB THALABUL ILMI INTERNALISATIF (TUMBUH)<br/>• 4 Domain: Adab pada Diri, Guru, Kawan, & Kitab.<br/>• Rest's Moral Components: Kepekaan, Nalar, & Aksi Moral.<br/>• Muru'ah Thullabul Ilmi: Integritas adab lahir & batin 24 jam."]
        
        AdabFormalisme ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsAdabThalabulIlmi["DOKTRIN ADAB SALAFUSH SHALIH"]
        AtsarMalik["Wasiat Imam Malik (Hilyatul Auliya'):<br/>تَعَلَّمِ الْأَدَبَ قَبْلَ أَنْ تَتَعَلَّمَ الْعِلْمَ<br/>(Pelajarilah Adab Sebelum Engkau Mempelajari Ilmu!)"] --> Inti["Hakikat Adab Thalabul Ilmi:<br/>Ilmu Tidak Akan Berkah Tanpa Penghormatan Tulus Kepada Guru & Kitab"]
        IbnJamaah["Ibnu Jama'ah (Tadzkiratus Sami'):<br/>Adab Penuntut Ilmu Meliputi 12 Adab Diri, 12 Adab Guru, & 8 Adab Kitab"] --> Inti
        Zarnuji["Az-Zarnuji (Ta'limul Muta'allim):<br/>Tidaklah Seseorang Meraih Ilmu Kecuali dengan Memuliakannya (At-Ta'dzim)"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsMoralAgencyAdab["SINTESIS REST & BANDURA DALAM ADAB"]
        Rest4Components["Rest's Four-Component Model (1986):<br/>• 1. Moral Sensitivity (Kepekaan Adab).<br/>• 2. Moral Judgment (Penalaran Adab Syar'i).<br/>• 3. Moral Motivation (Niat Ikhlas Lillah).<br/>• 4. Moral Character / Implementation (Keteguhan Praktik Adab)."]
        
        BanduraMoralAgency["Moral Agency & Social Modeling (Bandura):<br/>• Qudwah guru & pengurus asrama menjadi model primer pembentukan adab refleks santri."]
        
        TadibEpistemology["Al-Attas Ta'dib Framework:<br/>• Penanaman adab adalah proses pengenalan & pengakuan tempat yang tepat bagi segala ciptaan Allah."]
        
        Rest4Components & BanduraMoralAgency & TadibEpistemology ==> StandarAdabTUMBUH["KONTINUUM ADAB TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaEkologiAdab24Jam["REKAYASA EKOLOGI ADAB MAJELIS"]
        RakKitabTinggi["1. RAK KITAB MULIA (MINIMAL 1 METER DARI LANTAI): Larangan mutlak meletakkan kitab di lantai atau di bawah kaki."]
        AdabMajelis["2. STANDAR DUDUK TAWADHU' HALAQAH: Duduk bersila rapi/iftirasy menghadap kiblat & menyimak mata guru."]
        PapanNashihat["3. PAPAN WASIAT ADAB SALAF: Menampilkan kutipan mutiara adab Imam Syafi'i & Ibnu Jama'ah di lorong."]
        TradisiKhidmah["4. TRADISI MERAWAT GURU & ASRAMA: Santri membersihkan mimbar guru & membawakan kitab sebagai kehormatan."]
        
        RakKitabTinggi ~~~ AdabMajelis ~~~ PapanNashihat ~~~ TradisiKhidmah
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRestorasiAdab["PROTOKOL RESTORASI ADAB & TAWADHU' TIER 2"]
        Step1["1. DIALOG PRIBADI EMPATIK BERSAMA GURU SENIOR BA'DA KELAS<br/>• Ustadz mengingatkan dengan lembut: 'Kepintaranmu karunia Allah nak, namun iblis binasa bukan karena bodoh, melainkan karena sombong (*Kibr*)'."]
        
        Step2["2. PENUGASAN KHUSUS MENJADI 'TUTOR PENDAMPING DENGAN KESABARAN PENUH'<br/>• Santri Z ditugaskan mendampingi teman yang ditertawakannya setiap sore hingga lancar membaca bab tersebut."]
        
        Step3["3. BEDAH KITAB 'TADZKIRATUS SAMI'' BAB ADAB MENYIMAK & TAWADHU'<br/>• Santri Z menulis esai refleksi: 'Mengapa Imam Atha' bin Abi Rabah Mendengarkan Hadits yang Sudah Dihafalnya Seolah Belum Pernah Mendengarnya'."]
        
        Step4["4. HASIL TRANSFORMASI ADAB & KELAHIRAN PRIBADI TAWADHU' PARIPURNA<br/>• Sikap sombong sirna total; Santri Z menjadi pendengar setia di kelas, menghormati guru, & sangat dicintai teman-temannya."]
...
```mermaid
flowchart TD
    subgraph TanggaKontinuumAdab["EMPAT TANGGA KONTINUUM ADAB THALABUL ILMI (J1–J4)"]
        Level1["TANGGA 1 (JENJANG J1): ADAB LAHIRIAH & HIGIENITAS DASAR<br/>• Menundukkan pandangan, mencium tangan guru dengan ta'dzim, & mengucapkan salam.<br/>• Menjaga kebersihan mushaf, tidak melangkahi kitab, & duduk tertib di halaqah."]
        
        Level2["TANGGA 2 (JENJANG J2): ADAB KESUNGGUHAN & PEMULIAAN SARANA<br/>• Mencatat penjelasan guru dengan tulisan rapi, datang sebelum ustadz hadir di majelis.<br/>• Memelihara kitab dengan sampul rapi & membawa buku catatan di setiap pengajian."]
        
        Level3["TANGGA 3 (JENJANG J3): ADAB DIALOGIS, TAWADHU', & EMPATI SEBAYA<br/>• Bertanya dengan santun, tidak memotong ucapan, & menghargai pendapat kawan.<br/>• Tawadhu' atas ilmu yang dimiliki, menjadi tutor sabar bagi kawan yang tertinggal."]
        
        Level4["TANGGA 4 (JENJANG J4): ADAB TRANSMISI SANAD & MURU'AH PENUNTUT ILMU<br/>• Menjaga muru'ah (kehormatan diri) di mana pun berada, menjaga sanad keilmuan.<br/>• Menyebarkan ilmu dengan penuh keikhlasan, mengayomi junior, & berkhidmat bagi umat."]
