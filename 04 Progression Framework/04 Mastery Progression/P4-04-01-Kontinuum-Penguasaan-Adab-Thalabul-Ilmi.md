...
```mermaid
graph TD
    AdabMastery["Kontinuum Penguasaan Adab Thalabul 'Ilmi"]
    AdabMastery --> L1_Adab["Level 1: External Compliance (T1)<br/>Menghadiri kelas tepat waktu & duduk rapi karena aturan sekolah."]
    AdabMastery --> L2_Adab["Level 2: Respectful Habituation (T2)<br/>Mempersiapkan alat tulis/kitab mandiri & menjaga kebersihan majlis ilmu."]
    AdabMastery --> L3_Adab["Level 3: Internalized Reverence (T3)<br/>Menyimak penjelasan ustadz dengan khusyuk & mentazhimkan ilmu sebagai jalan kedekatan Allah."]
    AdabMastery --> L4_Adab["Level 4: Exemplary Embodiment (T4)<br/>Adab memancar alami, menjadi teladan majlis ilmu, & mengamalkan ilmu (*'Amal Bil 'Ilmi*)."]
```
