...
```mermaid
flowchart TD
    subgraph TransformasiAsesmenKarakter["REKONSTRUKSI ASESMEN KARAKTER SANTRI"]
        NilaiAbstrakSubjektif["NILAI AKHLAK ABSTRAK SEPIHAK (TRADISIONAL)<br/>• Huruf A/B/C diisi tanpa bukti logbook faktual.<br/>• Sangat rentan Halo Effect & bias subjektif pengasuh.<br/>• Rapor kelulusan tidak memuat rekam jejak karakter."]
        
        TUMBUH["EVALUASI MASTERY & TRANSKRIP TKS-360 (TUMBUH)<br/>• Triangulasi 360: Diri, Sebaya, Musyrif, & Munaqasyah.<br/>• Rubrik analitik berbasis bukti perilaku 24 jam.<br/>• Dokumen resmi Transkrip Karakter Santri penyerta ijazah."]
        
        NilaiAbstrakSubjektif ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsTadilusSyuhudSalaf["DOKTRIN VERIFIKASI KEADILAN SALAF"]
        UmarSyuhud["Atsar Umar bin Al-Khattab RA:<br/>هَلْ جَاوَرْتَهُ؟ هَلْ سَافَرْتَ مَعَهُ؟ هَلْ عَامَلْتَهُ بِالدِّينَارِ وَالدِّرْهَمِ؟ فَإِنَّكَ لَا تَعْرِفُهُ حَتَّى تُجَرِّبَهُ فِي هَذِهِ الثَّلَاثِ<br/>(Apakah Engkau Pernah Bertetangga Dengannya? Bersafar Dengannya? Bermuamalah Uang Dengannya? Jika Belum Maka Engkau Belum Mengenal Karakternya!)"] --> Inti["Hakikat Asesmen 360 Derajat:<br/>Karakter Sejati Teruji dalam Interaksi Nyata Kehidupan Asrama 24 Jam"]
        KhatibBaghdadi["Al-Khatib Al-Baghdadi (Al-Kifayah):<br/>Syarat Ta'dil Perawi Berdasarkan Bukti Nyata Istiqomah Sepanjang Waktu"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Pengujian Batiniah Murid Melalui Penugasan Nyata Khidmah Masyarakat"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsEvaluasiMasteryKarakter["SINTESIS MASTERY GRADING & 360 FEEDBACK"]
        MasteryGradingGuskey["Mastery-Based Assessment (Guskey, 2010):<br/>• Penilaian berbasis pencapaian kriteria kompetensi eksplisit, bukan perbandingan kurva lonceng normatif.<br/>• Remediasi berkelanjutan: Santri diberi kesempatan memperbaiki diri hingga mencapai Mastery."]
        
        Feedback360Edwards["360-Degree Assessment Model (Edwards & Ewen):<br/>• Mengumpulkan data multi-perspektif: Self-Evaluation, Peer Review, Musyrif Observation, & External Juror."]
        
        AuthenticAssessmentWiggins["Authentic Assessment (Wiggins, 1998):<br/>• Menguji kompetensi melalui penugasan dunia nyata (Capstone Project)."]
        
        MasteryGradingGuskey & Feedback360Edwards & AuthenticAssessmentWiggins ==> StandarAsesmenTUMBUH["SISTEM EVALUASI MASTERY TKS-360"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurDataTranskripKarakter["ALUR PEMROSESAN DATA TRANSKRIP TKS-360"]
        Input1["1. INPUT HARIAN: Logbook Musyrif Kamar (Form LOK-NL) & Presensi Masjid Otomatis."]
        Input2["2. INPUT PEKANAN: Jurnal Refleksi Mandiri Santri (Form Kasyf adz-Dzat)."]
        Input3["3. INPUT SEMESTERAN: Sima'an Ukhuwah Sebaya (Peer Review Kamar)."]
        Input4["4. INPUT KELULUSAN: Nilai Sidang Munaqasyah Capstone Civilizational Project."]
        
        Input1 & Input2 & Input3 & Input4 ==> EngineSIM["ENGINE ANALITIK SIM INTIZHAM PESANTREN"]
        EngineSIM ==> CetakTKS["DOKUMEN RESMI TRANSKRIP KARAKTER SANTRI (TKS-360)"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolBandingNilaiKarakter["PROTOKOL BANDING NILAI KARAKTER TIER 1"]
        StepA["1. PENGAJUAN FORM BANDING ASESMEN OLEH SANTRI Q DISERTAI BUKTI SURAT POSKESTREN<br/>• Santri Q mengisi Form Banding Karakter secara santun di portal SIM Intizham."]
        
        StepB["2. SIDANG VERIFIKASI TIM PENJAMIN MUTU BERSAMA MUSYRIF KAMAR & DOKTER PIKET<br/>• Tim QA mengonfrontasi data: Terbukti Santri Q sedang menjalankan khidmah agung merawat kawan sakit (*Al-Itsar*)."]
        
        StepC["3. REVISI SKOR KARAKTER SECARA TRANSPARAN & APRESIASI RESMI ATAS AKHLAK ITSAR<br/>• Skor Matinul Khuluq direvisi menjadi 4.0 (Mumtaz) & musyrif meminta maaf secara terbuka."]
        
        StepD["4. HASIL INTEGRITAS SISTEM EVALUASI & AKUNTABILITAS TKS-360 PARIPURNA<br/>• Santri merasa keadilan ditegakkan, kepercayaan pada sistem pengasuhan mengakar kokoh, & ijazah terbit dengan nilai sempurna."]
...
```mermaid
flowchart TD
    subgraph ArsitekturBobotAsesmen360["STRUKTUR PEMBOBOTAN ASESMEN TKS-360"]
        B1["1. LOGBOOK OBSERVASI MUSYRIF & GURU (40% BOBOT)<br/>• Konsistensi ibadah, kedisiplinan 5S kamar, ketepatan waktu, & adab majelis."]
        
        B2["2. KARYA CAPSTONE PROJECT & JAM KHIDMAH (30% BOBOT)<br/>• Laporan dampak pengabdian desa binaan & akumulasi $\ge 210\text{ jam}$ khidmah."]
        
        B3["3. EVALUASI SEBAYA & UKHUWAH KAMAR (15% BOBOT)<br/>• Penilaian teman sekamar atas sifat tidak egois, suka menolong, & anti-ejekan."]
        
        B4["4. REFLEKSI DIRI & JURNAL KASYF ADZ-DZAT (15% BOBOT)<br/>• Kejujuran mengakui kekurangan & konsistensi muhasabah belajar mandiri."]
        
        B1 & B2 & B3 & B4 ==> SkorAkhir["NILAI KOMPOSIT TRANSKRIP KARAKTER SANTRI (TKS-360)"]
    end
```
