...
```mermaid
graph TD
    ServantModel["Model Servant Leadership Santri TUMBUH"]
    ServantModel --> Humility["1. Khidmah & Tawadhu'<br/>Pemimpin santri berada di barisan paling depan dalam memberikan pelayanan & teladan."]
    ServantModel --> Protection["2. Perlindungan & Pengayoman<br/>Melindungi adik kelas dari segala bentuk rasa takut, kekerasan, & intimidasi."]
    ServantModel --> Empowerment["3. Pemberdayaan Sebaya (Empowerment)<br/>Mendorong potensi adik kelas agar tumbuh menjadi calon pemimpin berikutnya."]
```
