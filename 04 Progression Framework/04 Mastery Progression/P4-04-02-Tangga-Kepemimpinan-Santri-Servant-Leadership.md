...
```mermaid
flowchart TD
    subgraph TransformasiKepemimpinanSantri["REKONSTRUKSI TANGGA KEPEMIMPINAN SANTRI"]
        FeodalOtoriter["SENIORITAS FEODAL & KUASA PAKSAAN (TRADISIONAL)<br/>• Senior menuntut dilayani; membentak & menghukum fisik.<br/>• Kontrol berbasis ketakutan & ketiadaan empati.<br/>• Organisasi santri menjadi sumber trauma kekerasan."]
        
        TUMBUH["QIYADAH KHADIMAH & SERVANT LEADERSHIP (TUMBUH)<br/>• Sayyidul Qaumi Khadimuhum: Memimpin dengan melayani.<br/>• Kouzes-Posner 5 Practices: Model the Way & Encourage Heart.<br/>• Pengurus OPPM menjadi teladan & pelindung sejati adik kelas."]
        
        FeodalOtoriter ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsQiyadahKhadimahSalaf["DOKTRIN KEPEMIMPINAN KHADIMAH TURATS"]
        HaditsKhadim["HR. Abu Nu'aim:<br/>سَيِّدُ الْقَوْمِ خَادِمُهُمْ فِي السَّفَرِ<br/>(Pemimpin Suatu Kaum Adalah Orang yang Paling Banyak Melayani Mereka!)"] --> Inti["Hakikat Kepemimpinan Qiyadah Khadimah:<br/>Kekuasaan Adalah Pelayanan, Pengorbanan, & Pertanggungjawaban di Hadapan Allah"]
        UmarBayan["Atsar Umar bin Al-Khattab:<br/>Ketakutan Pemimpin Akan Keadilan Bagi Makhluk Terlemah Sekalipun"] --> Inti
        Mawardi["Al-Mawardi (Al-Ahkam As-Sulthaniyyah):<br/>Tujuan Utama Kepemimpinan Adalah Menjaga Agama & Mengatur Kesejahteraan Umat"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsKepemimpinanModern["SINTESIS SERVANT LEADERSHIP & KOUZES-POSNER"]
        GreenleafServantModel["Servant Leadership (Greenleaf, 1970):<br/>• Keinginan alami untuk melayani terlebih dahulu (Serve First), baru kemudian memimpin (Lead).<br/>• Kriteria sukses: Apakah orang yang dipimpin bertumbuh lebih sehat, bijak, & mandiri?"]
        
        KouzesPosnerModel["5 Exemplary Practices (Kouzes & Posner, 2012):<br/>• 1. Model the Way (Keteladanan Qudwah).<br/>• 2. Inspire a Shared Vision (Inspirasi Visi).<br/>• 3. Challenge the Process (Inovasi Maslahat).<br/>• 4. Enable Others to Act (Pemberdayaan Tim).<br/>• 5. Encourage the Heart (Apresiasi Batin)."]
        
        BassTransformational["Transformational Influence:<br/>• Memimpin dengan menginspirasi nilai luhur, bukan transaksi imbalan sempit."]
        
        GreenleafServantModel & KouzesPosnerModel & BassTransformational ==> StandarQiyadahTUMBUH["TANGGA KEPEMIMPINAN SANTRI"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaOPPMTanpaPrivilese["REKAYASA ORGANISASI OPPM KHIDMAH"]
        KeteladananFisik["1. PRINSIP KERJA BAKTI TERDEPAN: Ketua & Pengurus OPPM memegang sapu/cangkul di barisan paling depan."]
        MakanBersama["2. SATU MEJA MAKAN: Pengurus OPPM makan menu yang sama, di ruang yang sama, & mengantre bersama santri lain."]
        KotakSuaraAman["3. KOTAK SUARA RESTORATIF: Saluran pengaduan anonim bagi adik kelas untuk melaporkan penyalahgunaan wewenang senior."]
        EvaluasiPekanan["4. SIDANG EVALUASI KHIDMAH PEKANAN: Evaluasi 360 derajat atas pelayanan pengurus terhadap kenyamanan asrama."]
        
        KeteladananFisik ~~~ MakanBersama ~~~ KotakSuaraAman ~~~ EvaluasiPekanan
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRestrukturisasiOPPM["PROTOKOL DELEGASI KEPEMIMPINAN TIER 2"]
        StepA["1. KONSELING DE-STRES & AFIRMASI DUKUNGAN PENUH DARI KEPALA PENGASUHAN<br/>• Kepala Asrama merangkul Santri Y: 'Amanah ini bukan untuk kamu pikul sendirian; pemimpin sejati adalah yang menumbuhkan tim'."]
        
        StepB["2. WORKSHOP 'ENABLE OTHERS TO ACT' & PENATAAN ULANG DESKRIPSI KERJA OPPM<br/>• Setiap anggota divisi diberikan tanggung jawab spesifik yang terukur disertai wewenang penuh mengambil keputusan."]
        
        StepC["3. IMPLEMENTASI SISTEM DASHBOARD OPERASIONAL DIGITAL SIM INTIZHAM<br/>• Pembagian tugas piket & pengawasan dilakukan transparan melalui aplikasi digital terpadu."]
        
        StepD["4. HASIL KEBANGKITAN KEPEMIMPINAN TIM & SUKSES OPPM PARIPURNA<br/>• Burnout sirna 100%, divisi berjalan mandiri, & Santri Y sukses memimpin program akbar pesantren dengan senyuman bahagia."]
...
```mermaid
flowchart TD
    subgraph TanggaKepemimpinanEmpatEtape["EMPAT TANGGA KEPEMIMPINAN SANTRI (J1–J4)"]
        Etape1["TANGGA 1 (JENJANG J1): SELF-LEADERSHIP & COOPERATIVE FOLLOWER<br/>• Memimpin diri sendiri: Bangun mandiri, menata kamar 5S, & disiplin ibadah.<br/>• Menjadi anggota tim kamar yang taat, kooperatif, & menghargai pemimpin."]
        
        Etape2["TANGGA 2 (JENJANG J2): TEAM STEWARDSHIP & PEER ACCOUNTABILITY<br/>• Memimpin regu kecil: Penanggung jawab piket kamar, meja makan, & halaqah.<br/>• Saling mengingatkan kawan sebaya dengan santun tanpa menyakiti hati."]
        
        Etape3["TANGGA 3 (JENJANG J3): EMPATHETIC MENTORSHIP & PROJECT LEADER<br/>• Menjadi kakak asuh pelindung (*Restorative Buddy*) bagi santri junior J1.<br/>• Memimpin brigade pengabdian masyarakat (*Ekspedisi Santri Bina Desa*)."]
        
        Etape4["TANGGA 4 (JENJANG J4): AUTHENTIC SERVANT LEADER & CIVILIZATIONAL CATALYST<br/>• Menjadi pengurus sentral organisasi santri (OPPM) dengan prinsip melayani.<br/>• Mengeksekusi karya Capstone Project pengabdian & menjadi penggerak peradaban."]
