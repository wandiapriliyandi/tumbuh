...
```mermaid
flowchart TD
    subgraph TransformasiSistemGateway["REKONSTRUKSI SISTEM TRANSISI KENAIKAN JENJANG"]
        KenaikanOtomatis["KENAIKAN OTOMATIS BERBASIS WAKTU (TRADISIONAL)<br/>• Santri naik kelas hanya karena faktor usia/waktu.<br/>• Akumulasi ketidakmampuan membaca kitab & adab.<br/>• Tanpa portofolio bukti otentik perilaku 24 jam."]
        
        TUMBUH["EVIDENCE-BASED PROGRESSION GATEWAYS (TUMBUH)<br/>• 3 Gerbang Gateway Utama (G1 J1->J2, G2 J2->J3, G3 J3->J4).<br/>• Verifikasi Portofolio Bukti 4 Ranah (Tahfizh, 5S, Turats, Khidmah).<br/>• Remediasi Tier 2 Catch-Up bagi yang belum memenuhi standar."]
        
        KenaikanOtomatis ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsImtihanKafaahSalaf["DOKTRIN UJIAN KELAYAKAN SALAF"]
        HaditsMuadz["HR. Abu Dawud No. 3592:<br/>Ujian Kompetensi Nabi SAW Kepada Mu'adz bin Jabal Sebelum Diutus Memimpin Yaman"] --> Inti["Hakikat Gateway Transisi:<br/>Menguji Kesiapan Nalar, Amal, & Integritas Sebelum Diberi Tanggung Jawab Lebih Tinggi"]
        KhatibBaghdadi["Al-Khatib Al-Baghdadi (Al-Faqih):<br/>Larangan Meluluskan Murid Sebelum Menguji Kedalaman Pemahaman & Wara'nya"] --> Inti
        Zarkasyi["Az-Zarkasyi (Al-Bahrul Muhith):<br/>Ijazah Sanad Adalah Amanah Persaksian Hakiki"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsOBEDanGatewayAssessment["SINTESIS OUTCOME-BASED EDUCATION & GATEWAY"]
        SpadyOBEModel["Outcome-Based Education (Spady, 1994):<br/>• 1. Clarity of Focus (Kejelasan target akhir).<br/>• 2. Design Down (Menurunkan kurikulum dari profil lulusan).<br/>• 3. High Expectations (Standar mutu tinggi tanpa kompromi).<br/>• 4. Expanded Opportunities (Pemberian kesempatan remediasi hingga tuntas)."]
        
        CriterionReferenced["Criterion-Referenced Assessment (Popham):<br/>• Menilai capaian santri terhadap standar mutlak (Rubrik), bukan terhadap rata-rata kawan sekelas."]
        
        AuthenticEvidence["Portfolios of Authentic Evidence:<br/>• Bukti rekaman video qira'ah kitab, logbook jam khidmah, & laporan Capstone."]
        
        SpadyOBEModel & CriterionReferenced & AuthenticEvidence ==> StandarGatewayTUMBUH["ARSITEKTUR GATEWAY TRANSISI"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurVerifikasiGatewayDigital["ALUR VERIFIKASI GATEWAY TRANSISI"]
        UnggahBukti["1. PENGAJUAN PORTOFOLIO: Santri mengunggah bukti hafalan, jam khidmah, & sertifikat life-skills."]
        VerifikasiOtomatis["2. AUDIT SISTEM SIM INTIZHAM: Pengecekan otomatis presensi shalat & kelengkapan berkas."]
        SidangVerifikasi["3. SIDANG MUNAQASYAH TRANSISI: Uji praktik lisan di hadapan dewan penguji."]
        SidangPleno["4. SIDANG PLENO YUDISIUM PENGASUHAN: Pengesahan kelulusan gateway atau penugasan Tier 2 Catch-Up."]
        
        UnggahBukti --> VerifikasiOtomatis --> SidangVerifikasi --> SidangPleno
    end
```
...
flowchart TD
    subgraph ProtokolRemediasiKhidmah["PROTOKOL SERVICE CATCH-UP GATEWAY G3"]
        ...
        Step3["3. EVALUASI KEPUASAN MASYARAKAT DESA BINAAN & REFLEKSI JURNAL MAHABBAH<br/>• Tokoh masyarakat desa memberikan testimoni apresiasi tinggi atas ketulusan Santri N mengajar anak-anak."]
        
        Step4["4. PENGESAHAN KELULUSAN GATEWAY G3 DENGAN PREDIKAT LENGKAP<br/>• Total jam khidmah tuntas 60 jam; Santri N dilantik naik ke Jenjang J4 dengan jiwa kepemimpinan pelayan sejati."]
...
```mermaid
flowchart TD
    subgraph TigaGerbangGatewayTransisi["TIGA GERBANG GATEWAY TRANSISI KENAIKAN JENJANG"]
        G1["GERBANG G1: TRANSISI INISIASI MENJU HABITUASI (J1 -> J2)<br/>• 1. Skor SKA-F1 $\ge 2.50$ (Tuntas Adaptasi & Safe Haven).<br/>• 2. Sertifikasi Life-Skills: Cuci pakaian mandiri & lemari 5S.<br/>• 3. Tahfizh: Minimal 1–2 Juz Mutqin & Kitab *Safinah* tuntas.<br/>• 4. Khidmah: Akumulasi minimal 30 Jam Khidmah Asrama."]
        
        G2["GERBANG G2: TRANSISI HABITUASI MENUJU SEL (J2 -> J3)<br/>• 1. Skor LMK-F2 $\ge 2.75$ (Otomatisasi Shalat Shubuh $\ge 90\%$).<br/>• 2. Sertifikasi Kamar 5S Bintang Lima & P3K Dasar Luka Ringan.<br/>• 3. Tahfizh: Akumulatif 3–4 Juz Mutqin & Kitab *Taqrib* tuntas.<br/>• 4. Khidmah: Akumulasi minimal 45 Jam Khidmah Asrama."]
        
        G3["GERBANG G3: TRANSISI SEL MENUJU LEADERSHIP (J3 -> J4)<br/>• 1. Skor SKE-F3 $\ge 3.00$ (Kematangan Emosi & Bebas Geng).<br/>• 2. Evaluasi Mentorship Restorative Buddy bagi santri J1 tuntas.<br/>• 3. Tahfizh: Akumulatif 5–6 Juz Mutqin & Baca Kitab Gundul.<br/>• 4. Khidmah: Akumulasi minimal 60 Jam Khidmah Mengajar Desa."]
