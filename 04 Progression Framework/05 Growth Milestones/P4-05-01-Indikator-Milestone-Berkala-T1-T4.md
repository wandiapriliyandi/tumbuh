...
```mermaid
graph LR
    M3["Month 3 Checkpoint<br/>Adaptasi Bi'ah & Tuntas Homesick"] --> M6["Month 6 Checkpoint<br/>Habituasi Rutin Kamar (Gateway T1->T2)"]
    M6 --> M12["Month 12 Checkpoint<br/>Kemandirian Sholat & Mutabaah Mandiri"]
    M12 --> M24["Month 24 Checkpoint<br/>Internalisasi Nilai & SEL (Gateway T2->T3)"]
    M24 --> M36["Month 36 Checkpoint<br/>Leadership Qudwah & Khidmah (Gateway T3->T4)"]
```
