...
```mermaid
graph TD
    Taxonomy["Taksonomi Belajar Terpadu TUMBUH"]
    Taxonomy --> T1_Cognitive["T1: Mengingat & Memahami (Remembering & Understanding)<br/>Mengenal hukum fiqih dasar, membaca Al-Qur'an tartil, & menghafal mufradat."]
    Taxonomy --> T2_Cognitive["T2: Menerapkan & Mengorganisasi (Applying & Practicing)<br/>Menerapkan fiqih ibadah dalam harian & mengorganisasi waktu muraja'ah."]
    Taxonomy --> T3_Cognitive["T3: Menganalisis & Menginternalisasi (Analyzing & Internalizing)<br/>Menganalisis hikmah syari'at, illat hukum, & meyakini kebenaran ajaran."]
    Taxonomy --> T4_Cognitive["T4: Evaluasi, Kreasi & Khidmah (Evaluating, Creating & Teaching)<br/>Mengevaluasi isu syar'i kontemporer, mengajar adik kelas, & karya tulis ilmiah."]
```
