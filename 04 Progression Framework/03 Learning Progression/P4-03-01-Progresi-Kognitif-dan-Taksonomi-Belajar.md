...
```mermaid
flowchart TD
    subgraph TransformasiTaksonomiBelajar["REKONSTRUKSI TAKSONOMI BELAJAR DINIYYAH"]
        HafalanMekanis["HAFALAN MEKANIS TANPA PEMAHAMAN (TRADISIONAL)<br/>• Hafal matan di luar kepala tapi buta makna & i'rab.<br/>• Santri pasif; hanya meniru tanpa nalar kritis.<br/>• Diniyyah terpisah dari amal nyata & sains modern."]
        
        TUMBUH["TAKSONOMI INTEGRATIF MARATIB AL-MA'RIFAH (TUMBUH)<br/>• Maratib al-'Ilm: Hifzh -> Fahm -> Istinbath -> 'Amal.<br/>• Cognitive Load Theory: Penahapan bertahap ramah otak.<br/>• Nalar kritis syariat beradab: Melahirkan ulama transformatif."]
        
        HafalanMekanis ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMaratibIlmiSalaf["DOKTRIN MARATIB AL-'ILM DALAM TURATS"]
        SufyanTsauri["Atsar Sufyan Ats-Tsauri (Al-Jami' Ibnu Abdil Barr):<br/>أَوَّلُ الْعِلْمِ الِاسْتِمَاعُ، ثُمَّ الْإِنْصَاتُ، ثُمَّ الْحِفْظُ، ثُمَّ الْفَهْمُ، ثُمَّ الْعَمَلُ، ثُمَّ النَّشْرُ<br/>(Tahapan Ilmu: Mendengar, Menyimak, Menghafal, Memahami, Mengamalkan, & Menyebarkan)"] --> Inti["Hakikat Taksonomi Diniyyah:<br/>Evolusi Kognitif dari Penguasaan Teks Menuju Aplikasi Peradaban"]
        Ghazali["Al-Ghazali (Ihya'):<br/>Tingkatan Pengetahuan: Dari Taqlid Awam, Dalil Ijmali, Menuju Kasyf Hakikat"] --> Inti
        Syathibi["Asy-Syathibi (Al-Muwafaqat):<br/>Ilmu yang Tidak Membuahkan Amal Adalah Beban Hujah yang Memberatkan"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsKognisiDanTaksonomi["SINTESIS TEORI KOGNITIF & BLOOM REVISI"]
        CognitiveLoadSweller["Cognitive Load Theory (Sweller, 1988):<br/>• Mengelola Intrinsic Load (materi nahwu/fiqh).<br/>• Mereduksi Extraneous Load (metode mengajar membingungkan).<br/>• Mengoptimalkan Germane Load (pembentukan skema memori jangka panjang)."]
        
        AndersonBloomTaxonomy["Revised Bloom's Taxonomy (2001):<br/>• Remember -> Understand -> Apply -> Analyze -> Evaluate -> Create.<br/>• Terintegrasi dengan Maratib al-'Ilm Turats."]
        
        MetacognitiveFlavell["Metacognitive Regulation (Flavell):<br/>• Kesadaran santri memantau proses berpikir & mengidentifikasi kebingungannya sendiri."]
        
        CognitiveLoadSweller & AndersonBloomTaxonomy & MetacognitiveFlavell ==> StandarKognisiTUMBUH["TAKSONOMI BELAJAR DINIYYAH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaDidaktik24Jam["REKAYASA RITME DIDAKTIK 24 JAM"]
        PagiFresh["1. SESI TALAQQI & HIFZH SUBUH (05.30–06.30): Korteks prefrontal segar untuk retensi teks mutqin."]
        SiangKelas["2. SESI FAHM & TAFSHIL MADRASAH (07.30–12.00): Bedah kaidah nahwu, syarah kitab, & studi teks."]
        SoreAplikasi["3. SESI TATHBIQ & BAHTSUL MASAIL SORE (16.00–17.15): Diskusi interaktif studi kasus hukum praktis."]
        MalamRefleksi["4. SESI MURAJA'AH MANDIRI MALAM (20.00–21.00): Pengulangan metakognitif & jurnal hikmah santri."]
        
        PagiFresh ~~~ SiangKelas ~~~ SoreAplikasi ~~~ MalamRefleksi
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiIrab["PROTOKOL REMEDIASI KOGNITIF TIER 2"]
        Step1["1. DEKONSTRUKSI HAFALAN VERBAL MENJADI PETA KONSEP STRUKTURAL (CONCEPT MAPPING)<br/>• Guru nahwu memandu Santri R memetakan bait Alfiyyah ke dalam diagram alur fungsi kalimat."]
        
        Step2["2. PRAKTIK HARIAN 'BEDAH SATU HADITS GUNDUL' BERSAMA TUTOR SEBAYA J4<br/>• Santri R berlatih memberi harakat, mengurai kedudukan i'rab, & menghubungkannya dengan bait matan."]
        
        Step3["3. SIMULASI DEBAT NAHWU INTERAKTIF DI FORUM BAHTSUL MASAIL ASRAMA<br/>• Santri R diminta mempertahankan analisis i'rabnya di hadapan forum santri madrasah."]
        
        Step4["4. HASIL KEMAHIRAN QIRA'AH KITAB GUNDUL & PEMAHAMAN MENDALAM<br/>• Dalam 4 pekan, inert knowledge lenyap; Santri R lancar membaca kitab Turats gundul dengan alasan gramatikal shahih."]
...
```mermaid
flowchart TD
    subgraph TanggaKognitifDiniyyah["ENAM TANGGA KOGNITIF DINIYYAH TUMBUH (MARATIB AL-MA'RIFAH)"]
        Level1["LEVEL 1: AL-HIFZH WAL ISTIZHKAR (MENGINGAT TEKS TAHFIZH)<br/>• Hafal lafazh Al-Qur'an, Hadits Arbain, & Matan Fiqh/Nahwu dasar secara mutqin."]
        
        Level2["LEVEL 2: AL-FAHM WAL ISTI'AB (MEMAHAMI MAKNA TEKSTUAL)<br/>• Mampu menerjemahkan kata per kata & menjelaskan makna global (*Syarah Ijmali*)."]
        
        Level3["LEVEL 3: AT-TATHBIQ WAL 'AMAL (MENERAPKAN DALAM IBADAH NYATA)<br/>• Mengamalkan kaidah fiqh wudhu, shalat, & adab harian dengan benar."]
        
        Level4["LEVEL 4: AT-TAHLIL WAL I'RAB (MENGANALISIS STRUKTUR & DALIL)<br/>• Mengurai struktur i'rab gramatikal & mendudukkan dalil hukum syar'i (*Takhrij*)."]
        
        Level5["LEVEL 5: AT-TAQWIM WAL MUQARANAH (MENGEVALUASI & MEMBANDINGKAN)<br/>• Membandingkan pendapat ulama mazhab dengan argumen ilmiah yang santun."]
        
        Level6["LEVEL 6: AL-IBTIKAR WAL KHIDMAH (MENCIPTAKAN SOLUSI PERADABAN)<br/>• Merumuskan karya Capstone maslahat umat & mensintesis ilmu syariat dengan sains."]
