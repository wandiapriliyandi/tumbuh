...
```mermaid
flowchart TD
    subgraph TransformasiRegulasiBelajar["REKONSTRUKSI REGULASI BELAJAR SANTRI"]
        BelajarPasifCramming["BELAJAR PASIF & SISTEM KEBUT SEMALAM (TRADISIONAL)<br/>• Belajar hanya saat diawasi atau menjelang ujian.<br/>• Ilusi kompetensi: Merasa paham padahal hanya membaca sekilas.<br/>• Tanpa refleksi evaluasi strategi belajar harian."]
        
        TUMBUH["SELF-REGULATED LEARNING & MUHASABAH (TUMBUH)<br/>• Siklus Zimmerman: Perencanaan, Kontrol Aksi, & Refleksi.<br/>• Jurnal Kasyf adz-Dzat: Menulis evaluasi metakognitif malam.<br/>• Pembelajar mandiri sepanjang hayat yang haus ilmu."]
        
        BelajarPasifCramming ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMuhasabahSalaf["DOKTRIN MUHASABAH DALAM TURATS"]
        UmarKhattab["Atsar Umar bin Al-Khattab RA:<br/>حَاسِبُوا أَنْفُسَكُمْ قَبْلَ أَنْ تُحَاسَبُوا، وَزِنُوا أَنْفُسَكُمْ قَبْلَ أَنْ تُوزَنُوا<br/>(Hisablah Diri Kalian Sendiri Sebelum Kalian Dihisab di Hari Kiamat!)"] --> Inti["Hakikat Metakognisi Islami:<br/>Muraqabah & Muhasabah: Menyadari, Memantau, & Memperbaiki Amal Belajar"]
        Muhasibi["Al-Harits Al-Muhasibi (Ar-Ri'ayah):<br/>Memeriksa Niat di Awal Amal, Menjaga Ikhlas Saat Beramal, & Mengoreksi Diri di Akhir Amal"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Enam Etape Muhasabah: Musyharathah, Muraqabah, Muhasabah, Mu'aqabah, Mujahadah, wa Mu'atabah"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsMetakognisiDanSRL["SINTESIS ZIMMERMAN SRL & FLAVELL"]
        ZimmermanCyclic["Triadic Cyclical Model (Zimmerman, 2002):<br/>• 1. Forethought Phase (Goal Setting & Strategic Planning).<br/>• 2. Performance Phase (Self-Control & Self-Observation).<br/>• 3. Self-Reflection Phase (Self-Judgment & Adaptive Reaction)."]
        
        FlavellComponents["Metacognitive Framework (Flavell, 1979):<br/>• Person Knowledge (memahami gaya belajar diri), Task Knowledge (tingkat kesulitan materi), & Strategy Knowledge (teknik menghafal tepat)."]
        
        PintrichMotivation["Self-Efficacy & Goal Orientation (Pintrich):<br/>• Motivasi intrinsik berorientasi penguasaan ilmu (Mastery Goals)."]
        
        ZimmermanCyclic & FlavellComponents & PintrichMotivation ==> StandarSRLTUMBUH["MODEL METAKOGNISI TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaSesiHeningMalam["REKAYASA SESI HENING MUHASABAH ASRAMA"]
        Sesi1["1. BEL BELAJAR MANDIRI (20.00–20.45): Santri mengeksekusi target belajar/muraja'ah tanpa gawai & tanpa suara gaduh."]
        Sesi2["2. SESI HENING 'KASYF ADZ-DZAT' (20.45–21.00): Lampu temaram; santri menulis jurnal evaluasi diri harian."]
        Sesi3["3. SHARING METAKOGNITIF SEKAMAR (21.00–21.15): Santri saling menceritakan kendala materi & solusi belajarnya."]
        Sesi4["4. DOA TIDUR & PENETAPAN NIAT ESOK HARI: Tidur dalam kondisi hati tenang & target esok hari tertata jelas."]
        
        Sesi1 --> Sesi2 --> Sesi3 --> Sesi4
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiCramming["PROTOKOL REMEDIASI METAKOGNISI TIER 2"]
        Step1["1. PERAWATAN PEMULIHAN FISIK DI POSKESTREN & EDUKASI NEUROSAINS TIDUR<br/>• Dokter Poskestren menjelaskan: 'Otak mengkonsolidasikan hafalan saat tidur nyenyak; begadang merusak sirkuit memori'."]
        
        Step2["2. WORKSHOP 'DEKOMPOSISI TARGET MIKRO' BERSAMA KONSELOR BK ASRAMA<br/>• Santri G dilatih memecah 1 bab tebal menjadi target 2 halaman per hari selama 14 hari sebelum ujian."]
        
        Step3["3. IMPLEMENTASI JURNAL HARIAN 'KASYF ADZ-DZAT' BERSAMA MENTOR CICO<br/>• Santri G mencatat durasi belajar 30 menit setiap malam & menandai indikator pemahaman warna (Hijau/Kuning/Merah)."]
        
        Step4["4. HASIL KEMANDIRIAN BELAJAR PARIPURNA & PRESTASI AKADEMIK PRIMA<br/>• Santri G tidak pernah begadang lagi, tidur teratur jam 21.30, & meraih nilai A pada seluruh ujian madrasah dengan rileks."]
...
```mermaid
flowchart TD
    subgraph SiklusSRLMuhasabah["SIKLUS SELF-REGULATED LEARNING ISLAMI (SRL-MUHASABAH)"]
        Fase1["1. FASE FORETHOUGHT (MUSYARATHAH & TAHLIL AN-NIYYAH)<br/>• Menata niat ikhlas lillahi ta'ala.<br/>• Menetapkan target spesifik (misal: hafal 1 halaman Fathul Qarib).<br/>• Memilih strategi belajar (spaced retrieval / mind mapping)."]
        
        Fase2["2. FASE PERFORMANCE (MUJAHADAH & MURAQABAH)<br/>• Eksekusi belajar fokus 45 menit tanpa distraksi.<br/>• Memantau pemahaman mandiri: Apakah saya benar-benar paham?<br/>• Mengatur emosi tenang saat menghadapi materi sulit."]
        
        Fase3["3. FASE SELF-REFLECTION (MUHASABAH & MU'ATABAH)<br/>• Mengisi Jurnal Refleksi Harian Kasyf adz-Dzat.<br/>• Mengevaluasi: Berapa persen target tercapai? Mengapa belum lancar?<br/>• Merumuskan rencana perbaikan adaptif untuk esok hari."]
