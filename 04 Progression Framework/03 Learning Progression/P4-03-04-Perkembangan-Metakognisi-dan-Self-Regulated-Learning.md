...
```mermaid
graph LR
    Plan["1. Forethought Phase<br/>Perencanaan Target Belajar & Strategi"] --> Monitor["2. Performance Phase<br/>Pemantauan Proses Belajar & Kontrol Atensi"]
    Monitor --> Reflect["3. Self-Reflection Phase<br/>Evaluasi Diri & Penyesuaian Strategi"]
    Reflect --> Plan
```
...
graph TD
    ...
    SRL_Prog --> T4_SRL["T4: Autonomous Learning & Tutoring<br/>Menguasai regulasi kognisi utuh; mampu membimbing strategi belajar orang lain."]
```
