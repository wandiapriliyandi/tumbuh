...
```mermaid
flowchart TD
    subgraph TransformasiDidaktikTurats["REKONSTRUKSI METODOLOGI PENGAJARAN TURATS"]
        MaknaniPasif["BANDONGAN MASSAL & PENYALIN PASIF (TRADISIONAL)<br/>• Santri hanya menyalin makna pegon tanpa membaca aktif.<br/>• Buta huruf terhadap teks gundul baru tanpa makna.<br/>• Nahwu terpisah dari praktik qira'ah kitab."]
        
        TUMBUH["SOROGAN AKTIF & COMPREHENSIBLE INPUT (TUMBUH)<br/>• Sorogan tatap muka: Santri membaca & mengurai i'rab.<br/>• Progresi Bertahap: Matan -> Syarah -> Hasyiyah.<br/>• Munaqasyah Sanad: Menjamin kefasihan membaca kitab gundul."]
        
        MaknaniPasif ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsQiraahSyaikhSalaf["TRADISI QIRA'AH 'ALASY-SYAIKH DALAM TURATS"]
        KhatibBaghdadi["Al-Khatib Al-Baghdadi (Al-Jami'):<br/>الْقِرَاءَةُ عَلَى الشَّيْخِ أَرْفَعُ دَرَجَاتِ التَّحَمُّلِ؛ لِأَنَّهَا تَمْنَعُ التَّصْحِيفَ وَتَكْشِفُ عَنْ فَهْمِ الطَّالِبِ<br/>(Membaca Langsung di Hadapan Guru Adalah Derajat Tertinggi Karena Mencegah Kesalahan & Menguji Pemahaman)"] --> Inti["Hakikat Didaktik Turats:<br/>Sorogan Mandiri Adalah Kunci Keotentikan Sanad & Kemahiran Literasi"]
        Nawawi["An-Nawawi (Majmu'):<br/>Adab Penuntut Ilmu Adalah Membaca Teks Sendiri & Menyaring Maknanya Bersama Guru"] --> Inti
        IbnJamaah["Ibnu Jama'ah (Tadzkiratus Sami'):<br/>Larangan Belajar Hanya dari Lembaran Kertas Tanpa Bimbingan Guru (La Ta'khudzul Ilma min Shahafi)"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsLinguistikTerapanTurats["SINTESIS LINGUISTIK TERAPAN & COGNITIVE APPRENTICESHIP"]
        KrashenInput["Krashen's Input Hypothesis (i+1):<br/>• Teks kitab dipelajari dengan tingkat kesulitan satu tingkat di atas kemampuan santri saat ini (Scaffolded Comprehension)."]
        
        CognitiveApprenticeship["Cognitive Apprenticeship (Collins et al., 1989):<br/>• Modeling (guru mendemonstrasikan) -> Coaching (mendampingi santri membaca) -> Scaffolding -> Fading -> Articulation -> Reflection."]
        
        AppliedSyntaxArabiyyah["Applied Arabic Syntax (I'rab Terapan):<br/>• Menghubungkan fungsi gramatika dengan semantik makna hukum syariat."]
        
        KrashenInput & CognitiveApprenticeship & AppliedSyntaxArabiyyah ==> StandarDidaktikTurats["DIDAKTIK TURATS TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaHalaqahTurats24Jam["EMPAT FORMAT HALAQAH TURATS ASRAMA"]
        SoroganSubuh["1. HALAQAH SOROGAN FAJAR (06.00–07.00): Santri membaca teks gundul secara individual di hadapan ustadz."]
        BandonganSiang["2. HALAQAH BANDONGAN MADRASAH (08.00–11.30): Guru membedah syarah kitab & mendudukkan dalil khilafiyyah."]
        MudzakarahSore["3. HALAQAH MUDZAKARAH KAMAR (16.00–17.00): Santri junior menyimak pembacaan kitab oleh santri senior J4."]
        BahtsulMasailMalam["4. FORUM BAHTSUL MASAIL PEKANAN: Santri membedah kasus hukum kontemporer merujuk kitab klasik."]
        
        SoroganSubuh ~~~ BandonganSiang ~~~ MudzakarahSore ~~~ BahtsulMasailMalam
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiKitabGundul["PROTOKOL REMEDIASI LITERASI KITAB GUNDUL TIER 2"]
        Step1["1. ISOLASI DARI KITAB BERMAKNA & PEMBERIAN MUSHAF TEKS GUNDUL BERSIH<br/>• Ustadz mendampingi santri: 'Mulai hari ini kita belajar membaca teks bersih; jangan takut salah i'rab'."]
        
        Step2["2. PRAKTIK HARIAN 'IDENTIFIKASI 3 POLA UTAMA' (Mubtada-Khabar, Fi'il-Fa'il, & Inna wa Akhwatuha)<br/>• Santri P dibimbing mengenali pola-pola kalimat inti secara visual tanpa perlu menghafal rumus."]
        
        Step3["3. SESI SOROGAN INDIVIDUAL 15 MENIT SETIAP SUBUH DENGAN TEKNIK THINK-ALOUD<br/>• Santri P membaca keras & mengartikulasikan alasan i'rabnya secara langsung di hadapan guru."]
        
        Step4["4. HASIL KEMANDIRIAN QIRA'AH KITAB GUNDUL BERSIH PARIPURNA<br/>• Dalam 5 pekan, ketergantungan lenyap; Santri P lancar membaca Fathul Qarib gundul dengan intonasi & i'rab tepat."]
...
```mermaid
flowchart TD
    subgraph ArsitekturKurikulumTurats["STRUKTUR KURIKULUM TURATS BERJENJANG TUMBUH"]
        T1["JENJANG J1: TALAQQI MATAN & NAHWU DASAR<br/>• Fiqh: *Safinatun Naja* & *Sullamut Taufiq* (Terharakat).<br/>• Bahasa: *Al-Jurumiyyah* & *Al-Amtsilah At-Tashrifiyyah*.<br/>• Akhlak: *Taisirul Khalaq* & *Washaya Al-Aba' lil Abna'*."]
        
        T2["JENJANG J2: SYARAH IJMALI & I'RAB APLIKATIF<br/>• Fiqh: *Matan Al-Ghayah wat Taqrib* & *Fathul Qarib* awal.<br/>• Bahasa: *Nazham Al-Imrithi* & *Mukhtashar Jiddan*.<br/>• Hadits: *Al-Arbain An-Nawawiyyah* (Teks Gundul Awal)."]
        
        T3["JENJANG J3: QIRA'AH GUNDUL & USHUL FIQH<br/>• Fiqh: *Fathul Qarib* tuntas & *Kifayatul Akhyar* pilihan.<br/>• Bahasa: *Alfiyyah Ibnu Malik* (500 Bait) & *Mutammimah*.<br/>• Ushul Fiqh: *Al-Waraqat* (Imam Al-Haramain Al-Juwaini)."]
        
        T4["JENJANG J4: HASYIYAH & SINTESIS PERADABAN<br/>• Fiqh: *Fathul Mu'in* & *Bidayatul Mujtahid* (Muqaranah).<br/>• Qawa'id: *Al-Asybah wan Nazha'ir* (As-Suyuthi).<br/>• Tasawwuf/Adab: *Ihya' 'Ulumiddin* & *Tadzkiratus Sami'*."]
