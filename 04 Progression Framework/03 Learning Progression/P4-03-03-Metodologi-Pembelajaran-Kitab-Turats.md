...
```mermaid
graph TD
    TuratsMethod["3 Metode Pengajaran Kitab Turats"]
    TuratsMethod --> Bandongan["1. Bandongan / Halqaah (Talaqqi)<br/>Kiai/Ustadz membaca & menerjemahkan; santri menyimak & mencatat makna (Makna Gandul/Harfiyah)."]
    TuratsMethod --> Sorogan["2. Sorogan (Individual Reading Check)<br/>Santri membaca kitab di hadapan ustadz untuk menguji tata bahasa (Nahwu-Shorof) & pemahaman."]
    TuratsMethod --> BahtsulFormat["3. Bahtsul Masa'il (Discussion & Problem Solving)<br/>Diskusi analisis kasus hukum syar'i berbasis referensi kitab mu'tabarah melintasi T3-T4."]
```
