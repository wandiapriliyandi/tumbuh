...
```mermaid
graph TD
    Learn["Arsitektur Progresi Kognitif & Metakognisi Santri"]
    Learn --> T1_Learn["T1: Fondasi & Ketaatan Pengenalan (Remembering & Comprehending)<br/>• Fokus: Membaca Al-Qur'an tartil, hafalan juz dasar, & memahami fiqih thaharah/sholat."]
    Learn --> T2_Learn["T2: Aplikasi & Habituasi Belajar (Applying & Practicing)<br/>• Fokus: Setoran hafalan rutin, pemahaman terjemah/hikmah, & jadwal muraja'ah mandiri."]
    Learn --> T3_Learn["T3: Analisis & Metakognisi (Analyzing & Reflecting)<br/>• Fokus: Memahami illat hukum fiqih, strategi retensi hafalan mandiri, & studi kitab mu'tabarah."]
    Learn --> T4_Learn["T4: Sintesis & Khidmah Keilmuan (Creating & Teaching)<br/>• Fokus: Hafalan mutqin, mampu mengajar (*Tadris/Badal Ustadz*), & analisis masalah kontemporer."]
```
...
```mermaid
graph LR
    Sabaq["1. Sabaq (Ziyadah)<br/>Hafalan Baru Harian<br/>(Working Memory Integration)"]
    Sabqi["2. Sabqi (Muraja'ah Dekat)<br/>Pengulangan Hafalan 1-7 Hari Terakhir<br/>(Short-Term Retention)"]
    Manzil["3. Manzil (Muraja'ah Jauh)<br/>Pengulangan Keseluruhan Juz<br/>(Long-Term Memory Consolidation)"]
