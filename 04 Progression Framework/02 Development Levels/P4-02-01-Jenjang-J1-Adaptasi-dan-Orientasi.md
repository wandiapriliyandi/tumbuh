...
```mermaid
flowchart TD
    subgraph DialektikaKepengasuhanJ1["DIALEKTIKA KEPENGASUHAN SANTRI KELAS 7"]
        KutubA["PENELANTARAN KEMANDIRIAN EKSTREM (SINK-OR-SWIM)<br/>• Santri dilepas tanpa diajari cara cuci baju & menata lemari.<br/>• Barang hilang, baju berjamur, stres & putus asa.<br/>• Angka santri minta pindah sekolah sangat tinggi."]
        
        KutubB["OVERPROTEKSI TANPA LATIHAN MANDIRI<br/>• Semua diurusi petugas; santri pasif & manja.<br/>• Kematangan motorik & regulasi diri kerdil.<br/>• Ketergantungan kronis pada orang lain."]
        
        TUMBUH["JENJANG J1 TUMBUH (SCAFFOLDED ADAPTATION)<br/>• Musyrif memodelkan & mendampingi langsung (Scaffolding).<br/>• Sistem Restorative Buddy J4–J1: Kakak asuh pelindung.<br/>• Pembiasaan bertahap menuju kemandirian bahagia."]
...
```mermaid
flowchart LR
    subgraph TuratsMarhalatutTamyiz["DOKTRIN TAMYIZ DALAM SUNNAH & TURATS"]
        HaditsRifq["HR. Muslim No. 2594:<br/>إِنَّ الرِّفْقَ لَا يَكُونُ فِي شَيْءٍ إِلَّا زَانَهُ وَلَا يُنْزَعُ مِنْ شَيْءٍ إِلَّا شَانَهُ<br/>(Kelembutan Tidaklah Berada pada Sesuatu Melainkan Menghiasinya, & Tidaklah Dicabut Melainkan Memperburuknya)"] --> Inti["Hakikat Bimbingan J1:<br/>Menanamkan Disiplin dengan Kelembutan Kasih Sayang, Bukan Kekerasan"]
        Ghazali["Al-Ghazali (Ihya'):<br/>Anak Usia Awal Membutuhkan Apresiasi Pujian atas Kebaikan & Bimbingan Halus atas Kesalahan"] --> Inti
        Ulwan["Abdullah Nashih Ulwan (Tarbiyatul Aulad):<br/>Pentingnya Keteladanan Langsung (Tarbiyah bil Qudwah) di Awal Baligh"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsVygotskyDanAttachmentJ1["SINTESIS VYGOTSKY & ATTACHMENT J1"]
        ZPDTheory["Zone of Proximal Development (Vygotsky, 1978):<br/>• Jarak antara apa yang bisa dikerjakan mandiri vs yang bisa dikerjakan dengan bimbingan pendidik.<br/>• Scaffolding: Musyrif mendampingi mencuci baju & merapikan lemari di 3 pekan pertama."]
        
        AttachmentSecurity["Attachment Security in Dormitory (Bowlby):<br/>• Rasa aman emosional menjadi fondasi keberanian santri belajar & menghafal Al-Qur'an."]
        
        NeurobiologyEarlyPFC["Early Adolescent Prefrontal Maturation:<br/>• Membutuhkan struktur rutinitas eksternal yang jelas & konsisten."]
        
        ZPDTheory & AttachmentSecurity & NeurobiologyEarlyPFC ==> StandarJenjangJ1["PEDOMAN KEPENGASUHAN J1"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaAsramaJenjangJ1["REKAYASA ASRAMA SANTRI KELAS 7"]
        RasioMusyrif["1. RASIO PENGAWASAN HANGAT (1 Musyrif : 12 Santri): Musyrif tidur satu blok bersama santri J1."]
        ZonaLaundry["2. LIFE-SKILLS LAUNDRY STATION: Area cuci pakaian dengan petunjuk visual bergambar ramah anak."]
        LabelLemari["3. KODIFIKASI 5S LEMARI: Setiap rak memiliki label panduan (Baju, Celana, Buku, Alat Mandi)."]
        ZonaUkhuwah["4. KARPET UKHUWAH MALAM: Area melingkar di tengah kamar untuk curhat santri & baca doa bersama."]
        
        RasioMusyrif ~~~ ZonaLaundry ~~~ LabelLemari ~~~ ZonaUkhuwah
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolResolusiBarangTertukar["PROTOKOL PENATAAN BARANG PRIBADI TIER 2"]
        Step1["1. PENENANGAN EMOSI & PENYEDIAAN SERAGAM CADANGAN SEKETIKA OLEH MUSYRIF<br/>• Musyrif memeluk santri: 'Tenang nak, seragammu tidak hilang, hanya tertukar saat menjemur; ini seragam bersih cadangan untuk sekolah'."]
        
        Step2["2. OPERASI 'SISIR JEMURAN BERSAMA' & PENEMUAN SERAGAM ASLI SANTRI A<br/>• Musyrif & santri sekamar memeriksa jemuran bersama & menemukan seragam Santri A yang tertukar dengan kawan sekamar."]
        
        Step3["3. WORKSHOP 'PELABELAN NAMA PERMANEN' PADA SELURUH BARANG PRIBADI<br/>• Seluruh pakaian, ember, & buku Santri A dan kawan sekamar diberi label nama bordir/spidol permanen."]
        
        Step4["4. HASIL KETENANGAN ADAPTASI & KEMANDIRIAN PENATAAN LEMARI<br/>• Santri A tidak pernah kehilangan barang lagi, lemari bajunya rapi bintang lima, & ia ceria berangkat sekolah."]
...
```mermaid
flowchart TD
    subgraph ArsitekturProfilJenjangJ1["PROFIL KEMANDIRIAN SANTRI JENJANG J1 (KELAS 7)"]
        R1["1. DIMENSI RUHIYAH & IBADAH<br/>• Disiplin shalat 5 waktu berjamaah di masjid tepat waktu.<br/>• Hafalan Al-Qur'an mutqin 1–2 juz/tahun dengan tajwid makhraj shahih.<br/>• Pembiasaan zikir pagi-petang & adab makan/tidur islami."]
        
        R2["2. DIMENSI FISIK & LIFE-SKILLS<br/>• Keterampilan mencuci, menjemur, & melipat pakaian mandiri rapi.<br/>• Standar kebersihan kamar 5S: Kasur terlipat rapi seketika bangun tidur.<br/>• Kebugaran fisik aerobik dasar & sanitasi mandi teratur."]
        
        R3["3. DIMENSI KOGNITIF & MADRASAH<br/>• Ketuntasan pelajaran madrasah kelas 7 (Diniyyah & Umum).<br/>• Kebiasaan belajar mandiri 60 menit malam ba'da Isya'.<br/>• Kemampuan membaca kitab dasar (*Safinatun Naja / Taisirul Khalaq*)."]
        
        R4["4. DIMENSI SOSIAL-EMOSIONAL<br/>• Tuntas adaptasi homesickness $\le 40\text{ hari}$; ceria di asrama.<br/>• Ukhuwah kamar hangat, suka berbagi makanan, & anti-ejekan fisik.<br/>• Menuntaskan minimal 30 jam khidmah asrama per tahun ajaran."]
        
        R1 & R2 & R3 & R4 ==> OutputJ1["SANTRI J1: ADAPTIF, MANDIRI, ISTIQOMAH, & GEMBIRA"]
    end
```
...
```mermaid
flowchart LR
    G1["1. ADAPTASI ASRAMA<br/>Skor SKA-F1 $\ge 2.50$; 0% Homesick berat."]
    --> G2["2. LIFE-SKILLS MANDIRI<br/>Lulus Uji Praktik Cuci Baju & Lemari 5S."]
    --> G3["3. AKADEMIK & TAHFIZH<br/>Tuntas 1-2 Juz Mutqin & Rapor $\ge 75.0$."]
    --> G4["4. JAM KHIDMAH<br/>Tuntas $\ge 30\text{ Jam}$ Khidmah Asrama."]
```
