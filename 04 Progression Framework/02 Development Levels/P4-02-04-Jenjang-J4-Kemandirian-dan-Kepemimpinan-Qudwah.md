...
```mermaid
flowchart TD
    subgraph DialektikaKepemimpinanJ4["TRANSFORMASI KEPEMIMPINAN SANTRI SENIOR (J4)"]
        FeodalSenior["SENIORITAS FEODAL & HUKUMAN FISIK (TRADISIONAL)<br/>• Senior menuntut dilayani; membentak adik kelas.<br/>• Hukuman fisik melegitimasi rantai kekerasan asrama.<br/>• Kelulusan hanya dinilai dari ujian kertas kognitif."]
        
        TUMBUH["SERVANT LEADERSHIP & CAPSTONE TUMBUH (J4)<br/>• Pemimpin adalah pelayan: Memegang sapu paling depan.<br/>• Pengurus OPPM menjadi pelindung Zero-Bullying Policy.<br/>• Capstone Civilizational Project kelulusan di desa binaan."]
        
        FeodalSenior ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsQudwahKhulafa["DOKTRIN KEPEMIMPINAN KHULAFAUR RASYIDIN"]
        HaditsSayyid["HR. Abu Nu'aim:<br/>سَيِّدُ الْقَوْمِ خَادِمُهُمْ<br/>(Pemimpin Suatu Kaum Adalah Orang yang Paling Banyak Melayani Mereka!)"] --> Inti["Hakikat Kepemimpinan J4:<br/>Memimpin dengan Keteladanan Akhlak, Kerendahhatian, & Pengorbanan"]
        IbnTaimiyyah["Ibnu Taimiyyah (As-Siyasah Asy-Syar'iyyah):<br/>Amanah Kepemimpinan Adalah Menegakkan Keadilan & Mengayomi Kaum Lemah"] --> Inti
        Ghazali["Al-Ghazali (Nasihatul Muluk):<br/>Syarat Utama Pemimpin Adalah Tidak Sombong & Merasakan Penderitaan Rakyatnya"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsKepemimpinanModernJ4["SINTESIS SERVANT & TRANSFORMATIONAL LEADERSHIP"]
        ServantGreenleaf["Servant Leadership (Greenleaf, 2002):<br/>• Karakteristik: Listening, Empathy, Healing, Awareness, Persuasion, Conceptualization, Foresight, Stewardship, & Commitment to People's Growth."]
        
        TransformationalBass["Transformational Leadership (Bass & Avolio):<br/>• Idealized Influence (Qudwah), Inspirational Motivation, Intellectual Stimulation, & Individualized Consideration."]
        
        ActionLearningModel["Authentic Action Learning (Revans):<br/>• Belajar memimpin melalui eksekusi proyek nyata di masyarakat & refleksi mendalam."]
        
        ServantGreenleaf & TransformationalBass & ActionLearningModel ==> StandarJenjangJ4["PEDOMAN KEPENGASUHAN J4"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaAsramaJenjangJ4["REKAYASA ASRAMA SANTRI KELAS 11–12"]
        RuangOPPM["1. KANTOR SENTRAL OPPM KHIDMAH: Ruang manajemen operasional harian asrama berbasis data PBIS."]
        InkubasiMakerLab["2. MAKER LAB CAPSTONE PERADABAN: Pusat riset sosial & perancangan proposal bina desa."]
        KamarTutorSenior["3. BILIK RESTORATIVE BUDDY: Posko pendampingan santri senior untuk mengayomi adik kelas."]
        RuangNavigasiKampus["4. PUSAT KARIR & BEASISWA GLOBAL: Bimbingan bahasa Arab-Inggris & persiapan ujian masuk universitas."]
        
        RuangOPPM ~~~ InkubasiMakerLab ~~~ KamarTutorSenior ~~~ RuangNavigasiKampus
    end
```
...
flowchart TD
    subgraph ProtokolDeFeodalisasiOPPM["PROTOKOL DE-FEODALISASI KEPEMIMPINAN TIER 3"]
        ...
        Step4["4. LAHIRNYA KEPEMIMPINAN PELAYAN (SERVANT LEADERSHIP) SEJATI DI ASRAMA<br/>• Pengurus J4 mentransformasikan gaya kepemimpinan: selalu hadir 15 menit sebelum adzan & mengajak adik kelas dengan senyuman ramah."]
...
```mermaid
flowchart TD
    subgraph ArsitekturProfilJenjangJ4["PROFIL KEMANDIRIAN SANTRI JENJANG J4 (KELAS 11–12)"]
        P1["1. DIMENSI RUHIYAH & KEIKHLASAN PERADABAN<br/>• Keikhlasan amal murni (*Lillahi Ta'ala*), terbebas dari riya' jabatan OPPM.<br/>• Hafalan Al-Qur'an akumulatif 7–10 juz mutqin (atau 30 juz takhassus).<br/>• Qiyamullail istiqomah & adab thalabul ilmi paripurna."]
        
        P2["2. DIMENSI FISIK & KETAHANAN KERJA KERAS<br/>• Stamina fisik prima & ketahanan memimpin kerja bakti lapangan terdepan.<br/>• Menjaga kebersihan asrama 5S bintang lima tanpa kompromi.<br/>• Penguasaan keterampilan navigasi darurat & manajemen logistik asrama."]
        
        P3["3. DIMENSI KOGNITIF & INTEGRITAS ILMU<br/>• Mahir membaca, menerjemahkan, & mensyarah kitab Turats gundul lanjutan.<br/>• Kesiapan akademik menembus universitas terbaik nasional & internasional.<br/>• Menuntaskan karya Capstone Civilizational Project berbobot ilmiah."]
        
        P4["4. DIMENSI SERVANT LEADERSHIP & FILANTROPI<br/>• Memimpin organisasi OPPM dengan keteladanan fisik & kasih sayang (*Qudwah*).<br/>• Mengayomi seluruh santri junior & penegakan Zero-Bullying Policy 100%.<br/>• Menuntaskan minimal 75 jam khidmah pengabdian masyarakat per tahun."]
        
        P1 & P2 & P3 & P4 ==> OutputJ4["ALUMNI PARIPURNA: KHADIMUL UMMAH & PEMIMPIN PERADABAN GLOBAL"]
    end
```
...
```mermaid
flowchart LR
    G1["1. KEPEMIMPINAN OPPM<br/>Skor RKK-F4 $\ge 3.25$; Bebas Feodalisme / Kekerasan."]
    --> G2["2. CAPSTONE PROJECT<br/>Lulus Sidang Munaqasyah Pengabdian Desa Binaan."]
    --> G3["3. TAHFIZH & TURATS<br/>Tuntas 7-10 Juz Mutqin & Baca Kitab Gundul."]
    --> G4["4. JAM KHIDMAH<br/>Akumulasi $\ge 210\text{ Jam}$ Khidmah Selama 6 Tahun."]
```
