...
```mermaid
flowchart TD
    subgraph TransformasiPenangananTertinggal["REKONSTRUKSI PENANGANAN SANTRI TERTINGGAL"]
        Stigmatisasi["VONIS 'SANTRI BERMASALAH' & HUKUMAN (TRADISIONAL)<br/>• Labeling negatif yang merusak kepercayaan diri santri.<br/>• Santri tertinggal dibiarkan tanpa bimbingan metodologis.<br/>• Memicu keputusasaan & keinginan berhenti mondok."]
        
        TUMBUH["PROTOKOL TIER 2 CATCH-UP RESTORATIF (TUMBUH)<br/>• Response-to-Intervention (RTI) & Diagnosis Presisi.<br/>• Character Catch-Up Plan (CCUP) 30–60 Hari Terarah.<br/>• Pendampingan Musyrif Khusus & Tutor Sebaya: 100% Lolos Gateway."]
        
        Stigmatisasi ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMu'alajahRifq["DOKTRIN PENGOBATAN HATI DALAM TURATS"]
        HaditsMuawiyah["HR. Muslim No. 537:<br/>مَا رَأَيْتُ مُعَلِّمًا قَبْلَهُ وَلَا بَعْدَهُ أَحْسَنَ تَعْلِيمًا مِنْهُ؛ فَوَاللَّهِ مَا كَهَرَنِي وَلَا ضَرَبَنِي وَلَا شَتَمَنِي<br/>(Aku Tidak Pernah Melihat Pendidik yang Lebih Baik dari Nabi: Demi Allah Beliau Tidak Membentakku, Tidak Memukulku, & Tidak Mencelaku!)"] --> Inti["Hakikat Remediasi Tier 2:<br/>Membimbing Santri Tertinggal dengan Kesabaran, Kelembutan, & Metode Khusus"]
        Ghazali["Al-Ghazali (Ayyuhal Walad):<br/>Pendidik yang Bijak Laksana Dokter Ahli yang Memberikan Obat Sesuai Jenis Penyakit Pasien"] --> Inti
        Zarnuji["Az-Zarnuji (Ta'limul Muta'allim):<br/>Bab Penyebab Lemahnya Hafalan & Cara Mengobatinya"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsRTIDanTier2PBIS["SINTESIS RTI & TARGETED PBIS SUPPORT"]
        RTIModel["Response-to-Intervention Framework (Fuchs & Fuchs, 2006):<br/>• Tier 1: Universal High-Quality Instruction (80–85%).<br/>• Tier 2: Targeted Evidence-Based Small-Group Intervention (10–15%).<br/>• Tier 3: Intensive Individualized Support (1–5%)."]
        
        CheckInCheckOut["CICO Support System (Crone et al., 2010):<br/>• Monitoring harian bersama mentor: Pagi (Goal Setting) & Sore (Feedback Apresiasi)."]
        
        GrowthMindsetDweck["Growth Mindset Theory (Dweck, 2006):<br/>• Kegagalan transisi adalah proses belajar (*Not Yet*), bukan takdir kecerdasan tetap."]
        
        RTIModel & CheckInCheckOut & GrowthMindsetDweck ==> StandarCatchUpTUMBUH["PROTOKOL TIER 2 CATCH-UP"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurRujukanRemediasiTier2["ALUR PENANGANAN TRANSISI TERHAMBAT"]
        EWSAlert["1. TRIGGER DATA: Dashboard SIM Intizham Menandai Santri yang Tidak Mencapai Ambang Gateway."]
        SidangKasus["2. SIDANG KASUS TERBATAS: Musyrif Kamar, Wali Kelas, & Konselor BK Menentukan Diagnosis Masalah."]
        PenyusunanCCUP["3. PENYUSUNAN CHARACTER CATCH-UP PLAN (CCUP): Kontrak Belajar 30 Hari Bersama Santri."]
        EksekusiIntervensi["4. EKSEKUSI PENDAMPINGAN INTENSIF: Sesi CICO Harian, Tutor Sebaya, & Workshop Khusus."]
        ReEvaluasiGateway["5. RE-EVALUASI GATEWAY TRANSISI: Uji Ulang Kompetensi & Pelantikan Kenaikan Jenjang."]
        
        EWSAlert --> SidangKasus --> PenyusunanCCUP --> EksekusiIntervensi --> ReEvaluasiGateway
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiDigitalDetox["PROTOKOL DIGITAL DETOX & RESTORASI TIER 2"]
        Langkah1["1. PENYERAHAN PONSEL SECARA SUKARELA & SESI DIALOG RESTORATIF TANPA KEKERASAN<br/>• Konselor BK mengajak Santri E berdialog jujur: 'Ponsel ini merusak kesehatan otak & menghalangi hafalanmu; mari kita amankan'."]
        
        Langkah2["2. PROGRAM 'DIGITAL DETOX & REKONEKSI AL-QUR'AN' SELAMA 30 HARI<br/>• Santri E mengganti waktu gawai dengan terapi tadabbur Al-Qur'an 30 menit & olahraga bela diri sore."]
        
        Langkah3["3. MENTORING HARIAN CHECK-IN/CHECK-OUT (CICO) BERSAMA KEPALA ASRAMA<br/>• Santri E melapor setiap pagi jam 05.00 & malam jam 21.00 untuk evaluasi fokus target harian."]
        
        Langkah4["4. HASIL PEMULIHAN ADAB & KELANCARAN HAFALAN MUTQIN PARIPURNA<br/>• Dalam 3 pekan, adiksi hilang 100%, wajah kembali bercahaya, shalat shubuh di shaf awal, & hafalannya tuntas 6 juz."]
...
```mermaid
flowchart TD
    subgraph ArsitekturCatchUpTier2["KERANGKA KERJA TIER 2 CATCH-UP PBIS"]
        C1["PILAR 1: DIAGNOSIS MULTIDISIPLINER PRESISI<br/>• Mengurai akar masalah (faktor biologis, psikologis, keluarga, atau metode belajar).<br/>• Menghilangkan vonis moral sepihak; fokus pada perbaikan fungsional."]
        
        C2["PILAR 2: CHARACTER CATCH-UP PLAN (CCUP) 30–60 HARI<br/>• Sasaran target terukur, realistis, & disepakati bersama santri.<br/>• Pembagian peran pembimbing (Musyrif, Konselor BK, & Tutor Sebaya)."]
        
        C3["PILAR 3: SISTEM PENDAMPINGAN HARIAN CHECK-IN/CHECK-OUT (CICO)<br/>• Evaluasi harian 5 menit di awal & akhir hari untuk menjaga motivasi berprestasi.<br/>• Rasio penguatan positif 4:1 atas setiap kemajuan kecil yang dicapai."]
        
        C4["PILAR 4: SIDANG RE-EVALUASI GATEWAY TRANSISI ADIL<br/>• Uji ulang kompetensi secara transparan & bermartabat.<br/>• Pelantikan kenaikan jenjang resmi tanpa perlakuan diskriminatif."]
        
        C1 & C2 & C3 & C4 ==> OutputCatchUp["100% SANTRI TERTINGGAL BERHASIL MERAIH STANDAR GATEWAY"]
    end
```
