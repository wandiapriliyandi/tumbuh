...
```mermaid
flowchart TD
    subgraph TransformasiKomparasiJenjang["REKONSTRUKSI MATRIKS KOMPARASI JENJANG"]
        PenyeragamanKaku["PENYERAGAMAN BEBAN & KERANCUAN POLA ASUH (TRADISIONAL)<br/>• Ekspektasi sama rata tanpa membedakan usia 12 & 18 tahun.<br/>• Santri J1 dituntut mandiri instan; santri J4 dikekang.<br/>• Musyrif bingung memposisikan gaya kepengasuhan."]
        
        TUMBUH["MATRIKS KOMPARASI LINTAS JENJANG TUMBUH (J1–J4)<br/>• Peta pergeseran 10 dimensi perkembangan terukur.<br/>• Transisi peran musyrif: Dari Figur Lekat -> Mentor Strategis.<br/>• Keadilan ekspektasi: Beban bergeser selaras maturasi fitrah."]
        
        PenyeragamanKaku ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMaratibAulad["DOKTRIN PENAHAPAN USIA DALAM TURATS"]
        HaditsUqul["Atsar Ali bin Abi Thalib RA:<br/>خَاطِبُوا النَّاسَ عَلَى قَدْرِ عُقُولِهِمْ أَتُحِبُّونَ أَنْ يُكَذَّبَ اللَّهُ وَرَسُولُهُ؟<br/>(Ajaklah Manusia Berbicara Sesuai Tingkat Akal Mereka!)"] --> Inti["Hakikat Matriks Jenjang:<br/>Membedakan Ekspektasi & Metode Tarbiyah Sesuai Tahapan Usia Murid"]
        Ghazali["Al-Ghazali (Ihya'):<br/>Tarbiyah Anak Kecil dengan Kasih Sayang & Pujian; Tarbiyah Pemuda dengan Tanggung Jawab & Keteladanan"] --> Inti
        IbnQayyim["Ibnu Qayyim (Tuhfatul Maudud):<br/>Perbedaan Karakteristik Masa Tamyiz, Buluqh, & Rusyd"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPerkembanganKomparatif["SINTESIS TEORI PERKEMBANGAN KOMPARATIF"]
        PiagetStages["Piaget Cognitive Stages:<br/>• J1/J2: Concrete to Early Formal Operations.<br/>• J3/J4: Advanced Abstract Formal Operations & Metacognition."]
        
        KohlbergMoral["Kohlberg Moral Reasoning:<br/>• J1 (Pre-Conventional) -> J2 (Conventional Law & Order) -> J3/J4 (Post-Conventional Universal Principles)."]
        
        EisenbergProsocial["Eisenberg Prosocial Stages:<br/>• J1 (Needs-Oriented) -> J2 (Approval-Oriented) -> J3 (Empathic) -> J4 (Internalized Altruism)."]
        
        PiagetStages & KohlbergMoral & EisenbergProsocial ==> MatriksKomparasiTUMBUH["MATRIKS MASTER J1–J4"]
    end
```
...
```mermaid
flowchart LR
    J1["JENJANG J1 (KELAS 7)<br/>Pengawasan: Ketat & Hangat<br/>Rasio: 1 Musyrif : 12 Santri<br/>Fokus: Safe Haven & Life-Skills"]
    --> J2["JENJANG J2 (KELAS 8)<br/>Pengawasan: Terpola & Monitoring<br/>Rasio: 1 Musyrif : 18 Santri<br/>Fokus: Habituasi 5S & Rutinitas"]
    --> J3["JENJANG J3 (KELAS 9–10)<br/>Pengawasan: Fasilitatif & Dialogis<br/>Rasio: 1 Musyrif : 24 Santri<br/>Fokus: SEL, Buddy J1, & Desa"]
    --> J4["JENJANG J4 (KELAS 11–12)<br/>Pengawasan: Mentoring Strategis<br/>Rasio: 1 Musyrif : 30 Santri<br/>Fokus: Servant Leader & Capstone"]
```
...
```mermaid
flowchart TD
    subgraph ProtokolRekalibrasiDisiplin["PROTOKOL REKALIBRASI KEPENGASUHAN TIER 1 & 2"]
        StepA["1. PENGHENTIAN INSTAN HUKUMAN & PERLINDUNGAN EMOSI SANTRI J1 OLEH KEPALA PENGASUHAN<br/>• Kasur santri J1 diganti bersih & santri dipeluk hangat oleh konselor BK untuk meredakan trauma."]
        
        StepB["2. WORKSHOP REKALIBRASI MATRIKS PERKEMBANGAN J1–J4 BAGI SELURUH DEWAN MUSYRIF<br/>• Kepala Asrama membedah tabel komparasi: Santri J1 butuh bimbingan toilet hygiene, bukan hukuman fisik."]
        
        StepC["3. PENETAPAN SOP KONSEKUENSI BERJENJANG: EDUKATIF UNTUK J1–J2 & RESTORATIF UNTUK J3–J4<br/>• Pelanggaran J1 diselesaikan dengan coaching mencuci kasur bersama; pelanggaran J4 diselesaikan dengan evaluasi kepemimpinan."]
        
        StepD["4. HASIL KEADILAN KEPENGASUHAN & IKLIM ASRAMA YANG PENUH RAHMAH<br/>• Asrama memiliki kejelasan ekspektasi, santri J1 merasa aman dicintai, & santri J4 memimpin dengan penuh tanggung jawab."]
