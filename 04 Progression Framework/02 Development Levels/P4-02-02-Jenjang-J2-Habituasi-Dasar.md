...
```mermaid
flowchart TD
    subgraph DialektikaSecondYearSlump["TRANSFORMASI KEJENUHAN TAHUN KEDUA (J2)"]
        SlumpTahunKedua["SECOND-YEAR SLUMP & PROKRASTINASI (TRADISIONAL)<br/>• Kejenuhan rutinitas; ibadah terpaksa & menunda hafalan.<br/>• Mencari celah aturan saat pengawas tidak melihat.<br/>• Pembiasaan rapuh; sangat bergantung pada teriakan musyrif."]
        
        TUMBUH["HABITUASI OTONOM BERKELANJUTAN TUMBUH (J2)<br/>• Siklus 66 Hari Otomatisasi Perilaku (Lally et al.).<br/>• Self-Determination Theory: Menemukan kenikmatan batin ibadah.<br/>• Self-Monitoring Mutaba'ah: Santri memantau istiqomah diri."]
        
        SlumpTahunKedua ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsIstiqamahSalaf["DOKTRIN ISTIQOMAH DALAM TURATS"]
        HaditsIstiqamah["HR. Muslim No. 38:<br/>قُلْ آمَنْتُ بِاللَّهِ ثُمَّ اسْتَقِمْ<br/>(Katakanlah: Aku Beriman Kepada Allah, Kemudian Istiqomahlah!)"] --> Inti["Hakikat Bimbingan J2:<br/>Menjaga Konsistensi Amal Kebaikan Melampaui Rasa Bosan & Hawa Nafsu"]
        Ghazali["Al-Ghazali (Ihya'):<br/>Obat Kejenuhan Hati Adalah Memahami Buah Manis Amal & Mengingat Kematian"] --> Inti
        IbnQayyim["Ibnu Qayyim (Madarijus Salikin):<br/>Istiqomah Adalah Ruh Segala Maqam Spiritual; Tanpanya Amal Runtuh"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsOtonomiDanOtomatisasiJ2["SINTESIS SELF-DETERMINATION & HABIT FORMATION"]
        SDTInternalization["Self-Determination Theory (Deci & Ryan, 2000):<br/>• Menggeser External Regulation (takut dihukum) -> Introjected -> Identified -> Integrated Regulation (ibadah adalah identitas diri)."]
        
        HabitAutomaticity["Automaticity Formation Curve (Lally et al., 2010):<br/>• Pembiasaan membutuhkan 66 hari pengulangan bermakna dalam konteks lingkungan stabil."]
        
        CognitiveSelfControl["Self-Regulated Learning (Zimmerman):<br/>• Perencanaan belajar mandiri, monitoring diri, & evaluasi hasil berkala."]
        
        SDTInternalization & HabitAutomaticity & CognitiveSelfControl ==> StandarJenjangJ2["PEDOMAN KEPENGASUHAN J2"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaAsramaJenjangJ2["REKAYASA ASRAMA SANTRI KELAS 8"]
        Zona5S["1. ZONA 5S KAMAR MANDIRI: Standar Seiri, Seiton, Seiso, Seiketsu, Shitsuke pada kasur & lemari."]
        MejaBelajar["2. ZONA BELAJAR KONDUSIF: Meja belajar terpisah dari kasur tidur untuk mencegah kantuk."]
        BelRitme["3. SISTEM BEL OTOMATIS ASRAMA: Pengingat waktu transisi (shalat, makan, belajar, tidur)."]
        PapanTarget["4. PAPAN KENDALI MURAJA'AH MANDIRI: Grafik harian setoran hafalan Al-Qur'an santri."]
        
        Zona5S ~~~ MejaBelajar ~~~ BelRitme ~~~ PapanTarget
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRestrukturisasiTahfizh["PROTOKOL REMEDIASI MANAJEMEN HAFALAN TIER 2"]
        Step1["1. DIALOG EMPATI GURU TAHFIZH & PENETAPAN TARGET REALISTIS (ZPD)<br/>• Guru tahfizh merangkul santri: 'Jangan takut salah nak, mari kita sesuaikan target dari 1 halaman menjadi 1/2 halaman mutqin'."]
        
        Step2["2. PENETAPAN JADWAL MURAJA'AH KHUSUS 30 MENIT BA'DA ASHAR DENGAN TUTOR SEBAYA<br/>• Santri M dipasangkan dengan sahabat sekamar yang lancar hafalan untuk saling menyimak (*Talaqqi Zamil*)."]
        
        Step3["3. PENGHAPUSAN KETAKUTAN & PEMBERIAN APRESIASI SPESIFIK (4:1 RATIO)<br/>• Guru memberikan apresiasi hangat setiap kali Santri M berhasil menyetorkan 3 baris dengan tajwid makhraj tepat."]
        
        Step4["4. HASIL KEMANDIRIAN HAFALAN & KELANCARAN MUTQIN PARIPURNA<br/>• Keluhan sakit perut lenyap 100%, Santri M antusias datang paling awal di halaqah, & hafalannya tuntas 3 juz mutqin."]
...
```mermaid
flowchart TD
    subgraph ArsitekturProfilJenjangJ2["PROFIL KEMANDIRIAN SANTRI JENJANG J2 (KELAS 8)"]
        P1["1. DIMENSI RUHIYAH & OTOMATISASI IBADAH<br/>• Otomatisasi bangun shubuh mandiri jam 04.00 tanpa dibangunkan paksa.<br/>• Istiqomah shalat berjamaah 5 waktu di shaf awal $\ge 90\%$.<br/>• Hafalan Al-Qur'an akumulatif 3–4 juz mutqin & tilawah 1 juz/hari."]
        
        P2["2. DIMENSI FISIK & KETERATURAN 5S<br/>• Keteraturan penataan kasur, lemari, & slot sandal standar 5S.<br/>• Menguasai pertolongan pertama (P3K) dasar pada luka ringan & mimisan.<br/>• Kebugaran fisik prima & konsumsi makanan bergizi thoyyib."]
        
        P3["3. DIMENSI KOGNITIF & BELAJAR MANDIRI<br/>• Disiplin belajar mandiri malam 60 menit teratur ba'da Isya'.<br/>• Mampu membaca dan memahami kitab fiqh/nahwu matan lanjutan.<br/>• Ketuntasan nilai rapor madrasah $\ge 78.0$ pada seluruh mata pelajaran."]
        
        P4["4. DIMENSI SOSIAL-EMOSIONAL & KHIDMAH<br/>• Berpartisipasi aktif dalam piket pelayanan dapur umum & antre santun.<br/>• Menjadi tutor sebaya (*Peer Tutor*) membantu kawan yang kesulitan.<br/>• Menuntaskan minimal 45 jam khidmah asrama & lingkungan per tahun."]
        
        P1 & P2 & P3 & P4 ==> OutputJ2["SANTRI J2: ISTIQOMAH, DISIPLIN OTONOM, RAJIN, & PEDULI"]
    end
```
...
```mermaid
flowchart LR
    G1["1. HABITUASI IBADAH<br/>Skor LMK-F2 $\ge 2.75$; Konsistensi Shalat $\ge 90\%$."]
    --> G2["2. STANDAR 5S & P3K<br/>Lulus Uji 5S Kamar & Sertifikasi P3K Dasar."]
    --> G3["3. AKADEMIK & TAHFIZH<br/>Tuntas 3-4 Juz Mutqin & Rapor $\ge 78.0$."]
    --> G4["4. JAM KHIDMAH<br/>Tuntas $\ge 45\text{ Jam}$ Khidmah Terverifikasi."]
```
