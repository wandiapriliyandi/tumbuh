...
```mermaid
flowchart TD
    subgraph TransformasiFaseHabituasi["REKONSTRUKSI FASE HABITUASI KARAKTER"]
        PaksaanFisik["KEPATUHAN KARENA TAKUT ROTAN (TRADISIONAL)<br/>• Disiplin hanya saat diawasi pengurus keamanan.<br/>• Ibadah terasa sebagai beban & siksaan fisik.<br/>• Runtuh total saat liburan atau pasca-lulus."]
        
        TUMBUH["HABITUASI NEUROLOGIS BERKESADARAN (TUMBUH)<br/>• Dual-Process Habit Loop: Isyarat, Rutinitas, & Hadiah Batin.<br/>• Transisi kontrol eksternal menuju Self-Monitoring mandiri.<br/>• Otomatisasi sirkuit Basal Ganglia: Karakter mengakar abadi."]
        
        PaksaanFisik ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsDawamulAmalSalaf["DOKTRIN AL-I'TIYAD DALAM TURATS"]
        HaditsDawam["HR. Al-Bukhari No. 6464:<br/>أَحَبُّ الْأَعْمَالِ إِلَى اللَّهِ أَدْوَمُهَا وَإِنْ قَلَّ<br/>(Amalan yang Paling Dicintai Allah Adalah yang Paling Konsisten Sekalipun Sedikit)"] --> Inti["Hakikat Habituasi Karakter:<br/>Mengulang Kebaikan Hingga Menjadi Watak Alami (Thabi'ah Tsaniyah)"]
        Ghazali["Al-Ghazali (Ihya'):<br/>Akhlak Terbentuk Melalui Pengulangan Perbuatan Baik Secara Sadar Hingga Menjadi Refleks Jiwa yang Mengalir Ringan"] --> Inti
        IbnKhaldun["Ibnu Khaldun (Muqaddimah):<br/>Al-Malakah (Karakter) Lahir dari Repetisi Amal yang Terpola"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsNeurobiologiKebiasaan["SINTESIS NEUROBIOLOGI PEMBIASAAN"]
        HabitLoop["Dual-Process Habit Model (Wood & Neal, 2009):<br/>• Isyarat Kontekstual (Cue) -> Perilaku Otomatis (Routine) -> Kepuasan Batin (Reward).<br/>• Diperlukan rerata 66 hari pengulangan konsisten (Lally et al., 2010)."]
        
        BasalGangliaCircuit["Basal Ganglia Automaticity:<br/>• Pergeseran jalur neurokognitif dari Prefrontal Cortex (kesadaran berat) menuju Striatum/Basal Ganglia (otomatisasi efisien)."]
        
        SelfDeterminationTheory["Self-Determination Theory (Deci & Ryan):<br/>• Internalisasi motivasi ekstrinsik menjadi motivasi otonom berbasis nilai (Identified & Integrated Regulation)."]
        
        HabitLoop & BasalGangliaCircuit & SelfDeterminationTheory ==> StandarHabituasiTUMBUH["FASE HABITUASI TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaIsyaratBi'ah24Jam["REKAYASA ISYARAT LINGKUNGAN ASRAMA"]
        Isyarat1["1. SUARA TARHIM & ADZAN MERDU: Isyarat alami bangun shubuh 30 menit sebelum adzan berkumandang."]
        Isyarat2["2. PENATAAN ZONA RAK SANDAL 5S: Garis batas visual penataan sandal rapi di setiap pintu."]
        Isyarat3["3. MIKRO-JADWAL BELAJAR MANDIRI: Sesi belajar tenang 60 menit setiap ba'da Isya' di meja belajar."]
        Isyarat4["4. PAPAN APRESIASI PEKANAN (Positive Shout-Outs): Memajang apresiasi santri paling disiplin."]
        
        Isyarat1 ~~~ Isyarat2 ~~~ Isyarat3 ~~~ Isyarat4
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolReHabituasiSirkadian["PROTOKOL RE-HABITUASI SIRKADIAN TIER 2"]
        Step1["1. RESET RITME TIDUR BIOLOGIS: TIDUR LEBIH AWAL JAM 21.00 SELAMA 3 HARI<br/>• Musyrif memastikan Santri T tidur lebih awal & mematikan lampu kamar tepat waktu untuk memulihkan melatonin."]
        
        Step2["2. PENUGASAN 'BUDDY WAKE-UP' BERSAMA SAHABAT SEKAMAR DISIPLIN<br/>• Sahabat sekamar Santri T bertugas membangunkannya dengan tepukan pundak hangat & segelas air putih hangat."]
        
        Step3["3. SESI TADABBUR MALAM: 'MEMPERBAHARUI PERJANJIAN ISTIQOMAH DENGAN ALLAH'<br/>• Musyrif membimbing Santri T menata ulang target hafalan & niat belajar di semester baru."]
        
        Step4["4. HASIL PEMULIHAN RITME KEBIASAAN OTOMATIS PARIPURNA<br/>• Dalam 5 hari, jam biologis pulih 100%, Santri T bangun mandiri jam 04.00 tanpa perlu dibangunkan, & kembali ceria."]
...
```mermaid
flowchart TD
    subgraph ArsitekturPilarHabituasi["EMPAT PILAR FASE HABITUASI KARAKTER (J2)"]
        H1["PILAR 1: OTOMATISASI IBADAH MAHDHAH (AL-IBAADAH AR-RAASIKHAH)<br/>• Refleks wudhu sempurna, shalat 5 waktu di shaf awal, & tilawah 1 juz/hari.<br/>• Zikir pagi-petang (Al-Ma'tsurat) mengalir alami tanpa perlu dipaksa."]
        
        H2["PILAR 2: REGULASI DIRI & DISIPLIN BELAJAR (AL-INTIZHAM AD-DIRASI)<br/>• Jam belajar mandiri 60 menit/malam, persiapan buku pelajaran esok hari.<br/>• Metakognisi hafalan mutqin: Mampu mengulang hafalan mandiri (*Muraja'ah*)."]
        
        H3["PILAR 3: HIGIENITAS & KETERATURAN FISIK (AN-NAZHAFAH AL-AMALIYYAH)<br/>• Standar 5S kamar tidur: Kasur rapi, lemari tersusun rapi, rak sandal lurus.<br/>• Sanitasi pribadi: Mandi tertib, mencuci baju teratur, & menjaga kebersihan fasilitas."]
        
        H4["PILAR 4: SOLIDARITAS SOSIAL & ADAB UKHUWAH (AL-ADAB AL-UKHUWWI)<br/>• Disiplin antre makan, piket dapur umum sukarela, & saling mengingatkan dalam kebaikan.<br/>• Budaya mengingatkan kawan secara santun (*Nashihatul Ikhwan bil-Hikmah*)."]
        
        H1 & H2 & H3 & H4 ==> OutputHabituasi["SANTRI J2 DISIPLIN OTONOM, ISTIQOMAH, & BERADAB"]
    end
```
