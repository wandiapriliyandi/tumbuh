...
```mermaid
flowchart TD
    subgraph TransformasiTrajektoriHolistik["REKONSTRUKSI TRAJEKTORI PERKEMBANGAN SANTRI"]
        PolaTerpisah["FRAGMENTASI JASAD-AKAL-RUH (TRADISIONAL)<br/>• Masalah biologis/kognitif selalu divonis masalah spiritual.<br/>• Pertumbuhan fisik pubertas diabaikan tanpa nutrisi berimbang.<br/>• Regresi perilaku wajar dihukum secara destruktif."]
        
        TUMBUH["SINTESIS BIOSOSIAL-SPIRITUAL TUMBUH<br/>• Integrasi Fiqh At-Tadrij & Dynamic Systems Theory.<br/>• Keseimbangan biologis (nutrisi/tidur), sosial (ukhuwah), & ruhani (tauhid).<br/>• Peta jalan longitudinal 6 tahun yang harmonis & terukur."]
        
        PolaTerpisah ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsTadrijFitrahSalaf["DOKTRIN TADRIJ FITRAH IBNU QAYYIM"]
        IbnQayyim["Ibnu Qayyim (Tuhfatul Maudud):<br/>تَدَرُّجُ خَلْقِ الْإِنْسَانِ وَتَغْذِيَةُ جَسَدِهِ وَعَقْلِهِ وَرُوحِهِ يَجِبُ أَنْ يَكُونَ مِثْلَ تَدَرُّجِ النَّبَاتِ بِالْمَاءِ وَالضِّيَاءِ<br/>(Pendidikan Santri Harus Bertahap Menyiram Jasad, Akal, & Ruh Laksana Tumbuhan)"] --> Inti["Hakikat Sintesis Holistik:<br/>Keseimbangan Mutlak Antara Kesehatan Raga, Kecerdasan Akal, & Kesucian Jiwa"]
        Ghazali["Al-Ghazali (Ihya'):<br/>Jasad Adalah Kendaraan Ruh Menuju Akhirat; Merawat Raga Adalah Syarat Menuntut Ilmu"] --> Inti
        Syathibi["Asy-Syathibi (Al-Muwafaqat):<br/>Hifzhun Nafs & Hifzhud Din Saling Menopang Satu Sama Lain"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsDynamicSystemsDanFitrah["SINTESIS SISTEM DINAMIS & FITRAH"]
        DST["Dynamic Systems Theory (Thelen & Smith, 1994):<br/>• Perkembangan manusia adalah hasil interaksi mandiri (Self-Organization) yang non-linear antara tubuh, otak, & lingkungan."]
        
        BPSSModel["Biopsychosocial-Spiritual Model (Sulmasy, 2002):<br/>• Manusia adalah kesatuan 4 dimensi yang tidak dapat dipisahkan: Biologis, Psikologis, Sosial, & Spiritual."]
        
        NeurodevelopmentModel["Adolescent Brain Connectome (Giedd, 2004):<br/>• Penataan ulang sinapsis otak (Pruning) & mielinisasi Prefrontal Cortex sepanjang usia 12–18 tahun."]
        
        DST & BPSSModel & NeurodevelopmentModel ==> StandarSintesisTUMBUH["TRAJEKTORI TERPADU TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaHarmonisasiEkosistem24Jam["REKAYASA HARMONISASI EKOSISTEM ASRAMA"]
        Sirkadian["1. RITME SIRKADIAN SEHAT: Istirahat malam 7 jam (21.30–04.00) + Qailulah 30 menit siang."]
        Nutrisi["2. GIZI SEIMBANG THAYYIBAN: Menu tinggi protein, zat besi, sayur segar, & bebas pengawet berbahaya."]
        Kebugaran["3. KEKUATAN FISIK SUNNAH: Olahraga aerobik, bela diri, & peregangan motorik 3x sepekan."]
        Spiritual["4. SPIRITUALITAS DZIKIR & TILAWAH: Munajat malam, shalat khusyu', & tadabbur Al-Qur'an harian."]
        
        Sirkadian ~~~ Nutrisi ~~~ Kebugaran ~~~ Spiritual
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolIntervensiHolistik["PROTOKOL REMEDIASI HOLISTIK TIER 2"]
        Langkah1["1. INTERVENSI BIOLOGIS: SUPLEMEN ZAT BESI & MAKANAN BERGIZI TINGGI DI POSKESTREN<br/>• Dokter Poskestren memberikan terapi tablet Fe, madu murni, & telur rebus setiap pagi selama 30 hari."]
        
        Langkah2["2. INTERVENSI SOSIAL: FORUM MEDIASI RESTORATIF UKHUWAH KAMAR BERSAMA MUSYRIF<br/>• Musyrif memediasi konflik penggunaan barang di kamar & menyepakati batas privasi (*Zero Ghashab*)."]
        
        Langkah3["3. INTERVENSI SPIRITUAL & METAKOGNISI HAFALAN BERSAMA GURU TAHFIZH<br/>• Guru tahfizh memberikan afirmasi kasih sayang & menyesuaikan beban setoran hafalan secara bertahap."]
        
        Langkah4["4. HASIL PEMULIHAN KESEHATAN & LONJAKAN HAFALAN MUTQIN<br/>• Kadar Hb naik menjadi $13.5\text{ g/dL}$, wajah segar bugar, hubungan kamar hangat, & hafalan kembali lancar 1 halaman/hari."]
...
```mermaid
flowchart TD
    subgraph PetaLongitudinalEnamTahun["PETA JALAN LONGITUDINAL 6 TAHUN SANTRI TUMBUH"]
        Fase1["FASE I: INISIASI & ADAPTASI (USIA 12–13 TAHUN / KELAS 7 - J1)<br/>• Biologis: Adaptasi nutrisi asrama, keteraturan tidur, & higienitas mandiri.<br/>• Sosial: Mengatasi homesickness, ukhuwah kamar, & pendampingan Restorative Buddy.<br/>• Spiritual: Tauhid mahabbah (merasa disayangi Allah), pembiasaan wudhu, & shalat shubuh."]
        
        Fase2["FASE II: HABITUASI & REGULASI DIRI (USIA 13–14 TAHUN / KELAS 8 - J2)<br/>• Biologis: Lonjakan pertumbuhan pubertas awal (Growth Spurt), kebugaran fisik.<br/>• Sosial: Keteraturan piket dapur, disiplin antre makan, & tutor sebaya belajar.<br/>• Spiritual: Otomatisasi ibadah mahdhah, tilawah 1 juz/hari, & zikir pagi-petang rutin."]
        
        Fase3["FASE III: KEMATANGAN SOSIAL-EMOSIONAL (USIA 15–16 TAHUN / KELAS 9–10 - J3)<br/>• Biologis: Kematangan seksual sekunder baligh, kestabilan hormon fisik.<br/>• Sosial: 5 Kompetensi CASEL SEL, penolakan geng eksklusif, & Ekspedisi Bina Desa.<br/>• Spiritual: Kesadaran mukallaf penuh, pengendalian syahwat (*Ghadhdhul Bashar*), & qiyamullail."]
        
        Fase4["FASE IV: SERVANT LEADERSHIP & PERADABAN (USIA 17–18 TAHUN / KELAS 11–12 - J4)<br/>• Biologis: Stamina fisik prima, ketahanan kerja keras, & metabolisme dewasa.<br/>• Sosial: Kepemimpinan pelayan OPPM, advokasi anti-bullying, & Capstone Project.<br/>• Spiritual: Keikhlasan sejati (*Lillahi Ta'ala*), Al-Itsar paripurna, & visi peradaban umat."]
...
| :--- | :--- | :--- | :--- |
| **Fase I: Inisiasi (J1)<br/>Usia 12–13 Tahun** | Penyesuaian imunitas asrama, sanitasi pribadi, keteraturan makan-tidur. | Mengatasi kecemasan separasi, keterikatan aman pada musyrif (*Safe Haven*). | Penanaman tauhid cinta, rasa aman bermunajat, dan adab thalabul ilmi dasar. |
| **Fase II: Habituasi (J2)<br/>Usia 13–14 Tahun** | Adaptasi lonjakan tinggi badan, kebugaran aerobik, dan pencegahan anemia. | Pembentukan kebiasaan belajar 66 hari, regulasi diri (*Self-Monitoring*). | Otomatisasi ibadah mahdhah, hafalan mutqin, dan zikir pagi-petang istiqomah. |
| **Fase III: Kematangan SEL (J3)<br/>Usia 15–16 Tahun** | Pengelolaan energi pubertas melalui olahraga sunnah (bela diri/panahan). | Keterampilan regulasi amarah (*SEL*), empati sebaya, dan bakti desa binaan. | Kesadaran mukallaf hisab amal, tazkiyatun nafs, dan mujahadah hawa nafsu. |
| **Fase IV: Leadership (J4)<br/>Usia 17–18 Tahun** | Ketahanan fisik dewasa muda, ketahanan kerja keras (*Physical Grit*). | Kepemimpinan pelayan (*Servant Leadership*), resolusi konflik, dan Capstone. | Ikhlas lillahi ta'ala, Al-Itsar sejati, dan dedikasi pengabdian peradaban. |
