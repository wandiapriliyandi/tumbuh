...
```mermaid
graph TD
    Sintesis["Sintesis Trajektori Biososial-Spiritual"]
    
    subgraph Turats["Dimensi Turats Islam"]
        Takhalli["Takhalli (Membersihkan Dosa & Ego)"] --> Tahalli["Tahalli (Hiasi Diri dengan Adab & Ibadah)"] --> Tajalli["Tajalli (Keteguhan Konsisten / Istiqamah)"]
    end
    
    subgraph Neuro["Dimensi Neurosains Kognitif"]
        PFC1["Dominansi Limbik / Impulsif Awal"] --> PFC2["Penguatan Konektivitas PFC-Amigdala"] --> PFC3["Regulasi Eksekutif Matang Utuh"]
    end
