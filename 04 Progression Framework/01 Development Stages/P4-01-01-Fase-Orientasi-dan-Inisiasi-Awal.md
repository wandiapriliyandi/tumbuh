...
```mermaid
flowchart TD
    subgraph TransformasiFaseOrientasi["REKONSTRUKSI FASE INISIASI AWAL SANTRI"]
        PolaLama["ORIENTASI MILITERISTIK & PERPELONCOAN (TRADISIONAL)<br/>• Menakut-nakuti santri baru dengan bentakan.<br/>• Hukuman fisik pada santri yang belum paham SOP asrama.<br/>• Homesickness diabaikan; angka santri kabur tinggi."]
        
        TUMBUH["FASE INISIASI SAFE HAVEN TUMBUH (OBE & PBIS)<br/>• Program 40 Hari Pertama: Fokus rasa aman & kasih sayang.<br/>• In Loco Parentis: Musyrif menjadi figur lekat pengganti orang tua.<br/>• Sistem pendampingan Restorative Buddy J4–J1 tanpa feodalisme."]
        
        PolaLama ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsPenyambutanPenuntutIlmu["ADAB PENYAMBUTAN PENUNTUT ILMU SALAF"]
        HaditsMarhaban["HR. Ibnu Majah No. 247:<br/>مَرْحَبًا بِوَصِيَّةِ رَسُولِ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ<br/>(Selamat Datang Wahai Orang-Orang yang Diwasiatkan oleh Rasulullah SAW!)"] --> Inti["Hakikat Inisiasi Santri Baru:<br/>Memuliakan Tamu Allah dengan Kasih Sayang & Menghilangkan Ketakutan Hati"]
        IbnSahnun["Ibnu Sahnun (Adab ash-Shibyan):<br/>Pendidik Wajib Berlemah Lembut pada Murid Baru Hingga Jiwanya Tenang"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Syarat Pertama Guru: Memperlakukan Murid Baru Seperti Anak Kandungnya Sendiri"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsTransisiDanKelekatan["SINTESIS TEORI PERKEMBANGAN TRANSISI ASRAMA"]
        AttachmentTheory["Attachment Theory (Bowlby, 1982):<br/>• Kehilangan figur lekat primer (orang tua) memicu fase: Protest (menangis) -> Despair (menarik diri) -> Detachment.<br/>• Solusi: Musyrif hadir sebagai Secondary Attachment Figure (In Loco Parentis) yang responsif."]
        
        BronfenbrennerModel["Ecological Transition Theory (1979):<br/>• Perubahan mikrosistem dari rumah ke asrama membutuhkan jembatan ekologis (Mesosystem Bridge) yang mulus."]
        
        SelfRegulationEarly["Early Adolescent Neuroplasticity:<br/>• Amigdala sangat aktif, PFC belum matang: Membutuhkan ko-regulasi emosi hangat dari orang dewasa."]
        
        AttachmentTheory & BronfenbrennerModel & SelfRegulationEarly ==> StandarInisiasiTUMBUH["FASE ORIENTASI TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaSafeHavenAsrama["REKAYASA SAFE HAVEN 40 HARI PERTAMA"]
        Zona1["1. LINGKARAN PENYAMBUTAN HANGAT (Welcoming Circle): Upacara serah terima santri penuh haru & doa."]
        Zona2["2. KELAS KEMANDIRIAN PRAKTIS (Life Skills Lab): Praktik mencuci pakaian, merapikan kasur, & mandi tertib."]
        Zona3["3. CALL-HOME COMFORT SCHEDULE: Jadwal telepon orang tua terstruktur untuk meredakan kecemasan."]
        Zona4["4. RESTORATIVE BUDDY SUPPORT: Kakak asuh J4 mendampingi santri baru di setiap waktu shalat & makan."]
...
```mermaid
flowchart TD
    subgraph ProtokolDeEskalasiHomesick["PROTOKOL DE-ESKALASI HOMESICKNESS TIER 2 & 3"]
        StepA["1. HADIR FISIK PENUH KASIH: MUSYRIF MERANGKUL & DUDUK DI SAMPING SANTRI<br/>• Musyrif tidak memarahi atau menasehati panjang lebar; musyrif menyediakan teh hangat & memvalidasi perasaannya: 'Wajar menangis, ustadz dulu juga rindu rumah'."]
        
        StepB["2. FASILITASI VIDEO CALL PENENANGAN BERSAMA ORANG TUA & KONSULOR BK<br/>• Orang tua dibimbing konselor untuk memberikan afirmasi cinta: 'Ayah & Ibu sangat sayang padamu, kami menitipkanmu di sini agar kamu menjadi anak mulia'."]
        
        StepC["3. PENUGASAN RESTORATIVE BUDDY J4 SEBAGAI SAHABAT TIDUR & MAKAN<br/>• Kakak asuh J4 membawa makanan favorit Santri F, menyuapinya dengan hangat, & mengajaknya bermain tenis meja asrama."]
        
        StepD["4. HASIL INTEGRASI SOSIAL & KEBAHAGIAAN MONDOK PARIPURNA<br/>• Pada hari ke-10, Santri F berhenti menangis, memiliki sahabat akrab di kamar, & tersenyum ceria mengikuti kegiatan."]
...
```mermaid
flowchart TD
    subgraph ArsitekturFaseInisiasi["KERANGKA FASE ORIENTASI & INISIASI AWAL (J1)"]
        K1["DIMENSI 1: STABILISASI PSIKO-SPIRITUAL<br/>• Meredakan homesickness melalui ko-regulasi emosi musyrif.<br/>• Menanamkan tauhid mahabbah: Merasa disayangi Allah di pesantren."]
        
        K2["DIMENSI 2: LIFE-SKILLS & HYGIENE HABITUATION<br/>• Penguasaan keterampilan dasar: Mencuci baju, menjemur, menata lemari rapi.<br/>• Pembiasaan tidur teratur jam 21.30 & bangun shalat shubuh berjamaah."]
        
        K3["DIMENSI 3: SOCIAL BONDING & UKHUWAH KAMAR<br/>• Membangun persahabatan sekamar tanpa diskriminasi latar belakang keluarga.<br/>• Pembiasaan makan bersama, berbagi makanan ringan, & saling membantu."]
        
        K4["DIMENSI 4: LITERASI TATA TERTIB POSITIF (NO VIOLENCE)<br/>• Memahami hak dan kewajiban santri tanpa rasa takut.<br/>• Kesadaran perlindungan dari bullying & akses konseling BK 24 jam."]
        
        K1 & K2 & K3 & K4 ==> OutputInisiasi["SANTRI J1 ADAPTIF, KERASAN, MANDIRI, & GEMBIRA"]
    end
```
