...
```mermaid
flowchart TD
    subgraph TransformasiKeadilanRestoratif["REKONSTRUKSI PARADIGMA KEADILAN ASRAMA"]
        HukumanRetributifDendam["KEADILAN RETRIBUTIF (PARADIGMA LAMA)<br/>• Fokus pada pelanggaran aturan & hukuman fisik.<br/>• Korban diabaikan 100%, kerugian tidak diganti.<br/>• Pelaku distigma & menyimpan dendam batin."]
        
        TUMBUH["KEADILAN RESTORATIF 3R (TUMBUH)<br/>• Ishlah Dzātil Bain & Dhmānul Khasārah.<br/>• Howard Zehr Restorative Justice & John Braithwaite.<br/>• 3R: Restitution (Ganti Rugi), Resolution (Akar), Reconciliation (Damai)."]
        
        HukumanRetributifDendam ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsIshlahSalaf["DOKTRIN ISHLAH & RESTORASI TURATS"]
        AyatIshlah["QS. Al-Anfal [8]: 1:<br/>فَاتَّقُوا اللَّهَ وَأَصْلِحُوا ذَاتَ بَيْنِكُمْ<br/>(Bertaqwalah Kepada Allah & Damaikanlah Perselisihan di Antara Kalian!)"] --> Inti["Hakikat Keadilan Restoratif 3R:<br/>Memulihkan Hak Korban yang Terzalimi, Membimbing Pelaku Bertanggung Jawab Nyata, & Menyatukan Kembali Hati yang Retak"]
        HaditsAfdhalShadaqah["HR. Abu Dawud & At-Tirmidzi:<br/>أَفْضَلُ الصَّدَقَةِ إِصْلَاحُ ذَاتِ الْبَيْنِ<br/>(Sedekah yang Paling Utama Adalah Mendamaikan Retaknya Hubungan Persaudaraan!)"] --> Inti
        KaidahDhomanMutlafat["Kaidah Fiqh Salaf:<br/>مَنْ أَتْلَفَ شَيْئًا لَزِمَهُ ضَمَانُهُ<br/>(Barangsiapa yang Merusakkan Sesuatu Maka Wajib Baginya Mengganti Kerugiannya Secara Adil!)"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsKeadilanRestoratifZehrBraithwaite["SINTESIS ZEHR & BRAITHWAITE RESTORATIVE"]
        HowardZehrRestorativeJustice["Howard Zehr's 3 Restorative Questions (2015):<br/>• 1. Siapa yang terluka/dirugikan oleh tindakan ini?<br/>• 2. Apa kebutuhan pemulihan korban dan komunitas?<br/>• 3. Siapa yang bertanggung jawab untuk memperbaikinya?"]
        
        JohnBraithwaiteReintegrativeShaming["John Braithwaite's Reintegrative Shaming (1989):<br/>• Memisahkan perbuatan dosa dari martabat fitrah pelakunya.<br/>• Mengecam perilaku buruknya, namun menyambut & merangkul kembali pribadinya ke dalam ukhuwah."]
        
        WholeSchoolRestorativeCulture["Whole-School Restorative Culture (Hopkins, 2004):<br/>• Mengganti ruang sidang hukuman dengan Lingkaran Pemulihan Dialogis (Restorative Circles)."]
        
        HowardZehrRestorativeJustice & JohnBraithwaiteReintegrativeShaming & WholeSchoolRestorativeCulture ==> StandarRestoratifTUMBUH["FORM MRR-METODOLOGI"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurProsesRestoratifSIM["ALUR RESTORATIVE WORKFLOW 3R SIM"]
        InsidenTerjadi["1. INSIDEN TERJADI: Pelanggaran Adab / Kerusakan Barang Dilaporkan ke SIM"]
        TahapRestitusiNyata["2. TAHAP 1: RESTITUTION (Pelaku Menandatangani Komitmen Ganti Rugi / Pembersihan Barang Korban)"]
        TahapResolusiAkar["3. TAHAP 2: RESOLUTION (Konselor & Musyrif Mengidentifikasi Akar Masalah & Merancang Replacement Plan)"]
        TahapRekonsiliasiCircle["4. TAHAP 3: RECONCILIATION (Penyelenggaraan Restorative Circle Berbincang Damai & Saling Memaafkan)"]
        CleanSlateDanReintegrasi["5. CLEAN SLATE: Catatan Kesalahan Diarsip Tertutup; Hubungan Ukhuwah Pulih 100%"]
        
        InsidenTerjadi --> TahapRestitusiNyata --> TahapResolusiAkar --> TahapRekonsiliasiCircle --> CleanSlateDanReintegrasi
    end
```
...
```mermaid
flowchart TD
    subgraph TigaRantaiPemulihanRestoratif["TIGA RANTAI PEMULIHAN RESTORATIF 3R"]
        R1["1. RESTITUTION (DHMĀNUL MUTLAFĀT - GANTI RUGI MATERIIL)<br/>• Memperbaiki kerusakan fisik, membersihkan barang, atau mengganti biaya kerugian korban."]
        
        R2["2. RESOLUTION ('ILĀJUL ASBĀB - RESOLUSI AKAR MASALAH)<br/>• Menemukan fungsi perilaku (FBA) & melatih keterampilan emosi baru agar kesalahan tidak terulang."]
        
        R3["3. RECONCILIATION (ISHLĀHU DZĀTIL BAIN - REKONSILIASI BATIN)<br/>• Memulihkan kepercayaan, melenyapkan dendam, & menyatukan ukhuwah melalui Restorative Circle."]
