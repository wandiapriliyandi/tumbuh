...
```mermaid
flowchart TD
    subgraph TransformasiParadigmaDisiplin["REKONSTRUKSI PARADIGMA DISIPLIN PESANTREN"]
        OtoriterPermisifKacau["OTORITER vs PERMISIF (PARADIGMA LAMA)<br/>• Otoriter: Keras, membentak, kepatuhan semu karena takut.<br/>• Permisif: Ramah tapi tanpa batasan, anarki adab.<br/>• Melahirkan siklus dendam & perundungan senior."]
        
        TUMBUH["DISIPLIN POSITIF FIRM & KIND (TUMBUH)<br/>• Al-Lin fi Ghairi Dha'fin wal Quwwah fi Ghairi 'Unfin.<br/>• Jane Nelsen & Diana Baumrind Authoritative Parenting.<br/>• Konsekuensi Logis 3R & Regulasi Diri Internal Mandiri."]
        
        OtoriterPermisifKacau ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsRifqUmarSalaf["DOKTRIN KELEMBUTAN & KETEGASAN TURATS"]
        HaditsRifq["HR. Muslim No. 2594:<br/>إِنَّ الرِّفْقَ لَا يَكُونُ فِي شَيْءٍ إِلَّا زَانَهُ، وَلَا يُنْزَعُ مِنْ شَيْءٍ إِلَّا شَانَهُ<br/>(Sesungguhnya Kelembutan Tidaklah Berada Pada Suatu Perkara Melainkan Menghiasinya, & Tidaklah Dicabut Dari Suatu Perkara Melainkan Memperburuknya!)"] --> Inti["Hakikat Disiplin Positif Firm & Kind:<br/>Tegas Menjaga Batasan Hukum Allah Tanpa Menyakiti & Lembut Menyayangi Santri Tanpa Melemahkan Wibawa Adab"]
        WasiatUmarDoa["Wasiat Doa Sayyidina Umar RA:<br/>اللَّهُمَّ إِنِّي ضَعِيفٌ فَقَوِّنِي، وَإِنِّي شَدِيدٌ فَلَيِّنِّي فِي غَيْرِ ضَعْفٍ وَلَا عُنْفٍ<br/>(Ya Allah, Lembutkanlah Ketegasanku Tanpa Kelemahan & Kuatkanlah Tekadku Tanpa Kekerasan!)"] --> Inti
        GhazaliAyyuhalWalad["Al-Ghazali (Ayyuhal Walad):<br/>Nasihat yang Disertai Amarah Adalah Racun yang Merusak Hati Murid"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsDisiplinPositifNelsenBaumrind["SINTESIS POSITIVE DISCIPLINE & AUTHORITATIVE PARENTING"]
        DianaBaumrindParenting["Diana Baumrind's Authoritative Parenting (1966, 1991):<br/>• High Responsiveness (Kehangatan, empati, penerimaan emosi).<br/>• High Demandingness (Standar adab tinggi, struktur jelas, konsistensi).<br/>• Menghasilkan regulasi diri, ketahanan mental, & prestasi optimal."]
        
        JaneNelsenPositiveDiscipline["Jane Nelsen's Positive Discipline (2006):<br/>• Firm AND Kind at the Same Time.<br/>• Connection before Correction (Membangun relasi hati sebelum membenahi perilaku).<br/>• Focus on Solutions, not Punishment."]
        
        RudolfDreikursMistakenGoals["Rudolf Dreikurs' 4 Mistaken Goals of Behavior:<br/>• Attention, Power, Revenge, Inadequacy -> Memahami akar kebutuhan emosi santri."]
        
        DianaBaumrindParenting & JaneNelsenPositiveDiscipline & RudolfDreikursMistakenGoals ==> StandarDisiplinTUMBUH["FORM PDP-PRINSIP"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurResponFirmAndKindSIM["ALUR RESPON PENGASUHAN FIRM & KIND SIM"]
        SantriLakukanPelanggaran["1. SANTRI MELAKUKAN PELANGGARAN ADAB (Contoh: Bangun Kesiangan & Ranjang Berantakan)"]
        ValidasiEmosiEmpati["2. STEP 1: KINDNESS / CONNECTION (Musyrif Memvalidasi Emosi Secara Privat: 'Ustadz paham kamu lelah semalam')"]
        TegaskanBatasanAdab["3. STEP 2: FIRMNESS / BOUNDARY (Musyrif Menegaskan Standar: 'Namun aturan adab kamar mewajibkan ranjang rapi sebelum shubuh')"]
        TerapkanKonsekuensiLogis["4. STEP 3: LOGICAL CONSEQUENCE 3R (Santri Merapikan Ranjang & Menata Ulang Sprei Bersama Musyrif)"]
        TutupAfirmasiKasihSayang["5. STEP 4: CLOSING AFFIRMATION (Musyrif Menepuk Bahu Santri: 'Terima kasih atas kejujuranmu, mari shalat bersama')"]
        
        SantriLakukanPelanggaran --> ValidasiEmosiEmpati --> TegaskanBatasanAdab --> TerapkanKonsekuensiLogis --> TutupAfirmasiKasihSayang
    end
```
...
```mermaid
flowchart TD
    subgraph EmpatPilarDisiplinPositif["EMPAT PILAR DISIPLIN POSITIF TUMBUH"]
        P1["PILAR 1: MUTUAL RESPECT (SALING MENGHORMATI MARTABAT)<br/>• Musyrif menghormati martabat fitrah santri; santri menghormati wibawa ilmu dan aturan pondok."]
        
        P2["PILAR 2: CONNECTION BEFORE CORRECTION (HATI SEBELUM ATURAN)<br/>• Menjalin kedekatan emosional dan mendengarkan sebelum memperbaiki perilaku yang salah."]
        
        P3["PILAR 3: 3R LOGICAL CONSEQUENCES (KONSEKUENSI BERMAKNA)<br/>• Mengganti hukuman fisik/verbal dengan konsekuensi yang Relevan, Sopan, dan Wajar."]
        
        P4["PILAR 4: INTERNAL REGULATION FOCUS (FOKUS MOTIVASI BATIN)<br/>• Membangun kesadaran bahwa disiplin adalah ibadah taqarrub kepada Allah, bukan takut manusia."]
