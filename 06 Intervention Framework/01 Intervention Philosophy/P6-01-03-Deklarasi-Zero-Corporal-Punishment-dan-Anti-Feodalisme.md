...
```mermaid
flowchart TD
    subgraph TransformasiAntiKekerasan["REKONSTRUKSI PERLINDUNGAN SANTRI ASRAMA"]
        KekerasanFisikDanFeodalisme["KEKERASAN FISIK & FEODALISME (PARADIGMA LAMA)<br/>• Hukuman pukul, push-up militer, bentakan.<br/>• Senioritas feodal: junior mencuci baju senior.<br/>• Korban bungkam karena takut pembalasan."]
        
        TUMBUH["ZERO CORPORAL PUNISHMENT & EGALITER (TUMBUH)<br/>• Tahrimuzh Zhulm: Keharaman mutlak kezaliman.<br/>• UNCRC Article 19 & UU PA No. 35/2014 Compliance.<br/>• Whistleblowing Hotline Anonim & Sanksi Pemecatan."]
        
        KekerasanFisikDanFeodalisme ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsTahrimZhulmSalaf["DOKTRIN KEHARAMAN KEZALIMAN TURATS"]
        HaditsQudsiZhulm["Hadits Qudsi (HR. Muslim No. 2577):<br/>يَا عِبَادِي إِنِّي حَرَّمْتُ الظُّلْمَ عَلَى نَفْسِي وَجَعَلْتُهُ بَيْنَكُمْ مُحَرَّمًا فَلَا تَظَالَمُوا<br/>(Wahai Hamba-Ku, Sesungguhnya Aku Mengharamkan Kezaliman Atas Diri-Ku & Menjadikannya Haram di Antara Kalian, Maka Janganlah Saling Menzalimi!)"] --> Inti["Hakikat Zero Corporal Punishment:<br/>Kezaliman Fisik & Mental Adalah Dosa Besar yang Haram Ditoleransi di Pesantren: Menjaga Kesucian Darah, Raga, & Kehormatan Santri"]
        HaditsKhutbahWada["HR. Al-Bukhari & Muslim (Khutbah Wada'):<br/>إِنَّ دِمَاءَكُمْ وَأَمْوَالَكُمْ وَأَعْرَاضَكُمْ عَلَيْكُمْ حَرَامٌ<br/>(Sesungguhnya Darah Kalian, Harta Kalian, & Kehormatan Kalian Adalah Suci Haram Disentuh!)"] --> Inti
        IbnHazmMaratib["Ibnu Hazm (Maratibul Ijma'):<br/>Ijma' Ulama Mengharamkan Menyakiti Fisik Penuntut Ilmu Tanpa Hak Syar'i"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPerlindunganAnakGlobal["SINTESIS UNCRC, WHO INSPIRE, & UU PA"]
        UNCRCArticle19["UN Convention on the Rights of the Child (Article 19):<br/>• Kewajiban melindungi anak dari segala bentuk kekerasan fisik, mental, penelantaran, & eksploitasi."]
        
        UUPANo35Tahun2014["UU Perlindungan Anak No. 35 Tahun 2014 (Pasal 54):<br/>• Anak di dalam dan di lingkungan satuan pendidikan wajib mendapatkan perlindungan dari tindak kekerasan."]
        
        WHOINSPIREStrategy["WHO INSPIRE Strategies (2016):<br/>• Implementation and enforcement of laws, Safe environments, & Response and support services."]
        
        UNCRCArticle19 & UUPANo35Tahun2014 & WHOINSPIREStrategy ==> StandarPiagamTUMBUH["FORM ZCP-PIAGAM"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurChildSafeguardingSIM["ALUR CHILD SAFEGUARDING & WHISTLEBLOWING SIM"]
        SantriLaporInsiden["1. SANTRI / WALI MELAPOR VIA HOTLINE ANONIM ENKRIPSI (TOMBOL DARURAT APLIKASI SIM)"]
        NotifikasiKeKomiteSafeguarding["2. NOTIFIKASI RAHASIA TERKIRIM LANGSUNG KE KOMITE INDEPENDEN PERLINDUNGAN ANAK PESANTREN"]
        InvestigasiMedisDanCCTV["3. TIM INVESTIGASI MEMERIKSA VISUM MEDIS POSKESTREN & REKAMAN CCTV DALAM WAKTU < 2 JAM"]
        PenonaktifanPelaku["4. JIKA TERBUKTI: OKNUM MUSYRIF / SENIOR DINONAKTIFKAN SEKETIKA DARI TUGAS ASRAMA"]
        SanksiTegasDanHukum["5. SANKSI PEMECATAN TIDAK DENGAN HORMAT & PROSES HUKUM KEPOLISIAN JIKA TERINDIKASI PIDANA"]
        
        SantriLaporInsiden --> NotifikasiKeKomiteSafeguarding --> InvestigasiMedisDanCCTV --> PenonaktifanPelaku --> SanksiTegasDanHukum
    end
```
...
```mermaid
flowchart TD
    subgraph EmpatBentengPerlindunganZCP["EMPAT BENTENG PERLINDUNGAN ANAK TUMBUH"]
        B1["BENTENG 1: LEGAL ZERO-TOLERANCE CODE<br/>• Piagam tertulis yang melarang 10 bentuk kekerasan fisik, verbal, & senioritas feodal."]
        
        B2["BENTENG 2: MANDATORY INTEGRITY PACT (PAKTA INTEGRITAS PENDIDIK)<br/>• Seluruh musyrif, guru, & pengurus santri menandatangani pakta siap dipecat jika melakukan kekerasan."]
        
        B3["BENTENG 3: ANONYMOUS WHISTLEBLOWING HOTLINE<br/>• Saluran pelaporan darurat 24 jam yang aman, terenkripsi, & melindungi identitas pelapor."]
        
        B4["BENTENG 4: INDEPENDENT SAFEGUARDING COMMITTEE<br/>• Komite independen lintas profesi (Dokter, Psikolog, Advokat, Tokoh Agama) pengawal keadilan."]
