...
```mermaid
graph TD
    CohortSetup["Profil Awal Cohort 100 Santri (Kelas 7 MTs / Usia 12 Tahun)"]
    CohortSetup --> Diversity["Keanekaragaman Latar Belakang:<br/>• 60 Santri: Kemampuan Al-Qur'an & Adab Sedang (Biasa)<br/>• 25 Santri: Kemampuan Al-Qur'an Baik & Mandiri<br/>• 15 Santri: Belum Terbiasa Mandiri & Rentan Homesickness"]
    CohortSetup --> DualPillarStructure["Struktur Pengasuhan Terpadu:<br/>• 2 Wali Kelas (Walas) MTs (KBM 07.00-15.00)<br/>• 4 Musyrif Asrama (Shift 15.00-07.00 Subuh)<br/>• 1 Konselor BK & 4 Peer Buddy Senior (T4)"]
```
