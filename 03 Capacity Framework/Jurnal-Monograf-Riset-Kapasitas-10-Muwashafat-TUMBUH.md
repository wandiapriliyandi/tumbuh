...
```mermaid
graph TD
    LowFrictionProto["Protokol Efisiensi Asesmen 3-Lapis"]
    LowFrictionProto --> L1["Lapis 1: Self-Assessment Fitrah Santri (Refleksi Batin Mandiri 1x seminggu)"]
    LowFrictionProto --> L2["Lapis 2: Quick-Tap Logging Mobile App (Pencatatan Insiden & Apresiasi < 30 detik)"]
    LowFrictionProto --> L3["Lapis 3: Evaluasi Berkala Musyrif & Wali Kelas (Kalibrasi Data Semesteran)"]
```
