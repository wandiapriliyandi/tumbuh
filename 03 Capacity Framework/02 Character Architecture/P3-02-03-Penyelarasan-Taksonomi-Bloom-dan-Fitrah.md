...
```mermaid
flowchart TD
    subgraph PenyelarasanTaksonomiTUMBUH["INTEGRASI TAKSONOMI BARAT & TURATS ISLAM"]
        Bloom["TAKSONOMI BLOOM & MARZANO<br/>• Keunggulan: Struktur kognitif presisi (C1-C6).<br/>• Kelemahan: Sekuler, mekanistis, afektif terpisah."]
        
        Turats["TAKSONOMI ADAB TURATS (Al-Attas & Al-Ghazali)<br/>• Keunggulan: Ruhaniyah tauhid, tazkiyah, adab integral.<br/>• Kelemahan: Sering dinilai abstrak tanpa rubrik operasional."]
        
        Sintesis["TAKSONOMI FITRAH ADAB TUMBUH<br/>Mengintegrasikan nalar kritis ilmiah (C1-C6) ke dalam pendakian adab lahir-batin (Ta'lim -> Tarbiyah -> Ta'dib -> Tazkiyah -> Khidmah)."]
        
        Bloom & Turats ==> Sintesis
    end
```
...
```mermaid
graph TD
    A["Gugatan Dikotomi (Pihak A):<br/>'Taksonomi Bloom sudah standar dunia; buat apa repot-repot menyelaraskannya dengan konsep adab turats?'"]
    --> B1["Tinjauan Epistemologi Syed Muhammad Naquib Al-Attas:<br/>'Adab is the recognition and acknowledgment of the right and proper place of things in the order of creation, leading to the condition of justice.'"]
    A --> B2["Tinjauan Taksonomi Afektif Krathwohl/Bloom:<br/>Ranah afektif Bloom bersifat netral-nilai sekuler (hanya mengukur penerimaan & organisasi nilai tanpa standar wahyu)."]
    A --> B3["Tinjauan Syariat Islam:<br/>Ilmu kognitif tinggi tanpa adab kepada Allah & makhluk melahirkan kezaliman dan arogansi intelektual."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Taksonomi adab Islam menjadi pemandu arah moral bagi seluruh capaian kognitif kependidikan."]
```
...
```mermaid
flowchart TD
    subgraph DekonstruksiTaksonomiBarat["DEKONSTRUKSI & REKONSTRUKSI TAKSONOMI FITRAH"]
        Level1["1. TA'LIM (Cognitive Acquisition - C1/C2)<br/>Memperoleh wawasan ilmu syar'i & sains kauniyyah secara benar."]
        
        Level2["2. TARBIYAH (Application & Habituation - C3/C4)<br/>Mempraktikkan ilmu dalam rutinitas ibadah & disiplin asrama 24 jam."]
        
        Level3["3. TA'DIB (Internalized Adab & Critical Thinking - C5/C6)<br/>Menempatkan segala sesuatu pada tempatnya; berakhlak mulia otonom."]
        
        Level4["4. TAZKIYAH & KHIDMAH (Transcendence & Contribution)<br/>Penyucian batin dari riya'/kibr & mendedikasikan ilmu untuk maslahat umat."]
...
```mermaid
flowchart TD
    subgraph PenerapanTaksonomiFitrahKelasDanAsrama["ALUR PENERAPAN TAKSONOMI FITRAH 24 JAM"]
        Kelas["1. DI DALAM KELAS (KBM): Asatidz memadukan C1-C6 dengan dalil syar'i & tadabbur makna."]
        
        Lorong["2. DI LORONG & MASJID: Musyrif mengamati aplikasi adab (Ta'dib) saat shalat & antre makan."]
        
        Kamar["3. DI KAMAR ASRAMA: Santri mengisi jurnal muhasabah malam (Tazkiyah & Metakognisi)."]
        
        Masyarakat["4. DI MASYARAKAT: Santri mengeksekusi proyek khidmah sosial nyata (Khidmah)."]
        
        Kelas --> Lorong --> Kamar --> Masyarakat
    end
```
