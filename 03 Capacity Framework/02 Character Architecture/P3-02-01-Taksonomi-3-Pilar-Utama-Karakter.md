...
```mermaid
flowchart TD
    subgraph Taksonomi3PilarTUMBUH["ARSITEKTUR TAKSONOMI 3 PILAR KARAKTER TUMBUH"]
        Pilar1["PILAR 1: FONDASI RUHIYAH & AKHLAK (Spiritual-Moral Core)<br/>1. Salimul Aqidah (Tauhid Murni)<br/>2. Shahihul Ibadah (Ibadah Khusyuk)<br/>3. Matinul Khuluq (Akhlak Santun & Restoratif)"]
        
        Pilar2["PILAR 2: KETANGGUHAN DIRI & AKAL (Physical-Cognitive Core)<br/>4. Qawiyyul Jism (Bugar, Bersih, Sehat)<br/>5. Mutsaqqaful Fikr (Nalar Kritis & Mutqin)<br/>6. Mujahadatun Linafsih (Regulasi Diri & Emosi)"]
        
        Pilar3["PILAR 3: KETERATURAN & KHIDMAH (Organizational-Social Core)<br/>7. Haritsun 'Ala Waqtih (Disiplin Waktu)<br/>8. Munazhzham fi Syu'unih (Kerapian 5S)<br/>9. Qadirun 'Alal Kasb (Kemandirian Finansial)<br/>10. Nafi'un Lighairih (Khidmah & Manfaat Umat)"]
        
        Pilar1 ==>|Mendasari & Menyucikan Niat| Pilar2
        Pilar2 ==>|Menjadi Sarana & Energi Fisik-Akal| Pilar3
        Pilar3 ==>|Membuktikan Kematangan Batin di Ranah Sosial| Pilar1
    end
```
...
```mermaid
flowchart TD
    subgraph HierarkiKausal3Pilar["HIERARKI KAUSALITAS TIGA PILAR KARAKTER"]
        P1_Core["1. PILAR 1: FONDASI RUHIYAH (Akidah, Ibadah, Akhlak)<br/>Menjadi AKAR POHON: Menyediakan niat ikhlas lillahi ta'ala & kompas moral azali."]
        
        P2_Trunk["2. PILAR 2: BATANG KETANGGUHAN (Fisik, Nalar, Mujahadah)<br/>Menjadi BATANG POHON: Memberikan kekuatan biologis & ketajaman akal untuk memikul beban."]
        
        P3_Fruit["3. PILAR 3: BUAH KHIDMAH (Waktu, Kerapian, Mandiri, Manfaat)<br/>Menjadi BUAH MANIS: Memberikan keteduhan, manfaat nyata, & kemakmuran bagi masyarakat luas."]
        
        P1_Core --> P2_Trunk --> P3_Fruit
    end
```
...
```mermaid
flowchart TD
    subgraph SiklusBimbingan3PilarAsrama["SIKLUS BIMBINGAN 3 PILAR DI ASRAMA 24 JAM"]
        Pagi["SUBUH - PAGI: PENGUATAN PILAR 1 & 2<br/>Shalat subuh berjamaah, dzikir ma'tsurat, olahraga raga, & sarapan gizi."]
        
        Siang["SIANG - SORE: PENGUATAN PILAR 2 & 3<br/>KBM kelas dialektis, tahfizh mutqin, manajemen waktu belajar, & wirausaha."]
        
        Malam["MAGHRIB - MALAM: PENGUATAN PILAR 1, 2, & 3<br/>Kajian kitab adab, piket kebersihan kamar 5S, muhasabah diri, & istirahat 7 jam."]
