...
flowchart TD
    subgraph ArsitekturCharacterTUMBUH["5 PILAR MASTER ARSITEKTUR KARAKTER PESANTREN TUMBUH"]
        ...
        P4["PILAR 4: RUBRIK BARS TERAMATI (P3-02-04)<br/>• Deskriptor perilaku konkret 24 jam.<br/>• Protokol Fast-Logging digital <30 detik."]
        
        P5["PILAR 5: PSIKOMETRI & KALIBRASI (P3-02-05)<br/>• Validitas isi Aiken's V >= 0.85 (Panel 7 Pakar).<br/>• Reliabilitas Inter-Rater Fleiss' Kappa >= 0.80."]
        ...
        Pusat["TERBANGUNNYA SISTEM PEMBINAAN ADAB 24 JAM YANG ILMIAH, ADIL, & MEMBUMIKAN SUNNAH"]
...
graph TD
    subgraph TriadArsitekturKarakter["PERWUJUDAN TRIAD DALAM ARSITEKTUR KARAKTER"]
        ...
        Pesantren["3. PESANTREN / LEMBAGA TUMBUH<br/>• Memiliki bank data perilaku PBIS terukur & akuntabel.<br/>• Akreditasi mutu asrama diakui secara ilmiah.<br/>• Lingkungan aman, tertib, & memancarkan berkah."]
...
graph LR
    subgraph JembatanKonseptualArchitectureToRelationships["GERBANG DERIVASI SUB-DOMAIN 02 KE 03"]
        ...
        SD02 ==>|MENJADI FONDASI KARAKTER MODULAR BAGI ANALISIS INTERAKSI DI| SD03
    end
```
...
```mermaid
flowchart TD
    subgraph SiklusPenjaminanMutuArsitekturKarakter["SIKLUS PENJAMINAN MUTU ARSITEKTUR KARAKTER"]
        AuditKurikulum["1. AUDIT KURIKULUM ADAB (Setiap Tahun): Meninjau relevansi indikator BARS dengan perkembangan zaman."]
        ...
        AuditKurikulum --> KalibrasiMusyrif --> AnalisisDataPBIS --> RefleksiSantri --> AuditKurikulum
    end
```
