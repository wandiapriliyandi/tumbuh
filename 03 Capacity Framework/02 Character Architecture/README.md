...
## *Sitemap Induk & Navigasi Monograf Taksonomi 3 Pilar, Gradasi 4 Level Jenjang J1–J4, Penyelarasan Turats-Bloom, Rubrik BARS Teramati, & Validasi Psikometri (7 Monograf Terpadu)*
...
Sub-Domain `02 Character Architecture` membedah arsitektur taksonomi 10 Karakter Muwashafat ke dalam 3 pilar kluster, menetapkan 4 tingkat gradasi kemandirian (Jenjang Kemandirian TUMBUH (J1–J4) J1–J4), menyelaraskan taksonomi kognitif Bloom/Marzano dengan konsepsi adab Turats, menyusun deskriptor perilaku BARS teramati 24 jam, serta menegakkan validitas psikometri kuantitatif (Aiken's V & Fleiss' Kappa):

```mermaid
graph TD
    Architecture["SUB-DOMAIN 02: CHARACTER ARCHITECTURE (ARSITEKTUR KARAKTER - 7 MONOGRAF)"]
    
    Architecture --> Master["P3-02: Arsitektur Karakter Induk (Monograf Induk Sub-Domain 02)"]
    Architecture --> M1["P3-02-01: Taksonomi 3 Pilar Karakter (Ruhiyah, Ketangguhan, & Khidmah)"]
    Architecture --> M2["P3-02-02: Struktur Gradasi 4 Level (Jenjang Kemandirian TUMBUH (J1–J4) J1-J4)"]
    Architecture --> M3["P3-02-03: Penyelarasan Turats-Bloom (Integrasi C1-C6 & Adab Al-Attas)"]
    Architecture --> M4["P3-02-04: Skema Rubrik BARS Teramati (Deskriptor 24 Jam & Fast-Logging)"]
    Architecture --> M5["P3-02-05: Konstruk Psikometri & Validasi (Aiken's V >= 0.85 & Kappa >= 0.80)"]
    Architecture --> M6["P3-02-06: Sintesis Character Architecture TUMBUH (Grand Taxonomy Model)"]
```
...
| **01** | [**`P3-02-01-Taksonomi-3-Pilar-Utama-Karakter.md`**](./P3-02-01-Taksonomi-3-Pilar-Utama-Karakter.md) | Taksonomi 3 Pilar Utama Karakter | Tripartit Ruhiyah-Akhlak, Jasmani-Akal, & Keteraturan-Khidmah; integrasi 10 Muwashafat Khazanah Tarbiyah Adab Nabawi & 5 Kompetensi CASEL SEL (10 Catatan Kaki). |
| **02** | [**`P3-02-02-Struktur-Gradasi-4-Level-Kompetensi.md`**](./P3-02-02-Struktur-Gradasi-4-Level-Kompetensi.md) | Struktur Gradasi 4 Level Jenjang J1–J4 | *Maratibul Iman* Turats; Teori Kontinuum Regulasi Diri Deci-Ryan; ZPD Vygotsky; progresi T1 Kepatuhan s/d T4 Penggerak Qudwah (10 Catatan Kaki). |
