...
```mermaid
flowchart TD
    subgraph TransformasiDidaktikKeteraturan["REKONSTRUKSI DIDAKTIK TATA KELOLA HIDUP"]
        Semrawut["PEDAGOGI INKONSISTEN (TRADISIONAL)<br/>• Meja guru berantakan dipenuhi kertas kotor.<br/>• Kelas ditinggalkan kotor & papan tulis tercoreng.<br/>• Santri mencontoh kesemrawutan dari pendidik."]
        
        TUMBUH["EMPAT MODEL DIDAKTIK TATA KELOLA TUMBUH<br/>• Living Exemplary Orderliness: Meja guru 100% rapi & bersih.<br/>• Socratic Space-Audit & Hands-On 5S Organization Lab.<br/>• Micro-Habit Automated Conditioning & Clean Desk Policy.<br/>• Lingkungan belajar ergonomis melipatgandakan fokus kognitif."]
        
        Semrawut ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsKerapianMajelisIlmu["KERAPIAN MAJELIS ILMU SALAF"]
        HaditsShaf["HR. Abu Dawud No. 666:<br/>سَوُّوا صُفُوفَكُمْ وَحَاذُوا بَيْنَ الْمَنَاكِبِ وَسُدُّوا الْخَلَلَ<br/>(Luruskan Shaf Kalian, Sejajarkan Bahu, & Rapatkan Celah)"] --> Inti["Didaktik Munazhzham fi Syu'unih:<br/>Keteladanan Presisi Spasial Pendidik dalam Membangun Keteraturan"]
        ImamMalik["Imam Malik bin Anas (Al-Muwaththa'):<br/>Membakar Wewangian Bukhur & Merapikan Majelis Sebelum Mengajar Hadits"] --> Inti
        KhatibBaghdadi["Al-Khatib Al-Baghdadi (Al-Jami'):<br/>Adab Guru Menata Kitab di Meja & Menjaga Kebersihan Pena"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsInstruksionalTataKelola["SINTESIS DIDAKTIK ERGONOMI-SPASIAL"]
        VisualErgonomics["Visual Cognitive Ergonomics (Norman, 2013):<br/>• Clean Desk Policy: Meja yang bersih dari tumpukan benda asing menurunkan distraksi visual otak hingga 40%."]
        
        AtomicHabits["Atomic Micro-Habits (James Clear, 2018):<br/>• Mengotomatiskan 'Aturan 2 Menit' (merapikan sprei segera bangun & mengelap meja kelas)."]
        
        ZeroVandalism["Zero-Vandalism Environmental Culture:<br/>• Broken Windows Theory: Memperbaiki coretan meja seketika mencegah vandalisme massal."]
        
        VisualErgonomics & AtomicHabits & ZeroVandalism ==> DidaktikTUMBUH["DIDAKTIK TATA KELOLA PARIPURNA"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaSpasialKelasPresisi["REKAYASA SPASIAL KELAS 5S"]
        CleanDesk["1. CLEAN DESK MANDATE: Meja guru & santri hanya memuat buku pelajaran yang sedang dipelajari."]
        KotakSampah["2. TEMPAT SAMPAH DUA PILAH: Sampah kertas & plastik terpilah rapi di sudut kelas."]
        RakKitab["3. RAK KITAB KELAS BERSEKAT: Kitab-kitab referensi tersusun rapi menurut mata pelajaran."]
        ProtokolTransisi["4. PROTOKOL TRANSISI KELAS 2 MENIT: Menyeka papan tulis & merapikan meja sebelum guru berikutnya masuk."]
        
        CleanDesk ~~~ KotakSampah ~~~ RakKitab ~~~ ProtokolTransisi
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRestorasiMejaMadrasah["PROTOKOL RESTORASI ASET KELAS TIER 2"]
        TahapA["1. AUDIT VISUAL KERUSAKAN MEJA BERSAMA DEWAN GURU & KEPALA MADRASAH<br/>• Kepala Madrasah menegaskan bahwa meja madrasah adalah aset wakaf yang bernilai amanah syar'i."]
        
        TahapB["2. WORKSHOP SABTU BERKAH: AMPLAS & PERNIS MEJA BERSAMA SANTRI 8B<br/>• Guru & seluruh santri kelas 8B bersama-sama mengamplas coretan tip-ex & memernis ulang meja hingga berkilau."]
        
        TahapC["3. PENETAPAN PAKTA KELAS 'ZERO-GRAFFITI SANCTUARY'<br/>• Setiap santri menandatangani stiker nama di mejanya & bertanggung jawab menjaga kebersihan mejanya 100%."]
        
        TahapD["4. HASIL KEPEDULIAN & KEBERSIHAN KELAS PARIPURNA<br/>• Dalam 1 tahun ajaran, 0 coretan baru & kelas 8B meraih penghargaan 'The Most Beautiful Classroom'."]
...
```mermaid
flowchart TD
    subgraph EmpatModelDidaktikKeteraturan["EMPAT MODEL DIDAKTIK MUNAZHZHAM FI SYU'UNIH"]
        M1["MODEL 1: LIVING EXEMPLARY ORDERLINESS / QUDWAH (KETELADANAN PRESISI HIDUP)<br/>• Guru & musyrif memelihara meja kerja, kamar, & pakaian 100% rapi, bersih, & harum.<br/>• Menjadi living embodiment nilai-nilai Itqan & Husnut Tadbir."]
        
        M2["MODEL 2: SOCRATIC SPACE-AUDIT DIALECTICS (DIALOG AUDIT RUANG SOKRATES)<br/>• Membedah kesemrawutan kamar melalui analisis foto sebelum vs sesudah 5S.<br/>• Membimbing santri menyadari korelasi antara kerapian kamar dengan ketenangan berpikir."]
        
        M3["MODEL 3: HANDS-ON 5S ORGANIZATION LABORATORY (LAB PENATAAN 5S)<br/>• Praktik langsung teknik melipat pakaian KonMari Islami & pembukuan kas saku.<br/>• Melatih santri menyampul kitab & mengorganisasi arsip tugas madrasah."]
        
        M4["MODEL 4: MICRO-HABIT AUTOMATED CONDITIONING (KONDISIONING KEBIASAAN MIKRO)<br/>• Melatih kebiasaan 2 menit: Bed-making segera bangun, sandal di rak nomor, & clean desk.<br/>• Otomatisasi fungsi eksekutif spasial melalui pengulangan konsisten."]
        
        M1 & M2 & M3 & M4 ==> LingkunganRapi["SANTRI RAPI, BERSIH, MANDIRI, & BERADAB"]
    end
```
