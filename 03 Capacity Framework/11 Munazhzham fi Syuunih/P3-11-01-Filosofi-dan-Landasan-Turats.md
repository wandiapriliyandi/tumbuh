...
```mermaid
flowchart TD
    subgraph TransformasiFilosofiKeteraturan["REKONSTRUKSI FILOSOFI KETERATURAN HIDUP"]
        Kumuh["PARADIGMA KEKUMUHAN & GHASHAB (TRADISIONAL)<br/>• Normalisasi kamar pengap berantakan atas nama zuhud.<br/>• Budaya ghashab (memakai sandal/baju kawan tanpa izin).<br/>• Keuangan boros & barang pribadi hilang berulang kali."]
        
        TUMBUH["MUNAZHZHAM FI SYU'UNIH TUMBUH<br/>• Keteraturan lahiriah sebagai cermin ketertiban tauhid batin.<br/>• Integrasi Metodologi 5S Kaizen & Zero-Ghashab Protocol.<br/>• Standarisasi loker, literasi finansial, & kerapian 24 jam."]
        
        Kumuh ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsItqanHusnutTadbir["DOKTRIN ITQAN & HUSNUT TADBIR TURATS"]
        HaditsItqan["HR. Al-Baihaqi & Ath-Thabarani:<br/>إِنَّ اللَّهَ يُحِبُّ إِذَا عَمِلَ أَحَدُكُمْ عَمَلًا أَنْ يُتْقِنَهُ<br/>(Sesungguhnya Allah Mencintai Hamba yang Jika Mengerjakan Suatu Urusan, Ia Melakukannya Secara Rapi & Sempurna)"] --> Inti["Hakikat Munazhzham fi Syu'unih:<br/>Keteraturan Diri Presisi dalam Seluruh Urusan Hidup"]
        Mawardi["Al-Mawardi (Adab ad-Dunya wad-Din):<br/>'Husnut Tadbir (Manajemen Baik) Adalah Separuh Keberhasilan Hidup'"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Adab Menata Pakaian, Makanan, Harta Halal, & Kebersihan Kamar"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph Sains5SDanErgonomiRuang["SINTESIS METODOLOGI 5S & ERGONOMI KOGNITIF"]
        FiveS["Metodologi 5S Kaizen (Imai, 1986):<br/>1. Seiri (Ringkas/Sort): Memilah barang penting vs tak terpakai.<br/>2. Seiton (Rapi/Set in order): Setiap barang punya tempatnya sendiri.<br/>3. Seiso (Resik/Shine): Kebersihan & sanitasi harian.<br/>4. Seiketsu (Rawat/Standardize): Standarisasi visual tata letak loker.<br/>5. Shitsuke (Rajin/Sustain): Disiplin pembiasaan konsisten."]
        
        SpatialErgonomics["Visual Cognitive Ergonomics (Norman, 2013):<br/>• Ruang fisik yang rapi dan terlabel jelas menurunkan beban kognitif visual, meningkatkan fokus otak santri hingga 40%."]
        
        FiveS & SpatialErgonomics ==> StandarTUMBUH["SISTEM ASRAMA 5S TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph StandarisasiKamar5S["STANDARISASI ZONASI 5S KAMAR TIDUR ASRAMA"]
        Loker["1. SISTEM LOKER 5S TIGA SEKAT: Sekat 1 Kitab/Buku, Sekat 2 Pakaian Gantung, Sekat 3 Perlengkapan Mandi & Ibadah."]
        Ranjang["2. STANDAR BED-MAKING 'HOTEL-GRADE': Sprei ditarik kencang, bantal tertata rapi, selimut terlipat presisi."]
        Sepatu["3. RAK SANDAL/SEPATU BERLABEL NAMA & NOMOR: Setiap pasang sandal memiliki slot bernomor permanen."]
        Laundry["4. KERANJANG CUCIAN KOTOR TERTUTUP: Pakaian kotor tidak boleh digantung sembarangan di dinding kamar."]
        
        Loker ~~~ Ranjang ~~~ Sepatu ~~~ Laundry
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolEradikasiGhashab["PROTOKOL ERADIKASI GHASHAB TIER 1 & 2"]
        Step1["1. AUDIT FAKTA FIQH: 'MEMAKAI TANPA IZIN ADALAH GHASHAB HARAM'<br/>• Musyrif membedah hadits keharaman ghashab & menempel stiker edukasi di rak sandal."]
        
        Step2["2. PENYEDIAAN RAK SANDAL BERSEKAT DENGAN KODE NAMA SANTRI<br/>• Setiap santri wajib meletakkan sandalnya pada slot nomor pribadinya; musyrif menyediakan 5 pasang sandal darurat (Sandal Wakaf)."]
        
        Step3["3. SIDANG RESTORASI PEMULIHAN SANDAL HILANG<br/>• Seluruh kamar mengumpulkan sandal yang tertukar; mengembalikan kepada pemilik sah disertai permintaan maaf."]
        
        Step4["4. HASIL EVALUASI ASRAMA 'ZERO-GHASHAB SANCTUARY'<br/>• Dalam 14 hari, 0 kasus sandal hilang & santri memiliki kesadaran menjaga kehormatan barang orang lain 100%."]
...
```mermaid
flowchart TD
    subgraph ArsitekturFilosofisKeteraturan["EMPAT PILAR KAPASITAS MUNAZHZHAM FI SYU'UNIH"]
        P1["PILAR 1: PENATAAN FISIK & SISTEM LOKER 5S (AT-TANZHIIM AL-MĀDDI)<br/>• Kerapian ranjang tidur (Bed-Making), loker 3 sekat, & rak sepatu bernomor.<br/>• Eliminasi total barang tak terpakai & kebersihan ruang hidup 24 jam."]
        
        P2["PILAR 2: MANAJEMEN FINANSIAL AMANAH (AL-IDARAH AL-MĀLIYYAH)<br/>• Pengelolaan uang saku mingguan, pembagian pos infaq/kebutuhan/tabungan.<br/>• Anti-perilaku boros (Israf) & disiplin mencatat pengeluaran di buku kas saku."]
        
        P3["PILAR 3: KETERATURAN AKADEMIK & ARSIP KITAB (AT-TANZHIIM AL-'ILMI)<br/>• Buku catatan madrasah bersampul rapi, pena tersimpan di kotak pensil.<br/>• Inventarisasi kitab turats terjilid rapi & bebas dari halaman robek/hilang."]
        
        P4["PILAR 4: HIGIENITAS DIRI & PROTOKOL SANITASI (AN-NAZHAFAH AS-SYAR'IYYAH)<br/>• Mandi 2x sehari, menggosok gigi (Siwak), memotong kuku berkala.<br/>• Pakaian bersih berwangi sunnah & adab menjaga kesucian tempat ibadah."]
        
        P1 & P2 & P3 & P4 ==> InsanRapi["SANTRI RAPI, DISIPLIN, BERSIH, & BERWIBAWA"]
    end
```
