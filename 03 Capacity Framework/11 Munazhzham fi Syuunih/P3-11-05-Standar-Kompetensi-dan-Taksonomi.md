...
```mermaid
flowchart TD
    subgraph TransformasiTaksonomiKeteraturan["REKONSTRUKSI TAKSONOMI KETERATURAN HIDUP"]
        Biner["EVALUASI BINER KASAR (TRADISIONAL)<br/>• Vonis biner 'rapi' vs 'jorok' tanpa tahapan.<br/>• Tanpa kurikulum literasi finansial & arsip berjenjang.<br/>• Keterampilan psikomotorik penataan diabaikan."]
        
        TUMBUH["TAKSONOMI KETERATURAN FITRAH 4 LEVEL (TUMBUH)<br/>• Level 1: Al-Inqiyad (Kepatuhan 5S Terbimbing Checklist).<br/>• Level 2: Al-Intizham (Keteraturan Mandiri & Buku Kas Saku).<br/>• Level 3: At-Tanzhim ad-Dati (Audit 5S & Manajemen Portofolio).<br/>• Level 4: Al-Qudwah (Keteladanan Peradaban & Mentorship J1)."]
        
        Biner ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMaratibTartib["TINGKATAN PENATAAN DALAM TURATS"]
        Shatibi["Asy-Syathibi (Al-Muwafaqat):<br/>Dharuriyyat (Penjagaan Harta & Diri) -> Hajiyyat (Kemudahan Tata Kelola) -> Tahsinat (Estetika Kerapian Ihsan)"] --> Inti["Hakikat Taksonomi Keteraturan:<br/>Evolusi dari Pemenuhan Standar Wajib Menuju Keindahan Peradaban"]
        Ghazali["Al-Ghazali (Ihya'):<br/>Tingkatan Adab Makan, Tidur, Berpakaian, & Pengelolaan Nafaqah"] --> Inti
        Mawardi["Al-Mawardi (Al-Ahkam As-Sulthaniyyah):<br/>Manajemen Aset Publik & Tertib Administrasi"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsTaksonomiPsikomotorik["SINTESIS TAKSONOMI DAVE & FUNGSI EKSEKUTIF"]
        Dave["Dave's Psychomotor Taxonomy (1970):<br/>1. Imitation -> 2. Manipulation -> 3. Precision -> 4. Articulation -> 5. Naturalization."]
        
        SpatialExecutive["Executive Spatial Organization (Anderson, 2002):<br/>• Kematangan kognitif dalam memetakan, mengelompokkan, & memelihara tata letak fisik barang tanpa beban kognitif."]
        
        OBEStandards["OBE Competency Framework:<br/>• Penyelarasan SKI-SKD dengan capaian pembelajaran terukur."]
        
        Dave & SpatialExecutive & OBEStandards ==> TaksonomiTUMBUH["TAKSONOMI KETERATURAN FITRAH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaKurikulumOBEKeteraturan["REKAYASA KURIKULUM OBE BERJENJANG"]
        J1["J1 (Kelas 7): Keterampilan Dasar Loker 5S, Bed-Making 2 Menit, & Pencatatan Kas Harian."]
        J2["J2 (Kelas 8–9): Kemandirian Sanitasi Kamar Mandi, Jadwal Cuci Pakaian, & Pos Tabungan 20%."]
        J3["J3 (Kelas 10–11): Audit Mandiri 5S Kamar, Perencanaan Anggaran Bulanan, & Arsip Ilmiah."]
        J4["J4 (Kelas 12): Manajemen Aset Organisasi OPPM, Mentorship 5S Adik Kelas J1, & Qudwah Peradaban."]
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiInventaris["PROTOKOL PENDAMPINGAN INVENTARIS ORGANISASI TIER 2"]
        Step1["1. AUDIT LAPANGAN BERSAMA PEMBINA ORGANISASI ASRAMA (SARPRAS AUDIT)<br/>• Pembina mengajak Santri R menyisir seluruh sudut aula & mendokumentasikan kondisi fisik aset."]
        
        Step2["2. PELATIHAN STANDAR OPERASIONAL LOGISTIK & FORM SERAH TERIMA BARANG<br/>• Santri R dilatih menggunakan lembar kendali inventaris (*Equipment Check-Out Log*) berparaf."]
        
        Step3["3. TINDAKAN RESTORASI BERTANGGUNG JAWAB MEMPERBAIKI KABEL RUSAK<br/>• Santri R dibimbing menyolder kabel yang putus & membersihkan seluruh unit mikrofon di ruang sarpras."]
        
        Step4["4. HASIL KEMATANGAN TATA KELOLA LOGISTIK ACARA BERIKUTNYA<br/>• Pada acara wisuda, 100% inventaris tertata rapi, 0 barang hilang, & Santri R meraih predikat Koordinator Aset Terbaik."]
...
```mermaid
flowchart TD
    subgraph EmpatLevelTaksonomiKeteraturan["EMPAT LEVEL TAKSONOMI KETERATURAN FITRAH"]
        L1["LEVEL 1: AL-INQIYAD (KEPATUHAN TERBIMBING / GUIDED COMPLIANCE)<br/>• Mampu menata kasur, loker 3 sekat, & sandal di rak bernomor dengan panduan visual.<br/>• Mencatat uang saku harian dengan bimbingan wali kelas; 0% ghashab."]
        
        L2["LEVEL 2: AL-INTIZHAM (KETERATURAN MANDIRI / AUTONOMOUS HABITUATION)<br/>• Menjaga kerapian kamar & mencuci pakaian secara mandiri tanpa disuruh.<br/>• Disiplin menyisihkan pos tabungan 20% & merawat kitab pelajaran bersampul."]
        
        L3["LEVEL 3: AT-TANZHIIM AD-DATI (MANAJEMEN SISTEMIK OTONOM / SYSTEMIC MASTERY)<br/>• Mampu melakukan audit mandiri 5S kamar & merancang anggaran keuangan bulanan.<br/>• Mengorganisasikan arsip draf KTI & memelihara keindahan fasilitas asrama."]
        
        L4["LEVEL 4: AL-QUDWAH (KETELADANAN PERADABAN / EXEMPLARY LEADERSHIP)<br/>• Menjadi figur teladan kerapian 24 jam & memimpin manajemen aset organisasi.<br/>• Membimbing standarisasi 5S kamar santri junior J1 & menjadi inspirator keteraturan."]
...
| :--- | :--- | :--- |
| **Jenjang J1 (Kelas 7)<br/>*Level 1: Al-Inqiyad*** | Mampu melaksanakan pembiasaan tata kelola fisik kamar, higienitas dasar, dan pencatatan keuangan saku dengan panduan visual terstandar. | **1.1** Merapikan tempat tidur (*Bed-Making*) segera setelah bangun tidur sesuai standar.<br/>**1.2** Menata isi loker pakaian sesuai sistem 3 sekat 5S terlabel nama.<br/>**1.3** Mencatat setiap pengeluaran uang saku harian pada buku kas saku.<br/>**1.4** Menempatkan sandal/sepatu pada rak bersekat bernomor pribadi. |
| **Jenjang J2 (Kelas 8–9)<br/>*Level 2: Al-Intizham*** | Mampu membiasakan keteraturan hidup mandiri dalam sanitasi kamar mandi, perawatan arsip kitab, dan kedisiplinan menabung tanpa pengawasan ketat. | **2.1** Mencuci dan menjemur pakaian terjadwal tanpa menumpuk pakaian kotor.<br/>**2.2** Menyisihkan minimal 20% uang saku untuk pos tabungan terencana.<br/>**2.3** Menjaga seluruh kitab pelajaran bersampul rapi bebas halaman robek.<br/>**2.4** Memelihara kebersihan area sanitasi kamar mandi asrama secara gotong-royong. |
| **Jenjang J3 (Kelas 10–11)<br/>*Level 3: At-Tanzhim ad-Dati*** | Mampu mengorganisasikan tata kelola ruang hidup secara sistemik, merancang anggaran bulanan, dan menata arsip riset akademik mandiri. | **3.1** Melakukan audit mandiri (*5S Self-Audit*) terhadap kerapian kamar asrama.<br/>**3.2** Merancang anggaran keuangan bulanan dan menyalurkan pos infaq mandiri.<br/>**3.3** Mengarsipkan dokumen makalah, catatan kuliah/kitab, dan portofolio KTI rapi.<br/>**3.4** Berpartisipasi aktif dalam pemeliharaan sarana-prasarana lingkungan pesantren. |
| **Jenjang J4 (Kelas 12)<br/>*Level 4: Al-Qudwah*** | Mampu menampilkan keteladanan tata kelola peradaban, memimpin manajemen aset organisasi santri, dan membimbing adab keteraturan santri junior. | **4.1** Mengelola sistem logistik dan inventaris organisasi santri secara amanah.<br/>**4.2** Membimbing dan menginspeksi penerapan standar 5S adik asuh jenjang J1.<br/>**4.3** Menampilkan wibawa kepribadian rapi, wangi, bersih, dan profesional sejati.<br/>**4.4** Menuntaskan portofolio dokumen kelulusan dan arsip karya ilmiah paripurna. |
