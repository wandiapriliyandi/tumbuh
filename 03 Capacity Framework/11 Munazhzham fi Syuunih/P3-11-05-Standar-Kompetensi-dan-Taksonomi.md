...
```mermaid
graph TD
    Domain["3 Domain Kompetensi Munazhzham fi Syu'unih"]
    
    Domain --> K1["1. Kompetensi Kognitif Manajerial ('Aqliyyah)<br/>- Memahami prinsip 5R (Ringkas, Rapi, Resik, Rawat, Rajin).<br/>- Memahami konsep dasar pencatatan kas debet-kredit & budgeting."]
    
    Domain --> K2["2. Kompetensi Afektif (Qalbiyyah)<br/>- Menghargai keindahan & kenyamanan ruang yang tertata rapi.<br/>- Memiliki rasa tanggung jawab moral atas barang inventaris pesantren."]
    
    Domain --> K3["3. Kompetensi Psikomotorik & Perilaku (Amaliyyah)<br/>- Keterampilan melipat pakaian, menyusun buku & menata tempat tidur kencang.<br/>- Keterampilan menyusun proposal, SOP kerja panitia & laporan pertanggungjawaban."]
```
