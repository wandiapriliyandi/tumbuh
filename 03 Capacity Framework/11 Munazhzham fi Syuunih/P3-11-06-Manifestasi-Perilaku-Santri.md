...
```mermaid
flowchart TD
    subgraph TransformasiObservasiPerilaku["REKONSTRUKSI OBSERVASI PERILAKU KETERATURAN"]
        Subjektif["PENILAIAN SUBJEKTIF & KERAPIAN SEMU (TRADISIONAL)<br/>• Menilai berdasarkan mood musyrif tanpa deskriptor.<br/>• Pakaian kotor dilempar ke dalam lemari saat inspeksi.<br/>• Santri bingung standar operasional yang dinilai."]
        
        TUMBUH["KATALOG INDIKATOR TERAMATI 5 SETTING (TUMBUH)<br/>• Setting Kamar, Sanitasi, Kelas, Keuangan, & Perpustakaan.<br/>• BARS (Behaviorally Anchored Rating Scales) terstandar.<br/>• Deteksi dini red flags (Ghashab, Hoarding, & Israf)."]
...
```mermaid
flowchart LR
    subgraph TuratsObservasiAdabSalaf["OBSERVASI ADAB LAHIRIAH SALAF"]
        Zarnuji["Az-Zarnuji (Ta'limul Muta'allim):<br/>تَعْظِيمُ الْعِلْمِ تَعْظِيمُ الْكِتَابِ؛ فَلَا يَنْبَغِي لِطَالِبِ الْعِلْمِ أَنْ يَأْخُذَ الْكِتَابَ إِلَّا بِطَهَارَةٍ<br/>(Mengagungkan Ilmu Dimulai dari Mengagungkan Kitab; Wajib Membawa Kitab dalam Keadaan Bersih & Suci)"] --> Inti["Hakikat Observasi Perilaku Turats:<br/>Kerapian Fisik Sebagai Cermin Penghormatan Terhadap Syariat"]
        KhatibBaghdadi["Al-Khatib Al-Baghdadi (Al-Jami'):<br/>Adab Penataan Sandal di Luar Majelis & Menjaga Kebersihan Papan Tulis"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Adab Menata Pakaian Putih & Menggunakan Siwak Sebelum Majelis"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsBARSDanABAPerilaku["SINTESIS ABA & BARS PERILAKU"]
        BARS["Behaviorally Anchored Rating Scales (Smith & Kendall, 1963):<br/>• Menghubungkan setiap skor penilaian (1-4) dengan contoh tindakan konkret teramati di lapangan."]
        
        ABA["Applied Behavior Analysis (Cooper et al., 2020):<br/>• Mengidentifikasi Anteseden (Pemicu), Perilaku (Tindakan Kerapian), & Konsekuensi (Penguatan 4:1)."]
        
        EnvironmentalSignals["Visual Environmental Signals (Norman, 2013):<br/>• Garis batas visual & label rak menuntun perilaku otomatis."]
        
        BARS & ABA & EnvironmentalSignals ==> KatalogTUMBUH["KATALOG PERILAKU TERSTANDARISASI"]
    end
```
...
```mermaid
flowchart TD
    subgraph LimaSettingEkologiAsrama["LIMA SETTING OBSERVASI 24 JAM"]
        S1["SETTING 1: KAMAR TIDUR (Kasur, Loker 3 Sekat, Kolong Ranjang, & Lantai Kamar)."]
        S2["SETTING 2: RUANG SANITASI & KAMAR MANDI (Keranjang Mandi, Rak Sandal, & Jemuran Handuk)."]
        S3["SETTING 3: RUANG KELAS MADRASAH (Meja Belajar, Rak Kitab, Kotak Pensil, & Papan Tulis)."]
        S4["SETTING 4: AREA KANTIN & FINANSIAL (Buku Kas Saku, Antrean Makan, & Pengelolaan Sampah)."]
        S5["SETTING 5: RUANG ORGANISASI & PERPUS (Pengembalian Buku, Arsip Dokumen, & Peminjaman Aset)."]
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiPakaianBasah["PROTOKOL PEMBINAAN HIGIENITAS PAKAIAN TIER 2"]
        StepA["1. DIALOG EMPATIK PRIVAT: 'KEBERSIHAN ADALAH KASIH SAYANG BUKAN ANCAMAN'<br/>• Musyrif memeluk Santri B & menjelaskan bahwa jamur berbahaya bagi paru-paru & kulit tanpa memarahinya."]
        
        StepB["2. PEMBERSIHAN MASAL PAKAIAN BERJAMUR DENGAN CAIRAN ANTI-JAMUR<br/>• Santri B dibimbing merendam pakaian dengan cairan pembersih jamur & menjemurnya di bawah sinar matahari."]
        
        StepC["3. PELATIHAN JADWAL MIKRO CUCI HARIAN BERSAMA KAKAK ASUH J4<br/>• Kakak asuh J4 melatih Santri B mencuci 2 potong pakaian setiap selesai mandi sore & menggantungnya di rak nomor."]
        
        StepD["4. LAHIRNYA KEMANDIRIAN CUCI & KAMAR HARUM SEGAR<br/>• Dalam 2 pekan, kasur Santri B 100% bersih kering & ia menjadi santri yang sangat rajin mencuci pakaian."]
