...
```mermaid
flowchart TD
    subgraph TransformasiIntervensiKeteraturan["REKONSTRUKSI SISTEM INTERVENSI KERAPIAN ASRAMA"]
        LemparLemari["HUKUMAN LEMPAR LEMARI & KEKERASAN (TRADISIONAL)<br/>• Isi loker dilempar ke lantai/lapangan, dimaki di depan umum.<br/>• Memicu trauma asrama, baju rusak, & kebencian dendam.<br/>• Keterampilan teknis melipat & menata tidak diajarkan."]
        
        TUMBUH["ARSITEKTUR MULTI-TIER PBIS TATA KELOLA (TUMBUH)<br/>• Tier 1: Standar visual 5S 100% santri & rasio apresiasi 4:1.<br/>• Tier 2: CICO Tata Kelola, Laundry Scaffolding, & mentor J4.<br/>• Tier 3: Individualized Organizing Reclamation Plan & terapi CBT.<br/>• 0% kekerasan lempar lemari; penegakan konsekuensi logis 4R."]
        
        LemparLemari ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMetodePendidikanLemahLembut["METODE PENDIDIKAN NABAWI"]
        HaditsRifq["HR. Muslim No. 2594:<br/>إِنَّ الرِّفْقَ لَا يَكُونُ فِي شَيْءٍ إِلَّا زَانَهُ، وَلَا يُنْزَعُ مِنْ شَيْءٍ إِلَّا شَانَهُ<br/>(Sesungguhnya Kelembutan Tidaklah Berada Pada Sesuatu Melainkan Memperindahnya, & Tidaklah Dicabut Melainkan Memperburuknya)"] --> Inti["Hakikat Ta'dib Tata Kelola Syar'i:<br/>Membimbing Kebiasaan Rapi dengan Kelembutan & Kasih Sayang"]
        Ghazali["Al-Ghazali (Ihya'):<br/>Adab Menegur Anak dalam Kesalahan Rumah Tangga Secara Privat Tanpa Mempermalukan"] --> Inti
        Mawardi["Al-Mawardi (Adab ad-Dunya wad-Din):<br/>Keteladanan Mursyid Mengajarkan Seni Merapikan Kehidupan"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph PiramidaPBISMunazhzhamSyuunih["PIRAMIDA PBIS MULTI-TIER MUNAZHZHAM FI SYU'UNIH"]
        T1["TIER 1: PENCEGAHAN UNIVERSAL (80–90% Santri)<br/>• Penataan Standar Loker 5S Tiga Sekat & Bed-Making Hotel-Grade.<br/>• Isyarat Visual Garis Batas Rak Sandal Bernomor Pribadi.<br/>• Rasio Apresiasi Positif 4:1 bagi Kamar Terbersih di Apel Asrama."]
        
        T2["TIER 2: INTERVENSI TATA KELOLA TERARAH (10–15% Santri)<br/>• Program Check-In / Check-Out (CICO) Kerapian Loker.<br/>• Laundry Scaffolding Circle bersama Kakak Asuh J4.<br/>• Workshop Melipat Pakaian & Pengorganisasian Meja Belajar."]
        
        T3["TIER 3: REKLAMASI TATA KELOLA INTENSIF (1–5% Santri)<br/>• Individualized Organizing Reclamation Plan (IORP) Konselor BK.<br/>• Terapi Kognitif Perilaku (CBT) Mengatasi Hoarding / Kecemasan Ruang.<br/>• Pendampingan Literasi Keuangan & Restrukturisasi Anggaran Saku."]
...
```mermaid
flowchart TD
    subgraph RekayasaFasilitasTataKelola5S["REKAYASA FASILITAS TATA KELOLA ASRAMA"]
        LokerSekat["1. LOKER 3 SEKAT STANDAR LEAN: Kompartemen berlabel (Kitab, Baju, Mandi) memudahkan penataan."]
        HangerNomor["2. HANGER & JEPITAN JEMURAN BERNOMOR: Mencegah pakaian tertukar dan basah di dalam kamar."]
        RakSandal["3. RAK SANDAL BERKODE WARNA: Setiap kamar memiliki zona rak sandal sendiri berlabel nomor santri."]
        Pos5S["4. CORNER KHIDMAH 5S: Ruang bimbingan merapikan pakaian & klinik literasi keuangan asrama."]
        
        LokerSekat ~~~ HangerNomor ~~~ RakSandal ~~~ Pos5S
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolLockerReconstruction["PROTOKOL REKONSTRUKSI LOKER TIER 3"]
        Tahap1["1. SESI DEKONSTRUKSI TOTAL LOKER BERSAMA KAKAK ASUH J4 (SEIRI)<br/>• Seluruh isi loker dikeluarkan; dipilah menjadi: (1) Baju Bersih, (2) Baju Kotor, (3) Kitab, (4) Sampah Dibuang."]
        
        Tahap2["2. PENEMPELAN LABEL VISUAL 3 SEKAT & KOTAK ORGANIZER KECIL (SEITON)<br/>• Menempel stiker label pada setiap sekat & menyediakan kotak organizer kecil untuk kaos kaki dan pulpen."]
        
        Tahap3["3. PELATIHAN TEKNIK MELIPAT BAJU CEPAT 'KONMARI ISLAMI'<br/>• Santri E dilatih melipat baju secara vertikal agar semua pakaian terlihat jelas tanpa harus membongkar tumpukan."]
        
        Tahap4["4. HASIL AUDIT HARIAN & PRESTASI LOKER TELADAN (SHITSUKE)<br/>• Dalam 14 hari, loker Santri E menjadi salah satu loker paling rapi di asrama & ia meraih piagam Loker 5S Bintang Lima."]
...
```mermaid
flowchart TD
    subgraph TigaLapisPBISMunazhzhamSyuunih["SISTEM TIGA LAPIS INTERVENSI PBIS MUNAZHZHAM FI SYU'UNIH"]
        subgraph TIER1["TIER 1: PENCEGAHAN UNIVERSAL (100% SANTRI)"]
            T1A["• Standarisasi Loker 5S Tiga Sekat & Bed-Making."]
            T1B["• Rak Sandal Bersekat Bernomor Pribadi (Zero Ghashab)."]
            T1C["• Buku Kas Saku Harian & Pencatatan Arus Kas."]
            T1D["• Apresiasi 4:1 bagi Kamar Terbersih di Apel Asrama."]
        end

        subgraph TIER2["TIER 2: INTERVENSI TERARAH (10–15% SANTRI BERISIKO)"]
            T2A["• Check-In / Check-Out (CICO) Tata Kelola Loker."]
            T2B["• Laundry Scaffolding Circle bersama Kakak Asuh J4."]
            T2C["• Workshop Melipat Pakaian & Pengorganisasian Meja."]
            T2D["• Pendampingan Pos Tabungan Saku Mingguan."]
        end

        subgraph TIER3["TIER 3: REKLAMASI INTENSIF (1–5% SANTRI KRISIS)"]
            T3A["• Individualized Organizing Reclamation Plan (IORP)."]
            T3B["• Terapi CBT Mengatasi Compulsive Hoarding."]
            T3C["• Penanganan Medis Poskestren bagi Scabies Berat."]
            T3D["• Restrukturisasi Keuangan Saku Bersama Wali Santri."]
        end
...
| :--- | :--- | :--- | :--- | :--- |
| **Tier 1 (Universal)** | 100% Seluruh Santri Pondok | • Standarisasi loker 3 sekat, kasur hotel-grade, rak sandal nomor.<br/>• Buku kas saku harian & pos tabungan terencana.<br/>• Apresiasi penguatan positif 4:1 di apel asrama.<br/>• Audit visual kamar harian menggunakan form LOF-MS. | Harian & Berkelanjutan sepanjang tahun | Seluruh Musyrif Asrama, Guru Madrasah, & Wali Kamar |
| **Tier 2 (Targeted)** | 10–15% Santri yang lokernya sering berantakan, menunggak cucian | • Program CICO Tata Kelola (Check-in pagi & Check-out malam).<br/>• Laundry Scaffolding Circle bersama kakak asuh J4.<br/>• Workshop melipat pakaian & penataan kotak pensil meja.<br/>• Mentorship pembagian pos anggaran saku mingguan. | 3–6 Pekan (Sesi harian 10 menit CICO) | Musyrif Khusus 5S, Guru Wali Kelas, & Mentor Sebaya J4 |
| **Tier 3 (Intensive)** | 1–5% Santri yang mengalami hoarding kronis, ghashab berulang, scabies | • Individualized Organizing Reclamation Plan (IORP).<br/>• Terapi kognitif perilaku (CBT) mengatasi hoarding & kecemasan.<br/>• Protokol dekontaminasi pakaian air panas 60°C Poskestren.<br/>• Mediasi restoratif pengembalian aset ghashab bersama konselor BK. | 4–8 Pekan (Hingga tata kelola stabil) | Konselor BK, Dokter Poskestren, & Kepala Pengasuhan |
