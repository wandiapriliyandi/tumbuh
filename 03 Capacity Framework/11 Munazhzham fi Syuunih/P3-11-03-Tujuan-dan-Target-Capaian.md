...
```mermaid
flowchart TD
    subgraph TransformasiTargetKeteraturan["REKONSTRUKSI TARGET CAPAIAN KETERATURAN HIDUP"]
        Slogan["SLOGANISME ABSTRAK (TRADISIONAL)<br/>• Slogan 'Kebersihan Sebagian Iman' tanpa standar operasional.<br/>• Tanpa indikator Scabies 0% & Zero-Ghashab.<br/>• Santri menyapu hanya saat disuruh pengurus."]
        
        TUMBUH["STANDAR CAPAIAN CP-MS TUMBUH (OBE FRAMEWORK)<br/>• Dekomposisi Tri-Domain (Kognitif, Afektif, Psikomotorik).<br/>• Target Kuantitatif: Zero Ghashab & Scabies 0%.<br/>• Keterampilan hidup mandiri: Loker 5S & Buku Kas Saku."]
        
        Slogan ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMaqashidKeteraturan["MAQASHID SYARI'AH KETERATURAN TATA KELOLA"]
        Syathibi["Asy-Syathibi (Al-Muwafaqat):<br/>Penataan Harta & Perlindungan Hak Milik Merupakan Dharuriyyat Agama"] --> Inti["Hakikat Target CP-MS:<br/>Menjaga Kehormatan Harta & Kesehatan Santri Sesuai Syariat"]
        IbnuAsyur["Ibnu 'Asyur (Maqashid Asy-Syari'ah):<br/>Kerapian Sistem Kehidupan Merupakan Pilar Ketenteraman Masyarakat"] --> Inti
        Nawawi["Imam An-Nawawi (Al-Majmu'):<br/>Kewajiban Menjaga Kebersihan Pakaian & Tempat Shalat"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsOBEDanHBMKeteraturan["SINTESIS OBE & HEALTH BELIEF MODEL"]
        OBE["Outcome-Based Education (Spady, 1994):<br/>• Merancang kurikulum dari profil lulusan ideal (Insan Rapi & Mandiri) menuju capaian pembelajaran terukur."]
        
        HBM["Health Belief Model (Rosenstock, 1974):<br/>• Membangun kesadaran bahwa kamar kotor memicu penyakit kulit berbahaya (Perceived Susceptibility) sehingga mendorong adab higienis."]
        
        TQM["Total Quality Standards:<br/>• Kerapian loker 5S terverifikasi harian dengan audit visual."]
        
        OBE & HBM & TQM ==> StandarCPMS["CAPAIAN PEMBELAJARAN CP-MS TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaSanitasiDanKeuangan["REKAYASA SANITASI & KEUANGAN ASRAMA"]
        S1["1. MESIN CUCI & PENGERING ASRAMA: Menjamin pakaian santri kering sempurna tanpa dijemur di dalam kamar."]
        S2["2. KARTU SANTRI DIGITAL TERPADU (CASHLESS SMART CARD): Membatasi penarikan uang saku harian & rekam belanja."]
        S3["3. PROTOKOL CUCI SPREI DUA PEKANAN: Sanitasi sprei kamar tidur menggunakan air panas disinfektan."]
        S4["4. POS KEUANGAN SANTRI: Ruang bimbingan literasi keuangan & tabungan amanah asrama."]
...
```mermaid
flowchart TD
    subgraph ProtokolEradikasiScabies["PROTOKOL ERADIKASI SCABIES ASRAMA TIER 1 & 3"]
        Step1["1. DEKONTAMINASI MASAL SPREI & PAKAIAN DENGAN AIR PANAS 60°C<br/>• Seluruh pakaian, sarung, sprei, & selimut dicuci masal dengan air mendidih & dijemur di bawah terik matahari."]
        
        Step2["2. PENGOBATAN MEDIS SERENTAK DENGAN KRIM PERMETHRIN 5%<br/>• Seluruh santri kamar diobati serentak oleh Dokter Poskestren pada malam yang sama."]
        
        Step3["3. PEMBERLAKUAN 'INDIVIDUAL TOWEL & HANGER MANDATE'<br/>• Setiap santri wajib memiliki 1 rak handuk bernomor pribadi; larangan mutlak menggantung handuk basah di dalam kamar."]
        
        Step4["4. HASIL EVALUASI 30 HARI 'SCABIES-FREE DORMITORY'<br/>• Prevalensi penyakit kulit turun menjadi 0% & santri memiliki kesadaran higienitas pribadi yang sangat tinggi."]
...
```mermaid
flowchart TD
    subgraph DekomposisiTriDomainCPMS["DEKOMPOSISI CAPAIAN PEMBELAJARAN (CP-MS)"]
        subgraph KOGNITIF["A. DOMAIN KOGNITIF (KONSEPTUAL & NALAR)"]
            K1["• Menguasai Fiqh Thaharah, Fiqh Muamalah Keuangan, & Keharaman Ghashab."]
            K2["• Memahami Prinsip Metodologi 5S (Seiri, Seiton, Seiso, Seiketsu, Shitsuke)."]
            K3["• Menguasai Manajemen Anggaran Saku & Analisis Kebutuhan vs Keinginan."]
        end

        subgraph AFEKTIF["B. DOMAIN AFEKTIF (SIKAP & NILAI BATIN)"]
            A1["• Menghayati Kebersihan Lahiriah Sebagai Cermin Kesucian Kalbu (Thaharatul Batin)."]
            A2["• Memiliki Integritas Menjaga Kehormatan Hak Milik Orang Lain (Zero Ghashab)."]
            A3["• Menjunjung Nilai Hemat, Qana'ah, & Anti-Pemborosan (Anti-Israf)."]
        end

        subgraph PSIKOMOTORIK["C. DOMAIN PSIKOMOTORIK (KETERAMPILAN PRAKTIS)"]
            P1["• Mahir Merapikan Ranjang Kasur Standar Hotel & Menata Loker 3 Sekat 5S."]
            P2["• Terampil Mencatat Arus Kas Saku Harian & Membagi Pos Tabungan Mandiri."]
            P3["• Terampil Merawat, Menyampul, & Mengarsipkan Kitab Turats Tanpa Robek."]
        end
...
| :--- | :--- |
| **Jenjang J1 (Kelas 7, Usia 12–13)** | • Mampu merapikan tempat tidur segera setelah bangun tidur mandiri.<br/>• Mampu menata loker pakaian sesuai standar 3 sekat 5S terlabel.<br/>• Mampu mencatat pengeluaran uang saku harian di buku kas saku.<br/>• Membiasakan mandi 2x sehari & menaruh sandal di rak bernomor. |
| **Jenjang J2 (Kelas 8–9, Usia 13–15)** | • Mampu mencuci dan menjemur pakaian secara mandiri tanpa menumpuk cucian.<br/>• Mampu menyisihkan minimal 20% uang saku untuk pos tabungan terencana.<br/>• Mampu menjaga kebersihan area sanitasi kamar mandi asrama bersama.<br/>• Memelihara seluruh kitab pelajaran bersampul plastik rapi bebas coretan. |
| **Jenjang J3 (Kelas 10–11, Usia 15–17)** | • Mampu melakukan audit mandiri (*5S Self-Audit*) terhadap ruang kamar tidur.<br/>• Mampu merancang anggaran keuangan bulanan dan menyalurkan infaq mandiri.<br/>• Mampu mengorganisasikan arsip makalah, draf KTI, dan catatan ilmiah rapi.<br/>• Menjadi teladan higienitas pribadi dan menjaga wangi pakaian sunnah. |
| **Jenjang J4 (Kelas 12, Usia 17–18)** | • Mampu mengelola tata kelola aset organisasi santri (OPPM/OSIS) secara amanah.<br/>• Mampu membimbing dan menginspeksi penerapan standar 5S santri junior J1.<br/>• Mampu mengelola portofolio keuangan dan dokumen kelulusan secara paripurna.<br/>• Menjadi figur teladan kerapian, kebersihan, dan profesionalisme peradaban. |
...
Penerapan konsep **P3-11-03: TUJUAN DAN TARGET CAPAIAN MUNAZHZHAM FI SYUUNIH** di ekosistem pesantren TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
