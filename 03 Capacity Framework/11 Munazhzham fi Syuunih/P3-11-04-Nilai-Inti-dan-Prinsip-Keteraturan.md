...
```mermaid
flowchart TD
    subgraph TransformasiAksiologiKeteraturan["REKONSTRUKSI AKSIOLOGI KETERATURAN HIDUP"]
        Paksaan["KEPATUHAN KARENA TAKUT HUKUMAN (TRADISIONAL)<br/>• Merapikan kasur hanya karena takut disiram/dihukum.<br/>• Fasilitas publik dirusak; lingkungan madrasah dicoret.<br/>• Aktivitas kebersihan dianggap beban hukuman kuli."]
        
        TUMBUH["EMPAT NILAI INTI TATA KELOLA TUMBUH<br/>• Al-Amanah: Tanggung jawab penuh atas aset & fasilitas.<br/>• Al-Itqan: Standar mutu keunggulan & kerapian presisi.<br/>• An-Nazhafah: Kesucian raga sebagai cermin kesucian kalbu.<br/>• Al-Iqtishad: Manajemen finansial seimbang & anti-pemborosan."]
        
        Paksaan ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsKeadilanSpasial["HAKIKAT KEADILAN SPASIAL TURATS"]
        RaghibIsfahani["Ar-Raghib Al-Isfahani (Al-Mufradat):<br/>الْعَدْلُ: هُوَ وَضْعُ الشَّيْءِ فِي مَوْضِعِهِ اللَّائِقِ بِهِ<br/>(Keadilan Adalah Meletakkan Segala Sesuatu Pada Tempat yang Layak Baginya)"] --> Inti["Prinsip Keteraturan Islam:<br/>Menata Barang Pada Tempatnya Adalah Bagian dari Menegakkan Keadilan"]
        IbnuTaimiyyah["Ibnu Taimiyyah (Al-Hisbah):<br/>Kewajiban Menjaga Amanah Fasilitas Umum & Mengharamkan Pengrusakan"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Adab Menjaga Kebersihan Harta & Menjauhi Sikap Boros"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsInternalisasiNilaiKeteraturan["SINTESIS SDT & ETIKA KEBAJIKAN"]
        SDT["Self-Determination Theory (Deci & Ryan, 2000):<br/>• Menggeser motivasi dari External Regulation (takut hukuman) menuju Integrated Regulation (kerapian sebagai identitas diri)."]
        
        VirtueEthics["Aristotelian & Islamic Virtue Ethics:<br/>• Kerapian dan kebersihan sebagai kebajikan karakter (Fadhilah) yang dipraktikkan secara konsisten hingga menjadi fitrah kedua."]
        
        NudgeTheory["Nudge Spatial Design (Thaler & Sunstein):<br/>• Lingkungan asrama 5S memberikan dorongan visual alami untuk tertib."]
        
        SDT & VirtueEthics & NudgeTheory ==> InternalisasiTUMBUH["INTERNALISASI NILAI TATA KELOLA TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaBudayaKerapian24Jam["REKAYASA BUDAYA KERAPIAN ASRAMA"]
        Keteladanan["1. KETELADANAN MUSYRIF: Kamar musyrif menjadi standar percontohan 5S paling rapi & wangi."]
        Apresiasi["2. APRESIASI KAMAR TELADAN PEKANAN: Penghargaan bendera hijau bagi kamar terbersih di apel pagi."]
        Khidmah["3. BUDAYA KHIDMAH BERSAMA: Kerja bakti dilakukan dengan riang gembira diiringi nasyid kebersihan."]
        SanksiRestoratif["4. SANKSI RESTORATIF EDUKATIF: Merapikan fasilitas bersama bagi santri yang melanggar kerapian."]
        
        Keteladanan --> Apresiasi --> Khidmah --> SanksiRestoratif
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRestorasiFasilitas["PROTOKOL RESTORASI AMANAH FASILITAS TIER 2"]
        StepA["1. SESI DE-ESKALASI REGULASI EMOSI BERSAMA KONSELOR BK<br/>• Santri F ditenangkan, dibimbing istighfar, & diajak memahami bahaya merusak fasilitas umum."]
        
        StepB["2. PENGAKUAN TANGGUNG JAWAB RESTORASI FISIK FASILITAS (RESTITUTION)<br/>• Santri F didampingi bagian sarana-prasarana membeli engsel baru & memasangnya kembali dengan tangannya sendiri."]
        
        StepC["3. RESTUKTURISASI JADWAL BANGUN FAJAR SANTRI F<br/>• Santri F dibimbing bangun pukul 03.45 agar dapat mandi lebih awal sebelum terjadi antrean panjang."]
        
        StepD["4. LAHIRNYA KEPEDULIAN & TANGGUNG JAWAB FASILITAS ASRAMA<br/>• Santri F menjadi ketua tim piket pemeliharaan fasilitas kamar mandi & menjaganya dengan penuh amanah."]
...
```mermaid
flowchart TD
    subgraph EmpatNilaiIntiKeteraturan["EMPAT NILAI INTI MUNAZHZHAM FI SYU'UNIH"]
        N1["1. AL-AMANAH (INTEGRITAS & TANGGUNG JAWAB ASET)<br/>• Menjaga barang pribadi, mengharamkan ghashab, & memelihara fasilitas umum.<br/>• Kesadaran bahwa seluruh raga, waktu, & harta adalah titipan Allah."]
        
        N2["2. AL-ITQAN (KETELITIAN & KERAPIAN PRESISI)<br/>• Melakukan pekerjaan penataan secara sempurna, rapi, & berstandar mutu tinggi.<br/>• Anti-perilaku asal-asalan (Semberono) dalam merapikan ranjang & loker."]
        
        N3["3. AN-NAZHAFAH (KESUCIAN RAGA & HIGIENITAS SYAR'I)<br/>• Menjaga kebersihan tubuh, pakaian wangi, & sanitasi kamar tidur 24 jam.<br/>• Kebersihan lahiriah sebagai manifestasi dari kesucian tauhid batiniah."]
        
        N4["4. AL-IQTISHAD (KESEIMBANGAN FINANSIAL & HIDUP HEMAT)<br/>• Mengelola keuangan saku secara bijak, gemar berinfaq, & disiplin menabung.<br/>• Anti-pemborosan konsumtif (Israf) & gaya hidup qana'ah."]
        
        N1 & N2 & N3 & N4 ==> KarakterKeteraturan["SANTRI BERINTEGRITAS, RAPI, BERSIH, & BIJAK"]
    end
```
