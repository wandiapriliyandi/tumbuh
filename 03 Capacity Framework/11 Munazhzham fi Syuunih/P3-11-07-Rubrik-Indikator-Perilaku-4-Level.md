...
```mermaid
flowchart TD
    subgraph TransformasiRubrikKeteraturan["REKONSTRUKSI SISTEM PENILAIAN KERAPIAN ASRAMA"]
        VonisKasur["VONIS SUBJEKTIF TANPA RUBRIK (TRADISIONAL)<br/>• Menghukum kamar 'kotor' tanpa deskriptor kriteria.<br/>• Tanpa penghargaan atas progres perbaikan diri santri.<br/>• Santri bingung standar operasional yang harus dicapai."]
        
        TUMBUH["RUBRIK 4-LEVEL MUNAZHZHAM FI SYU'UNIH (TUMBUH)<br/>• Deskriptor kriteria faktual 4 dimensi (Fisik 5S, Finansial, Arsip, Sanitasi).<br/>• Penilaian berbasis bukti observasi LOF-MS & buku kas saku.<br/>• Uji reliabilitas Cohen's Kappa & penilaian pertumbuhan ipsatif."]
        
        VonisKasur ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMizanHisabAmal["TIMBANGAN AMAL DALAM KHASANAH TURATS"]
        Ghazali["Al-Ghazali (Ihya' - Kitab Tartibul Aurad):<br/>زِنْ كُلَّ عَمَلٍ بِمِيزَانِ الْإِحْسَانِ وَالْإِتْقَانِ<br/>(Timbanglah Setiap Pekerjaan dengan Timbangan Ihsan & Kerapian Presisi)"] --> Inti["Hakikat Rubrik Turats:<br/>Instrumen Penimbang Kualitas Tata Kelola Hidup Santri"]
        Mawardi["Al-Mawardi (Adab ad-Dunya wad-Din):<br/>Kriteria Pengukuran Manajemen Harta & Kebersihan Rumah"] --> Inti
        Muhasibi["Al-Muhasibi (Ar-Ri'ayah):<br/>Pemeriksaan Diri Terhadap Kerapian Fisik & Kesucian Batin"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPsikometriRubrikKeteraturan["STANDAR PSIKOMETRI RUBRIK MUNAZHZHAM FI SYU'UNIH"]
        IRR["Inter-Rater Reliability (Cohen's Kappa >= 0.88):<br/>• Kesepakatan penilaian inspeksi kamar antar-musyrif asrama.<br/>• Kalibrasi deskriptor kerapian 5S terstandar."]
        
        Brookhart["Analytical Rubric Design (Brookhart, 2018):<br/>• Kriteria kualitatif deskriptif berbasis bukti perilaku fisik teramati."]
        
        Ipsative["Ipsative Growth Standards (Hughes, 2014):<br/>• Mengukur kemajuan kerapian santri dibandingkan titik awal dirinya."]
        
        IRR & Brookhart & Ipsative ==> RubrikStandar["RUBRIK MUNAZHZHAM FI SYU'UNIH TERVALIDASI"]
    end
```
...
```mermaid
flowchart TD
    subgraph SistemAsesmenKeteraturan24Jam["INTEGRASI DATA ASESMEN TATA KELOLA HIDUP"]
        DataMusyrif["1. MUSYRIF ASRAMA: Inspeksi Kasur, Loker 3 Sekat 5S, & Rak Sandal (40%)."]
        DataGuru["2. GURU MADRASAH: Observasi Kerapian Meja Belajar, Kitab Bersampul, & Kotak Pensil (25%)."]
        DataSantri["3. SANTRI MANDIRI: Buku Kas Saku Harian & Form 5S Self-Audit (20%)."]
        DataPeer["4. ULASAN SEBAYA: Peer Review: Bebas Ghashab Sandal & Kerapian Jemuran Bersama (10%)."]
        DataSarpras["5. TIM SARANA-PRASARANA: Rekam Pemeliharaan & Ketiadaan Pengrusakan Fasilitas (5%)."]
        
        DataMusyrif & DataGuru & DataSantri & DataPeer & DataSarpras ==> Dashboard["DASHBOARD INTIZHAM-TUMBUH (IK-MS)"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolKalibrasiPenilai["PROTOKOL KALIBRASI PENILAI KEPENGASUHAN"]
        P1["1. SESI KALIBRASI FOTO SAMPEL 5S KAMAR BERSAMA TIM KEPENGASUHAN<br/>• Dewan musyrif membedah 20 foto standar kamar: mana yang masuk Level 1, 2, 3, dan 4 secara mufakat."]
        
        P2["2. PENETAPAN ATURAN TOLERANSI KESALAHAN RINGAN (TOLERANCE THRESHOLD)<br/>• Menetapkan bahwa sandal di rak dengan deviasi kecil tetap sah Level 3 jika seluruh area lain 100% rapi."]
        
        P3["3. UJI COBA JOINT INSPECTION (INSPEKSI BERSAMA DUA MUSYRIF)<br/>• Musyrif A & B melakukan inspeksi kamar bersama hingga mencapai kesepakatan Kappa >= 0.88."]
        
        P4["4. HASIL KONSISTENSI PENILAIAN LINTAS ASRAMA<br/>• Seluruh musyrif memiliki persepsi seragam & santri merasa diperlakukan secara adil tanpa diskriminasi."]
...
```mermaid
flowchart TD
    subgraph ArsitekturRubrik4LevelKeteraturan["EMPAT TINGKAT KEMATANGAN MUNAZHZHAM FI SYU'UNIH"]
        L1["LEVEL 1: AL-INQIYAD / PERINTISAN (EMERGING / PERLU BIMBINGAN 5S)<br/>• Menata kasur & loker dengan checklist visual; sering lupa menaruh sandal di rak nomor.<br/>• Buku kas saku terisi hanya jika diingatkan; kitab pelajaran mulai lusuh."]
        
        L2["LEVEL 2: AL-INTIZHAM / PEMBIASAAN (DEVELOPING / KETERATURAN MANDIRI)<br/>• Merapikan ranjang hotel-grade segera bangun; loker 3 sekat rapi mandiri.<br/>• Menaruh sandal di rak bernomor; mencuci baju terjadwal; tabungan saku 20%."]
        
        L3["LEVEL 3: AT-TANZHIIM AD-DATI / PEMANTAPAN (PROFICIENT / SISTEMIK & EFISIEN)<br/>• Audit 5S mandiri; merancang anggaran bulanan & infaq mandiri.<br/>• Kitab bersampul rapi bebas robek; mengorganisasikan portofolio riset KTI."]
        
        L4["LEVEL 4: AL-QUDWAH / KETELADANAN (EXEMPLARY / QUDWAH PERADABAN)<br/>• Teladan kerapian 24 jam; memimpin tata kelola aset organisasi santri OPPM.<br/>• Membimbing standarisasi 5S santri junior J1 & menjadi inspirator keteraturan peradaban."]
