...
```mermaid
flowchart TD
    subgraph TransformasiInstrumentasiKeteraturan["REKONSTRUKSI INSTRUMENTASI TATA KELOLA HIDUP"]
        TanpaInstrumen["EVALUASI TANPA REKAM DATA (TRADISIONAL)<br/>• Teguran kerapian lisan tanpa lembar kendali.<br/>• Kerusakan fasilitas diselesaikan dengan kekerasan.<br/>• Pengeluaran uang saku santri tidak pernah tercatat."]
        
        TUMBUH["PAKET INSTRUMEN MASTER TATA KELOLA (TUMBUH)<br/>• LOF-MS: Lembar observasi kerapian asrama 5S.<br/>• LKS-MS: Logbook buku kas saku harian & pos tabungan.<br/>• FAR-MS: Formulir audit tata kelola & restorasi fasilitas.<br/>• SPK-MS: Skala persepsi kemandirian tata kelola BK."]
...
```mermaid
flowchart LR
    subgraph TuratsTadwinInventaris["TRADISI DOKUMENTASI HISAB SALAF"]
        AyatTadwin["QS. Al-Baqarah: 282:<br/>يَا أَيُّهَا الَّذِينَ آمَنُوا إِذَا تَدَايَنْتُمْ بِدَيْنٍ إِلَى أَجَلٍ مُسَمًّى فَاكْتُبُوهُ<br/>(Wahai Orang Beriman! Jika Kalian Bermuamalah, Hendaklah Kalian Mencatatnya!)"] --> Inti["Hakikat Mutaba'ah Tertulis:<br/>Pencatatan Administrasi Sebagai Penegak Amanah Syariat"]
        Mawardi["Al-Mawardi (Al-Ahkam As-Sulthaniyyah):<br/>Dokumentasi Buku Kas & Daftar Inventaris Perlengkapan"] --> Inti
        Muhasibi["Al-Muhasibi (Ar-Ri'ayah):<br/>Hisab Harian Terhadap Pemasukan & Pengeluaran Rezeki"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPengukuranKeteraturan["VALIDITAS INSTRUMEN MUNAZHZHAM FI SYU'UNIH"]
        Construct["Construct Validity (Aiken's V >= 0.95):<br/>• Uji validitas isi oleh pakar manajemen asrama, ahli 5S, & psikolog kognitif."]
        
        EMA["Ecological Momentary Assessment (Stone & Shiffman):<br/>• Pencatatan data kas saku & 5S pada setting nyata 24 jam mengurangi bias ingatan."]
        
        VisualAudit["Visual 5S Audit Precision Standard:<br/>• Formulir LOF-MS terstandarisasi foto komparasi kamar Bintang Lima."]
        
        Construct & EMA & VisualAudit ==> InstrumenStandar["PAKET INSTRUMEN TATA KELOLA TERSTANDARISASI"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurMutabaahKeteraturan24Jam["ALUR MUTABA'AH TATA KELOLA 24 JAM"]
        SantriIsi["1. SANTRI MENGISI LKS-MS: Mencatat pengeluaran jajan harian & centang Bed-Making 2 menit."]
        MusyrifCek["2. MUSYRIF MEMVALIDASI LOF-MS: Memeriksa kasur, loker 3 sekat, rak sandal nomor, & paraf mingguan."]
        GuruMadrasah["3. GURU MENGISI REKAM MEJA: Memverifikasi kebersihan meja kelas & portofolio kitab bersampul."]
        AdminInput["4. INPUT DATA KE DASHBOARD INTIZHAM-TUMBUH: Seluruh skor disinkronkan ke basis data digital pesantren."]
        
        SantriIsi --> MusyrifCek --> GuruMadrasah --> AdminInput
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRestorasiKeuanganJujur["PROTOKOL RESTORASI KEJUJURAN KEUANGAN TIER 2"]
        Step1["1. DIALOG RESTORATIF PRIVAT 'HARTA BERKAH BUKAN DARI KEBOHONGAN'<br/>• Wali kelas membedah hakikat kejujuran rezeki & bahaya kebohongan finansial secara hangat."]
        
        Step2["2. PENGAKUAN TULUS KEPADA ORANG TUA MELALUI TELEPON RESTORATIF<br/>• Santri J secara ksatria mengakui kesalahannya kepada orang tua didampingi wali kelas."]
        
        Step3["3. TINDAKAN MENABUNG MANDIRI UNTUK MEMBELI KITAB ASLI<br/>• Santri J menyisihkan uang jajan Rp5.000/hari selama 10 hari hingga kitab Fathul Qarib terbeli secara sah."]
        
        Step4["4. HASIL INTEGRITAS KEUANGAN & PEMULIHAN KEPERCAYAAN<br/>• Dalam 30 hari, Santri J menjadi pencatat buku kas paling jujur & disiplin menabung di asrama."]
...
```mermaid
flowchart TD
    subgraph EmpatInstrumenMasterKeteraturan["EMPAT INSTRUMEN MASTER MUNAZHZHAM FI SYU'UNIH"]
        LOF["1. FORM LOF-MS (LEMBAR OBSERVASI KERAPIAN ASRAMA 5S)<br/>• Target: Musyrif Asrama & Guru Madrasah.<br/>• Fungsi: Menilai kasur hotel-grade, loker 3 sekat, rak sandal nomor, & meja kelas."]
        
        LKS["2. FORM LKS-MS (LOGBOOK BUKU KAS SAKU & POS TABUNGAN)<br/>• Target: Santri Mandiri.<br/>• Fungsi: Mencatat arus kas saku harian, pos tabungan 20%, infaq, & bed-making."]
        
        FAR["3. FORM FAR-MS (FORMULIR AUDIT TATA KELOLA & RESTORASI FASILITAS)<br/>• Target: Dewan Pengasuhan & Tim Sarpras.<br/>• Fungsi: Berita acara ghashab, analisis kerusakan fasilitas, & pakta restitusi 4R."]
        
        SPK["4. FORM SPK-MS (SKALA PERSEPSI KEMANDIRIAN TATA KELOLA)<br/>• Target: Konselor BK & Psikolog.<br/>• Fungsi: Mengukur tingkat perceived organizational competence, hoarding, & stres spasial."]
