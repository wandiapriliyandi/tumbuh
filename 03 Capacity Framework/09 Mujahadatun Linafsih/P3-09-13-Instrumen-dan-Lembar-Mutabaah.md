...
```mermaid
flowchart TD
    subgraph TransformasiInstrumentasiJiwa["REKONSTRUKSI INSTRUMENTASI EVALUASI JIWA"]
        TanpaInstrumen["EVALUASI SUBJEKTIF TANPA DOKUMEN (TRADISIONAL)<br/>• Tidak ada rekam jejak pengendalian amarah & tahajjud.<br/>• Mediasi perkelahian tanpa formulir perjanjian damai.<br/>• Nilai akhlak diberikan berdasarkan impresi sesaat musyrif."]
        
        TUMBUH["PAKET INSTRUMEN MASTER MUJAHADAH (TUMBUH)<br/>• LOF-ML: Lembar observasi pengendalian diri asrama.<br/>• JRM-ML: Jurnal muhasabah batin & puasa sunnah.<br/>• FMR-ML: Formulir mediasi restoratif Ishlah al-Bain.<br/>• SKS-ML: Skala kesejahteraan emosional santri BK."]
...
```mermaid
flowchart LR
    subgraph TuratsDaftarMuhasabah["TRADISI REKAM MUHASABAH TURATS"]
        Tawus["Thawus bin Kaisan:<br/>Memiliki Buku Catatan Khusus untuk Mencatat Kesalahan Diri & Menangisinya di Malam Hari"] --> Inti["Hakikat Mutaba'ah Jiwa:<br/>Audit Batin Harian Menuju Kesucian Jiwa"]
        Muhasibi["Al-Harits Al-Muhasibi (Ar-Ri'ayah):<br/>Daftar Hisab: Mengaudit Niat, Lintasan Hati, & Tindakan Anggota Tubuh"] --> Inti
        Ghazali["Al-Ghazali (Ihya' - Al-Murabathah):<br/>Musyarathah di Pagi Hari & Muhasabah di Malam Hari"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPengukuranAfektif["VALIDITAS INSTRUMEN MUJAHADATUN LINAFSIH"]
        Construct["Construct Validity (Aiken's V >= 0.94):<br/>• Uji validitas isi oleh pakar tasawuf, psikolog klinis, & ahli PBIS."]
        
        EMA["Ecological Momentary Assessment (Stone & Shiffman):<br/>• Pencatatan data emosi pada setting nyata 24 jam mengurangi recall bias."]
        
        RestorativeForm["Restorative Documentation Standard:<br/>• Formulir FMR-ML terakreditasi standar mediasi hukum Islam & perlindungan anak."]
        
        Construct & EMA & RestorativeForm ==> InstrumenStandar["PAKET INSTRUMEN MASTER TERSTANDARISASI"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurMutabaahJiwa24Jam["ALUR MUTABA'AH PENGENDALIAN DIRI 24 JAM"]
        SantriIsi["1. SANTRI MENGISI JRM-ML: Mencatat rekam tahajjud, puasa sunnah, refleksi amarah, & doa muhasabah."]
        MusyrifCek["2. MUSYRIF MEMVALIDASI LOF-ML: Memeriksa ketertiban kamar tidur, adab makan, & paraf mingguan."]
        KonselorBK["3. KONSELOR BK MENGISI SKS-ML: Merekam skor kesejahteraan emosional & mediasi kasus sengketa."]
        AdminInput["4. INPUT DATA KE DASHBOARD SAKINAH-TUMBUH: Seluruh skor disinkronkan ke basis data digital pesantren."]
        
        SantriIsi --> MusyrifCek --> KonselorBK --> AdminInput
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRestorasiIbadah["PROTOKOL RESTORASI KEJUJURAN SPIRITUAL TIER 2"]
        Step1["1. DIALOG RESTORATIF PRIVAT 'BERIBADAH UNTUK ALLAH BUKAN UNTUK CENTANG'<br/>• Musyrif membedah hakikat niat ikhlas & bahaya kebohongan batin secara hangat."]
        
        Step2["2. PEMBATALAN CATATAN PALSU & RESET TARGET IBADAH REALISTIS<br/>• Catatan palsu dibatalkan; target disesuaikan: tahajjud 2 rakaat 2x seminggu secara jujur."]
        
        Step3["3. MENTORSHIP BANGUN MALAM BERSAMA KAKAK ASUH J4<br/>• Kakak asuh J4 membimbing Santri N bangun malam dengan lembut tanpa paksaan."]
        
        Step4["4. PEMULIHAN KEJUJURAN BATIN & KEMANISAN DOA SIRR<br/>• Dalam 3 pekan, Santri N shalat tahajjud mandiri secara jujur & mencatat mutaba'ah dengan apa adanya."]
...
```mermaid
flowchart TD
    subgraph EmpatInstrumenMasterJiwa["EMPAT INSTRUMEN MASTER MUJAHADATUN LINAFSIH"]
        LOF["1. FORM LOF-ML (LEMBAR OBSERVASI PENGENDALIAN DIRI ASRAMA)<br/>• Target: Musyrif Asrama & Guru Madrasah.<br/>• Fungsi: Menilai pengendalian amarah, antre tertib, shalat subuh, & adab kamar tidur."]
        
        JRM["2. FORM JRM-ML (JURNAL MUHASABAH BATIN YAUMIYYAH)<br/>• Target: Santri Mandiri.<br/>• Fungsi: Mencatat rekam tahajjud, puasa sunnah, refleksi amarah, & taubat harian."]
        
        FMR["3. FORM FMR-ML (FORMULIR MEDIASI RESTORATIF ISHLAH AL-BAIN)<br/>• Target: Dewan Pengasuhan & Konselor BK.<br/>• Fungsi: Berita acara mediasi perselisihan, pengakuan salah, & pakta perdamaian."]
        
        SKS["4. FORM SKS-ML (SKALA KESEJAHTERAAN EMOSIONAL SANTRI)<br/>• Target: Konselor BK & Psikolog.<br/>• Fungsi: Mengukur tingkat kecemasan, homesickness, & stabilitas afektif santri."]
