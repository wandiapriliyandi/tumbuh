...
```mermaid
flowchart TD
    subgraph TransformasiDidaktikJiwa["REKONSTRUKSI DIDAKTIK PENGENDALIAN NAFSU"]
        Teoritis["DIDAKTIK HAFALAN TEORITIS (TRADISIONAL)<br/>• Menghafal definisi sabar tanpa latihan praktis.<br/>• Guru membentak saat marah (kontradiksi nilai).<br/>• Ketiadaan simulasi penanganan provokasi & syahwat."]
        
        TUMBUH["EMPAT MODEL DIDAKTIK TAZKIYAH TUMBUH<br/>• Living Exemplarity: Keteladanan kesabaran nyata pendidik.<br/>• Stress Inoculation Training: Latihan de-eskalasi emosi.<br/>• Reflective Socratic Tazkiyah & Guided Service Learning.<br/>• Guru sebagai Murabbi penyembuh jiwa santri."]
        
        Teoritis ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsTarbiyahQudwah["DIDAKTIK KETELADANAN NABAWI"]
        NashUswah["QS. Al-Ahzab: 21:<br/>لَّقَدْ كَانَ لَكُمْ فِي رَسُولِ اللَّهِ أُسْوَةٌ حَسَنَةٌ<br/>(Keteladanan Karakter Paripurna Rasulullah SAW)"] --> Inti["Didaktik Mujahadatun Linafsih:<br/>Keteladanan Hidup Menundukkan Ego & Memancarkan Ketenangan"]
        IbnuQayyim["Ibnu Qayyim (Madarijus Salikin):<br/>Tarbiyah Ruhiyah Menuntut Keselarasan Ucapan & Perbuatan Murabbi"] --> Inti
        Syathibi["Asy-Syathibi (Muwafaqat):<br/>Ulama Adalah Pewaris Nabi yang Membimbing dengan Tindakan Nyata"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsDidaktikAfektif["SINTESIS DIDAKTIK KOGNITIF-AFEKTIF MODERN"]
        SIT["Stress Inoculation Training (Donald Meichenbaum, 1985):<br/>1. Conceptualization Phase (Memahami Pemicu Emosi)<br/>2. Skills Acquisition & Rehearsal (Latihan Nafas, Wudhu, & Reappraisal)<br/>3. Application & Relapse Prevention (Simulasi Mengatasi Provokasi)"]
        
        Bandura["Social Learning Theory (Bandura, 1977):<br/>• Modeling: Santri meniru secara bawah sadar bagaimana ustadz merespons kemarahan & kesulitan."]
        
        SIT & Bandura ==> DidaktikTUMBUH["DIDAKTIK TAZKIYAH PARIPURNA"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaSpasialLatihanJiwa["ARENA LATIHAN MUJAHADAH 24 JAM"]
        MomenAntre["1. MOMEN ANTRE KAMAR MANDI: Latihan Kesabaran & Mengutamakan Teman (*Itsar*)."]
        MomenOlahraga["2. MOMEN OLAHRAGA BERSAMA: Latihan Menahan Emosi Saat Terkena Benturan Fisik."]
        MomenMakan["3. MOMEN MAKAN ASRAMA: Latihan Qana'ah, Makan Secukupnya, & Bersyukur."]
        MomenMalam["4. MOMEN SEPERTIGA MALAM: Latihan Mengalahkan Rasa Kantuk Demi Shalat Tahajjud."]
        
        MomenAntre ~~~ MomenOlahraga ~~~ MomenMakan ~~~ MomenMalam
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolTransformasiMusyrif["PROTOKOL PELATIHAN REGULASI EMOSI MUSYRIF"]
        TahapI["1. MEDIASI RESTORATIF PRIVAT & PERMINTAAN MAAF KEPADA SANTRI<br/>• Ustadz H secara ksatria meminta maaf kepada santri di hadapan pimpinan pondok (Keteladanan Jiwa Besar)."]
        
        TahapII["2. WORKSHOP 'THE CALM EDUCATOR: EMOTIONAL SELF-REGULATION'<br/>• Ustadz H mengikuti pelatihan teknik de-eskalasi emosi & pencegahan burnout 2 hari."]
        
        TahapIII["3. PEMBERIAN JEDA ISTIRAHAT SIRKADIAN & SUPERVISI COACHING<br/>• Mengatur ulang jadwal piket musyrif untuk menjamin tidur 7 jam & didampingi musyrif senior."]
        
        TahapIV["4. PENILAIAN REPUTASI KEHANGATAN ASRAMA (90 HARI)<br/>• Ustadz H bertransformasi menjadi musyrif paling sabar & dicintai santri di asramanya."]
...
```mermaid
flowchart TD
    subgraph EmpatModelDidaktikMujahadah["EMPAT MODEL DIDAKTIK MUJAHADATUN LINAFSIH"]
        M1["MODEL 1: LIVING EXEMPLARY / QUDWAH HASANAH (KETELADANAN HIDUP NYATA)<br/>• Pendidik memancarkan ketenangan, tidak pernah membentak, & memaafkan kawan.<br/>• Menjadi living embodiment nilai-nilai Madarijus Salikin."]
        
        M2["MODEL 2: REFLECTIVE SOCRATIC TAZKIYAH (DIALOG TAZKIYAH REFLEKTIF)<br/>• Membedah penyakit hati melalui pertanyaan dialektis mendalam.<br/>• Membimbing santri menyadari akar kesombongan, dengki, & riya' dalam jiwanya."]
        
        M3["MODEL 3: COGNITIVE-BEHAVIORAL EMOTIONAL INOCULATION (INOKULASI EMOSI)<br/>• Simulasi situasi memicu amarah (role-play provokasi) di ruang aman.<br/>• Melatih santri mempraktikkan protokol wudhu & cognitive reappraisal secara refleks."]
        
        M4["MODEL 4: GUIDED SERVICE LEARNING / KHIDMAH (PENGABDIAN MERUNTUHKAN EGO)<br/>• Penugasan khidmah sosial nyata: membersihkan toilet, melayani makanan santri baru.<br/>• Meruntuhkan ego kesombongan feodal & membangun empati kasih sayang."]
        
        M1 & M2 & M3 & M4 ==> JiwaMuthmainnah["PEMBINAAN KARAKTER JIWA BERKUALITAS"]
    end
```
