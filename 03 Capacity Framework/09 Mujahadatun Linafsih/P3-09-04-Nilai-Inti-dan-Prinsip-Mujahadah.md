...
```mermaid
flowchart TD
    subgraph RekonstruksiAksiologiMujahadah["REKONSTRUKSI NILAI PENGENDALIAN NAFSU"]
        Krisis["KRISIS NILAI TRADISIONAL & MODERN<br/>• Hedonisme digital & candu kepuasan instan.<br/>• Pamer ibadah di medsos (Digital Riya').<br/>• Asketisme ekstrem menyiksa tubuh tanpa syariat."]
        
        TUMBUH["EMPAT NILAI INTI MUJAHADAH TUMBUH<br/>• Al-Ikhlas: Niat murni menundukkan ego & riya'.<br/>• Ash-Shabr: Ketabahan aktif menahan syahwat & derita.<br/>• Al-'Iffah: Menjaga kesucian kehormatan lahir-batin.<br/>• Al-Hilm: Kelembutan hati meredam ledakan amarah."]
...
```mermaid
flowchart LR
    subgraph EmpatAkarNilaiMujahadah["EMPAT AKAR NILAI TURATS MUJAHADATUN LINAFSIH"]
        N1["1. AL-IKHLAS (QS. Al-Bayyinah: 5)<br/>وَمَا أُمِرُوا إِلَّا لِيَعْبُدُوا اللَّهَ مُخْلِصِينَ لَهُ الدِّينَ<br/>(Memurnikan Ketaatan Semata Karena Allah)"]
        N2["2. ASH-SHABR (QS. Ali 'Imran: 200):<br/>يَا أَيُّهَا الَّذِينَ آمَنُوا اصْبِرُوا وَصَابِرُوا وَرَابِطُوا<br/>(Ketabahan Berlapis & Kesiapsiagaan Jiwa)"]
        N3["3. AL-'IFFAH (HR. Muslim No. 2722):<br/>اللَّهُمَّ إِنِّي أَسْأَلُكَ الْهُدَى وَالتُّقَى وَالْعَفَافَ وَالْغِنَى<br/>(Doa Memohon Petunjuk, Taqwa, Kesucian Diri, & Kecukupan)"]
        N4["4. AL-HILM (HR. Al-Bukhari - Kitabul Adab):<br/>لَيْسَ الشَّدِيدُ بِالصُّرَعَةِ، إِنَّمَا الشَّدِيدُ الَّذِي يَمْلِكُ نَفْسَهُ عِنْدَ الْغَضَبِ<br/>(Orang Kuat Sejati: Yang Mampu Mengendalikan Diri Saat Marah)"]
        
        N1 & N2 & N3 & N4 --> Puncak["MUJAHADATUN LINAFSIH PARIPURNA"]
    end
```
...
```mermaid
flowchart TD
    subgraph SainsEtikaKebajikan["SINTESIS ETIKA KEBAJIKAN ISLAM"]
        Miskawaih["Ibnu Miskawaih (Tahdzibul Akhlaq):<br/>• Kebajikan adalah Titik Tengah Emas (The Golden Mean / Al-Wasath).<br/>• 'Iffah (Kesucian Diri) = Titik Tengah Antara Syahwat Liar (Syarah) & Mati Rasa (Jumud).<br/>• Hilm (Kelembutan) = Titik Tengah Antara Pemarah Brutal (Tahawwur) & Pengecut (Jubn)."]
        
        Virtue["Modern Virtue Ethics (MacIntyre, 1981):<br/>• Karakter moral dibentuk melalui pembiasaan praktik terpuji yang bermakna dalam komunitas."]
        
        Miskawaih & Virtue ==> NilaiStandar["AKSIOLOGI MUJAHADAH TERINTEGRASI"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaEkologiNilai["PENERAPAN NILAI DI SETTING ASRAMA"]
        KamarTidur["1. SETTING KAMAR ASRAMA: Praktik Al-'Iffah (Adab Menjaga Aurat & Batasan Sentuhan Tubuh)."]
        RuangMakan["2. SETTING RUANG MAKAN: Praktik Ash-Shabr & Qana'ah (Makan Secukupnya & Berbagi Makanan)."]
        Masjid["3. SETTING MASJID: Praktik Al-Ikhlas (Dzikir Sirr & Muhasabah Menangis Sendirian di Malam Hari)."]
        Lapangan["4. SETTING LAPANGAN OLAHRAGA: Praktik Al-Hilm (Sportivitas Murni & Tidak Membalas Pelanggaran)."]
        
        KamarTidur ~~~ RuangMakan ~~~ Masjid ~~~ Lapangan
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRestorasiKesucian["PROTOKOL RESTORASI KEHORMATAN MORAL TIER 3"]
        Fase1["1. SITTUR 'AURAT & MEDIASI TERTUTUP PRIVAT (CONFIDENTIAL CONVERSATION)<br/>• Musyrif merahasiakan aib Santri G secara mutlak dari santri lain (Menutup Aib Saudara)."]
        
        Fase2["2. DIALOG HATI KE HATI MEMBEDAH FIQH GHADH-DHUL BASHAR<br/>• Konselor membedah QS. An-Nur ayat 30 tentang menjaga pandangan & menjaga kemaluan."]
        
        Fase3["3. PENGHANCURAN MATERI TERLARANG SECARA SADAR OLEH SANTRI SENDIRI<br/>• Santri G membakar sendiri majalah tersebut sebagai simbol pembersihan taubat nasuha."]
        
        Fase4["4. PROGRAM PENINGKATAN RIYADHAH RUHANIYAH & PUASA SUNNAH<br/>• Santri G dibimbing konsisten puasa Daud/Senin-Kamis & olahraga beladiri intensif."]
...
```mermaid
flowchart TD
    subgraph FormulasiEmpatNilaiMujahadah["STRUKTUR AKSIOLOGIS EMPAT NILAI MUJAHADAH"]
        Ikhlas["1. AL-IKHLAS (KEMURNIAN NIAT MENUNDUKKAN EGO)<br/>• Beramal semata-mata mencari ridha Allah SWT.<br/>• Membersihkan hati dari riya', sum'ah, 'ujub, & haus pujian manusia."]
        
        Shabr["2. ASH-SHABR (KETABAHAN AKTIF MENGHADAPI COBAAN)<br/>• Sabar dalam menjalankan ketaatan yang berat.<br/>• Sabar menahan diri dari keharaman & sabar atas takdir yang pahit."]
        
        Iffah["3. AL-'IFFAH (KESUCIAN KEHORMATAN DIRI & NAFSU)<br/>• Menahan pandangan (*Ghadhdhul Bashar*) dari hal yang haram.<br/>• Menjaga kemaluan, perut, & lisan dari syahwat yang merusak."]
        
        Hilm["4. AL-HILM (KELEMAHLEMBUTAN & PENGENDALIAN AMARAH)<br/>• Menahan ledakan emosi saat marah & tidak membalas dendam.<br/>• Santun mengayomi kawan yang berbuat salah & berjiwa pemaaf."]
        
        Ikhlas & Shabr & Iffah & Hilm ==> Mahkota["MUJAHADATUN LINAFSIH PARIPURNA"]
    end
```
...
```mermaid
flowchart LR
    J1["J1 (KELAS 7)<br/>Kesabaran Adaptasi Awal<br/>• Sabar rindu keluarga<br/>• Tertib antre kamar mandi<br/>• Mengakui kesalahan diri"]
    --> J2["J2 (KELAS 8–9)<br/>Kesucian Diri ('Iffah)<br/>• Menjaga pandangan siber<br/>• Menerapkan Hilm saat diejek<br/>• Menolak provokasi sebaya"]
    --> J3["J3 (KELAS 10–11)<br/>Kemurnian Ikhlas Batin<br/>• Mengikis riya' & hasad<br/>• Resiliensi tahfidz tinggi<br/>• Memaafkan tulus kawan"]
    --> J4["J4 (KELAS 12)<br/>Kepemimpinan Hilm & Qudwah<br/>• Mengayomi adik kelas J1<br/>• Teladan kesabaran asrama<br/>• Jiwa Muthma'innah matang"]
```
...
Penerapan konsep **P3-09-04: NILAI INTI DAN PRINSIP MUJAHADATUN LINAFSIH** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
