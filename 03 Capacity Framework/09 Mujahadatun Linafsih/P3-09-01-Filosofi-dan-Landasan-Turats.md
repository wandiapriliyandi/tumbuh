...
```mermaid
flowchart TD
    subgraph TransformasiParadigmaMujahadah["REKONSTRUKSI PARADIGMA PENGENDALIAN NAFSU"]
        Represi["PARADIGMA REPRESI EMOSI KAKU (TRADISIONAL)<br/>• Menuntut kepatuhan buta & memendam emosi.<br/>• Bullying senioritas dibenarkan atas nama 'latihan mental'.<br/>• Akibat: Trauma psikologis, ledakan amarah, & histeria."]
        
        TUMBUH["PARADIGMA MUJAHADATUN LINAFSIH TUMBUH<br/>• Regulasi emosi otonom (Prefrontal Cortex vs Amigdala).<br/>• Tazkiyatun Nafs integratif (Madarijus Salikin & Ihya').<br/>• 0% perpeloncoan; iklim asrama Bi'ah Shalihah yang menenangkan."]
        
        Represi ==>|DIREKONSTRUKSI SECARA SISTEMIK MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMaratibNafs["TINGKATAN JIWA DALAM TURATS"]
        NashTazkiyah["QS. Asy-Syams: 9–10:<br/>قَدْ أَفْلَحَ مَن زَكَّاهَا ۝ وَقَدْ خَابَ مَن دَسَّاهَا<br/>(Keberuntungan Hakiki Terletak pada Pensucian Jiwa)"] --> Inti["Hakikat Mujahadatun Linafsih:<br/>Transformasi Nafs Ammarah Menuju Nafs Muthma'innah"]
        IbnuQayyim["Ibnu Qayyim (Madarijus Salikin):<br/>Empat Tingkatan Jihadun Nafs: Ilmu, Amal, Dakwah, & Sabar"] --> Inti
        Ghazali["Al-Ghazali (Ihya' - Riyadhatun Nafs):<br/>Menundukkan Syahwat Perut & Kemaluan Serta Mengobati Amarah"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph NeurosainsRegulasiEmosi["NEUROSAINS REGULASI EMOSI"]
        PFC["Dorsolateral & Ventromedial Prefrontal Cortex (dlPFC / vmPFC):<br/>• Pusat kendali nalar, inhibitory control, & self-monitoring.<br/>• Menekan impulsivitas hawa nafsu amarah & syahwat."]
        
        Amigdala["Sistem Limbik & Amigdala (Fight or Flight):<br/>• Pusat reaktivitas emosi instingtif primitif.<br/>• Amigdala Hijacking: Emosi meledak sebelum nalar sempat berpikir."]
        
        Gross["Model Regulasi Emosi James Gross (2015):<br/>• Situation Selection -> Situation Modification -> Attentional Deployment -> Cognitive Reappraisal -> Response Modulation."]
        
        PFC & Amigdala & Gross ==> Ketenangan["KETENANGAN JIWA (NAFS MUTHMA'INNAH)"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaSpasialMujahadah["REKAYASA SPASIAL ASRAMA TUMBUH"]
        KamarHening["1. KAMAR HENING & RUANG DZIKIR ASRAMA:<br/>• Tempat tenang untuk merenung, muhasabah, & menenangkan diri saat emosi memuncak."]
        
        RuangBK["2. RUANG CURHAT & KONSELING RAMAH SANTRI:<br/>• Ruang privat yang nyaman untuk de-eskalasi kecemasan & mediasi konflik sebaya."]
        
        PatroliHotspot["3. PATROLI TITIK RAWAN ASRAMA (HOTSPOTS PATROL):<br/>• Musyrif menjaga area rawan perpeloncoan (kamar mandi belakang, sudut jemuran)."]
        
        KamarHening & RuangBK & PatroliHotspot ==> ZeroBullying["LINGKUNGAN ASRAMA 100% AMAN DARI BULLYING"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolDeeskalasiEmosi["PROTOKOL DE-ESKALASI EMOSI AKUT TIER 3"]
        Tahap1["1. PEMISAHAN FISIK & AMANKAN LINGKUNGAN (PHYSICAL SAFETY)<br/>• Musyrif mendekat dengan tenang, suara rendah, tanpa senjata: 'Akhi B, antum aman di sini, tarik nafas dalam'."]
        
        Tahap2["2. PROTOKOL FISIOLOGIS WUDHU & AIR DINGIN (HR. ABU DAWUD)<br/>• Musyrif membimbing Santri B berwudhu dengan air dingin untuk menurunkan detak jantung & suhu tubuh."]
        
        Tahap3["3. SESI ACTIVE LISTENING DI RUANG KONSELING BK<br/>• Konselor memvalidasi luka batin Santri B: 'Ustadz paham antum sangat marah karena orang tua antum dihina'."]
        
        Tahap4["4. RESTORATIVE JUSTICE MEDIATION & ISHLAH AL-BAIN<br/>• Santri yang mengejek meminta maaf secara tulus; Santri B memperbaiki meja yang rusak secara sadar."]
...
```mermaid
flowchart TD
    subgraph ArsitekturMujahadatunLinafsih["EMPAT PILAR DIMENSI MUJAHADATUN LINAFSIH"]
        P1["PILAR 1: TAHAKKUM FID-DAWANI' (KONTROL IMPULSIVITAS & NAFSU SYAHWAT)<br/>• Menahan pandangan (*Ghadhdhul Bashar*) & menundukkan syahwat pornografi/makanan.<br/>• Disiplin bangun subuh & konsisten puasa sunnah tanpa terpaksa."]
        
        P2["PILAR 2: REGULASI EMOSI & MANAJEMEN AMARAH (KAZHMUL GHAIDZ)<br/>• Menahan ledakan amarah saat terprovokasi & bersikap sabar (*Hilm*).<br/>• Keterampilan *Cognitive Reappraisal* memaknai ujian dengan prasangka baik (*Husnuzh-Zhann*)."]
        
        P3["PILAR 3: ASH-SHABRU 'ALAL IBAADAH WAL BALA' (KETEKUNAN & RESILIENSI JIWA)<br/>• Sabar menjalankan ketaatan yang berat (tahajjud, hafalan, belajar).<br/>• Resiliensi mental menghadapi rindu rumah (*Homesickness*) & kesulitan hidup."]
        
        P4["PILAR 4: AT-TAWADHU' WA ITHRAHUN NAFS (KERENDAHAN HATI & ANTI-AROGANSI)<br/>• Mengikis penyakit hati: sombong (*Kibr*), dengki (*Hasad*), & pamer (*Riya'*).<br/>• Menghargai orang lain & menolak perpeloncoan/superioritas senior."]
        
        P1 & P2 & P3 & P4 ==> Output["INSAN ADABI BERJIWA TENANG (NAFS MUTHMA'INNAH)"]
    end
```
...
```mermaid
flowchart LR
    J1["JENJANG J1 (KELAS 7)<br/>Adaptasi Regulasi Dasar<br/>• Mengatasi homesickness<br/>• Disiplin bangun tepat waktu<br/>• Menahan tangisan amarah"]
    --> J2["JENJANG J2 (KELAS 8–9)<br/>Manajemen Konflik & Ghadhab<br/>• Mengendalikan amarah sebaya<br/>• Menjaga pandangan siber<br/>• Sabar saat dihukum logis"]
    --> J3["JENJANG J3 (KELAS 10–11)<br/>Ketahanan Mental & Ikhlas<br/>• Mengikis riya' & hasad<br/>• Resiliensi hafalan tinggi<br/>• Empati & pemaaf tulus"]
    --> J4["JENJANG J4 (KELAS 12)<br/>Ketenangan Jiwa & Qudwah<br/>• Menjadi teladan kesabaran<br/>• Mengayomi adik kelas J1<br/>• Jiwa Muthma'innah matang"]
```
...
```mermaid
flowchart TD
    subgraph MultiTierPBISMujahadah["ARSITEKTUR MULTI-TIER PBIS MUJAHADATUN LINAFSIH"]
        Tier1["TIER 1: PENCEGAHAN UNIVERSAL REGULASI EMOSI (100% Santri)<br/>• Pelatihan Manajemen Emosi & Dzikir Al-Ma'tsurat Pagi-Petang Harian.<br/>• Budaya Saling Memaafkan Sebelum Tidur di Kamar Asrama.<br/>• Apresiasi 'Santri Paling Sabar & Berjiwa Sejuk' Mingguan."]
        
        Tier2["TIER 2: INTERVENSI EMOSI TERARAH (10–15% Santri Rentan)<br/>• Kelompok Bimbingan Regulasi Amarah (Anger Management Group).<br/>• Konseling Homesickness & Penyesuaian Diri bagi Santri J1.<br/>• Peer Conflict Mediation (Mediasi Sebaya) Terlatih."]
        
        Tier3["Tier 3: RESTORASI INTENSIF & TERAPI SPIRITUAL (1–5% Santri Krisis)<br/>• Konseling Psikologis Individual & Terapi CBT Islami.<br/>• Lingkaran Keadilan Restoratif (Restorative Justice Circle) Kasus Perkelahian.<br/>• Rencana Pendampingan Emosi Terindividualisasi (Individualized Emotional Plan)."]
