...
```mermaid
flowchart TD
    subgraph TransformasiHalaqahRuhiyah["REKONSTRUKSI METODE HALAQAH RUHIYAH ASRAMA"]
        Formalitas["HALAQAH FORMALITAS KERING (TRADISIONAL)<br/>• Ceramah normatif tanpa sentuhan hati santri.<br/>• Ibadah sunnah hanya saat ada razia musyrif.<br/>• Tanpa mentorship kakak asuh; senioritas kaku."]
        
        TUMBUH["HALAQAH TAZKIYATUN NAFS DIALOGIS (TUMBUH)<br/>• Silabus Tematik 24 Pekan (Madarijus Salikin & Ihya').<br/>• Sesi Hening Muhasabah, Doa Rabithah, & Ladz-dzatul Munajah.<br/>• Peer Spiritual Mentorship J4–J1 & budaya saling memaafkan."]
...
```mermaid
flowchart LR
    subgraph TuratsMajalisTazkiyah["TRADISI MAJELIS TAZKIYAH SALAF"]
        HasanAlBashri["Hasan Al-Bashri (Majalisul Wa'zh):<br/>Kata-Kata yang Keluar dari Hati yang Ikhlas Pasti Akan Menembus Kalbu Pendengarnya"] --> Inti["Hakikat Halaqah Tazkiyah:<br/>Menyentuh Kalbu Santri Menuju Ketenangan Taqwa"]
        IbnuAthaillah["Ibnu 'Athaillah (Al-Hikam):<br/>Lampu Hati Menyala Melalui Dzikir & Muhasabah Malam"] --> Inti
        Nawawi["Imam An-Nawawi (At-Tibyan):<br/>Adab Menangis Saat Membaca Al-Qur'an di Malam Hari"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPsikologiTranspersonal["SINTESIS PSIKOLOGI TRANSPERSONAL & NEUROBIOLOGI"]
        Transpersonal["Transpersonal Psychology (Frankl, 1985 / Maslow):<br/>• Self-Transcendence: Kebutuhan jiwa manusia untuk terhubung dengan Dzat Yang Maha Kuasa."]
        
        Neurotheology["Neurosains Kontemplasi & Doa (Newberg, 2010):<br/>• Aktivasi Default Mode Network (DMN) mereda saat dzikir khusyuk, menurunkan hormon kortisol stres & memicu ketenangan batin."]
        
        Habituation["Spiritual Habituation Protocol:<br/>• Pembiasaan qiyamul lail 40 malam berturut-turut membentuk sirkuit saraf kebiasaan otomatis."]
        
        Transpersonal & Neurotheology & Habituation ==> ModelHalaqah["MODEL HALAQAH TAZKIYAH TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaSpasialHalaqahJiwa["SETTING RUANG HALAQAH TAZKIYAH"]
        Cahaya["1. PENERANGAN LAMPU REDUP / WARM LIGHT (AMBIENT LIGHTING):<br/>• Menciptakan suasana intim, tenang, & mempermudah perenungan batin."]
        
        Karpet["2. FORMASI KARPET MELINGKAR RAPAT (CLOSE CIRCLE):<br/>• Menghilangkan jarak fisik, menumbuhkan rasa kehangatan ukhuwah & perlindungan."]
        
        Aroma["3. AROMA WEWANGIAN BUKHUR / GAHARU ALAMI:<br/>• Menenangkan sistem saraf penciuman (*Olfactory Calming System*) & menyegarkan udara."]
        
        Cahaya & Karpet & Aroma ==> SuasanaKhusyuk["SUASANA SAKINAH & KHIDMAT PENUH KEBERKAHAN"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolPemulihanFutur["PROTOKOL PEMULIHAN JIWA TIER 2"]
        Langkah1["1. SANKSI DILARANG BEBAN BERLEBIH (MINDFUL SPIRITUAL REST)<br/>• Musyrif membebaskan Santri A dari target kuantitas hafalan selama 1 pekan; fokus shalat wajib khusyuk."]
        
        Langkah2["2. TERAPI TADABBUR ALAM & JALAN PAGI HENING (NATURE TAFFAKUR)<br/>• Santri A diajak berjalan hening di kebun pondok saat fajar menyingsing untuk merenungi ciptaan Allah."]
        
        Langkah3["3. SESI BEDAH HIKMAH KITAB AL-HIKAM BERSAMA USTADZ SENIOR<br/>• Membedah hikmah Ibnu 'Athaillah: 'Terkadang Allah membuka pintu ketaatan namun tidak membuka pintu penerimaan, dan terkadang Allah menakdirkanmu jatuh dalam kelemahan agar engkau merasa butuh kepada-Nya'."]
        
        Langkah4["4. PEMULIHAN KEMANISAN IMAN (HALAWATUL IMAN)<br/>• Dalam 10 hari, air mata taubat Santri A kembali mengalir & ia shalat malam dengan kebahagiaan luar biasa."]
...
```mermaid
flowchart TD
    subgraph SilabusHalaqah24PekanTazkiyah["SILABUS KURIKULUM HALAQAH TAZKIYAH TEMATIK"]
        Blok1["BLOK 1: FONDASI KESADARAN DIRI & TOBAT (Pekan 1–6)<br/>• Hakikat Niat Ikhlas, Bahaya Riya', Taubat Nasuha, & Muhasabatun Nafs."]
        
        Blok2["BLOK 2: MANAJEMEN NAFSU & REGULASI AMARAH (Pekan 7–12)<br/>• Menundukkan Syahwat, Menahan Amarah (Hilm), Ghadhdhul Bashar, & 'Iffah."]
        
        Blok3["BLOK 3: PENYUCIAN HATI DARI PENYAKIT BATIN (Pekan 13–18)<br/>• Mengikis Dengki (Hasad), Sombong (Kibr), 'Ujub, & Membangun Tawadhu'."]
        
        Blok4["BLOK 4: KEMATANGAN SAKINAH & CINTA ALLAH (Pekan 19–24)<br/>• Sabar Jamil, Syukur Hakiki, Ridha Takdir, & Ketenangan Nafs Muthma'innah."]
...
```mermaid
flowchart LR
    Fase1["FASE 1: 15 MENIT<br/>Tilawah & Tadabbur Teks<br/>• Pembacaan nash Turats.<br/>• Pemahaman konsep hati."]
    --> Fase2["FASE 2: 30 MENIT<br/>Dialog Hati-ke-Hati & Solusi<br/>• Curhat kasus emosional.<br/>• Bimbingan tazkiyah praktis."]
    --> Fase3["FASE 3: 15 MENIT<br/>Sesi Hening & Doa Rabithah<br/>• Muhasabah menangis sirr.<br/>• Komitmen tahajjud mandiri."]
```
...
```mermaid
flowchart TD
    subgraph ModelSpiritualMentorshipJ4J1["PROGRAM PEER SPIRITUAL MENTORSHIP"]
        MentorJ4["SANTRI PENGAYOM J4 (KELAS 12)<br/>• Membangunkan adik asuh J1 untuk shalat tahajjud dengan lembut.<br/>• Mendengarkan curahan hati adik asuh saat rindu rumah.<br/>• Memberikan keteladanan akhlak pemaaf & santun di asrama."]
        
        MenteeJ1["SANTRI MENTEE J1 (KELAS 7)<br/>• Memperoleh rasa aman, perlindungan, & kehangatan keluarga baru.<br/>• Berkonsultasi mengenai adaptasi kehidupan asrama.<br/>• Meniru kematangan ibadah & kesabaran kakak asuhnya."]
        
        MentorJ4 <==>|Bimbingan Kasih Sayang Harian| MenteeJ1
    end
```
...
Penerapan konsep **P3-09-11: PROGRAM PEMBINAAN DAN HALAQAH MUJAHADATUN LINAFSIH** di ekosistem pesantren TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
