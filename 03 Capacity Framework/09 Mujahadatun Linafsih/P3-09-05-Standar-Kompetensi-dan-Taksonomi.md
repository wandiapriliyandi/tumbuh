...
```mermaid
flowchart TD
    subgraph RekonstruksiTaksonomiJiwa["REKONSTRUKSI TAKSONOMI PENGENDALIAN NAFSU"]
        Formalitas["NILAI AKHLAK FORMALITAS (TRADISIONAL)<br/>• Nilai rapor sekadar huruf A/B tanpa deskriptor.<br/>• Mengabaikan regulasi amarah & kematangan emosi.<br/>• Tanpa pentahapan Takhalli, Tahalli, & Tajalli."]
        
        TUMBUH["TAKSONOMI JIWA FITRAH TUMBUH<br/>• 4 Level: Ta'alluq -> Takhalli -> Tahalli -> Tajalli/Qudwah.<br/>• Integrasi CASEL SEL (Self-Management & Social-Awareness).<br/>• Standarisasi SKI-SKD J1–J4 melahirkan insan Muthma'in."]
...
```mermaid
flowchart LR
    subgraph TuratsTakhalliTahalliTajalli["TAHAPAN EVOLUSI SPIRITUAL JIWA"]
        Takhalli["1. TAKHALLI (التَّخَلِّي):<br/>Membersihkan Diri dari Dosa Lahir & Batin (Riya', Hasad, Sombong, Amarah)"]
        --> Tahalli["2. TAHALLI (التَّحَلِّي):<br/>Menghiasi Diri dengan Ibadah Sunnah & Akhlak Mulia (Sabar, Ikhlas, Hilm)"]
        --> Tajalli["3. TAJALLI (التَّجَلِّي):<br/>Pancaran Ketenangan Jiwa Hakiki (An-Nafs al-Muthma'innah) & Makrifatullah"]
    end
```
...
```mermaid
flowchart TD
    subgraph KonvergensiTaksonomiAfektif["SINTESIS TAKSONOMI AFEKTIF & CASEL SEL"]
        Krathwohl["Taksonomi Afektif Krathwohl (1964):<br/>Receiving -> Responding -> Valuing -> Organization -> Characterization"]
        
        CASEL["CASEL SEL Competencies (2020):<br/>• Self-Awareness (Kesadaran Diri)<br/>• Self-Management (Manajemen Diri)<br/>• Social Awareness (Kepekaan Sosial)<br/>• Relationship Skills (Keterampilan Relasi)<br/>• Responsible Decision-Making"]
        
        Fitrah["Taksonomi Jiwa Fitrah TUMBUH:<br/>1. Ta'alluq wa Inqiyad (Penerimaan & Kepatuhan Terbimbing)<br/>2. Takhalli wa Mujahadah (Pengendalian Nafsu & Amarah)<br/>3. Tahalli wa Istiqamah (Kemandirian Ibadah & Ikhlas)<br/>4. Tajalli wa Qudwah Nafs (Ketenangan Jiwa & Kepemimpinan)"]
        
        Krathwohl & CASEL ==> Fitrah
    end
```
...
```mermaid
flowchart TD
    subgraph KurikulumJiwa24Jam["INTEGRASI KURIKULUM PENGENDALIAN DIRI 24 JAM"]
        Kamar["JAM KAMAR ASRAMA: Pembiasaan Takhalli (Menahan ego sekamar, antre, & menjaga lisan)."]
        Masjid["JAM MASJID & HALAQAH: Pembiasaan Tahalli (Shalat berjamaah tepat waktu, tilawah, & dzikir)."]
        AreaPublik["JAM SEKOLAH & LAPANGAN: Pembiasaan Tajalli (Sportivitas, pemaaf, & mengayomi adik kelas)."]
        
        Kamar <==> Masjid <==> AreaPublik
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolKematanganAfektif["PROTOKOL PENDAMPINGAN EMOSI TIER 2"]
        StepA["1. TEKNIK EMOTIONAL IDENTIFICATION & JOURNALING<br/>• Santri L dilatih mencatat emosi yang dirasakannya (Marah, Malu, Kecewa) & pemicunya di jurnal muhasabah."]
        
        StepB["2. REKONSTRUKSI MAKNA KEGAGALAN DENGAN KONSEP TAKDIR & IKHTIAR<br/>• Konselor membimbing Santri L memahami bahwa nilai ujian bukanlah penentu harga diri di hadapan Allah."]
        
        StepC["3. PELATIHAN ASERTIVITAS & COPING MECHANISM POSITIF<br/>• Santri L dilatih teknik relaksasi pernafasan 4-7-8 & dialog asertif saat merasa kecewa."]
        
        StepD["4. PENUGASAN SEBAGAI PENDAMPING BELAJAR ADIK KELAS J1<br/>• Memberdayakan Santri L untuk mengajar adik kelas guna menumbuhkan rasa percaya diri & tanggung jawab emosional."]
...
```mermaid
flowchart TD
    subgraph HierarkiTaksonomiJiwaFitrah["EMPAT LEVEL TAKSONOMI JIWA FITRAH MUJAHADATUN LINAFSIH"]
        L4["LEVEL 4: TAJALLI WA QUDWAH NAFS (KETENANGAN HAKIKI & TELADAN PENGAYOM)<br/>• Memiliki kestabilan emosi mutlak (*An-Nafs al-Muthma'innah*) di segala situasi.<br/>• Menjadi figur teladan kesabaran, pemaaf agung, & mengayomi tanpa perpeloncoan."]
        
        L3["LEVEL 3: TAHALLI WA ISTIQAMAH (KEMANDIRIAN IBADAH, RESILIENSI, & IKHLAS)<br/>• Konsisten menjalankan qiyamul lail & puasa sunnah secara mandiri tanpa pengawasan.<br/>• Resiliensi mental tinggi & membersihkan batin dari penyakit riya' serta hasad."]
        
        L2["LEVEL 2: TAKHALLI WA MUJAHADAH (REGULASI AMARAH & PEMBERSIHAN DIRI)<br/>• Mampu menahan amarah dengan wudhu; menolak provokasi teman sekamar.<br/>• Menjaga pandangan dari konten terlarang & menerima konsekuensi logis secara ikhlas."]
        
        L1["LEVEL 1: TA'ALLUQ WA INQIYAD (ADAPTASI AWAL & KEPATUHAN TERBIMBING)<br/>• Mampu mengatasi homesickness; disiplin bangun subuh & antre kamar mandi.<br/>• Menghormati ustadz & santri senior dengan adab santun."]
...
| :--- | :--- | :--- |
| **Pilar 1: Kontrol Impulsivitas** | **SKD-ML-1.1**<br/>**SKD-ML-1.2**<br/>**SKD-ML-1.3** | Menerapkan adab menjaga pandangan (*Ghadhdhul Bashar*) dari konten digital terlarang.<br/>Mampu menahan nafsu makan berlebih (*Qana'ah*) dan tertib antre fasilitas asrama.<br/>Menolak ajakan melanggar tata tertib asrama atas dasar kesadaran muraqabah. |
| **Pilar 2: Regulasi Amarah** | **SKD-ML-2.1**<br/>**SKD-ML-2.2**<br/>**SKD-ML-2.3** | Mempraktikkan protokol sunnah (berwudhu, duduk/berbaring) saat emosi memuncak.<br/>Menerapkan teknik *Cognitive Reappraisal* untuk meredam provokasi teman sekamar.<br/>Menampilkan sikap pemaaf tulus (*Al-'Afwu*) dan memediasi perselisihan kawan. |
| **Pilar 3: Resiliensi Jiwa** | **SKD-ML-3.1**<br/>**SKD-ML-3.2**<br/>**SKD-ML-3.3** | Mengatasi kecemasan rindu rumah (*Homesickness*) melalui penguatan ruhiyah.<br/>Menampilkan ketekunan dan ketabahan (*Ash-Shabr*) dalam menambah hafalan Al-Qur'an.<br/>Bangun qiyamul lail dan menjalankan puasa sunnah secara mandiri tanpa paksaan. |
| **Pilar 4: Kerendahan Hati** | **SKD-ML-4.1**<br/>**SKD-ML-4.2**<br/>**SKD-ML-4.3** | Membersihkan hati dari penyakit iri dengki (*Hasad*) dan pamer amal (*Riya'*).<br/>Mengikis arogansi senioritas dan memperlakukan santri junior dengan penuh kasih.<br/>Berjiwa besar mengakui kesalahan pribadi dan bersedia melakukan restitusi moral. |
...
Penerapan konsep **P3-09-05: STANDAR KOMPETENSI DAN TAKSONOMI MUJAHADATUN LINAFSIH** di ekosistem pesantren TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
