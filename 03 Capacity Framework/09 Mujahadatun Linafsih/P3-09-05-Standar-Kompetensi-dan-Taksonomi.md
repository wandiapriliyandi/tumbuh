...
```mermaid
graph TD
    Domain["3 Domain Kompetensi Mujahadatun Linafsih"]
    
    Domain --> K1["1. Kompetensi Kognitif ('Aqliyyah)<br/>- Memahami dinamika kerja nafsu (Ammarah, Lawwamah, Muthmainnah).<br/>- Menguasai strategi kognitif meredakan amarah & mengatasi kejenuhan belajar."]
    
    Domain --> K2["2. Kompetensi Afektif (Qalbiyyah)<br/>- Menumbuhkan rasa malu kepada Allah (Haya') saat terlintas niat bermaksiat.<br/>- Menikmati kelezatan menahan hawa nafsu demi meraih ridha Allah."]
    
    Domain --> K3["3. Kompetensi Regulasi Perilaku (Amaliyyah)<br/>- Menghentikan respon impulsif (Stop-Think-Act) saat terjadi konflik.<br/>- Menjalankan puasa sunnah & mematuhi aturan digital detox asrama."]
```
