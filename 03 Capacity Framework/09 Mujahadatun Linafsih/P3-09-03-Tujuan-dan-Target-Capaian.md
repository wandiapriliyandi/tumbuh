...
```mermaid
flowchart TD
    subgraph TransformasiTargetMujahadah["REKONSTRUKSI TARGET CAPAIAN REGULASI DIRI"]
        Negatif["TARGET NEGATIF PASIF (TRADISIONAL)<br/>• 'Pokoknya tidak melanggar tata tertib asrama'.<br/>• Tanpa pengukuran kematangan regulasi emosi & resiliensi.<br/>• Akibat: Santri pura-pura patuh & dendam terpendam."]
        
        TUMBUH["TARGET CAPAIAN MUJAHADATUN LINAFSIH (TUMBUH)<br/>• Capaian Pembelajaran (CP-ML) berbasis Tri-Domain Fitrah.<br/>• Target pengendalian amarah, puasa sunnah, & empati anti-bullying.<br/>• Matriks capaian berjenjang J1–J4 melahirkan jiwa Muthma'innah."]
        
        Negatif ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsTargetRiyadhah["TARGET CAPAIAN RIYADHATUN NAFS"]
        Ghazali["Al-Ghazali (Ihya' - Riyadhatun Nafs):<br/>حُسْنُ الْخُلُقِ عِبَارَةٌ عَنْ هَيْئَةٍ فِي النَّفْسِ رَاسِخَةٍ عَنْهَا تَصْدُرُ الْأَفْعَالُ بِسُهُولَةٍ وَيُسْرٍ مِنْ غَيْرِ حَاجَةٍ إِلَى فِكْرٍ وَرَوِيَّةٍ<br/>(Akhlak Mulia: Kondisi Jiwa Kokoh yang Memancarkan Kebaikan dengan Mudah)"] --> Inti["Target Capaian Mujahadatun Linafsih:<br/>Kematangan Regulasi Diri Spontan & Ketenangan Jiwa"]
        IbnuQayyim["Ibnu Qayyim (Madarijus Salikin):<br/>Tercapainya Derajat Sabar Jamīl & Ridha atas Takdir"] --> Inti
        Muhasibi["Al-Muhasibi (Ar-Ri'ayah):<br/>Kejernihan Hati dari Noda Riya', 'Ujub, & Hasad"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph StandarRegulasiEmosiDERS["SINTESIS KERANGKA KERJA DERS & TAZKIYAH"]
        DERS["DERS Framework (Gratz & Roemer, 2004):<br/>1. Non-acceptance of emotional responses (Penerimaan Emosi)<br/>2. Difficulty engaging in goal-directed behavior (Fokus Ibadah saat Stres)<br/>3. Impulse control difficulties (Kendali Impulsivitas)<br/>4. Lack of emotional awareness & clarity (Kejernihan Muhasabah Diri)<br/>5. Limited access to emotion regulation strategies (Strategi Dzikir & Reappraisal)"]
        
        Tazkiyah["Khazanah Tazkiyatun Nafs Islam:<br/>Muraqabah, Kazhmul Ghaidz, Sabar, Syukur, & Ikhlas."]
        
        DERS & Tazkiyah ==> TargetTUMBUH["TARGET KUANTITATIF-KUALITATIF MUJAHADATUN LINAFSIH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RitmeKematanganJiwa24Jam["RITME HARIAN PEMBIASAAN MUJAHADAH"]
        Subuh["04.00 - 05.30: Qiyamul Lail Mandiri, Shalat Subuh Berjamaah, & Dzikir Al-Ma'tsurat Pagi."]
        Siang["12.00 - 13.30: Qailulah (Tidur Siang 20 Menit) & Tertib Makan Qana'ah di Ruang Makan."]
        Sore["16.00 - 17.30: Olahraga Sunnah Raga & Saling Mengapresiasi Kawan Sebaya."]
        Malam["19.30 - 21.00: Halaqah Tazkiyatun Nafs, Muhasabah Harian, & Budaya Saling Memaafkan Sebelum Tidur."]
        
        Subuh --> Siang --> Sore --> Malam --> Subuh
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiDopamin["PROTOKOL DIGITAL DETOX & RESTORASI JIWA TIER 3"]
        Step1["1. PENYERAHAN GAWAI SECARA SADAR DENGAN MEDIASI NON-KEKERASAN<br/>• Musyrif berdialog empatik membedah siklus kecanduan dopamin tanpa membentak atau menghancurkan gawai."]
        
        Step2["2. PROTOKOL DETOKSIFIKASI DOPAMIN DIGITAL 30 HARI (DIGITAL DETOX)<br/>• Santri M dialihkan pada aktivitas fisik intensif (panahan/renang) & proyek kebun asrama untuk merestorasi reseptor dopamin."]
        
        Step3["3. MENTORSHIP TAHFIDZ & TAZKIYAH INTENSIF BERSAMA KAKAK ASUH J4<br/>• Kakak asuh J4 mendampingi Santri M menyetorkan kembali 3 juz hafalannya setiap ba'da Ashar."]
        
        Step4["4. KONSISTENSI QIYAMUL LAIL & EVALUASI KEMANDIRIAN BATIN<br/>• Dalam 4 pekan, pola tidur Santri M normal, hafalannya pulih, & ia meraih predikat Santri Bangkit Terbaik."]
...
```mermaid
flowchart TD
    subgraph StrukturTargetCPML["STRUKTUR TARGET CAPAIAN PEMBELAJARAN (CP-ML)"]
        CP["CAPAIAN PEMBELAJARAN INDUK MUJAHADATUN LINAFSIH"]
        
        T1["Target Pilar 1: Kontrol Impulsivitas<br/>• Disiplin Ibadah Tanpa Diawasi.<br/>• Menahan Pandangan & Syahwat Digital."]
        
        T2["Target Pilar 2: Regulasi Amarah<br/>• 0% Insiden Kekerasan Fisik/Verbal.<br/>• Penguasaan Protokol Wudhu & Reappraisal."]
        
        T3["Target Pilar 3: Resiliensi Jiwa<br/>• Ketekunan Menghafal Al-Qur'an.<br/>• Resiliensi Menghadapi Kegagalan/Ujian."]
        
        T4["Target Pilar 4: Kerendahan Hati<br/>• 0% Praktik Perpeloncoan Senioritas.<br/>• Sikap Mengayomi & Pemaaf Tulus."]
...
```mermaid
flowchart LR
    subgraph TargetProgresiJiwaJ1J4["PETA TARGET CAPAIAN KEMATANGAN JIWA J1–J4"]
        J1["J1 (KELAS 7): ADAPTASI & REGULASI DASAR<br/>Target: Adaptasi homesickness 100%, disiplin bangun tidur, patuh aturan asrama."]
        --> J2["J2 (KELAS 8–9): MANAJEMEN AMARAH & SEBAYA<br/>Target: 0% perkelahian, kontrol gawai digital, menerapkan wudhu saat marah."]
        --> J3["J3 (KELAS 10–11): RESILIENSI & KEIKHLASAN BATIN<br/>Target: Konsisten puasa sunnah, resiliensi hafalan tinggi, mengikis hasad."]
        --> J4["J4 (KELAS 12): KETENANGAN HAKIKI & QUDWAH<br/>Target: Teladan kesabaran, mengayomi adik kelas tanpa bullying, jiwa muthma'in."]
    end
```
...
| :--- | :--- | :--- |
| **Jenjang J1 (Kelas 7)** | • Mampu mengatasi rasa rindu rumah (*Homesickness*) dalam 4 pekan pertama.<br/>• Mengontrol emosi tangisan saat menghadapi kesulitan adaptasi asrama.<br/>• Melapor kepada musyrif jika merasa diperlakukan tidak adil, tanpa membalas memukul. | • Tertib bangun tidur pukul 04.00 dan merapikan ranjang mandiri.<br/>• Menghormati santri senior dan ustadz dengan adab yang santun.<br/>• Mau berbagi fasilitas kamar dan antre kamar mandi dengan sabar. |
| **Jenjang J2 (Kelas 8–9)** | • Mampu menerapkan protokol wudhu dan duduk saat emosi memuncak.<br/>• Menahan diri dari membalas ejekan nama orang tua atau fisik teman sekamar.<br/>• Memiliki imunitas menolak konten gawai ilegal dan pornografi. | • Tekun menambah hafalan Al-Qur'an meski menghadapi rasa bosan/lelah.<br/>• Menerima konsekuensi logis atas pelanggaran dengan lapang dada.<br/>• Tidak sombong atas kepemilikan barang bermerek atau status keluarga. |
| **Jenjang J3 (Kelas 10–11)** | • Mampu memaafkan kesalahan teman sebelum teman meminta maaf.<br/>• Menjadi penengah (*Mediator*) saat terjadi ketegangan antar-kawan sebaya.<br/>• Mengontrol nafsu makan berlebih dan konsisten puasa sunnah Senin-Kamis. | • Bangun shalat malam (Tahajjud) secara mandiri tanpa dibangunkan paksa.<br/>• Menjaga keikhlasan amal (membersihkan diri dari riya' dan sum'ah).<br/>• Menghargai prestasi teman lain tanpa merasa iri dengki (*Hasad*). |
| **Jenjang J4 (Kelas 12)** | • Memiliki kestabilan emosi tingkat tinggi menghadapi stres ujian akhir.<br/>• Menampilkan wibawa ketenangan (*Sakinah*) dalam seluruh tindakan.<br/>• Tidak pernah menggunakan kekuasaan senioritas untuk memerintah junior. | • Menjadi figur teladan kesabaran dan keikhlasan bagi seluruh santri asrama.<br/>• Mengasuh dan membimbing 2 santri junior J1 dengan penuh kasih sayang.<br/>• Memiliki konsep diri matang berakar pada keridhaan Allah SWT. |
...
Penerapan konsep **P3-09-03: TUJUAN DAN TARGET CAPAIAN MUJAHADATUN LINAFSIH** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
