...
```mermaid
flowchart TD
    subgraph TransformasiIntervensiJiwa["REKONSTRUKSI SISTEM PENANGANAN DISIPLIN ASRAMA"]
        Retributif["PARADIGMA HUKUMAN RETRIBUTIF (TRADISIONAL)<br/>• Menghukum fisik (rotan/jemur/push-up masal).<br/>• Menumbuhkan dendam batin & melanggengkan kekerasan.<br/>• Akar masalah emosi & luka korban terabaikan."]
        
        TUMBUH["ARSITEKTUR MULTI-TIER PBIS RESTORATIF (TUMBUH)<br/>• Tier 1: Budaya damai 100% santri & dzikir penenang jiwa.<br/>• Tier 2: Kelompok bimbingan amarah & mediasi sebaya.<br/>• Tier 3: Restorative Justice Circle & terapi pemulihan ukhuwah.<br/>• 0% kekerasan fisik; penegakan konsekuensi logis bermartabat."]
        
        Retributif ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsIshlahulBain["KONSEP ISHLAHUL BAIN DALAM SUNNAH"]
        HaditsIshlah["HR. Abu Dawud No. 4919 & At-Tirmidzi:<br/>أَلَا أُخْبِرُكُمْ بِأَفْضَلَ مِنْ دَرَجَةِ الصِّيَامِ وَالصَّلَاةِ وَالصَّدَقَةِ؟ قَالُوا: بَلَى. قَالَ: إِصْلَاحُ ذَاتِ الْبَيْنِ<br/>(Mendamaikan Perselisihan Lebih Utama dari Derajat Puasa & Shalat Sunnah)"] --> Inti["Hakikat Disiplin Restoratif:<br/>Memulihkan Ukhuwah & Menghilangkan Dendam Batin"]
        IbnuTaimiyyah["Ibnu Taimiyyah (Majmu' Fatawa):<br/>Tujuan Utama Ta'zir Adalah Mendidik Jiwa Bukan Melampiaskan Kemarahan"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Kewajiban Menghilangkan Permusuhan Sebelum Shalat Diterima"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph PiramidaPBISMujahadah["PIRAMIDA PBIS MULTI-TIER MUJAHADATUN LINAFSIH"]
        T1["TIER 1: PENCEGAHAN UNIVERSAL (80–90% Santri)<br/>• Kurikulum Manajemen Emosi & Dzikir Al-Ma'tsurat Pagi-Petang.<br/>• Budaya Saling Memaafkan Sebelum Tidur di Kamar Tidur Asrama.<br/>• Rasio Apresiasi Positif 4:1 bagi Santri Berjiwa Sabar & Pengayom."]
        
        T2["TIER 2: INTERVENSI EMOSI TERARAH (10–15% Santri)<br/>• Kelompok Bimbingan Regulasi Amarah (Anger Management Circle).<br/>• Pendampingan Homesickness & Transisi Adaptasi bagi Santri J1.<br/>• Peer Mediation (Mediasi Sebaya) Terlatih bagi Konflik Ringan."]
        
        T3["TIER 3: RESTORASI INTENSIF & TERAPI PSIKOLOGIS (1–5% Santri)<br/>• Restorative Justice Circle (Lingkaran Keadilan Restoratif) Kasus Perkelahian.<br/>• Terapi CBT Islami & Konseling Khusus Kasus Kecanduan Gawai/Pornografi.<br/>• Rencana Pendampingan Emosi Terindividualisasi (Individualized Emotional Plan)."]
...
```mermaid
flowchart TD
    subgraph RekayasaFasilitasSakinah["REKAYASA FASILITAS KETENANGAN ASRAMA"]
        F1["1. RUANG MEDIASI ISHLAH ASRAMA: Ruang privat berkarpet nyaman dengan formasi lingkaran tertutup."]
        F2["2. POJOK RELAKSASI & KAMAR DZIKIR: Tempat hening untuk meredakan emosi memuncak secara mandiri."]
        F3["3. KOTAK SURAT EMPATI SANTRI (EMPATHY BOX): Sarana menyampaikan keluh kesah privat ke konselor BK."]
        F4["4. PAPAN MOTIVASI UKHUWAH: Menampilkan kisah keteladanan pemaaf para sahabat & ulama salaf."]
        
        F1 & F2 & F3 & F4 ==> LingkunganDamai["IKLIM ASRAMA 100% DAMAI & BEBAS KEKERASAN"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolResolusiPerkelahian["PROTOKOL RESTORATIF PERKELAHIAN MASSAL TIER 3"]
        StepA["1. PEMISAHAN KELOMPOK & PROTOKOL WUDHU MASSAL (IMMEDIATE COOLING DOWN)<br/>• Musyrif memisahkan kedua kamar; seluruh santri dibimbing mengambil air wudhu dingin & duduk di masjid."]
        
        StepB["2. SESI SHALAT ISYA & DZIKIR AL-IKHLAS BERSAMA (SPIRITUAL RESET)<br/>• Suasana spiritual mengembalikan aktivasi Prefrontal Cortex & meredam lonjakan adrenalin amigdala."]
        
        StepC["3. RESTORATIVE JUSTICE CIRCLE MELINGKAR BERSAMA KEDUA KAMAR<br/>• Setiap santri dipersilakan mengungkapkan perasaannya secara bergantian tanpa memotong pembicaraan."]
        
        StepD["4. IKRAR PERDAMAIAN (ISHLAH AL-BAIN) & MAKAN BERSAMA SATU NAMPAN<br/>• Kedua kamar saling berpelukan, meminta maaf, & menyantap hidangan satu nampan (*Makan Tabarruk*)."]
...
```mermaid
flowchart TD
    subgraph TigaLapisPBISMujahadah["SISTEM TIGA LAPIS INTERVENSI PBIS MUJAHADATUN LINAFSIH"]
        subgraph TIER1["TIER 1: PENCEGAHAN UNIVERSAL (100% SANTRI)"]
            T1A["• Kurikulum Tazkiyatun Nafs & Adab Ukhuwah."]
            T1B["• Dzikir Al-Ma'tsurat Pagi-Petang & Shalat Khusyuk."]
            T1C["• Budaya Saling Memaafkan Sebelum Tidur di Kamar."]
            T1D["• Apresiasi 4:1 bagi Santri Paling Sabar & Santun."]
        end
        
        subgraph TIER2["TIER 2: INTERVENSI TERARAH (10–15% SANTRI BERISIKO)"]
            T2A["• Kelompok Bimbingan Regulasi Amarah (Anger Management)."]
            T2B["• Pendampingan Homesickness Santri Baru Jenjang J1."]
            T2C["• Mediasi Konflik Sebaya (Peer Mediation) Terlatih."]
            T2D["• Penyaluran Energi ke Olahraga Beladiri & Panahan."]
        end
        
        subgraph TIER3["TIER 3: RESTORASI INTENSIF & MEDIS (1–5% SANTRI KRISIS)"]
            T3A["• Lingkaran Keadilan Restoratif Kasus Perkelahian."]
            T3B["• Terapi CBT Islami Khusus Kasus Kecanduan Gawai/Pornografi."]
            T3C["• Mediasi Privat Kasus Pemalakan / Bullying Terselubung."]
            T3D["• Individualized Emotional Plan (IEP) Konselor BK."]
        end
...
| :--- | :--- | :--- | :--- | :--- |
| **Tier 1 (Universal)** | 100% Seluruh Santri Pondok | • Pembiasaan dzikir Al-Ma'tsurat pagi-petang berjamaah.<br/>• Jam tidur hening pukul 22.00 & budaya saling memaafkan.<br/>• Apresiasi penguatan positif 4:1 di apel asrama.<br/>• Patroli berkala di titik rawan asrama (*Hotspots Patrol*). | Harian & Berkelanjutan sepanjang tahun | Seluruh Musyrif Asrama, Guru Madrasah, & Wali Kamar |
| **Tier 2 (Targeted)** | 10–15% Santri yang mudah marah, cengeng rindu rumah, atau sering berselisih | • Kelompok bimbingan regulasi amarah 6 pekan.<br/>• Konseling adaptasi homesickness bagi santri J1.<br/>• Penyaluran hormon testosteron ke beladiri Tapak Suci.<br/>• Mediasi sebaya (*Peer Mediation*) oleh santri J4. | 4–6 Pekan (Sesi mingguan 45 menit) | Konselor BK Asrama, Musyrif Khusus, & Tutor Sebaya J4 |
| **Tier 3 (Intensive)** | 1–5% Santri yang terlibat perkelahian fisik, pemalakan, atau kecanduan gawai | • Sidang Lingkaran Keadilan Restoratif (*Restorative Circle*).<br/>• Terapi Kognitif Perilaku (CBT) Islami & Digital Detox.<br/>• Sanksi logis khidmah sosial melayani santri junior.<br/>• Pemantauan intensif mutaba'ah batin 60 hari. | 4–12 Pekan (Hingga tuntas teruji) | Dewan Pengawas Kepengasuhan, Psikolog Klinis, & Pimpinan Pondok |
...
Penerapan konsep **P3-09-10: PROTOKOL INTERVENSI DAN PEMBIASAAN MUJAHADATUN LINAFSIH** di ekosistem pesantren TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
