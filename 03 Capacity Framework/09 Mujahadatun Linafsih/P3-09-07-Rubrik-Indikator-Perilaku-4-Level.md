...
```mermaid
flowchart TD
    subgraph TransformasiRubrikMujahadah["REKONSTRUKSI SISTEM PENILAIAN KARAKTER JIWA"]
        Subjektif["PENILAIAN SUBJEKTIF ANGKA/HURUF (TRADISIONAL)<br/>• Nilai akhlak diberikan berdasarkan kedekatan/kesan musyrif.<br/>• Rawan bias Halo & Horn Effect; vonis permanen santri nakal.<br/>• Mengabaikan pertumbuhan personal santri (Ipsative Growth)."]
        
        TUMBUH["RUBRIK 4-LEVEL MUJAHADATUN LINAFSIH TUMBUH<br/>• Deskriptor kriteria faktual 4 pilar (Impulsivitas, Amarah, Resiliensi, Tawadhu').<br/>• Penilaian berbasis bukti observasi 24 jam & rekam mutaba'ah.<br/>• Uji reliabilitas Cohen's Kappa & sistem penilaian ipsatif berkelanjutan."]
...
```mermaid
flowchart LR
    subgraph TuratsMizanQalbi["TIMBANGAN MUHASABAH DALAM TURATS"]
        UmarBinKhattab["Sayyidina Umar bin Khattab RA:<br/>حَاسِبُوا أَنْفُسَكُمْ قَبْلَ أَنْ تُحَاسَبُوا، وَزِنُوا أَنْفُسَكُمْ قَبْلَ أَنْ تُوزَنُوا<br/>(Hisablah Diri Kalian Sebelum Dihisab; Timbanglah Diri Kalian Sebelum Ditimbang)"] --> Inti["Al-Mizanul Qalbi:<br/>Rubrik Evaluasi Diri yang Jujur, Adil, & Presisi"]
        Muhasibi["Al-Harits Al-Muhasibi (Ar-Ri'ayah):<br/>Audit Niat Setiap Detik Sebelum Beramal, Saat Beramal, & Sesudah Beramal"] --> Inti
        Ghazali["Al-Ghazali (Ihya' - Al-Murabathah):<br/>Enam Tingkat Penjagaan Jiwa: Musyharathah, Muraqabah, Muhasabah, Mu'aqabah, Mujahadah, Mu'atabah"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPsikometriAfektif["STANDAR PSIKOMETRI RUBRIK MUJAHADATUN LINAFSIH"]
        IRR["Inter-Rater Reliability (Cohen's Kappa >= 0.89):<br/>• Kesepakatan penilaian antar-musyrif kamar asrama.<br/>• Kalibrasi deskriptor perilaku regulasi emosi."]
        ...
        Ipsative["Ipsative Assessment Standard (Hughes, 2014):<br/>• Mengukur kemajuan santri dibandingkan dengan titik awal perilakunya sendiri."]
        
        IRR & Brookhart & Ipsative ==> RubrikStandar["RUBRIK MUJAHADATUN LINAFSIH TERVALIDASI"]
    end
```
...
```mermaid
flowchart TD
    subgraph SistemAsesmenJiwa24Jam["INTEGRASI DATA ASESMEN PENGENDALIAN DIRI"]
        DataMusyrif["1. MUSYRIF ASRAMA: Observasi Pengendalian Amarah, Antre, & Adab Kamar Tidur (35%)."]
        DataGuru["2. GURU MADRASAH: Observasi Kesabaran Belajar, Sportivitas, & Kejujuran Kelas (20%)."]
        DataSantri["3. SANTRI MANDIRI: Jurnal Muhasabah Batin, Rekam Tahajjud, & Puasa Sunnah (20%)."]
        DataPeer["4. ULASAN SEBAYA: Peer Assessment: Keharmonisan Kamar & Ketiadaan Bullying (15%)."]
        DataKonselor["5. KONSELOR BK: Catatan Bimbingan Resolusi Konflik & Manajemen Stres (10%)."]
        
        DataMusyrif & DataGuru & DataSantri & DataPeer & DataKonselor ==> Dashboard["DASHBOARD JIWA SANTRI (SAKINAH-TUMBUH)"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolKalibrasiPenilai["PROTOKOL KALIBRASI PENILAIAN ASRAMA"]
        P1["1. FORUM KALIBRASI MINGGUAN DEWAN KEPENGASUHAN (RATER STANDARDIZATION)<br/>• Menyatukan persepsi deskriptor rubrik berbasis bukti logbook faktual, bukan kesan subjektif."]
        
        P2["2. AUDIT LOGBOOK OBSERVASI HARIAN SANTRI R<br/>• Memeriksa data konkret: 0 insiden kekerasan fisik dalam 60 hari membuktikan pertumbuhan nyata."]
        
        P3["3. PENETAPAN SKOR KONSENSUS BERBASIS PERTUMBUHAN IPSATIF<br/>• Skor disepakati pada Level 2.85 (Kategori Berkembang Menuju Pemantapan)."]
        
        P4["4. PEMBERIAN UMPAN BALIK PENGUATAN POSITIF KEPADA SANTRI R<br/>• Musyrif A & B bersama-sama mengapresiasi kemajuan kesabaran Santri R di apel kamar."]
...
```mermaid
flowchart TD
    subgraph ArsitekturRubrik4LevelMujahadah["EMPAT TINGKAT KEMATANGAN MUJAHADATUN LINAFSIH"]
        L1["LEVEL 1: PERINTISAN (EMERGING / PERLU BANTUAN)<br/>• Masih cengeng rindu rumah; mudah meledak amarahnya; sering melanggar aturan asrama.<br/>• Ibadah hanya saat dipaksa; egois memperebutkan fasilitas sekamar."]
        
        L2["LEVEL 2: PEMBIASAAN (DEVELOPING / REGULASI TERBIMBING)<br/>• Mampu meredam amarah dengan wudhu; tidak membalas ejekan kawan sekamar.<br/>• Tertib shalat berjamaah; menjaga pandangan dari konten terlarang di gawai."]
        
        L3["LEVEL 3: PEMANTAPAN (PROFICIENT / MANDIRI & RESILIEN)<br/>• Konsisten qiyamul lail & puasa sunnah secara mandiri tanpa pengawasan.<br/>• Resiliensi hafalan tinggi; pemaaf tulus; membersihkan hati dari dengki."]
        
        L4["LEVEL 4: KETELADANAN (EXEMPLARY / QUDWAH NAFS)<br/>• Kestabilan jiwa mutlak (*An-Nafs al-Muthma'innah*); berwibawa & tenang di situasi krisis.<br/>• Mengayomi adik kelas J1 tanpa perpeloncoan; teladan kesabaran asrama."]
