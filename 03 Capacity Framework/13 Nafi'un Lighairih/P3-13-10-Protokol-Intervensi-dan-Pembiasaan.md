...
```mermaid
flowchart TD
    subgraph TransformasiIntervensiSosial["REKONSTRUKSI INTERVENSI MASALAH SOSIAL"]
        HukumanRetributif["HUKUMAN FISIK & BALAS DENDAM (TRADISIONAL)<br/>• Menghukum pelaku dengan kekerasan baru.<br/>• Korban diabaikan tanpa pemulihan trauma.<br/>• Memicu dendam sosial & perundungan berantai."]
        
        TUMBUH["ARSITEKTUR PBIS MULTI-TIER RESTORATIF (TUMBUH)<br/>• Tier 1: Universal Kurikulum Khidmah & Posko Ukhuwah (100%).<br/>• Tier 2: Targeted Empathy Circle & Buddy Care (15%).<br/>• Tier 3: Intensive Restorasi Ishlahul Bain & Anti-Bullying (5%).<br/>• SOP Konsekuensi Logis Edukatif 4R & Zero Violence Policy."]
        
        HukumanRetributif ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsIshlahDzatilBain["DOKTRIN ISHLAH DALAM SUNNAH & TURATS"]
        HaditsIshlah["HR. Abu Dawud No. 4919:<br/>أَلَا أُخْبِرُكُمْ بِأَفْضَلَ مِنْ دَرَجَةِ الصِّيَامِ وَالصَّلَاةِ وَالصَّدَقَةِ؟ إِصْلَاحُ ذَاتِ الْبَيْنِ<br/>(Maukah Aku Kabarkan Amalan yang Lebih Utama dari Derajat Puasa, Shalat, & Sedekah? Mendamaikan Perselisihan!)"] --> Inti["Hakikat Intervensi Restoratif:<br/>Menghilangkan Kedengkian, Memulihkan Cinta Kasih, & Menjaga Persaudaraan Iman"]
        AyatIshlah["QS. Al-Hujurat: 10:<br/>إِنَّمَا الْمُؤْمِنُونَ إِخْوَةٌ فَأَصْلِحُوا بَيْنَ أَخَوَيْكُمْ<br/>(Sesungguhnya Orang-Orang Mukmin Itu Bersaudara, Maka Damaikanlah Antara Keduanya!)"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Kewajiban Menghilangkan Kebencian Batin (Hiqd) & Menggantinya dengan Husnudzan"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPBISDanKeadilanRestoratif["SINTESIS PBIS & RESTORATIVE JUSTICE"]
        SWPBIS["School-Wide PBIS Multi-Tier (Sugai & Horner, 2020):<br/>• Tier 1 Universal (100%), Tier 2 Targeted (15%), & Tier 3 Intensive (5%)."]
        
        RestorativeJustice["Restorative Justice Framework (Zehr, 2015):<br/>• Fokus pada perbaikan luka batin, pertanggungjawaban langsung pelaku, & reintegrasi tanpa stigma."]
        
        ZeroViolence["Zero-Violence Safe School Policy (UNESCO, 2019):<br/>• Eradikasi mutlak kekerasan fisik, psikologis, & feodalisme senioritas."]
        
        SWPBIS & RestorativeJustice & ZeroViolence ==> ProtokolTUMBUH["PROTOKOL INTERVENSI RESTORATIF TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurPenangananMasalahSosial["ALUR INTERVENSI MASALAH SOSIAL 24 JAM"]
        Deteksi["1. DETEKSI DINI: Laporan Musyrif / Peer Alert / Early Warning System (EWS)."]
        Tapis["2. PENAPISAN TINGKAT MASALAH: Tier 1 (Pasif), Tier 2 (Konflik/Ostracism), Tier 3 (Bullying/Agresi)."]
        Tindakan["3. EKSEKUSI INTERVENSI RESTORATIF: Empathy Circle, Restorative Buddy, atau Sidang Ishlah 4R."]
        Monitoring["4. MONITORING SOSIOMETRI UKHUWAH: Evaluasi hubungan persaudaraan selama 30 hari."]
...
```mermaid
flowchart TD
    subgraph ProtokolResolusiOstracism["PROTOKOL LINGKARAN UKHUWAH TIER 2 & 3"]
        Step1["1. PERLINDUNGAN EMOSIONAL SANTRI D & KONSELING HANGAT WALI KELAS<br/>• Wali kelas memeluk Santri D, memberikan rasa aman mutlak, & menyediakan seragam baru yang harum."]
        
        Step2["2. FORUM 'RESTORATIVE TALKING CIRCLE' DENGAN 7 SANTRI SEKAMAR<br/>• Musyrif membedah firman Allah tentang memuliakan anak yatim (QS. Adh-Dhuha) & mendengarkan curahan hati Santri D."]
        
        Step3["3. PENGAKUAN TULUS & PERMINTAAN MAAF 7 SANTRI DISERTAI PAKTA SAHABAT<br/>• Seluruh santri menangis menyesali perbuatannya, memeluk Santri D, & menandatangani Pakta Saudara Sekamar."]
        
        Step4["4. HASIL INTEGRASI UKHUWAH SEJATI & KAMAR PERCONTOHAN<br/>• Dalam 1 pekan, Santri D menjadi sahabat paling disayang di kamar & kamar tersebut meraih penghargaan 'Kamar Paling Harmonis'."]
...
```mermaid
flowchart TD
    subgraph ArsitekturTigaTingkatPBISKhidmah["ARSITEKTUR MULTI-TIER PBIS NAFI'UN LIGHAIRIH"]
        Tier1["TIER 1: UNIVERSAL INTERVENTION (100% SANTRI - PREVENTIF)<br/>• Kurikulum Khidmah Terpadu & Silabus Halaqah 24 Pekan.<br/>• Posko Khidmah Asrama, piket dapur umum, & sedekah koin Subuh."]
        
        Tier2["TIER 2: TARGETED INTERVENTION (10–15% SANTRI - DUKUNGAN TERARAH)<br/>• Klinik Empati (Empathy Training Circle) bagi santri individualis/pasif.<br/>• Restorative Buddy Care (Pendampingan santri introvert/homesick).<br/>• Penugasan Khidmah Terbimbing di Poskestren & Perpustakaan."]
        
        Tier3["TIER 3: INTENSIVE RESTORATIVE (1–5% SANTRI - REMEDIASI INTENSIF)<br/>• Sidang Restorasi Ukhuwah Anti-Bullying (Ishlahul Bain).<br/>• Pakta Pertanggungjawaban Restitusi Sosial 4R.<br/>• Terapi CBT regulasi kemarahan & de-eskalasi agresi feodal."]
...
| :--- | :---: | :--- | :--- | :--- |
| **Tier 1: Universal Prevention** | $100\%$ Seluruh Santri | • Pembelajaran kurikulum khidmah & empati.<br/>• Pengisian kartu rekam jam khidmah digital.<br/>• Praktik piket kamar, masjid, & dapur umum. | Musyrif Kamar & Guru Madrasah | $100\%$ Santri mencapai minimal 60 jam khidmah/tahun. |
| **Tier 2: Targeted Support** | $10–15\%$ Santri Rentan | • Restorative Talking Circle bagi santri pasif.<br/>• Penugasan buddy care bagi santri yang terisolasi.<br/>• Khidmah pendampingan pasien di Poskestren. | Wali Kelas & Konselor BK | Integrasi sosial pulih; $0\%$ gejala pengucilan kawan. |
| **Tier 3: Intensive Restorative** | $1–5\%$ Kasus Khusus | • Sidang Keadilan Restoratif kasus perundungan.<br/>• Terapi kognitif de-eskalasi kemarahan (Anger Management).<br/>• Khidmah sosial restitusi membersihkan fasilitas umum. | Dewan Keadilan Restoratif & Kepala Pengasuhan | $0\%$ Kasus Bullying Berulang; Pemulihan Trauma Korban 100%. |
...
```mermaid
flowchart LR
    R1["1. RELATED<br/>Konsekuensi berhubungan langsung dengan luka sosial (misal: melayani kawan yang dizalimi)."]
    --> R2["2. RESPECTFUL<br/>Disampaikan dengan adab santun tanpa kekerasan verbal / fisik."]
    --> R3["3. REASONABLE<br/>Beban perbaikan sebanding tanpa menzalimi santri pelaku."]
    --> R4["4. RESTORATIVE<br/>Memulihkan ukhuwah & mendidik santri menjadi pribadi pengayom."]
```
