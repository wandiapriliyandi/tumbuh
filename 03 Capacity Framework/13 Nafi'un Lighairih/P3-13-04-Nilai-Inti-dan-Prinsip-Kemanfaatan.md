...
```mermaid
flowchart TD
    subgraph TransformasiAksiologiKhidmah["REKONSTRUKSI AKSIOLOGI KEMANFAATAN SOSIAL"]
        Polarisasi["POLARISASI TRANSAKSIONAL VS PATERNALISME (TRADISIONAL)<br/>• Membantu demi imbalan materi / pujian manusia.<br/>• Menolong dengan sikap merendahkan pihak yang dibantu.<br/>• Amal sosial sekadar formalitas & pameran."]
        
        TUMBUH["EMPAT NILAI INTI KEMANFAATAN TUMBUH<br/>• Al-Itsar: Kerelaan mendahulukan kepentingan sesama.<br/>• At-Tawadhu': Kerendahhatian mutlak dalam melayani.<br/>• At-Ta'awun: Solidaritas gotong royong dalam kebajikan.<br/>• Ar-Rahmatul 'Ammah: Kasih sayang universal bagi semesta."]
...
```mermaid
flowchart LR
    subgraph TuratsKonsepFutuwwahKhidmah["DOKTRIN AL-FUTUWWAH SALAF"]
        Sulami["As-Sulami (Kitabul Futuwwah):<br/>الْفُتُوَّةُ أَنْ لَا تَرَى لِنَفْسِكَ فَضْلًا عَلَى أَحَدٍ، وَأَنْ تَكُونَ خَادِمًا لِلْجَمِيعِ<br/>(Al-Futuwwah: Engkau Tidak Memandang Dirimu Lebih Utama dari Siapapun & Menjadi Pelayan Bagi Semua)"] --> Inti["Hakikat Nilai Khidmah Turats:<br/>Penyucian Diri dari Kesombongan Melalui Pengabdian Tulus"]
        Qusyairi["Al-Qusyairi (Ar-Risalah):<br/>Adab Berkhidmah Tanpa Mengungkit Kebaikan (*Mannan*)"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Tanda Keikhlasan Khidmah: Berterima Kasih Kepada Orang yang Menerima Bantuan Kita"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsMoralitasAltruistik["SINTESIS MORALITAS ALTRUISTIK & ETHICS OF CARE"]
        AltruisticBatson["Empathy-Altruism Model (Batson, 2011):<br/>• Penolakan terhadap doktrin Egoisme Psikologis: Manusia memiliki kapasitas fitrah untuk menolong murni demi kesejahteraan korban."]
        
        EthicsOfCare["Ethics of Care (Gilligan & Noddings):<br/>• Moralitas berbasis relasi kasih sayang, tanggung jawab moral timbal balik, & merawat pihak yang lemah."]
        
        IhsanFramework["Ihsan Transcendent Ethics:<br/>• Berbuat baik melampaui batas kewajiban formal sebagai perwujudan cinta ilahi."]
        
        AltruisticBatson & EthicsOfCare & IhsanFramework ==> StandarTUMBUH["FILOSOFI NILAI KEMANFAATAN TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaBudayaKhidmah24Jam["REKAYASA BUDAYA KHIDMAH ASRAMA"]
        KeteladananKyai["1. KETELADANAN ASATIDZ: Ustadz ikut memungut sampah & melayani makan santri."]
        ApresiasiKhidmah["2. PENGHARGAAN RELAWAN PEKANAN: Piagam 'Bintang Khidmah' bagi santri paling proaktif."]
        TradisiSedekahTenaga["3. TRADISI SEDEKAH TENAGA: Gerakan membersihkan masjid & kamar mandi secara mandiri."]
        DoaUkhuwahMalam["4. DOA UKHUWAH MALAM: Mendoakan kesembuhan kawan yang sakit & keselamatan umat."]
        
        KeteladananKyai --> ApresiasiKhidmah --> TradisiSedekahTenaga --> DoaUkhuwahMalam
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolPurifikasiNiatKhidmah["PROTOKOL PURIFIKASI NIAT TIER 2"]
        StepA["1. DIALOG PRIVAT PENYADARAN NURANI BERSAMA WALI KELAS<br/>• Wali kelas mengajak tadabbur: 'Pujian manusia tidak mendatangkan pahala; Allah Maha Melihat amal rahasiamu di kegelapan malam'."]
        
        StepB["2. PENUGASAN 'AMAL KHIDMAH RAHASIA' (AMAL SIRR) SELAMA 1 PEKAN<br/>• Santri E ditugaskan merapikan rak sandal masjid tengah malam tanpa ada yang tahu namanya."]
        
        StepC["3. REFLEKSI KEINDAHAN IKHLAS DALAM HALAQAH MALAM<br/>• Santri E merasakan kelezatan beramal rahasia demi Allah tanpa riya' pujian manusia."]
        
        StepD["4. LAHIRNYA KETULUSAN KHIDMAH SEJATI PARIPURNA<br/>• Santri E menjadi relawan paling tulus, merawat santri sakit dengan kasih sayang konsisten di segala kondisi."]
...
```mermaid
flowchart TD
    subgraph EmpatNilaiIntiKemanfaatan["EMPAT NILAI INTI NAFI'UN LIGHAIRIH"]
        N1["1. AL-ITSAR (MENDAHULUKAN ORANG LAIN)<br/>• Kerelaan berkorban mendahulukan kebutuhan kawan di atas kenyamanan diri sendiri.<br/>• Kesadaran bahwa berbagi makanan, waktu, dan tenaga adalah mahkota akhlak Anshar."]
        
        N2["2. AT-TAWADHU' (KERENDAHHATIAN MUTLAK)<br/>• Bangga menjadi pelayan sesama (*Khadim*); anti-kesombongan intelektual & kasta sosial.<br/>• Menghargai seluruh manusia dengan kesetaraan martabat insan di hadapan Allah."]
        
        N3["3. AT-TA'AWUN (SOLIDARITAS GOTONG ROYONG)<br/>• Semangat tolong-menolong dalam kebajikan & ketakwaan (*'Alal Birri wat-Taqwa*).<br/>• Sinergi kolaboratif menyelesaikan problem sosial asrama & masyarakat luas."]
        
        N4["4. AR-RAHMATUL 'AMMAH (KASIH SAYANG SEMESTA)<br/>• Menjadi sumber kedamaian, perlindungan kaum lemah, & pelestari kelestarian alam.<br/>• Anti-kekerasan, anti-bullying, & penebar salam bagi seluruh semesta alam."]
        
        N1 & N2 & N3 & N4 ==> KarakterKhidmah["SANTRI BERJIWA ITSAR, TAWADHU', SOLIDARITAS, & RAHMAH"]
    end
```
