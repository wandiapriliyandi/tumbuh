...
```mermaid
flowchart TD
    subgraph TransformasiRubrikKhidmah["REKONSTRUKSI SISTEM PENILAIAN KARAKTER SOSIAL"]
        Impresionis["PENILAIAN IMPRESIONIS & PASIF (TRADISIONAL)<br/>• Pendiam dinilai baik tanpa bukti aksi tolong-menolong.<br/>• Tanpa penghargaan atas inisiatif khidmah & dakwah desa.<br/>• Santri bingung standar perilaku yang harus dicapai."]
        
        TUMBUH["RUBRIK 4-LEVEL NAFI'UN LIGHAIRIH (TUMBUH)<br/>• Deskriptor kriteria faktual 4 dimensi (Empati, Khidmah, Qiyadah, Advokasi).<br/>• Penilaian berbasis bukti portofolio jam khidmah riil & logbook.<br/>• Uji reliabilitas Cohen's Kappa & penilaian pertumbuhan ipsatif."]
        
        Impresionis ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsHisabAkhlaqKhidmah["TIMBANGAN KHIDMAH DALAM TURATS"]
        Ghazali["Al-Ghazali (Ihya' - Adab ash-Shuhbah):<br/>عَلَامَةُ حُسْنِ الْخُلُقِ كَثْرَةُ الْحَيَاءِ، وَقِلَّةُ الْأَذَى، وَكَثْرَةُ الصَّلَاحِ، وَصِدْقُ اللِّسَانِ، وَقِلَّةُ الْكَلَامِ، وَكَثْرَةُ الْعَمَلِ فِي خِدْمَةِ النَّاسِ<br/>(Tanda Akhlak Mulia: Sedikit Gangguan & Banyak Aksi Nyata dalam Melayani Manusia)"] --> Inti["Hakikat Rubrik Khidmah Turats:<br/>Instrumen Pengukur Ketulusan, Kerendahhatian, & Kemanfaatan Nyata"]
        Nawawi["An-Nawawi (Riyadhus Shalihin):<br/>Kriteria Penilaian Hak-Hak Ukhuwah & Penjagaan Kawan"] --> Inti
        Mawardi["Al-Mawardi (Adab ad-Dunya):<br/>Hisab Kemanfaatan Berdasarkan Luasnya Maslahat yang Dihasilkan"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPsikometriRubrikKhidmah["STANDAR PSIKOMETRI RUBRIK NAFI'UN LIGHAIRIH"]
        IRR["Inter-Rater Reliability (Cohen's Kappa >= 0.88):<br/>• Kesepakatan penilaian portofolio jam khidmah antar-musyrif asrama.<br/>• Kalibrasi deskriptor empati, kerja bakti, & servant leadership."]
        
        Brookhart["Analytical Rubric Design (Brookhart, 2018):<br/>• Kriteria kualitatif deskriptif berbasis bukti jam pelayanan nyata."]
        
        Ipsative["Ipsative Prosocial Growth (Hughes, 2014):<br/>• Mengukur kemajuan kepekaan nurani & inisiatif menolong santri."]
        
        IRR & Brookhart & Ipsative ==> RubrikStandar["RUBRIK NAFI'UN LIGHAIRIH TERVALIDASI"]
    end
```
...
```mermaid
flowchart TD
    subgraph SistemAsesmenKhidmah24Jam["INTEGRASI DATA ASESMEN KEMANFAATAN SOSIAL"]
        DataMusyrif["1. MUSYRIF ASRAMA: Observasi Pelayanan Kamar, Tanggap Santri Sakit, & Dapur (35%)."]
        DataGuru["2. GURU MADRASAH: Observasi Tutor Sebaya, Kerja Kelompok, & Inisiatif Kelas (25%)."]
        DataPortofolio["3. LOGBOOK JAM KHIDMAH RIIL: Kartu Rekam Jam Khidmah Asrama & Ekspedisi Desa (20%)."]
        DataSebaya["4. ASESMEN PEER REVIEW SEBAYA: Indeks Suka Berbagi, Ramah, & Anti-Bullying (10%)."]
        DataMasyarakat["5. ULASAN TOKOH MASYARAKAT: Kepuasan Warga Desa Binaan & Takmir Masjid Desa (10%)."]
        
        DataMusyrif & DataGuru & DataPortofolio & DataSebaya & DataMasyarakat ==> Dashboard["DASHBOARD INTIZHAM-TUMBUH (IK-NL)"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolKalibrasiKhidmah["PROTOKOL KALIBRASI PENILAI KHIDMAH ASRAMA"]
        P1["1. FORUM INTEGRASI DEWAN MUSYRIF & PEMBINA PENGABDIAN MASYARAKAT<br/>• Menyatukan persepsi: Bobot terbesar rubrik terletak pada aksi khidmah nyata & ketulusan, bukan sekadar kelincahan bicara."]
        
        P2["2. PENETAPAN BOBOT SEIMBANG OBSERVASI INTERNAL ASRAMA & AKSI DESA BINAAN<br/>• Menyepakati bahwa Santri Y berhak meraih Level 3.75 (Kategori Penggerak Khidmah) dengan apresiasi atas dedikasi desa."]
        
        P3["3. PENDAMPINGAN EKSPRESI KEHANGATAN SOSIAL DI DALAM KAMAR ASRAMA<br/>• Santri Y dibimbing agar kebaikan dan keceriaannya saat mengajar anak desa juga dipancarkan kepada kawan sekamar."]
        
        P4["4. HASIL KONSISTENSI EVALUASI LINTAS PEMBINA<br/>• Seluruh penilai memiliki kesepakatan seragam & santri memperoleh evaluasi yang adil dan memotivasi."]
...
```mermaid
flowchart TD
    subgraph ArsitekturRubrik4LevelKhidmah["EMPAT TINGKAT KEMATANGAN NAFI'UN LIGHAIRIH"]
        L1["LEVEL 1: AL-IHSAN AL-MUBTADI' (KHIDMAH KAMAR & EMPATI SEBAYA / EMERGING)<br/>• Merawat kawan sakit $\le 15\text{ menit}$; piket kebersihan kamar tertib; bagi makanan.<br/>• Menuntaskan $\ge 30\text{ Jam Khidmah/Tahun}$; 0% penelantaran kawan sekamar."]
        
        L2["LEVEL 2: AL-KHIDMAH AL-MUBADIRAH (KERELAWANAN LINGKUNGAN / DEVELOPING)<br/>• Terampil P3K luka ringan; menjadi tutor sebaya; piket dapur umum sukarela.<br/>• Menuntaskan $\ge 45\text{ Jam Khidmah/Tahun}$; pelopor kebersihan fasilitas asrama."]
        
        L3["LEVEL 3: AL-QIYADAH AL-KHADIMAH (PENGGERAK DESA BINAAN / PROFICIENT)<br/>• Mengorganisasi Ekspedisi Bina Desa; Restorative Buddy adik asuh J1; bank sampah.<br/>• Menuntaskan $\ge 60\text{ Jam Khidmah/Tahun}$; mediasi perselisihan kawan secara damai."]
        
        L4["LEVEL 4: AR-RIYADAH AL-INSANIYYAH (SERVANT LEADERSHIP / EXEMPLARY)<br/>• Memimpin organisasi OPPM khidmah; Capstone Civilizational Project kelulusan.<br/>• Garda terdepan Zero-Bullying; mengayomi seluruh santri; Al-Itsar sejati $\ge 75\text{ Jam}$."]
