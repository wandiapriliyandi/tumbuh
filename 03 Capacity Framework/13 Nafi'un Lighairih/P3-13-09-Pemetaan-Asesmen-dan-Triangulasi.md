...
```mermaid
flowchart TD
    subgraph TransformasiTriangulasiKhidmah["REKONSTRUKSI SISTEM TRIANGULASI KEMANFAATAN SOSIAL"]
        Sepihak["PENILAIAN SEPIHAK & HALO EFFECT (TRADISIONAL)<br/>• Nilai akhlak sosial berdasarkan persepsi sepihak musyrif.<br/>• Jam pengabdian masyarakat tanpa verifikasi tokoh desa.<br/>• Pengucilan sosial santri lemah tidak terdeteksi."]
        
        TUMBUH["SISTEM TRIANGULASI 360 DERAJAT (TUMBUH)<br/>• 5 Sumber Independen: Musyrif, Guru, Portofolio, Sebaya, Warga Desa.<br/>• Matriks MTMM: Validitas konvergen-diskriminan teruji.<br/>• Early Warning System (EWS) pengucilan sosial & penelantaran."]
...
```mermaid
flowchart LR
    subgraph TuratsTazkiyatushSyuhud["DOKTRIN KESAKSIAN SOSIAL TURATS"]
        HaditsSyuhada["HR. Al-Bukhari No. 1367:<br/>أَنْتُمْ شُهَدَاءُ اللَّهِ فِي الْأَرْضِ<br/>(Kalian Adalah Saksi-Saksi Allah di Muka Bumi!)"] --> Inti["Hakikat Triangulasi Sosial:<br/>Verifikasi Kebaikan Karakter Berdasarkan Kesaksian Multi-Pihak yang Adil"]
        HaditsJar["HR. Ahmad No. 3808:<br/>Tanda Mukmin Sejati: Jika Tetangganya Memujinya Baik Maka Ia Benar-Benar Baik"] --> Inti
        Mawardi["Al-Mawardi (Al-Ahkam):<br/>Syarat Keadilan Muamalah Berdasarkan Rekam Jejak Kemanfaatan Sosial"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsMTMMDanPsikometriKhidmah["VALIDASI MTMM MATRIKS CAMPBELL & FISKE"]
        MTMM["Multi-Trait Multi-Method Matrix (1959):<br/>• Convergent Validity: Korelasi tinggi antara skor observasi musyrif, portofolio jam khidmah, & review warga desa (r >= 0.84).<br/>• Discriminant Validity: Membedakan secara tegas antara altruisme sejati vs keramahan manipulatif/pencitraan."]
        
        Triangulation360["360-Degree Prosocial Evaluation Framework:<br/>• Mengeliminasi bias rater tunggal melalui integrasi 5 sudut pandang independen."]
        
        PredictiveValidity["Predictive Social Impact Validity:<br/>• Skor IK-NL memprediksi keberhasilan kepemimpinan santri di masyarakat luas."]
...
```mermaid
flowchart TD
    subgraph AlurDataKhidmah24Jam["ALUR DATA MUTABA'AH KHIDMAH SANTRI"]
        Input1["1. INPUT LOGBOOK POSKO KHIDMAH: Merekam piket kamar, tanggap santri sakit, & dapur umum."]
        Input2["2. INPUT GURU MADRASAH: Merekam aktivitas tutor sebaya, kepemimpinan kelas, & kerja kelompok."]
        Input3["3. INPUT KARTU JAM KHIDMAH RIIL: Santri memvalidasi jam pengabdian desa bersama pembina."]
        Input4["4. INPUT PEER REVIEW & WARGA DESA: Input ulasan keramahan kawan & indeks kepuasan desa."]
        
        Input1 & Input2 & Input3 & Input4 ==> ServerEngine["ENGINE ANALITIK DATA INTIZHAM-TUMBUH"]
        ServerEngine ==> DashboardEWS["DASHBOARD EWS: STATUS KEMANFAATAN & RED FLAGS"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolAuditIntegritasKhidmah["PROTOKOL AUDIT INTEGRITAS KHIDMAH TIER 2"]
        Step1["1. DIALOG RESTORATIF TERBUKA BERSAMA PEMBINA & TAKMIR MASJID DESA<br/>• Pembina membedah hakikat khidmah: 'Pengabdian palsu tidak mendatangkan pahala Allah; khidmah adalah pembuktian nurani'."]
        
        Step2["2. PERMINTAAN MAAF KSATRIA KEPADA TAKMIR MASJID DESA SECARA LANGSUNG<br/>• Santri G mendatangi takmir masjid desa didampingi pembina & mengakui kesalahannya secara tulus."]
        
        Step3["3. PENUGASAN KHIDMAH RIIL PENGGANTI 25 JAM DI MASJID DESA BINAAN<br/>• Santri G menuntaskan pengajaran TPA dan pembersihan masjid desa secara nyata dan diverifikasi harian."]
        
        Step4["4. HASIL INTEGRITAS MORAL KHIDMAH PARIPURNA<br/>• Santri G menyadari manisnya mengabdi dengan tulus & menjadi salah satu penggerak TPA desa paling dicintai anak-anak."]
...
```mermaid
flowchart TD
    subgraph LimaSumberTriangulasiKhidmah["ARSITEKTUR TRIANGULASI ASESMEN 360 DERAJAT"]
        S1["SUMBER 1: OBSERVASI MUSYRIF ASRAMA (Bobot: 35%)<br/>• Pelayanan kamar, tanggap santri sakit $\le 15\text{ menit}$, piket dapur, & rak sandal."]
        
        S2["SUMBER 2: GURU MADRASAH & AKADEMIK (Bobot: 25%)<br/>• Tutor sebaya hafalan/nahwu, dinamika kerja kelompok inklusif, & inisiatif kelas."]
        
        S3["SUMBER 3: AUDIT KARTU JAM KHIDMAH RIIL (Bobot: 20%)<br/>• Logbook akumulasi jam pelayanan asrama, Poskestren, & Ekspedisi Bina Desa."]
        
        S4["SUMBER 4: ASESMEN PEER REVIEW SEBAYA (Bobot: 10%)<br/>• Suka berbagi makanan, ramah, tidak pilih kasih, & sikap anti-bullying."]
        
        S5["SUMBER 5: INDEKS KEPUASAN TOKOH DESA (Bobot: 10%)<br/>• Ulasan takmir masjid desa, keramahan santun ke warga, & bakti sosial."]
        
        S1 & S2 & S3 & S4 & S5 ==> Komposit["SKOR INDEKS KARAKTER KEMANFAATAN (IK-NL)"]
    end
```
