...
```mermaid
flowchart TD
    subgraph TransformasiPedagogiKhidmah["REKONSTRUKSI PEDAGOGI KEMANFAATAN SOSIAL"]
        Tekstual["HAFALAN TEKSTUAL & HIPOKRISI FEODAL (TRADISIONAL)<br/>• Menghafal dalil ta'awun tanpa aksi nyata tolong-menolong.<br/>• Guru bersikap feodal; santri pasif & acuh lingkungan.<br/>• Steril dari problem kemasyarakatan di dunia nyata."]
        
        TUMBUH["EMPAT MODEL PEDAGOGI KHIDMAH TERAPAN (TUMBUH)<br/>• Living Exemplary Mentorship (Guru melayani paling depan).<br/>• Problem-Based Community Learning (Investigasi problem desa).<br/>• Service-Learning Experiential Immersion (Bakti desa riil).<br/>• Socratic Moral Dilemma Discourses (Refleksi Al-Itsar)."]
        
        Tekstual ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsQudwahKhidmahNabawi["METODE TA'DIB KHIDMAH KENABIAN"]
        HaditsKhandaq["HR. Al-Bukhari No. 4106:<br/>Nabi SAW Ikut Memikul Tanah & Memecah Batu Besar di Parit Khandaq Hingga Debu Menutupi Dada Beliau"] --> Inti["Hakikat Pedagogi Khidmah:<br/>Guru & Murid Bersama-Sama Berkhidmah Menegakkan Kemaslahatan"]
        IbnKhaldun["Ibnu Khaldun (Muqaddimah):<br/>Pengajaran Karakter yang Efektif Hanyalah Melalui Pembiasaan & Praktik Nyata (*Al-Malakah*), Bukan Ceramah Kata-Kata"] --> Inti
        Ghazali["Al-Ghazali (Ayyuhal Walad):<br/>Ilmu Tanpa Amal Adalah Gila, & Amal Tanpa Ikhlas Adalah Sia-Sia"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsDidaktikKhidmah["SINTESIS DIDAKTIK PBL & SITUATED LEARNING"]
        PBL["Problem-Based Learning (Barrows, 1996):<br/>• Belajar bermula dari skenario masalah sosial autentik di sekitar santri (sampah, santri sakit, & desa tertinggal)."]
        
        SituatedLearning["Situated Learning & CoP (Lave & Wenger, 1991):<br/>• Belajar dalam komunitas praksis (Community of Practice) khidmah nyata asrama."]
        
        SocraticDilemma["Socratic Moral Dilemma Method:<br/>• Melatih nalar empati melalui simulasi dilema moral Al-Itsar."]
        
        PBL & SituatedLearning & SocraticDilemma ==> ModelDidaktikTUMBUH["DIDAKTIK KEMANFAATAN TERPADU"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaKelasLaboratoriumMaslahat["TRANSFORMASI KELAS LABORATORIUM MASLAHAT"]
        FaseAwal["1. CHECK-IN EMPATI HARIAN (5 Menit): Guru & Santri Berbagi Kondisi Sahabat yang Sedang Sakit."]
        EksplorasiPBL["2. DISKUSI STUDI KASUS SOSIAL (15 Menit): Menganalisis Kebutuhan Warga Desa Binaan / Asrama."]
        SimulasiKhidmah["3. SIMULASI KETERAMPILAN KHIDMAH (15 Menit): Praktik P3K, Mengajar Anak, atau Mediasi Damai."]
        KomitmenAksi["4. KOMITMEN AKSI 24 JAM (10 Menit): Penandatanganan Kartu Khidmah & Penugasan Nyata."]
        
        FaseAwal --> EksplorasiPBL --> SimulasiKhidmah --> KomitmenAksi
    end
```
...
flowchart TD
    subgraph ProtokolTransformasiQudwahGuru["PROTOKOL TRANSFORMASI QUDWAH GURU"]
        ...
        TahapC["3. TINDAKAN PERMOHONAN MAAF & KETELADANAN NYATA DI KELAS BERIKUTNYA<br/>• Ustadz F meminta maaf secara tulus di depan kelas & bersama-sama santri merapikan seluruh perabotan kelas secara ceria."]
        
        TahapD["4. LAHIRNYA PENDIDIK FIGUR TELADAN YANG SANGAT DICINTAI SANTRI<br/>• Ustadz F bertransformasi menjadi salah satu guru paling dihormati karena keteladanan kerja nyatanya."]
...
```mermaid
flowchart TD
    subgraph EmpatModelPedagogiKhidmah["EMPAT MODEL PEDAGOGI NAFI'UN LIGHAIRIH"]
        M1["MODEL 1: LIVING EXEMPLARY MENTORSHIP (QUDWAH KHADIMAH)<br/>• Guru & musyrif menjadi teladan hidup dalam melayani, menyapu, & merawat kawan sakit.<br/>• Menghancurkan feodalisme; membuktikan bahwa pemimpin sejati adalah pelayan."]
        
        M2["MODEL 2: PROBLEM-BASED COMMUNITY LEARNING (PBL SOSIAL)<br/>• Pembelajaran bermula dari investigasi masalah nyata (sampah asrama, santri sakit, desa binaan).<br/>• Santri merancang proposal solusi kemaslahatan terukur & mengeksekusinya dalam tim."]
        
        M3["MODEL 3: SERVICE-LEARNING EXPERIENTIAL IMMERSION<br/>• Terjun langsung mengabdi di Poskestren, dapur umum, & Ekspedisi Santri Bina Desa.<br/>• Mengintegrasikan capaian akademik madrasah dengan dampak sosial kemasyarakatan."]
        
        M4["MODEL 4: SOCRATIC MORAL DILEMMA DISCOURSES<br/>• Diskusi mendalam studi kasus dilema pengorbanan Al-Itsar vs kenyamanan pribadi.<br/>• Menajamkan nalar moral empati & mengikis mentalitas egois santri secara filosofis."]
        
        M1 & M2 & M3 & M4 ==> OutputDidaktik["SANTRI BERKETERAMPILAN KHIDMAH & BERJIWA PELAYAN"]
    end
```
...
```mermaid
flowchart LR
    subgraph SintaksRPP45MenitKhidmah["SINTAKS RPP 45 MENIT BAKTI UMAT"]
        Pendahuluan["1. PENDAHULUAN (8 Menit):<br/>• Salam hangat & Check-In kawan sakit.<br/>• Tadabbur QS. Al-Hasyr: 9 (Kisah Tamu Lapar Abu Thalhah RA)."]
        --> Eksplorasi["2. INVESTIGASI & DILEMA MORAL (12 Menit):<br/>• Studi Kasus: 'Kawan sekamar demam tinggi saat malam ujian nahwu: Apa tindakanmu?'<br/>• Diskusi Sokrates: Nilai Ujian vs Menolong Kawan."]
        --> Praktik["3. WORKSHOP SIMULASI KHIDMAH (15 Menit):<br/>• Role-Playing: Praktik menyuapi makan kawan sakit & mengompres dahi.<br/>• Praktik evakuasi santri pingsan menggunakan tandu."]
        --> Penutup["4. REFLEKSI & KOMITMEN 24 JAM (10 Menit):<br/>• Doa ukhuwah & pengisian komitmen jam khidmah pekanan di kartu digital."]
    end
```
