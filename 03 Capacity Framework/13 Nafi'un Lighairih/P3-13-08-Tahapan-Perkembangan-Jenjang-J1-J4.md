...
```mermaid
flowchart TD
    subgraph TransformasiTrajektoriKhidmah["REKONSTRUKSI TRAJEKTORI KEMANFAATAN SOSIAL"]
        Seragam["PENYERAGAMAN SOSIAL & SENIORITAS OTORITER (TRADISIONAL)<br/>• Santri J1 dibebani tugas di luar kapasitas emosinya.<br/>• Santri J4 memimpin dengan kekerasan & feodalisme.<br/>• Tanpa pengujian kematangan empati & pelayanan (Khidmah)."]
        
        TUMBUH["TRAJEKTORI PERKEMBANGAN J1–J4 (TUMBUH)<br/>• J1: Empati Kamar & Khidmah Asrama Dasar (30 Jam).<br/>• J2: Kerelawanan Lingkungan, P3K, & Tutor Sebaya (45 Jam).<br/>• J3: Penggerak Ekspedisi Bina Desa & Restorative Buddy (60 Jam).<br/>• J4: Servant Leadership OPPM & Capstone Project (75 Jam)."]
        
        Seragam ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsKullukumRain["DOKTRIN PENGGEMBALAAN AMANAH DALAM SUNNAH"]
        HaditsRain["HR. Al-Bukhari No. 893:<br/>كُلُّكُمْ رَاعٍ وَكُلُّكُمْ مَسْئُولٌ عَنْ رَعِيَّتِهِ<br/>(Setiap Kalian Adalah Pemimpin & Setiap Kalian Akan Dimintai Pertanggungjawaban Atas yang Dipimpinnya!)"] --> Inti["Hakikat Trajektori J1–J4:<br/>Evolusi Tanggung Jawab dari Memimpin Diri & Kamar Menuju Penggembalaan Umat"]
        Nawawi["An-Nawawi (Syarah Muslim):<br/>Ar-Ra'i Adalah Penjaga yang Melayani Demi Kemaslahatan Pihak yang Dipimpin"] --> Inti
        Mawardi["Al-Mawardi (Al-Ahkam As-Sulthaniyyah):<br/>Syarat Pemimpin: Keadilan, Ilmu, & Jiwa Mengayomi Kaum Lemah"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsMaturasiPerspektifSosial["SINTESIS MATURASI PERSPEKTIF SOSIAL"]
        SelmanStages["Selman's Perspective-Taking Stages (1980):<br/>• Stage 1 (Usia 6-9): Differentiated Perspective.<br/>• Stage 2 (Usia 9-12): Self-Reflective Perspective.<br/>• Stage 3 (Usia 12-15): Third-Party / Mutual Perspective.<br/>• Stage 4 (Usia 15-18+): Societal / Universal Perspective."]
        
        EmpathyNeuroscience["Empathy & Frontal Cortex Development:<br/>• Pematangan sirkuit empati otak (Mirror Neuron System & Anterior Insula) dari usia 12 hingga 18 tahun."]
        
        ServantMaturity["Servant Leadership Developmental Trajectory:<br/>• Transisi dari dilayani menuju melayani sesama secara sukarela."]
        
        SelmanStages & EmpathyNeuroscience & ServantMaturity ==> ModelTrajektoriTUMBUH["TRAJEKTORI J1–J4 TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaZonaTransisiKhidmah["ZONA TRANSISI KHIDMAH 24 JAM"]
        ZonaJ1["ZONA J1 (KELAS 7): Sesi Perawatan Kawan Sekamar Sakit & Piket Kamar Sukarela (30 Jam)."]
        ZonaJ2["ZONA J2 (KELAS 8–9): Klinik P3K Dasar, Tutor Sebaya Belajar, & Piket Dapur Umum (45 Jam)."]
        ZonaJ3["ZONA J3 (KELAS 10–11): Ekspedisi Santri Bina Desa, Restorative Buddy J1, & Bank Sampah (60 Jam)."]
        ZonaJ4["ZONA J4 (KELAS 12): Kantor Organisasi OPPM Khidmah, Capstone Project, & Anti-Bullying (75 Jam)."]
        
        ZonaJ1 --> ZonaJ2 --> ZonaJ3 --> ZonaJ4
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolTraumaHoarding["PROTOKOL DE-ESKALASI FOOD HOARDING TIER 2"]
        Tahap1["1. KONSELING HANGAT & VALIDASI RASA AMAN OLEH MUSYRIF (SAFE HAVEN)<br/>• Musyrif memeluk santri: 'Di sini barangmu aman, tidak ada yang boleh mengambil tanpa izin (*Zero Ghashab*)'."]
        
        Tahap2["2. PENYEDIAAN KOTAK MAKANAN PRIBADI TERKUNCI & PROTOKOL BERBAGI SUKARELA<br/>• Santri P diberi kotak khusus; musyrif tidak memaksa berbagi sampai rasa amannya pulih 100%."]
        
        Tahap3["3. SHARING CIRCLE MALAM BERSAMA KAKAK ASUH J4 (PEMODELAN DERMAWAN)<br/>• Kakak asuh J4 membawa camilan & membagikannya kepada seluruh adik asuh tanpa meminta imbalan."]
        
        Tahap4["4. HASIL KEPULIHAN RASA PERCAYA DIRI & KEMATANGAN BERBAGI<br/>• Dalam 3 pekan, trauma reda, Santri P secara sukarela membuka biskuitnya & membagikannya kepada kawan sekamar."]
...
```mermaid
flowchart TD
    subgraph EmpatEtapeKemanfaatanJ1J4["EMPAT ETAPE TRAJEKTORI NAFI'UN LIGHAIRIH"]
        E1["ETAPE 1: JENJANG J1 (KELAS 7, USIA 12–13) — EMPATI KAMAR & KHIDMAH DASAR<br/>• Fokus: Merawat kawan sekamar sakit $\le 15\text{ menit}$, piket kamar tertib, berbagi makanan.<br/>• Target: $\ge 30\text{ Jam Khidmah/Tahun}$; 0% penelantaran kawan sekamar."]
        
        E2["ETAPE 2: JENJANG J2 (KELAS 8–9, USIA 13–15) — KERELAWANAN & TUTOR SEBAYA<br/>• Fokus: P3K luka ringan, menjadi tutor sebaya hafalan/belajar, piket dapur umum sukarela.<br/>• Target: $\ge 45\text{ Jam Khidmah/Tahun}$; pelopor kebersihan fasilitas asrama."]
        
        E3["ETAPE 3: JENJANG J3 (KELAS 10–11, USIA 15–17) — PENGGERAK DESA BINAAN & BUDDY<br/>• Fokus: Mengorganisasi Ekspedisi Bina Desa, Restorative Buddy adik asuh J1, bank sampah.<br/>• Target: $\ge 60\text{ Jam Khidmah/Tahun}$; mediasi perselisihan kawan secara damai."]
        
        E4["ETAPE 4: JENJANG J4 (KELAS 12, USIA 17–18) — SERVANT LEADERSHIP & FILANTROPI<br/>• Fokus: Memimpin organisasi OPPM khidmah, menuntaskan Capstone Project kelulusan.<br/>• Target: $\ge 75\text{ Jam Khidmah/Tahun}$; mengayomi santri junior & advokasi keadilan."]
...
| :--- | :--- | :--- | :--- |
| **Jenjang J1 (Kelas 7)<br/>Usia 12–13 Tahun** | Masa adaptasi; empati berkembang di lingkungan terdekat (*Mutual Perspective* kamar). | Merawat kawan sakit $\le 15\text{ menit}$; piket kamar; berbagi makanan. | $\ge 30\text{ Jam Khidmah}$; 0 penelantaran kawan; kamar rapi & bersih. |
| **Jenjang J2 (Kelas 8–9)<br/>Usia 13–15 Tahun** | Mulai peka lingkungan umum; tertarik aktivitas kerelawanan dan tolong-menolong sebaya. | Praktik P3K dasar luka ringan; tutor sebaya; piket dapur umum. | $\ge 45\text{ Jam Khidmah}$; sertifikasi P3K dasar; nilai tutor aktif. |
| **Jenjang J3 (Kelas 10–11)<br/>Usia 15–17 Tahun** | Perspektif sosial kemasyarakatan matang (*Societal Perspective*); siap mengabdi ke warga. | Mengajar TPA Desa Binaan; Restorative Buddy adik J1; kelola sampah. | $\ge 60\text{ Jam Khidmah}$; presensi TPA desa $\ge 90\%$; buddy care tuntas. |
| **Jenjang J4 (Kelas 12)<br/>Usia 17–18 Tahun** | Identitas kepemimpinan pelayan mengkristal (*Servant Leader*); siap mengabdi bagi bangsa. | Memimpin OPPM khidmah; Capstone Civilizational Project; Zero Bullying. | $\ge 75\text{ Jam Khidmah}$; Capstone Project teruji; teladan Al-Itsar. |
