...
```mermaid
flowchart TD
    subgraph DialektikaKonseptualKhidmah["DIALEKTIKA KONSEPTUAL KEMANFAATAN SOSIAL"]
        KutubA["KUTUB FEODALISME PERPELONCOAN (EKSPLOITATIF)<br/>• Senior memaksa junior melayani urusan pribadi.<br/>• Dalih mencari berkah untuk menindas adik kelas.<br/>• Akibat: Trauma, dendam sosial, & rusaknya ukhuwah."]
        
        KutubB["KUTUB APATISME INDIVIDUALIS (EGOIS MURNI)<br/>• Menolak kerja bakti; acuh tak acuh pada sesama.<br/>• Hanya fokus pada nilai akademik diri sendiri.<br/>• Akibat: Kesalehan individual semu & elitisme menara gading."]
        
        TUMBUH["NAFI'UN LIGHAIRIH TUMBUH (AL-WASATHIYYAH)<br/>• Khidmah sukarela bermartabat demi kemaslahatan umum.<br/>• Senior menjadi teladan & pengayom (Peer Mentorship).<br/>• Servant Leadership: Memimpin dengan melayani sesama."]
...
```mermaid
flowchart LR
    subgraph TuratsMuwasahDanItsarSalaf["DOKTRIN MUWASAH & ITSAR SALAF"]
        HaditsItsar["HR. Al-Bukhari No. 3798:<br/>Kisah Sahabat Anshar yang Mematikan Lampu Demi Mendahulukan Tamu Memakan Makanan Terakhir"] --> Inti["Hakikat Al-Itsar Syar'i:<br/>Mendahulukan Saudaranya di Atas Kenyamanan Diri Demi Ridha Allah"]
        Ghazali["Al-Ghazali (Ihya' - Adab ash-Shuhbah):<br/>Tiga Tingkatan Khidmah: Menunaikan Hajat Saat Diminta -> Menunaikan Sebelum Diminta -> Mendahulukan Kawan"] --> Inti
        Mawardi["Al-Mawardi (Adab ad-Dunya):<br/>Kewajiban Tolong-Menolong (At-Ta'awun) Sebagai Penopang Keteraturan Sosial"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsEmpatiDanServantLeadership["SINTESIS SERVANT LEADERSHIP & EMPATI"]
        ServantLeadership["Servant Leadership (Greenleaf, 1977):<br/>• Pemimpin sejati melayani kebutuhan tim terlebih dahulu (*Serve First, Lead Second*).<br/>• Mengembangkan kapasitas orang lain & membangun komunitas yang sehat."]
        
        ProsocialDevelopment["Prosocial Moral Development (Eisenberg, 2006):<br/>• Transisi dari empati hedonistik menuju empati berbasis prinsip moral universal (Internalized Altruism)."]
        
        SocialCohesion["Social Cohesion & Empathy-in-Action:<br/>• Merawat kebersamaan melalui aksi nyata tolong-menolong."]
        
        ServantLeadership & ProsocialDevelopment & SocialCohesion ==> StandarTUMBUH["KONSTRUK NAFI'UN LIGHAIRIH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaZonaKhidmahAsrama24Jam["REKAYASA ZONA KHIDMAH ASRAMA"]
        PosCare["ZONA 1: POS PELAYANAN UKHUWAH (Piket Perawatan Santri Sakit, Penjagaan Kamar, & Kotak P3K)."]
        KhidmahLingkungan["ZONA 2: BRIGADE KHIDMAH LINGKUNGAN (Tim Pengelolaan Sampah, Kompos, & Kebersihan Selokan)."]
        PeerTutoring["ZONA 3: KLINIK BELAJAR SEBAYA (Bimbingan Belajar Gratis dari Santri Mahir untuk Kawan yang Kesulitan)."]
        AksiDesa["ZONA 4: POSKO BAKTI DESA BINAAN (Penyaluran Zakat, Pengajaran Al-Qur'an, & Khidmah Kemasyarakatan)."]
        
        PosCare ~~~ KhidmahLingkungan ~~~ PeerTutoring ~~~ AksiDesa
    end
```
...
flowchart TD
    subgraph ProtokolRestorasiKhidmahBermartabat["PROTOKOL DE-FEODALISASI KHIDMAH TIER 2 & 3"]
        ...
        TahapC["3. PELAKSANAAN KERJA BAKTI BERSAMA: SANTRI J4 MENGURAS BAK BERSAMA J1<br/>• Santri J4 dan J1 turun bersama menguras bak mandi dalam suasana ukhuwah dan keceriaan (*Shared Khidmah*)."]
        
        TahapD["4. LAHIRNYA BUDAYA SERVANT LEADERSHIP SEJATI DI ASRAMA<br/>• Senior J4 menjadi figur teladan yang paling rajin bekerja & santri J1 merasa dimuliakan serta aman."]
...
```mermaid
flowchart TD
    subgraph EmpatDimensiKemanfaatanSosial["EMPAT DIMENSI OPERASIONAL NAFI'UN LIGHAIRIH"]
        D1["DIMENSI 1: KEPEKAAN EMPATI & ALTRUISME (AR-RA'FAH WAL-ITSAR)<br/>• Kepekaan rasa terhadap kesusahan kawan & inisiatif menghibur kawan yang sedih.<br/>• Kerelaan mendahulukan kepentingan bersama (*Al-Itsar*) di atas kenyamanan diri."]
        
        D2["DIMENSI 2: KERELAWANAN KHIDMAH PROAKTIF (AL-KHIDMAH AL-MUBADIRAH)<br/>• Inisiatif membersihkan fasilitas umum, melayani santri sakit, & piket tanpa disuruh.<br/>• Semangat gotong royong memelihara keindahan Bi'ah Shalihah asrama 24 jam."]
        
        D3["DIMENSI 3: KEPEMIMPINAN KOLABORATIF (AL-QIYADAH AL-KHADIMAH)<br/>• Gaya kepemimpinan pelayan (*Servant Leadership*): Mengayomi, adil, & anti-feodalisme.<br/>• Menggerakkan tim dalam memecahkan problem sosial asrama & masyarakat."]
        
        D4["DIMENSI 4: ADVOKASI KEADILAN & FILANTROPI (AL-INFAQ WA RAF'UL MAZHALIM)<br/>• Keberanian membela korban ketidakadilan, menghentikan bullying, & melerai konflik.<br/>• Menyalurkan tenaga, waktu, dan harta untuk kemakmuran peradaban umat."]
        
        D1 & D2 & D3 & D4 ==> KonstrukUtuh["KAPASITAS NAFI'UN LIGHAIRIH PARIPURNA"]
    end
```
...
```mermaid
flowchart LR
    J1["J1 (KELAS 7)<br/>Empati & Khidmah Kamar<br/>• Merawat kawan sekamar sakit<br/>• Piket kebersihan kamar tertib<br/>• Berbagi makanan & senyum"]
    --> J2["J2 (KELAS 8–9)<br/>Kerelawanan Lingkungan<br/>• Khidmah masjid & dapur umum<br/>• Menjadi tutor sebaya kawan<br/>• Anti-bullying di asrama"]
    --> J3["J3 (KELAS 10–11)<br/>Penggerak Program Maslahat<br/>• Mengorganisasi bakti sosial desa<br/>• Restorative buddy santri baru<br/>• Inisiatif pemilahan sampah"]
    --> J4["J4 (KELAS 12)<br/>Servant Leadership & Filantropi<br/>• Memimpin organisasi OPPM khidmah<br/>• Mengayomi seluruh santri junior<br/>• Advokasi keadilan & wakaf peradaban"]
```
