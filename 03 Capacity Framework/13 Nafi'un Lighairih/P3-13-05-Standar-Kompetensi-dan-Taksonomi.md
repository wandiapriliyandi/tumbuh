...
```mermaid
flowchart TD
    subgraph TransformasiTaksonomiKhidmah["REKONSTRUKSI TAKSONOMI KEMANFAATAN SOSIAL"]
        Sporadis["EVALUASI KEPEDULIAN TANPA TANGGA TAKSONOMI (TRADISIONAL)<br/>• Tuntutan sama rata tanpa memperhatikan jenjang usia.<br/>• Hanya fokus pada hafalan dalil ta'awun tanpa keterampilan P3K.<br/>• Pembiasaan kepemimpinan pelayan diabaikan."]
        
        TUMBUH["TAKSONOMI KEMANFAATAN FITRAH 4 LEVEL (TUMBUH)<br/>• Level 1: Al-Ihsan al-Mubtadi' (Khidmah Kamar & Empati Sebaya).<br/>• Level 2: Al-Khidmah al-Mubadirah (Kerelawanan & Tutor Sebaya).<br/>• Level 3: Al-Qiyadah al-Khadimah (Penggerak Desa Binaan & Buddy).<br/>• Level 4: Ar-Riyadah al-Insaniyyah (Servant Leadership & Filantropi)."]
        
        Sporadis ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMaratibUkhuwahSalaf["TINGKATAN UKHUWAH DALAM TURATS"]
        Ghazali["Al-Ghazali (Ihya' - Adab ash-Shuhbah):<br/>Tiga Derajat Ukhuwah: 1. Hak Pelayan (Khadim) -> 2. Hak Persaudaraan Setara (Nafs) -> 3. Derajat Al-Itsar (Mendahulukan Saudara)"] --> Inti["Hakikat Taksonomi Khidmah:<br/>Evolusi dari Pelayanan Diri & Kamar Menuju Pengorbanan Total Bagi Umat"]
        Nawawi["An-Nawawi (Syarah Muslim):<br/>Tingkatan Hak-Hak Muslim yang Wajib Ditegakkan"] --> Inti
        Mawardi["Al-Mawardi (Adab ad-Dunya):<br/>Tahapan Melatih Remaja Berjiwa Dermawan & Berkhidmah"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsKrathwohlDanEisenberg["SINTESIS KRATHWOHL & EISENBERG"]
        Krathwohl["Krathwohl Affective Taxonomy (1964):<br/>1. Receiving -> 2. Responding -> 3. Valuing -> 4. Organization -> 5. Characterization by Value."]
        
        EisenbergStages["Eisenberg's Prosocial Reasoning Stages:<br/>• Hedonistic -> Needs-Oriented -> Approval-Oriented -> Empathic -> Strongly Internalized Altruism."]
        
        ServiceCompetency["Service-Learning Competency Standards:<br/>• Keterampilan merancang proyek pengabdian masyarakat berbasis bukti."]
        
        Krathwohl & EisenbergStages & ServiceCompetency ==> TaksonomiTUMBUH["TAKSONOMI KEMANFAATAN FITRAH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaKurikulumOBEKhidmah["REKAYASA KURIKULUM OBE BERJENJANG"]
        J1["J1 (Kelas 7): Khidmah Kamar Tidur, Perawatan Kawan Sakit, & Piket Rak Sandal (30 Jam)."]
        J2["J2 (Kelas 8–9): Pertolongan Pertama P3K Dasar, Tutor Sebaya, & Pelayanan Dapur Umum (45 Jam)."]
        J3["J3 (Kelas 10–11): Ekspedisi Santri Bina Desa, Restorative Buddy J1, & Bank Sampah (60 Jam)."]
        J4["J4 (Kelas 12): Kepemimpinan OPPM Servant Leadership, Capstone Project, & Anti-Bullying (75 Jam)."]
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiKomunikasiDesa["PROTOKOL PELATIHAN KOMUNIKASI EMPATIK TIER 2"]
        Step1["1. FORUM DEBRIEFING HANGAT BERSAMA PEMBINA EKSPEDISI DESA<br/>• Pembina menenangkan Santri H: 'Mengajar anak masyarakat membutuhkan kelembutan hati (*Rifq*); mari kita pelajari seninya'."]
        
        Step2["2. ROLE-PLAYING ICE-BREAKING & DONGENG EDUKATIF BERSAMA MENTOR J4<br/>• Kakak asuh J4 melatih Santri H teknik tepuk anak shalih, lagu islami ceria, & bercerita kisah sahabat."]
        
        Step3["3. SIMULASI MICRO-TEACHING DI KELAS MADRASAH SEBELUM TERJUN KEMBALI<br/>• Santri H mempraktikkan pengajaran Iqro' yang interaktif dan penuh senyuman di hadapan kawan sekelas."]
        
        Step4["4. HASIL KECINTAAN ANAK DESA & PENGUASAAN DIDAKTIK DAKWAH<br/>• Pada kunjungan berikutnya, anak-anak desa berebut belajar bersama Santri H & ia dinobatkan sebagai 'Ustadz Terfavorit TPA Desa'."]
...
```mermaid
flowchart TD
    subgraph EmpatLevelTaksonomiKhidmah["EMPAT LEVEL TAKSONOMI KEMANFAATAN FITRAH"]
        L1["LEVEL 1: AL-IHSAN AL-MUBTADI' (KHIDMAH KAMAR & EMPATI SEBAYA / EMERGING)<br/>• Mampu merawat kawan sekamar sakit, piket kebersihan kamar tertib, & membagi makanan.<br/>• Menuntaskan minimal 30 jam khidmah asrama; 0% penelantaran kawan."]
        
        L2["LEVEL 2: AL-KHIDMAH AL-MUBADIRAH (KERELAWANAN & TUTOR SEBAYA / DEVELOPING)<br/>• Memberikan P3K dasar luka ringan, menjadi tutor sebaya belajar, & piket dapur umum.<br/>• Menuntaskan minimal 45 jam khidmah asrama & lingkungan; anti-perundungan."]
        
        L3["LEVEL 3: AL-QIYADAH AL-KHADIMAH (PENGGERAK DESA & BUDDY CARE / PROFICIENT)<br/>• Mengorganisasi Ekspedisi Bina Desa, mendampingi adik asuh J1 (Restorative Buddy).<br/>• Menuntaskan minimal 60 jam khidmah masyarakat; inisiatif pelestarian lingkungan."]
        
        L4["LEVEL 4: AR-RIYADAH AL-INSANIYYAH (SERVANT LEADERSHIP & WAKAF / EXEMPLARY)<br/>• Memimpin organisasi OPPM khidmah, menuntaskan Capstone Project kelulusan.<br/>• Mengayomi seluruh santri junior, advokasi keadilan sosial, & Al-Itsar sejati."]
...
| :--- | :--- | :--- |
| **Jenjang J1 (Kelas 7)<br/>*Level 1: Al-Ihsan al-Mubtadi'*** | Mampu menampilkan kepekaan empati dasar pada kawan sekamar, menjalankan piket kebersihan kamar, dan membantu kawan yang sakit dengan bimbingan musyrif. | **1.1** Menjaga dan merawat kawan sekamar yang sakit serta melaporkan ke Poskestren $\le 15\text{ menit}$.<br/>**1.2** Melaksanakan piket kebersihan kamar tidur dan slot rak sandal pribadi secara sukarela.<br/>**1.3** Membiasakan berbagi makanan, perlengkapan mandi, dan senyuman ramah kepada kawan.<br/>**1.4** Menuntaskan minimal 30 jam khidmah asrama terverifikasi dalam setahun. |
| **Jenjang J2 (Kelas 8–9)<br/>*Level 2: Al-Khidmah al-Mubadirah*** | Mampu menunjukkan inisiatif kerelawanan dalam pemeliharaan fasilitas umum asrama, terampil memberikan P3K dasar, dan membantu kawan dalam belajar. | **2.1** Menguasai keterampilan pertolongan pertama (P3K) dasar pada luka ringan dan mimisan.<br/>**2.2** Menjadi tutor sebaya (*Peer Tutor*) membantu kawan yang kesulitan hafalan Al-Qur'an/kitab.<br/>**2.3** Berpartisipasi aktif dalam piket pelayanan dapur umum dan gerakan pemilahan sampah.<br/>**2.4** Menuntaskan minimal 45 jam khidmah asrama dan lingkungan per tahun ajaran. |
| **Jenjang J3 (Kelas 10–11)<br/>*Level 3: Al-Qiyadah al-Khadimah*** | Mampu mengorganisasi program pelayanan sosial kemasyarakatan, mendampingi adik kelas junior, dan menggerakkan inisiatif pelestarian lingkungan asrama. | **3.1** Mengorganisasi dan mengajar pada program Ekspedisi Santri Bina Desa (TPA & bakti warga).<br/>**3.2** Menjadi *Restorative Buddy* mendampingi adik asuh jenjang J1 yang mengalami homesickness.<br/>**3.3** Memelopori program pengelolaan bank sampah, komposting, dan penanaman pohon asrama.<br/>**3.4** Menuntaskan minimal 60 jam khidmah kemasyarakatan per tahun ajaran. |
| **Jenjang J4 (Kelas 12)<br/>*Level 4: Ar-Riyadah al-Insaniyyah*** | Mampu memimpin organisasi santri berbasis prinsip murni *Servant Leadership*, melindungi adik kelas dari bullying, dan menuntaskan proyek pengabdian peradaban. | **4.1** Memimpin organisasi santri (OPPM) dengan keteladanan melayani paling depan tanpa kekerasan.<br/>**4.2** Menjadi garda terdepan penegakan Zero-Bullying Policy dan perlindungan santri lemah.<br/>**4.3** Merancang dan menuntaskan karya proyek pengabdian peradaban (*Capstone Civilizational Project*).<br/>**4.4** Menampilkan kepribadian *Khadimul Ummah* sejati yang siap mengabdikan ilmu bagi bangsa. |
