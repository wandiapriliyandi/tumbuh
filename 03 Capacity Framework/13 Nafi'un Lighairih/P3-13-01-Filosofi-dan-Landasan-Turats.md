...
```mermaid
flowchart TD
    subgraph TransformasiFilosofisKemanfaatan["REKONSTRUKSI FILOSOFI KEMANFAATAN SOSIAL"]
        Egosentris["KESALEHAN INDIVIDUAL EGOIS & MENARA GADING (TRADISIONAL)<br/>• Menghafal ilmu tanpa kepedulian sosial.<br/>• Acuh tak acuh terhadap penderitaan kawan & lingkungan.<br/>• Kehilangan ruh khidmah & kepemimpinan pelayan."]
        
        TUMBUH["NAFI'UN LIGHAIRIH TUMBUH (KHADIMUL UMMAH)<br/>• Khairun Naas Anfa'uhum lin-Naas sebagai puncak ilmu.<br/>• Integrasi Doktrin Al-Itsar & Teori Modal Sosial Putnam.<br/>• Posko khidmah santri, aksi bakti sosial, & empati prososial."]
        
        Egosentris ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsKemuliaanKhidmahSosial["DOKTRIN KHIDMAH DALAM SUNNAH & TURATS"]
        HaditsAnfa["HR. Ath-Thabarani (Al-Awsath No. 5787):<br/>أَحَبُّ النَّاسِ إِلَى اللَّهِ أَنْفَعُهُمْ لِلنَّاسِ<br/>(Manusia yang Paling Dicintai Allah Adalah yang Paling Bermanfaat Bagi Manusia)"] --> Inti["Hakikat Nafi'un Lighairih:<br/>Menjadikan Diri Sebagai Sumber Kebaikan, Penolong Hajat, & Rahmatan lil 'Alamin"]
        HaditsHajah["HR. Ibnu Abi Dunya:<br/>Berjalan Membantu Hajat Saudara Lebih Dicintai Nabi daripada I'tikaf 1 Bulan di Masjid Nabawi"] --> Inti
        Ghazali["Al-Ghazali (Ihya' - Adab ash-Shuhbah):<br/>Tiga Derajat Ukhuwah: Menganggap Harta Kawan Seperti Harta Sendiri -> Al-Itsar (Mendahulukan Kawan)"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPerilakuPrososialDanModalSosial["SINTESIS ALTRUISME & MODAL SOSIAL"]
        EmpathyAltruism["Empathy-Altruism Hypothesis (Batson, 2011):<br/>• Empati tulus membangkitkan motivasi altruistik murni untuk menolong sesama tanpa pamrih materiil."]
        
        SocialCapital["Social Capital Theory (Putnam, 2000):<br/>• Bonding & Bridging Social Capital: Jaringan kepercayaan, norma timbal balik (Reciprocity), & aksi gotong royong."]
        
        ServiceLearning["Service-Learning Pedagogy (Furco, 1996):<br/>• Mengintegrasikan pembelajaran akademik dengan pelayanan masyarakat nyata."]
        
        EmpathyAltruism & SocialCapital & ServiceLearning ==> StandarTUMBUH["KAPASITAS NAFI'UN LIGHAIRIH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaEkosistemKhidmah24Jam["REKAYASA EKOSISTEM KHIDMAH ASRAMA"]
        PoskoKhidmah["1. POSKO KHIDMAH & TIM SIAGA ASRAMA: Melayani santri yang sakit, perawatan kamar darurat, & kebersihan."]
        DapurKhidmah["2. PROGRAM KHIDMAH DAPUR & KANTIN: Santri bergiliran melayani pembagian makanan dengan senyuman santun."]
        BinaDesa["3. EKSPEDISI SANTRI BINA DESA: Mengajar TPA gratis, kerja bakti masjid desa, & santunan dhu'afa."]
        BuddyCare["4. RESTORATIVE BUDDY CARE: Pendampingan santri senior kepada kawan yang mengalami kesulitan belajar."]
        
        PoskoKhidmah ~~~ DapurKhidmah ~~~ BinaDesa ~~~ BuddyCare
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolTransformasiKhidmah["PROTOKOL TRANSFORMASI KHIDMAH TIER 2"]
        Step1["1. KAJIAN TURATS BEDAH HADITS 'I'TIKAF 1 BULAN VS HAJAT SAUDARA'<br/>• Musyrif membedah hadits Nabi SAW secara mendalam: 'Ilmu tanpa khidmah adalah kesombongan iblis; Nabi meletakkan menolong orang sakit di atas ibadah sunnah'."]
        
        Step2["2. PENUGASAN KHIDMAH PENDAMPINGAN PASIEN DI POSKESTREN SELAMA 3 HARI<br/>• Santri A ditugaskan merawat kawannya yang sakit, menyuapi makanan, & mengompres dahinya secara tulus."]
        
        Step3["3. REFLEKSI HIKMAH KHIDMAH DI HALAQAH MALAM<br/>• Santri A menangis dan menyadari bahwa melayani kawan yang lemah justru mendatangkan keberkahan pemahaman ilmu."]
        
        Step4["4. LAHIRNYA FIGUR PEMIMPIN PELAYAN (SERVANT LEADER)<br/>• Santri A bertransformasi menjadi santri yang paling peduli, tetap juara kelas, & dicintai seluruh kawan sekamarnya."]
...
```mermaid
flowchart TD
    subgraph ArsitekturFilosofisKhidmah["EMPAT PILAR KAPASITAS NAFI'UN LIGHAIRIH"]
        P1["PILAR 1: KEPEKAAN EMPATI & ALTRUISME (AR-RA'FAH WAL-ITSAR)<br/>• Kepekaan rasa (*Affective Empathy*) terhadap kesusahan & penderitaan orang lain.<br/>• Mendahulukan kepentingan bersama (*Al-Itsar*) di atas kenyamanan pribadi."]
        
        P2["PILAR 2: KHIDMAH & KERELAWANAN AKTIF (AL-KHIDMAH AL-MUBADIRAH)<br/>• Inisiatif turun tangan menolong sesama tanpa menunggu diperintah atau dibayar.<br/>• Dedikasi melayani santri sakit, lansia, anak yatim, & menjaga kebersihan lingkungan."]
        
        P3["PILAR 3: KEPEMIMPINAN KOLABORATIF MASLAHAT (AL-QIYADAH AL-KHADIMAH)<br/>• Gaya kepemimpinan pelayan (*Servant Leadership*): Memimpin dengan keteladanan & pengayoman.<br/>• Menggerakkan tim dalam memecahkan problem sosial asrama & masyarakat."]
        
        P4["PILAR 4: ADVOKASI KEADILAN & FILANTROPI (AL-INFAQ WA RAF'UL MAZHALIM)<br/>• Membela kaum lemah (*Dhu'afa & Mustadh'afin*), anti-perundungan (Bullying), & advokasi keadilan.<br/>• Menyalurkan tenaga, waktu, dan harta untuk kemakmuran peradaban umat."]
        
        P1 & P2 & P3 & P4 ==> SantriPelayan["SANTRI BEREMPATI, DERMAWAN, RELAWAN, & PELAYAN UMAT"]
    end
```
