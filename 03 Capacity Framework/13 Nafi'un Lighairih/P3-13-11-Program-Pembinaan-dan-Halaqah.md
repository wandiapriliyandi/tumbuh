...
```mermaid
flowchart TD
    subgraph TransformasiPembinaanKhidmah["REKONSTRUKSI PROGRAM PEMBINAAN KEMANFAATAN"]
        MonologPasif["CERAMAH MONOLOG TANPA AKSI RIIL (TRADISIONAL)<br/>• Nasehat ukhuwah pasif tanpa latihan keterampilan.<br/>• Santri gagap saat menghadapi kawan pingsan/luka.<br/>• Tanpa sistem mentorship kakak asuh yang mengayomi."]
        
        TUMBUH["PROGRAM PEMBINAAN KHADIMUL UMMAH (TUMBUH)<br/>• Silabus Tematik 24 Pekan Halaqah Khidmah terstruktur.<br/>• 4 Workshop Keterampilan Teknis (P3K, TPA Ceria, Ishlah, Capstone).<br/>• Sistem Restorative Buddy J4–J1 & Ekspedisi Bina Desa Semesteran."]
        
        MonologPasif ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsTarbiyahKhidmahSuffah["TARBIYAH KHIDMAH ASHABUS SUFFAH"]
        HaditsSuffah["Abu Hurairah RA (Shahih Al-Bukhari):<br/>Nabi SAW Mengajarkan Kami Berbagi Susu & Mendahulukan Tamu Sebelum Diri Sendiri"] --> Inti["Hakikat Halaqah Khidmah:<br/>Kombinasi Zikrullah, Pemahaman Syariat, & Latihan Pengorbanan Sosial Riil"]
        Ghazali["Al-Ghazali (Ihya'):<br/>Halaqah yang Diberkahi Adalah yang Melahirkan Kerendahan Hati & Aksi Nyata Melayani Sesama"] --> Inti
        AbuNuaim["Abu Nu'aim (Hilyatul Auliya'):<br/>Kisah Sahabat yang Memikul Gandum Tengah Malam untuk Kaum Faqir"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsKolbDanServiceLearning["SINTESIS EXPERIENTIAL LEARNING & KHIDMAH"]
        KolbCycle["Kolb's Experiential Learning (1984):<br/>1. Concrete Experience (Aksi Pengabdian Desa).<br/>2. Reflective Observation (Refleksi Halaqah).<br/>3. Abstract Conceptualization (Kajian Turats).<br/>4. Active Experimentation (Proyek Maslahat)."]
        
        ServiceLearningModel["Service-Learning Pedagogy (Furco, 1996):<br/>• Menyeimbangkan capaian pembelajaran karakter dengan dampak nyata bagi kesejahteraan masyarakat."]
        
        PeerMentorshipTheory["Peer Mentorship Theory (Topping, 2005):<br/>• Kakak asuh senior membimbing adik asuh junior menumbuhkan rasa aman & empati."]
        
        KolbCycle & ServiceLearningModel & PeerMentorshipTheory ==> DesainProgramTUMBUH["KURIKULUM PEMBINAAN KHIDMAH"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurProgramKhidmahMingguan["ALUR SIKLUS MINGGUAN PEMBINAAN"]
        HalaqahMalam["1. MALAM JUM'AT (45 MENIT): Halaqah Tematik Khadimul Ummah & Bedah Kasus Empati."]
        SimulasiSabtu["2. SABTU SORE (60 MENIT): Workshop Simulasi Teknis (P3K / Micro-Teaching TPA)."]
        AksiAhad["3. AHAD PAGI (120 MENIT): Aksi Nyata Ekspedisi Desa Binaan & Khidmah Dapur Asrama."]
        RefleksiAhadMalam["4. AHAD MALAM (30 MENIT): Sesi Refleksi Ukhuwah & Pengisian Logbook Jam Khidmah."]
        
        HalaqahMalam --> SimulasiSabtu --> AksiAhad --> RefleksiAhadMalam
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolTransformasiPiketDapur["PROTOKOL TRANSFORMASI SOCIAL LOAFING TIER 2"]
        Step1["1. DIALOG PRIVAT PENYADARAN MAKNA BUTIRAN NASI BERSAMA KEPALA DAPUR<br/>• Kepala Dapur mengajak Santri R melihat jerih payah juru masak yang bangun jam 03.00 pagi demi memberi makan santri."]
        
        Step2["2. PENUGASAN KHIDMAH SPESIAL BERSAMA MUSYRIF: MENYAJIKAN MAKANAN WALI KELAS<br/>• Santri R bertugas membawakan nampan makanan guru & melihat senyuman terima kasih yang tulus dari para asatidz."]
        
        Step3["3. SHARING DI HALAQAH TENTANG 'BERKAH MELAYANI ORANG YANG MENUNTUT ILMU'<br/>• Santri R dibimbing memahami hadits: Melayani para penuntut ilmu mendatangkan aliran pahala ilmu mereka."]
        
        Step4["4. HASIL TRANSFORMASI INISIATIF DAPUR PARIPURNA<br/>• Santri R bertransformasi menjadi ketua regu piket dapur yang paling rajin, sigap, & selalu datang paling awal."]
...
```mermaid
flowchart TD
    subgraph Silabus24PekanHalaqahKhidmah["SILABUS 24 PEKAN HALAQAH KHADIMUL UMMAH"]
        subgraph K1["KUADRAN I: FONDASI EMPATI & RUH AL-ITSAR (PEKAN 1–6)"]
            W01["Pekan 1: Hadits Khairun Naas Anfa'uhum lin Naas & Visi Khadimul Ummah"]
            W02["Pekan 2: Adab ash-Shuhbah Imam Al-Ghazali & Menjaga Perasaan Kawan"]
            W03["Pekan 3: Keagungan Doktrin Al-Itsar (Mendahulukan Saudara Seiman)"]
            W04["Pekan 4: Tazkiyatun Nafs: Mengikis Sombong & Riya' dalam Beramal"]
            W05["Pekan 5: Adab Menjenguk & Merawat Kawan Sekamar yang Sakit"]
            W06["Pekan 6: Indahnya Berbagi Rezeki: Praktik Infaq Subuh & Berbagi Makanan"]
        end

        subgraph K2["KUADRAN II: KETERAMPILAN TEKNIS KHIDMAH ASRAMA (PEKAN 7–12)"]
            W07["Pekan 7: Workshop Pertolongan Pertama (P3K): Penanganan Luka & Pingsan"]
            W08["Pekan 8: Manajemen Siaga Poskestren & Protokol Sanitasi Asrama"]
            W09["Pekan 9: Fiqh Imathatul Adza: Menjaga Fasilitas Publik & Rak Sandal"]
            W10["Pekan 10: Adab Melayani di Dapur Umum & Menghargai Makanan"]
            W11["Pekan 11: Teknik Menjadi Tutor Sebaya (Peer Tutor) Nahwu & Hafalan"]
            W12["Pekan 12: Evaluasi Tengah Tahun: Audit Portofolio Jam Khidmah Asrama"]
        end

        subgraph K3["KUADRAN III: DAKWAH MASYARAKAT & EKSPEDISI DESA (PEKAN 13–18)"]
            W13["Pekan 13: Fiqh Dakwah Kemasyarakatan & Memahami Karakter Warga Desa"]
            W14["Pekan 14: Workshop Didaktik Mengajar TPA Ceria: Dongeng & Lagu Islami"]
            W15["Pekan 15: Perencanaan Ekspedisi Santri Bina Desa: Pemetaan Kebutuhan"]
            W16["Pekan 16: Pelaksanaan Ekspedisi Santri Bina Desa: Mengajar & Bakti Sosial"]
            W17["Pekan 17: Fiqh Hifzhul Bi'ah: Bank Sampah, Daur Ulang, & Tanam Pohon"]
            W18["Pekan 18: Refleksi Pengabdian Masyarakat & Menulis Catatan Hikmah Desa"]
        end

        subgraph K4["KUADRAN IV: SERVANT LEADERSHIP & PROYEK PERADABAN (PEKAN 19–24)"]
            W19["Pekan 19: Doktrin Sayyidul Qaumi Khadimuhum: Memimpin Tanpa Kekerasan"]
            W20["Pekan 20: Garda Terdepan Anti-Bullying: Menjaga Santri Lemah & Yatim"]
            W21["Pekan 21: Mediasi Ishlah Damai: Seni Merukunkan Kawan yang Berselisih"]
            W22["Pekan 22: Perancangan Capstone Civilizational Project Kelulusan (J4)"]
            W23["Pekan 23: Sidang Terbuka Paparan Proyek Pengabdian Peradaban"]
            W24["Pekan 24: Ikrar & Wisuda Kelulusan Khadimul Ummah Paripurna"]
        end
