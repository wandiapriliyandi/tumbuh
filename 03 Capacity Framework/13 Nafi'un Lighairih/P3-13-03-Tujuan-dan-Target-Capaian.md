...
```mermaid
flowchart TD
    subgraph TransformasiTargetKhidmah["REKONSTRUKSI TARGET CAPAIAN KEMANFAATAN SOSIAL"]
        SloganAbstrak["SLOGAN NORMATIF TANPA JAM PENGABDIAN (TRADISIONAL)<br/>• Visi kemanfaatan tanpa portofolio jam khidmah riil.<br/>• Tanpa pengukuran keterampilan P3K & mediasi konflik.<br/>• Pembiasaan feodalisme senioritas dibiarkan."]
        
        TUMBUH["STANDAR CAPAIAN CP-NL TUMBUH (OBE FRAMEWORK)<br/>• Dekomposisi Tri-Domain (Kognitif, Afektif, Psikomotorik).<br/>• Target: Minimal 60 Jam Khidmah Sosial/Tahun & 0% Bullying.<br/>• Servant Leadership & Penggerak Solusi Masyarakat Binaan."]
        
        SloganAbstrak ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMaqashidKhidmahSosial["MAQASHID SYARI'AH KHIDMAH SOSIAL"]
        IzzAbdusSalam["Al-'Izz bin Abdissalam (Qawa'idul Ahkam):<br/>جَلْبُ الْمَصَالِحِ وَدَرْءُ الْمَفَاسِدِ عَنِ الْعِبَادِ أَعْظَمُ مَقَاصِدِ الشَّرِيعَةِ<br/>(Mendatangkan Maslahat & Menolak Mafsadat Adalah Maqashid Tertinggi)"] --> Inti["Hakikat Target CP-NL:<br/>Mewujudkan Insan Pelayan yang Mengalirkan Maslahat bagi Seluruh Makhluk"]
        Syathibi["Asy-Syathibi (Al-Muwafaqat):<br/>Tolong-Menolong (At-Ta'awun) Adalah Syarat Mutlak Berdirinya Agama & Dunia"] --> Inti
        Nawawi["An-Nawawi (Riyadhus Shalihin):<br/>Bab Qadha' Hawa'ijil Muslimin & Fadhlur Rifq"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsOBEDanKompetensiPrososial["SINTESIS OBE & PERILAKU PROSOSIAL"]
        OBE["Outcome-Based Education (Spady, 1994):<br/>• Merancang kurikulum dari profil lulusan ideal (Khadimul Ummah) menuju bukti portofolio khidmah nyata."]
        
        ProsocialCompetency["Prosocial Competency Framework (Eisenberg, 2006):<br/>• Tiga Pilar: Empathic Distress Perception, Altruistic Motivation, & Helping Behavior Execution."]
        
        SocialImpact["Social Impact Assessment Standards:<br/>• Mengukur dampak nyata program bina desa terhadap kesejahteraan masyarakat."]
        
        OBE & ProsocialCompetency & SocialImpact ==> StandarCPNL["CAPAIAN PEMBELAJARAN CP-NL TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaFasilitasKhidmah24Jam["REKAYASA FASILITAS KHIDMAH ASRAMA"]
        PoskestrenKhidmah["1. POSKESTREN & TIM RELAWAN P3K: Ruang perawatan medis dasar yang dikelola relawan santri J3–J4."]
        DapurKhidmah["2. PROGRAM ROTASI KHIDMAH DAPUR: Santri bergiliran melayani makan kawan asrama secara terjadwal."]
        BankSampah["3. BANK SAMPAH & KOMPOS PESANTREN: Unit daur ulang sampah organik & anorganik asrama."]
        DesaBinaan["4. DESA BINAAN PESANTREN TUMBUH: 3 desa sekitar pondok yang menjadi laboratorium pengabdian santri."]
        
        PoskestrenKhidmah ~~~ DapurKhidmah ~~~ BankSampah ~~~ DesaBinaan
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolTransformasiKerendahhatian["PROTOKOL DE-FEODALISASI KELAS SOSIAL TIER 2"]
        Step1["1. DIALOG RESTORATIF PRIVAT BERSAMA MUSYRIF: KESETARAAN MUTLAK INSAN<br/>• Musyrif membedah hadits 'Innamal Mu'minuna Ikhwah' & teladan Nabi SAW memikul batu saat menggali Parit Khandaq."]
        
        Step2["2. PEMBATALAN PEMBAYARAN KEPADA TEMAN & PENUGASAN KHIDMAH BERSAMA WALI KELAS<br/>• Santri L wajib mengembalikan uang & membersihkan area selokan bersama wali kelas secara langsung."]
        
        Step3["3. PENUGASAN 'KHIDMAH CUCI PIRING DAPUR UMUM' SELAMA 3 HARI<br/>• Santri L melayani mencuci perlengkapan makan santri dhu'afa di dapur asrama (*Humility Training*)."]
        
        Step4["4. HASIL KERENDAHHATIAN & UKHUWAH SEJATI PARIPURNA<br/>• Santri L menyadari bahwa kemuliaan ada pada kerendahhatian & menjadi sahabat akrab kawan dhu'afanya."]
...
```mermaid
flowchart TD
    subgraph DekomposisiTriDomainCPNL["DEKOMPOSISI CAPAIAN PEMBELAJARAN (CP-NL)"]
        subgraph KOGNITIF["A. DOMAIN KOGNITIF (KONSEPTUAL & NALAR SOSIAL)"]
            K1["• Menguasai Fiqh Khidmah, Adab ash-Shuhbah, & Prinsip Servant Leadership."]
            K2["• Memahami Analisis Kebutuhan Sosial Masyarakat (Community Needs Assessment)."]
            K3["• Menguasai Protokol Mediasi Konflik Damai, Anti-Bullying, & Manajemen Bencana."]
        end

        subgraph AFEKTIF["B. DOMAIN AFEKTIF (NURANI & MORAL ALTRUISME)"]
            A1["• Menghayati Kepekaan Empati Afektif (Ar-Ra'fah) & Sikap Mendahulukan Sesama (Al-Itsar)."]
            A2["• Memiliki Kerendahhatian (Tawadhu') Mutlak: Bangga Menjadi Pelayan Umat (Khadim)."]
            A3["• Menjunjung Jiwa Pengorbanan Sukarela: Ikhlas Berkhidmah Tanpa Mengharapkan Upah."]
        end

        subgraph PSIKOMOTORIK["C. DOMAIN PSIKOMOTORIK (KETERAMPILAN KHIDMAH PRAKTIS)"]
            P1["• Terampil Memberikan Pertolongan Pertama (P3K) & Perawatan Santri Sakit Poskestren."]
            P2["• Mahir Mengajar Al-Qur'an/Adab di TPA Desa Binaan & Memimpin Aksi Bakti Sosial."]
            P3["• Terampil Memelihara Kelestarian Fasilitas Publik, Dapur Umum, & Kebersihan Lingkungan."]
        end
...
| :--- | :--- |
| **Jenjang J1 (Kelas 7, Usia 12–13)** | • Mampu merawat kawan sekamar yang sakit dan melaporkan ke Poskestren $\le 15\text{ menit}$.<br/>• Terbiasa membagi makanan dan tersenyum ramah kepada seluruh kawan asrama.<br/>• Menuntaskan piket kebersihan kamar dan rak sandal asrama secara sukarela.<br/>• Menuntaskan minimal 30 jam khidmah asrama per tahun ajaran. |
| **Jenjang J2 (Kelas 8–9, Usia 13–15)** | • Terampil memberikan pertolongan pertama (P3K) dasar pada luka ringan.<br/>• Menjadi tutor sebaya (*Peer Tutor*) membantu kawan yang kesulitan hafalan.<br/>• Berpartisipasi aktif dalam piket pelayanan dapur umum dan pemilahan sampah.<br/>• Menuntaskan minimal 45 jam khidmah asrama & lingkungan per tahun. |
| **Jenjang J3 (Kelas 10–11, Usia 15–17)** | • Mampu mengorganisasi program Ekspedisi Santri Bina Desa (mengajar TPA & bakti sosial).<br/>• Menjadi *Restorative Buddy* mendampingi adik asuh J1 yang mengalami homesickness.<br/>• Memelopori aksi peduli lingkungan, bank sampah, dan penanaman pohon.<br/>• Menuntaskan minimal 60 jam khidmah kemasyarakatan per tahun. |
| **Jenjang J4 (Kelas 12, Usia 17–18)** | • Mampu memimpin organisasi santri (OPPM) berbasis prinsip murni *Servant Leadership*.<br/>• Menjadi garda terdepan perlindungan adik kelas dari perundungan (*Zero Bullying Advocate*).<br/>• Menuntaskan proyek pengabdian peradaban (*Capstone Civilizational Project*) kelulusan.<br/>• Menampilkan kepribadian *Khadimul Ummah* paripurna yang siap berbakti bagi bangsa. |
