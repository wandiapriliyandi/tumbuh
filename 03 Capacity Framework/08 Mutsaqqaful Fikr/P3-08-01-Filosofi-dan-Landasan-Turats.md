...
```mermaid
flowchart TD
    subgraph TransformasiParadigmaIntelektual["REKONSTRUKSI PARADIGMA INTELEKTUAL PESANTREN"]
        Dogmatis["PARADIGMA TAKLID BUTA & HAFALAN VERBAL<br/>• Menghafal tanpa paham nalar dalil.<br/>• Tabu bertanya kritis & diskusi ilmiah diharamkan.<br/>• Akibat: Santri jumud, gagap sains, & mudah termakan hoaks."]
        
        TUMBUH["PARADIGMA MUTSAQQAFUL FIKR TUMBUH<br/>• Integrasi Nalar Bayani (Teks), Burhani (Sains), & Irfani (Hikmah).<br/>• Literasi riset kritis, metakognisi, & Bahtsul Masail dialogis.<br/>• Hasil: Cendekiawan berwawasan luas, beradab, & solutif bagi peradaban."]
        
        Dogmatis ==>|DIREKONSTRUKSI SECARA METODOLOGIS MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsEpistemologiFikr["AKAR EPISTEMOLOGIS TURATS MUTSAQQAFUL FIKR"]
        NashUlilAlbab["QS. Ali 'Imran: 190–191:<br/>إِنَّ فِي خَلْقِ السَّمَاوَاتِ وَالْأَرْضِ... لَآيَاتٍ لِأُولِي الْأَلْبَابِ<br/>(Sintesis Dzikir & Fikir: Observasi Kosmologis & Tadabbur)"] --> Inti["Hakikat Mutsaqqaful Fikr:<br/>Kecerdasan Intelektual Berorientasi Hikmah & Maslahat"]
        IbnuRusyd["Ibnu Rusyd (Fashlul Maqal):<br/>Harmoni Antara Hikmah (Filsafat/Sains) & Syariat (Wahyu)"] --> Inti
        AlJabiri["Abid Al-Jabiri (Bunyatu Aqlil Arabi):<br/>Integrasi Tiga Nalar: Bayani, Burhani, & Irfani"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsKognitifModern["INTEGRASI SAINS KOGNITIF & METAKOGNISI"]
        CLT["1. Cognitive Load Theory (Sweller, 1988):<br/>• Intrinsic, Extraneous, & Germane Load.<br/>• Pengelolaan memori kerja (Working Memory) agar tidak overload saat menghafal."]
        
        PFC["2. Prefrontal Cortex & Executive Function (Diamond, 2013):<br/>• Cognitive Flexibility (Kelenturan Nalar)<br/>• Inhibitory Control (Penyaringan Informasi Palsu)<br/>• Working Memory Update"]
        
        Meta["3. Metacognition & Self-Regulated Learning (Flavell, 1979):<br/>• Kesadaran santri tentang cara belajarnya sendiri (Thinking about Thinking)."]
        
        CLT & PFC & Meta ==> IntelekPrima["KAPASITAS INTELEKTUAL MUTSAQQAFUL FIKR PRIMA"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaEkologiLiterasi["REKAYASA SPASIAL LITERASI ASRAMA TUMBUH"]
        PojokBaca["1. POJOK LITERASI DI SETIAP KAMAR TIDUR:<br/>• Rak buku kamar berisi kitab rujukan, ensiklopedia sains, & novel sejarah beradab.<br/>• Waktu wajib membaca senyap 20 menit sebelum tidur (Silent Reading)."]
        
        PerpusDigital["2. PERPUSTAKAAN MAKTABAH DIGITAL PESANTREN:<br/>• Akses internet riset terfilter ke ribuan kitab Turats digital (Maktabah Syamilah) & jurnal sains."]
        
        BahtsulMasail["3. FORUM BAHTSUL MASAIL DIALOGIS:<br/>• Musyawarah mingguan membedah isu-isu kontemporer (AI, bioetika, fiqh lingkungan)."]
        
        PojokBaca & PerpusDigital & BahtsulMasail ==> KulturRiset["BUDAYA LITERASI & RISET ILMIAH 24 JAM"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRestorasiIntelektual["PROTOKOL TRANSFORMASI NALAR KRITIS TIER 2"]
        L1["1. DIALOG SOCRATIC BERSAMA USTADZ PEMBINA (SOCRATIC QUESTIONING)<br/>• Ustadz memancing pertanyaan reflektif: 'Mengapa Imam Syafi'i memiliki Qawl Qadim & Qawl Jadid?'"]
        
        L2["2. PENGENALAN STUDI KOMPARATIF LINTAS MAZHAB (IKHTILAFUL FUQAHA)<br/>• Santri D diajak membaca kitab Bidayatul Mujtahid karya Ibnu Rusyd untuk melihat ragam dalil."]
        
        L3["3. TUGAS RISET INKUIRI LAPANGAN TERPANDU<br/>• Santri D meneliti studi kasus riil (misal: pengelolaan sampah pasar) lalu mencari solusi fikih kontekstual."]
        
        L4["4. PRESENTASI DI FORUM BAHTSUL MASAIL SANTRI<br/>• Santri D mempresentasikan hasil risetnya & menerima tanggapan kawan dengan lapang dada."]
...
```mermaid
flowchart TD
    subgraph ArsitekturMutsaqqafulFikr["EMPAT PILAR DIMENSI KARAKTER MUTSAQQAFUL FIKR"]
        P1["PILAR 1: AL-MA'RIFAH AS-SYAR'IYYAH (PENGUASAAN KEILMUAN TURATS & TAFSIR WAHYU)<br/>• Pemahaman mendalam nash Al-Qur'an, Hadits, Fiqh 4 Mazhab, & Maqashid Syari'ah.<br/>• Metodologi Ushul Fiqh & istinbath hukum yang terstruktur."]
        
        P2["PILAR 2: AT-TAFAKKUR AL-NAQDIY (NALAR KRITIS, LOGIKA, & METAKOGNISI)<br/>• Penguasaan logika mantiq, filsafat argumentasi, & deteksi sesat pikir (Fallacy).<br/>• Keterampilan metakognisi memecahkan masalah kompleks secara sistematis."]
        
        P3["PILAR 3: AL-LITERASIYAH AL-ILMIYYAH (LITERASI SAINS, SOSIAL, & RISET EMPIRIS)<br/>• Wawasan sains alam, kosmologi, matematika terapan, & metodologi riset ilmiah.<br/>• Pemahaman dinamika geopolitik, sosiologi umat, & sejarah peradaban Islam."]
        
        P4["PILAR 4: AL-LITERASIYAH AR-RAQMIYYAH (LITERASI DIGITAL & TABAYYUN INFORMASI)<br/>• Kemampuan navigasi teknologi informasi, analisis data cerdas, & etika digital syar'i.<br/>• Imunitas terhadap hoaks, disinformasi, & polarisasi media sosial."]
        
        P1 & P2 & P3 & P4 ==> Output["INSAN ADABI BERWAWASAN INTELEKTUAL LUAS (MUTSAQQAFUL FIKR)"]
    end
```
...
```mermaid
flowchart LR
    J1["JENJANG J1 (KELAS 7)<br/>Literasi Dasar & Membaca Kritis<br/>• Minat baca mandiri 2 buku/bln<br/>• Memahami peta konsep kitab<br/>• Tabayyun informasi awal"]
    --> J2["JENJANG J2 (KELAS 8–9)<br/>Logika Mantiq & Analisis Dalil<br/>• Membedakan fakta vs opini<br/>• Debat ilmiah terstruktur<br/>• Studi perbandingan mazhab"]
    --> J3["JENJANG J3 (KELAS 10–11)<br/>Riset Ilmiah & Fiqh Kontekstual<br/>• Penulisan karya tulis ilmiah (KTI)<br/>• Bahtsul masail isu modern<br/>• Literasi digital & coding dasar"]
    --> J4["JENJANG J4 (KELAS 12)<br/>Sintesis Hikmah & Qudwah Fikr<br/>• Publikasi monograf riset mandiri<br/>• Menjadi narasumber kajian adik kelas<br/>• Wawasan kepemimpinan peradaban"]
```
...
```mermaid
flowchart TD
    subgraph MultiTierPBISIntelektual["ARSITEKTUR MULTI-TIER PBIS MUTSAQQAFUL FIKR"]
        Tier1["TIER 1: UNIVERSAL INTELLECTUAL PROMOTION (100% Santri)<br/>• Pojok Baca Kamar & Jadwal Membaca Senyap 20 Menit Harian.<br/>• Budaya Pertanyaan Terbuka di Kelas Madrasah (Inquiry Classroom).<br/>• Apresiasi 'Santri Pembaca Buku Terbaik' Mingguan."]
        
        Tier2["TIER 2: TARGETED COGNITIVE INTERVENTION (10–15% Santri)<br/>• Klinik Metakognisi & Bimbingan Belajar Adaptif bagi santri kesulitan memahami konsep.<br/>• Bengkel Penulisan KTI & Literasi Kritis bagi santri berbakat riset.<br/>• Sesi Mentorship Membaca Terpandu (Guided Reading) bersama Santri J4."]
        
        Tier3["TIER 3: INTENSIVE INTELLECTUAL RESTORATION (1–5% Santri)<br/>• Bimbingan Khusus Kasus Hambatan Kognitif Berat / Disleksia oleh Psikolog Pendidikan.<br/>• Dialog Restoratif Intelektual bagi santri yang terpapar ideologi ekstremis / nihilisme.<br/>• Rencana Pembelajaran Terindividualisasi (Individualized Learning Plan / ILP)."]
