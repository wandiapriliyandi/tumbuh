...
```mermaid
flowchart TD
    subgraph DekonstruksiDefinisiIntelektual["DEKONSTRUKSI DEFINISI KECERDASAN SANTRI"]
        Parsial["DEFINISI PARSIAL TRADISIONAL<br/>• Cerdas = Sekadar hafal matan kitab di luar kepala.<br/>• Buta metodologi sains modern & gagap teknologi.<br/>• Rawan terjebak sesat pikir (Logical Fallacy) & hoaks."]
        
        TUMBUH["KONSEPTUALISASI MUTSAQQAFUL FIKR TUMBUH<br/>• Cerdas = Keutuhan Nalar Turats, Sains, Logika, & Digital.<br/>• Mampu berpikir kritis (HOTS), metakognisi, & riset ilmiah.<br/>• Menghasilkan karya pemikiran solutif bagi peradaban."]
...
```mermaid
flowchart LR
    subgraph TuratsKonsepAkal["HAKIKAT AKAL & ILMU DALAM TURATS"]
        Ghazali["Al-Ghazali (Ihya' - Kitabul 'Ilm):<br/>Akal Sebagai 'Nurun fil Qalb' yang Mampu Membedakan Hakikat Masalah"] --> Inti["Hakikat Mutsaqqaful Fikr:<br/>Kecerdasan Intelektual Berorientasi Hikmah & Amal"]
        Raghib["Ar-Raghib Al-Ashfahani (Adz-Dzari'ah):<br/>Tingkatan Ilmu: Ma'rifah, Fahm, Dirayah, & Hikmah"] --> Inti
        Mawardi["Al-Mawardi (Adab Dunya):<br/>Akal Ghariji (Fitrah) Menyatu dengan Akal Muktasab (Belajar)"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph IntegrasiKognisiModern["SINTESIS HOTS DAN DUAL-PROCESS THEORY"]
        Bloom["Taksonomi Bloom-Anderson (2001):<br/>• Low Order: Remember, Understand, Apply.<br/>• Higher Order Thinking Skills (HOTS): Analyze, Evaluate, Create."]
        
        Kahneman["Dual-Process Theory (Daniel Kahneman, 2011):<br/>• System 1: Berpikir Cepat, Otomatis, Rawan Bias/Emosi.<br/>• System 2: Berpikir Lambat, Logis, Kritis, Analitis."]
        
        Bloom & Kahneman ==> FikrTUMBUH["MUTSAQQAFUL FIKR TUMBUH:<br/>Nalar Analitis HOTS & Aktivasi System 2 Terlatih"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaSpasialIntelektual["EKOLOGI DIALEKTIKA INTELEKTUAL ASRAMA"]
        Kelas["1. RUANG KELAS MADRASAH: Forum Diskusi Inkuiri & Socratic Dialogue."]
        Halaqah["2. SESI HALAQAH MINGGUAN: Bedah Konseptual Turats & Isu Peradaban Modern."]
        Kamar["3. RUANG KAMAR ASRAMA: Pojok Baca Senyap & Diskusi Adab Ilmiah Sebelum Tidur."]
...
```mermaid
flowchart TD
    subgraph ProtokolAdabIntelektual["PROTOKOL TRANSFORMASI DIALEKTIKA TIER 2"]
        Step1["1. KAJIAN ETIKA DIALOG (ADABUL BAHATS WAL MUNAZHARAH)<br/>• Musyrif membedah kitab Risalah fi Adabil Bahats bersama Santri M.<br/>• Menanamkan prinsip Imam Syafi'i: 'Pendapatku benar tapi mungkin salah, pendapat lawanku salah tapi mungkin benar'."]
        
        Step2["2. PENUGASAN 'STEEL-MANNING ARGUMENT'<br/>• Santri M diwajibkan menulis ulang argumen kawan yang didebatnya dengan cara paling kuat & objektif sebelum memberikan tanggapan."]
        
        Step3["3. LATIHAN MENDENGARKAN EMPATIK (ACTIVE LISTENING)<br/>• Santri M dilarang memotong pembicaraan selama 3 menit saat diskusi halaqah."]
        
        Step4["4. REFLEKSI TAWADHU' INTELEKTUAL 30 HARI<br/>• Santri M merasakan kedamaian batin saat berdialog dengan niat mencari ridha Allah."]
...
```mermaid
flowchart TD
    subgraph KonstrukMutsaqqafulFikr["STRUKTUR KONSTRUK MULTIDIMENSIONAL MUTSAQQAFUL FIKR"]
        Core["INTI MUTSAQQAFUL FIKR<br/>(Kecerdasan Peradaban Berbasis Wahyu & Akal)"]
        
        D1["Dimensi 1: Kafa'ah Turatsiyyah (Epistemologi Wahyu)<br/>• Pemahaman Al-Qur'an & Hadits<br/>• Kaidah Ushul Fiqh & Maqashid<br/>• Khazanah Kitab Kuning Klasik"]
        
        D2["Dimensi 2: Kafa'ah Mantiqiyyah (Nalar Kritis & Logika)<br/>• Logika Silogisme Bebas Fallacy<br/>• Analisis HOTS & Metakognisi<br/>• Kemampuan Pemecahan Masalah"]
        
        D3["Dimensi 3: Kafa'ah 'Ilmiyyah (Literasi Sains & Riset)<br/>• Wawasan Kosmologi & Sains Alam<br/>• Metodologi Riset Ilmiah Empiris<br/>• Literasi Data & Statistik"]
        
        D4["Dimensi 4: Kafa'ah Raqmiyyah (Literasi Digital & Tabayyun)<br/>• Verifikasi Informasi & Anti-Hoaks<br/>• Etika Komunikasi Siber Syar'i<br/>• Pemanfaatan Teknologi Riset"]
...
```mermaid
quadrantChart
    title MATRIKS TIPOLOGI PROFIL PEMIKIRAN SANTRI
    x-axis "Keterbukaan Sains/Nalar Kritis Rendah" --> "Keterbukaan Sains/Nalar Kritis Tinggi"
    y-axis "Penguasaan Turats Rendah" --> "Penguasaan Turats Tinggi"
    quadrant-1 "TIPE 4: INTELEKTUAL ADABI PARIPURNA (TUMBUH)"
    quadrant-2 "TIPE 1: TEKSTUALIS KAKU / DOGMATIS JUMUD"
    quadrant-3 "TIPE 3: PASIF APATIS / DEFIAS KOGNITIF"
    quadrant-4 "TIPE 2: RASIONALIS SEKULER / ALIENASI TURATS"
```
...
```mermaid
flowchart TD
    subgraph ProgresiIntelektualJ1J4["TANGGA PERKEMBANGAN INTELEKTUAL J1–J4"]
        J1["J1: LITERASI DASAR & STRUKTUR HAFALAN (KELAS 7)<br/>• Memahami kaidah dasar bahasa Arab & peta konsep matan.<br/>• Membaca mandiri 2 buku/bulan & membedakan fakta vs opini."]
        
        J2["J2: LOGIKA MANTIQ & ANALISIS DALIL (KELAS 8–9)<br/>• Mendeteksi kesesatan berpikir (Logical Fallacy).<br/>• Studi perbandingan dalil mazhab & debat ilmiah beradab."]
        
        J3["J3: RISET ILMIAH & FIQH KONTEKSTUAL (KELAS 10–11)<br/>• Penulisan Karya Tulis Ilmiah (KTI) metodologis.<br/>• Bahtsul masail isu modern & literasi riset digital terstandarisasi."]
        
        J4["J4: SINTESIS HIKMAH & KEPEMIMPINAN PIKIR (KELAS 12)<br/>• Publikasi monograf riset mandiri & narasumber kajian junior.<br/>• Wawasan kepemimpinan peradaban global berakar nilai Islam."]
