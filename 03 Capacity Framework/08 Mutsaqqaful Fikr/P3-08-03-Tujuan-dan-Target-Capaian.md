...
```mermaid
flowchart TD
    subgraph TransformasiTargetIntelektual["REKONSTRUKSI TARGET CAPAIAN INTELEKTUAL SANTRI"]
        Kabur["TARGET TRADISIONAL KABUR<br/>• 'Pokoknya khatam kitab kuning & hafal matan'.<br/>• Tanpa pengukuran kemampuan nalar kritis & riset.<br/>• Santri gagap menulis karya ilmiah & memecahkan masalah."]
        
        TUMBUH["TARGET CAPAIAN MUTSAQQAFUL FIKR TUMBUH<br/>• Capaian Pembelajaran (CP-MF) berbasis HOTS & Inkuiri.<br/>• Target penguasaan metodologi Turats, logika, sains, & KTI.<br/>• Matriks capaian berjenjang J1–J4 & publikasi riset mandiri."]
        
        Kabur ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsTargetIntelektual["TAHAPAN TARGET CAPAIAN ILMU SALAF"]
        IbnuAbdilBarr["Ibnu Abdil Barr (Jami' Bayanil 'Ilmi):<br/>أَوَّلُ الْعِلْمِ الِاسْتِمَاعُ، ثُمَّ الْفَهْمُ، ثُمَّ الْحِفْظُ، ثُمَّ النَّشْرُ وَالْعَمَلُ<br/>(Mendengar -> Memahami -> Menghafal -> Menyebarkan & Mengamalkan)"] --> Inti["Target Capaian Mutsaqqaful Fikr:<br/>Kematangan Nalar, Integritas Riset, & Penyebaran Manfaat"]
        Zarnuji["Az-Zarnuji (Ta'limul Muta'allim):<br/>Syarat Sukses Ilmu: Kecerdasan, Semangat, Kesabaran, Biaya, Bimbingan Guru, & Waktu Panjang"] --> Inti
        Mawardi["Al-Mawardi (Adab Dunya):<br/>Keluasan Wawasan Sebagai Benteng Kehormatan Akal"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph StandarBerpikirKritis["SINTESIS KERANGKA BERPIKIR KRITIS"]
        Ennis["Robert Ennis Critical Thinking Framework (2018):<br/>• Clarification (Analisis Argumen & Konsep)<br/>• Basis for Decision (Menilai Kredibilitas Sumber/Sanad)<br/>• Inference (Penarikan Deduksi & Induksi Logis)<br/>• Advanced Clarification (Mendefinisikan Istilah & Menguji Asumsi)"]
        
        PaulElder["Paul-Elder Critical Thinking Model (2019):<br/>• Intellectual Standards: Clarity, Accuracy, Precision, Relevance, Depth, Breadth, Logic."]
        
        Ennis & PaulElder ==> TargetTUMBUH["TARGET KUANTITATIF-KUALITATIF MUTSAQQAFUL FIKR"]
    end
```
...
```mermaid
flowchart TD
    subgraph RitmeIntelektual24Jam["RITME LITERASI & RISET SANTRI 24 JAM"]
        Pagi["07.00 - 12.00: Pembelajaran Kelas Madrasah Berbasis Inkuiri & Analisis Teks."]
        Sore["14.00 - 15.30: Sesi Riset Maktabah Digital & Penulisan Karya Tulis Ilmiah (KTI)."]
        MalamA["19.30 - 20.30: Halaqah Bahtsul Masail Dialogis & Debat Ilmiah Beradab."]
        MalamB["20.30 - 21.00: Membaca Senyap Mandiri di Kamar Tidur (Silent Reading 30 Menit)."]
        
        Pagi --> Sore --> MalamA --> MalamB --> Pagi
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiKTI["PROTOKOL PENDAMPINGAN RISET TIER 2"]
        Step1["1. SESI DEKONSTRUKSI MASALAH DENGAN PEMBIMBING RISET<br/>• Membimbing santri membuat Peta Pikiran (Mind Mapping) gagasan utama."]
        
        Step2["2. PENULISAN BERTAHAP MIKRO (SCAFFOLDED WRITING)<br/>• Menargetkan penulisan 1 paragraf per hari dengan struktur: Premis -> Dalil/Data -> Analisis."]
        
        Step3["3. PEER-REVIEW FEEDBACK BERSAMA KAKAK ASUH J4<br/>• Santri H berdiskusi dengan kakak asuh J4 yang telah berhasil mempublikasikan KTI."]
        
        Step4["4. FINALISASI & SIMULASI SIDANG MUNAQASYAH MINI<br/>• Santri H mempresentasikan draf KTI di forum halaqah kecil dan memperoleh penguatan positif."]
...
```mermaid
flowchart TD
    subgraph StrukturTargetCPMF["STRUKTUR TARGET CAPAIAN PEMBELAJARAN (CP-MF)"]
        CP["CAPAIAN PEMBELAJARAN INDUK MUTSAQQAFUL FIKR"]
        
        T1["Target Pilar 1: Turats & Wahyu<br/>• Penguasaan Kaidah Ushul Fiqh & Maqashid.<br/>• Analisis Perbandingan Mazhab."]
        
        T2["Target Pilar 2: Logika & Nalar Kritis<br/>• Bebas dari 10 Sesat Pikir (Fallacy).<br/>• Keterampilan Pemecahan Masalah HOTS."]
        
        T3["Target Pilar 3: Sains & Riset KTI<br/>• Penulisan 1 Monograf KTI Mandiri.<br/>• Literasi Metode Ilmiah & Statistik."]
        
        T4["Target Pilar 4: Literasi Digital<br/>• Kemahiran Cek Fakta & Tabayyun Siber.<br/>• Produksi Konten Dakwah Ilmiah."]
...
```mermaid
flowchart LR
    subgraph TargetProgresiIntelektual["PETA TARGET CAPAIAN INTELEKTUAL J1–J4"]
        J1["J1 (KELAS 7): LITERASI DASAR & METAKOGNISI<br/>Target: Membaca 20 buku/thn, ringkasan peta konsep, membedakan fakta vs opini."]
        --> J2["J2 (KELAS 8–9): LOGIKA MANTIQ & ANALISIS DALIL<br/>Target: Deteksi logical fallacy, studi perbandingan dalil, esai kritis 5 halaman."]
        --> J3["J3 (KELAS 10–11): RISET ILMIAH & KTI MANDIRI<br/>Target: Penulisan KTI 20 halaman terstandarisasi, Bahtsul Masail isu modern."]
        --> J4["J4 (KELAS 12): SINTESIS PERADABAN & QUDWAH FIKR<br/>Target: Publikasi artikel ilmiah, instruktur kajian junior, orasi pemikiran Islam."]
    end
```
...
| :--- | :--- | :--- |
| **Jenjang J1 (Kelas 7)** | • Menguasai kaidah dasar nahwu-sharaf matan *Jurumiyyah*.<br/>• Memahami peta konsep kitab fikih ibadah dasar.<br/>• Mampu membuat ringkasan logis dari teks yang dibaca. | • Membaca minimal 2 buku non-pelajaran per bulan.<br/>• Menulis resensi buku 500 kata dengan bahasa yang rapi.<br/>• Menerapkan adab tabayyun dalam bermedia digital. |
| **Jenjang J2 (Kelas 8–9)** | • Menguasai kaidah ushul fiqh dasar (*Al-Waraqat*).<br/>• Mengidentifikasi 5 sesat pikir utama (*Ad Hominem, Strawman, dll*).<br/>• Berpartisipasi aktif dalam debat ilmiah terstruktur. | • Melakukan eksperimen sains madrasah dan menulis laporannya.<br/>• Menulis esai komparatif fikih/sains minimal 1.500 kata.<br/>• Mampu memverifikasi keaslian berita digital (Cek Fakta). |
| **Jenjang J3 (Kelas 10–11)** | • Memahami Maqashid Syari'ah dan kaidah fikih (*Al-Qawa'id al-Fiqhiyyah*).<br/>• Menganalisis perbedaan dalil mazhab dalam *Bidayatul Mujtahid*.<br/>• Menjadi juru bicara dalam sidang Bahtsul Masail asrama. | • Menyusun Karya Tulis Ilmiah (KTI) metodologis $\ge 20\text{ halaman}$.<br/>• Menguasai perangkat lunak sitasi ilmiah (Mendeley / Zotero).<br/>• Mengkaji jurnal ilmiah sains dan Turats digital secara mandiri. |
| **Jenjang J4 (Kelas 12)** | • Menguasai sintesis multidisipliner (Turats, Sains, Filsafat).<br/>• Mampu merumuskan solusi fikih atas masalah sosial modern.<br/>• Menampilkan kerendahan hati intelektual (*Intellectual Humility*). | • Mempublikasikan artikel ilmiah di jurnal santri / media massa.<br/>• Menjadi mentor riset dan pembimbing halaqah santri J1.<br/>• Menyampaikan orasi ilmiah kelulusan yang menggugah nalar umat. |
...
Penerapan konsep **P3-08-03: TUJUAN DAN TARGET CAPAIAN MUTSAQQAFUL FIKR** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
