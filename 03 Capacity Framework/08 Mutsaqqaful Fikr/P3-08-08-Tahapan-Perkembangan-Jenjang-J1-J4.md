...
```mermaid
flowchart TD
    subgraph TransformasiTrajektoriKognitif["REKONSTRUKSI TRAJEKTORI PERKEMBANGAN INTELEKTUAL"]
        Ekstrem["PENGACAUAN PENTAHAPAN KOGNITIF (TRADISIONAL)<br/>• Kelas 7 dipaksa hafal debat ushul abstrak tanpa analogi.<br/>• Kelas 12 masih disuruh hafalan pasif tanpa riset mandiri.<br/>• Akibat: Trauma akademik & stagnasi nalar kritis santri."]
        
        TUMBUH["TRAJEKTORI NALAR FITRAH J1–J4 TUMBUH<br/>• J1 (Konkret & Peta Konsep) -> J2 (Logika & Mantiq).<br/>• J3 (Riset KTI & Metodologi) -> J4 (Sintesis Hikmah & Qudwah).<br/>• Selaras dengan maturasi Prefrontal Cortex & ZPD Vygotsky."]
        
        Ekstrem ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsTadrijTalim["PENTAHAPAN PENGAJARAN DALAM TURATS"]
        IbnuKhaldun["Ibnu Khaldun (Muqaddimah):<br/>اعْلَمْ أَنَّ تَلْقِينَ الْعُلُومِ لِلْمُتَعَلِّمِينَ إِنَّمَا يَكُونُ مُفِيدًا إِذَا كَانَ عَلَى التَّدْرِيجِ شَيْئًا فَشَيْئًا<br/>(Pengajaran Ilmu Hanya Bermanfaat Jika Dilakukan Bertahap 3 Putaran)"] --> Inti["At-Tadrij fit-Ta'lim:<br/>Menyelaraskan Materi Ilmu dengan Kapasitas Akal Santri"]
        Ghazali["Al-Ghazali (Ihya'):<br/>Jangan Mengajarkan Masalah Rumit Sebelum Menguasai Dasar"] --> Inti
        Zarnuji["Az-Zarnuji (Ta'lim):<br/>Memulai Kitab dari yang Ringkas Menuju yang Tebal"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph NeurosainsKognisiRemaja["INTEGRASI SAINS PERKEMBANGAN & NEUROSAINS"]
        Piaget["Jean Piaget: Transisi Operasional Konkret (11–12 Thn) Menuju Operasional Formal (13–18 Thn / Nalar Hipotetis-Deduktif)."]
        
        Vygotsky["Lev Vygotsky: Zone of Proximal Development (ZPD) & Scaffolding Bimbingan Pendidik/Kakak Asuh."]
        
        PFC["Neurosains Prefrontal Cortex: Myelinisasi & Synaptic Pruning di Lobus Frontal Berlangsung Hingga Usia 20 Tahun (Executive Function)."]
        
        Piaget & Vygotsky & PFC ==> TrajektoriTUMBUH["TRAJEKTORI NALAR FITRAH J1–J4"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaKurikulumJ1J4["REKAYASA KURIKULUM BERBASIS FASE KOGNITIF"]
        KurikulumJ1["J1: 80% Penguasaan Konsep Konkret, Gramatika Dasar, & Budaya Membaca 20 Buku."]
        KurikulumJ2["J2: 60% Analisis Dalil, Logika Mantiq, Studi Perbandingan, & Esai Ilmiah 1.500 Kata."]
        KurikulumJ3["J3: 70% Riset Inkuiri Mandiri, Penulisan Monograf KTI 20 Halaman, & Bahtsul Masail."]
        KurikulumJ4["J4: 80% Sintesis Hikmah Multidisipliner, Sidang Munaqasyah, & Mentorship Riset Junior."]
...
```mermaid
flowchart TD
    subgraph ProtokolScaffoldingNahwu["PROTOKOL PENDAMPINGAN GRAMATIKA VISUAL TIER 2"]
        StepA["1. PENGGUNAAN KARTU WARNA 'I'RAB (COLOR-CODED SYNTAX MATRIX)<br/>• Ustadz membuat kartu belajar: Rafa' (Warna Biru / Subjek), Nashab (Warna Merah / Objek), Khafadh (Warna Hijau)."]
        
        StepB["2. PERMAINAN BONGKAR PASANG KALIMAT (SYNTACTIC PUZZLE)<br/>• Santri S menyusun kalimat nyata menggunakan kartu warna tersebut secara gembira."]
        
        StepC["3. SESI TUTORIAL SEBAYA BERSAMA KAKAK ASUH J4 (PEER SCAFFOLDING)<br/>• Santri S didampingi kakak asuh J4 yang mengajarinya dengan analogi sederhana 15 menit harian."]
        
        StepD["4. EVALUASI FORMATIF KEBERHASILAN MEMBACA KITAB GUNDUL<br/>• Santri S mampu membaca teks tanpa harakat dengan logika warna yang telah terinternalisasi."]
...
```mermaid
flowchart TD
    subgraph ArsitekturTrajektoriIntelektualJ1J4["TRAJEKTORI PERKEMBANGAN INTELEKTUAL LENGKAP J1–J4"]
        J1["JENJANG J1: FASE LITERASI DASAR & PETA KONSEP KONKRET (KELAS 7)<br/>• Karakteristik: Transisi nalar konkret, pembiasaan membaca, gramatika dasar.<br/>• Target: Membaca 20 buku/thn, ringkasan logis, adab tabayyun, paham nahwu-sharaf dasar."]
        
        J2["JENJANG J2: FASE LOGIKA MANTIQ & ANALISIS DALIL (KELAS 8–9)<br/>• Karakteristik: Awal nalar formal operasional, kritis bertanya, senang berargumen.<br/>• Target: Deteksi logical fallacy, studi perbandingan dalil, esai ilmiah 1.500 kata, debat santun."]
        
        J3["JENJANG J3: FASE RISET METODOLOGIS & KTI MANDIRI (KELAS 10–11)<br/>• Karakteristik: Maturasi nalar analitis-sistematis, literasi digital riset tinggi.<br/>• Target: Monograf KTI 20 halaman terstandarisasi APA 7th, Bahtsul Masail modern, aplikasi Mendeley."]
        
        J4["JENJANG J4: FASE SINTESIS PERADABAN & QUDWAH FIKR (KELAS 12)<br/>• Karakteristik: Kematangan fungsi eksekutif, sintesis hikmah multidisipliner.<br/>• Target: Sidang Munaqasyah KTI, publikasi artikel jurnal, mentor riset junior, orasi pemikiran."]
...
```mermaid
flowchart TD
    subgraph RitesOfPassageIntelektual["RANGKAIAN INISIASI RISET KELULUSAN (J4)"]
        TahapI["1. SIDANG MUNAQASYAH KTI TERBUKA (OPEN THESIS DEFENSE)<br/>• Santri J4 mempresentasikan & mempertahankan risetnya di hadapan Dewan Penguji Pakar."]
        
        TahapII["2. PROSESI PENYERAHAN MONOGRAF KE PERPUSTAKAAN (LIBRARY ARCHIVING)<br/>• Naskah KTI yang lulus diarsipkan secara digital & fisik di perpustakaan sebagai warisan keilmuan."]
        
        TahapIII["3. ORASI ILMIAH KELULUSAN DI HADAPAN WALI SANTRI (COMMENCEMENT SPEECH)<br/>• Perwakilan santri menyampaikan pidato pemikiran peradaban Islam di wisuda kelulusan."]
        
        TahapIV["4. PEMBERIAN MANDAT 'DUTA LITERASI PERADABAN'<br/>• Pimpinan pesantren menyematkan tanda kelulusan intelektual & doa keberkahan ilmu."]
