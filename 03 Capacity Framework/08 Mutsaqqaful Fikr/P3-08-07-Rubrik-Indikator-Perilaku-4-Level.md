...
```mermaid
flowchart TD
    subgraph TransformasiRubrikIntelektual["REKONSTRUKSI SISTEM ASESMEN KOGNITIF"]
        Tradisional["PENILAIAN TUNGGAL PILIHAN GANDA<br/>• Hanya menguji ingatan dangkal (C1-C2).<br/>• Mengabaikan nalar mantiq, riset KTI, & adab ikhtilaf.<br/>• Umpan balik angka mati tanpa panduan perbaikan."]
        
        TUMBUH["RUBRIK 4-LEVEL MUTSAQQAFUL FIKR TUMBUH<br/>• Deskriptor kriteria terperinci 4 pilar (Turats, Nalar, Sains, Digital).<br/>• Evaluasi formatif otentik (KTI, Sidang Munaqasyah, Bahtsul Masail).<br/>• Uji reliabilitas Cohen's Kappa & penilaian pertumbuhan ipsatif."]
...
```mermaid
flowchart LR
    subgraph TuratsMizanFikr["TIMBANGAN NALAR DALAM TURATS"]
        Ghazali["Al-Ghazali (Mi'yarul 'Ilm):<br/>Mantiq Sebagai Timbangan Standar Menguji Kebenaran Berpikir (Mi'yar)"] --> Inti["Al-Mizan fil Fikr:<br/>Rubrik Penilaian Nalar yang Presisi, Adil, & Bebas Sesat Pikir"]
        Syathibi["Asy-Syathibi (Muwafaqat):<br/>Pengujian Kekuatan Dalil Berdasarkan Induksi Ma'nawi"] --> Inti
        Jurjani["Al-Jurjani (At-Ta'rifat):<br/>Standar Definisi Jami' Mani' (Presisi & Komprehensif)"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPsikometriIntelektual["STANDAR PSIKOMETRI RUBRIK MUTSAQQAFUL FIKR"]
        IRR["Inter-Rater Reliability (Cohen's Kappa & ICC):<br/>• Kesepakatan penilaian antar-dewan penguji KTI >= 88%.<br/>• Kalibrasi interpretasi deskriptor nalar kritis."]
        
        RubricDesign["Analytical & Holistic Rubric Design (Brookhart, 2018):<br/>• Kriteria kualitatif deskriptif berbasis bukti unjuk kerja nyata."]
        
        Authentic["Authentic Task Evaluation (Wiggins, 1998):<br/>• Pengujian kemampuan nalar dalam konteks nyata (Sidang KTI, Bahtsul Masail)."]
        
        IRR & RubricDesign & Authentic ==> RubrikStandar["RUBRIK MUTSAQQAFUL FIKR TERVALIDASI"]
    end
```
...
```mermaid
flowchart TD
    subgraph SistemAsesmenIntelektual24Jam["INTEGRASI DATA ASESMEN INTELEKTUAL 24 JAM"]
        DataGuru["1. GURU MADRASAH: Nilai Ujian Analisis HOTS, Pemahaman Nahwu-Sharaf, & Sains."]
        DataMusyrif["2. MUSYRIF HALAQAH: Observasi Adab Bahtsul Masail, Logbook Membaca 20 Buku, & Nalar Kritis."]
        DataDewanRiset["3. DEWAN RISET KTI: Penilaian Monograf KTI, Uji Similaritas Anti-Plagiasi, & Sidang Munaqasyah."]
        DataSantri["4. SANTRI MANDIRI: Jurnal Muhasabah Metakognisi & Resensi Buku Harian."]
        
        DataGuru & DataMusyrif & DataDewanRiset & DataSantri ==> Dashboard["DASHBOARD INTELEKTUAL SANTRI (FIKR-TUMBUH)"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRekonsiliasiIntelektual["PROTOKOL REKONSILIASI KOGNITIF-ADAB TIER 3"]
        P1["1. PEMBATALAN HASIL DRAF KTI LAMA & STATUS REMEDIAL RISET<br/>• Dewan Riset membatalkan naskah plagiat & menunda kelulusan riset Santri T."]
        
        P2["2. KAJIAN MENDALAM TAZKIYATUN NAFS & ADABUL 'ILM<br/>• Musyrif membimbing Santri T membedah kitab Ta'limul Muta'allim mengenai bahaya riya' & curang."]
        
        P3["3. BENGKEL PENULISAN RISET MANDIRI INTENSIF (4 PEKAN)<br/>• Santri T dilatih menyusun argumen dari data primer di bawah supervisi harian pembimbing."]
        
        P4["4. SIDANG ULANG MUNAQASYAH & PENETAPAN SKOR IPSATIF<br/>• Santri T berhasil mempertahankan KTI orisinal (Similaritas 7%) & predikat integritasnya pulih."]
...
```mermaid
flowchart TD
    subgraph ArsitekturRubrik4LevelIntelektual["EMPAT TINGKAT KEMATANGAN MUTSAQQAFUL FIKR"]
        L1["LEVEL 1: PERINTISAN (EMERGING / PERLU BANTUAN)<br/>• Belum mandiri membaca; hafalan teks kaku tanpa pemahaman nalar.<br/>• Pasif dalam diskusi & rentan terpengaruh informasi hoaks."]
        
        L2["LEVEL 2: PEMBIASAAN (DEVELOPING / REGULASI NALAR AWAL)<br/>• Mampu menganalisis dalil terstruktur; mendeteksi sesat pikir sederhana.<br/>• Membaca rutin di asrama; menerapkan adab tabayyun dalam bermedia."]
        
        L3["LEVEL 3: PEMANTAPAN (PROFICIENT / KRITIS & RISET MANDIRI)<br/>• Mampu menyusun Karya Tulis Ilmiah (KTI) metodologis bebas plagiasi.<br/>• Menguasai logika mantiq, perbandingan dalil mazhab, & literasi digital."]
        
        L4["LEVEL 4: KETELADANAN (EXEMPLARY / QUDWAH INTELEKTUAL)<br/>• Mampu melakukan sintesis hikmah peradaban & solusi masalah umat.<br/>• Menjadi mentor riset adik kelas, produktif menulis, & tawadhu' ilmiah."]
...
Penerapan konsep **P3-08-07: RUBRIK INDIKATOR PERILAKU 4-LEVEL MUTSAQQAFUL FIKR** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
...
[^5]: Standar formula indeks karakter intelektual dan kelayakan munaqasyah KTI santri dalam sistem TUMBUH (2026).  
