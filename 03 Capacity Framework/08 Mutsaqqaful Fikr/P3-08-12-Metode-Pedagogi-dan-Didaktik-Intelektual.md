...
```mermaid
flowchart TD
    subgraph TransformasiDidaktikIntelektual["REKONSTRUKSI DIDAKTIK PEMBELAJARAN PESANTREN"]
        Pasif["DIDAKTIK DIKTE PASIF (TRADISIONAL)<br/>• Guru mendiktekan harakat 1 arah (Maknani).<br/>• Santri pasif mencatat tanpa pemahaman nalar dalil.<br/>• Pembelajaran terisolasi dari problem riil umat."]
        
        TUMBUH["EMPAT MODEL DIDAKTIK INKUIRI TUMBUH<br/>• Problem-Based Learning (PBL) berbasis isu kontemporer.<br/>• Socratic Dialogue membedah premis & logika mantiq.<br/>• Scaffolded Writing menghasilkan Monograf KTI Mandiri.<br/>• Guru sebagai Fasilitator Inkuiri; santri pembelajar aktif."]
...
```mermaid
flowchart LR
    subgraph TuratsDidaktikNabawi["DIDAKTIK DIALOGIS DALAM SUNNAH"]
        HaditsPohon["HR. Al-Bukhari No. 61 (Hadits Pohon Kurma):<br/>إِنَّ مِنَ الشَّجَرِ شَجَرَةً لَا يَسْقُطُ وَرَقُهَا، وَإِنَّهَا مَثَلُ الْمُسْلِمِ، فَحَدِّثُونِي مَا هِيَ؟<br/>(Nabi Memantik Nalar Sahabat Melalui Teka-Teki Logika Analogi)"] --> Inti["Pedagogi Mutsaqqaful Fikr:<br/>Memantik Nalar Santri Melalui Pertanyaan Reflektif"]
        IbnuAbbas["Ibnu Abbas RA:<br/>بِمَ نِلْتَ الْعِلْمَ؟ قَالَ: بِلِسَانٍ سَئُولٍ وَقَلْبٍ عَقُولٍ<br/>(Ilmu Diraih Melalui Lisan yang Kritis Bertanya & Hati yang Menalar)"] --> Inti
        Ghazali["Al-Ghazali (Fatihah):<br/>Mengajar Hakikatnya Adalah Menumbuhkan Daya Pikir Murid"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsDidaktikModern["SINTESIS DIDAKTIK KOGNITIF MODERN"]
        PBL["Problem-Based Learning (Howard Barrows, 1996):<br/>• Pembelajaran diawali dengan masalah riil tak terstruktur (Ill-Structured Problem).<br/>• Santri aktif meriset dalil & data untuk menemukan solusi."]
        
        Socratic["Socratic Questioning (Paul & Elder, 2019):<br/>• 6 Kategori Pertanyaan: Klarifikasi, Asumsi, Alasan/Bukti, Sudut Pandang, Implikasi, & Pertanyaan tentang Pertanyaan."]
        
        Scaffolding["Scaffolded Writing (Vygotsky / Bruner):<br/>• Penulisan karya ilmiah bertahap dari peta konsep hingga naskah utuh."]
        
        PBL & Socratic & Scaffolding ==> DidaktikTUMBUH["DIDAKTIK INTELEKTUAL PARIPURNA"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaKelasInkuiri["SETTING KELAS INKUIRI MADRASAH"]
        Meja["1. FORMASI MEJA KELOMPOK (CLUSTER SEATING): Meja disusun berkelompok 4–5 santri untuk kolaborasi riset."]
        Whiteboard["2. MULTI-WHITEBOARD PER KELOMPOK: Setiap kelompok memiliki papan tulis kecil untuk merancang peta argumen."]
        AksesRiset["3. SUDUT MAKTABAH KELAS: Rak berisi kitab kamus (*Al-Munawwir*, *Lisanul Arab*) & ensiklopedia sains."]
        
        Meja & Whiteboard & AksesRiset ==> BudayaInkuiri["KELAS AKTIF HOTS & DIALEKTIKA"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolPelatihanGuru["PROTOKOL TRANSFORMASI DIDAKTIK MASTER GURU"]
        Modul1["1. WORKSHOP 'THE ART OF SOCRATIC QUESTIONING' (2 HARI)<br/>• Ustadz K dilatih 6 jenis pertanyaan pemantik nalar kritis."]
        
        Modul2["2. SIMULASI MICRO-TEACHING MODEL PROBLEM-BASED LEARNING (PBL)<br/>• Ustadz K mempraktikkan pengajaran bab zakat dengan studi kasus riil kemiskinan kota."]
        
        Modul3["3. PENDAMPINGAN PEER-COACHING DI DALAM KELAS (3 SESI)<br/>• Master Teacher mendampingi Ustadz K di kelas & memberi umpan balik langsung."]
        
        Modul4["4. EVALUASI FORMATIF KEPUASAN BELAJAR SANTRI<br/>• Partisipasi aktif santri melonjak ke 95%; kelas fiqih menjadi mata pelajaran paling dinanti."]
...
```mermaid
flowchart TD
    subgraph EmpatModelDidaktikIntelektual["EMPAT MODEL DIDAKTIK MUTSAQQAFUL FIKR"]
        M1["MODEL 1: INQUIRY-BASED TURATS LEARNING (INKUIRI TEKS WAHYU)<br/>• Santri menganalisis 'illat hukum & asbabun nuzul sebelum membaca syarah kitab.<br/>• Menghubungkan kaidah ushul fiqh dengan ayat-ayat kauniyyah."]
        
        M2["MODEL 2: SOCRATIC DIALOGUE & APPLIED LOGIC (DIALOG SOKRATIK & MANTIQ)<br/>• Membedah teks melalui pertanyaan dialektis mendalam.<br/>• Melatih santri menyusun silogisme mantiq & mendeteksi sesat pikir."]
        
        M3["MODEL 3: PROBLEM-BASED LEARNING (PBL FIQIH SOSIAL & SAINS)<br/>• Pembelajaran diawali dengan studi kasus riil (AI, lingkungan, uang digital).<br/>• Santri bekerja kelompok meriset dalil & merumuskan rekomendasi fatwa."]
        
        M4["MODEL 4: SCAFFOLDED THESIS WRITING (PENULISAN RISET KTI MANDIRI)<br/>• Penulisan KTI bertahap: Mind Map -> Rumusan Masalah -> Literatur -> Naskah.<br/>• Bimbingan intensif metodologi terstandarisasi APA 7th & Turnitin."]
        
        M1 & M2 & M3 & M4 ==> PendidikParipurna["PEMBELAJARAN NALAR FITRAH BERKUALITAS"]
    end
```
...
Penerapan konsep **P3-08-12: METODE PEDAGOGI DAN DIDAKTIK INTELEKTUAL MUTSAQQAFUL FIKR** di ekosistem pesantren TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
