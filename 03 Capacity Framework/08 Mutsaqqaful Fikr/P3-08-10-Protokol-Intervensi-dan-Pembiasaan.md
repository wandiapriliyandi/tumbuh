...
```mermaid
flowchart TD
    subgraph TransformasiIntervensiIntelektual["REKONSTRUKSI SISTEM INTERVENSI KOGNITIF"]
        HukumanVerbal["PARADIGMA HUKUMAN & LABELING VERBAL (TRADISIONAL)<br/>• Santri lambat dicap bebal & dihukum berdiri di depan kelas.<br/>• Memicu trauma akademik, minder, & learned helplessness.<br/>• Masalah nalar kritis & kesulitan baca kitab tetap tidak selesai."]
        
        TUMBUH["ARSITEKTUR MULTI-TIER PBIS TUMBUH<br/>• Tier 1: Promosi literasi 100% santri & budaya inkuiri HOTS.<br/>• Tier 2: Klinik Metakognisi & Scaffolding bimbingan KTI.<br/>• Tier 3: Dialog restoratif integritas akademik & ILP adaptif.<br/>• 0% kekerasan verbal; penegakan disiplin ilmiah firm & kind."]
        
        HukumanVerbal ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsKasihSayangPendidik["PRINSIP KELEMBUTAN DIDAKTIK NABAWI"]
        HaditsMuawiyah["HR. Muslim No. 537 (Kisah Mu'awiyah bin Al-Hakam):<br/>مَا رَأَيْتُ مُعَلِّمًا قَبْلَهُ وَلَا بَعْدَهُ أَحْسَنَ تَعْلِيمًا مِنْهُ؛ فَوَاللَّهِ مَا كَهَرَنِي وَلَا ضَرَبَنِي وَلَا شَتَمَنِي<br/>(Demi Allah, Nabi Tidak Membentakku, Tidak Memukulku, & Tidak Mencelaku!)"] --> Inti["Ar-Rifq fit-Ta'lim:<br/>Membimbing Akal Santri dengan Kasih Sayang & Kesabaran"]
        Zarnuji["Az-Zarnuji (Ta'limul Muta'allim):<br/>Guru Wajib Menyayangi Murid Seperti Menyayangi Anak Sendiri"] --> Inti
        Mawardi["Al-Mawardi (Adab Dunya):<br/>Kelemahlembutan Membuka Pintu Akal yang Tertutup"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph PiramidaPBISIntelektual["PIRAMIDA PBIS MULTI-TIER MUTSAQQAFUL FIKR"]
        T1["TIER 1: UNIVERSAL INTELLECTUAL PROMOTION (80–90% Santri)<br/>• Kelas Inkuiri Berbasis HOTS & Budaya Bertanya Terbuka.<br/>• Pojok Literasi Kamar Tidur 24 Jam & Silent Reading 20 Menit.<br/>• Rasio Apresiasi Positif 4:1 bagi Santri Penanya Kritis & Peresensi Buku."]
        
        T2["TIER 2: TARGETED COGNITIVE INTERVENTION (10–15% Santri)<br/>• Klinik Metakognisi & Bimbingan Belajar Adaptif.<br/>• Scaffolding Penulisan KTI bagi Santri Mengalami Writer's Block.<br/>• Peer Tutoring (Tutorial Sebaya) bersama Santri Jenjang J4."]
        
        T3["TIER 3: INTENSIVE INTELLECTUAL RESTORATION (1–5% Santri)<br/>• Rencana Pembelajaran Terindividualisasi (Individualized Learning Plan / ILP).<br/>• Dialog Restoratif Kasus Plagiarisme / Joki Tugas.<br/>• Konseling Kognitif Khusus Kasus Hambatan Belajar Berat / Disleksia."]
...
```mermaid
flowchart TD
    subgraph RekayasaFasilitasLiterat["REKAYASA FASILITAS LITERASI ASRAMA"]
        F1["1. POJOK BACA KAMAR: Rak buku kamar tidur bervariasi dengan lampu baca ergonomis."]
        F2["2. MAKTABAH DIGITAL: Akses komputer khusus riset Turats digital & jurnal ilmiah terakreditasi."]
        F3["3. RUANG DISKUSI DIALEKTIKA: Meja bundar untuk forum Bahtsul Masail & debat ilmiah."]
        F4["4. MADING LITERASI: Papan apresiasi esai santri terbaik mingguan & infografis anti-hoaks."]
        
        F1 & F2 & F3 & F4 ==> Sukses["KULTUR BI'AH 'ILMIYYAH PESANTREN"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolPenumbuhanKeberanian["PROTOKOL PENDAMPINGAN INKUIRI TIER 2"]
        StepA["1. TEKNIK KOTAK PERTANYAAN ANONIM (ANONYMOUS QUESTION BOX)<br/>• Musyrif menyediakan kotak di kamar di mana santri bebas memasukkan pertanyaan tertulis tanpa nama."]
        
        StepB["2. APRESIASI SETIAP PERTANYAAN DI FORUM KELAS<br/>• Guru madrasah membacakan pertanyaan Santri N & memujinya: 'Ini pertanyaan luar biasa cerdas!'"]
        
        StepC["3. METODE THINK-PAIR-SHARE DALAM KELOMPOK KECIL<br/>• Santri N dilatih berdiskusi dengan 1 teman akrab sebelum berbicara di depan kelas besar."]
        
        StepD["4. PEMBERIAN 'PENGHARGAAN PENANYA PALING KRITIS'<br/>• Santri N berani mengacungkan tangan langsung & rasa takutnya hilang total dalam 4 pekan."]
...
```mermaid
flowchart TD
    subgraph TigaLapisPBISIntelektual["SISTEM TIGA LAPIS INTERVENSI PBIS MUTSAQQAFUL FIKR"]
        subgraph TIER1["TIER 1: PENCEGAHAN UNIVERSAL (100% SANTRI)"]
            T1A["• Budaya Kelas Inkuiri & Socratic Dialogue."]
            T1B["• Silent Reading 20 Menit di Kamar Tidur."]
            T1C["• Bahtsul Masail Dialogis & Adab Ikhtilaf."]
            T1D["• Apresiasi 4:1 Santri Pembaca Buku Terbaik."]
        end
        
        subgraph TIER2["TIER 2: INTERVENSI TERARAH (10–15% SANTRI BERISIKO)"]
            T2A["• Klinik Metakognisi & Bimbingan Belajar Adaptif."]
            T2B["• Scaffolding Penulisan KTI (Mind Mapping & Draf Mikro)."]
            T2C["• Tutorial Sebaya (Peer Scaffolding) bersama Santri J4."]
            T2D["• Workshop Verifikasi Fakta & Literasi Digital Terpandu."]
        end
        
        subgraph TIER3["TIER 3: RESTORASI INTENSIF & MEDIS (1–5% SANTRI KRISIS)"]
            T3A["• Dialog Restoratif Kasus Plagiarisme / Joki Tugas."]
            T3B["• Individualized Learning Plan (ILP) Psikolog Pendidikan."]
            T3C["• De-radikalisasi Nalar bagi Santri Terpapar Pemikiran Ekstrem."]
            T3D["• Remedial Intensif Munaqasyah KTI di Bawah Dewan Pakar."]
        end
...
| :--- | :--- | :--- | :--- | :--- |
| **Tier 1 (Universal)** | 100% Seluruh Santri Pondok | • Penyediaan pojok baca kamar & buku bermutu.<br/>• Penguatan positif rasio 4:1 (apresiasi pertanyaan kritis).<br/>• Jam membaca senyap harian 20 menit sebelum tidur.<br/>• Forum Bahtsul Masail mingguan di asrama. | Harian & Berkelanjutan sepanjang tahun | Seluruh Guru Madrasah, Musyrif Asrama, & Pustakawan |
| **Tier 2 (Targeted)** | 10–15% Santri yang mengalami kesulitan nalar, writer's block, atau defisit membaca | • Klinik Metakognisi (diagnosis hambatan belajar).<br/>• Bimbingan penulisan KTI terpandu draf mikro.<br/>• Scaffolding nahwu visual & analogi konkret.<br/>• Tutorial membaca bersama kakak asuh J4. | 4–8 Pekan (Evaluasi tiap pekan) | Guru Pembimbing Riset, Musyrif Khusus, & Tutor Sebaya J4 |
| **Tier 3 (Intensive)** | 1–5% Santri yang melakukan kecurangan akademik berat (plagiasi) atau hambatan nalar ekstrem | • Sidang Mediasi Restoratif Integritas Akademik.<br/>• Penyusunan Rencana Pembelajaran Individual (ILP).<br/>• Dialog pemulihan akidah bagi santri terpapar paham menyimpang.<br/>• Penulisan ulang karya ilmiah di bawah supervisi langsung. | 4–12 Pekan (Hingga tuntas teruji) | Dewan Pengawas Akademik, Psikolog Pendidikan, & Pimpinan Pondok |
...
Penerapan konsep **P3-08-10: PROTOKOL INTERVENSI DAN PEMBIASAAN MUTSAQQAFUL FIKR** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
