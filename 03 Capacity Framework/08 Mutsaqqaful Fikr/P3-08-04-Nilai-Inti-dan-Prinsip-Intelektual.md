...
```mermaid
flowchart TD
    subgraph RekonstruksiAksiologiIntelektual["REKONSTRUKSI NILAI INTELEKTUAL PESANTREN"]
        Krisis["KRISIS AKSIOLOGI TRADISIONAL<br/>• Plagiarisme digital & menyontek dinormalisasi.<br/>• Fanatisme buta mazhab & gemar mendebat kusir.<br/>• Terjebak skeptisisme nihilistik tanpa pedoman wahyu."]
        
        TUMBUH["AKSIOLOGI MUTSAQQAFUL FIKR TUMBUH<br/>• Taharril Haqq: Pencarian kebenaran sejati tanpa bias.<br/>• Al-Inshaf: Keadilan logika & lapang dada pada perbedaan.<br/>• Amanah Ilmiyyah: Integritas akademik & anti-plagiasi 100%.<br/>• Al-Hikmah: Ilmu untuk kemaslahatan & khidmah peradaban."]
...
```mermaid
flowchart LR
    subgraph EmpatAkarNilaiIntelektual["EMPAT AKAR NILAI TURATS MUTSAQQAFUL FIKR"]
        N1["1. TAHARRIL HAQQ (QS. Al-Isra': 36)<br/>وَلَا تَقْفُ مَا لَيْسَ لَكَ بِهِ عِلْمٌ<br/>(Larangan Mengikuti Sesuatu Tanpa Bukti Ilmu)"]
        N2["2. AL-INSHAF (Prinsip Imam Syafi'i):<br/>مَا نَاظَرْتُ أَحَدًا إِلَّا وَدِدْتُ أَنَّ اللَّهَ يُظْهِرُ الْحَقَّ عَلَى لِسَانِهِ<br/>(Harapan Kebenaran Terbit dari Lisan Lawan Debat)"]
        N3["3. AL-AMANAH (Ibnu Abdil Barr):<br/>بَرَكَةُ الْعِلْمِ عَزْوُهُ إِلَى قَائِلِهِ<br/>(Berkah Ilmu Terletak pada Penisbatan Kepada Pemiliknya)"]
        N4["4. AL-HIKMAH (HR. At-Tirmidzi No. 2687):<br/>الْكَلِمَةُ الْحِكْمَةُ ضَالَّةُ الْمُؤْمِنِ<br/>(Hikmah Adalah Harta Berharga Mukmin yang Hilang)"]
        
        N1 & N2 & N3 & N4 --> Puncak["MUTSAQQAFUL FIKR PARIPURNA"]
    end
```
...
```mermaid
flowchart TD
    subgraph SainsKebajikanIntelektual["SINTESIS VIRTUE EPISTEMOLOGY & INTEGRITAS RISET"]
        Virtues["Intellectual Virtues (Baehr, 2011):<br/>• Intellectual Humility (Kerendahan Hati Intelektual)<br/>• Intellectual Courage (Keberanian Menguji Asumsi)<br/>• Intellectual Empathy (Memahami Sudut Pandang Lain)<br/>• Intellectual Integrity (Konsistensi Etika Kebenaran)"]
        
        Ethics["International Research Ethics (COPE / APA):<br/>• Zero Plagiarism & Rigorous Attribution.<br/>• Data Transparency & Peer Review Accountability."]
        
        Virtues & Ethics ==> BudayaRiset["BUDAYA RISET BERADAB TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaIntegritasAkademik["SISTEM PENJAMINAN KEJUJURAN RISET ASRAMA"]
        Pemberitahuan["1. PEMBIASAAN ADAB SITASI SEJAK JENJANG J1:<br/>• Santri diajarkan cara mengutip kitab & buku secara terhormat."]
        
        PerantiLunak["2. PEMERIKSAAN UJI SIMILARITAS KARYA TULIS (TURNITIN / PLAGIARISM CHECKER):<br/>• Batas toleransi similaritas KTI santri maksimal 15%."]
        
        IkrarKejujuran["3. IKRAR INTEGRITAS AKADEMIK (HONOR CODE):<br/>• Penandatanganan pakta kejujuran sebelum ujian & penulisan riset."]
        
        Pemberitahuan --> PerantiLunak --> IkrarKejujuran ==> BebasPlagiasi["PESANTREN ZERO PLAGIARISM"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolResolusiPlagiarisme["PROTOKOL RESTORATIF INTEGRITAS AKADEMIK TIER 3"]
        Tindakan1["1. DIALOG RESTORATIF AKADEMIK (NON-PUNITIVE CONVERSATION)<br/>• Pembimbing riset berdialog empatik, membedah hadits 'Barakatul 'Ilmi 'Azwuhu ila Qa'ilih'."]
        
        Tindakan2["2. PENGAKUAN TULUS & PEMBATALAN DRAF KTI LAMA<br/>• Santri P mengakui kesalahannya & berkomitmen menulis ulang dari awal secara mandiri."]
        
        Tindakan3["3. BENGKEL TEKNIK PARAFRASE & SITASI ILMIAH (REMEDIAL CITATION)<br/>• Santri P dilatih teknik parafrase kalimat, sintesis gagasan, & penggunaan aplikasi Mendeley."]
        
        Tindakan4["4. PENULISAN ULANG KTI & UJI SIMILARITAS ULANG (< 10%)<br/>• KTI baru berhasil diselesaikan dengan hasil similaritas 8% (Orisinal Murni)."]
...
```mermaid
flowchart TD
    subgraph FormulasiEmpatNilaiIntelektual["STRUKTUR AKSIOLOGIS EMPAT NILAI MUTSAQQAFUL FIKR"]
        Haqq["1. TAHARRIL HAQQ (PENCARIAN KEBENARAN OBYEKTIF)<br/>• Cinta pada kebenaran di atas fanatisme golongan/mazhab.<br/>• Pembuktian dalil secara teliti, ilmiah, & objektif."]
        
        Inshaf["2. AL-INSHAF (KEADILAN NALAR & EMPATI INTELEKTUAL)<br/>• Menghargai argumen lawan debat secara proporsional.<br/>• Lapang dada mengakui kekeliruan nalar diri & menerima kritik."]
        
        Amanah["3. AL-AMANAH AL-'ILMIYYAH (INTEGRITAS AKADEMIK & SITASI)<br/>• Kejujuran mutlak dalam penulisan ilmiah & anti-plagiarisme.<br/>• Menyebutkan sanad sumber ilmu & menghindari manipulasi data."]
        
        Hikmah["4. AL-HIKMAH WAL MASLAHAH (KEMANFAATAN PERADABAN)<br/>• Mengorientasikan seluruh wawasan untuk kemaslahatan umat.<br/>• Menjaga adab lisan & menghindari perdebatan kusir nir-manfaat."]
        
        Haqq & Inshaf & Amanah & Hikmah ==> Mahkota["MUTSAQQAFUL FIKR PARIPURNA"]
    end
```
...
```mermaid
flowchart LR
    J1["J1 (KELAS 7)<br/>Integritas Belajar Dasar<br/>• Anti-menyontek mutlak<br/>• Menyebutkan sumber kutipan<br/>• Tabayyun sebelum bicara"]
    --> J2["J2 (KELAS 8–9)<br/>Keadilan Nalar (Inshaf)<br/>• Menghargai dalil mazhab lain<br/>• Menolak debat kusir<br/>• Mengakui kesalahan logika"]
    --> J3["J3 (KELAS 10–11)<br/>Integritas Riset & KTI<br/>• Penulisan KTI bebas plagiasi<br/>• Penguasaan standar APA 7th<br/>• Tawadhu' intelektual"]
    --> J4["J4 (KELAS 12)<br/>Kepemimpinan Hikmah<br/>• Solutif memecahkan masalah<br/>• Menjadi mentor riset junior<br/>• Duta keadaban intelektual"]
```
...
Penerapan konsep **P3-08-04: NILAI INTI DAN PRINSIP INTELEKTUAL MUTSAQQAFUL FIKR** di ekosistem pesantren TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
