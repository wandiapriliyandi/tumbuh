...
```mermaid
flowchart TD
    Core["KOMPENDIUM INDUK MUTSAQQAFUL FIKR (P3-08)"]
    
    subgraph FondasiTeoretis["FONDASI TEORETIS & AKSIOLOGI"]
        M01["P3-08-01: Filosofi & Landasan Turats"]
        M02["P3-08-02: Definisi & Konseptualisasi"]
        M03["P3-08-03: Tujuan & Target Capaian (CP-MF)"]
        M04["P3-08-04: Nilai Inti & Prinsip Intelektual"]
    end
    
    subgraph StandarisasiKognitif["STANDARISASI KOMPETENSI & PERILAKU"]
        M05["P3-08-05: Standar Kompetensi & Taksonomi"]
        M06["P3-08-06: Manifestasi Perilaku 5 Setting"]
        M07["P3-08-07: Rubrik 4-Level & Formula IK-MF"]
        M08["P3-08-08: Trajektori Perkembangan J1–J4"]
    end
    
    subgraph PraksisOperasional["PRAKSIS INTERVENSI & EVALUASI"]
        M09["P3-08-09: Triangulasi 360 Derajat & EWS"]
        M10["P3-08-10: SW-PBIS Multi-Tier & Klinik Metakognisi"]
        M11["P3-08-11: Silabus Halaqah Tematik 24 Pekan"]
        M12["P3-08-12: Empat Model Didaktik (PBL, Socratic)"]
        M13["P3-08-13: Paket Master Formulir Lapangan"]
        M14["P3-08-14: Sintesis, Uji CFA-SEM, & Stress-Test"]
    end
    
    Core --> FondasiTeoretis & StandarisasiKognitif & PraksisOperasional
```
...
```mermaid
flowchart TD
    subgraph EmpatPilarNalarFitrah["EMPAT PILAR DIMENSI MUTSAQQAFUL FIKR"]
        P1["PILAR 1: AL-MA'RIFAH AS-SYAR'IYYAH<br/>• Penguasaan Turats, Nahwu-Sharaf, & Ushul Fiqh.<br/>• Kajian Maqashid Syari'ah & Perbandingan Mazhab."]
        
        P2["PILAR 2: AT-TAFAKKUR AL-NAQDIY<br/>• Nalar Kritis, Logika Mantiq Silogisme, & HOTS.<br/>• Deteksi 10 Sesat Pikir (Logical Fallacies) & Metakognisi."]
        
        P3["PILAR 3: AL-LITERASIYAH AL-'ILMIYYAH<br/>• Literasi Sains Alam, Kosmologi, & Statistik Empiris.<br/>• Penulisan Monograf Karya Tulis Ilmiah (KTI) Mandiri."]
        
        P4["PILAR 4: AL-LITERASIYAH AR-RAQMIYYAH<br/>• Literasi Digital, Tabayyun Siber, & Cek Fakta Anti-Hoaks.<br/>• Penguasaan Maktabah Syamilah digital & Mendeley APA 7th."]
        
        P1 & P2 & P3 & P4 ==> Output["PROFIL CIKAL BAKAL ULIL ALBAB (TUMBUH 2026)"]
    end
```
...
```mermaid
flowchart TD
    subgraph EkosistemPembinaan24Jam["INTEGRASI PEMBINAAN INTELEKTUAL 24 JAM"]
        Madrasah["JAM KELAS MADRASAH (07.00 - 12.00):<br/>• Problem-Based Learning (PBL) & Socratic Dialogue.<br/>• Integrasi Ayat Kauniyyah (Sains) & Kaidah Syar'iyyah."]
        
        Maktabah["JAM PERPUSTAKAAN & LAB (14.00 - 15.30):<br/>• Riset Digital Maktabah Syamilah & Penelusuran Jurnal.<br/>• Bimbingan Penulisan KTI Mandiri Berstandar APA 7th."]
        
        Asrama["JAM ASRAMA & HALAQAH (19.30 - 21.00):<br/>• Silabus Halaqah Tematik 24 Pekan & Bahtsul Masail.<br/>• Membaca Senyap 20 Menit di Kamar (Silent Reading).<br/>• Mentorship Sebaya: Santri J4 Membimbing Santri J1."]
