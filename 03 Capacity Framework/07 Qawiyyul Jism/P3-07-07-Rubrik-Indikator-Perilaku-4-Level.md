...
```mermaid
flowchart TD
    subgraph TransformasiRubrikJasmani["REKONSTRUKSI SISTEM ASESMEN KEBUGARAN"]
        Tradisional["PENILAIAN TUNGGAL OLAHRAGA (TRADISIONAL)<br/>• Nilai rapor hanya berdasarkan tes lari / sepak bola.<br/>• Mengabaikan higienitas kamar, pola makan, & tidur.<br/>• Santri non-atletis merasa minder & terpinggirkan."]
        
        TUMBUH["RUBRIK 4-LEVEL QAWIYYUL JISM TUMBUH<br/>• Deskriptor kriteria terperinci 4 pilar (Thaharah, Giza, Naum, Kebugaran).<br/>• Evaluasi formatif multi-sumber (Santri, Musyrif, Poskestren, Guru Penjas).<br/>• Uji reliabilitas Cohen's Kappa & penilaian pertumbuhan ipsatif."]
...
```mermaid
flowchart LR
    subgraph TuratsMizanBadan["PRINSIP PENIMBANGAN FISIK DALAM TURATS"]
        IbnuSina["Ibnu Sina (Al-Qanun):<br/>Taqdirul Liyaqah: Menakar Keseimbangan Unsur Raga<br/>Berdasarkan Warna Kulit, Nadi, & Kelincahan Gerak"] --> Inti["Al-Mizan fil Abdan:<br/>Pengukuran Kebugaran yang Presisi, Proporsional, & Objektif"]
        IbnuQayyim["Ibnu Qayyim (Zadul Ma'ad):<br/>Penimbangan Kekuatan Raga untuk Ibadah"] --> Inti
        Ghazali["Al-Ghazali (Mizanul 'Amal):<br/>Moderasi Kebutuhan Fisik Antara Ifrath & Tafrith"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPsikometriKebugaran["STANDAR PSIKOMETRI RUBRIK QAWIYYUL JISM"]
        IRR["Inter-Rater Reliability (Cohen's Kappa & ICC):<br/>• Kesepakatan penilaian antar-musyrif & Poskestren >= 86%.<br/>• Standarisasi interpretasi deskriptor kebersihan."]
        
        Criterion["Criterion-Referenced Validity (Nitko & Brookhart):<br/>• Kriteria keberhasilan didasarkan pada standar fisiologis baku (AKG, TKJI, VO2Max)."]
        
        Authentic["Authentic Performance Tasks (Wiggins):<br/>• Pengujian kinerja raga dalam konteks nyata (Renang 50m, Menjemur Kasur, Disiplin Wudhu)."]
        
        IRR & Criterion & Authentic ==> RubrikStandar["RUBRIK QAWIYYUL JISM TERVALIDASI"]
    end
```
...
```mermaid
flowchart TD
    subgraph SistemAsesmenTerpadu24Jam["INTEGRASI DATA ASESMEN KESEHATAN 24 JAM"]
        DataPoskestren["1. POSKESTREN: Data IMT, Tekanan Darah, Riwayat Sakit, & Screening Kulit."]
        DataPenjas["2. GURU PENJAS: Skor TKJI (Lari, Push-up, Sit-up) & Sertifikasi Renang/Panahan."]
        DataMusyrif["3. MUSYRIF ASRAMA: Observasi Harian Sanitasi Kamar, Jam Tidur 21.30, & Senam Pagi."]
        DataSantri["4. SANTRI: Jurnal Muhasabah Mutaba'ah Hidrasi & Sarapan Pagi."]
        
        DataPoskestren & DataPenjas & DataMusyrif & DataSantri ==> Dashboard["DASHBOARD KESEHATAN SANTRI (HEALTH-TUMBUH)"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRekonsiliasiJasmani["PROTOKOL REKONSILIASI PENILAIAN TIER 2"]
        R1["1. FORUM REKONSILIASI GURU PENJAS & MUSYRIF ASRAMA<br/>• Memadukan skor motorik (Level 4) dan skor sanitasi (Level 1)."]
        
        R2["2. SESI COACHING INTEGRATIF BERSAMA SANTRI G<br/>• Menyadarkan bahwa menjadi 'atlet sejati' dalam Islam menuntut kebersihan badan & kesucian kamar.<br/>• Merujuk hadits 'Ath-Thuhuru Syathrul Iman'."]
        
        R3["3. KONTRAK PEMBIASAAN SANITASI KAMAR (30 HARI)<br/>• Santri G diberi target spesifik merapikan loker & menjemur kasur mingguan.<br/>• Musyrif memantau via logbook harian."]
        
        R4["4. PENETAPAN SKOR IPSATIF AKHIR TERPADU<br/>• Skor komposit ditetapkan pada Level 2 (Developing) hingga target sanitasi tercapai."]
...
```mermaid
flowchart TD
    subgraph ArsitekturRubrik4LevelJasmani["EMPAT TINGKAT KEMATANGAN QAWIYYUL JISM"]
        L1["LEVEL 1: PERINTISAN (EMERGING / PERLU PANDUAN)<br/>• Belum mandiri menjaga kebersihan diri; sering mengabaikan makan sehat & tidur.<br/>• Stamina fisik rendah & cepat lelah saat beraktivitas."]
        
        L2["LEVEL 2: PEMBIASAAN (DEVELOPING / REGULASI FISIK AWAL)<br/>• Menjaga kebersihan diri & kamar dalam rutinitas terstruktur asrama.<br/>• Mampu mengikuti senam & lari rutin; disiplin tidur dengan pengingat musyrif."]
        
        L3["LEVEL 3: PEMANTAPAN (PROFICIENT / STAMINA PRIMA & BERSIH OTONOM)<br/>• Menampilkan kebiasaan hidup bersih mandiri tanpa perlu diawasi.<br/>• Memiliki stamina kardiorespirasi prima, menguasai olahraga sunnah, & sehat."]
        
        L4["LEVEL 4: KETELADANAN (EXEMPLARY / QUDWAH JASMANI)<br/>• Menjadi teladan hidup sehat & instruktur kebugaran santri junior.<br/>• Memimpin gerakan sanitasi lingkungan asrama & menguasai tanggap darurat P3K."]
...
Penerapan konsep **P3-07-07: RUBRIK INDIKATOR PERILAKU 4-LEVEL QAWIYYUL JISM** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
