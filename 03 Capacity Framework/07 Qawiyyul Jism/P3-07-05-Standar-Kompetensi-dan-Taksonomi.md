...
```mermaid
flowchart TD
    subgraph RekonstruksiTaksonomiJasmani["REKONSTRUKSI TAKSONOMI KOMPETENSI JASMANI"]
        Parsial["TAKSONOMI OLAHRAGA PARSIAL (SEKULER)<br/>• Sekadar menilai tes keterampilan teknis cabang olahraga.<br/>• Terpisah dari kebiasaan mandi, tidur, & sanitasi kamar.<br/>• Olahraga sunnah diabaikan."]
        
        TUMBUH["TAKSONOMI RAGA FITRAH TUMBUH (HOLISTIK)<br/>• Integrasi 4 Pilar: Thaharah, Nutrisi, Tidur, & Kebugaran.<br/>• Gradasi 4 Level Kematangan Raga (Ta'allum -> Qudwah).<br/>• Wajib lulus sertifikasi kebugaran & olahraga sunnah J1–J4."]
...
```mermaid
flowchart LR
    subgraph TuratsRiyadhatulAbdan["PENTAHAPAN LATIHAN JASMANI DALAM TURATS"]
        IbnuSina["Ibnu Sina (Al-Qanun):<br/>Tadrijur Riyadhah: Pemanasan Lembut -> Gerak Inti -> Pendinginan"] --> Inti["Taksonomi Raga Fitrah:<br/>Dari Pembiasaan Motorik Menuju Ketahanan Fisik Prima"]
        IbnuQayyim["Ibnu Qayyim (Zadul Ma'ad):<br/>Riyadhah Khusus Setiap Anggota Badan"] --> Inti
        Mawardi["Al-Mawardi (Adab Dunya):<br/>Keseimbangan Olahraga & Waktu Belajar"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph KonvergensiTaksonomiPsikomotorik["SINTESIS TAKSONOMI PSIKOMOTORIK MULTIDIMENSI"]
        Dave["Taksonomi Psikomotorik R.H. Dave (1970):<br/>Imitation -> Manipulation -> Precision -> Articulation -> Naturalization"]
        Simpson["Taksonomi E.J. Simpson (1972):<br/>Perception -> Set -> Guided Response -> Mechanism -> Complex Response -> Adaptation -> Origination"]
        Fitrah["Taksonomi Raga Fitrah TUMBUH:<br/>1. Ta'allum (Perintisan Higienitas & Gerak)<br/>2. Tanmiyah (Pengembangan Kebugaran & Regulasi)<br/>3. Itqan (Kemahiran Olahraga Sunnah & Stamina)<br/>4. Qudwah (Keteladanan Jasmani & Khidmah)"]
...
```mermaid
flowchart TD
    subgraph KurikulumFisik24Jam["INTEGRASI KURIKULUM JASMANI ASRAMA 24 JAM"]
        Madrasah["JAM MADRASAH: Teori Fisiologi & Keterampilan Olahraga Sunnah."]
        Poskestren["JAM POSKESTREN: Screening IMT, Kebugaran VO2Max, & Konseling Gizi."]
        Asrama["JAM ASRAMA: Pembiasaan Mandi 2x, Tidur Sirkadian 7 Jam, & Piket Sanitasi."]
        
        Madrasah <==> Poskestren <==> Asrama
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolIntervensiMotorik["PROTOKOL PENDAMPINGAN MOTORIK ADAPTIF TIER 2"]
        TahapA["1. ASESMEN FISIOTERAPI & MOTORIK POSKESTREN<br/>• Mengukur rentang gerak sendi, keseimbangan statis/dinamis, & kekuatan otot."]
        
        TahapB["2. PROGRAM LATIHAN MOTORIK TERPANDU (GUIDED MOTOR PROGRAM)<br/>• Sesi privat 20 menit 3x sepekan bersama musyrif olahraga berkeahlian Penjas Adaptif.<br/>• Latihan bertahap: Keseimbangan garis lurus, lempar-tangkap bola spons, berenang terapi."]
        
        TahapC["3. SISTEM BUDDY SYSTEM DENGAN SANTRI JENJANG J4<br/>• Santri T didampingi seorang kakak asuh J4 yang sabar dan suportif."]
        
        TahapD["4. EVALUASI IPSATIF BERTARAP (3 BULAN)<br/>• Mengukur kemajuan Santri T dibandingkan performa awalnya sendiri (Zero Stigma)."]
...
```mermaid
flowchart TD
    subgraph HierarkiTaksonomiRagaFitrah["EMPAT LEVEL TAKSONOMI RAGA FITRAH QAWIYYUL JISM"]
        L4["LEVEL 4: QUDWAH WA KHIDMAH (KETELADANAN JASMANI & KEPEMIMPINAN)<br/>• Gaya hidup sehat menjadi karakter alami seumur hidup.<br/>• Menjadi instruktur kebugaran, asisten pelatih olahraga, & duta sanitasi."]
        
        L3["LEVEL 3: ITQAN WAL MAHAROH (KEMAHIRAN OLAHRAGA SUNNAH & KETAHANAN)<br/>• Penguasaan tersertifikasi renang 50m atau panahan 15m.<br/>• Kebugaran kardiorespirasi VO2Max prima & kompetensi tanggap darurat P3K."]
        
        L2["LEVEL 2: TANMIYAH WAL LAYAQA (PENGEMBANGAN KEBUGARAN & REGULASI)<br/>• Peningkatan kekuatan otot inti, kelenturan, & beladiri dasar.<br/>• Disiplin tidur sirkadian 7 jam & eliminasi makanan nir-gizi."]
        
        L1["LEVEL 1: TA'ALLUM WA TA'WID (PENGENALAN & PEMBIASAAN HIGIENITAS DASAR)<br/>• Mandiri menjaga kebersihan diri (mandi 2x, sikat gigi, cuci baju).<br/>• Mengikuti senam pagi rutin & makan sayur dapur pondok."]
...
| :--- | :--- | :--- |
| **Pilar 1: At-Thaharah (Higienitas)** | **SKD-QJ-1.1**<br/>**SKD-QJ-1.2**<br/>**SKD-QJ-1.3** | Menerapkan kebiasaan mandi mandiri 2x sehari, sikat gigi sebelum tidur, dan mencuci pakaian.<br/>Menjaga sanitasi kamar tidur, menjemur kasur berkala, dan mengeliminasi risiko penyakit kulit.<br/>Memelihara kebersihan toilet dan sarana umum pesantren sesuai standar *Zero-Scabies*. |
| **Pilar 2: Al-Giza' (Nutrisi Thayyib)** | **SKD-QJ-2.1**<br/>**SKD-QJ-2.2**<br/>**SKD-QJ-2.3** | Mengonsumsi menu makanan seimbang dapur pondok (karbohidrat, protein, sayur, buah).<br/>Menerapkan adab makan sepertiga perut dan menghentikan kebiasaan jajan makanan berpengawet.<br/>Memahami kebutuhan hidrasi air bersih minimal 2.5 liter per hari dan nutrisi otak. |
| **Pilar 3: An-Naum (Tidur Sirkadian)** | **SKD-QJ-3.1**<br/>**SKD-QJ-3.2**<br/>**SKD-QJ-3.3** | Mematuhi jadwal tidur malam tepat waktu pukul 21.30 dan bangun Shubuh mandiri.<br/>Membiasakan tidur siang sunnah (*Qailulah*) 15–20 menit untuk pemulihan kognitif.<br/>Menghindari begadang sia-sia dan mengoptimalkan suasana kamar tidur yang tenang. |
| **Pilar 4: Ar-Riyadhah (Kebugaran)** | **SKD-QJ-4.1**<br/>**SKD-QJ-4.2**<br/>**SKD-QJ-4.3** | Mengikuti senam pagi harian dan latihan aerobik rutin (lari 1.500m/Cooper Test).<br/>Menguasai teknik dasar beladiri kesatria (pencak silat / thifan) untuk pertahanan diri.<br/>Menguasai minimal satu cabang olahraga sunnah (renang 50m / panahan 15m). |
