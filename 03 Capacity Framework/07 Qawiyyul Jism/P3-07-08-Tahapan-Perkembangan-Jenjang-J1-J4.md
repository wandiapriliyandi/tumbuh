...
```mermaid
flowchart TD
    subgraph TransformasiTrajektoriFisik["REKONSTRUKSI TRAJEKTORI PERKEMBANGAN JASMANI"]
        Seragam["PENDEKATAN SERAGAM TRADISIONAL<br/>• Beban fisik, porsi makan, & latihan olahraga disamaratakan.<br/>• Pubertas tabu dibicarakan; santri bingung mandi janabah.<br/>• Cedera tulang & gangguan postur tubuh remaja terabaikan."]
        
        TUMBUH["TRAJEKTORI BIOLOGIS J1–J4 TUMBUH<br/>• Sinkronisasi latihan fisik dengan Tanner Stages & Growth Spurt.<br/>• Edukasi Thaharah Bulugh & kesehatan reproduksi syar'i.<br/>• Progresi kebugaran adaptif dari sanitasi dasar hingga puncak stamina."]
...
```mermaid
flowchart LR
    subgraph TuratsMaratibutTanmiyah["PENTAHAPAN USIA DALAM KEDOKTERAN TURATS"]
        IbnuSina["Ibnu Sina (Al-Qanun):<br/>Sinnus Shibā (Kanak-kanak) -> Sinnun Numuww (Pertumbuhan/Puber) -> Sinnus Syabab (Pemuda)"] --> Inti["Maratibut Tanmiyah:<br/>Penyesuaian Latihan Jasmani Berdasarkan Usia & Kekuatan Raga"]
        IbnuQayyim["Ibnu Qayyim (Tuhfatul Maudud):<br/>Adab Menjaga Jasmani Anak Menjelang Akil Baligh"] --> Inti
        Syathibi["Asy-Syathibi (Al-Muwafaqat):<br/>Taklif Syar'i Selaras dengan Kesiapan Fisik & Akal"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph FisiologiPubertasRemaja["INTEGRASI TANNER STAGES DENGAN JENJANG J1–J4"]
        J1Fase["JENJANG J1 (12–13 Tahun / Tanner 2):<br/>• Awal lonjakan hormon (GnRH, LH, FSH).<br/>• Pembesaran testis/payudara, perubahan suara awal.<br/>• Fokus: Higienitas dasar & edukasi mandi wajib."]
        
        J2Fase["JENJANG J2 (13–15 Tahun / Tanner 3–4):<br/>• Puncak Peak Height Velocity (Tumbuh 8–10 cm/tahun).<br/>• Penambahan massa otot & mineralisasi tulang.<br/>• Fokus: Latihan kekuatan otot inti & kecukupan kalsium/protein."]
        
        J3Fase["JENJANG J3 (15–17 Tahun / Tanner 4–5):<br/>• Kapasitas kardiorespirasi (VO2Max) meningkat tajam.<br/>• Koordinasi neuromuskular matang & stamina tinggi.<br/>• Fokus: Olahraga sunnah mahir (renang, panahan, beladiri)."]
        
        J4Fase["JENJANG J4 (17–18 Tahun / Tanner 5 / Dewasa Awal):<br/>• Fusi lempeng pertumbuhan tulang (Epiphyseal Closure).<br/>• Kekuatan fisik puncak & stabilitas homeostatis.<br/>• Fokus: Kepemimpinan kebugaran (Qudwah) & gaya hidup seumur hidup."]
        
        J1Fase --> J2Fase --> J3Fase --> J4Fase
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaNutrisiLatihanJ1J4["REKAYASA GIZI & LATIHAN BERBASIS JENJANG"]
        GiziJ1["J1: Kalori 2.200 kkal, Kalsium 1.200 mg, Protein 65g. Latihan gerak adaptif & senam."]
        GiziJ2["J2: Kalori 2.600 kkal, Protein 80g, Zat Besi tinggi. Latihan penguatan otot & beladiri."]
        GiziJ3["J3: Kalori 2.800 kkal, Protein 85g, Hidrasi 3 Liter. Latihan endurance aerobik & renang."]
        GiziJ4["J4: Kalori 2.500 kkal seimbang, Mikronutrien otak. Latihan kebugaran mandiri & instruktur."]
        
        GiziJ1 --> GiziJ2 --> GiziJ3 --> GiziJ4
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolOsgoodSchlatter["PROTOKOL FISIOTERAPI & LATIHAN ADAPTIF TIER 2"]
        P1["1. DIAGNOSIS MEDIS & EVALUASI RADIOLOGIS POSKESTREN<br/>• Dokter Poskestren mengonfirmasi diagnosis & mengedukasi bahwa ini kondisi jinak terkait pertumbuhan."]
        
        P2["2. PROTOKOL MODIFIKASI LATIHAN FISIK (POLICE PROTOCOL)<br/>• Menghindari lari sprint keras & lompat tinggi selama 4–6 pekan.<br/>• Mengganti latihan dengan berenang gaya bebas & peregangan otot paha depan (Quadriceps)."]
        
        P3["3. SUPLEMENTASI NUTRISI TULANG & SENDI<br/>• Pemberian asupan kalsium, vitamin D3, & anti-inflamasi alami (minyak zaitun/habbatussauda)."]
        
        P4["4. MONITORING POSTUR & PEMULIHAN BERTAHAP<br/>• Santri F kembali berolahraga penuh setelah fase nyeri mereda dengan postur tubuh tegap."]
...
```mermaid
flowchart TD
    subgraph ArsitekturTrajektoriJ1J4["TRAJEKTORI PERKEMBANGAN JASMANI LENGKAP J1–J4"]
        J1["JENJANG J1: FASE ADAPTASI HIGIENITAS & AWAL PUBERTAS (KELAS 7)<br/>• Karakteristik: Transisi rumah ke asrama, Tanner 2, emosi fisik labil.<br/>• Target: Mandiri mandi 2x, cuci pakaian, paham mandi janabah, senam pagi."]
        
        J2["JENJANG J2: FASE LONJAKAN PERTUMBUHAN & REGULASI OTOT (KELAS 8–9)<br/>• Karakteristik: Peak Height Velocity (Tanner 3–4), nafsu makan melonjak.<br/>• Target: Beladiri pencak silat, kekuatan otot inti, bebas skabies, tidur 7 jam."]
        
        J3["JENJANG J3: FASE STAMINA AEROBIK & OLAHRAGA SUNNAH (KELAS 10–11)<br/>• Karakteristik: Maturasi neuromuskular (Tanner 4–5), kapasitas paru optimal.<br/>• Target: Renang 50m / Panahan 15m, VO2Max Prima, sertifikasi P3K."]
        
        J4["JENJANG J4: FASE PUNCAK KEBUGARAN & KETELADANAN QUDWAH (KELAS 12)<br/>• Karakteristik: Fusi tulang dewasa, stabilitas stamina, kesadaran mandiri.<br/>• Target: Instruktur senam, duta sanitasi, pola hidup sehat seumur hidup."]
...
```mermaid
flowchart TD
    subgraph ProtokolTransisiAkilBaligh["PROTOKOL TRANSISI AKIL BALIGH ASRAMA"]
        TahapI["1. EDUKASI PRA-BULUGH DIALOGIS (HALAQAH KESEHATAN REPRODUKSI)<br/>• Penjelasan ilmiah & syar'i mengenai mimpi basah & menstruasi oleh dokter Poskestren & musyrif."]
        
        TahapII["2. PELAYANAN PRIVASI MANDI JANABAH TANPA STIGMA<br/>• Fasilitas kamar mandi khusus dengan air hangat & ketersediaan sabun thaharah.<br/>• Santri melapor kepada musyrif secara privat tanpa diketahui teman sebaya."]
        
        TahapIII["3. PEMBERIAN 'PAKET KEDEWASAAN' (MATURITY WELCOME KIT)<br/>• Buku saku Fiqh Bulugh, perlengkapan thaharah pribadi, & minyak wangi sunnah."]
        
        TahapIV["4. DOA SYUKURAN KEDEWASAAN (RITES OF PASSAGE)<br/>• Musyrif mendoakan santri yang telah baligh agar istiqamah memikul taklif syar'i."]
        
        TahapI --> TahapII --> TahapIII --> TahapIV
    end
```
...
Penerapan konsep **P3-07-08: TAHAPAN PERKEMBANGAN JENJANG J1–J4 QAWIYYUL JISM** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
