...
```mermaid
flowchart TD
    subgraph TransformasiTargetJasmani["REKONSTRUKSI TARGET CAPAIAN KESEHATAN SANTRI"]
        Kabur["TARGET TRADISIONAL KABUR<br/>• 'Pokoknya santri sehat dan tidak sakit'.<br/>• Tanpa pengukuran VO2Max & evaluasi IMT.<br/>• Masalah gizi buruk & sanitasi kumuh terabaikan."]
        
        TUMBUH["TARGET CAPAIAN QAWIYYUL JISM TUMBUH<br/>• Capaian Pembelajaran (CP-QJ) berbasis bukti.<br/>• Tes Kebugaran Jasmani (TKJI & VO2Max) berkala.<br/>• Matriks capaian berjenjang J1–J4 & standar zero-scabies."]
...
```mermaid
flowchart LR
    subgraph TuratsTargetOlahraga["TARGET KETERAMPILAN JASMANI SALAF"]
        AtsarUmar["Wasiat Sayyidina Umar RA:<br/>عَلِّمُوا أَوْلَادَكُمُ السِّبَاحَةَ وَالرِّمَايَةَ وَمُرُوهُمْ فَلْيَثِبُوا عَلَى الْخَيْلِ وَثْبًا<br/>(Ajarkan Anak-anakmu Renang, Memanah, & Menunggang Kuda)"] --> Inti["Target Capaian Qawiyyul Jism:<br/>Kekuatan Motorik, Ketangkasan, & Keberanian Fisik"]
        IbnuQayyim["Ibnu Qayyim (Al-Furusiyyah):<br/>Ketangkasan Raga Penopang Kemuliaan Islam"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Bermain Fisik Menyegarkan Akal Anak"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph StandarKebugaranTerpadu["SINTESIS STANDAR PENGUKURAN KEBUGARAN"]
        WHO["WHO & ACSM Guidelines (2020):<br/>• Minimal 60 menit aktivitas fisik intensitas sedang-berat per hari.<br/>• Latihan kekuatan otot minimal 3x sepekan."]
        
        TKJI["Tes Kebugaran Jasmani Indonesia (Kemenpora):<br/>1. Lari Cepat (Sprint 50m/60m)<br/>2. Gantung Angkat Tubuh (Pull-up)<br/>3. Baring Duduk (Sit-up 60 detik)<br/>4. Loncat Tegak (Vertical Jump)<br/>5. Lari Jarak Jauh (1.000m / 1.200m)"]
        
        WHO & TKJI ==> TargetTUMBUH["TARGET KUANTITATIF QAWIYYUL JISM SANTRI"]
    end
```
...
```mermaid
flowchart TD
    subgraph RitmeFisik24Jam["RITME HARIAN KEBUGARAN & KESEHATAN SANTRI"]
        Pagi["05.30 - 06.00: Senam Kesegaran Jasmani / Jogging Pagi (Stimulasi BDNF)."]
        Siang["12.30 - 13.00: Makan Siang Gizi Seimbang & Qailulah 20 Menit."]
        Sore["16.00 - 17.15: Latihan Olahraga Sunnah / Ekstrakurikuler Beladiri Terstruktur."]
        Malam["21.30 - 04.00: Istirahat Tidur Sirkadian Gelap & Tenang (Konsolidasi Memori)."]
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiObesitas["PROTOKOL REMEDIASI KESEHATAN TIER 2"]
        Aksi1["1. SCREENING MEDIS AWAL DI POSKESTREN<br/>• Pemeriksaan fungsi jantung, paru, & kadar gula darah puasa."]
        
        Aksi2["2. PROGRAM DIET SEIMBANG KHUSUS DAPUR PONDOK<br/>• Penurunan porsi karbohidrat sederhana; peningkatan serat sayur & protein tanpa lemak.<br/>• Eliminasi total konsumsi minuman berpemanis buatan."]
        
        Aksi3["3. LATIHAN FISIK ADAPTIF LOW-IMPACT BERTARAP<br/>• Latihan jalan cepat 30 menit & renang terapi 2x sepekan (Low Joint Stress).<br/>• Didampingi oleh musyrif olahraga yang memotivasi (Firm & Kind)."]
        
        Aksi4["4. MONITORING IMT & KESEHATAN MENTAL (6 BULAN)<br/>• Evaluasi lingkar pinggang dan skor kebugaran bulanan.<br/>• Edukasi anti-body shaming di kamar asrama."]
        
        Aksi1 --> Aksi2 --> Aksi3 --> Aksi4
    end
```
...
```mermaid
flowchart TD
    subgraph StrukturTargetCPQJ["STRUKTUR TARGET CAPAIAN PEMBELAJARAN (CP-QJ)"]
        CP["CAPAIAN PEMBELAJARAN INDUK QAWIYYUL JISM"]
        
        T1["Target Pilar 1: Thaharah & Sanitasi<br/>• 0% Kasus Skabies & Infeksi Kulit.<br/>• Kebersihan Mandiri Kamar & Pakaian."]
        
        T2["Target Pilar 2: Nutrisi Thayyib<br/>• Pola Makan Halal & Bergizi Seimbang.<br/>• Bebas Anemia & Malnutrisi."]
        
        T3["Target Pilar 3: Tidur Sirkadian<br/>• Disiplin Tidur 7–8 Jam per Malam.<br/>• Nol Kasus Kantuk Kronis di Kelas."]
        
        T4["Target Pilar 4: Kebugaran & Olahraga<br/>• Skor TKJI Kategori 'Baik' & VO2Max Prima.<br/>• Kemahiran Olahraga Sunnah (Renang/Panahan)."]
...
```mermaid
flowchart LR
    subgraph TargetProgresiFisik["PETA TARGET CAPAIAN JASMANI LINTAS JENJANG J1–J4"]
        J1["J1 (KELAS 7): ADAPTASI & SANITASI DASAR<br/>Target: Mandi 2x tertib, cuci baju sendiri, lari 1.500m bertahap, tidur 21.30."]
        --> J2["J2 (KELAS 8–9): KEBUGARAN & BELADIRI<br/>Target: Beladiri dasar (jurus 1–5), push-up 25x, sit-up 30x, qailulah 20 menit."]
        --> J3["J3 (KELAS 10–11): OLAHRAGA SUNNAH & STAMINA<br/>Target: Renang 50m / Panahan 15m, VO2Max >= 42, sertifikasi P3K."]
        --> J4["J4 (KELAS 12): KEPEMIMPINAN QUDWAH JASMANI<br/>Target: Instruktur senam/olahraga santri junior, inspektur sanitasi asrama."]
    end
```
...
| :--- | :--- | :--- |
| **Jenjang J1 (Kelas 7)** | • Mandiri menjaga kebersihan badan dan kuku.<br/>• Menghabiskan porsi sayur dapur pondok.<br/>• Mencuci sarung dan sprei secara rutin. | • Mampu lari jogging 15 menit tanpa henti.<br/>• Mengikuti senam kesegaran jasmani dengan benar.<br/>• Latihan fleksibilitas tubuh dasar. |
| **Jenjang J2 (Kelas 8–9)** | • Bebas mutlak dari penyakit kulit/skabies.<br/>• Menghindari makanan sampah/minuman berpengawet.<br/>• Disiplin tidur sirkadian 7 jam. | • Lari 2.400 meter (Cooper Test) waktu tempuh $\le 12\text{ menit}$.<br/>• Menguasai teknik tangkisan dan pukulan beladiri.<br/>• Kekuatan otot inti (Plank 60 detik). |
| **Jenjang J3 (Kelas 10–11)** | • Memahami penghitungan kalori dan gizi harian.<br/>• Mengelola sanitasi kamar mandi asrama bersama.<br/>• Menguasai pertolongan pertama pada kecelakaan (P3K). | • Mampu berenang 50 meter gaya dada/bebas.<br/>• Menembak sasaran panahan jarak 15 meter (akurasi $\ge 70\%$).<br/>• Skor VO2Max kategori Prima. |
| **Jenjang J4 (Kelas 12)** | • Menjadi teladan pola makan thayyib dan hidup bersih.<br/>• Menginspeksi dan membimbing standar sanitasi kamar J1.<br/>• Menjaga kebugaran mandiri tanpa instruksi musyrif. | • Memimpin sesi pemanasan dan senam seluruh santri.<br/>• Menjadi asisten pelatih olahraga sunnah/beladiri.<br/>• Memiliki postur tubuh tegap dan stamina puncak. |
...
Penerapan konsep **P3-07-03: TUJUAN DAN TARGET CAPAIAN QAWIYYUL JISM** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
