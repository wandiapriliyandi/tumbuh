...
```mermaid
flowchart TD
    subgraph DekonstruksiDefinisiJasmani["DEKONSTRUKSI DEFINISI KESEHATAN FISIK"]
        Pasif["DEFINISI SEHAT PASIF (TRADISIONAL)<br/>• Sehat = Sekadar tidak terbaring sakit di kamar UKS.<br/>• Mengabaikan stamina rendah, postur bungkuk, & gizi buruk.<br/>• Raga cepat lelah saat halaqah & hafalan malam."]
        
        TUMBUH["KONSEPTUALISASI QAWIYYUL JISM TUMBUH<br/>• Sehat = Vitalitas holistik, kebugaran aerobik prima.<br/>• Postur ergonomis, nutrisi thayyib seimbang, & higienis.<br/>• Raga tahan berjam-jam belajar dengan fokus tajam."]
        
        Pasif ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsSihhatulAbdan["KEDUDUKAN JASMANI DALAM TURATS"]
        Syafi'i["Imam Asy-Syafi'i:<br/>لَا أَعْلَمُ عِلْمًا بَعْدَ الْحَلَالِ وَالْحَرَامِ أَنْبَلَ مِنَ الطِّبِّ<br/>(Ilmu Kedokteran Adalah Ilmu Paling Mulia Pasca-Fiqih)"] --> Inti["Sihhatul Abdan Muqaddamun:<br/>Kesehatan Raga Sebagai Wasilah Penegakan Syariat"]
        Syathibi["Asy-Syathibi (Al-Muwafaqat):<br/>Hifzhun Nafs Meliputi Penjagaan Imunitas Raga"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Raga Adalah Kendaraan Menuju Akhirat"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph ModelKesehatanHolistik["INTEGRASI WHO DAN FISIOLOGI KEBUGARAN"]
        WHO["Definisi Kesehatan WHO (1948):<br/>State of complete physical, mental, and social well-being, and not merely the absence of disease."]
        
        Fitness["5 Komponen Kebugaran Fisik (ACSM):<br/>1. Cardiorespiratory Endurance (Daya Tahan Jantung-Paru)<br/>2. Muscular Strength (Kekuatan Otot)<br/>3. Muscular Endurance (Ketahanan Otot)<br/>4. Flexibility (Kelenturan Sendi)<br/>5. Body Composition (Komposisi Lemak vs Massa Otot)"]
        
        WHO & Fitness ==> Qawiyy["QAWIYYUL JISM TUMBUH:<br/>Vitalitas Raga Holistik Berbasis Syariat"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaErgonomiAsrama["REKAYASA ERGONOMI ASRAMA TUMBUH"]
        DudukDampar["1. DUDUK MENGAJI DI MASJID:<br/>• Penggunaan kursi lantai portabel bersandaran (Floor Backrest Chair).<br/>• Pencegahan kifosis tulang belakang & penekanan diafragma."]
        
        MejaBelajar["2. MEJA & KURSI MADRASAH:<br/>• Sudut meja 15 derajat & ketinggian kursi disesuaikan tinggi santri.<br/>• Jarak pandang baca Al-Qur'an/buku minimal 30 cm anti-miopia."]
        
        TasBeban["3. BEBAN TAS SEKOLAH:<br/>• Berat tas punggung maksimal 10–15% dari berat badan santri.<br/>• Penyimpanan kitab di loker kelas untuk meringankan beban harian."]
        
        DudukDampar & MejaBelajar & TasBeban ==> PosturTegap["POSTUR TUBUH TEGAP & BEBAS NYERI PUNGGUNG"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolResolusiFatigue["PROTOKOL RESTORASI VITALITAS SANTRI TIER 2"]
        StepA["1. INTERVENSI MEDIS & NUTRISI POSKESTREN<br/>• Suplementasi tablet tambah darah (Zat Besi + Vitamin C) & madu harian.<br/>• Modifikasi menu tinggi protein & sayuran hijau di dapur pondok."]
        
        StepB["2. RESTRUKTURISASI JADWAL SIRKADIAN TIDUR MANDATORI<br/>• Santri Z diwajibkan tidur tepat pukul 21.30 & bangun pukul 04.00 (6.5 Jam).<br/>• Wajib tidur siang sunnah (Qailulah) 20 menit pasca-Zhuhur."]
        
        StepC["3. PENJADWALAN ULANG TARGET TAHFIZH DIALOGIS<br/>• Musyrif Al-Qur'an menyesuaikan target setoran hafalan secara bertahap (Ipsatif).<br/>• Mengedukasi santri bahwa tidur cukup adalah syarat mutlak kekuatan hafalan."]
        
        StepD["4. MONITORING KEBUGARAN KARDIORESPIRASI 30 HARI<br/>• Santri Z dilatih lari pagi ringan 15 menit 3x sepekan untuk stimulasi oksigenasi otak."]
...
```mermaid
flowchart TD
    subgraph KonstrukQawiyyulJism["STRUKTUR KONSTRUK MULTIDIMENSIONAL QAWIYYUL JISM"]
        Core["INTI QAWIYYUL JISM<br/>(Vitalitas Raga Penegak Amanah Syariat)"]
        
        D1["Dimensi 1: Kebugaran Motorik (Liyaqah Badaniyyah)<br/>• Daya Tahan Kardiorespirasi (VO2Max)<br/>• Kekuatan & Kelenturan Otot<br/>• Keterampilan Olahraga Sunnah"]
        
        D2["Dimensi 2: Nutrisi Thayyib (Al-Giza' as-Salim)<br/>• Keseimbangan Makro-Mikronutrien<br/>• Adab Sepertiga Perut<br/>• Hidrasi Air Bersih Teratur"]
        
        D3["Dimensi 3: Higienitas & Sanitasi (At-Thaharah)<br/>• Kebersihan Diri & Mandi Mandiri<br/>• Sanitasi Kamar Tidur Bebas Parasit<br/>• Thaharah Syar'i Tertib"]
        
        D4["Dimensi 4: Restorasi Sirkadian (Ar-Raha)<br/>• Disiplin Jam Tidur Malam (7–8 Jam)<br/>• Qailulah Siang Sunnah<br/>• Ergonomi Aktivitas Belajar"]
...
```mermaid
quadrantChart
    title MATRIKS TIPOLOGI KONDISI JASMANI SANTRI ASRAMA
    x-axis "Higienitas Rendah" --> "Higienitas Tinggi"
    y-axis "Stamina/Kebugaran Rendah" --> "Stamina/Kebugaran Tinggi"
    quadrant-1 "TIPE 4: SANTRI QAWIYYUL JISM PARIPURNA"
    quadrant-2 "TIPE 3: ATLETIS TAPI KUMUH / RENTAN SKABIES"
    quadrant-3 "TIPE 1: KRITIS / SEDENTARI & RENTAN WABAH"
    quadrant-4 "TIPE 2: HIGIENIS TAPI LEMAH / KURANG STAMINA"
```
...
```mermaid
flowchart TD
    subgraph ProgresiKapasitasFisik["TANGGA PERKEMBANGAN JASMANI J1–J4"]
        J1["J1: ADAPTASI HIGIENITAS & GERAK DASAR (KELAS 7)<br/>• Mandi teratur 2x sehari, cuci pakaian sendiri, makan sayur dapur.<br/>• Lari aerobik 1.500 meter bertahap, senam kesegaran jasmani."]
        
        J2["J2: PEMBINAAN KEBUGARAN & BELADIRI (KELAS 8–9)<br/>• Penguasaan dasar beladiri pencak silat / thifan.<br/>• Peningkatan kekuatan otot inti (Push-up, Sit-up, Plank).<br/>• Disiplin tidur sirkadian 7 jam."]
        
        J3["J3: OLAHRAGA SUNNAH & KETAHANAN STAMINA (KELAS 10–11)<br/>• Kemahiran berenang (gaya dada/bebas 50m) & memanah.<br/>• Kebugaran kardiorespirasi (Tes Bleep Test / Cooper Test Level Baik).<br/>• Keterampilan P3K gawat darurat asrama."]
        
        J4["J4: KEPEMIMPINAN QUDWAH KESEHATAN (KELAS 12)<br/>• Instruktur kebugaran & olahraga santri junior.<br/>• Manajemen nutrisi & pola hidup sehat mandiri seumur hidup.<br/>• Inspektur sanitasi lingkungan pondok."]
...
Penerapan konsep **P3-07-02: DEFINISI DAN KONSEPTUALISASI QAWIYYUL JISM** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
