...
```mermaid
flowchart TD
    subgraph TransformasiParadigmaJasmani["REKONSTRUKSI PARADIGMA KESEHATAN JASMANI PESANTREN"]
        Asketis["PARADIGMA ASKETISME RUSAK (TRADISIONAL KUNOP)<br/>• Raga diabaikan; gudik dianggap berkah ilmu.<br/>• Begadang kronis & menu dapur rendah gizi.<br/>• Akibat: Santri kurus/lemah, daya ingat tumpul, wabah menular."]
        
        TUMBUH["PARADIGMA QAWIYYUL JISM TUMBUH (HOLISTIK)<br/>• Raga adalah amanah Ilahi yang wajib dirawat.<br/>• Tidur sirkadian 7–8 jam & nutrisi halalan thayyiban seimbang.<br/>• Olahraga terstruktur, sanitasi higienis, & Poskestren proaktif.<br/>• Hasil: Santri bugar prima, daya hafalan tajam, & imunitas kokoh."]
        
        Asketis ==>|DIREKONSTRUKSI SECARA METODOLOGIS MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsQawiyyulJism["AKAR EPISTEMOLOGIS TURATS QAWIYYUL JISM"]
        HaditsQawiyy["HR. Muslim No. 2664:<br/>الْمُؤْمِنُ الْقَوِيُّ خَيْرٌ وَأَحَبُّ إِلَى اللَّهِ مِنَ الْمُؤْمِنِ الضَّعِيفِ<br/>(Keutamaan Mukmin yang Kuat Jasmani & Ruhani)"] --> Inti["Hakikat Qawiyyul Jism:<br/>Kekuatan Raga Sebagai Sarana Khidmah & Ibadah"]
        IbnuQayyim["Ibnu Qayyim (Zadul Ma'ad):<br/>Ath-Thibb an-Nabawiy: Hifzhus Sihhah (Preventif) & Himyah (Diet)"] --> Inti
        IbnuSina["Ibnu Sina (Al-Qanun):<br/>Kebugaran Gerak (Riyadhah) Adalah Obat Terbesar"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph NeurosainsKebugaranSantri["INTEGRASI BIOMEDIS DAN KOGNISI SANTRI"]
        BDNF["1. Neurogenesis Hippocampus (BDNF):<br/>• Olahraga aerobik memicu Brain-Derived Neurotrophic Factor.<br/>• Mempercepat pembentukan sinaps baru & kapasitas memori hafalan."]
        
        Sirkadian["2. Ritme Sirkadian & Sleep Hygiene:<br/>• Tidur malam 7–8 jam memicu pelepasan Growth Hormone (GH).<br/>• Konsolidasi memori memindahkan hafalan ke jangka panjang."]
        
        GutBrain["3. Gut-Brain Axis (Mikrobioma Usus):<br/>• Menu bergizi tinggi serat memproduksi 90% Serotonin tubuh.<br/>• Menstabilkan mood, menekan kecemasan, & meningkatkan fokus."]
        
        BDNF & Sirkadian & GutBrain ==> Prima["KECERDASAN AKADEMIK & KESEHATAN PRIMA SANTRI"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaSpasialSanitasi["STANDAR EKOLOGI ASRAMA SEHAT TUMBUH"]
        Ventilasi["1. VENTILASI & PENCAHAYAAN ALAMI:<br/>• Sirkulasi udara silang (Cross-Ventilation) minimal 20% luas lantai.<br/>• Sinar matahari pagi masuk langsung ke kamar tidur membunuh kuman/tungau."]
        
        TempatTidur["2. SANITASI TEMPAT TIDUR:<br/>• Jarak antar-ranjang minimal 1 meter; jemur kasur berkala.<br/>• Larangan mutlak bertukar pakaian, handuk, & selimut pribadi."]
        
        SanitasiAir["3. INSTALASI AIR BERSIH & DRAINASE:<br/>• Air wudhu & mandi mengalir bebas lumut dan jentik.<br/>• Lantai kamar mandi miring 2% anti-genangan."]
        
        Ventilasi & TempatTidur & SanitasiAir ==> BebasWabah["ASRAMA ZERO-SCABIES & BEBAS INFEKSI"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolEliminasiSkabies["PROTOKOL ERADIKASI WABAH SKABIES TIER 3 (POSKESTREN)"]
        Tahap1["1. SCREENING MASSAL & DIAGNOSIS DOKTER POSKESTREN<br/>• Pemeriksaan seluruh santri, musyrif, dan staf dapur."]
        
        Tahap2["2. PENGOBATAN SIMULTAN SERENTAK (SIMULTANEOUS TREATMENT)<br/>• Aplikasi topikal Permethrin 5% ke seluruh tubuh seluruh santri (baik bergejala maupun kontak erat) pada malam yang sama.<br/>• Pengulangan aplikasi pada hari ke-7."]
        
        Tahap3["3. DEKONTAMINASI TOTAL LINGKUNGAN FISIK ASRAMA<br/>• Seluruh sprei, sarung, pakaian, dan handuk dicuci air panas >= 60 C.<br/>• Kasur dijemur di bawah terik matahari dan disemprot disinfektan/akarida."]
        
        Tahap4["4. EDUKASI ADAB THAHARAH PRIBADI & MONITORING 30 HARI<br/>• Pembiasaan tidak bertukar pakaian & penataan loker pribadi terpisah."]
...
```mermaid
flowchart TD
    subgraph ArsitekturQawiyyulJism["EMPAT PILAR DIMENSI KARAKTER QAWIYYUL JISM"]
        P1["PILAR 1: AT-THAHARAH WAN-NAZHAFAH (HIGIENITAS & KESUCIAN RAGA)<br/>• Kebersihan badan, pakaian, tempat tidur, & sarana umum.<br/>• Thaharah syar'i sempurna, wudhu tertib, & sanitasi diri mandiri."]
        
        P2["PILAR 2: AL-GIZA' AT-THAYYIB (NUTRISI HALALAN THAYYIBAN & POLA MAKAN)<br/>• Pemilihan makanan bergizi seimbang, kaya protein & serat.<br/>• Adab makan sepertiga perut & menghindari makanan sampah (Junk Food)."]
        
        P3["PILAR 3: AN-NAUM AS-SIRKADIY (MANAJEMEN TIDUR & PEMULIHAN ENERGI)<br/>• Disiplin tidur malam 7–8 jam & qailulah siang sunnah.<br/>• Kebersihan tidur (Sleep Hygiene) & bebas begadang sia-sia."]
        
        P4["PILAR 4: AR-RIYADHAH WAL LAYAQA (KEBUGARAN MOTORIK & OLAHRAGA SUNNAH)<br/>• Kebugaran kardiorespirasi (VO2Max) & kekuatan otot.<br/>• Penguasaan olahraga sunnah: Renang, Memanah, Beladiri, & Lari."]
        
        P1 & P2 & P3 & P4 ==> Output["INSAN ADABI BERJASMANI KUAT & SEHAT (QAWIYYUL JISM)"]
    end
```
...
```mermaid
flowchart LR
    J1["JENJANG J1 (KELAS 7)<br/>Adaptasi Higienitas Dasar<br/>• Mandi 2x sehari tertib.<br/>• Merawat pakaian bersih.<br/>• Pembiasaan makan sayur."]
    --> J2["JENJANG J2 (KELAS 8–9)<br/>Kebugaran & Olahraga Teratur<br/>• Senam pagi rutin & lari aerobik.<br/>• Latihan beladiri dasar.<br/>• Manajemen tidur sirkadian."]
    --> J3["JENJANG J3 (KELAS 10–11)<br/>Ketahanan & Olahraga Sunnah<br/>• Kemahiran renang / memanah.<br/>• Kebugaran VO2Max prima.<br/>• Tanggap darurat P3K asrama."]
    --> J4["JENJANG J4 (KELAS 12)<br/>Keteladanan Qudwah Jasmani<br/>• Instruktur olahraga adik kelas.<br/>• Gaya hidup sehat mandiri seumur hidup.<br/>• Duta sanitasi lingkungan."]
```
...
```mermaid
flowchart TD
    subgraph MultiTierPBISJasmani["ARSITEKTUR MULTI-TIER PBIS QAWIYYUL JISM"]
        Tier1["TIER 1: UNIVERSAL HEALTH PROMOTION (100% SANTRI)<br/>• Matriks Menu Dapur Seimbang (Standar AKG Kemenkes).<br/>• Jadwal Olahraga Aerobik 3x Sepekan & Senam Pagi Harian.<br/>• Inspeksi Sanitasi Kamar Mingguan Berhadiah 'Kamar Tersehat'."]
        
        Tier2["TIER 2: TARGETED HEALTH INTERVENTION (10–15% SANTRI BERISIKO)<br/>• Program CICO Poskestren bagi santri underweight/overweight.<br/>• Program bimbingan higienitas personal bagi santri bergejala awal sakit.<br/>• Sesi kebugaran fisik adaptif bagi santri berstamina rendah."]
        
        Tier3["TIER 3: INTENSIVE MEDICAL & RESTORATIVE CARE (1–5% SANTRI)<br/>• Ruang Isolasi Medis Nyaman & Bermartabat (Bukan Kamar Pengasingan Menakutkan).<br/>• Rencana Pemulihan Kesehatan Individual (Individual Health Recovery Plan).<br/>• Rujukan Medis Terkoordinasi ke Rumah Sakit Mitra & Notifikasi Orang Tua."]
