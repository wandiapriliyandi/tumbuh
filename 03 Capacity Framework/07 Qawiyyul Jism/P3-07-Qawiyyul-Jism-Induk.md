...
```mermaid
flowchart TD
    subgraph Arsitektur14SubModulQawiyyulJism["ARSITEKTUR LENGKAP 14 SUB-MODUL QAWIYYUL JISM"]
        subgraph FONDASI["1. FONDASI TEORETIS & AKSIOLOGIS"]
            M01["[P3-07-01] Filosofi & Turats (Al-Mu'minul Qawiyy)"]
            M02["[P3-07-02] Definisi & Konseptualisasi Kebugaran Holistik"]
            M03["[P3-07-03] Tujuan & Target Capaian Pembelajaran (CP-QJ)"]
            M04["[P3-07-04] Nilai Inti & Aksiologi Kesehatan Syar'i"]
        ...
        subgraph PRAKSIS["3. PRAKSIS ASESMEN, INTERVENSI, & DIDAKTIK"]
            ...
            M10["[P3-07-10] Protokol Intervensi PBIS Multi-Tier & Poskestren"]
...
```mermaid
flowchart LR
    J1["JENJANG J1 (KELAS 7)<br/>Adaptasi Higienitas & Puber<br/>• Mandi 2x tertib<br/>• Cuci baju sendiri<br/>• Senam pagi rutin<br/>• Tidur jam 21.30"]
    --> J2["JENJANG J2 (KELAS 8–9)<br/>Kebugaran & Pertumbuhan<br/>• Lari Cooper 2.400m<br/>• Beladiri pencak silat<br/>• Bebas skabies total<br/>• Qailulah siang rutin"]
    --> J3["JENJANG J3 (KELAS 10–11)<br/>Stamina & Olahraga Sunnah<br/>• Mahir Renang 50m<br/>• Panahan sasaran 15m<br/>• VO2Max kategori Prima<br/>• Sertifikasi P3K"]
    --> J4["JENJANG J4 (KELAS 12)<br/>Puncak Kebugaran & Qudwah<br/>• Instruktur senam santri<br/>• Duta sanitasi asrama<br/>• Gaya hidup sehat otonom<br/>• Postur atletis tegap"]
```
...
```mermaid
flowchart TD
    subgraph SistemPBISJasmani24Jam["SISTEM DISIPLIN RESTORATIF PBIS KESEHATAN 24 JAM"]
        T1["TIER 1: UNIVERSAL HEALTH PROMOTION (100% Santri)<br/>• Rasio Apresiasi Positif 4:1 bagi Kamar Terbersih & Terwangi.<br/>• Fasilitas Sanitasi WASH Lengkap (Air Bersih, Sabun, Filter Minum RO).<br/>• Menu Dapur Seimbang Sesuai AKG & Senam Pagi Harian."]
        
        T2["TIER 2: TARGETED INTERVENTION (10–15% Santri Berisiko)<br/>• Program Check-In / Check-Out (CICO) Poskestren Harian.<br/>• Modifikasi Menu Gizi Khusus Kasus Underweight / Anemia.<br/>• Sesi Bimbingan Kebugaran Fisik Adaptif Terpandu."]
        
        T3["TIER 3: INTENSIVE MEDICAL CARE (1–5% Kasus Khusus)<br/>• Ruang Rawat Inap / Isolasi Medis Poskestren yang Nyaman & Bermartabat.<br/>• Pengobatan Tuntas Penyakit Kulit / Infeksi Menular (Zero-Scabies).<br/>• Rujukan Rumah Sakit Mitra & Koordinasi Penuh dengan Wali Santri."]
