...
```mermaid
flowchart TD
    subgraph TransformasiObservasiKesehatan["REKONSTRUKSI OBSERVASI PERILAKU KESEHATAN"]
        Reaktif["OBSERVASI REAKTIF TRADISIONAL<br/>• Baru diperiksa saat santri pingsan / demam tinggi.<br/>• Perilaku begadang, dehidrasi, & kumuh dibiarkan.<br/>• Penyebaran penyakit menular terlambat diantisipasi."]
        
        TUMBUH["OBSERVASI PERILAKU TERPADU (TUMBUH)<br/>• Pemetaan perilaku teramati di 5 setting asrama 24 jam.<br/>• Deteksi dini perilaku berisiko (kurang tidur, malnutrisi).<br/>• Pembiasaan proaktif berbasis data analitik Poskestren."]
        
        Reaktif ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsAdabFisik["PERILAKU PEMELIHARAAN RAGA NABAWI"]
        HaditsSiwak["HR. Al-Bukhari & Muslim:<br/>لَوْلَا أَنْ أَشُقَّ عَلَى أُمَّتِي لَأَمَرْتُهُمْ بِالسِّوَاكِ عِنْدَ كُلِّ صَلَاةٍ<br/>(Adab Higienitas Mulut & Gigi Berkala)"] --> Inti["Al-Harakah as-Salimah:<br/>Perilaku Hidup Bersih & Sehat Adalah Sunnah Amaliyyah"]
        HaditsTidur["HR. Al-Bukhari (Adab Tidur):<br/>Berwudhu Sebelum Tidur, Memiringkan Badan ke Kanan, & Kibas Kasur"] --> Inti
        HaditsMakan["HR. Muslim (Adab Makan):<br/>Makan dengan Tangan Kanan & Menjilati Jari (Anti-Mubazir)"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsModelPerilakuKesehatan["SINTESIS ABA DAN HEALTH BELIEF MODEL"]
        HBM["Health Belief Model (Rosenstock, 1974):<br/>• Perceived Susceptibility (Sadar Risiko Penyakit)<br/>• Perceived Severity (Paham Bahaya Skabies/Fatigue)<br/>• Perceived Benefits (Merasakan Manfaat Raga Bugar)<br/>• Cues to Action (Pengingat Visual & Musyrif)"]
        
        ABA["Applied Behavior Analysis (Cooper et al., 2020):<br/>• Stimulus Kontrol: Penataan Loker Rapi & Akses Air Bersih.<br/>• Reinforcement: Apresiasi Kebiasaan Makan Sehat & Olahraga."]
        
        HBM & ABA ==> SistemPerilaku["SISTEM MANIFESTASI PERILAKU QAWIYYUL JISM"]
    end
```
...
```mermaid
flowchart TD
    subgraph LimaSettingJasmani["LIMA SETTING KRUSIAL MANIFESTASI KESEHATAN"]
        S1["1. SETTING KAMAR MANDI & TEMPAT WUDHU<br/>• Perilaku: Mandi tertib 2x, istinja' bersih, sikat gigi, tidak meninggalkan pakaian basah."]
        
        S2["2. SETTING RUANG MAKAN & KANTIN<br/>• Perilaku: Cuci tangan sabun, makan sayur/protein seimbang, minum air putih 2.5L, anti-sampah plastik."]
        
        S3["3. SETTING KAMAR TIDUR & LOKER<br/>• Perilaku: Menjemur kasur berkala, loker pakaian rapi, ventilasi jendela terbuka, tidur 21.30."]
        
        S4["4. SETTING LAPANGAN OLAHRAGA & SENAM<br/>• Perilaku: Pemanasan tertib, antusias senam pagi, lari aerobik, sportivitas tinggi."]
        
        S5["5. SETTING POSKESTREN & RUANG KESEHATAN<br/>• Perilaku: Melapor mandiri saat gejala awal sakit, minum obat tertib, menjaga kebersihan ruang isolasi."]
        
        S1 & S2 & S3 & S4 & S5 --> Terpadu["EKOSISTEM ASRAMA SEHAT 24 JAM"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolEdukasiMencuci["PROTOKOL PEMBIASAAN HIGIENITAS PAKAIAN TIER 2"]
        Step1["1. WORKSHOP KETERAMPILAN MENCUCI PRAKTIS (LAUNDRY CLINIC)<br/>• Musyrif melatih santri cara memilah pakaian, mengucek, membilas, & menjemur rapi."]
        
        Step2["2. PENYEDIAAN KERANJANG PAKAIAN KOTOR BERLUBANG (AERATED LAUNDRY BASKET)<br/>• Mengganti kantong plastik tertutup dengan keranjang berventilasi anti-lembap."]
        
        Step3["3. PENJADWALAN MENCUCI BERGILIR KAMAR (WASHING SCHEDULE)<br/>• Pembagian waktu mencuci pagi/sore per klaster kamar tidur."]
        
        Step4["4. INSPEKSI LOKER 'BEBAS AROMA APEK' MINGGUAN<br/>• Apresiasi kamar paling rapi dan wangi dalam apel mingguan."]
...
| :--- | :--- | :--- |
| **1. At-Thaharah (Higienitas)** | • Mandi mandiri 2x sehari menggunakan sabun dan air mengalir.<br/>• Menyikat gigi minimal 2x sehari (pagi dan sebelum tidur malam).<br/>• Mengganti pakaian dalam dan kaos kaki setiap hari.<br/>• Memotong kuku tangan dan kaki setiap hari Jumat secara tertib.<br/>• Merapikan sprei dan menjemur bantal/kasur di bawah sinar matahari. | • Jarang mandi atau hanya "mandi bebek" tanpa sabun.<br/>• Tidur malam tanpa menyikat gigi.<br/>• Mengenakan pakaian/sarung yang sama berhari-hari hingga kotor.<br/>• Kuku panjang dan hitam menyimpan kotoran.<br/>• Membiarkan kasur lembap, berdebu, dan penuh remah makanan. |
| **2. Al-Giza' (Nutrisi Thayyib)** | • Menghabiskan porsi sarapan pagi dan sayuran dapur pondok.<br/>• Minum air putih minimal 8 gelas (2–2.5 liter) setiap hari.<br/>• Duduk tertib dan membaca doa sebelum/sesudah makan.<br/>• Mencuci tangan dengan sabun sebelum menyentuh makanan.<br/>• Memilih makanan segar dan menghindari jajanan berpengawet. | • Melewatkan sarapan pagi lalu mengonsumsi gorengan jelantah.<br/>• Jarang minum air putih dan menggantinya dengan minuman manis buatan.<br/>• Makan sambil berdiri, berjalan, atau terburu-buru.<br/>• Makan tanpa cuci tangan pasca-beraktivitas di luar ruangan.<br/>• Menyimpan makanan sisa di kamar hingga basi dan berjamur. |
| **3. An-Naum (Tidur Sirkadian)** | • Bersiap tidur pukul 21.00 dan mematikan lampu kamar pukul 21.30.<br/>• Berwudhu dan membaca doa/zikir sebelum tidur.<br/>• Tidur memiringkan badan ke sisi kanan sesuai sunnah Nabawiyyah.<br/>• Bangun tidur secara mandiri saat azan Awwal/Shubuh.<br/>• Melakukan tidur siang singkat (*Qailulah*) 15–20 menit. | • Begadang lewat tengah malam untuk mengobrol atau membaca komik.<br/>• Tidur dalam keadaan badan kotor penuh keringat.<br/>• Tidur tengkurap atau dengan posisi leher tertekuk membahayakan saraf.<br/>• Sangat sulit dibangunkan Shubuh (harus ditarik atau disiram air).<br/>• Tertidur pulas di ruang kelas saat jam pelajaran berlangsung. |
| **4. Ar-Riyadhah (Kebugaran)** | • Antusias mengikuti senam pagi dan lari aerobik mingguan.<br/>• Melakukan pemanasan dan pendinginan sebelum/sesudah olahraga.<br/>• Memelihara postur duduk tegap saat mengaji di masjid dan kelas.<br/>• Menunjukkan sportivitas tinggi dan menghormati keselamatan kawan.<br/>• Aktif berlatih olahraga sunnah (renang, memanah, beladiri). | • Malas berolahraga dan mencari alasan palsu sakit di Poskestren.<br/>• Langsung berolahraga berat tanpa pemanasan memicu cedera otot.<br/>• Duduk membungkuk menempelkan dada ke meja/lantai saat mengaji.<br/>• Emosional, bermain kasar, dan memicu perkelahian di lapangan.<br/>• Menolak mencoba aktivitas fisik baru karena minder/takut lelah. |
...
```mermaid
flowchart TD
    subgraph MatriksSettingJasmani24Jam["PETA PERILAKU SEHAT LINTAS SETTING ASRAMA"]
        KamarTidur["KAMAR TIDUR ASRAMA:<br/>• (+) Sprei rapi, loker bersih, jemur kasur, tidur jam 21.30, wudhu sebelum tidur.<br/>• (-) Pakaian kotor menumpuk di ranjang, begadang, makan di atas kasur."]
        
        KamarMandi["KAMAR MANDI & TOILET:<br/>• (+) Antre tertib, istinja' tuntas, sabun pribadi, matikan keran air.<br/>• (-) Meninggalkan celana basah di lantai, membuang plastik di kloset, tidak menyiram toilet."]
        
        RuangMakan["RUANG MAKAN & DAPUR:<br/>• (+) Cuci tangan sabun, makan sayur/protein habis, minum air putih cukup, nampan bersih.<br/>• (-) Berebut lauk, buang sisa makanan berlebih (mubazir), jajan sembarangan."]
        
        KelasMadrasah["KELAS & PERPUSTAKAAN:<br/>• (+) Postur duduk tegap, ventilasi jendela dibuka, mata tidak terlalu dekat ke buku.<br/>• (-) Tidur di atas meja, membaca dalam gelap, postur bungkuk."]
        
        LapanganFisik["LAPANGAN OLAHRAGA:<br/>• (+) Senam pagi bersemangat, lari aerobik tuntas, pemanasan tertib, minum teratur.<br/>• (-) Duduk melamun di pinggir lapangan, bermain kasar, tidak ganti pakaian olahraga."]
        
        KamarTidur ~~~ KamarMandi ~~~ RuangMakan ~~~ KelasMadrasah ~~~ LapanganFisik
    end
```
...
| :--- | :--- | :--- |
| **Jenjang J1 (Kelas 7)** | • Mandi mandiri 2x sehari secara bersih tanpa perlu disuruh musyrif.<br/>• Menghabiskan porsi sayur dan buah yang disediakan dapur pondok.<br/>• Tidur tepat waktu pukul 21.30 dan bangun Shubuh mandiri. | • Menangis menolak mandi atau takut antre kamar mandi (*Sanitation Phobia*).<br/>• Membuang sayuran ke tempat sampah dan hanya makan nasi dengan kerupuk.<br/>• Mengompol (*Enuresis*) akibat stres adaptasi atau jarang buang air sebelum tidur. |
| **Jenjang J2 (Kelas 8–9)** | • Bebas dari penyakit kulit dan aktif menjaga kebersihan lemari pribadi.<br/>• Mengikuti latihan beladiri dasar dan senam kesegaran jasmani.<br/>• Membiasakan qailulah 20 menit pasca-shalat Zhuhur. | • Menumpuk pakaian basah di dalam tas tertutup hingga berjamur.<br/>• Mengonsumsi mi instan mentah atau minuman berenergi ilegal.<br/>• Begadang mengobrol di lorong asrama melewati batas jam malam. |
| **Jenjang J3 (Kelas 10–11)** | • Memiliki stamina kardiorespirasi prima (mampu lari 2.400m tanpa henti).<br/>• Menguasai teknik renang 50m atau panahan jarak 15m.<br/>• Tanggap melakukan pertolongan pertama (P3K) jika ada kawan terluka. | • Merokok atau mencoba zat adiktif berbahaya di area titik buta pondok.<br/>• Menolak berolahraga dengan dalih "fokus belajar ujian akademik".<br/>• Memaksakan diri begadang hingga jatuh sakit dan anemia. |
| **Jenjang J4 (Kelas 12)** | • Menjadi teladan hidup sehat (*Qudwah*) dalam pola makan dan olahraga.<br/>• Memimpin senam pagi dan membimbing olahraga adik kelas J1.<br/>• Menginspeksi dan menjaga standar kebersihan lingkungan pondok. | • Menampilkan kemalasan fisik dengan dalih "sudah kelas akhir".<br/>• Menyalahgunakan izin keluar pondok untuk membeli makanan tidak sehat.<br/>• Melalaikan waktu istirahat malam akibat kecemasan masa depan kuliah. |
...
Penerapan konsep **P3-07-06: MANIFESTASI PERILAKU SANTRI QAWIYYUL JISM** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
