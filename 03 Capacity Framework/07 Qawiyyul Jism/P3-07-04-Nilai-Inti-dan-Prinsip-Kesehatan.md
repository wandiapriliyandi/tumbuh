...
```mermaid
flowchart TD
    subgraph RekonstruksiAksiologiKesehatan["REKONSTRUKSI NILAI KESEHATAN PESANTREN"]
        Dikotomi["DIKOTOMI NILAI TRADISIONAL<br/>• Thaharah hanya hafalan teori najis.<br/>• Kamar mandi kotor & sampah dibiarkan.<br/>• Makanan nir-gizi & malas olahraga dinormalisasi."]
        
        TUMBUH["AKSIOLOGI QAWIYYUL JISM TUMBUH<br/>• Thaharah: Higienitas nyata raga & lingkungan.<br/>• I'tidal Nutrisi: Makanan halalan thayyiban seimbang.<br/>• Quwwah Harakiyyah: Etos kebugaran fisik & olahraga sunnah.<br/>• Hifzhus Sihhah: Raga adalah amanah Ilahi yang wajib dijaga."]
        
        Dikotomi ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph EmpatAkarNilaiKesehatan["EMPAT AKAR NILAI TURATS QAWIYYUL JISM"]
        N1["1. AT-THAHARAH (HR. Muslim No. 223)<br/>الطُّهُورُ شَطْرُ الْإِيمَانِ<br/>(Kebersihan Adalah Separuh Keimanan)"]
        N2["2. AL-I'TIDAL GIZA'I (QS. Al-A'raf: 31)<br/>وَكُلُوا وَاشْرَبُوا وَلَا تُسْرِفُوا<br/>(Makan & Minum Tanpa Israf/Boros)"]
        N3["3. AL-QUWWAH (HR. Muslim No. 2664)<br/>الْمُؤْمِنُ الْقَوِيُّ خَيْرٌ وَأَحَبُّ إِلَى اللَّهِ<br/>(Keutamaan Raga yang Kuat)"]
        N4["4. HIFZHUS SIHHAH (HR. Al-Bukhari No. 6412)<br/>نِعْمَتَانِ مَغْبُونٌ فِيهِمَا كَثِيرٌ مِنَ النَّاسِ: الصِّحَّةُ وَالْفَرَاغُ<br/>(Amanah Nikmat Sehat & Waktu Luang)"]
        
        N1 & N2 & N3 & N4 --> Puncak["QAWIYYUL JISM PARIPURNA"]
    end
```
...
```mermaid
flowchart TD
    subgraph SainsMotivasiKesehatan["SINTESIS TEORI DETERMINASI DIRI & SANITASI"]
        SDT["Self-Determination Theory (Deci & Ryan, 2000):<br/>• Autonomy: Santri merawat kesehatan atas kesadaran mandiri.<br/>• Competence: Menguasai keterampilan kebugaran & olahraga.<br/>• Relatedness: Solidaritas menjaga kebersihan kamar bersama."]
        
        Sanitasi["Environmental Sanitation (WHO, 2020):<br/>• Akses air bersih (WASH: Water, Sanitation, Hygiene).<br/>• Reduksi transmisi patogen fecal-oral & tungau kulit."]
        
        SDT & Sanitasi ==> BudayaSehat["BUDAYA ASRAMA SEHAT BERKELANJUTAN"]
    end
```
...
```mermaid
flowchart TD
    subgraph TransformasiKulturKamar["REKAYASA IKLIM HIGIENITAS ASRAMA"]
        KamarBau["KULTUR KAMAR ASRAMA KUMUH (TRADISIONAL):<br/>• Pakaian kotor tergantung di ventilasi jendela menghalangi udara.<br/>• Karpet lembap, aroma apek, & sandal berserakan di depan pintu."]
        
        Pembersihan["SOP KAMAR ASRI & SEHAT TUMBUH:<br/>• Larangan menggantung pakaian di ventilasi jendela.<br/>• Rak sandal tertib & tempat jemur pakaian luar ruangan terbuka.<br/>• Pembersihan karpet berkala & penggunaan pengharum alami."]
        
        KamarWangi["HASIL IKLIM ASRAMA BARU:<br/>• Kamar terang benderang, udara segar mengalir lancar.<br/>• Santri tenang belajar & tidur nyenyak bebas gigitan serangga."]
        
        KamarBau ==> Pembersihan ==> KamarWangi
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolResolusiSanitasi["PROTOKOL RESTORASI SANITASI FASILITAS ASRAMA"]
        Langkah1["1. PERBAIKAN INFRASTRUKTUR & PENYEDIAAN FASILITAS LENGKAP<br/>• Pihak pondok memperbaiki saluran mampet & mengecat ulang dinding.<br/>• Menyediakan tempat sampah tertutup, sikat toilet, & sabun wangi di setiap bilik."]
        
        Langkah2["2. PENYUSUNAN PIAGAM ADAB THAHARAH ASRAMA BERSAMA<br/>• Musyrif memfasilitasi halaqah penyusunan aturan bersama penggunaan toilet."]
        
        Langkah3["3. SISTEM PIKET BERGILIR KOLABORATIF (DUO SYSTEM)<br/>• Santri membersihkan kamar mandi secara berpasangan (1 Santri J3 + 1 Santri J2).<br/>• Musyrif memberikan inspeksi harian dengan checklist transparan."]
        
        Langkah4["4. APRESIASI LOMBA 'TOILET TERWANGI & TERBERSIH'<br/>• Pemberian reward mingguan bagi asrama dengan sanitasi terbaik."]
...
```mermaid
flowchart TD
    subgraph FormulasiEmpatNilaiKesehatan["STRUKTUR AKSIOLOGIS EMPAT NILAI QAWIYYUL JISM"]
        Thaharah["1. AT-THAHARAH AL-KAMILAH (HIGIENITAS TOTAL)<br/>• Kesucian badan, pakaian, tempat shalat, & kamar tidur.<br/>• Mandi tertib, sikat gigi rutin, wudhu sempurna, & anti-kumuh."]
        
        Itidal["2. AL-I'TIDAL AL-GIZA'I (MODERASI NUTRISI SEHAT)<br/>• Memilih makanan halalan thayyiban bergizi seimbang.<br/>• Adab sepertiga perut, anti-israf, & menjauhi makanan sampah."]
        
        Quwwah["3. AL-QUWWAH AL-HARAKIYYAH (VITALITAS MOTORIK & OLAHRAGA)<br/>• Kebugaran aerobik prima & kekuatan otot tubuh.<br/>• Kemahiran olahraga sunnah (renang, panahan, beladiri, lari)."]
        
        Hifzh["4. HIFZHUS SIHHAH (TANGGUNG JAWAB PREVENTIF)<br/>• Menjaga amanah tubuh dari cedera, begadang, & penyakit.<br/>• Istirahat sirkadian cukup & kepatuhan protokol Poskestren."]
        
        Thaharah & Itidal & Quwwah & Hifzh ==> Mahkota["QAWIYYUL JISM PARIPURNA"]
    end
```
...
```mermaid
flowchart LR
    J1["J1 (KELAS 7)<br/>Habituasi Higienitas Dasar<br/>• Mandi 2x sehari tertib.<br/>• Merapikan kasur & baju.<br/>• Makan sayur dapur pondok."]
    --> J2["J2 (KELAS 8–9)<br/>Regulasi Kebugaran & Tidur<br/>• Senam & lari teratur.<br/>• Beladiri dasar.<br/>• Disiplin tidur sirkadian 7 jam."]
    --> J3["J3 (KELAS 10–11)<br/>Internalisasi Olahraga Sunnah<br/>• Mahir renang / panahan.<br/>• Pemilihan nutrisi mandiri.<br/>• Relawan PMR Poskestren."]
    --> J4["J4 (KELAS 12)<br/>Keteladanan Qudwah Sehat<br/>• Instruktur olahraga adik kelas.<br/>• Duta sanitasi asrama.<br/>• Gaya hidup sehat seumur hidup."]
```
...
Penerapan konsep **P3-07-04: NILAI INTI DAN PRINSIP KESEHATAN QAWIYYUL JISM** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
