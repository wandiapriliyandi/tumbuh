...
```mermaid
flowchart TD
    subgraph TransformasiKurikulumHalaqah["REKONSTRUKSI KURIKULUM HALAQAH PESANTREN"]
        Teori["HALAQAH PASIF TANPA FISIK (TRADISIONAL)<br/>• 100% ceramah doktrinal duduk diam di lantai.<br/>• Masalah kesehatan, tidur, gizi, & kebugaran diabaikan.<br/>• Santri jenuh, mengantuk, & fisik tetap lemah."]
        
        TUMBUH["KURIKULUM HALAQAH QAWIYYUL JISM (TUMBUH)<br/>• 24 Pekan Silabus Thibb Nabawi & Kebugaran Terpadu.<br/>• 30 Menit Kajian Turats + 60 Menit Praktik Olahraga Sunnah.<br/>• Mentorship Kakak Asuh J4–J1 & Sertifikasi Kebugaran."]
        
        Teori ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsPembinaanJasmani["MODEL TARBIYAH JASMANI NABAWI"]
        HaditsLomba["HR. Abu Dawud No. 2578:<br/>Lomba Lari Rasulullah SAW bersama Ummul Mukminin Aisyah RA"] --> Inti["Tarbiyah Jasadiyyah Nabawiyyah:<br/>Olahraga Adalah Sarana Keakraban, Kegembiraan, & Kebugaran"]
        HaditsGulat["HR. Abu Dawud (Gulat Nabawi):<br/>Nabi SAW Menantang Rukanah Bergulat & Mengalahkannya"] --> Inti
        HaditsPanahan["HR. Al-Bukhari No. 2899:<br/>ارْمُوا بَنِي إِسْمَاعِيلَ فَإِنَّ أَبَاكُمْ كَانَ رَامِيًا<br/>(Memanah Adalah Warisan Kesatria Nabi Ismail AS)"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsExperientialJasmani["SINTESIS EXPERIENTIAL LEARNING JASMANI"]
        Kolb["David Kolb's Experiential Learning Cycle (1984):<br/>1. Concrete Experience (Praktik Olahraga Sunnah)<br/>2. Reflective Observation (Muhasabah Stamina & Kelelahan)<br/>3. Abstract Conceptualization (Kajian Thibb Nabawi & Fisiologi)<br/>4. Active Experimentation (Penerapan Pola Hidup Sehat)"]
        
        Social["Social-Emotional Learning (CASEL):<br/>• Self-Management: Regulasi Napas & Emosi saat Memanah.<br/>• Relationship Skills: Kerjasama Tim dalam Beladiri/Renang."]
        
        Kolb & Social ==> ModelHalaqah["MODEL HALAQAH QAWIYYUL JISM TUMBUH"]
    end
```
...
```mermaid
flowchart LR
    Sesi1["SESI 1 (30 Menit):<br/>Dialog Thibb Nabawi<br/>• Matan Zadul Ma'ad<br/>• Fiqh Thaharah Bulugh<br/>• Edukasi Gizi & Tidur"]
    --> Sesi2["SESI 2 (60 Menit):<br/>Praktik Kebugaran Terpadu<br/>• Pemanasan Dinamis<br/>• Latihan Olahraga Sunnah<br/>• Pendinginan & Hidrasi"]
    --> Sesi3["SESI 3 (15 Menit):<br/>Muhasabah & Evaluasi<br/>• Cek Mutaba'ah Sehat<br/>• Apresiasi Pencapaian"]
```
...
```mermaid
flowchart TD
    subgraph ProtokolDeeskalasiBurnout["PROTOKOL DE-ESKALASI KELELAHAN KOGNITIF"]
        Step1["1. MORATORIUM KAJIAN DUDUK STATIS SEMENTARA<br/>• Mengganti sesi halaqah kelas dengan aktivitas luar ruangan di alam terbuka."]
        
        Step2["2. PELAKSANAAN FESTIVAL OLAHRAGA SUNNAH GEMBIRA (SUNNAH GAMES)<br/>• Lomba panahan beregu, estafet renang gembira, & permainan ketangkasan tradisional."]
        
        Step3["3. ASUPAN NUTRISI PEMULIHAN ENERGI (HERBAL SMOOTHIES)<br/>• Pemberian minuman madu lemon hangat, kurma, & pisang kaya kalium."]
        
        Step4["4. REFLEKSI KESEGARAN AKAL PASCA-OLAHRAGA<br/>• Santri merasakan lonjakan endorfin & kesiapan belajar kembali tajam."]
...
```mermaid
flowchart TD
    subgraph Silabus24PekanHalaqah["SILABUS 24 PEKAN HALAQAH QAWIYYUL JISM"]
        M1["MODUL 1 (Pekan 1–6): FONDASI THAHARAH & SANITASI ASRAMA<br/>• Hakikat raga amanah Ilahi, Fiqh Thaharah Bulugh, Zero-Scabies, sanitasi kamar."]
        
        M2["MODUL 2 (Pekan 7–12): GIZI THAYYIB & MANAJEMEN TIDUR SIRKADIAN<br/>• Adab sepertiga perut, bahaya junk food, neurosains tidur 7 jam, sunnah qailulah."]
        
        M3["MODUL 3 (Pekan 13–18): KEBUGARAN MOTORIK & OLAHRAGA SUNNAH<br/>• Fisiologi kardiorespirasi (BDNF), teknik renang gaya dada, panahan fokus, beladiri."]
        
        M4["MODUL 4 (Pekan 19–24): KESEHATAN KOMUNITAS & KEPEMIMPINAN QUDWAH<br/>• Keterampilan P3K asrama, sanitasi lingkungan eco-pesantren, evaluasi portofolio kelulusan."]
...
```mermaid
flowchart TD
    subgraph SistemMentorshipJasmani["SISTEM MENTORSHIP KAKAK ASUH JASMANI J4–J1"]
        J4Leader["SANTRI SENIOR JENJANG J4 (INSTRUKTUR KESEHATAN)<br/>• Dilatih oleh Guru Penjas & Dokter Poskestren.<br/>• Berperan sebagai Mentor, Pelatih Pemanasan, & Teladan Adab."]
        
        J1Junior["SANTRI JUNIOR JENJANG J1 (SANTRI ASUH)<br/>• Didampingi saat latihan renang, senam pagi, & sanitasi kamar.<br/>• Memperoleh rasa aman & bimbingan fisik yang hangat."]
        
        J4Leader ==>|MEMBIMBING DENGAN KASIH SAYANG| J1Junior
        J1Junior ==>|MENGHORMATI SEBAGAI TELADAN| J4Leader
    end
```
...
Penerapan konsep **P3-07-11: PROGRAM PEMBINAAN DAN HALAQAH QAWIYYUL JISM** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
