...
```mermaid
flowchart TD
    subgraph TransformasiIntervensiJasmani["REKONSTRUKSI SISTEM INTERVENSI KESEHATAN"]
        Hukuman["PARADIGMA HUKUMAN FISIK (TRADISIONAL)<br/>• Push-up paksa, siram air es, & jemur matahari.<br/>• Memicu cedera sendi, trauma mental, & dendam.<br/>• Masalah sanitasi & kurang tidur tetap tidak selesai."]
        
        TUMBUH["ARSITEKTUR MULTI-TIER PBIS TUMBUH<br/>• Tier 1: Promosi kesehatan 100% santri & penguatan 4:1.<br/>• Tier 2: Pendampingan CICO Poskestren & gizi personal.<br/>• Tier 3: Isolasi medis humanis & pemulihan bertahap.<br/>• 0% kekerasan fisik; penegakan disiplin firm & kind."]
        
        Hukuman ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsKasihSayangRaga["PRINSIP KELEMBUTAN TERHADAP RAGA DALAM TURATS"]
        HaditsRifq["HR. Muslim No. 2594:<br/>إِنَّ الرِّفْقَ لَا يَكُونُ فِي شَيْءٍ إِلَّا زَانَهُ، وَلَا يُنْزَعُ مِنْ شَيْءٍ إِلَّا شَانَهُ<br/>(Kelembutan Menghiasi Segala Sesuatu)"] --> Inti["Ar-Rifq bil Abdan:<br/>Merawat Jasmani Santri dengan Kasih Sayang & Kebijakan Mendidik"]
        HaditsDharar["HR. Ibnu Majah:<br/>لَا ضَرَرَ وَلَا ضِرَارَ<br/>(Larangan Mutlak Memberikan Kemudaratan Fisik)"] --> Inti
        IbnuQayyim["Ibnu Qayyim (Zadul Ma'ad):<br/>Larangan Membebani Tubuh Melampaui Batas Fitrah"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph PiramidaPBISJasmani["PIRAMIDA PBIS MULTI-TIER QAWIYYUL JISM"]
        T1["TIER 1: UNIVERSAL HEALTH PROMOTION (80–90% Santri)<br/>• Fasilitas Sanitasi WASH Lengkap (Sabun, Air Bersih, Tempat Sampah).<br/>• Menu Dapur Seimbang AKG & Olahraga Aerobik 3x Sepekan.<br/>• Rasio Penguatan Positif 4:1 & Matriks Ekspektasi Sanitasi."]
        
        T2["TIER 2: TARGETED HEALTH INTERVENTION (10–15% Santri)<br/>• Program Check-In / Check-Out (CICO) Poskestren.<br/>• Bimbingan Nutrisi Personal (Kasus Underweight/Overweight).<br/>• Sesi Olahraga Adaptif bagi Santri Berstamina Rendah."]
        
        T3["TIER 3: INTENSIVE MEDICAL & RESTORATIVE CARE (1–5% Santri)<br/>• Ruang Isolasi Medis Nyaman Ber-AC/Air Purifier.<br/>• Rencana Pemulihan Kesehatan Individual (Individual Health Recovery Plan).<br/>• Rujukan Rumah Sakit Mitra & Koordinasi Penuh dengan Orang Tua."]
...
```mermaid
flowchart TD
    subgraph RekayasaFasilitasSehat["REKAYASA FASILITAS PENDUKUNG KESEHATAN"]
        F1["1. SARANA HIGIENITAS: Wastafel cuci tangan dengan sabun cair otomatis di depan ruang makan & masjid."]
        F2["2. SARANA AIR BERSIH: Filter air minum reverse osmosis gratis & instalasi air mandi bebas bau."]
        F3["3. SARANA OLAHRAGA: Lapangan futsal/basket terawat, area panahan aman, & akses kolam renang."]
        F4["4. POSKESTREN TERPADU: Ruang periksa dokter, apotek lengkap, & kamar isolasi manusiawi."]
        
        F1 & F2 & F3 & F4 ==> Sukses["KULTUR ASRAMA SEHAT BERKELANJUTAN"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolPenangananFobiaMandi["PROTOKOL PENDAMPINGAN HIGIENITAS TIER 2"]
        StepA["1. PENELUSURAN EMPATIK OLEH MUSYRIF (DIALOG FIRM & KIND)<br/>• Musyrif mengajak Santri R berbicara privat, mendengarkan ketakutannya tanpa mengejek."]
        
        StepB["2. PENYEDIAAN AIR HANGAT TRANSISI DI POSKESTREN<br/>• Selama 3 hari pertama, Santri R difasilitasi mandi air hangat di Poskestren."]
        
        StepC["3. DESENSITISASI SISTEMATIS TERHADAP AIR DINGIN<br/>• Musyrif melatih santri membasahi kaki dan tangan terlebih dahulu secara bertahap."]
        
        StepD["4. SISTEM BUDDY ASUH DENGAN SANTRI SENIOR J4<br/>• Kakak asuh J4 mendampingi Santri R saat jam mandi asrama dengan suasana riang."]
...
```mermaid
flowchart TD
    subgraph TigaLapisPBISJasmani["SISTEM TIGA LAPIS INTERVENSI PBIS QAWIYYUL JISM"]
        subgraph TIER1["TIER 1: PENCEGAHAN UNIVERSAL (100% SANTRI)"]
            T1A["• Menu Seimbang Halalan Thayyiban Dapur."]
            T1B["• Senam Pagi Harian & Olahraga Aerobik 3x Sepekan."]
            T1C["• Inspeksi Sanitasi Kamar Mingguan 'Kamar Wangi'."]
            T1D["• Edukasi Thaharah & Fiqh Bulugh di Halaqah."]
        end
        
        subgraph TIER2["TIER 2: INTERVENSI TERARAH (10–15% SANTRI BERISIKO)"]
            T2A["• Check-In / Check-Out (CICO) Poskestren Harian."]
            T2B["• Program Gizi Khusus Underweight / Overweight."]
            T2C["• Latihan Kebugaran Fisik Adaptif Terpandu."]
            T2D["• Workshop Keterampilan Mencuci Pakaian & Higienitas."]
        end
        
        subgraph TIER3["TIER 3: PERAWATAN INTENSIF & MEDIS (1–5% SANTRI KRISIS)"]
            T3A["• Isolasi Medis Humanis Kasus Infeksi Menular."]
            T3B["• Individual Health Recovery Plan (IHRP) Dokter."]
            T3C["• Konseling Medis-Psikologis Komprehensif."]
            T3D["• Koordinasi Rujukan Rumah Sakit & Kemitraan Orang Tua."]
        end
...
| :--- | :--- | :--- | :--- | :--- |
| **Tier 1 (Universal)** | 100% Seluruh Santri Pondok | • Penyediaan fasilitas sanitasi WASH lengkap.<br/>• Penguatan positif rasio 4:1 (memuji kebersihan kamar).<br/>• Senam pagi 15 menit & olahraga aerobik mingguan.<br/>• Jadwal tidur sirkadian tepat waktu pukul 21.30. | Harian & Berkelanjutan sepanjang tahun | Seluruh Musyrif, Guru Penjas, & Staf Dapur |
| **Tier 2 (Targeted)** | 10–15% Santri yang berisiko kesehatan (anemia, stamina rendah, kumuh, obesitas) | • Program CICO Poskestren (monitoring sarapan & obat).<br/>• Modifikasi menu gizi tinggi protein/zat besi.<br/>• Kelas bimbingan kebugaran adaptif low-impact.<br/>• Pendampingan higienitas pakaian oleh kakak asuh J4. | 4–8 Pekan (Evaluasi tiap pekan) | Musyrif Pendamping, Guru Penjas Adaptif, & Perawat Poskestren |
| **Tier 3 (Intensive)** | 1–5% Santri yang mengalami infeksi menular (skabies parah, cacar, ISPA akut) | • Perawatan di Ruang Isolasi Medis Nyaman Poskestren.<br/>• Terapi farmakologis tuntas di bawah dokter spesialis.<br/>• Dekontaminasi total lingkungan kamar tidur santri.<br/>• Rencana pemulihan stamina pasca-sakit terstruktur. | 7–14 Hari (Hingga sembuh total) | Dokter Poskestren, Tim Medis Mitra, & Musyrif Senior |
...
Penerapan konsep **P3-07-10: PROTOKOL INTERVENSI DAN PEMBIASAAN QAWIYYUL JISM** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
