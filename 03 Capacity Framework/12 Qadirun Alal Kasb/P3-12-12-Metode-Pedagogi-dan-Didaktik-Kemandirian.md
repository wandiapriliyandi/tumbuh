...
```mermaid
flowchart TD
    subgraph TransformasiDidaktikWirausaha["REKONSTRUKSI DIDAKTIK KEMANDIRIAN FINANSIAL"]
        Tekstual["PEDAGOGI TEKSTUAL HAFALAN (TRADISIONAL)<br/>• Hafalan fiqh muamalah tanpa studi kasus modern.<br/>• Guru tidak memiliki unit usaha & nir-keteladanan.<br/>• Santri tidak pernah praktik mengelola laba riil."]
        
        TUMBUH["EMPAT MODEL DIDAKTIK KEMANDIRIAN TUMBUH<br/>• Living Entrepreneurial Exemplary: Pendidik mandiri & ber-izzah.<br/>• Socratic Business Dilemma & Venture Incubator Lab.<br/>• Micro-Financial Habit Conditioning & Problem-Based Learning.<br/>• Pembelajaran vokasi terpadu melahirkan santri preneur beradab."]
...
```mermaid
flowchart LR
    subgraph TuratsKeteladananNiagaSalaf["DIDAKTIK KEMANDIRIAN SALAF"]
        HaditsNabi["HR. Al-Bukhari No. 2287:<br/>Rasulullah SAW Berniaga Membawa Barang Khadijah RA dengan Amanah & Menghasilkan Laba Besar"] --> Inti["Didaktik Qadirun 'Alal Kasb:<br/>Keteladanan Nyata Pendidik dalam Membangun Kemandirian & Integritas"]
        AbuHanifah["Imam Abu Hanifah:<br/>Mengajak Murid-Muridnya ke Toko Sutra & Menguji Kecakapan Fiqh Muamalah Mereka di Pasar"] --> Inti
        KhatibBaghdadi["Al-Khatib Al-Baghdadi (Al-Jami'):<br/>Adab Guru Mengajarkan Keterampilan Bekerja Mandiri Kepada Penuntut Ilmu"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsDidaktikVokasiModern["SINTESIS DIDAKTIK PROBLEM-BASED LEARNING"]
        AuthenticPBL["Authentic Problem-Based Learning (Barrows, 1996):<br/>• Santri memecahkan dilema bisnis nyata (misal: bagaimana mengatasi produk keripik yang kurang laku?)."]
        
        EntrepreneurialPedagogy["Venture Pedagogy (Neck & Corbett, 2018):<br/>• Mengajarkan kewirausahaan sebagai metode berpikir & bertindak (*Method, not Process*)."]
        
        MicroHabits["Micro-Financial Habits Conditioning:<br/>• Otomatisasi pencatatan uang saku setiap selesai bertransaksi (*Instant Logging*)."]
        
        AuthenticPBL & EntrepreneurialPedagogy & MicroHabits ==> DidaktikTUMBUH["DIDAKTIK KEMANDIRIAN PARIPURNA"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaSpasialVokasi24Jam["REKAYASA SPASIAL KELAS & LAB BISNIS"]
        KelasPBL["1. KELAS DIALOG DISKUSI: Analisis kasus fiqh muamalah & bedah laporan laba-rugi."]
        KoperasiLab["2. LAB RITEL KOPERASI SANTRI: Tempat simulasi kasir digital, display barang, & layanan pembeli."]
        MakerSpace["3. CREATIVE MAKER LAB: Tempat praktik sablon, konveksi seragam, & produksi kuliner halal."]
        ArenaMarketDay["4. ARENA MARKET DAY: Tempat praktik eksekusi penjualan langsung kepada masyarakat luas."]
        
        KelasPBL ~~~ KoperasiLab ~~~ MakerSpace ~~~ ArenaMarketDay
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRestorasiFinansialPendidik["PROTOKOL RESTORASI FINANSIAL PENDIDIK TIER 3"]
        TahapA["1. MEDIASI HUKUM & ADVOKASI LEMBAGA TERHADAP PINJOL ILEGAL<br/>• Tim Lembaga Pesantren menghentikan teror penagih secara hukum & menyalurkan dana talangan qardhul hasan darurat."]
        
        TahapB["2. KONTRAK RESTRUKTURISASI FINANSIAL & PEMOTONGAN GAJI TERENCANA<br/>• Ustadz K menyepakati program pelunasan pinjaman qardh secara bertahap tanpa membebani nafkah keluarga."]
        
        TahapC["3. PELATIHAN INKUBASI BISNIS PRODUKTIF KELUARGA DI UNIT AGRIBISNIS<br/>• Ustadz K dibimbing mengelola unit hidroponik pesantren untuk menghasilkan pendapatan tambahan halal."]
        
        TahapD["4. LAHIRNYA KETELADANAN KEMANDIRIAN PENDIDIK PARIPURNA<br/>• Utang lunas 100%, Ustadz K mandiri berbisnis sayur organik, & mengajar Fiqh Muamalah dengan wibawa keteladanan tinggi."]
...
```mermaid
flowchart TD
    subgraph EmpatModelDidaktikKemandirian["EMPAT MODEL DIDAKTIK QADIRUN 'ALAL KASB"]
        M1["MODEL 1: LIVING ENTREPRENEURIAL EXEMPLARY / QUDWAH (KETELADANAN WIRAUSAHA)<br/>• Guru & musyrif memiliki unit usaha mandiri halal percontohan.<br/>• Menjadi living embodiment nilai-nilai 'Iffatun Nafs & kemandirian dakwah ber-izzah."]
        
        M2["MODEL 2: SOCRATIC BUSINESS-CASE DILEMMA (DIALEKTIKA DILEMA BISNIS SOKRATES)<br/>• Membedah studi kasus nyata: penipuan transaksi, riba terselubung, & strategi bersaing sehat.<br/>• Membimbing nalar kritis santri dalam memecahkan dilema moral perdagangan."]
        
        M3["MODEL 3: VENTURE CREATION INCUBATOR LAB (LAB INKUBASI WIRAUSAHA)<br/>• Praktik langsung merancang prototipe produk, spreadsheet HPP/BEP, & strategi pemasaran.<br/>• Mengoperasikan kasir digital di Koperasi Santri & Greenhouse Agribisnis."]
        
        M4["MODEL 4: MICRO-FINANCIAL HABIT CONDITIONING (KONDISIONING KEBIASAAN MIKRO)<br/>• Melatih kebiasaan seketika: Instant logging kas saku, menabung 10%, & infaq koin Subuh.<br/>• Otomatisasi fungsi regulasi diri finansial melalui pengulangan konsisten."]
        
        M1 & M2 & M3 & M4 ==> SantriPreneur["SANTRI MANDIRI, BERINTEGRITAS, CERDAS, & BER-IZZAH"]
    end
```
