...
```mermaid
flowchart TD
    subgraph DialektikaKonseptualKemandirian["DIALEKTIKA KONSEPTUAL KEMANDIRIAN FINANSIAL"]
        KutubA["KUTUB KAPITALISME SEKULER (GREED-DRIVEN)<br/>• Menghalalkan segala cara demi laba materi pribadi.<br/>• Riba, monopoli, penipuan (Tadlis), & individualis.<br/>• Akibat: Keserakahan, eksploitasi, & hilangnya berkah."]
        
        KutubB["KUTUB FATALISME PASIF (PSEUDO-ZUHUD)<br/>• Mengharamkan bisnis; mengemis proposal donatur.<br/>• Kemalasan ekonomi & ketergantungan seumur hidup.<br/>• Akibat: Kemiskinan sistemik & hilangnya izzah umat."]
        
        TUMBUH["QADIRUN 'ALAL KASB TUMBUH (AL-WASATHIYYAH)<br/>• Kasbul Yad halal berorientasi nilai ibadah & izzah.<br/>• Etika bisnis syar'i, penciptaan nilai, & pembukuan rapi.<br/>• Menghasilkan laba halal demi infaq & kedaulatan umat."]
...
```mermaid
flowchart LR
    subgraph TuratsKehormatanKasbHalal["KEMULIAAN BISNIS HALAL DALAM SUNNAH"]
        HaditsTajir["HR. At-Tirmidzi No. 1209:<br/>التَّاجِرُ الصَّدُوقُ الْأَمِينُ مَعَ النَّبِيِّينَ وَالصِّدِّيقِينَ وَالشُّهَدَاءِ<br/>(Pedagang yang Jujur & Amanah Bersama Para Nabi, Shiddiqin, & Syuhada)"] --> Inti["Hakikat Kasbul Halal Syar'i:<br/>Perniagaan Sebagai Jalan Keberkahan Hidup & Kemuliaan Akhirat"]
        HaditsAfdhal["HR. Ahmad No. 17302:<br/>عَمَلُ الرَّجُلِ بِيَدِهِ، وَكُلُّ بَيْعٍ مَبْرُورٍ<br/>(Penghasilan Terbaik: Keringat Tangan Sendiri & Setiap Jual Beli yang Mabrur/Jujur)"] --> Inti
        Ghazali["Al-Ghazali (Ihya' - Adabul Kasb):<br/>Niat Berniaga: Menjaga Diri dari Meminta, Menafkahi Keluarga, & Membantu Muslim"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPenciptaanNilaiBisnis["SINTESIS VALUE CREATION & LITERASI FINANSIAL"]
        ValueCreation["Value Creation Theory (Porter & Kramer):<br/>• Bisnis sukses bukan memeras pelanggan, melainkan menciptakan solusi yang meningkatkan kualitas hidup masyarakat."]
        
        OECDStandards["OECD Financial Literacy Framework:<br/>• Tiga Pilar: Pengetahuan Finansial (Financial Knowledge), Perilaku Finansial (Financial Behavior), & Sikap Finansial (Financial Attitude)."]
        
        IslamicVenture["Islamic Social Entrepreneurship:<br/>• Mengintegrasikan laba bisnis halal dengan misi kemaslahatan umat (Maqashid Syari'ah)."]
        
        ValueCreation & OECDStandards & IslamicVenture ==> StandarTUMBUH["KONSTRUK QADIRUN 'ALAL KASB"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaLabKewirausahaan24Jam["REKAYASA LABORATORIUM WIRAUSAHA ASRAMA"]
        UnitRitel["ZONA 1: KOPERASI & RITEL SANTRI (Praktik Kasir, Manajemen Stok Barang, & Laporan Penjualan)."]
        UnitKreatif["ZONA 2: CREATIVE MAKER LAB (Produksi Sablon Kaos Dakwah, Kaligrafi, & Kerajinan Tangan)."]
        UnitAgro["ZONA 3: AGRIBISNIS HIDROPONIK (Pertanian Sayur Organik, Kolam Ikan Lele/Nila, & Pemasaran Hasil)."]
        UnitDigital["ZONA 4: DIGITAL MARKETPLACE SANTRI (Pemasaran Online Produk UMKM Pesantren & Afiliasi Syar'i)."]
        
        UnitRitel ~~~ UnitKreatif ~~~ UnitAgro ~~~ UnitDigital
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolResolusiKhiyarAib["PROTOKOL RESTORASI ETIKA BISNIS TIER 2"]
        TahapA["1. FORUM BEDAH FIQH KHIYAR 'AIB BERSAMA WALI KELAS & MUSYRIF<br/>• Musyrif membedah hadits keharaman menyembunyikan cacat barang & hak pembeli membatalkan akad (*Haqqul Khiyar*)."]
        
        TahapB["2. PENGEMBALIAN UANG PENUH DISERTAI PERMINTAAN MAAF KSATRIA<br/>• Santri G mengembalikan uang Rp75.000 secara utuh kepada Santri P di depan musyrif & meminta maaf tulus."]
        
        TahapC["3. PELATIHAN STANDAR DESKRIPSI PRODUK JUJUR DI KOPERASI SANTRI<br/>• Santri G ditugaskan magang di bagian sortir barang koperasi selama 1 pekan untuk melatih kejujuran mutu."]
        
        TahapD["4. HASIL INTEGRITAS ETIKA BISNIS SYAR'I PARIPURNA<br/>• Santri G memahami hakikat keberkahan jual-beli & menjadi salah satu pengelola koperasi paling amanah."]
...
```mermaid
flowchart TD
    subgraph EmpatDimensiKemandirianFinansial["EMPAT DIMENSI OPERASIONAL QADIRUN 'ALAL KASB"]
        D1["DIMENSI 1: JIWA KEWIRAUSAHAAN INOVATIF (AR-RUH AL-RIYADIYYAH)<br/>• Pola pikir pemecahan masalah (Problem Solver) & keberanian merintis peluang bisnis halal.<br/>• Inovasi produk/jasa bernilai tambah (*Value Creation*) & etos kerja pantang menyerah."]
        
        D2["DIMENSI 2: LITERASI FINANSIAL & MANAJEMEN MODAL (AL-IDARAH AL-MĀLIYYAH)<br/>• Keterampilan pembukuan laba-rugi, pemisahan uang modal vs laba bersih.<br/>• Disiplin mengalokasikan keuntungan ke pos tabungan modal & investasi aset produktif."]
        
        D3["DIMENSI 3: INTEGRITAS ETIKA BISNIS SYAR'I (AL-AMANAH AL-MU'AMALAH)<br/>• Kejujuran mutlak dalam akad jual-beli, deskripsi barang, timbangan, & takaran.<br/>• Steril 100% dari riba, gharar, maysir, tadlis (penipuan), & penimbunan barang (Ihtikar)."]
        
        D4["DIMENSI 4: FILANTROPI PRODUKTIF & TANGAN DI ATAS (AL-INFAQ AL-INTAJI)<br/>• Mentalitas tangan di atas (*Al-Yadul 'Ulya*): Berpenghasilan agar mampu berzakat & wakaf.<br/>• Menyalurkan minimal 10% laba usaha untuk beasiswa dhu'afa & kemakmuran umat."]
        
        D1 & D2 & D3 & D4 ==> KonstrukUtuh["KAPASITAS QADIRUN 'ALAL KASB PARIPURNA"]
    end
```
...
```mermaid
flowchart LR
    J1["J1 (KELAS 7)<br/>Literasi Finansial Dasar<br/>• Pembukuan buku kas saku<br/>• Membedakan kebutuhan vs jajan<br/>• Menabung saku rutin"]
    --> J2["J2 (KELAS 8–9)<br/>Penciptaan Nilai Mikro<br/>• Merancang produk karya mandiri<br/>• Praktik jualan jujur di bazar mini<br/>• Menghitung margin laba bersih"]
    --> J3["J3 (KELAS 10–11)<br/>Inkubasi Bisnis Nyata<br/>• Magang ritel Koperasi Santri<br/>• Mengelola proyek agribisnis/jasa<br/>• Pembukuan kas laba-rugi"]
    --> J4["J4 (KELAS 12)<br/>Kedaulatan Wirausaha & Qudwah<br/>• Memimpin unit bisnis pesantren<br/>• Membimbing wirausaha adik J1<br/>• Al-Yadul 'Ulya: Berzakat & Wakaf"]
```
