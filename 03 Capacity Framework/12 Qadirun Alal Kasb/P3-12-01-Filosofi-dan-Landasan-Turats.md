...
```mermaid
flowchart TD
    subgraph TransformasiFilosofiKemandirian["REKONSTRUKSI FILOSOFI KEMANDIRIAN FINANSIAL"]
        Ketergantungan["PARADIGMA KETERGANTUNGAN & TANGAN DI BAWAH (TRADISIONAL)<br/>• Mengharamkan bisnis atas nama zuhud semu.<br/>• Bergantung pada proposal donatur & belas kasihan.<br/>• Santri gagap wirausaha & tidak mandiri finansial."]
        
        TUMBUH["QADIRUN 'ALAL KASB TUMBUH (AL-YADUL 'ULYA)<br/>• Mencari nafkah halal sebagai kewajiban syariat (Fardhu).<br/>• Integrasi Kitab Al-Kasb & Entrepreneurial Mindset.<br/>• Lab bisnis santri, literasi finansial, & penciptaan nilai."]
        
        Ketergantungan ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsKasbulYadSyaibani["DOKTRIN KASBUL YAD DALAM TURATS"]
        HaditsKasb["HR. Al-Bukhari No. 2072:<br/>مَا أَكَلَ أَحَدٌ طَعَامًا قَطُّ خَيْرًا مِنْ أَنْ يَأْكُلَ مِنْ عَمَلِ يَدِهِ<br/>(Tidaklah Seseorang Memakan Makanan yang Lebih Baik daripada Makanan dari Hasil Keringat Tangannya Sendiri)"] --> Inti["Hakikat Qadirun 'Alal Kasb:<br/>Kemandirian Ekonomi Syar'i Demi Menjaga Izzah & Berinfaq"]
        Syaibani["Asy-Syaibani (Kitab Al-Kasb):<br/>'Mencari Rezeki Halal Adalah Kewajiban Setelah Menunaikan Fardhu Shalat'"] --> Inti
        Ghazali["Al-Ghazali (Ihya' - Adabul Kasb):<br/>Tiga Derajat Pelaku Usaha: Celaka (Serakah), Selamat (Cukup), & Beruntung (Dermawan)"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsKewirausahaanMandiri["SINTESIS ENTREPRENEURSHIP & EFIKASI DIRI"]
        Mindset["Entrepreneurial Mindset (Neck et al., 2018):<br/>• Problem-Solving Orientation: Melihat masalah sebagai peluang menciptakan solusi bernilai tambah.<br/>• Calculated Risk-Taking: Berani mencoba rintisan usaha dengan mitigasi terukur."]
        
        SelfEfficacy["Economic Self-Efficacy (Bandura, 1997):<br/>• Keyakinan diri santri bahwa ia mampu menghasilkan pendapatan halal melalui keahlian nyata."]
        
        FinancialLiteracy["OECD Financial Competency Framework (2020):<br/>• Penguasaan cash flow, margin keuntungan, & investasi aset produktif."]
        
        Mindset & SelfEfficacy & FinancialLiteracy ==> StandarTUMBUH["KAPASITAS QADIRUN 'ALAL KASB"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaLabBisnisSantri["REKAYASA EKOSISTEM WIRAUSAHA SANTRI"]
        KantinSantri["1. KOPERASI & MARKET HUB SANTRI: Unit usaha ritel kebutuhan harian yang dikelola oleh santri senior J4."]
        CreativeLab["2. CREATIVE MAKER SPACE / WORKSHOP: Laboratorium desain grafis, konveksi seragam, & kaligrafi kreatif."]
        AgroHub["3. AGRIBISNIS & GREENHOUSE SANTRI: Budidaya hidroponik, perikanan air tawar, & pengolahan pangan halal."]
        CashlessSystem["4. SISTEM KEUANGAN CASHLESS SANTRI: Transaksi digital internal yang merekam laba unit usaha secara transparan."]
        
        KantinSantri ~~~ CreativeLab ~~~ AgroHub ~~~ CashlessSystem
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolTransformasiWirausaha["PROTOKOL TRANSFORMASI PARADIGMA KASB TIER 2"]
        Step1["1. KAJIAN TURATS BEDAH BIOGRAFI IMAM ABU HANIFAH (PEDAGANG SUTRA SUKSES)<br/>• Musyrif membedah fakta sejarah: Mayoritas ulama mazhab dan perawi hadits adalah saudagar mandiri yang membiayai santrinya."]
        
        Step2["2. PENUGASAN PROYEK 'VALUE CREATION' MENJUAL KARYA BUKU SAKU NAHWU<br/>• Santri T dibimbing merancang buku rangkuman nahwu kreatif & mencetaknya di Creative Maker Space."]
        
        Step3["3. MENGHASILKAN KEUNTUNGAN HALAL PERTAMA & MENYALURKAN INFAQ<br/>• 50 eksemplar buku terjual; Santri T memperoleh keuntungan bersih Rp250.000 & menginfaqkan 30% ke kas kamar."]
        
        Step4["4. LAHIRNYA KESADARAN 'ULAMA MANDIRI BER-IZZAH'<br/>• Santri T memahami bahwa wirausaha mengokohkan independensi ulama dari tekanan penguasa/donatur."]
...
```mermaid
flowchart TD
    subgraph ArsitekturFilosofisKemandirian["EMPAT PILAR KAPASITAS QADIRUN 'ALAL KASB"]
        P1["PILAR 1: JIWA KEWIRAUSAHAAN KREATIF (AR-RUH AL-RIYADIYYAH)<br/>• Orientasi pemecahan masalah (Problem Solver) & keberanian merintis peluang halal.<br/>• Inovasi produk/jasa bernilai tambah (*Value Creation*) & etos kerja pantang menyerah."]
        
        P2["PILAR 2: LITERASI & MANAJEMEN ASET PRODUKTIF (AL-IDARAH AL-MĀLIYYAH)<br/>• Keterampilan menyusun anggaran, analisis arus kas (*Cash-Flow Analysis*), & margin laba.<br/>• Disiplin mengalokasikan keuntungan ke pos tabungan modal & investasi produktif."]
        
        P3["PILAR 3: INTEGRITAS ETIKA BISNIS SYAR'I (AL-AMANAH AL-MU'AMALAH)<br/>• Kejujuran mutlak dalam timbangan, takaran, deskripsi produk, & akad jual-beli.<br/>• Steril dari riba, gharar, maysir, tadlis (penipuan), & penimbunan barang (Ihtikar)."]
        
        P4["PILAR 4: FILANTROPI PRODUKTIF & TANGAN DI ATAS (AL-INFAQ AL-INTAJI)<br/>• Mentalitas tangan di atas (*Al-Yadul 'Ulya*): Berpenghasilan agar mampu berzakat & wakaf.<br/>• Pemberdayaan ekonomi kaum dhu'afa & pembangunan peradaban umat."]
        
        P1 & P2 & P3 & P4 ==> SantriMandiri["SANTRI MANDIRI, BERDAULAT, DERMAWAN, & BER-IZZAH"]
    end
```
