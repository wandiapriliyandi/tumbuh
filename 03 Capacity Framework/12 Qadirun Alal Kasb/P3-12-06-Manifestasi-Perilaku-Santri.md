...
```mermaid
flowchart TD
    subgraph TransformasiObservasiKemandirian["REKONSTRUKSI OBSERVASI PERILAKU KEMANDIRIAN"]
        Abstrak["PENILAIAN ABSTRAK & TRANSAKSI GELAP (TRADISIONAL)<br/>• Transaksi riba terselubung antar-kamar luput terpantau.<br/>• Kemalasan ekonomi dinormalisasi sebagai ketenangan.<br/>• Santri pasif tidak memiliki portofolio produk nyata."]
        
        TUMBUH["KATALOG INDIKATOR TERAMATI 5 SETTING (TUMBUH)<br/>• Setting Koperasi, Maker Lab, Kelas, Kamar, & Bazar.<br/>• BARS (Behaviorally Anchored Rating Scales) terstandar.<br/>• Deteksi dini red flags (Riba kamar, Tadlis, & Israf)."]
...
```mermaid
flowchart LR
    subgraph TuratsPengawasanPasarNabawi["PENGAWASAN PASAR NABAWI"]
        HaditsGhasysya["HR. Muslim No. 102:<br/>مَنْ غَشَّنَا فَلَيْسَ مِنَّا<br/>(Barangsiapa Menipu Kami dalam Transaksi, Maka Ia Bukan dari Golongan Kami!)"] --> Inti["Hakikat Observasi Perilaku Ekonomi:<br/>Menjamin Kemurnian Muamalah & Keadilan Transaksi di Seluruh Ekosistem"]
        HaditsSama'["HR. Abu Dawud No. 3452:<br/>Rasulullah Memasukkan Tangannya ke Tumpukan Makanan & Menemukan Bagian Dalam yang Basah"] --> Inti
        Mawardi["Al-Mawardi (Al-Ahkam As-Sulthaniyyah):<br/>Tugas Muhtasib Mengawasi Timbangan, Takaran, & Mencegah Monopoli"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsBARSDanABAKemandirian["SINTESIS ABA & BARS PERILAKU EKONOMI"]
        BARS["Behaviorally Anchored Rating Scales (Smith & Kendall, 1963):<br/>• Menghubungkan setiap skor penilaian (1-4) dengan contoh tindakan nyata wirausaha teramati."]
        
        ABA["Applied Behavior Analysis (Cooper et al., 2020):<br/>• Mengidentifikasi Anteseden (Peluang Usaha), Perilaku (Kreasi Produk & Transaksi Jujur), & Konsekuensi (Laba Halal & Apresiasi)."]
        
        VentureObservables["Venture Competency Anchors (OECD, 2020):<br/>• Perilaku menghitung margin laba, melayani konsumen, & menabung."]
        
        BARS & ABA & VentureObservables ==> KatalogTUMBUH["KATALOG PERILAKU WIRAUSAHA TERSTANDAR"]
    end
```
...
```mermaid
flowchart TD
    subgraph LimaSettingEkologiWirausaha["LIMA SETTING OBSERVASI WIRAUSAHA 24 JAM"]
        S1["SETTING 1: KANTIN & KOPERASI (Pelayanan Kasir, Manajemen Stok, & Kejujuran Uang Kembalian)."]
        S2["SETTING 2: CREATIVE MAKER LAB (Kreasi Prototipe Produk, Pemeliharaan Mesin, & Safety)."]
        S3["SETTING 3: RUANG KELAS MADRASAH (Studi Kasus Fiqh Muamalah, Rencana Bisnis, & Kepatuhan Tugas)."]
        S4["SETTING 4: AREA ASRAMA & KAMAR (Buku Kas Saku Harian, Tabungan Saku, & Hidup Hemat)."]
        S5["SETTING 5: PASAR & BAZAR ASRAMA (Negosiasi Akad Syar'i, Pemasaran Jujur, & Infaq Laba)."]
...
```mermaid
flowchart TD
    subgraph ProtokolEradikasiRiba["PROTOKOL DE-RIBA ASRAMA TIER 2 & 3"]
        StepA["1. SIDANG DEWAN KEPENGASUHAN & BEDAH BAHAYA DOSA RIBA<br/>• Dewan Musyrif membedah dalil Al-Qur'an keharaman riba (QS. Al-Baqarah: 275) secara tegas & mendalam."]
        
        StepB["2. PEMBATALAN SELURUH AKAD BUNGA & PENGEMBALIAN POKOK SAJA<br/>• Santri D hanya berhak menerima uang pokok pinjaman; kelebihan bunga Rp10.000 dikembalikan kepada santri peminjam."]
        
        StepC["3. PENGALIHAN MODAL SANTRI D KE UNIT USAHA RIIL KOPERASI (MUDHARABAH)<br/>• Modal Santri D diarahkan untuk diinvestasikan secara sah pada unit produksi sablon Maker Lab dengan bagi hasil halal."]
        
        StepD["4. LAHIRNYA KESADARAN MUAMALAH SYAR'I BEBAS RIBA 100%<br/>• Santri D meraih keuntungan halal dari bagi hasil riil & asrama 100% steril dari praktik rentenir kamar."]
