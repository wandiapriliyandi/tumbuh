...
```mermaid
flowchart TD
    subgraph TransformasiHalaqahWirausaha["REKONSTRUKSI METODE HALAQAH KEMANDIRIAN"]
        CeramahPasif["HALAQAH CERAMAH TEORITIS PASIF (TRADISIONAL)<br/>• Nasihat umum tanpa kurikulum literasi finansial.<br/>• Santri malu berjualan & merasa rendah diri.<br/>• Koperasi asrama terpisah dari proses pendidikan santri."]
        
        TUMBUH["HALAQAH KEWIRAUSAHAAN APLIKATIF (TUMBUH)<br/>• Silabus Tematik 24 Pekan (Kitab Al-Kasb & Lean Venture).<br/>• Workshop Hands-On: Desain Produk, Hitung HPP, & Kasir SIM.<br/>• Peer Mentorship J4–J1 & Tradisi Market Day Bintang Lima."]
        
        CeramahPasif ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMajelisTijarahSalaf["MAJELIS PENDIDIKAN BISNIS SALAF"]
        UmarKhaththab["Umar bin Al-Khaththab RA:<br/>لَا يَبِيعُ فِي سُوقِنَا إِلَّا مَنْ قَدْ تَفَقَّهَ فِي الدِّينِ<br/>(Tidak Boleh Berjualan di Pasar Kami Melainkan Orang yang Telah Paham Fiqh Muamalah!)"] --> Inti["Hakikat Halaqah Bisnis Syar'i:<br/>Menjamin Setiap Pelaku Usaha Menguasai Fiqh Muamalah & Etika Kejujuran"]
        Syaibani["Asy-Syaibani (Kitab Al-Kasb):<br/>Majelis Bedah Akad Syariah & Standar Pembukuan Laba-Rugi"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Halaqah Pelatihan Menjaga Niat Ikhlas dalam Berniaga"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsDidaktikWirausaha["SINTESIS DIDAKTIK KEWIRAUSAHAAN"]
        ExperientialKolb["Experiential Learning Cycle (Kolb, 1984):<br/>1. Concrete Experience (Jualan di Bazar) -> 2. Reflective Observation (Audit Laba) -> 3. Abstract Conceptualization (Hitung HPP) -> 4. Active Experimentation (Pivoting)."]
        
        PeerMentorship["Peer Venture Mentorship Protocol:<br/>• Santri J4 mendampingi santri J1 dalam mengatasi grogi berjualan & mencatat kas saku."]
        
        ActionLearning["Action-Learning Framework (Revans):<br/>• Belajar memecahkan masalah riil bisnis dalam kelompok kecil halaqah."]
        
        ExperientialKolb & PeerMentorship & ActionLearning ==> ModelHalaqahTUMBUH["MODEL HALAQAH WIRAUSAHA TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaSpasialHalaqahWirausaha["SETTING RUANG HALAQAH WIRAUSAHA"]
        MejaWorkshop["1. MEJA WORKSHOP PROTOTYPING: Tempat santri merancang kemasan produk & kerajinan tangan."]
        DisplayEtalase["2. ETALASE PRODUK SANTRI: Tempat memamerkan produk karya halal santri berlabel nama."]
        PojokKonsultasi["3. POJOK KONSULTASI BISNIS & BEP: Dilengkapi spreadsheet keuangan & panduan sertifikasi halal."]
        PapanPrestasi["4. PAPAN BINTANG LIMA SANTRI PRENEUR: Menampilkan capaian omset jujur & piagam infaq laba."]
        
        MejaWorkshop ~~~ DisplayEtalase ~~~ PojokKonsultasi ~~~ PapanPrestasi
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolPenguatanEfikasiWirausaha["PROTOKOL DE-SHAMING WIRAUSAHA TIER 2"]
        Step1["1. DIALOG REFLEKTIF HANGAT BERSAMA PEMBINA HALAQAH (DE-SHAMING)<br/>• Pembina membedah biografi Nabi SAW sebagai saudagar terhormat & para sahabat konglomerat surga (Abdurrahman bin Auf & Utsman bin Affan)."]
        
        Step2["2. ROLE-PLAYING TEKNIK PENGURUSAN STAND & PENAWARAN RAMAH BERSAMA MENTOR J4<br/>• Kakak asuh J4 melatih Santri B teknik menyapa pembeli dengan senyum dan percaya diri di ruang halaqah."]
        
        Step3["3. PENDAMPINGAN 'CO-SELLING' DI STAND MARKET DAY ASRAMA<br/>• Kakak asuh J4 menemani Santri B di stand bazar; dalam 30 menit seluruh 15 roti bakar terjual habis (*Mastery Experience*)."]
        
        Step4["4. HASIL TRANSFORMASI PERCAYA DIRI & KEBANGGAAN SANTRI PRENEUR<br/>• Santri B merasakan kebahagiaan meraih laba halal pertama Rp30.000 & bangga menjadi santri wirausaha ber-izzah."]
...
```mermaid
flowchart TD
    subgraph SilabusHalaqah24PekanWirausaha["SILABUS KURIKULUM HALAQAH KEWIRAUSAHAAN TEMATIK"]
        Blok1["BLOK 1: FONDASI TEOLOGIS & 'IFFAH (Pekan 1–6)<br/>• Doktrin Kasbul Yad, Izzah Al-Yadul 'Ulya, Literasi Kas Saku, & Anti-Meminta."]
        
        Blok2["BLOK 2: PENCIPTAAN NILAI & PROTOTYPING (Pekan 7–12)<br/>• Ide Produk Halal, Desain Kemasan Kreatif, Hitung HPP/BEP, & Higienitas Produk."]
        
        Blok3["BLOK 3: ETIKA AKAD & PRAKTIK PASAR (Pekan 13–18)<br/>• Fiqh Buyu' Syar'i, Zero-Tadlis, Pelayanan Kasir Ramah, & Market Day Asrama."]
        
        Blok4["BLOK 4: MANAJEMEN ASET & FILANTROPI (Pekan 19–24)<br/>• Pembukuan Laba-Rugi, Pivoting Bisnis, Penyaluran Infaq Laba, & Business Plan."]
...
```mermaid
flowchart LR
    Fase1["FASE 1: 15 MENIT<br/>Tadabbur Turats Adab Kasb<br/>• Pembacaan Kitab Al-Kasb.<br/>• Bedah hikmah kemandirian."]
    --> Fase2["FASE 2: 30 MENIT<br/>Hands-On Workshop Bisnis<br/>• Praktik desain / hitung HPP.<br/>• Simulasi kasir & negosiasi."]
    --> Fase3["FASE 3: 15 MENIT<br/>Audit Logbook & Infaq Barakah<br/>• Verifikasi buku kas saku.<br/>• Doa keberkahan rezeki."]
```
...
```mermaid
flowchart TD
    subgraph ModelVentureMentorshipJ4J1["PROGRAM PEER VENTURE MENTORSHIP"]
        MentorJ4["SANTRI MENTOR J4 (KELAS 12)<br/>• Memeriksa kerapian buku kas saku & tabungan adik asuh J1 setiap malam Ahad.<br/>• Mendampingi adik asuh mengatasi rasa malu berjualan pada event Market Day.<br/>• Membimbing teknik menghitung HPP & memisahkan uang modal vs uang saku."]
        
        MenteeJ1["SANTRI MENTEE J1 (KELAS 7)<br/>• Memperoleh bimbingan keuangan tanpa rasa takut.<br/>• Terampil menabung, hidup hemat, & berani berjualan halal secara mandiri.<br/>• Meneladani kepemimpinan wirausaha dan kedermawanan kakak asuhnya."]
        
        MentorJ4 <==>|Pendampingan Penuh Keteladanan| MenteeJ1
    end
```
...
Penerapan konsep **P3-12-11: PROGRAM PEMBINAAN DAN HALAQAH QADIRUN ALAL KASB** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
