...
```mermaid
flowchart TD
    subgraph TransformasiInstrumentasiWirausaha["REKONSTRUKSI INSTRUMENTASI KEMANDIRIAN FINANSIAL"]
        TanpaInstrumen["EVALUASI KEUANGAN TANPA REKAM DATA (TRADISIONAL)<br/>• Penilaian wirausaha berdasarkan persepsi sepihak.<br/>• Tanpa dokumen portofolio & bukti nota transaksi.<br/>• Efikasi ekonomi santri tidak pernah terukur."]
        
        TUMBUH["PAKET INSTRUMEN MASTER KEMANDIRIAN (TUMBUH)<br/>• LOK-QK: Lembar observasi kinerja ritel koperasi.<br/>• LKS-QK: Logbook buku kas saku harian & pos tabungan.<br/>• FAP-QK: Formulir audit portofolio rintisan usaha.<br/>• SPE-QK: Skala persepsi efikasi diri kewirausahaan BK."]
        
        TanpaInstrumen ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsTadwinMuamalah["DOKTRIN PENCATATAN MUAMALAH TURATS"]
        AyatTadwin["QS. Al-Baqarah: 282:<br/>وَلَا تَسْأَمُوا أَنْ تَكْتُبُوهُ صَغِيرًا أَوْ كَبِيرًا إِلَىٰ أَجَلِهِ<br/>(Dan Janganlah Kalian Bosan Menuliskan Transaksi Itu, Baik Kecil Maupun Besar Hingga Batas Waktunya!)"] --> Inti["Hakikat Mutaba'ah Finansial:<br/>Pencatatan Tertulis Sebagai Penegak Keadilan & Kebersihan Harta"]
        Mawardi["Al-Mawardi (Al-Ahkam As-Sulthaniyyah):<br/>Standarisasi Buku Jurnal Transaksi Baitul Mal & Pasar"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Hisab Harian Terhadap Setiap Dirham yang Masuk & Keluar"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPengukuranKinerjaVokasi["VALIDITAS INSTRUMEN QADIRUN 'ALAL KASB"]
        Construct["Construct Validity (Aiken's V >= 0.96):<br/>• Uji validitas isi oleh pakar ekonomi Islam, ahli vokasi, & psikolog kognitif."]
        
        EMA["Ecological Momentary Assessment (Stone & Shiffman):<br/>• Pencatatan data kas saku & transaksi ritel pada setting nyata 24 jam."]
        
        AuthenticPortfolio["Authentic Portfolio Assessment (Brookhart, 2018):<br/>• Penilaian berbasis bukti nyata produk, nota, & laba riil."]
        
        Construct & EMA & AuthenticPortfolio ==> InstrumenStandar["PAKET INSTRUMEN WIRAUSAHA TERSTANDARISASI"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurMutabaahKeuangan24Jam["ALUR MUTABA'AH KEMANDIRIAN FINANSIAL 24 JAM"]
        SantriIsi["1. SANTRI MENGISI LKS-QK: Mencatat pengeluaran harian, tabungan 10%, & infaq Subuh."]
        PembinaCek["2. PEMBINA MEMVALIDASI LOK-QK: Menilai kinerja kasir koperasi, pelayanan, & paraf mingguan."]
        GuruMadrasah["3. GURU MENGISI FAP-QK: Memverifikasi berkas portofolio produk halal & analisis BEP."]
        AdminInput["4. INPUT DATA KE DASHBOARD INTIZHAM-TUMBUH: Seluruh skor disinkronkan ke basis data digital pesantren."]
        
        SantriIsi --> PembinaCek --> GuruMadrasah --> AdminInput
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolPembiasaanKasSaku["PROTOKOL PEMBIASAAN KAS SAKU TIER 2"]
        Step1["1. DIALOG RAMAH BERSAMA WALI KELAS & KAKAK ASUH J4 (NO BLAME CULTURE)<br/>• Wali kelas menenangkan santri & merekonstruksi alur pengeluaran 3 pekan lalu secara santai."]
        
        Step2["2. PENYEDIAAN DOMPET SAKU KHUSUS BERTEMPAT LOGBOOK MINI<br/>• Santri W dibekali dompet yang memiliki selipan buku kas saku mini & pulpen kecil agar mudah mencatat seketika."]
        
        Step3["3. HABIT STACKING PROTOCOL: MENCATAT KAS SAKU TEPAT SEBELUM TIDUR MALAM<br/>• Kakak asuh J4 mendampingi Santri W selama 7 hari berturut-turut mencatat kas saku setiap selesai shalat Isya."]
        
        Step4["4. HASIL OTOMATISASI PENCATATAN & KEMANDIRIAN KEUANGAN<br/>• Dalam 14 hari, Santri W terbiasa mencatat pengeluaran tanpa diingatkan & saldo kas sakunya seimbang 100%."]
...
```mermaid
flowchart TD
    subgraph EmpatInstrumenMasterWirausaha["EMPAT INSTRUMEN MASTER QADIRUN 'ALAL KASB"]
        LOK["1. FORM LOK-QK (LEMBAR OBSERVASI KINERJA RITEL KOPERASI)<br/>• Target: Pembina Bisnis Asrama & Musyrif.<br/>• Fungsi: Menilai kinerja kasir, akurasi uang kembalian, stok barang, & keramahan."]
        
        LKS["2. FORM LKS-QK (LOGBOOK BUKU KAS SAKU & POS TABUNGAN)<br/>• Target: Santri Mandiri.<br/>• Fungsi: Mencatat arus kas saku harian, pos tabungan 10%, infaq Subuh, & saldo kas."]
        
        FAP["3. FORM FAP-QK (FORMULIR AUDIT PORTOFOLIO RINTISAN USAHA)<br/>• Target: Verifikator Bisnis & Guru Madrasah.<br/>• Fungsi: Menilai kelayakan prototipe produk, HPP, margin laba, & sertifikat halal."]
        
        SPE["4. FORM SPE-QK (SKALA PERSEPSI EFIKASI DIRI KEWIRAUSAHAAN)<br/>• Target: Konselor BK & Psikolog.<br/>• Fungsi: Mengukur perceived venture self-efficacy, resiliensi usaha, & orientasi Al-Yadul 'Ulya."]
