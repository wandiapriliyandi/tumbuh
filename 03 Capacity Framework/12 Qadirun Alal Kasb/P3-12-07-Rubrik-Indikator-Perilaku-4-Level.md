...
```mermaid
flowchart TD
    subgraph TransformasiRubrikKemandirian["REKONSTRUKSI SISTEM PENILAIAN WIRAUSAHA SANTRI"]
        UjianKertas["UJIAN TEORI HAFALAN KERTAS (TRADISIONAL)<br/>• Menilai hafalan definisi fiqh tanpa praktik bisnis nyata.<br/>• Tanpa penghargaan atas progres keberanian berjualan.<br/>• Santri bingung standar operasional yang harus dicapai."]
        
        TUMBUH["RUBRIK 4-LEVEL QADIRUN 'ALAL KASB (TUMBUH)<br/>• Deskriptor kriteria faktual 4 dimensi (Mindset, Akuntansi, Etika, Filantropi).<br/>• Penilaian berbasis bukti portofolio bisnis riil & buku kas.<br/>• Uji reliabilitas Cohen's Kappa & penilaian pertumbuhan ipsatif."]
        
        UjianKertas ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMizanPerniagaanSalaf["TIMBANGAN BISNIS DALAM TURATS"]
        Ghazali["Al-Ghazali (Ihya' - Adabul Kasb):<br/>زِنْ تِجَارَتَكَ بِمِيزَانِ الْعَدْلِ وَالْإِحْسَانِ، لَا تَرْضَ لِأَخِيكَ إِلَّا مَا تَرْضَاهُ لِنَفْسِكَ<br/>(Timbanglah Perniagaanmu dengan Timbangan Keadilan & Ihsan)"] --> Inti["Hakikat Rubrik Bisnis Turats:<br/>Instrumen Pengukur Integritas, Profesionalisme, & Berkah Usaha"]
        Syaibani["Asy-Syaibani (Kitab Al-Kasb):<br/>Kriteria Penilaian Kehalalan Usaha & Keteraturan Pembukuan Modal"] --> Inti
        Mawardi["Al-Mawardi (Adab ad-Dunya):<br/>Hisab Harta Berdasarkan Asal-Usul Perolehan & Penyaluran Nafaqah"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPsikometriRubrikWirausaha["STANDAR PSIKOMETRI RUBRIK QADIRUN 'ALAL KASB"]
        IRR["Inter-Rater Reliability (Cohen's Kappa >= 0.88):<br/>• Kesepakatan penilaian portofolio bisnis antar-pembina asrama.<br/>• Kalibrasi deskriptor penciptaan nilai & etika syar'i."]
        
        Brookhart["Analytical Rubric Design (Brookhart, 2018):<br/>• Kriteria kualitatif deskriptif berbasis bukti kinerja usaha riil."]
        
        Ipsative["Ipsative Growth Standards (Hughes, 2014):<br/>• Mengukur kemajuan keberanian & keterampilan wirausaha santri."]
        
        IRR & Brookhart & Ipsative ==> RubrikStandar["RUBRIK QADIRUN 'ALAL KASB TERVALIDASI"]
    end
```
...
```mermaid
flowchart TD
    subgraph SistemAsesmenWirausaha24Jam["INTEGRASI DATA ASESMEN KEMANDIRIAN FINANSIAL"]
        DataPembina["1. PEMBINA BISNIS ASRAMA: Observasi Kinerja Ritel Koperasi, Kasir, & Standar Pelayanan (35%)."]
        DataGuru["2. GURU FIQH MUAMALAH: Uji Studi Kasus Fiqh, Analisis BEP, & Business Plan Madrasah (25%)."]
        DataPortofolio["3. PORTOFOLIO BISNIS MANDIRI: Laporan Penjualan Produk, Margin Laba, & Foto Bukti Usaha (20%)."]
        DataSantri["4. ASESMEN MANDIRI SANTRI: Buku Kas Saku Harian & Pos Tabungan Mandiri (10%)."]
        DataKonsumen["5. ULASAN KONSUMEN / PEER: Kepuasan Pembeli, Kejujuran Deskripsi Produk, & Ramah (10%)."]
        
        DataPembina & DataGuru & DataPortofolio & DataSantri & DataKonsumen ==> Dashboard["DASHBOARD INTIZHAM-TUMBUH (IK-QK)"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolKalibrasiWirausaha["PROTOKOL KALIBRASI PENILAI BISNIS ASRAMA"]
        P1["1. FORUM INTEGRASI DEWAN GURU MADRASAH & PEMBINA BISNIS KOPERASI<br/>• Menyatukan persepsi: Bobot terbesar rubrik terletak pada eksekusi riil & integritas syariah, didukung laporan sederhana."]
        
        P2["2. PENETAPAN BOBOT SEIMBANG PROSES PRODUKSI & PEMBUKUAN KEUANGAN<br/>• Menyepakati bahwa Santri H berhak meraih Level 3.75 (Kategori Mahir Mandiri) dengan perbaikan format pembukuan."]
        
        P3["3. PENDAMPINGAN FORMAT LAPORAN KEUANGAN BISNIS TERSTANDAR<br/>• Santri H dibimbing merapikan spreadsheet laporan laba-rugi agar memenuhi standar akuntabilitas madrasah."]
        
        P4["4. HASIL KONSISTENSI PENILAIAN LINTAS PEMBINA<br/>• Seluruh penilai memiliki kesepakatan seragam & santri memperoleh evaluasi yang adil dan memotivasi."]
...
```mermaid
flowchart TD
    subgraph ArsitekturRubrik4LevelKemandirian["EMPAT TINGKAT KEMATANGAN QADIRUN 'ALAL KASB"]
        L1["LEVEL 1: AL-IKTISAB AL-MUBTADI' (LITERASI DASAR / EMERGING)<br/>• Mampu mencatat kas saku harian; membedakan kebutuhan vs jajan; menabung 10%.<br/>• Memahami rukun jual-beli dasar; 0% mentalitas meminta donasi/proposal."]
        
        L2["LEVEL 2: AL-INJAZ AL-MAHIR (PENCIPTAAN NILAI MIKRO / DEVELOPING)<br/>• Mampu membuat 1 produk karya halal mandiri & menghitung margin laba bersih.<br/>• Mempraktikkan akad jual-beli jujur di Bazar Santri; menyalurkan infaq laba."]
        
        L3["LEVEL 3: AT-TIJARAH AL-MUSTAQILLAH (INKUBASI RITEL / PROFICIENT)<br/>• Mengoperasikan unit ritel Koperasi Santri & menyusun laporan laba-rugi.<br/>• Menerapkan strategi pemasaran digital & mengatasi kendala bisnis dengan pivoting."]
        
        L4["LEVEL 4: AR-RIYADAH AL-MUBARAKAH (KEPEMIMPINAN BISNIS / EXEMPLARY)<br/>• Memimpin unit bisnis pesantren; menyusun business plan kelulusan mandiri.<br/>• Membimbing wirausaha adik asuh J1 & Al-Yadul 'Ulya: berzakat & wakaf produktif."]
