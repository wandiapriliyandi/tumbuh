...
```mermaid
flowchart TD
    subgraph TransformasiIntervensiKemandirian["REKONSTRUKSI INTERVENSI MASALAH FINANSIAL"]
        HukumanFisik["HUKUMAN FISIK & DIARAK KELILING PONDOK (TRADISIONAL)<br/>• Mempermalukan santri tanpa mengajarkan solusi finansial.<br/>• Mematikan minat wirausaha santri yang merugi.<br/>• Memicu dendam sosial & trauma psikologis."]
        
        TUMBUH["ARSITEKTUR PBIS MULTI-TIER KEMANDIRIAN (TUMBUH)<br/>• Tier 1: Universal Literasi Finansial & Lab Bisnis (100%).<br/>• Tier 2: Targeted Budgeting Clinic & Mentoring Pivoting (15%).<br/>• Tier 3: Intensive Restorasi Tadlis & Terapi Keuangan (5%).<br/>• SOP Konsekuensi Logis Edukatif 4R & Pendampingan Kasih."]
        
        HukumanFisik ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsPenangananDebiturPailit["HUKUM TAFLIS & ISHLAH DALAM TURATS"]
        AyatInzhar["QS. Al-Baqarah: 280:<br/>وَإِنْ كَانَ ذُو عُسْرَةٍ فَنَظِرَةٌ إِلَىٰ مَيْسَرَةٍ<br/>(Jika Debitur Mengalami Kesulitan, Berilah Tangguh Waktu Hingga Ia Berkelapangan)"] --> Inti["Hakikat Intervensi Restoratif:<br/>Pemberian Kesempatan Bangkit & Rekonstruksi Amanah Tanpa Menghancurkan Martabat"]
        HaditsMuflis["HR. Muslim No. 1554:<br/>Penetapan Status Muflis & Pembagian Aset Sisa Secara Proporsional"] --> Inti
        Mawardi["Al-Mawardi (Adab ad-Dunya):<br/>Membimbing Debitur Mengembangkan Usaha Baru Agar Mampu Melunasi Utang"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPBISDanFinancialTherapy["SINTESIS PBIS & FINANCIAL THERAPY"]
        SWPBIS["School-Wide PBIS Multi-Tier (Sugai & Horner, 2020):<br/>• Tier 1 Universal (100%), Tier 2 Targeted (15%), & Tier 3 Intensive (5%)."]
        
        FinancialTherapy["Financial Therapy Association Standards (2020):<br/>• Mengurai distorsi kognitif 'Money Beliefs' & belanja impulsif maladaptif."]
        
        RestorativeJustice["Restorative Justice Framework (Zehr, 2015):<br/>• Restitusi kerugian korban & pemulihan ukhuwah tanpa stigmatisasi."]
        
        SWPBIS & FinancialTherapy & RestorativeJustice ==> ProtokolTUMBUH["PROTOKOL INTERVENSI PBIS TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurPenangananMasalahFinansial["ALUR INTERVENSI MASALAH KEUANGAN 24 JAM"]
        Deteksi["1. DETEKSI DINI: Laporan Musyrif / Early Warning System (EWS) Digital Intizham."]
        Tapis["2. PENAPISAN TINGKAT MASALAH: Tier 1 (Habit), Tier 2 (Utang/Boros), Tier 3 (Tadlis/Kompulsif)."]
        Tindakan["3. EKSEKUSI INTERVENSI EDUKATIF: Klinik Kas Saku, Pivoting Usaha, atau Sidang Restorasi 4R."]
        Monitoring["4. MONITORING LOGBOOK KEUANGAN: Evaluasi arus kas santri selama 30 hari hingga mandiri."]
        
        Deteksi --> Tapis --> Tindakan --> Monitoring
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolKrisisUtangRentenir["PROTOKOL REMEDIASI KRISIS UTANG TIER 3"]
        Step1["1. PERLINDUNGAN KEAMANAN FISIK SANTRI & NEGOSIASI HUKUM DENGAN PIHAK LUAR<br/>• Tim Advokasi Pesantren mendatangi pemilik warnet, membatalkan bunga riba secara hukum, & melunasi pokok pinjaman Rp300.000 melalui dana darurat qardhul hasan."]
        
        Step2["2. KONTRAK PELUNASAN MANDIRI MELALUI PROGRAM KHIDMAH PRODUKTIF DI KOPERASI<br/>• Santri F menandatangani komitmen bekerja paruh waktu di bagian packing konveksi Maker Lab (memperoleh upah halal Rp15.000/jam)."]
        
        Step3["3. TERAPI CBT ADIKSI GADGET & EDUKASI LITERASI KEUANGAN SYARIAH<br/>• Konselor BK memberikan terapi kognitif pembongkaran ilusi game online & pemulihan harga diri."]
        
        Step4["4. HASIL PELUNASAN UTANG MANDIRI & KEMATANGAN KARAKTER KASB<br/>• Dalam 2 bulan, Santri F berhasil melunasi pinjaman Rp300.000 dari keringat sendiri & menjadi santri mandiri yang berdedikasi."]
...
```mermaid
flowchart TD
    subgraph ArsitekturTigaTingkatPBISKemandirian["ARSITEKTUR MULTI-TIER PBIS QADIRUN 'ALAL KASB"]
        Tier1["TIER 1: UNIVERSAL INTERVENTION (100% SANTRI - PREVENTIF)<br/>• Kurikulum Literasi Finansial Terpadu & Silabus Halaqah 24 Pekan.<br/>• Tabungan saku mandiri, pembiasaan kasir koperasi, & sedekah fajar."]
        
        Tier2["TIER 2: TARGETED INTERVENTION (10–15% SANTRI - DUKUNGAN TERARAH)<br/>• Klinik Manajemen Kas Saku (Budgeting Clinic) bagi santri boros/impulsif.<br/>• Mentoring Pivoting Bisnis bagi rintisan usaha yang merugi/stagnan.<br/>• Program Buddy Wirausaha bersama kakak asuh J4."]
        
        Tier3["TIER 3: INTENSIVE RESTORATIVE (1–5% SANTRI - REMEDIASI INTENSIF)<br/>• Sidang Restorasi Penipuan Transaksi (Tadlis) & penegakan Khiyar 'Aib.<br/>• Program pelunasan utang darurat melalui kerja khidmah halal.<br/>• Terapi CBT regulasi belanja kompulsif & adiksi game/judi siber."]
...
| :--- | :---: | :--- | :--- | :--- |
| **Tier 1: Universal Prevention** | $100\%$ Seluruh Santri | • Pembelajaran literasi finansial terstruktur.<br/>• Pengisian logbook buku kas saku harian.<br/>• Praktik magang kasir koperasi & sedekah Subuh. | Musyrif Kamar & Guru Madrasah | $100\%$ Santri memiliki buku kas saku & tabungan aktif. |
| **Tier 2: Targeted Support** | $10–15\%$ Santri Rentan | • Konseling budgeting bagi santri yang sering kehabisan uang saku.<br/>• Mentoring pivoting rintisan usaha yang merugi.<br/>• Pemantauan arus kas mingguan oleh kakak asuh J4. | Wali Kelas & Mentor Bisnis Asrama | Saldo kas saku stabil; rintisan usaha mencapai BEP. |
| **Tier 3: Intensive Restorative** | $1–5\%$ Kasus Khusus | • Sidang penyelesaian kasus tadlis / sengketa jual-beli asrama.<br/>• Terapi CBT belanja kompulsif / kecanduan game berbayar.<br/>• Khidmah kerja mandiri melunasi pinjaman modal qardh. | Dewan Pengasuhan, Konselor BK, & Sarpras | Utang terlunasi 100%; $0\%$ pengulangan kecurangan bisnis. |
...
```mermaid
flowchart LR
    R1["1. RELATED<br/>Konsekuensi berhubungan langsung dengan muamalah (misal: mengganti barang cacat)."]
    --> R2["2. RESPECTFUL<br/>Disampaikan dengan adab santun tanpa membentak atau mempermalukan di publik."]
    --> R3["3. REASONABLE<br/>Beban perbaikan sebanding dengan kerugian tanpa menzalimi santri."]
    --> R4["4. RESTORATIVE<br/>Memulihkan ukhuwah & mendidik santri menjadi pribadi amanah."]
```
