...
```mermaid
flowchart TD
    subgraph TransformasiTargetKemandirian["REKONSTRUKSI TARGET CAPAIAN KEMANDIRIAN FINANSIAL"]
        Retorika["RETORIKA ABSTRAK TANPA EKSEKUSI (TRADISIONAL)<br/>• Slogan santri mandiri tanpa lab bisnis nyata.<br/>• Tanpa pengukuran BEP, laba-rugi, & cash flow.<br/>• Lulusan bermental pencari kerja pasif (Job Seeker)."]
        
        TUMBUH["STANDAR CAPAIAN CP-QK TUMBUH (OBE FRAMEWORK)<br/>• Dekomposisi Tri-Domain (Kognitif, Afektif, Psikomotorik).<br/>• Target Kuantitatif: 100% Portofolio Usaha & BEP Mandiri.<br/>• Pencipta lapangan kerja berdaya (Job Creator) & Al-Yadul 'Ulya."]
        
        Retorika ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMaqashidKemandirianFinansial["MAQASHID SYARI'AH KEMANDIRIAN FINANSIAL"]
        Syathibi["Asy-Syathibi (Al-Muwafaqat):<br/>Pengembangan Harta (Tanmiyatul Mal) Adalah Kewajiban Penegak Maqashid"] --> Inti["Hakikat Target CP-QK:<br/>Menjaga Izzah Kehormatan Muslim Melalui Kemandirian Ekonomi Halal"]
        IbnuAsyur["Ibnu 'Asyur (Maqashid Asy-Syari'ah):<br/>Perekonomian Umat Wajib Berdaulat Agar Terbebas dari Dominasi Asing"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Kemandirian Finansial Melindungi Agama dari Syubhat & Ketergantungan"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsOBEDanIntensiWirausaha["SINTESIS OBE & TEORI PERILAKU TERENCANA"]
        OBE["Outcome-Based Education (Spady, 1994):<br/>• Merancang kurikulum dari profil lulusan ideal (Santri Mandiri Finansial) menuju capaian pembelajaran terukur."]
        
        TPB["Theory of Planned Behavior (Ajzen, 1991):<br/>• Tiga Faktor Intensi Wirausaha: Sikap terhadap Bisnis (Attitude), Norma Subjektif Asrama (Subjective Norms), & Efikasi Diri (Perceived Behavioral Control)."]
        
        LeanStartup["Lean Startup Methodology (Ries, 2011):<br/>• Validasi ide bisnis cepat melalui Build-Measure-Learn Feedback Loop."]
        
        OBE & TPB & LeanStartup ==> StandarCPQK["CAPAIAN PEMBELAJARAN CP-QK TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaFasilitasWirausaha24Jam["REKAYASA FASILITAS WIRAUSAHA ASRAMA"]
        DanaMikro["1. DANA BERGILIR MODAL MIKRO (QARDHUL HASAN): Pinjaman modal rintisan usaha santri tanpa bunga."]
        PasarSantri["2. MARKET DAY & BAZAR PEKANAN ASRAMA: Sarana pemasaran produk kreatif & makanan halal santri."]
        PosInkubasi["3. POS INKUBATOR BISNIS SANTRI: Ruang konsultasi analisis BEP, desain kemasan, & legalitas halal."]
        KiosDigital["4. KIOS TRANSAKSI DIGITAL SMART CARD: Pembayaran nontunai yang memverifikasi omset & margin laba."]
        
        DanaMikro ~~~ PasarSantri ~~~ PosInkubasi ~~~ KiosDigital
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiPivotUsaha["PROTOKOL REMEDIASI PIVOT WIRAUSAHA TIER 2"]
        Step1["1. AUDIT LAPANGAN & BEDAH AKAR MASALAH BERSAMA MENTOR BISNIS ASRAMA<br/>• Mentor menenangkan santri: 'Kegagalan adalah laboratorium belajar terbaik; mari kita audit penyebab basi'."]
        
        Step2["2. STRATEGI PIVOTING: BERALIH KE PRODUK TAHAN LAMA (KERIPIK PISANG ANEKA RASA)<br/>• Tim santri mengubah produk dari jus basah ke produk keripik kering yang tahan disimpan 3 bulan."]
        
        Step3["3. REKAYASA SISTEM PRE-ORDER & PEMASARAN DIGITAL DI LINGKUNGAN PONDOK<br/>• Menerapkan sistem Pre-Order (PO) sehingga produksi hanya dilakukan sesuai pesanan pasti (*Zero Waste*)."]
        
        Step4["4. HASIL PEMULIHAN LABA & PELUNASAN MODAL QARDHUL HASAN<br/>• Dalam 3 pekan, seluruh modal Rp500.000 terlunasi, tim meraih laba bersih Rp450.000, & meraih piagam 'The Most Resilient Venture'."]
...
```mermaid
flowchart TD
    subgraph DekomposisiTriDomainCPQK["DEKOMPOSISI CAPAIAN PEMBELAJARAN (CP-QK)"]
        subgraph KOGNITIF["A. DOMAIN KOGNITIF (KONSEPTUAL & NALAR EKONOMI)"]
            K1["• Menguasai Fiqh Muamalah Kontemporer, Akad-Akad Syariah, & Larangan Riba/Gharar."]
            K2["• Memahami Analisis Titik Impas (BEP), Margin Laba, & Arus Kas Bisnis."]
            K3["• Menguasai Strategi Pemasaran Halal, Branding Produk, & Analisis Peluang Pasar."]
        end

        subgraph AFEKTIF["B. DOMAIN AFEKTIF (SIKAP & ETIKA WIRAUSAHA)"]
            A1["• Menghayati Kehormatan Diri (Iffah) & Anti-Mentalitas Meminta-minta/Proposal."]
            A2["• Memiliki Kejujuran Mutlak dalam Berniaga (Shidqul Muamalah) & Amanah Timbangan."]
            A3["• Menjunjung Jiwa Dermawan: Berpenghasilan Agar Mampu Berinfaq & Wakaf."]
        end

        subgraph PSIKOMOTORIK["C. DOMAIN PSIKOMOTORIK (KETERAMPILAN BISNIS PRAKTIS)"]
            P1["• Terampil Merancang Prototipe Produk/Jasa Halal Bernilai Tambah (Value Creation)."]
            P2["• Mahir Menyusun Pembukuan Laba-Rugi & Laporan Keuangan Usaha Sederhana."]
            P3["• Terampil Menjalankan Operasional Ritel Koperasi, Kasir Digital, & Layanan Konsumen."]
        end
...
| :--- | :--- |
| **Jenjang J1 (Kelas 7, Usia 12–13)** | • Mampu mengelola uang saku harian dengan buku kas saku rapi.<br/>• Memahami perbedaan kebutuhan primer vs keinginan konsumtif.<br/>• Menabung minimal 10% uang saku secara konsisten.<br/>• Membiasakan mentalitas tangan di atas melalui infaq koin Subuh harian. |
| **Jenjang J2 (Kelas 8–9, Usia 13–15)** | • Mampu merancang 1 produk karya kerajinan/kuliner halal sederhana.<br/>• Mampu menghitung modal awal, harga jual, dan margin laba bersih.<br/>• Terampil mempraktikkan akad jual-beli jujur pada event Bazar Santri.<br/>• Menyalurkan sebagian keuntungan perdana untuk pos infaq asrama. |
| **Jenjang J3 (Kelas 10–11, Usia 15–17)** | • Mampu magang dan mengoperasikan unit usaha Koperasi/Agribisnis Santri.<br/>• Mampu menyusun laporan keuangan laba-rugi unit usaha secara berkala.<br/>• Mampu merancang strategi pemasaran digital dan kemasan produk kreatif.<br/>• Mampu mengatasi hambatan operasional bisnis dengan metode pivoting. |
| **Jenjang J4 (Kelas 12, Usia 17–18)** | • Mampu memimpin dan mengelola unit bisnis mandiri pesantren secara amanah.<br/>• Mampu membimbing dan menjadi mentor wirausaha adik asuh jenjang J1.<br/>• Menuntaskan draf rencana bisnis mandiri (*Business Plan*) pasca-kelulusan.<br/>• Menampilkan kemandirian finansial paripurna berjiwa filantropi peradaban. |
