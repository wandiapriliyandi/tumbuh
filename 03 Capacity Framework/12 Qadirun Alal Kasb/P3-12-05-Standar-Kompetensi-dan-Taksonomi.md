...
```mermaid
flowchart TD
    subgraph TransformasiTaksonomiKemandirian["REKONSTRUKSI TAKSONOMI KEMANDIRIAN FINANSIAL"]
        Sporadis["EVALUASI SPORADIS TANPA TANGGA TAKSONOMI (TRADISIONAL)<br/>• Tuntutan sama rata tanpa memperhatikan jenjang usia.<br/>• Hanya fokus pada proposal kertas tanpa eksekusi riil.<br/>• Keterampilan psikomotorik bisnis diabaikan."]
        
        TUMBUH["TAKSONOMI KEMANDIRIAN FITRAH 4 LEVEL (TUMBUH)<br/>• Level 1: Al-Iktisab al-Mubtadi' (Literasi Kas Saku & Tabungan).<br/>• Level 2: Al-Injaz al-Mahir (Produk Mikro & Praktik Bazar).<br/>• Level 3: At-Tijarah al-Mustaqillah (Inkubasi Ritel Koperasi).<br/>• Level 4: Ar-Riyadah al-Mubarakah (Kepemimpinan Bisnis & Qudwah)."]
...
```mermaid
flowchart LR
    subgraph TuratsMaratibKasb["TINGKATAN PENGELOLAAN HARTA DALAM TURATS"]
        Syaibani["Asy-Syaibani (Kitab Al-Kasb):<br/>Maratibul Kasb: Fardhu (Nafkah Diri) -> Mustahab (Infaq & Bantu Sesama) -> Mubah (Pengembangan Aset)"] --> Inti["Hakikat Taksonomi Kasb:<br/>Evolusi dari Pemenuhan Kebutuhan Mandiri Menuju Kedaulatan Filantropi Umat"]
        Ghazali["Al-Ghazali (Ihya'):<br/>Tingkatan Kematangan Wara' dalam Muamalah & Perniagaan"] --> Inti
        Mawardi["Al-Mawardi (Adab ad-Dunya):<br/>Tahapan Melatih Anak Mengelola Harta Sebelum Menyerahkan Warisan"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsEntreCompDanEfikasi["SINTESIS ENTRECOMP & TAKSONOMI OBE"]
        EntreComp["EntreComp Framework (Bacigalupo et al., 2016):<br/>1. Ideas & Opportunities -> 2. Resources & Financial Literacy -> 3. Into Action & Value Creation."]
        
        OBECompetency["Outcome-Based Competency Standards:<br/>• Penyelarasan SKI-SKD dengan capaian hasil belajar terukur."]
        
        ExperientialLearning["Experiential Venture Creation (Kolb, 1984):<br/>• Pembelajaran berbasis siklus pengalaman nyata di Market Hub asrama."]
        
        EntreComp & OBECompetency & ExperientialLearning ==> TaksonomiTUMBUH["TAKSONOMI KEMANDIRIAN FITRAH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaKurikulumOBEKemandirian["REKAYASA KURIKULUM OBE BERJENJANG"]
        J1["J1 (Kelas 7): Literasi Kas Saku, Bed-Making 2 Menit, & Disiplin Menabung 10%."]
        J2["J2 (Kelas 8–9): Perancangan Prototipe Produk Halal, Praktik Bazar Santri, & Margin Laba."]
        J3["J3 (Kelas 10–11): Magang Ritel Koperasi, Agribisnis Santri, & Laporan Keuangan Laba-Rugi."]
        J4["J4 (Kelas 12): Manajemen Unit Bisnis Pesantren, Draf Business Plan Kelulusan, & Mentorship J1."]
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiHPP["PROTOKOL PELATIHAN HPP BIAYA TIER 2"]
        Step1["1. BEDAH AKUNTANSI BIAYA BERSAMA PEMBINA BISNIS ASRAMA (COST AUDIT)<br/>• Pembina mengajarkan rumus HPP lengkap: Bahan Baku + Biaya Sablon + Kemasan + Biaya Distribusi."]
        
        Step2["2. SIMULASI RE-CALCULATING HPP KAOS DENGAN SPREADSHEET KOPERASI<br/>• Ditemukan HPP asli = Rp58.000; harga jual rasional ditetapkan Rp75.000 (Margin Laba = Rp17.000)."]
        
        Step3["3. PRODUKSI GELOMBANG KEDUA DENGAN SISTEM PRE-ORDER LENGKAP<br/>• Tim santri membuka PO gelombang 2; 60 kaos terjual dengan strategi harga baru yang transparan."]
        
        Step4["4. HASIL PEMULIHAN LABA & PENGUASAAN AKUNTANSI BIAYA<br/>• Tim meraih laba bersih Rp1.020.000, menutup kerugian awal, & santri mahir menghitung HPP 100%."]
...
```mermaid
flowchart TD
    subgraph EmpatLevelTaksonomiKemandirian["EMPAT LEVEL TAKSONOMI KEMANDIRIAN FITRAH"]
        L1["LEVEL 1: AL-IKTISAB AL-MUBTADI' (LITERASI KAS SAKU & MENABUNG / EMERGING)<br/>• Mampu mencatat pengeluaran saku harian, membedakan kebutuhan vs jajan, & menabung 10%.<br/>• 0% mentalitas meminta donasi; membiasakan infaq koin Subuh."]
        
        L2["LEVEL 2: AL-INJAZ AL-MAHIR (PRODUK MIKRO & PRAKTIK BAZAR / DEVELOPING)<br/>• Mampu membuat 1 produk halal mandiri & menghitung margin laba bersih.<br/>• Mempraktikkan akad jual-beli jujur di Bazar Santri; menyalurkan infaq laba."]
        
        L3["LEVEL 3: AT-TIJARAH AL-MUSTAQILLAH (INKUBASI RITEL & LABA-RUGI / PROFICIENT)<br/>• Mengoperasikan unit ritel Koperasi Santri & menyusun laporan laba-rugi.<br/>• Menerapkan strategi pemasaran digital & mengatasi kendala bisnis dengan pivoting."]
        
        L4["LEVEL 4: AR-RIYADAH AL-MUBARAKAH (KEPEMIMPINAN BISNIS & QUDWAH / EXEMPLARY)<br/>• Memimpin unit bisnis pesantren, menyusun business plan kelulusan mandiri.<br/>• Membimbing wirausaha adik asuh J1 & Al-Yadul 'Ulya: berzakat & wakaf produktif."]
...
| :--- | :--- | :--- |
| **Jenjang J1 (Kelas 7)<br/>*Level 1: Al-Iktisab al-Mubtadi'*** | Mampu memahami literasi finansial dasar, mengelola uang saku secara hemat, dan membiasakan mentalitas tangan di atas dengan panduan terstruktur. | **1.1** Mencatat seluruh pemasukan dan pengeluaran saku pada buku kas saku harian.<br/>**1.2** Membedakan antara kebutuhan primer (*Dharuriyyat*) dengan keinginan konsumtif.<br/>**1.3** Menyisihkan minimal 10% uang saku untuk pos tabungan terencana.<br/>**1.4** Membiasakan sedekah koin fajar harian demi menanamkan jiwa dermawan. |
| **Jenjang J2 (Kelas 8–9)<br/>*Level 2: Al-Injaz al-Mahir*** | Mampu merancang produk karya mandiri sederhana, menghitung modal dan margin keuntungan, serta mempraktikkan perniagaan jujur pada skala mikro. | **2.1** Merancang minimal 1 prototipe produk kerajinan/kuliner halal bernilai tambah.<br/>**2.2** Menghitung Harga Pokok Penjualan (HPP), harga jual, dan margin laba bersih.<br/>**2.3** Mempraktikkan akad jual-beli syar'i yang jujur dan bebas dari tadlis/gharar.<br/>**2.4** Menyalurkan minimal 10% keuntungan perdana ke kas infaq sosial asrama. |
| **Jenjang J3 (Kelas 10–11)<br/>*Level 3: At-Tijarah al-Mustaqillah*** | Mampu mengoperasikan unit usaha ritel/agribisnis asrama, menyusun laporan keuangan laba-rugi, dan menerapkan strategi pemasaran halal adaptif. | **3.1** Menjalankan magang operasional di unit Koperasi Santri / Greenhouse Agribisnis.<br/>**3.2** Menyusun laporan keuangan pembukuan kas laba-rugi usaha secara berkala.<br/>**3.3** Menerapkan strategi promosi, kemasan kreatif, dan pemasaran berbasis pre-order.<br/>**3.4** Mengatasi hambatan operasional dan fluktuasi pasar dengan metode pivoting. |
| **Jenjang J4 (Kelas 12)<br/>*Level 4: Ar-Riyadah al-Mubarakah*** | Mampu menampilkan kepemimpinan wirausaha syariah mandiri, menyusun rencana bisnis masa depan, dan mendampingi rintisan usaha adik kelas. | **4.1** Memimpin dan mengkoordinasikan unit usaha bisnis mandiri santri secara amanah.<br/>**4.2** Menyusun draf rencana bisnis mandiri (*Comprehensive Business Plan*) kelulusan.<br/>**4.3** Membimbing dan menjadi mentor wirausaha adik asuh jenjang J1.<br/>**4.4** Menampilkan kepribadian ksatria berpenghasilan mandiri dan berjiwa wakaf peradaban. |
