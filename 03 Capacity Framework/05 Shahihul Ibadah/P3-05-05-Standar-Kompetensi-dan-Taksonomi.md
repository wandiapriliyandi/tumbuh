...
```mermaid
flowchart TD
    subgraph TransformasiTaksonomiIbadah["TRANSFORMASI TAKSONOMI KOMPETENSI IBADAH"]
        UjianTulisSaja["TAKSONOMI KOGNITIF PARSIAL (LAMA)<br/>• Ujian tulis hafalan teori fiqh semata.<br/>• Tanpa verifikasi kinestetik gerakan nyata shalat.<br/>• Santri lulus nilai 100 namun sujud & wudhunya salah."]
        
        TaksonomiTriDomain["TAKSONOMI TRI-DOMAIN INTEGRATIF (TUMBUH)<br/>• Kognitif 'Aqliyyah (Pemahaman Dalil & Rukun).<br/>• Afektif Qalbiyyah (Kekhusyukan & Thuma'ninah).<br/>• Psikomotorik Amaliyyah (Presisi Gerakan & Uji Praktik 1-on-1)."]
        
        UjianTulisSaja ==>|DIREKONSTRUKSI MENJADI| TaksonomiTriDomain
    end
```
...
```mermaid
graph TD
    A["Gugatan Standarisasi Santai (Pihak A):<br/>'Santri itu tidak perlu diuji praktik satu per satu; cukup beri ceramah fiqh di kelas, mereka pasti shalat sendiri dengan benar!'"]
    --> B1["Tinjauan Tafsir QS. At-Taubah: 122:<br/>Li yatafaqqahuu fid-diin (Kewajiban mendalami fiqh secara presisi & mengawal penerapannya pada kaumnya)."]
    A --> B2["Tinjauan Kitab Sullam at-Taufiq (Sayyid Abdullah Ba'alawi):<br/>Mempelajari kaidah Fiqh Thaharah & Shalat adalah Fardhu 'Ain mutlak bagi setiap mukallaf yang wajib diverifikasi keabsahannya."]
    A --> B3["Tinjauan Hadits Al-Musi'u Shalatuhu (HR. Bukhari & Muslim):<br/>Rasulullah SAW menguji langsung praktik shalat sahabat 3 kali berturut-turut hingga gerakannya sempurna (Irji' fa shalli fa innaka lam tushalli)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Standar kompetensi ibadah wajib meneladani metodologi uji klinis kenabian yang ketat & beradab."]
```
...
```mermaid
graph TD
    A["Gugatan Teori Pendidikan Barat (Pihak A):<br/>'Taksonomi Bloom itu teori sekuler; tidak layak dipakai untuk mengukur ibadah shalat dan thaharah santri!'"]
    --> B1["Tinjauan Taksonomi Kognitif Bloom (Anderson & Krathwohl, 2001):<br/>C1 (Remembering Dalil) ➔ C2 (Understanding Rukun) ➔ C3 (Applying Shalat) ➔ C4 (Analyzing Pembatal) ➔ C5 (Evaluating Khilafiyah) ➔ C6 (Creating Modul Dakwah)."]
    A --> B2["Tinjauan Taksonomi Afektif Krathwohl (1964):<br/>A1 (Receiving Panggilan Adzan) ➔ A2 (Responding Wudhu Segera) ➔ A3 (Valuing Shalat Khusyu') ➔ A4 (Organizing Jadwal Ibadah) ➔ A5 (Characterization Malakah Qudwah)."]
    A --> B3["Tinjauan Taksonomi Psikomotorik Simpson (1972):<br/>P1 (Perception) ➔ P2 (Set Kesiapan Saf) ➔ P3 (Guided Response) ➔ P4 (Mechanism Refleks) ➔ P5 (Complex Overt Response Presisi Gerakan)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Sintesis Tri-Domain menyediakan instrumen psikometri presisi untuk mengukur kompetensi ibadah holistik."]
```
...
```mermaid
flowchart LR
    subgraph TriDomainTaksonomiIbadahTUMBUH["INTEGRASI TRI-DOMAIN TAKSONOMI SHAHIHUL IBADAH"]
        Kognitif["1. KOGNITIF 'AQLIYYAH (Bloom C1-C6)<br/>Penguasaan Dalil, Syarat, Rukun, & Analisis Fiqh."]
        
        Afektif["2. AFEKTIF QALBIYYAH (Krathwohl A1-A5)<br/>Kekhusyukan Kalbu, Thuma'ninah, & Mahabbah Masjid."]
        
        Psikomotorik["3. PSIKOMOTORIK AMALIYYAH (Simpson P1-P5)<br/>Presisi Kinestetik Wudhu & Gerakan Shalat Sunnah."]
        
        InsanAbid["4. OUTPUT: Profil Insan 'Abid Paripurna (Tangga J1–J4)"]
        
        Kognitif --> InsanAbid
        Afektif --> InsanAbid
        Psikomotorik --> InsanAbid
    end
```
...
```mermaid
flowchart TD
    subgraph PemetaanSKLJ1J4ShahihulIbadah["PEMETAAN STANDAR KOMPETENSI LULUSAN (SKL) SHAHIHUL IBADAH"]
        
        SKL_J1["SKL JENJANG J1: KEMANDIRIAN DASAR (KELAS 7)<br/>• Kognitif: Hafal & paham rukun, syarat, pembatal Thaharah & Shalat Fardhu.<br/>• Afektif: Disiplin hadir shalat berjamaah saf awal; tertib & hening di masjid.<br/>• Psikomotorik: Lulus Uji Praktik Wudhu & Shalat 1-on-1 Presisi 100%."]
        
        SKL_J2["SKL JENJANG J2: PEMBIASAAN NAWAFIL (KELAS 8-9)<br/>• Kognitif: Menguasai Fiqh Sujud Sahwi, Shalat Jenazah, & Fiqh Jamak-Qashar.<br/>• Afektif: Menghayati Fahmul Ma'ani terjemahan Al-Fatihah & doa shalat.<br/>• Psikomotorik: Istiqamah Shalat Rawatib 12 Rakaat, Dhuha, & Tilawah 1 Juz/Hari."]
        
        SKL_J3["SKL JENJANG J3: INTEGRASI & ADVOKASI (KELAS 10-11)<br/>• Kognitif: Menguasai dalil hadits Bulughul Maram & perbandingan madzhab dasar.<br/>• Afektif: Kenikmatan Qiyamul Lail mandiri (Halawatul Munajah) & puasa sunnah.<br/>• Psikomotorik: Terampil memimpin Muadzin, Dzikir Ba'da Shalat, & Shalat Gaib."]
        
        SKL_J4["SKL JENJANG J4: KEPEMIMPINAN QUDWAH (KELAS 12)<br/>• Kognitif: Menguasai Bidayatul Mujtahid & Hikmatut Tasyri' Ibadah.<br/>• Afektif: Keterpautan hati abadi dengan masjid (Qalbuhu Mu'allaqun bil Masjid).<br/>• Psikomotorik: Lulus Sertifikasi Imam Rawatib, Khatib Jumat, & Pembina Fiqh."]
        
        SKL_J1 ==> SKL_J2 ==> SKL_J3 ==> SKL_J4
    end
```
...
```mermaid
flowchart TD
    subgraph AlurResolusiUjiKlinisFiqh["PROTOKOL PENEGAKAN INTEGRITAS SKL SHAHIHUL IBADAH"]
        TemuanUji["1. TEMUAN UJI KLINIS: Santri Nilai Tulis 100 Namun Sujud Cacat & Lahn Jaliy"]
        
        PenahananKelulusan["2. PENAHANAN STATUS SKL IBADAH (Pending / Incomplete)<br/>• Menegaskan: Tidak ada kompromi pada keabsahan rukun shalat."]
        
        KlinikTashih["3. KLINIK TASHIH FIQH & TAHSIN 1-ON-1 (2 Pekan Bersama Pakar)<br/>• Memperbaiki sujud 7 anggota badan & memfasihkan tajwid Al-Fatihah."]
        
        UjiUlangLulus["4. UJI ULANG KLINIS & SERTIFIKASI MUTQIN PARIPURNA<br/>• Santri lulus dengan keabsahan shalat yang hakiki & sah syar'i."]
        
        TemuanUji --> PenahananKelulusan --> KlinikTashih --> UjiUlangLulus
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturTriDomainSKLIbadah["ARSITEKTUR TRI-DOMAIN SKL SHAHIHUL IBADAH (TUMBUH)"]
        
        subgraph DomainKognitif["1. DOMAIN KOGNITIF 'AQLIYYAH (BLOOM C1 - C6)"]
            C1_C2["• C1-C2: Hafal & Paham Rukun, Syarat, & Pembatal Thaharah/Shalat."]
            C3_C4["• C3-C4: Menerapkan Shalat Sunnah & Menganalisis Kasus Fiqh Musafir."]
            C5_C6["• C5-C6: Mengevaluasi Dalil Perbandingan Madzhab & Merancang Dakwah."]
        end
        
        subgraph DomainAfektif["2. DOMAIN AFEKTIF QALBIYYAH (KRATHWOHL A1 - A5)"]
            A1_A2["• A1-A2: Menghormati Panggilan Adzan & Segera Berwudhu."]
            A3_A4["• A3-A4: Merasakan Nikmat Khusyu' & Menata Jadwal Tilawah 1 Juz."]
            A5["• A5: Karakterisasi Malakah Kesalehan Abadi & Hati Rindu Masjid."]
        end
        
        subgraph DomainPsikomotorik["3. DOMAIN PSIKOMOTORIK AMALIYYAH (SIMPSON P1 - P5)"]
            P1_P2["• P1-P2: Kesiapan Fisik Saf Pertama & Thaharah Hemat Air."]
            P3_P4["• P3-P4: Presisi Gerakan Thuma'ninah 7 Anggota Badan Refleks."]
            P5["• P5: Kemahiran Memimpin Shalat Berjamaah Sebagai Imam & Khatib."]
        end
        
        DomainKognitif <===> DomainAfektif <===> DomainPsikomotorik
    end
```
