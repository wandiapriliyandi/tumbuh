...
```mermaid
flowchart TD
    subgraph TransformasiObservasiIbadah["TRANSFORMASI OBSERVASI PERILAKU IBADAH"]
        AsumsiAbstrak["ASUMSI SUBJEKTIF ABSTRAK (LAMA)<br/>• Ibadah dianggap rahasia batin tak terukur.<br/>• Mengabaikan perilaku buruk wudhu & saf shalat.<br/>• Evaluasi hampa tanpa indikator perilaku nyata."]
        
        ManifestasiTerpadu["MANIFESTASI PERILAKU TERAMATI (TUMBUH)<br/>• Indikator konkret 4 Lokus Asrama 24 Jam.<br/>• Observasi presisi Wudhu Hemat Air, Saf Rapat, & Thuma'ninah.<br/>• Rekayasa Nudge Lingkungan Memfasilitasi Adab Refleks."]
        
        AsumsiAbstrak ==>|DIREKONSTRUKSI MENJADI| ManifestasiTerpadu
    end
```
...
```mermaid
graph TD
    A["Gugatan Pemisahan Batin-Zhahir (Pihak A):<br/>'Kekhusyukan itu hanya urusan hati; gerakan raga yang gelisah dan terburu-buru tidak boleh dijadikan bukti rusaknya ibadah seseorang!'"]
    --> B1["Tinjauan Tafsir QS. Al-Fath: 29:<br/>Siimahum fii wujuhihim min atsaris sujud (Kekhusyukan batin memancarkan tanda ketenangan nyata pada wajah & anggota badan)."]
    A --> B2["Tinjauan Hadits Said bin al-Musayyib (Ihya' Al-Ghazali):<br/>Melihat orang memainkan jenggot saat shalat: Lau khasya'a qalbuhu lakhasya'at jawarihuh (Seandainya hatinya khusyu', niscaya tenanglah anggota badannya)."]
    A --> B3["Tinjauan Kaidah Azh-Zhahiru 'Unwanul Bathin (Ibnu Rajab):<br/>Perilaku raga lahiriah adalah cermin dan penerjemah mutlak dari kondisi keimanan batin."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Kekhusyukan ibadah sejati keniscayaannya memancar dalam ketenangan gerakan fisik & adab luhur."]
```
...
```mermaid
graph TD
    A["Gugatan Pemaksaan Fisik (Pihak A):<br/>'Satu-satunya cara membuat santri rajin ibadah adalah ronda musyrif membawa tongkat rotan; rekayasa lingkungan Nudge dan teori Ajzen itu tidak mempan di pesantren!'"]
    --> B1["Tinjauan Theory of Planned Behavior Icek Ajzen (1991):<br/>Perilaku nyata lahir dari Intensi (Niat Kuat), yang dibentuk oleh Sikap Positif (Attitude), Norma Subjektif Sebaya (Subjective Norm), & Persepsi Kendali Perilaku (PBC)."]
    A --> B2["Tinjauan Nudge Theory (Richard Thaler & Cass Sunstein, 2008):<br/>Rekayasa pilihan arsitektur lingkungan (Choice Architecture) mengarahkan perilaku positif secara otomatis tanpa paksaan kekerasan."]
    A --> B3["Tinjauan Behavioral Prompting & Cues:<br/>Pemberian isyarat visual (Visual Cues) di tempat wudhu & selasar masjid meningkatkan kepatuhan adab hingga 300%."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Perpaduan Teori Ajzen & Nudge Theory menciptakan ekosistem asrama yang memicu perilaku ibadah refleks & mandiri."]
```
...
```mermaid
flowchart LR
    subgraph ModelAjzenNudgeIbadahTUMBUH["MODEL PERILAKU TERENCANA & NUDGE SHAHIHUL IBADAH"]
        SikapPositif["1. ATTITUDE: 'Shalat Berjamaah adalah Kemuliaan & Kesejukan Hatiku'"]
        
        NormaSebaya["2. SUBJECTIVE NORM: Seluruh Teman Sekamar Bergegas ke Masjid Saat Adzan"]
        
        NudgeFisik["3. NUDGE CUES: Rak Sandal Bersekat, Karpet Saf Rapi, & Lampu Fajar Sejuk"]
        
        PerilakuRefleks["4. MANIFESTASI PERILAKU: Hadir di Saf Pertama Tepat Waktu Secara Mandiri"]
        
        SikapPositif --> PerilakuRefleks
        NormaSebaya --> PerilakuRefleks
        NudgeFisik --> PerilakuRefleks
    end
```
...
```mermaid
flowchart TD
    subgraph PemetaanPerilaku4LokusTUMBUH["PEMETAAN MANIFESTASI PERILAKU SHAHIHUL IBADAH 4 LOKUS"]
        
        Lokus1["1. TEMPAT WUDHU & SANITASI<br/>• Wudhu hemat air (<90 dtk) & menutup kran rapat.<br/>• Tertib antre tanpa memercikkan air ke teman.<br/>• Melafalkan doa ma'tsur sebelum & sesudah wudhu."]
        
        Lokus2["2. RUANG UTAMA MASJID<br/>• Hadir sebelum iqamah; shalat Tahiyyatul Masjid.<br/>• Menempati saf depan kosong; merapatkan tumit & bahu.<br/>• Thuma'ninah 4-5 dtk & tenang wirid ba'da shalat."]
        
        Lokus3["3. KAMAR ASRAMA (RUANG PRIVAT)<br/>• Bangun fajar mandiri saat bel Qiyamul Lail berbunyi.<br/>• Istiqamah Tilawah Al-Qur'an 1 Juz harian di sudut kamar.<br/>• Wudhu sebelum tidur & dzikir 3 Qul posisi miring kanan."]
        
        Lokus4["4. KELAS & AREA MADRASAH<br/>• Menegakkan Shalat Dhuha mandiri saat istirahat pertama.<br/>• Doa pembuka & penutup majelis ilmu penuh khusyu'.<br/>• Segera menghentikan belajar saat mendengar seruan adzan."]
        
        Lokus1 <===> Lokus2 <===> Lokus3 <===> Lokus4
    end
```
...
```mermaid
flowchart TD
    subgraph AlurTransformasiQiyamulLail["PROTOKOL TRANSFORMASI RESISTENSI QIYAMUL LAIL ASRAMA"]
        KasusPuraTidur["1. ANOMALI: Santri Berpura-pura Tidur Saat Bel Qiyamul Lail Fajar"]
        
        InvestigasiTidur["2. INVESTIGASI EMPATIS: Menemukan Masalah Begadang & Sleep Hygiene"]
        
        PenataanJadwal["3. PENATAAN DISIPLIN TIDUR MALAM: Lampu Padam Tepat Pukul 21.45"]
        
        SentuhanKasihFajar["4. SENTUHAN KASIH FAJAR: Panggilan Lembut 'Allah Menunggu Munajatmu'"]
        
        BangunMandiriCinta["5. TRANSFORMASI PARIPURNA: Santri Bangun Mandiri dengan Rindu Ibadah"]
        
        KasusPuraTidur --> InvestigasiTidur --> PenataanJadwal --> SentuhanKasihFajar --> BangunMandiriCinta
    end
```
...
```mermaid
flowchart TD
    subgraph TaksonomiPerilakuShahihulIbadah["TAKSONOMI MANIFESTASI PERILAKU SHAHIHUL IBADAH (TUMBUH)"]
        
        subgraph PerilakuPositif["PERILAKU POSITIF TERAMATI (TAG: [IB-POS])"]
            Pos1["• [IB-POS-01]: Hadir di masjid <10 menit sebelum iqamah & mengisi saf awal."]
            Pos2["• [IB-POS-02]: Wudhu hemat air (<90 dtk), membasuh sempurna, & kran tertutup rapat."]
            Pos3["• [IB-POS-03]: Thuma'ninah 4-5 dtk pada setiap ruku'/sujud & diam tenang tanpa fidgeting."]
            Pos4["• [IB-POS-04]: Merapatkan tumit & bahu sejajar garis saf tanpa komando berulang."]
            Pos5["• [IB-POS-05]: Istiqamah Shalat Rawatib, Dhuha, & Tilawah 1 Juz harian mandiri."]
        end
        
        subgraph PerilakuNegatif["PERILAKU NEGATIF TERAMATI (TAG: [IB-NEG])"]
            Neg1["• [IB-NEG-01]: Masbuq shalat fardhu karena sengaja menunda di kamar/lapangan."]
            Neg2["• [IB-NEG-02]: Membuka kran air deras & bermain cipratan air di tempat wudhu."]
            Neg3["• [IB-NEG-03]: Shalat tergesa-gesa tanpa thuma'ninah (mematuk seperti ayam)."]
            Neg4["• [IB-NEG-04]: Membiarkan celah saf renggang / menaruh sajadah untuk memblokir saf."]
            Neg5["• [IB-NEG-05]: Berbicara gaduh / bercanda tertawa di dalam masjid saat waktu ibadah."]
        end
    end
```
...
| :--- | :--- | :--- | :--- |
| **1. Tempat Wudhu & Sanitasi** | • Mengantre tertib tanpa saling dorong.<br/>• Mengalirkan air kran kecil hemat (<1.5 L/menit).<br/>• Menyempurnakan basuhan wudhu hingga mata kaki.<br/>• Membaca doa wudhu menghadap kiblat. | • Membuka kran air maksimal hingga meluap.<br/>• Mencipratkan air ke baju teman sekamar.<br/>• Meninggalkan kran air dalam keadaan menetes.<br/>• Mengobrol teriak-teriak saat membasuh anggota. | Observasi In-Vivo Musyrif Kamar & Indikator Water-Meter Asrama. |
| **2. Ruang Utama Masjid** | • Masuk melangkah kaki kanan & shalat Tahiyyat.<br/>• Mengisi saf pertama yang kosong & merapatkan tumit.<br/>• Shalat tenang thuma'ninah 4–5 detik per rukun.<br/>• Duduk khusyu' wirid dzikir ba'da shalat fardhu. | • Masuk tergesa-gesa melangkahi pundak jamaah.<br/>• Melirik jam tangan / menggaruk badan berlebihan.<br/>• Shalat kilat tanpa thuma'ninah ruku'/sujud.<br/>• Langsung berlari keluar masjid saat salam pertama. | Fast-Tap Logbook PBIS Musyrif & Rekaman Pos Saf Depan. |
| **3. Kamar Asrama (Privat)** | • Bangun fajar mandiri saat bel Qiyamul Lail.<br/>• Tilawah Al-Qur'an 1 juz harian di sudut meja kamar.<br/>• Wudhu sebelum tidur & membaca dzikir 3 Qul.<br/>• Merapikan sajadah dan mukena di gantungan kamar. | • Berpura-pura tidur menarik selimut saat adzan.<br/>• Melempar mukena/sarung kotor di lantai kamar.<br/>• Mengabaikan tilawah harian selama berhari-hari.<br/>• Begadang mengobrol hingga lewat jam 22.30 malam. | Checklist Mutaba'ah Saku & Sosiometri Teman Sekamar. |
| **4. Kelas & Madrasah** | • Mendirikan Shalat Dhuha mandiri saat jeda istirahat.<br/>• Segera menutup buku pelajaran saat adzan Zhuhur.<br/>• Melafalkan doa pembuka/penutup majelis ilmu khusyu'. | • Menunda shalat Zhuhur demi menyelesaikan tugas.<br/>• Mengabaikan seruan adzan dan tetap bercanda di kelas. | Rekap Absensi Shalat Dhuha & Pengamatan Guru Kelas. |
...
```mermaid
flowchart TD
    subgraph RekayasaLingkunganNudgeIbadah["ARSITEKTUR REKAYASA LINGKUNGAN NUDGE SHAHIHUL IBADAH"]
        
        N1["1. NUDGE RAK SANDAL BERSEKAT & BERNAMA<br/>➔ Menghilangkan tumpukan sandal di tangga & meniadakan ghashab sandal masjid."]
        
        N2["2. NUDGE PITA LASER GARIS TUMIT SAF MASJID<br/>➔ Memandu santri meluruskan & merapatkan saf secara refleks tanpa komando imam."]
        
        N3["3. NUDGE AERATOR PEMBATAS KRAN AIR WUDHU<br/>➔ Membatasi debit air maksimal 1.5 L/menit untuk mencegah israf pemborosan air."]
        
        N4["4. NUDGE ZONA SERAMBI KHUSUS TILAWAH SUARA KERAS<br/>➔ Memisahkan area tilawah suara lantang dari area hening shalat sunnah di dalam."]
