...
```mermaid
flowchart TD
    subgraph TransformasiInstrumenMutabaah["TRANSFORMASI DESAIN INSTRUMEN MUTABAAH IBADAH"]
        BukuTebalKaku["BUKU TEBAL MANUAL KAKU (LAMA)<br/>• Format A4 tebal, mudah basah terkena wudhu, & hilang.<br/>• Diisi seminggu sekali ➔ Recall Bias parah & data palsu.<br/>• Tanpa formulir klinis FBA & OSCE untuk musyrif."]
        
        ToolkitsSakuTUMBUH["TOOLKITS ERGONOMIS TIGA TEMPLATE (TUMBUH)<br/>• 1. Kartu Kendali Saku Mingguan (Lipat Saku Anti-Air <30 Dtk).<br/>• 2. Formulir Intervensi CICO Fajar & FBA Ringkas Tier 2-3.<br/>• 3. Rubrik Checklist OSCE Uji Praktik Fiqh Klinis 4 Stasiun."]
        
        BukuTebalKaku ==>|DIREKONSTRUKSI MENJADI| ToolkitsSakuTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Riya' Catatan Amal (Pihak A):<br/>'Mencatat shalat dan tilawah di kartu mutaba'ah itu perbuatan riya' dan bid'ah; ibadah harus disembunyikan tanpa perlu dicatat!'"]
    --> B1["Tinjauan Tafsir QS. Al-Infitar: 10-12:<br/>Inna 'alaikum lahaafizhiin, kiraaman kaatibiin (Allah menugaskan malaikat mencatat setiap amal perbuatan manusia dalam Shaha'if al-A'mal)."]
    A --> B2["Tinjauan Atsar Sayyidina Umar bin Khattab RA:<br/>Haasibuu anfusakum qabla an tuhaasabuu (Kewajiban menghisab & mencatat kekurangan diri sebelum datang hari hisab akbar)."]
    A --> B3["Tinjauan Kitab Ihya' 'Ulumiddin (Al-Ghazali):<br/>Muhasabah menuntut instrumen pencatatan (Jaridatul Hisab) agar seorang hamba mengetahui modal pokok (Fardhu) & keuntungan (Nawafil)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Lembar mutaba'ah adalah sarana hisab diri (Muhasabah) yang sah syar'i & menumbuhkan keikhlasan."]
```
...
```mermaid
graph TD
    A["Gugatan Beban Administrasi Santri (Pihak A):<br/>'Santri itu ke pesantren untuk beribadah dan mengaji, bukan untuk menjadi pegawai administrasi yang sibuk mengisi formulir rumit!'"]
    --> B1["Tinjauan Ecological Momentary Assessment (EMA - Shiffman et al., 2008):<br/>EMA merekam perilaku secara realtime di lingkungan alami subjek, mengeliminasi Recall Bias, & meminimalkan beban pengisian (<30 detik)."]
    A --> B2["Tinjauan Human-Centered Design (Don Norman, 2013):<br/>Desain instrumen yang ergonomis (Ukuran Saku Lipat Tiga, Kertas Sintetis Anti-Air, & Ikon Visual Intuitif) meningkatkan kepatuhan pengisian hingga 98%."]
    A --> B3["Tinjauan Psikometri Item Design:<br/>Item kartu mutaba'ah dirancang dengan format Checklist Biner & Skala Grafis yang mudah dipahami santri usia 12-18 tahun."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Desain instrumen berbasis EMA & HCD menjadikan mutaba'ah ibadah ringan, cepat, & membahagiakan."]
```
...
```mermaid
flowchart LR
    subgraph ModelEMAMutabaahTUMBUH["DESAIN INSTRUMEN BERBASIS ECOLOGICAL MOMENTARY ASSESSMENT (EMA)"]
        ErgonomiSaku["1. ERGONOMI SAKU (9x14 CM)<br/>Muat di saku baju koko / mukena; kertas sintetis anti-air."]
        
        PengisianCepat["2. PENGISIAN CEPAT (<30 DETIK)<br/>Format centang biner [✓] tepat setelah shalat selesai."]
        
        ZeroRecallBias["3. ZERO RECALL BIAS<br/>Data tercatat seketika tanpa mengandalkan ingatan lama."]
        
        DataValidPBIS["4. OUTPUT: Data Riil Terverifikasi untuk Dashboard PBIS Asrama"]
        
        ErgonomiSaku --> PengisianCepat --> ZeroRecallBias --> DataValidPBIS
    end
```
...
```mermaid
flowchart TD
    subgraph TipologiTigaInstrumenTUMBUH["TIPOLOGI TIGA INSTRUMEN BAKU SHAHIHUL IBADAH (TUMBUH)"]
        
        Inst1["1. MASTER TEMPLATE 1: KARTU KENDALI SAKU MUTABA'AH (SANTRI)<br/>• Format: Saku Lipat Tiga (Mingguan) Berbahan Anti-Air.<br/>• Fungsi: Self-Monitoring Harian Shalat 5 Waktu, Rawatib, Dhuha, & ODOJ.<br/>• Pengguna: Seluruh Santri Jenjang J1 s/d J4."]
        
        Inst2["2. MASTER TEMPLATE 2: FORMULIR INTERVENSI CICO & FBA (MUSYRIF)<br/>• Format: Lembar Tindakan Klinis PBIS Tier 2 & Tier 3.<br/>• Fungsi: Diagnosa Pemicu Masbuq, Kontrak Tidur Fajar, & Evaluasi 21 Hari.<br/>• Pengguna: Musyrif Kamar & Konselor Bimbingan Konseling."]
        
        Inst3["3. MASTER TEMPLATE 3: RUBRIK CHECKLIST UJI KLINIS OSCE (PENGUJI)<br/>• Format: Lembar Observasi 4 Stasiun Praktik Fiqh Ibadah.<br/>• Fungsi: Sertifikasi Keabsahan Wudhu, Shalat, Tajwid, & Imamah 1-on-1.<br/>• Pengguna: Asatidz Fiqh & Dewan Penguji Kelulusan."]
...
```mermaid
flowchart TD
    subgraph AlurPenyelesaianKasusMutabaahTeman["PROTOKOL RESTORATIF PENANGANAN KASUS MUTABA'AH SEBAYA"]
        TemuanKasus["1. TEMUAN: Santri Mencentangkan Kartu Teman Sekamar yang Sedang Sakit"]
        
        ApresiasiEmpati["2. APRESIASI EMPATI: Memuji Niat Kasih Sayang Namun Mengoreksi Cara"]
        
        EdukasiFiqhSakit["3. EDUKASI FIQH RUKHSHAH: Pahala Sempurna Orang Sakit Sesuai Sunnah"]
        
        ValidasiResmi["4. VALIDASI DOKUMEN: Memberi Label Resmi [SAKIT] Berbasis Data Klinik"]
        
        IntegritasTerjaga["5. KELUHURAN ADAB: Tumbuhnya Kejujuran Spiritual & Ukhuwah yang Murni"]
        
        TemuanKasus --> ApresiasiEmpati --> EdukasiFiqhSakit --> ValidasiResmi --> IntegritasTerjaga
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturToolkitsIbadahTUMBUH["ARSITEKTUR TOOLKITS INSTRUMEN SHAHIHUL IBADAH (TUMBUH)"]
        
        Tool1["MASTER TEMPLATE 1: KARTU SAKU MUTABA'AH MINGGUAN (SANTRI)<br/>• Format: Kertas Sintetis Lipat 3 (Dimensi 9x14 cm).<br/>• Konten: Grid Shalat 5 Waktu, Rawatib, Dhuha, Tahajjud, & ODOJ.<br/>• Verifikasi: Tanda Tangan Musyrif Kamar & Stempel Apresiasi PBIS."]
        
        Tool2["MASTER TEMPLATE 2: FORMULIR CICO & FBA RINGKAS (MUSYRIF)<br/>• Format: Lembar Tindak Lanjut Klinis PBIS Tier 2 & Tier 3.<br/>• Konten: Identifikasi Anteseden, Kontrak Tidur Fajar, & Grafik 21 Hari.<br/>• Verifikasi: Kolaborasi Musyrif, Konselor BK, & Wali Santri."]
        
        Tool3["MASTER TEMPLATE 3: CHECKLIST PRAKTIK FIQH KLINIS OSCE (PENGUJI)<br/>• Format: Lembar Matriks Rubrik Analitik 4 Stasiun Uji Fiqh.<br/>• Konten: Skor Biner Rukun Thaharah, Shalat, Tajwid, & Imamah.<br/>• Verifikasi: Tanda Tangan Asatidz Penguji & Sertifikat Mutqin."]
