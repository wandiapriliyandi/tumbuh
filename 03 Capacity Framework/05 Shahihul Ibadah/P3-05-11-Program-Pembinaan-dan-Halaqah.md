...
```mermaid
flowchart TD
    subgraph TransformasiProgramPembinaanIbadah["TRANSFORMASI PROGRAM PEMBINAAN IBADAH"]
        ProgramSeremonial["PROGRAM SEREMONIAL SPORADIS (LAMA)<br/>• Tabligh akbar besar setahun sekali.<br/>• Tanpa halaqah pembinaan mingguan rutin.<br/>• Santri pasif; imamah dimonopoli ustadz sepuh."]
        
        ProgramTerstruktur["EMPAT PROGRAM UNGGULAN TERPADU (TUMBUH)<br/>• 1. Gerakan Shubuh Akbar & Mabit Ruhaniyah Mingguan.<br/>• 2. Daurah Praktik Fiqh Thaharah & Shalat Presisi.<br/>• 3. Halaqah One Day One Juz (ODOJ) Berbasis Time-Blocking.<br/>• 4. Kaderisasi Imam & Muadzin Muda (KIM)."]
        
        ProgramSeremonial ==>|DIREKONSTRUKSI MENJADI| ProgramTerstruktur
    end
```
...
```mermaid
graph TD
    A["Gugatan Program Massal Lepas (Pihak A):<br/>'Cukup beri ceramah umum di aula untuk 1000 santri; halaqah kecil 10 orang itu membuang-buang waktu musyrif!'"]
    --> B1["Tinjauan Hadits Halaqah Dzikir Masjid Nabawi (HR. Muslim No. 2701):<br/>Ijtama'a qawmun fii baitin min buyuutillah (Keutamaan malaikat menaungi & ketenangan turun pada majelis halaqah yang intim & berkah)."]
    A --> B2["Tinjauan Tradisi Ashhabus Suffah (Masjid Nabawi):<br/>Rasulullah SAW membina sahabat ahli ibadah dalam kelompok kecil intensif di serambi masjid untuk melahirkan kader peradaban."]
    A --> B3["Tinjauan Kitab Ihya' 'Ulumiddin (Al-Ghazali):<br/>Tarbiyah ruhiyah yang efektif menuntut ikatan persaudaraan intim (Ukhuwah Fillah) dalam lingkar halaqah kecil yang saling menasihati."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Halaqah kecil terstruktur adalah sarana tarbiyah otentik nabawiyyah yang melipatgandakan keberkahan ibadah."]
```
...
```mermaid
graph TD
    A["Gugatan Teori Komunitas (Pihak A):<br/>'Ibadah di asrama itu urusan masing-masing individu; tidak ada hubungannya dengan teori sosial Communities of Practice Lave & Wenger!'"]
    --> B1["Tinjauan Communities of Practice (Lave & Wenger, 1991):<br/>Pembelajaran sejati terjadi melalui keterlibatan sosial dalam komunitas praktik (Domain, Community, & Practice)."]
    A --> B2["Tinjauan Legitimate Peripheral Participation (LPP):<br/>Santri baru (Novice / J1) belajar adab ibadah dari pinggiran dengan mengamati & meniru santri senior (Master / J4) hingga menjadi praktisi penuh."]
    A --> B3["Tinjauan Peer Mentoring & Scaffolding:<br/>Santri senior yang membimbing adik kelas memperkuat retensi malakah ibadahnya sendiri hingga 90% (The Protégé Effect)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Arsitektur pembinaan berbasis Komunitas Praktik menjamin regenerasi budaya kesalehan asrama secara alami."]
```
...
```mermaid
flowchart LR
    subgraph ModelCoPIbadahTUMBUH["PROGRESI KOMUNITAS PRAKTIK IBADAH (LAVE & WENGER)"]
        J1_Novice["1. NOVICE (SANTRI J1)<br/>Mengamati keteladanan saf awal & meniru gerakan thuma'ninah senior."]
        
        J2_J3_Journeyman["2. JOURNEYMAN (SANTRI J2-J3)<br/>Mempraktikkan Shalat Rawatib, ODOJ, & memimpin halaqah kecil."]
        
        J4_Master["3. MASTER PRACTITIONER (SANTRI J4)<br/>Bertindak sebagai Imam Rawatib, Muadzin, & Mentor Qudwah Adik Kelas."]
        
        J1_Novice ==> J2_J3_Journeyman ==> J4_Master
    end
```
...
```mermaid
flowchart TD
    subgraph EmpatProgramUnggulanTUMBUH["DESAIN EMPAT PROGRAM UNGGULAN SHAHIHUL IBADAH (TUMBUH)"]
        
        P1["1. GERAKAN SHUBUH AKBAR & MABIT RUHANIYAH (MINGGUAN)<br/>• Waktu: Setiap Malam Ahad (Pukul 03.30 - 06.30).<br/>• Konten: Qiyamul Lail Syahdu, Muhasabah Taubat, & Kajian Asrar ash-Shalah.<br/>• Output: Pengisian Bahan Bakar Spiritual & Ukhuwah Seluruh Asrama."]
        
        P2["2. DAURAH PRAKTIK FIQH THAHARAH & SHALAT PRESISI (SEMESTERAN)<br/>• Waktu: Pekan Pertama Masuk Semester Baru (3 Hari Intensif).<br/>• Konten: Workshop Bedah Gerakan Wudhu, Mandi Janabah, Sujud Sahwi, & Shalat.<br/>• Output: Sertifikasi Uji Praktik 1-on-1 Presisi 100% Bebas Cacat Rukun."]
        
        P3["3. HALAQAH ONE DAY ONE JUZ (ODOJ) MANDIRI (HARIAN)<br/>• Waktu: Ba'da Shubuh (1/2 Juz) & Ba'da Maghrib/Isya' (1/2 Juz).<br/>• Konten: Tilawah Tartil Berbasis Time-Blocking & Setoran Logbook Digital.<br/>• Output: Khatam Al-Qur'an 30 Juz Setiap Bulan Secara Konsisten."]
        
        P4["4. KADERISASI IMAM & MUADZIN MUDA / KIM (BERJENJANG J3-J4)<br/>• Waktu: Setiap Hari Sabtu Sore & Praktik Jadwal Shalat Fardhu.<br/>• Konten: Tahsin Adzan, Seni Maqomat Suara, Fiqh Masbuq, & Khutbah Jumat.<br/>• Output: 100% Santri J4 Siap Menjadi Imam Rawatib & Khatib di Masyarakat."]
...
```mermaid
flowchart TD
    subgraph AlurPenangananDemamPanggungMuadzin["PROTOKOL PENDAMPINGAN DEMAM PANGGUNG MUADZIN (KIM)"]
        InsidenGemetar["1. INSIDEN: Santri H Gemetar & Suara Tercekat Saat Jadwal Adzan Shubuh Perdana"]
        
        DeEskalasiKasih["2. DE-ESKALASI EMPATIS: Musyrif Merangkul, Menenangkan Nafas, & Berbisik Lembut"]
        
        CoAdzanScaffolding["3. CO-ADZAN SCAFFOLDING: Membantu Takbir Pertama Bersama-sama Hingga Percaya Diri"]
        
        TuntasMandiri["4. ADZAN TUNTAS MANDIRI: Santri Melantunkan Adzan Merdu dengan Penuh Wibawa"]
        
        ApresiasiKomunal["5. PENGUATAN IDENTITAS: Pujian Tulus Musyrif Membangun Mental Pemimpin Umat"]
        
        InsidenGemetar --> DeEskalasiKasih --> CoAdzanScaffolding --> TuntasMandiri --> ApresiasiKomunal
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturEmpatProgramTUMBUH["ARSITEKTUR EMPAT PROGRAM UNGGULAN SHAHIHUL IBADAH"]
        
        Prog1["1. SHUBUH AKBAR & MABIT RUHANIYAH<br/>• Frekuensi: Mingguan (Malam Ahad).<br/>• Sasaran: Seluruh Santri Jenjang J1–J4.<br/>• Pilar: Qiyamul Lail, Muhasabah, Doa Fajar, & Ukhuwah."]
        
        Prog2["2. DAURAH PRAKTIK FIQH PRESISI<br/>• Frekuensi: Semesteran (Awal Semester 3 Hari).<br/>• Sasaran: Santri Baru J1 & Refreshing J2–J3.<br/>• Pilar: Tashih Wudhu 1-on-1, Shalat Presisi, & Sujud Sahwi."]
        
        Prog3["3. HALAQAH ONE DAY ONE JUZ (ODOJ)<br/>• Frekuensi: Harian (Ba'da Shubuh & Maghrib).<br/>• Sasaran: Seluruh Santri Asrama.<br/>• Pilar: Time-Blocking Shalat 5 Waktu & Logbook Tilawah."]
        
        Prog4["4. KADERISASI IMAM & MUADZIN (KIM)<br/>• Frekuensi: Mingguan & Praktik Shalat Fardhu.<br/>• Sasaran: Santri Jenjang J3 & J4 Terpilih.<br/>• Pilar: Tahsin Adzan, Fiqh Imamah, & Khutbah Jumat."]
