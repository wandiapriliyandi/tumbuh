...
```mermaid
graph TD
    Ibadah_SEL["Integrasi Shahihul Ibadah dengan Sains Perilaku"]
    
    Ibadah_SEL --> S1["1. Self-Management & Inhibitory Control (CASEL SEL)<br/>Kemampuan menghentikan aktivitas fisik/hiburan untuk segera berwudhu saat mendengar adzan."]
    Ibadah_SEL --> S2["2. Attentional Regulation & Mindfulness (Khusyuk)<br/>Fokus perhatian penuh saat ruku', sujud, & dzikir tanpa terdistraksi pikiran acak."]
    Ibadah_SEL --> S3["3. Habit Stacking & Circadian Rhythm Alignment<br/>Menyelaraskan ritme biologis tubuh dengan 5 waktu sholat & Qiyamul Lail."]
```
...
* **Level**: Project 3 - `03 Capacity Framework / 05 Shahihul Ibadah / ./P3-05-05-Standar-Kompetensi-dan-Taksonomi.md`**.
