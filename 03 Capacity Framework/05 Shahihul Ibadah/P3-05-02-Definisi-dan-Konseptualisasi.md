...
```mermaid
flowchart TD
    subgraph RekonseptualisasiShahihulIbadah["TRANSFORMASI DEFINISI KONSEPTUAL SHAHIHUL IBADAH"]
        DefinisiSempit["DEFINISI REDUKSIONIS FORMAL (LAMA)<br/>• Terbatas pada keabsahan rukun fiqh lahiriah semata.<br/>• Mengabaikan kekhusyukan kalbu & regulasi diri.<br/>• Santri shalat tertib namun akhlaknya tetap bermasalah."]
        
        DefinisiTUMBUH["KONSEPTUALISASI INTEGRATIF TUMBUH<br/>• Keabsahan Fiqh Sunnah Presisi.<br/>• Regulasi Diri (CASEL Self-Management & Inhibitory Control).<br/>• Transformasi Nyata: Shalat Mencegah Kekejian & Ghashab."]
        
        DefinisiSempit ==>|DIREKONSTRUKSI MENJADI| DefinisiTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Legalistik Kering (Pihak A):<br/>'Kata 'Ibadah' dalam fiqh itu hanya berarti menjalankan perintah rukun; tidak perlu memasukkan unsur ketundukan cinta (Khudhū' wa Hubb) ke dalam definisi operasional!'"]
    --> B1["Tinjauan Filologi Lisan al-'Arab (Ibnu Manzhur):<br/>Al-'Ibadah bermakna At-Tadzallul wal-Khudhū' (Ketundukan mutlak yang lahir dari rasa cinta & pengagungan tertinggi)."]
    A --> B2["Tinjauan Al-Mufradat (Ar-Raghib al-Ashfahani):<br/>Al-'Ibadah adalah Ghayatut Tadzallul (Puncak ketundukan yang tidak layak ditujukan kecuali kepada Sang Pencipta)."]
    A --> B3["Tinjauan Leksikon Ash-Shihhah (Al-Fairuzabadi):<br/>Ash-Shahih adalah sesuatu yang selamat dari cacat (Salima minal 'Aib) & menghasilkan buah manfaat yang dituju."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Shahihul Ibadah adalah ketaatan sempurna yang selamat dari cacat fiqh & berbuah ketundukan adab."]
```
...
```mermaid
graph TD
    A["Gugatan Pemisahan Sains Kognitif (Pihak A):<br/>'Menyegerakan shalat dan khusyu' itu urusan taufiq hidayah gaib semata; tidak ada hubungannya dengan teori Self-Management CASEL atau fungsi eksekutif otak!'"]
    --> B1["Tinjauan CASEL SEL Framework (Self-Management):<br/>Kapasitas mengatur emosi, menunda gratifikasi instan (Delayed Gratification), & mengarahkan perilaku menuju tujuan mulia."]
    A --> B2["Tinjauan Inhibitory Control (Diamond, 2013):<br/>Fungsi eksekutif Prefrontal Cortex yang memungkinkan santri menghentikan aktivitas asyik (game/obrolan) saat adzan berkumandang."]
    A --> B3["Tinjauan Attentional Regulation & Mindfulness (Kabat-Zinn):<br/>Latihan memusatkan fokus kesadaran penuh pada satu objek (bacaan shalat) tanpa terdistraksi rangsangan luar."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Shahihul Ibadah melatih kematangan fungsi eksekutif otak & kecerdasan regulasi diri santri."]
```
...
```mermaid
flowchart LR
    subgraph SainsKognitifIbadahTUMBUH["INTEGRASI SAINS KOGNITIF & REGULASI DIRI DALAM SHAHIHUL IBADAH"]
        SuaraAdzan["1. STIMULUS: Panggilan Adzan Berkumandang"]
        
        InhibitoryControl["2. INHIBITORY CONTROL (CASEL Self-Management)<br/>Menghentikan game/obrolan; Menunda kesenangan instan."]
        
        ThaharahWudhu["3. THAHARAH SOMATIK (Relaksasi Saraf & Kebersihan)"]
        
        AttentionalControl["4. ATTENTIONAL REGULATION (Kekhusyukan Shalat)<br/>Fokus penuh pada bacaan ayat & doa menghadap Allah."]
        
        DisiplinKarakter["5. OUTPUT: Kematangan Regulasi Diri & Integritas Moral"]
        
        SuaraAdzan --> InhibitoryControl --> ThaharahWudhu --> AttentionalControl --> DisiplinKarakter
    end
```
...
```mermaid
flowchart TD
    subgraph HabitStackingIbadahTUMBUH["ARSITEKTUR HABIT STACKING IBADAH DALAM ASRAMA 24 JAM"]
        
        Anchor1["ANCHOR 1: BANGUN TIDUR SUBUH (04.00)<br/>➔ STACK: Doa Bangun + Cuci Tangan + Siwak + Wudhu Hemat Air."]
        
        Anchor2["ANCHOR 2: TRANSISI SEBELUM BELAJAR (06.45)<br/>➔ STACK: Shalat Dhuha 2 Rakaat + Doa Pembuka Pintu Ilmu."]
        
        Anchor3["ANCHOR 3: JEDA SIANG MADRASAH (12.00)<br/>➔ STACK: Shalat Zhuhur Berjamaah + Rawatib + Qailulah 15 Menit."]
        
        Anchor4["ANCHOR 4: SELESAI OLAHRAGA SORE (17.30)<br/>➔ STACK: Mandi Bersih + Wudhu Maghrib + Tilawah 1 Juz."]
        
        Anchor5["ANCHOR 5: LAMPU PADAM MALAM (21.45)<br/>➔ STACK: Wudhu Sebelum Tidur + Dzikir 3 Qul + Muhasabah 3 Menit."]
...
```mermaid
flowchart TD
    subgraph AlurResolusiMasbuqKronis["PROTOKOL TRANSFORMASI MASBUQ KRONIS MENJADI SAF PERTAMA"]
        KasusMasbuq["1. ANOMALI: Santri Berprestasi Selalu Masbuq Karena Asyik Belajar"]
        
        DialogKarakter["2. DIALOG HIKMAH & COACHING REGULASI DIRI (Kepala Madrasah)<br/>• Menegaskan: Shalat adalah poros kemuliaan sejati, bukan sampingan."]
        
        HardCutOff["3. KEBIJAKAN HARD CUT-OFF LABORATORIUM (<20 Menit Sebelum Adzan)<br/>• Menghilangkan friksi lingkungan yang memicu keterlambatan."]
        
        AmanahMuadzin["4. PEMBERDAYAAN PERAN: Petugas Muadzin & Penjaga Saf Awal<br/>• Membangun kebanggaan menjadi pelayan panggilan Allah."]
        
        IstiqamahParipurna["5. ISTIQAMAH PARIPURNA: Santri Berprestasi & Selalu di Saf Pertama"]
        
        KasusMasbuq --> DialogKarakter --> HardCutOff --> AmanahMuadzin --> IstiqamahParipurna
    end
```
...
```mermaid
flowchart TD
    subgraph TigaDimensiShahihulIbadah["TAKSONOMI TIGA DIMENSI OPERASIONAL SHAHIHUL IBADAH"]
        
        subgraph DimensiKognitif["1. DIMENSI KOGNITIF SYAR'I (FAHMUSH SYARI'AH)"]
            DK1["• Mengetahui dalil naqli Al-Qur'an & Sunnah Shahihah."]
            DK2["• Memahami rukun, syarat sah, syarat wajib, & pembatal ibadah."]
            DK3["• Menguasai makna lafaz bacaan doa & dzikir (Fahmul Ma'ani)."]
        end
        
        subgraph DimensiAfektif["2. DIMENSI AFEKTIF KHUSYU' (HUDHURUL QALB)"]
            DA1["• Merasakan getaran keagungan Allah saat takbiratul ihram."]
            DA2["• Menikmati thuma'ninah ruku' & sujud tanpa tergesa-gesa."]
            DA3["• Tumbuh rasa harap (Raja') & takut (Khauf) yang seimbang."]
        end
        
        subgraph DimensiKonatif["3. DIMENSI KONATIF DISIPLIN (INHIBITORY REGULATION)"]
            DKon1["• Respons cepat <3 menit pasca-adzan menuju masjid."]
            DKon2["• Berwudhu hemat air (<90 detik) & tertib di saf pertama."]
            DKon3["• Istiqamah shalat rawatib, dhuha, & tilawah Al-Qur'an mandiri."]
        end
        
        DimensiKognitif <===> DimensiAfektif <===> DimensiKonatif
    end
```
