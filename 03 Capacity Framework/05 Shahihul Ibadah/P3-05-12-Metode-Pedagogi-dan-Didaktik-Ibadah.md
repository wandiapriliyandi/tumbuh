...
```mermaid
flowchart TD
    subgraph TransformasiMetodePedagogiIbadah["TRANSFORMASI METODE PEDAGOGI & DIDAKTIK IBADAH"]
        CeramahPasif["METODE CERAMAH PASIF & BENTAKAN (LAMA)<br/>• Ustadz ceramah teori di kelas; santri pasif.<br/>• Menegur kesalahan ruku' dengan membentak kasar.<br/>• Santri trauma, kaku kinestetik, & gagal paham."]
        
        PedagogiNabawiModern["PEDAGOGI NABAWIYYAH MODERN (TUMBUH)<br/>• 1. Talaqqi & Demonstrasi Presisi (I-Do, We-Do, You-Do).<br/>• 2. Koreksi Halus Seketika (Gentle Touch In-Situ Feedback).<br/>• 3. Habit Stacking Syar'i (Cue ➔ Routine ➔ Reward).<br/>• 4. Keteladanan Saf Pertama Musyrif (Live Qudwah)."]
        
        CeramahPasif ==>|DIREKONSTRUKSI MENJADI| PedagogiNabawiModern
    end
```
...
```mermaid
graph TD
    A["Gugatan Tanpa Demonstrasi (Pihak A):<br/>'Santri cukup disuruh membaca teks kitab fiqh sendiri; ustadz tidak perlu repot-repot naik panggung mempraktikkan shalat di depan mereka!'"]
    --> B1["Tinjauan Hadits Shalluu Kamaa Ra'aitumuunii Ushallii (HR. Bukhari No. 631):<br/>Perintah tegas Nabi SAW agar umat shalat persis meniru demonstrasi fisik yang dicontohkan Rasulullah."]
    A --> B2["Tinjauan Praktik Shalat Nabi di Atas Mimbar (HR. Bukhari No. 917):<br/>Rasulullah SAW sengaja shalat di atas mimbar tinggi agar seluruh sahabat melihat jelas posisi ruku' & sujud beliau (Innamaa fa'altu haadzaa li ta'tammuu bii)."]
    A --> B3["Tinjauan Kitab Fathul Bari (Ibnu Hajar al-Asqalani):<br/>Metode visual kinestetik langsung (Al-Mu'ayanah wal-Musyahadah) adalah metode pengajaran syariat yang paling efektif & bebas distorsi."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Demonstrasi presisi (Talaqqi) & keteladanan visual adalah sunnah pedagogis tertinggi Rasulullah SAW."]
```
...
```mermaid
graph TD
    A["Gugatan Teori Didaktik Barat (Pihak A):<br/>'Direct Instruction dan Cognitive Load Theory itu teori sekuler; mengajar fiqh ibadah di pondok cukup pakai metode sorogan dan bandongan saja!'"]
    --> B1["Tinjauan Direct Instruction (Siegfried Engelmann, 1980):<br/>Model pengajaran terstruktur eksplisit: I-Do (Ustadz Mendemonstrasikan) ➔ We-Do (Santri & Ustadz Praktik Bersama) ➔ You-Do (Santri Praktik Mandiri Presisi)."]
    A --> B2["Tinjauan Cognitive Load Theory (John Sweller, 2011):<br/>Memecah gerakan fiqh ke dalam komponen mikro (Chunking) mencegah kelebihan beban kognitif (Cognitive Overload) pada santri pemula."]
    A --> B3["Tinjauan Motor Learning & Feedback (Schmidt & Lee, 2019):<br/>Umpan balik kinestetik langsung mengunci memori prosedural di cerebellum hingga menjadi refleks permanen."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Sintesis sains instruksional modern mempercepat penguasaan fiqh ibadah santri secara mutqin & menyenangkan."]
```
...
```mermaid
flowchart LR
    subgraph ModelDirectInstructionIbadah["MODEL DIRECT INSTRUCTION PENGAJARAN SHALAT (TUMBUH)"]
        IDo["1. I-DO (USTADZ DEMONSTRASI)<br/>Ustadz memperagakan takbir & ruku' sempurna di depan kelas."]
        
        WeDo["2. WE-DO (LATIHAN TERBIMBING)<br/>Ustadz & seluruh santri mempraktikkan gerakan bersama hitungan 1-2-3."]
        
        YouDo["3. YOU-DO (PRAKTIK MANDIRI 1-ON-1)<br/>Setiap santri mempraktikkan sendiri & diuji langsung tanpa bantuan."]
        
        RefleksMutqin["4. OUTPUT: Refleks Gerakan Shalat Mutqin & Thuma'ninah"]
        
        IDo --> WeDo --> YouDo --> RefleksMutqin
    end
```
...
```mermaid
flowchart TD
    subgraph EmpatMetodePedagogisTUMBUH["EMPAT METODE PEDAGOGIS BAKU SHAHIHUL IBADAH (TUMBUH)"]
        
        M1["1. TALAQQI & DEMONSTRASI PRESISI<br/>• Ustadz mempraktikkan gerakan secara langsung.<br/>• Format I-Do, We-Do, You-Do terstruktur.<br/>• Digunakan dalam Daurah Fiqh & Halaqah Awal."]
        
        M2["2. KOREKSI HALUS SEKETIKA (IN-SITU FEEDBACK)<br/>• Musyrif membetulkan saf & gerakan dengan sentuhan lembut.<br/>• Berbisik santun tanpa suara keras mempermalukan.<br/>• Diterapkan di masjid & tempat wudhu asrama 24 jam."]
        
        M3["3. HABIT STACKING SYAR'I (KAIT KEBIASAAN)<br/>• Mengaitkan amalan sunnah pada jangkar shalat fardhu.<br/>• 2 Lembar Tilawah Ba'da Shalat ➔ Khatam 1 Juz/Hari.<br/>• Wudhu Sebelum Tidur ➔ Dzikir 3 Qul Miring Kanan."]
        
        M4["4. KETELADANAN SAF PERTAMA (LIVE QUDWAH)<br/>• Musyrif hadir di saf terdepan 15 mnt sebelum adzan.<br/>• Menunjukkan ketenangan thuma'ninah nyata.<br/>• Menjadi magnet penarik langkah santri ke masjid."]
...
```mermaid
flowchart TD
    subgraph AlurPenegakanEtikaKoreksiPedagogi["PROTOKOL PENEGAKAN ETIKA KOREKSI PEDAGOGIS MASJID"]
        PelanggaranEtika["1. PELANGGARAN: Musyrif Mempermalukan Santri di Mikrofon Masjid Ba'da Shalat"]
        
        TeguranPimpinan["2. TEGURAN TEGAS PIMPINAN: Menegakkan Kaidah Perlindungan Martabat Santri"]
        
        PermintaanMaafMusyrif["3. RESTORASI ADAB: Musyrif Meminta Maaf Secara Tulus Kepada Santri"]
        
        TashihPrivatEmpatis["4. TASHIH PRIVAT EMPATIS: Mengajarkan Fiqh Gerakan Shalat dengan Kelembutan"]
        
        EkosistemAdabTegak["5. PEMULIHAN IKLIM: Masjid Pesantren Menjadi Rumah Kasih Sayang Tarbiyah"]
        
        PelanggaranEtika --> TeguranPimpinan --> PermintaanMaafMusyrif --> TashihPrivatEmpatis --> EkosistemAdabTegak
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturMetodePedagogiTUMBUH["ARSITEKTUR EMPAT METODE PEDAGOGIS SHAHIHUL IBADAH"]
        
        subgraph Metode1["1. TALAQQI & DEMONSTRASI PRESISI (DIRECT INSTRUCTION)"]
            M1_A["• Model Instruksional: I-Do (Demonstrasi) ➔ We-Do (Bersama) ➔ You-Do (Mandiri)."]
            M1_B["• Chunking Rukun Fiqh: Memecah Gerakan Kinestetik Menjadi Komponen Mikro."]
            M1_C["• Platform: Daurah Fiqh Awal Semester & Matrikulasi Santri Baru J1."]
        end
        
        subgraph Metode2["2. KOREKSI HALUS SEKETIKA (GENTLE IN-SITU FEEDBACK)"]
            M2_A["• Sentuhan Fisik Lembut (The Gentle Touch) Merapikan Saf & Posisi Sujud."]
            M2_B["• Mengharamkan Mutlak Teguran Kasar / Mempermalukan di Mikrofon Masjid."]
            M2_C["• Platform: Pendampingan Saf Shalat & Bimbingan Tempat Wudhu Harian."]
        end
        
        subgraph Metode3["3. HABIT STACKING SYAR'I (KAIT KEBIASAAN OTOMATIS)"]
            M3_A["• Formula: [CUE: Salam Shalat Fardhu] ➔ [ROUTINE: 2 Lembar Tilawah] ➔ [REWARD: Sakinah]."]
            M3_B["• Formula: [CUE: Jam Tidur 21.45] ➔ [ROUTINE: Wudhu & 3 Qul] ➔ [REWARD: Bugar Fajar]."]
            M3_C["• Platform: Halaqah ODOJ Harian & SOP Higiene Tidur Asrama 24 Jam."]
        end
