...
```mermaid
flowchart TD
    subgraph TransformasiDoktrinIndukIbadah["TRANSFORMASI DOKTRIN INDUK SHAHIHUL IBADAH"]
        ParadigmaLama["PARADIGMA FORMALISTIK KERING (LAMA)<br/>• Shalat mekanis tanpa thuma'ninah & pemahaman makna.<br/>• Patroli rotan memicu trauma & kepatuhan semu.<br/>• Ibadah runtuh seketika saat lulus dari pesantren."]
        
        DoktrinTUMBUH["DOKTRIN INDUK SHAHIHUL IBADAH (TUMBUH)<br/>• Presisi Fiqh Sunnah + Thuma'ninah + Self-Management.<br/>• SW-PBIS Multi-Tier: The 10-Minute Call & CICO Fajar.<br/>• Malakah Ibadah Abadi Melintasi Tangga J1 s/d J4."]
        
        ParadigmaLama ==>|DIREKONSTRUKSI MENJADI| DoktrinTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Ritual Terisolasi (Pihak A):<br/>'Ibadah shalat itu hanya ritual 10 menit di masjid; tidak ada hubungannya dengan seluruh siklus hidup 24 jam santri!'"]
    --> B1["Tinjauan Tafsir QS. Al-An'am: 162:<br/>Inna shalaatii wa nusukii wa mahyaaya wa mamaatii lillaahi rabbil 'aalamiin (Ibadah shalat adalah poros penggerak seluruh nafas hidup & mati seorang muslim)."]
    A --> B2["Tinjauan Madarijus Salikin (Ibnul Qayyim):<br/>Manzilah 'Iyyaka Na'budu' menuntut ketundukan mutlak lahir-batin & ittiba'us sunnah murni bebas bid'ah."]
    A --> B3["Tinjauan Ihya' 'Ulumiddin (Al-Ghazali):<br/>Asrar ash-Shalah mengubah raga mushalli menjadi cermin ketenteraman jiwa di hadapan Sang Pencipta."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Doktrin Shahihul Ibadah adalah poros gravitasi kehidupan santri di dunia & akhirat."]
```
...
```mermaid
graph TD
    A["Gugatan Dikotomi Ilmu (Pihak A):<br/>'Fiqh ibadah tidak boleh dicampuradukkan dengan psikologi CASEL Self-Management, neurosains perhatian, dan sistem PBIS!'"]
    --> B1["Tinjauan CASEL Self-Management (2020):<br/>Regulasi diri, disiplin waktu, & kontrol impuls biologis adalah fondasi psikologis bagi tegaknya shalat berjamaah tepat waktu."]
    A --> B2["Tinjauan Neurosains Attentional Regulation (Posner, 2012):<br/>Thuma'ninah & Khusyu' melatih Prefrontal Cortex menekan distraksi pikiran (Inhibitory Control)."]
    A --> B3["Tinjauan School-Wide PBIS (Horner & Sugai, 2015):<br/>Arsitektur intervensi multi-tier menyediakan sistem pendukung terstruktur bagi santri yang mengalami kesulitan."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Sintesis multidisipliner memperkokoh pengamalan fiqh ibadah dengan landasan sains perilaku teruji."]
```
...
```mermaid
flowchart LR
    subgraph KonvergensiSainsMultidisipliner["KONVERGENSI MULTIDISIPLINER DOKTRIN SHAHIHUL IBADAH"]
        FiqhTurats["1. FIQH TURATS: Standar Keabsahan Syar'i (Rukun & Syarat)"]
        
        CASEL_SEL["2. CASEL SELF-MANAGEMENT: Regulasi Emosi & Disiplin Waktu"]
        
        Neurosains["3. NEUROSINS KOGNITIF: Attentional Control & Thuma'ninah"]
        
        PBIS_MultiTier["4. SW-PBIS MULTI-TIER: Sistem Intervensi Asrama & Apresiasi 4:1"]
        
        OutputDoktrin["5. OUTPUT: Karakter Insan 'Abid Paripurna (Tangga J1–J4)"]
        
        FiqhTurats --> OutputDoktrin
        CASEL_SEL --> OutputDoktrin
        Neurosains --> OutputDoktrin
        PBIS_MultiTier --> OutputDoktrin
    end
```
...
```mermaid
flowchart TD
    subgraph EkosistemPembiasaan24JamTUMBUH["ARSITEKTUR EKOSISTEM PEMBIASAAN IBADAH 24 JAM"]
        
        subgraph EmpatLokus["EMPAT LOKUS ASRAMA 24 JAM"]
            L1["1. Tempat Wudhu: Isbagh, Hemat Air (<90 dtk), & Sekat Akrilik."]
            L2["2. Ruang Masjid: Saf Awal, Garis Tumit, Thuma'ninah, & Sacred Silence."]
            L3["3. Kamar Tidur: Jam Tidur 21.45, Bangun Fajar Santun, & Tilawah ODOJ."]
            L4["4. Ruang Kelas: Shalat Dhuha Mandiri & Doa Majelis Ilmu Khusyu'."]
        end
        
        subgraph EmpatProgram["EMPAT PROGRAM UNGGULAN TERPADU"]
            P1_["1. Gerakan Shubuh Akbar & Mabit Ruhaniyah (Mingguan)."]
            P2_["2. Daurah Praktik Fiqh Thaharah & Shalat Presisi (Semesteran)."]
            P3_["3. Halaqah One Day One Juz (ODOJ) Berbasis Time-Blocking (Harian)."]
            P4_["4. Kaderisasi Imam & Muadzin Muda / KIM (Berjenjang J3–J4)."]
        end
        
        EmpatLokus <===> EmpatProgram
    end
```
...
```mermaid
flowchart TD
    subgraph AlurTransformasiSantriBermasalah["STUDI KASUS TRANSFORMASI SANTRI BERMASALAH MENJADI TELADAN"]
        KasusAwal["1. KONDISI AWAL: 45x Masbuq, Sembunyi di Toilet, & Divonis Santri Gagal"]
        
        DiagnosaFBA["2. DIAGNOSA FBA: Mengungkap Trauma Kekerasan Air & Kebencian Fajar"]
        
        PemulihanEmpatis["3. PEMULIHAN EMPATIS: Bimbingan Kasih Sayang Musyrif & Perlindungan Mental"]
        
        KaderisasiKIM["4. KADERISASI KIM: Menyalurkan Bakat Vokal Menjadi Muadzin Fajar Resmi"]
        
        JuaraTeladan["5. TRANSFORMASI PARIPURNA: Juara 1 Adzan, Zero Masbuq, & Qudwah Asrama"]
        
        KasusAwal --> DiagnosaFBA --> PemulihanEmpatis --> KaderisasiKIM --> JuaraTeladan
    end
```
...
```mermaid
flowchart TD
    subgraph MasterDoktrinShahihulIbadah["ARSITEKTUR MASTER DOKTRIN SHAHIHUL IBADAH (TUMBUH)"]
        
        subgraph Dimensi1["DIMENSI 1: KETERTIBAN THAHARAH & KESUCIAN FISIK"]
            D1_1["• Isbaghul Wudhu Presisi Membasuh Sempurna Sesuai Batas Fiqh."]
            D1_2["• Konservasi Air Syar'iyyah: Hemat Air Sesuai Sunnah 1 Mud."]
            D1_3["• Mandi Janabah Tertib Rukun & Adab Istinja' Bersih."]
        end
        
        subgraph Dimensi2["DIMENSI 2: SHALAT BERJAMAAH & THUMA'NINAH MASJID"]
            D2_1["• Disiplin The 10-Minute Call & Kehadiran di Saf Terdepan."]
            D2_2["• Kerapian Saf: Heel-to-Heel Alignment & Merapatkan Bahu."]
            D2_3["• Thuma'ninah Kinestetik 4-5 Detik & Khusyu' Menghayati Makna."]
        end
        
        subgraph Dimensi3["DIMENSI 3: KELAZIMAN IBADAH SUNNAH (NAWAFIL)"]
            D3_1["• Istiqamah Shalat Rawatib 12 Rakaat Qabliyyah & Ba'diyyah."]
            D3_2["• Shalat Dhuha Harian & Qiyamul Lail Mandiri di Asrama."]
            D3_3["• Puasa Sunnah Senin-Kamis & Ayyamul Bidh Terjadwal."]
        end
        
        subgraph Dimensi4["DIMENSI 4: TILAWAH & KHIDMAH KEPEMIMPINAN MASJID"]
            D4_1["• Halaqah One Day One Juz (ODOJ) Tartil Berbasis Time-Blocking."]
            D4_2["• Sertifikasi Kompetensi Imam Shalat Rawatib & Muadzin (KIM)."]
            D4_3["• Menjadi Figur Teladan Hidup (Live Qudwah) bagi Umat."]
        end
