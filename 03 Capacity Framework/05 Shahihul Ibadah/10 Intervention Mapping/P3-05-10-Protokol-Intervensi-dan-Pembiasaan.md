...
```mermaid
graph TD
    subgraph Intervensi_Ibadah_PBIS["Intervensi PBIS untuk Shahihul Ibadah"]
        Tier1["TIER 1 (Pencegahan Universal 80-90%)<br/>• Ekspektasi adab masjid jelas, bimbingan Fiqh aplikatif & apresiasi 4:1."]
        
        Tier2["TIER 2 (Dukungan Terarah 10-15%)<br/>• Kasus: Santri yang sering terlambat sholat Subuh (>3x sepekan) / mengantuk berat.<br/>• Tindakan: CICO bangun tidur dengan musyrif kamar, audit jam tidur & ranjang dekat pintu."]
        
        Tier3["TIER 3 (Intervensi Khusus 1-5%)<br/>• Kasus: Sengaja bolos sholat berjamaah / bersembunyi di kamar/kamar mandi.<br/>• Tindakan: FBA (mencari pemicu: depresi, bully, masalah fisik), konseling BK & komitmen restoratif."]
...
* **Level**: Project 3 - `03 Capacity Framework / 05 Shahihul Ibadah / 10 Intervention Mapping`
* **Langkah Berikutnya**: **`14 Evidence/P3-05-14-Sintesis-dan-Validasi-Shahihul-Ibadah.md`**.
