...
```mermaid
flowchart TD
    subgraph TransformasiMetodologiAsesmen["TRANSFORMASI METODOLOGI ASESMEN IBADAH"]
        AsesmenTunggal["ASESMEN SUMBER TUNGGAL CACAT (LAMA)<br/>• Buku Mutaba'ah diisi centang palsu oleh santri.<br/>• Rapor ditentukan subjektivitas sepihak musyrif.<br/>• Data tidak valid, bias halo, & tanpa verifikasi silang."]
        
        Triangulasi360["TRIANGULASI 360 DERAJAT & MTMM (TUMBUH)<br/>• 1. Observasi Logbook Musyrif Asrama (35%).<br/>• 2. Ujian Praktik Klinis Guru Fiqh / OSCE (30%).<br/>• 3. Self-Assessment Reflektif Santri (20%).<br/>• 4. Peer-Confirmation Rekan Sekamar (15%)."]
        
        AsesmenTunggal ==>|DIREKONSTRUKSI MENJADI| Triangulasi360
    end
```
...
```mermaid
graph TD
    A["Gugatan Asesmen Otoriter Sepihak (Pihak A):<br/>'Cukup musyrif yang menentukan nilai ibadah santri secara mutlak; tidak perlu melibatkan konfirmasi teman sebaya atau self-assessment santri!'"]
    --> B1["Tinjauan Tafsir QS. Al-Baqarah: 282:<br/>Wastasyhiduu syahiidaini min rijaalikum (Perintah syariat untuk menghadirkan multi-saksi yang adil guna menjamin validitas kebenaran)."]
    A --> B2["Tinjauan Kaidah Fiqh Qadha':<br/>Al-Bayyinatu 'alal mudda'i (Klaim penilaian wajib disertai alat bukti yang nyata & multi-sumber, bukan sangkaan)."]
    A --> B3["Tinjauan Fiqh Muhasabatun Nafs (Al-Ghazali):<br/>Self-assessment reflektif adalah sarana tarbiyah batiniah agar santri jujur mengakui kekurangan amalnya di hadapan Allah."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Triangulasi 360 Derajat adalah perwujudan prinsip keadilan syariat & hisab yang transparan."]
```
...
```mermaid
graph TD
    A["Gugatan Kerumitan Statistik (Pihak A):<br/>'Metode MTMM Campbell-Fiske dan triangulasi Denzin itu terlalu rumit untuk evaluasi shalat santri di asrama!'"]
    --> B1["Tinjauan Multitrait-Multimethod Matrix (Campbell & Fiske, 1959):<br/>MTMM menguji Convergent Validity (Korelasi tinggi antar-metode berbeda untuk trait yang sama) & Discriminant Validity (Korelasi rendah antar-trait berbeda)."]
    A --> B2["Tinjauan Triangulasi Data 360 Derajat (Norman Denzin, 1978):<br/>Memadukan Data Triangulation (Lintas Waktu & Lokasi) & Investigator Triangulation (Lintas Penilai) untuk mengeliminasi bias personal."]
    A --> B3["Tinjauan Psikometri Modern:<br/>Instrumen MTMM membuktikan bahwa skor ibadah santri benar-benar mencerminkan karakter aslinya (True Score), bukan artefak metode ujian."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Penerapan MTMM & Triangulasi 360 menjamin validitas konstruk & keandalan evaluasi ibadah."]
```
...
```mermaid
flowchart LR
    subgraph ModelMTMMIbadahTUMBUH["MATRIKS MULTITRAIT-MULTIMETHOD (MTMM) SHAHIHUL IBADAH"]
        MusyrifObs["METODE 1: Observasi Logbook Musyrif (35%)"]
        
        FiqhOSCE["METODE 2: Ujian Praktik Klinis OSCE (30%)"]
        
        SelfJournal["METODE 3: Self-Assessment Reflektif (20%)"]
        
        PeerSosiometri["METODE 4: Peer Confirmation Sekamar (15%)"]
        
        KarakterSejati["OUTPUT: Skor Sejati Karakter Shahihul Ibadah (True Score)"]
        
        MusyrifObs --> KarakterSejati
        FiqhOSCE --> KarakterSejati
        SelfJournal --> KarakterSejati
        PeerSosiometri --> KarakterSejati
    end
```
...
```mermaid
flowchart TD
    subgraph EmpatPilarSumberDataIbadah["EMPAT PILAR SUMBER DATA ASESMEN SHAHIHUL IBADAH (TUMBUH)"]
        
        P1["PILAR 1: OBSERVASI MUSYRIF ASRAMA (BOBOT 35%)<br/>• Presensi Shalat Berjamaah 5 Waktu di Masjid.<br/>• Kehadiran di Saf Pertama & Adab Merapatkan Tumit.<br/>• Fast-Tap Logging PBIS [IB-POS] & [IB-NEG]."]
        
        P2["PILAR 2: UJIAN PRAKTIK ASATIDZ FIQH / OSCE (BOBOT 30%)<br/>• Uji Praktik Isbaghul Wudhu & Mandi Janabah 1-on-1.<br/>• Presisi Kinestetik 7 Anggota Sujud & Thuma'ninah.<br/>• Kelancaran Tajwid Al-Fatihah Bebas Lahn Jaliy."]
        
        P3["PILAR 3: SELF-ASSESSMENT SANTRI (BOBOT 20%)<br/>• Lembar Refleksi Spiritual Harian (Mutaba'ah Yaumiyyah).<br/>• Pencatatan Shalat Rawatib, Dhuha, & Tilawah 1 Juz.<br/>• Muhasabah Batiniah Kekhusyukan & Hambatan Hati."]
        
        P4["PILAR 4: PEER CONFIRMATION SEKAMAR (BOBOT 15%)<br/>• Konfirmasi Kehadiran Bangun Fajar & Qiyamul Lail.<br/>• Kebersihan & Kerapian Sajadah/Mukena di Kamar.<br/>• Sosiometri Saling Mengingatkan Kebaikan Ibadah."]
...
```mermaid
flowchart TD
    subgraph AlurRekonsiliasiTriangulasi360["PROTOKOL REKONSILIASI DISKREPANSI DATA ASESMEN IBADAH"]
        AnomaliData["1. ANOMALI DATA: Ujian Fiqh Nilai 100 vs Musyrif & Teman Catat Masbuq Kronis"]
        
        DeteksiSistem["2. DETEKSI SISTEM: Red Flag Discrepancy Variance > 30 Poin"]
        
        SidangKlinis["3. SIDANG REKONSILIASI KLINIS: Guru Fiqh & Musyrif Membedah Akar Masalah"]
        
        SkorBobot360["4. PENETAPAN SKOR 360 TERPADU: 75.75 (Level 2 Developing) Transparan"]
        
        KontrakTransformasi["5. KONTRAK INTERVENSI TIDUR FAJAR: Menyelaraskan Teori dengan Amaliah Riil"]
        
        AnomaliData --> DeteksiSistem --> SidangKlinis --> SkorBobot360 --> KontrakTransformasi
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturTriangulasi360TUMBUH["ARSITEKTUR ASESMEN TRIANGULASI 360 DERAJAT (TUMBUH)"]
        
        Pilar1["1. OBSERVASI IN-VIVO MUSYRIF (35%)<br/>• Logbook PBIS Presensi Shalat Berjamaah.<br/>• Observasi Kerapian Saf & Thuma'ninah.<br/>• Catatan Kedisiplinan Wudhu Hemat Air."]
        
        Pilar2["2. UJIAN PRAKTIK KLINIS FIQH / OSCE (30%)<br/>• Uji Praktik Thaharah 1-on-1 Presisi.<br/>• Uji Rukun & Pembatal Shalat Kinestetik.<br/>• Uji Tajwid Al-Fatihah & Fahmul Ma'ani."]
        
        Pilar3["3. SELF-ASSESSMENT SANTRI (20%)<br/>• Jurnal Refleksi Mutaba'ah Yaumiyyah.<br/>• Pencatatan Amaliah Sunnah Mandiri.<br/>• Muhasabah Batiniah & Komitmen Ikhlas."]
        
        Pilar4["4. PEER CONFIRMATION SEKAMAR (15%)<br/>• Fact-Checking Bangun Fajar & Tahajjud.<br/>• Observasi Kerapian Adab Kamar 24 Jam.<br/>• Sosiometri Budaya Saling Mengingatkan."]
        
        SkorAkhir["SKOR AKHIR ASESMEN TRIANGULASI 360°<br/>Rapor Karakter Shahihul Ibadah (Status J1–J4)"]
