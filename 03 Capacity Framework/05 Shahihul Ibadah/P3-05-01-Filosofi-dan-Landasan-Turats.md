...
```mermaid
graph TD
    Turats["Rujukan Turats Shahihul Ibadah"]
    
    Turats --> T1["1. Matan Ghayah wat Taqrib (Abu Syuja')<br/>Standar Fiqh Thaharah & Sholat Madzhab Syafi'i bagi santri dasar."]
    Turats --> T2["2. Bidayatul Mujtahid (Ibnu Rusyd)<br/>Pemahaman hikmah perbandingan madzhab & dalil sunnah bagi santri lanjut."]
    Turats --> T3["3. Sifat Sholat Nabi (Syaikh Al-Albani / Ibnul Qayyim)<br/>Ketepatan gerakan & bacaan sholat persis sebagaimana diajarkan Rasulullah ﷺ."]
```
...
* **Level**: Project 3 - `03 Capacity Framework / 05 Shahihul Ibadah / ./P3-05-02-Definisi-dan-Konseptualisasi.md`**.
