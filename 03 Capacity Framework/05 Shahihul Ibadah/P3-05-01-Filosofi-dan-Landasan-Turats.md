...
```mermaid
flowchart TD
    subgraph TransformasiParadigmaIbadah["TRANSFORMASI PARADIGMA SHAHIHUL IBADAH"]
        IbadahMekanis["PARADIGMA FORMALISTIK MEKANIS (LAMA)<br/>• Shalat kilat tanpa thuma'ninah & tanpa khusyu'.<br/>• Sindrom was-was thaharah & pemborosan air.<br/>• Fanatisme madzhab sempit yang merusak ukhuwah."]
        
        ShahihulIbadahTUMBUH["SHAHIHUL IBADAH TERPADU (TUMBUH)<br/>• Ketepatan kaidah Fiqh Sunnah & Thuma'ninah mutlak.<br/>• Fiqh Bathin: Kehadiran kalbu, mahabbah, & ketenangan.<br/>• Literasi toleransi ikhtilaf furuiyyah & hemat air syar'i."]
        
        IbadahMekanis ==>|DIREKONSTRUKSI MENJADI| ShahihulIbadahTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Ritualisme Bebas (Pihak A):<br/>'Ibadah itu yang penting niatnya baik dan khusyu'; tata cara gerakan dan dalil sunnah tidak perlu diperdebatkan secara kaku!'"]
    --> B1["Tinjauan Tafsir QS. Al-Kahf: 110 & Al-Mulk: 2 (Liyabluwakum ayyukum ahsanu 'amala):<br/>Al-Fudhail bin 'Iyadh menegaskan: Ahsanu 'amala adalah 'Akhlashuhu wa Ashwabuhu' (Paling Ikhlas & Paling Benar Sesuai Sunnah)."]
    A --> B2["Tinjauan Hadits Induk Shalat (HR. Bukhari No. 631):<br/>Shallu kama ra'aitumuni ushalli (Ibadah Mahdhah bersifat Tauqifiyyah; wajib persis meneladani Sunnah Nabi SAW)."]
    A --> B3["Tinjauan Asrar ash-Shalah (Al-Ghazali - Ihya'):<br/>Syarat sah zhahir menggugurkan kewajiban hukum, sedangkan syarat bathin (Khusyu') menentukan pahala penerimaan di sisi Allah."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Shahihul Ibadah wajib memadukan kebenaran kaidah fiqh zhahir dengan kesucian niat bathin."]
```
...
```mermaid
graph TD
    A["Gugatan Gerakan Mekanis (Pihak A):<br/>'Gerakan shalat itu sekadar olahraga jasmani; tidak ada kaitannya dengan sains kognitif atau ketenangan sistem saraf!'"]
    --> B1["Tinjauan Embodied Cognition Theory (Varela, Thompson, & Rosch):<br/>Postur fisik tubuh secara langsung membentuk pola kognisi, persepsi emosi, & kesadaran jiwa (Mind-Body Coupling)."]
    A --> B2["Tinjauan Psikofisiologi Saraf Vagal (Porges - Polyvagal Theory):<br/>Posisi ruku' yang lurus & sujud yang menempelkan dahi ke tanah menstimulasi Parasympathetic Nervous System, meredakan hormon kortisol."]
    A --> B3["Tinjauan Cognitive Load Reduction (Sweller):<br/>Memahami arti bacaan shalat (Fahmul Ma'ani) mengunci perhatian kognitif, mengeliminasi lamunan pikiran melayang (Mind-Wandering)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Gerakan shalat adalah desain psikofisiologis sempurna yang menghubungkan raga dengan ketenangan kalbu."]
```
...
```mermaid
flowchart LR
    subgraph FisiologiThumaninahTUMBUH["PSIKOFISIOLOGI THUMA'NINAH DALAM SHALAT NABAWNYYAH"]
        PosturSunnah["POSTUR SUNNAH PRESISI (Punggung Rata, Dahi Menempel Tanah)"]
        
        ThumaninahDurasi["THUMA'NINAH 3-5 DETIK (Ketenangan Sendi-Sendi Raga)"]
        
        SarafParasimpatis["AKTIVASI NERVUS VAGUS (Penurunan Detak Jantung & Kortisol)"]
        
        ThumaninatulQalb["TERCAPAINYA KHUSYU' & KETENTERAMAN JIWA (Nafs Muthma'innah)"]
        
        PosturSunnah --> ThumaninahDurasi --> SarafParasimpatis --> ThumaninatulQalb
    end
```
...
```mermaid
flowchart TD
    subgraph EkosistemIbadah24JamTUMBUH["EKOSISTEM INTEGRASI SHAHIHUL IBADAH ASRAMA 24 JAM"]
        
        Fajar["04.00 - 05.30: QIYAMUL LAIL, ADAB THAHARAH, SHALAT SUBUH BERJAMAAH SAF PERTAMA"]
        
        Duha["06.45 - 07.15: SHALAT DHUHA MANDIRI & DOA KELUAR ASRAMA MENUNTUT ILMU"]
        
        Siang["12.00 - 12.45: SHALAT ZHUHUR BERJAMAAH & SUNNAH RAWATIB QABLIYYAH/BA'DIYYAH"]
        
        Petang["15.30 - 18.30: SHALAT ASHAR, TILAWAH AL-QUR'AN, & SHALAT MAGHRIB BERJAMAAH"]
        
        Malam["19.30 - 21.30: SHALAT ISYA' BERJAMAAH, RAWATIB, & HALAQAH TAFAQQUH FID-DIN"]
        
        Tidur["21.45 - 22.00: ADAB TIDUR SUNNAH (Wudhu Sebelum Tidur, Dzikir Tiga Qul, Miring Kanan)"]
        
        Fajar --> Duha --> Siang --> Petang --> Malam --> Tidur --> Fajar
    end
```
...
```mermaid
flowchart TD
    subgraph AlurResolusiIbadahAsrama["PROTOKOL RESOLUSI KEDISIPLINAN IBADAH ASRAMA"]
        KasusIbadah["1. ANOMALI: Santri Tertidur Saat Shubuh Akibat Begadang Belajar"]
        
        AuditSirkadian["2. AUDIT KRONOBIOLOGI & DIALOG SOKRATIK (Musyrif Kamar)<br/>• Menemukan akar masalah manajemen waktu tidur malam."]
        
        Restrukturisasi["3. RESTRUKTURISASI JADWAL TIDUR SEHAT (<22.30)<br/>• Menyeimbangkan hak tubuh & hak ibadah kepada Allah."]
        
        AmanahRestoratif["4. AMANAH RESTORATIF: Petugas Muadzin Shubuh & Belajar Ba'da Subuh<br/>• Santri bangkit menjadi penjaga waktu shalat yang disiplin."]
        
        KasusIbadah --> AuditSirkadian --> Restrukturisasi --> AmanahRestoratif
    end
```
...
```mermaid
flowchart TD
    subgraph DuaPilarShahihulIbadah["ARSITEKTUR DUA PILAR SHAHIHUL IBADAH (TUMBUH)"]
        
        subgraph PilarZhahir["PILAR 1: FIQH ZHAHIR (KETEPATAN SYAR'I)"]
            PZ1["• Thaharah: Wudhu, Tayammum, Mandi Wajib Sempurna."]
            PZ2["• Syarat & Rukun: Menutup Aurat, Kiblat, Waktu, & Thuma'ninah."]
            PZ3["• Sunnah Haiah & Ab'adh: Posisi Jari, Doa Iftitah, Tasyahhud."]
            PZ4["• Pembatal Ibadah: Menjaga dari Gerakan Ekstra & Hadats."]
        end
        
        subgraph PilarBathin["PILAR 2: FIQH BATHIN (KEHADIRAN KALBU / KEKHUSYUKAN)"]
            PB1["• Hudhurul Qalb: Kehadiran Hati Penuh Sadar Menghadap Allah."]
            PB2["• Tafahhum: Menghayati Makna Lafaz Bacaan & Doa."]
            PB3["• Ta'zhim & Haibah: Mengagungkan Kebesaran & Keagungan Ilahi."]
            PB4["• Raja' & Haya': Harap Diterima & Malu atas Kelalaian Diri."]
        end
        
        PilarZhahir <===>|TERPADU UTUH MELAHIRKAN| IbadahMaqbulah["IBADAH MAQBULAH (Mencegah Maksiat & Menyejukkan Jiwa)"]
        PilarBathin <===> IbadahMaqbulah
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolOperasionalIbadahAsrama["SOP OPERASIONAL SHALAT BERJAMAAH & THAHARAH ASRAMA"]
        
        Adzan["1. 15 MENIT SEBELUM ADZAN: Santri Mengambil Wudhu Hemat Air & Menuju Masjid"]
        
        Tahiyyat["2. MASUK MASJID: Shalat Sunnah Tahiyyatul Masjid & Menempati Saf Depan Kosong"]
        
        Iqamah["3. SAAT IQAMAH: Musyrif & Imam Merapatkan dan Meluruskan Saf (Sawwu Shufufakum)"]
        
        ShalatKhusyu["4. SHALAT BERJAMAAH: Imam Membaca Tartil, Makmum Menghayati, & Thuma'ninah 3-5 Detik"]
        
        DzikirDoa["5. BA'DA SALAM: Wirid Ma'tsur Berjamaah, Shalat Sunnah Ba'diyyah, & Saling Bersalaman"]
        
        Adzan --> Tahiyyat --> Iqamah --> ShalatKhusyu --> DzikirDoa
    end
```
