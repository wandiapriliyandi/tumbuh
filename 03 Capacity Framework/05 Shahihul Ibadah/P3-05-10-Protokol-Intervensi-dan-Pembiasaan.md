...
```mermaid
flowchart TD
    subgraph TransformasiIntervensiIbadah["TRANSFORMASI SISTEM INTERVENSI & PEMBIASAAN IBADAH"]
        HukumanFisik["HUKUMAN FISIK DESTRUKTIF (LAMA)<br/>• Memukul betis, mengguyur air, & mempermalukan di aula.<br/>• Santri trauma, mendendam, & membenci ibadah.<br/>• Tanpa diagnosa akar masalah (FBA)."]
        
        PBISMultiTier["SISTEM PBIS MULTI-TIER RESTORATIF (TUMBUH)<br/>• Tier 1: Universal 80-90% (The 10-Minute Call & Apresiasi 4:1).<br/>• Tier 2: Targeted 10-15% (CICO Fajar & Audit Jam Tidur).<br/>• Tier 3: Intensive 1-5% (FBA Klinis & Konseling BK Restoratif)."]
        
        HukumanFisik ==>|DIREKONSTRUKSI MENJADI| PBISMultiTier
    end
```
...
```mermaid
graph TD
    A["Gugatan Militerisme Pesantren (Pihak A):<br/>'Santri santai tidak bisa dididik dengan teori PBIS; satu-satunya bahasa yang mereka mengerti adalah rotan dan hukuman fisik keras!'"]
    --> B1["Tinjauan Tafsir QS. An-Nisa: 34 & Kaidah Ta'zir:<br/>Tahapan intervensi syar'i wajib bertahap: Fa'izhuuhunna (Nasihat Empatis) ➔ Wahjuruuhunna (Isolasi Edukatif) ➔ Wadribuuhunna (Tindakan Terakhir Simbolis Tanpa Menyakiti)."]
    A --> B2["Tinjauan Kitab Ihya' 'Ulumiddin (Al-Ghazali):<br/>Tahapan hisbah: At-Ta'rif bi Luthf (Memberitahu lembut) ➔ An-Nahyu bil Kalam al-Lathif (Menegur santun) ➔ At-Tasyri' al-Munasib (Konsekuensi logis proporsional)."]
    A --> B3["Tinjauan Hadits Ar-Rifqu Ma Kana fi Syai'in Illa Zanah (HR. Muslim):<br/>Kelembutan tidaklah ada pada sesuatu melainkan akan menghiasinya, dan tidaklah dicabut dari sesuatu melainkan akan memperburuknya."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Protokol PBIS Multi-Tier adalah formalisasi modern dari prinsip tahapan Ta'zir & Hisbah Islam."]
```
...
```mermaid
graph TD
    A["Gugatan Penolakan FBA (Pihak A):<br/>'Santri yang bolos shalat itu masalah niat malas saja; tidak perlu analisis fungsi perilaku FBA (Functional Behavior Assessment) atau Check-In/Check-Out!'"]
    --> B1["Tinjauan School-Wide PBIS Multi-Tier (Horner & Sugai, 2015):<br/>Tier 1 mencakup 80-90% santri dengan sistem pencegahan; Tier 2 mendukung 10-15% santri berisiko; Tier 3 menangani 1-5% santri kasus berat."]
    A --> B2["Tinjauan Functional Behavior Assessment (O'Neill et al., 1997):<br/>FBA mengidentifikasi Anteseden (Pemicu), Perilaku (Behavior), & Konsekuensi (Payoff/Escape) untuk merumuskan intervensi pengganti yang efektif."]
    A --> B3["Tinjauan Check-In/Check-Out Fajar (Crone et al., 2010):<br/>Intervensi CICO fajar harian meningkatkan kehadiran tepat waktu santri hingga 94% dalam tempo 3 pekan."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Integrasi PBIS Multi-Tier, FBA, & CICO menyediakan protokol ilmiah yang presisi dalam menyembuhkan masalah ibadah santri."]
```
...
```mermaid
flowchart LR
    subgraph ModelPBISIbadahTUMBUH["KERANGKA MULTI-TIER PBIS SHAHIHUL IBADAH"]
        Tier1["TIER 1: UNIVERSAL (80-90%)<br/>• Ekspektasi Adab Jelas.<br/>• The 10-Minute Call.<br/>• Apresiasi 4:1 Logbook."]
        
        Tier2["TIER 2: TARGETED (10-15%)<br/>• Check-In/Check-Out Fajar.<br/>• Posisi Ranjang Dekat Pintu.<br/>• Audit Higiene Tidur."]
        
        Tier3["TIER 3: INTENSIVE (1-5%)<br/>• Functional Behavior Assessment.<br/>• Konseling BK Restoratif.<br/>• Kontrak Perilaku Individual."]
...
```mermaid
flowchart TD
    subgraph SOPPembiasaan24JamTUMBUH["STANDAR OPERASIONAL PEMBIASAAN IBADAH ASRAMA 24 JAM"]
        
        SOP1["1. PROTOKOL FAJAR & QIYAMUL LAIL (04.00 - 05.30)<br/>• Bel bangun lembut 45 mnt sebelum Shubuh; Musyrif menyapa hangat.<br/>• Shalat Tahajjud & Witir 4-8 rakaat berjamaah/munfarid.<br/>• The 10-Minute Call: Tiba di masjid sebelum adzan Shubuh berkumandang."]
        
        SOP2["2. PROTOKOL DZIKIR & TILAWAH PAGI (05.30 - 06.30)<br/>• Dzikir Al-Ma'tsurat Kubra ba'da shalat fardhu berjamaah.<br/>• Halaqah Tilawah 1/2 Juz mandiri di serambi masjid asrama.<br/>• Shalat Sunnah Isyraq / Dhuha awal saat matahari terbit."]
        
        SOP3["3. PROTOKOL SHALAT SIANG & SORE (11.45 & 15.15)<br/>• Bel istirahat madrasah berbunyi; transisi wudhu tertib hemat air.<br/>• Shalat Zhuhur & Ashar saf awal berjamaah tepat waktu.<br/>• Shalat Sunnah Rawatib Qabliyyah & Ba'diyyah terjaga."]
        
        SOP4["4. PROTOKOL MALAM & HIGIENE TIDUR (18.00 - 22.00)<br/>• Shalat Maghrib, Halaqah Tilawah 1/2 Juz malam, & Shalat Isya'.<br/>• Pukul 21.45: Seluruh santri wudhu pra-tidur & membaca 3 Qul.<br/>• Pukul 22.00: Lampu kamar padam total (Kualitas tidur 6-7 jam terjamin)."]
        
        SOP1 ==> SOP2 ==> SOP3 ==> SOP4 ==> SOP1
    end
```
...
```mermaid
flowchart TD
    subgraph AlurPenangananKekerasanSenior["PROTOKOL RESPON CEPAT ANTI-KEKERASAN FISIK ASRAMA"]
        InsidenKekerasan["1. INSIDEN: Santri Senior Menghukum Push-Up 100x & Menampar Adik Kelas"]
        
        PerlindunganMedis["2. PERLINDUNGAN DARURAT: Pemeriksaan Klinik Korban & Pengamanan Situasi"]
        
        PencopotanJabatan["3. PENEGAKAN TEGAS: Pencopotan Jabatan Pengurus Santri Senior Seketika"]
        
        RestoratifMediasi["4. MEDIASI RESTORATIF: Permintaan Maaf Tulus Kepada Korban & Khidmah Masjid"]
        
        BudayaQudwahTegak["5. REFORMASI BUDAYA: Transformasi Kepemimpinan Menjadi Qudwah Penuh Kasih"]
        
        InsidenKekerasan --> PerlindunganMedis --> PencopotanJabatan --> RestoratifMediasi --> BudayaQudwahTegak
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturTigaTierPBISIbadah["ARSITEKTUR TIGA TIER PBIS SHAHIHUL IBADAH (TUMBUH)"]
        
        subgraph Tier1_Box["TIER 1: PENCEGAHAN UNIVERSAL (80% - 90% SELURUH SANTRI)"]
            T1_1["• Penerapan 'The 10-Minute Call' Sebelum Adzan Berkumandang."]
            T1_2["• Nudge Karpet Saf Presisi & Rak Sandal Bersekat Nama."]
            T1_3["• Rasio Apresiasi Emas 4:1 Fast-Tap Logbook PBIS Mobile."]
        end
        
        subgraph Tier2_Box["TIER 2: DUKUNGAN TERARAH (10% - 15% SANTRI BERISIKO)"]
            T2_1["• Program Check-In / Check-Out (CICO) Fajar Harian (3 Pekan)."]
            T2_2["• Relokasi Ranjang Tidur Dekat Pintu & Audit Higiene Tidur Malam."]
            T2_3["• Mentoring Halaqah Khusus Bersama Santri Teladan Jenjang J4."]
        end
        
        subgraph Tier3_Box["TIER 3: INTERVENSI INTENSIF (1% - 5% KASUS KHUSUS)"]
            T3_1["• Functional Behavior Assessment (FBA) Komprehensif Multi-Disiplin."]
            T3_2["• Konseling Bimbingan Konseling (BK) Naratif & Terapi Restoratif."]
            T3_3["• Kontrak Perilaku Individual (Behavior Intervention Plan / BIP)."]
        end
