...
```mermaid
flowchart TD
    subgraph TransformasiNilaiIntiIbadah["TRANSFORMASI NILAI INTI AKSIOLOGIS IBADAH"]
        IbadahKering["PARADIGMA FORMALISTIK KERING (LAMA)<br/>• Masjid riuh gaduh; sandal berantakan di tangga.<br/>• Pakaian shalat lusuh, berbau apek, & mengganggu makmum.<br/>• Mengabaikan amalan nawafil; masjid sepi di luar shalat fardhu."]
        
        NilaiIntiTUMBUH["LIMA NILAI INTI SHAHIHUL IBADAH (TUMBUH)<br/>• 1. Ittiba'us Sunnah Otentik.<br/>• 2. Thuma'ninah & Khusyu' Kalbu.<br/>• 3. Ta'zhimul Masjid (Keheningan & Keagungan).<br/>• 4. Nazhafah Syar'iyyah (Wangi & Rapi).<br/>• 5. Istiqamah Nawafil (Rawatib, Dhuha, & Qiyam)."]
        
        IbadahKering ==>|DIREKONSTRUKSI MENJADI| NilaiIntiTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Pragmatisme Pakaian (Pihak A):<br/>'Yang penting aurat tertutup; santri boleh shalat memakai kaos oblong compang-camping dan bercanda di dalam masjid!'"]
    --> B1["Tinjauan Tafsir QS. Al-A'raf: 31:<br/>Khudzuu ziinatakum 'inda kulli masjidin (Perintah tegas Allah untuk berhias dengan pakaian terindah & bersih setiap kali menuju masjid)."]
    A --> B2["Tinjauan Tafsir QS. An-Nur: 36:<br/>Fii buyuutin adzinallahu an turfa'a wa yudzkara fiihasmuhu (Masjid adalah rumah Allah yang wajib dimuliakan dan dijaga kehormatannya)."]
    A --> B3["Tinjauan Kitab Al-Majmu' (Imam An-Nawawi):<br/>Haram hukumnya membuat kegaduhan di masjid yang mengganggu orang shalat, dan sunnah muakkadah memakai wewangian & pakaian putih bersih."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Memuliakan masjid dan menjaga kebersihan pakaian adalah rukun adab tertinggi dalam Shahihul Ibadah."]
```
...
```mermaid
graph TD
    A["Gugatan Pemisahan Nilai Modern (Pihak A):<br/>'Ibadah di pesantren tidak perlu dianalisis dengan teori nilai dasar Schwartz atau psikologi disonansi moral!'"]
    --> B1["Tinjauan Schwartz Basic Human Values (1992):<br/>Nilai Universalism, Benevolence, & Tradition membentuk struktur motivasi transendental yang memandu tindakan etis sehari-hari."]
    A --> B2["Tinjauan Cognitive Dissonance Theory (Leon Festinger):<br/>Disonansi terjadi ketika santri shalat khusyu' di masjid namun kamarnya berantakan dan kotor (Hypocrisy Discomfort)."]
    A --> B3["Tinjauan Self-Perception Theory (Bem):<br/>Tindakan menjaga kebersihan pakaian & masjid memperkuat persepsi diri santri sebagai Insan Mutathahhir yang mulia."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Internalisasi 5 Nilai Inti Ibadah menyelaraskan kesucian ritual dengan integritas perilaku hidup."]
```
...
```mermaid
flowchart LR
    subgraph ResolusiDisonansiIbadahTUMBUH["RESOLUSI DISONANSI AKSIOLOGIS SHAHIHUL IBADAH"]
        DisonansiLama["DISONANSI MORAL (LAMA)<br/>Shalat di Masjid Khusyu' ➔ Kamar Asrama Kumuh & Kasur Bau Apek."]
        
        InternalisasiNilai["INTERNALISASI NILAI NAZHAFAH & TA'ZHIM (TUMBUH)<br/>'Kebersihan Kamar Adalah Cermin Kesucian Shalatku'"]
        
        IntegrasiPerilaku["INTEGRASI PERILAKU KONSISTEN<br/>Kamar Rapi Wangi, Kasur Tertata, & Masjid Dimuliakan."]
        
        DisonansiLama ==>|DIREKONSTRUKSI MELALUI| InternalisasiNilai ==> IntegrasiPerilaku
    end
```
...
```mermaid
flowchart TD
    subgraph TataKelolaNilaiInti24Jam["TRANSLASI 5 NILAI INTI DALAM OPERASIONAL ASRAMA 24 JAM"]
        
        V1_Op["1. ITTIBA'US SUNNAH ➔ Workshop 'Tashih Shalat & Thaharah' Berkala Setiap Bulan."]
        
        V2_Op["2. THUMA'NINAH & KHUSYU' ➔ Durasi Shalat Fardhu Berjamaah Minimal 12-15 Menit."]
        
        V3_Op["3. TA'ZHIMUL MASJID ➔ Penegakan 'Sacred Silence' & Rak Sandal Tertib Bersekat."]
        
        V4_Op["4. NAZHAFAH SYAR'IYYAH ➔ Operasi Bersih Kamar Harian & Standar Gamis Shalat Bersih."]
        
        V5_Op["5. ISTIQAMAH NAWAFIL ➔ Poin Apresiasi PBIS Khusus untuk Santri Shalat Rawatib & Dhuha."]
        
        V1_Op <===> V2_Op <===> V3_Op <===> V4_Op <===> V5_Op
    end
```
...
```mermaid
flowchart TD
    subgraph AlurPenegakanNilaiAdabMasjid["PROTOKOL PENEGAKAN NILAI ADAB MASJID BEBAS PRIVILESE"]
        PelanggaranAdab["1. ANOMALI: Tokoh Santri Senior Melangkahi Pundak Jamaah & Shalat Kilat"]
        
        CoachingPrivat["2. COACHING PRIVAT TEGAS & PENUH KASIH (Musyrif Pengasuhan)<br/>• Menegaskan: Tidak ada privilese pelanggaran adab di Rumah Allah."]
        
        KsatriaTawadhu["3. KETELADANAN KSATRIA: Meminta Maaf Secara Tulus Kepada Adik Kelas<br/>• Menghancurkan kesombongan senioritas feodal di masjid."]
        
        WibawaQudwah["4. WIBAWA QUDWAH PULIH: Menjadi Garda Terdepan Penjaga Adab Masjid"]
        
        PelanggaranAdab --> CoachingPrivat --> KsatriaTawadhu --> WibawaQudwah
    end
```
...
```mermaid
flowchart TD
    subgraph LimaNilaiIntiShahihulIbadah["LIMA NILAI INTI SHAHIHUL IBADAH (TUMBUH)"]
        
        V1["1. ITTIBA'US SUNNAH (KETAATAN SUNNAH OTENTIK)<br/>• Ibadah berakar pada dalil shahih & kaidah muta'abbad.<br/>• Menolak bid'ah dhalalah & takhayul ibadah."]
        
        V2["2. THUMA'NINAH & KHUSYU' (KETENANGAN RAGA & BATIN)<br/>• Menghilangkan ketergesa-gesaan dalam shalat (3-5 detik per rukun).<br/>• Kehadiran kalbu penuh menghayati dialog dengan Allah."]
        
        V3["3. TA'ZHIMUL MASJID (MEMULIAKAN RUMAH ALLAH)<br/>• Menjaga keheningan sakral; melangkah dengan tenang.<br/>• Menghormati saf & meniadakan feodalisme kasta di masjid."]
        
        V4["4. NAZHAFAH SYAR'IYYAH (KESUCIAN & KERAPIAN PARIPURNA)<br/>• Pakaian shalat putih bersih wangi bebas bau apek.<br/>• Wudhu hemat air sempurna & kebersihan lingkungan asrama."]
        
        V5["5. ISTIQAMAH NAWAFIL (KONSISTENSI AMALAN SUNNAH)<br/>• Istiqamah Shalat Rawatib 12 Rakaat, Dhuha, & Qiyamul Lail.<br/>• Tilawah Al-Qur'an harian & dzikir ma'tsurat pagi-petang."]
