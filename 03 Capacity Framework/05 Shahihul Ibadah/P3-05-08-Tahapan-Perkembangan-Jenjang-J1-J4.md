...
```mermaid
flowchart TD
    subgraph TransformasiModelTahapanIbadah["TRANSFORMASI MODEL TAHAPAN PERKEMBANGAN IBADAH"]
        PukulRata["MODEL PUKUL RATA STATIS (LAMA)<br/>• Beban ibadah usia 12 tahun disamakan dengan usia 18 tahun.<br/>• Mengandalkan pemaksaan eksternal tanpa membangun otonomi.<br/>• Santri burnout, jenuh ibadah, & futur permanen saat lulus."]
        
        TanggaJ1J4["TANGGA KEMANDIRIAN BERJENJANG J1-J4 (TUMBUH)<br/>• J1 (Usia 12-13): Adaptasi & Scaffolding Thaharah Dasar.<br/>• J2 (Usia 13-15): Habituasi Rawatib & Tilawah 1 Juz.<br/>• J3 (Usia 15-17): Internalisasi Qalbiyyah & Qiyamul Lail.<br/>• J4 (Usia 17-18): Kepemimpinan Imamah & Teladan Qudwah."]
        
        PukulRata ==>|DIREKONSTRUKSI MENJADI| TanggaJ1J4
    end
```
...
```mermaid
graph TD
    A["Gugatan Pemaksaan Dini (Pihak A):<br/>'Anak masuk pondok harus langsung dipukul kalau tidak shalat tahajjud; tidak perlu pentahapan usia yang bertele-tele!'"]
    --> B1["Tinjauan Hadits Sunan Abi Dawud No. 495:<br/>Muruu awlaadakum bis-shalah li sab'i siniin (Perintah shalat usia 7 tahun dengan kelembutan, disiplin usia 10 tahun, & baligh taklif)."]
    A --> B2["Tinjauan Kitab Ihya' 'Ulumiddin (Al-Ghazali):<br/>Pendidikan anak wajib bertahap (Tadrij): dari pembiasaan lahiriah (Ta'wid) menuju pemahaman akal (Fahm) hingga kemanisan batin (Dzuq)."]
    A --> B3["Tinjauan Fiqh Taklif Syar'i:<br/>Gugurnya hisab dosa sebelum baligh (Rufi'al Qalamu 'an Tsalatsin) mewajibkan pendekatan tarbiyah edukatif, bukan hukuman kriminal."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Pentahapan usia ibadah adalah sunnah Rasulullah SAW yang wajib menjadi pondasi kurikulum asrama."]
```
...
```mermaid
graph TD
    A["Gugatan Teori Modern (Pihak A):<br/>'Teori perkembangan moral Kohlberg dan neurosains prefrontal cortex tidak relevan dengan santri yang mengaji kitab kuning!'"]
    --> B1["Tinjauan Teori Moral Lawrence Kohlberg (1984):<br/>Tahap Prakonvensional (Takut Hukuman) ➔ Tahap Konvensional (Norma Sosial Sebaya) ➔ Tahap Pascakonvensional (Prinsip Etika Universal & Ridha Allah)."]
    A --> B2["Tinjauan Self-Determination Theory (Deci & Ryan, 2000):<br/>Motivasi ibadah bertransformasi dari Eksternal (Takut Absen) ➔ Introyeksi (Rasa Bersalah) ➔ Identifikasi (Menghargai Manfaat) ➔ Integrasi Otonom (Kebutuhan Jiwa)."]
    A --> B3["Tinjauan Neurosains Prefrontal Cortex Remaja (Blakemore, 2012):<br/>Otak eksekutif remaja belum matang sempurna hingga usia 20 tahun; pendampingan regulasi waktu sangat krusial di usia 12-16 tahun."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Sintesis Kohlberg-SDT-Neurosains memandu perancangan tangga J1-J4 yang adaptif secara biologis & psikologis."]
```
...
```mermaid
flowchart LR
    subgraph TransformasiMotivasiIbadahTUMBUH["TRANSFORMASI MOTIVASI IBADAH BERDASARKAN SELF-DETERMINATION THEORY"]
        J1_Motiv["J1: REGULASI EKSTERNAL<br/>'Saya shalat tepat waktu karena ada musyrif yang membimbing.'"]
        
        J2_Motiv["J2: REGULASI TERIDENTIFIKASI<br/>'Saya shalat berjamaah karena saya tahu ini penting bagi diri saya.'"]
        
        J3_Motiv["J3: REGULASI TERINTEGRASI<br/>'Shalat rawatib & qiyamul lail sudah menjadi bagian dari identitas hidupku.'"]
        
        J4_Motiv["J4: MOTIVASI OTONOM MURNI (IKHLAS)<br/>'Ibadah adalah cinta & kerinduanku bermunajat kepada Allah Ta'ala.'"]
        
        J1_Motiv ==> J2_Motiv ==> J3_Motiv ==> J4_Motiv
    end
```
...
```mermaid
flowchart TD
    subgraph TanggaKemandirianIbadahTUMBUH["PROGRESI EMPAT TANGGA KEMANDIRIAN SHAHIHUL IBADAH (TUMBUH)"]
        
        J1["TANGGA J1: ADAPTASI DASAR (KELAS 7 / USIA 12-13 TAHUN)<br/>• Fokus: Sertifikasi Fiqh Thaharah & Shalat 1-on-1 Presisi 100%.<br/>• Disiplin: Hadir di masjid tepat waktu dengan panduan musyrif kamar.<br/>• Target: Eliminasi masbuq, hafal dzikir ma'tsurat, & wudhu hemat air."]
        
        J2["TANGGA J2: HABITUASI OTONOM (KELAS 8-9 / USIA 13-15 TAHUN)<br/>• Fokus: Istiqamah Shalat Rawatib 8-12 Rakaat & Shalat Dhuha harian.<br/>• Disiplin: Tiba di masjid 5 menit sebelum adzan atas inisiatif pribadi.<br/>• Target: One Day One Juz Tilawah Al-Qur'an mandiri & Fahmul Ma'ani."]
        
        J3["TANGGA J3: INTERNALISASI RUHANIYAH (KELAS 10-11 / USIA 15-17 TAHUN)<br/>• Fokus: Qiyamul Lail mandiri 3-5x sepekan & Puasa Sunnah Senin-Kamis.<br/>• Disiplin: Thuma'ninah khusyu' mendalam & aktif merapikan saf jamaah.<br/>• Target: Menguasai dalil hadits Bulughul Maram & melatih adab adik kelas."]
        
        J4["TANGGA J4: KEPEMIMPINAN QUDWAH (KELAS 12 / USIA 17-18 TAHUN)<br/>• Fokus: Kompetensi Imam Shalat Rawatib, Khatib Jumat, & Muadzin.<br/>• Disiplin: Malakah ibadah mandiri abadi 100% tanpa pengawasan luar.<br/>• Target: Menjadi Figur Teladan Hidup (Live Qudwah) bagi asrama & umat."]
...
```mermaid
flowchart TD
    subgraph AlurResolusiFuturSpiritual["PROTOKOL PENANGANAN KEJENUHAN SPIRITUAL (FUTUR) JENJANG J3"]
        AnomaliFutur["1. GEJALA FUTUR: Santri Sebelumnya Rajin Menjadi Malas & Sinis Ibadah"]
        
        TinjauanHadits["2. TINJAUAN SYAR'I: Memahami Fenomena Masa Fatrah Sebagai Fase Alami"]
        
        KonselingNaratif["3. KONSELING SPIRITUAL EMPATIS: Mengurai Akar Kelelahan Mental & Ekspektasi"]
        
        PenyesuaianBeban["4. PENYESUAIAN BEBAN & REKREASI SOSIAL: Menjaga Pokok Fardhu & Khidmah Sosial"]
        
        KematanganDewasa["5. TRANSFIGURASI RUHIYAH: Melewati Fatrah & Meraih Malakah Ibadah Dewasa"]
        
        AnomaliFutur --> TinjauanHadits --> KonselingNaratif --> PenyesuaianBeban --> KematanganDewasa
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturTanggaJ1J4Ibadah["ARSITEKTUR TANGGA KEMANDIRIAN SHAHIHUL IBADAH J1–J4 (TUMBUH)"]
        
        subgraph J1_Stage["JENJANG J1: ADAPTASI DASAR (KELAS 7 / USIA 12-13 THN)"]
            J1_A["• Model Motivasi: Regulasi Eksternal (Butuh Panduan & Scaffolding Musyrif)."]
            J1_B["• Target Syar'i: Zero-Defect Fiqh Thaharah & Shalat Fardhu Berjamaah Tepat Waktu."]
            J1_C["• Instrumen: Uji Praktik 1-on-1 & Checklist Mutaba'ah Saku Pemula."]
        end
        
        subgraph J2_Stage["JENJANG J2: HABITUASI OTONOM (KELAS 8-9 / USIA 13-15 THN)"]
            J2_A["• Model Motivasi: Regulasi Teridentifikasi (Sadar Manfaat & Disiplin Diri)."]
            J2_B["• Target Syar'i: Istiqamah Shalat Rawatib 8-12 Rakaat & One Day One Juz Mandiri."]
            J2_C["• Instrumen: Fast-Tap Tagging PBIS & Evaluasi Mingguan Halaqah Kamar."]
        end
        
        subgraph J3_Stage["JENJANG J3: INTERNALISASI RUHANIYAH (KELAS 10-11 / USIA 15-17 THN)"]
            J3_A["• Model Motivasi: Regulasi Terintegrasi (Ibadah Menjadi Kebutuhan Jiwa)."]
            J3_B["• Target Syar'i: Qiyamul Lail Mandiri 3-5x/pekan & Menguasai Dalil Fiqh Muqaran."]
            J3_C["• Instrumen: Portofolio Khidmah Asrama & Bimbingan Tahsin Adik Kelas."]
        end
        
        subgraph J4_Stage["JENJANG J4: KEPEMIMPINAN QUDWAH (KELAS 12 / USIA 17-18 THN)"]
            J4_A["• Model Motivasi: Motivasi Otonom Ikhlas Mutlak (Post-Conventional Morality)."]
            J4_B["• Target Syar'i: Lulus Sertifikasi Imam Rawatib, Khatib Jumat, & Teladan Abadi."]
            J4_C["• Instrumen: Uji Standar OSCE Fiqh Imamah & Sertifikat Qudwah Paripurna."]
        end
        
        J1_Stage ==> J2_Stage ==> J3_Stage ==> J4_Stage
    end
```
