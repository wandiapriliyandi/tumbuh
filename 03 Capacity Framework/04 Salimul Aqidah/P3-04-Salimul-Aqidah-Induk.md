...
```mermaid
flowchart TD
    subgraph TransformasiMasterIndukAqidah["TRANSFORMASI PARADIGMA INDUK SALIMUL AQIDAH"]
        DogmaFormalis["AQIDAH DOGMATIS FORMALISTIK (LAMA)<br/>• Hafalan teks kalam tanpa pemahaman nalar burhani.<br/>• Kepatuhan semu karena takut takzir musyrif.<br/>• Kepribadian ganda: Alim di depan, ghashab di belakang."]
        
        SalimulAqidahTUMBUH["SALIMUL AQIDAH HOLISTIK & HIDUP (TUMBUH)<br/>• Tauhid murni berakar pada nalar sehat & cinta Ilahi.<br/>• Radar Muraqabatullah: Berintegritas mutlak di ruang privat.<br/>• Insan Adabi tangguh, merdeka dari takhayul, & beradab mulia."]
        
        DogmaFormalis ==>|DIREKONSTRUKSI MENJADI| SalimulAqidahTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Minimalisme Aqidah (Pihak A):<br/>'Salimul Aqidah itu cukup hafal rukun iman dan tidak menyembah berhala fisik; tidak perlu dikaitkan dengan integritas ghashab sandal atau kejujuran ujian!'"]
    --> B1["Tinjauan Tafsir QS. Al-An'am: 82 & Shahih Bukhari:<br/>Alladzina aamanuu wa lam yalbisuu iimanahum bi-zhulmin (Iman yang murni adalah iman yang tidak dicampuri kezhaliman syirik khafi, kemunafikan, & perampasan hak sesama)."]
    A --> B2["Tinjauan Hadits Jibril tentang Ihsan:<br/>An ta'budallaha ka-annaka taraahu fa-in lam takun taraahu fa-innahu yaraaka (Ihsan adalah radar batin yang memandu setiap tindakan di ruang ramai maupun sunyi)."]
    A --> B3["Tinjauan Kitab at-Tauhid (Muhammad bin Abdil Wahhab) & Ihya' (Al-Ghazali):<br/>Tauhid sejati membebaskan jiwa dari ketakutan pada makhluk & ketergantungan pada jimat/takhayul."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Salimul Aqidah adalah poros integritas moral dan pembebasan jiwa manusia secara total."]
```
...
```mermaid
graph TD
    A["Gugatan Pemisahan Teori & Karakter (Pihak A):<br/>'Aqidah itu ilmu teoritis kognitif; urusan pengendalian diri dan moralitas itu urusan disiplin fisik, tidak ada kaitannya dengan sains identitas moral atau neurosains!'"]
    --> B1["Tinjauan Moral Identity Theory (Augusto Blasi & Karl Aquino):<br/>Perilaku moral hanya terwujud jika nilai etika telah terintegrasi menjadi 'Inti Identitas Diri' (Core Self-Concept)."]
    A --> B2["Tinjauan Neurosains Regulasi Diri (Prefrontal Cortex & Amygdala):<br/>Dzikir Ma'tsurat & Muraqabah melatih Prefrontal Cortex menekan impuls negatif Amygdala, mengotomatiskan kendali diri moral."]
    A --> B3["Tinjauan Locus of Control Julian Rotter:<br/>Tauhid murni membangun Internal Spiritual Locus of Control tertinggi, menghilangkan mentalitas menyalahkan nasib."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Salimul Aqidah adalah integrasi sempurna antara konstruksi identitas moral & neurobiologi regulasi diri."]
```
...
```mermaid
flowchart LR
    subgraph MekanismeKognitifSalimulAqidah["MEKANISME KOGNITIF & NEUROBIOLOGIS SALIMUL AQIDAH"]
        WahyuTurats["WAHYU & TURATS TAUHID (Al-Qur'an & Sunnah)"]
        
        MoralIdentity["MORAL IDENTITY CENTRALITY (Blasi & Aquino)<br/>'Aku adalah Hamba Allah yang Beriman & Merdeka'"]
        
        ExecutiveControl["PREFRONTAL CORTEX EXECUTIVE CONTROL<br/>Penekanan Impuls Ghashab & Fobia Mistis"]
        
        InsanAdabi["MANIFESTASI INSAN ADABI PARIPURNA (Istiqamah 24 Jam)"]
        
        WahyuTurats --> MoralIdentity --> ExecutiveControl --> InsanAdabi
    end
```
...
```mermaid
flowchart TD
    subgraph Arsitektur4DimensiSalimulAqidah["EMPAT DIMENSI UTAMA KAPASITAS SALIMUL AQIDAH"]
        
        D1["DIMENSI 1: KEMURNIAN TAUHIDULLAH (Al-Ikhlas)<br/>• Mengesakan Allah dalam Rububiyyah, Uluhiyyah, & Asma wa Shifat.<br/>• Ikhlas beramal hanya mengharap ridha Allah; bebas riya' & sum'ah."]
        
        D2["DIMENSI 2: RADAR BATIN MURAQABATULLAH (Al-Ihsan)<br/>• Merasakan kehadiran Allah di ruang ramai maupun sepi.<br/>• Integritas mutlak di ruang privat: Zero Ghashab, Zero Menyontek."]
        
        D3["DIMENSI 3: PEMBEBASAN KHURAFAT & SYIRIK (Al-Bara'ah)<br/>• Menolak ramalan zodiak, tarot, horoskop, jimat rajah, & takhayul.<br/>• Keberanian tauhid menghadapi fobia mistis & fitnah syubhat."]
        
        D4["DIMENSI 4: TAWAKKAL & RIDHA (Ath-Thuma'ninah)<br/>• Ikhtiar maksimal (Itqan) lalu berserah diri bulat kepada takdir Allah.<br/>• Ketenangan batin menghadapi kegagalan, ujian, & sakit."]
...
```mermaid
flowchart TD
    subgraph PuncakManifestasiSalimulAqidah["PUNCAK MANIFESTASI INSAN ADABI SALIMUL AQIDAH"]
        UjianPrivat["1. UJIAN RUANG PRIVAT (Khalwah): Uang Tercecer / Ajakan Maksiat / Kegelapan Lorong"]
        
        AktivasiRadar["2. AKTIVASI RADAR MURAQABATULLAH: 'Sesungguhnya Allah Maha Menyaksikan Setiap Detikku'"]
        
        KemenanganMoral["3. KEMENANGAN MORAL OTONOM: Menolak Maksiat & Menjaga Amanah Tanpa Pengawas Luar"]
        
        KetenanganJiwa["4. KETENTERAMAN JIWA (Nafs Muthma'innah): Kebahagiaan Transendental Menjadi Kekasih Allah"]
        
        UjianPrivat --> AktivasiRadar --> KemenanganMoral --> KetenanganJiwa
    end
```
...
```mermaid
flowchart TD
    subgraph TanggaProgresiJ1J4Aqidah["PROGRESI JENJANG KEMANDIRIAN SALIMUL AQIDAH (J1 - J4)"]
        
        J1["JENJANG J1: PENGENALAN & PEMBIASAAN (KELAS 7)<br/>• Kognitif: Hafal matan doa & rukun iman dasar.<br/>• Afektif: Merasa aman di asrama & dibimbing dzikir.<br/>• Perilaku (BARS Level 1-2): Tertib dzikir ma'tsurat terpantau musyrif."]
        
        J2["JENJANG J2: INTERNALISASI & PENGUATAN (KELAS 8-9)<br/>• Kognitif: Paham dalil naqli & sains kauniyah.<br/>• Afektif: Tumbuh rasa malu pada Allah (Haya').<br/>• Perilaku (BARS Level 2-3): Menolak ghashab & menolak ramalan zodiak."]
        
        J3["JENJANG J3: KEMANDIRIAN & ADVOKASI (KELAS 10-11)<br/>• Kognitif: Menguasai mantiq burhani bantahan syubhat.<br/>• Afektif: Cinta Allah di atas segalanya (Mahabbatullah).<br/>• Perilaku (BARS Level 3-4): Istiqamah dzikir mandiri & aktif menolong teman."]
        
        J4["JENJANG J4: KEPEMIMPINAN & KETELADANAN QUDWAH (KELAS 12)<br/>• Kognitif: Mampu mengajarkan aqidah & membimbing halaqah.<br/>• Afektif: Hati tenteram (Thuma'ninah) & ikhlas lillahi ta'ala.<br/>• Perilaku (BARS Level 4 - Exemplary): Menjadi figur teladan hidup (Live Qudwah)."]
...
```mermaid
flowchart TD
    subgraph PetaNavigasiDomain04["PETA NAVIGASI 14 SUB-MODUL KAPASITAS SALIMUL AQIDAH (TUMBUH)"]
        
        P01["P3-04-01: Filosofi & Landasan Turats Tauhid"]
        P02["P3-04-02: Definisi Operasional & Konseptualisasi"]
        P03["P3-04-03: Tujuan & Target Capaian (Wasiat Luqman)"]
        P04["P3-04-04: Nilai Inti & Resolusi Disonansi Moral"]
        
        P05["P3-04-05: SKL Taksonomi Bloom-Fitrah-Fowler"]
        P06["P3-04-06: Manifestasi Perilaku & Nudge Architecture"]
        P07["P3-04-07: Rubrik Indikator BARS 4 Level & Tag PBIS"]
        P08["P3-04-08: Tahapan Perkembangan Tangga J1–J4"]
        
        P09["P3-04-09: Pemetaan Asesmen Triangulasi 360° MTMM"]
        P10["P3-04-10: Protokol Intervensi Multi-Tier & FBA"]
        P11["P3-04-11: Program Pembinaan & Desain Halaqah Kolb"]
        P12["P3-04-12: Metode Pedagogi Sokratik & Dual-Coding"]
        P13["P3-04-13: Instrumen Mutaba'ah & Formula IKR"]
        P14["P3-04-14: Sintesis & Validasi Konsensus Delphi A+"]
