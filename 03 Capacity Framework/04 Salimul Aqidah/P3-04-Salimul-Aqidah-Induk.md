...
```mermaid
graph TD
    Aqidah["Karakter 1: Salimul Aqidah"]
    
    Aqidah --> D1["1. Kemurnian Tauhid (Tauhidullah)<br/>Mengesakan Allah dalam Rububiyyah, Uluhiyyah, & Asma wa Shifat."]
    Aqidah --> D2["2. Pengawasan Batin (Muraqabatullah)<br/>Merasa selalu diawasi Allah di tempat ramai maupun sepi (Ihsan)."]
    Aqidah --> D3["3. Pembebasan dari Khurafat & Syirik<br/>Menolak ramalan zodiak, jimat, kesialan (thiyarah), & takhayul modern."]
    Aqidah --> D4["4. Tawakkal & Ridha (Ketenteraman Hati)<br/>Berikhtiar optimal lalu menyandarkan hasil sepenuhnya kepada takdir Allah."]
```
