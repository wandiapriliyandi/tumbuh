...
```mermaid
flowchart TD
    subgraph ParadigmaAqidahTUMBUH["TRANSFORMASI PARADIGMA AQIDAH DI PESANTREN"]
        Tradisional["AQIDAH VERBALISTIK (DOGMATIS KERING)<br/>• Hafalan teks nazham tanpa penghayatan jiwa.<br/>• Taat hanya jika ada Musyrif/CCTV.<br/>• Rentan fatalisme semu & syirik terselubung (Riya')."]
        
        TUMBUH["SALIMUL AQIDAH TUMBUH (LIVING TAWHEED)<br/>• Tauhid murni berakar pada kesadaran Muraqabatullah.<br/>• Integritas moral otonom di ruang ramai & sepi.<br/>• Tawakkal dinamis: Ikhtiar optimal + Ridha pada takdir."]
        
        Tradisional ==>|DIREKONSTRUKSI SECARA METODOLOGIS MENJADI| TUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Reduksionisme Dogmatis (Pihak A):<br/>'Aqidah itu cukup mengajarkan 50 Aqa'id & rukun iman secara hafalan kelas; menghubungkan aqidah dengan perilaku kamar tidur itu mengada-ada!'"]
    --> B1["Tinjauan Tafsir QS. Al-An'am: 82:<br/>Iman yang murni adalah yang tidak dicampuri kezhaliman (Syirik besar maupun Syirik kecil seperti zhalim pada sesama)."]
    A --> B2["Tinjauan Hadits Jibril tentang Maqam Ihsan:<br/>'Anta'budallaha ka-annaka taraahu...' (Beribadah dan berakhlak dengan kesadaran penuh bahwa Allah melihat setiap detik gerak-gerik batin)."]
    A --> B3["Tinjauan Kitab Al-Aqidah Ath-Thahawiyyah & Ihya' Ulumiddin:<br/>Tauhid sejati membuahkan istiqamah lahiriah dan mengikis penyakit riya', ujub, serta ketergantungan pada makhluk."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Salimul Aqidah adalah ruh hidup yang memancarkan seluruh adab dan disiplin santri 24 jam."]
```
...
```mermaid
graph TD
    A["Gugatan Reduksionisme Sains Sekuler (Pihak A):<br/>'Konsep keyakinan agama itu dogmatis dan tidak punya korelasi saintifik dengan kematangan kognitif atau regulasi emosi santri!'"]
    --> B1["Tinjauan Teori Locus of Control Julian Rotter (1966):<br/>Internal Spiritual Locus of Control melahirkan ketahanan mental (Grit), proaktivitas, & tanggung jawab penuh atas pilihan moral pribadi."]
    A --> B2["Tinjauan Konsensus CASEL SEL (Self-Awareness):<br/>Kesadaran diri spiritual (Spiritual Alignment) memampukan santri mengidentifikasi bias emosi, niat batin, & kompas nilai abadi."]
    A --> B3["Tinjauan Teori Makna Hidup Viktor Frankl (Logotherapy):<br/>Tauhid memberikan kepastian eksistensial, menghapus kehampaan makna (Existential Vacuum), & menekan kecemasan remaja."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Salimul Aqidah adalah katalisator psikologis terkuat bagi pembentukan Self-Awareness dan kematangan kepribadian santri."]
```
...
```mermaid
flowchart LR
    subgraph SinergiAqidahSains["KONVERGENSI SALIMUL AQIDAH DENGAN SAINS KOGNITIF"]
        TauhidCore["SALIMUL AQIDAH<br/>(Tauhidullah & Muraqabah)"]
        
        SEL["CASEL SELF-AWARENESS<br/>(Mengenali Niat, Emosi, & Integritas)"]
        Rotter["SPIRITUAL LOCUS OF CONTROL<br/>(Tanggung Jawab Pribadi & Anti-Fatalisme)"]
        Frankl["LOGOTHERAPY & MEANING<br/>(Kepastian Arah & Imunitas Putus Asa)"]
        
        TauhidCore ==> SEL & Rotter & Frankl
        SEL & Rotter & Frankl ==> Perilaku["PERILAKU SANTRI YANG ADIL, JUJUR, & TANGGUH (J1–J4)"]
    end
```
...
```mermaid
flowchart TD
    subgraph EliminasiBudayaCCTV["DEKONSTRUKSI SISTEM KONTROL EKSTERNAL MENUJU MURAQABAH"]
        SistemPolisi["SISTEM KONTROL POLISIAL (FEODAL/TEROR)<br/>• Menempatkan musyrif sebagai polisi pengintai.<br/>• Pemasangan CCTV di segala sudut asrama.<br/>• Santri patuh semata karena takut takzir fisik.<br/>• Akibat: Kemunafikan sistemik & pelanggaran di titik buta (Blindspots)."]
        
        SistemMuraqabah["SISTEM EKOSISTEM MURAQABAH (TUMBUH)<br/>• Membangun kesadaran batin 'Allah Maha Melihat'.<br/>• Musyrif sebagai teladan (Qudwah) & pembimbing kasih sayang.<br/>• Disiplin Restoratif: Memperbaiki kesalahan dengan restitusi adab.<br/>• Hasil: Integritas otonom di ruang ramai maupun ruang privat."]
        
        SistemPolisi ==>|DITRANSFORMASIKAN MENJADI| SistemMuraqabah
    end
```
...
```mermaid
flowchart TD
    subgraph AlurPenangananKasusAqidah["PROTOKOL RESTORATIF PENANGANAN PELANGGARAN PRIVAT"]
        Insiden["1. TERJADI PELANGGARAN PRIVAT (Pencurian / Penipuan di Asrama)"]
        
        Kerahasiaan["2. PROTEKSI AIB & TABAYYUN PRIVAT (<12 Jam)<br/>• Tidak diumumkan di depan publik.<br/>• Musyrif/BK memanggil santri secara empatik (Ruang Konseling)."]
        
        Penyadaran["3. DIALOG SOKRATIK AQIDAH (Muraqabah Awakening)<br/>• Menghadirkan kesadaran hisab Allah & luasnya pintu Taubat.<br/>• Santri mengakui kesalahan dari lubuk hati terdalam."]
        
        Restitusi["4. RESTITUSI LOGIS 4R (Ishlah al-Bain)<br/>• Mengganti kerugian korban secara rahasia/fasilitasi asatidz.<br/>• Proyek khidmah kebersihan masjid asrama selama 14 hari."]
        
        Reintegrasi["5. REINTEGRASI RUHIYAH & PENDAMPINGAN HALAQAH<br/>• Monitoring logbook aqidah mingguan tanpa stigma masa lalu."]
        
        Insiden --> Kerahasiaan --> Penyadaran --> Restitusi --> Reintegrasi
    end
```
...
```mermaid
flowchart TD
    subgraph DimensiSalimulAqidah["EMPAT DIMENSI SALIMUL AQIDAH TERPADU"]
        D1["DIMENSI 1: TAUHIDULLAH (KEMURNIAN KEYAKINAN)<br/>• Mengesakan Allah dalam Rububiyyah, Uluhiyyah, & Asma wa Shifat.<br/>• Keyakinan teguh tanpa keraguan syubhat ateisme/relativisme."]
        
        D2["DIMENSI 2: MURAQABATULLAH (INTEGRITAS PRIVAT)<br/>• Kesadaran batin selalu diawasi Allah di ruang sepi (Ihsan).<br/>• Kejujuran mutlak dalam ujian, pengelolaan uang, & penggunaan waktu."]
        
        D3["DIMENSI 3: BARA'ATUN MINASY-SYIRKI (IMUNITAS KHURAFAT)<br/>• Menolak ramalan zodiak, jimat, pelet, santet, mitos hari sial.<br/>• Tabayyun terhadap hoaks agama dan doktrin menyimpang."]
        
        D4["DIMENSI 4: TAWAKKAL WA RIDHA (KETENTERAMAN EKSISTENSIAL)<br/>• Ikhtiar optimal (Itqan) dibarengi kepasrahan total pada takdir.<br/>• Berlapang dada menghadapi musibah & bersyukur atas nikmat."]
...
```mermaid
graph TD
    subgraph PBISAqidah["ARSITEKTUR PBIS 3-TIER SALIMUL AQIDAH"]
        T1["TIER 1: PEMBIASAAN UNIVERSAL SELURUH SANTRI (100%)<br/>• Dzikir Al-Ma'tsurat ba'da Shubuh & Ashar berjamaah.<br/>• Kajian tematik Tadabbur Ayat Kauniyah & Asmaul Husna mingguan.<br/>• Budaya Apresiasi Kejujuran (Poin Penguatan Positif Logbook PBIS)."]
        
        T2["TIER 2: INTERVENSI KELOMPOK TERFOKUS (10-15%)<br/>• Halaqah Khusus Santri Rentan Syubhat / Sering Berbohong.<br/>• Program Mentoring Sebaya (Peer Buddy Jenjang T4 mendampingi T1).<br/>• Bimbingan Konseling Reflektif Muhasabah Qalbiyah 2 pekan sekali."]
        
        T3["TIER 3: INTERVENSI INTENSIF & INDIVIDUAL (1-5%)<br/>• Konseling Mendalam Kasus Syirik / Krisis Eksistensial / Trauma Berat.<br/>• Restorasi Ruhiyah Khusus bersama Dewan Masyayikh & Psikolog Pesantren.<br/>• Rencana Intervensi Perilaku Individual (BIP) berbasis Pendampingan 1-on-1."]
...
Penerapan konsep **P3-04-01: FILOSOFI DAN LANDASAN TURATS SALIMUL AQIDAH** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
...
[^1]: Riset Evaluasi Karakter Asrama Ekosistem Pesantren Berbasis TUMBUH, *Laporan Diagnostik Kesenjangan Nilai Rapor vs Integritas Privat*, 2026.  
