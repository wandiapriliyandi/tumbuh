...
```mermaid
graph TD
    Turats["Rujukan Turats Salimul Aqidah"]
    
    Turats --> T1["1. Al-Aqidah Ath-Thahawiyyah (Imam Ath-Thahawi)<br/>Prinsip Tauhid murni & kebersihan aqidah dari tasybih & ta'thil."]
    Turats --> T2["2. Kitab At-Tauhid (Syaikh Muhammad bin Abdul Wahhab)<br/>Pemurnian ibadah dari syirik besar, syirik kecil (riya'), & khurafat."]
    Turats --> T3["3. Ihya' Ulumiddin - Bab Al-Muraqabah wal Muhasabah (Imam Al-Ghazali)<br/>Metode menghadirkan kesadaran pengawasan Allah di setiap detik kehidupan."]
```
...
* **Level**: Project 3 - `03 Capacity Framework / 04 Salimul Aqidah / 01 Philosophy`
* **Langkah Berikutnya**: **`02 Definition/P3-04-02-Definisi-dan-Konseptualisasi.md`**.
