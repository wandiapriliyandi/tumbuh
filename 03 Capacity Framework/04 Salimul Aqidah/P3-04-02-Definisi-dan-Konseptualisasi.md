...
```mermaid
flowchart TD
    subgraph RekonstruksiDefinisiAqidah["REKONSTRUKSI OPERASIONALISASI SALIMUL AQIDAH"]
        DefLama["DEFINISI TRADISIONAL (REDUKSIONIS)<br/>• Aqidah = Hafalan matan nazham & rukun iman.<br/>• Batasan sempit di ranah kognitif kelas.<br/>• Tidak mampu mengukur integritas moral privat."]
        
        DefTUMBUH["DEFINISI OPERASIONAL TUMBUH (HOLISTIK)<br/>• Aqidah = Integritas batin Tauhidullah + Muraqabah.<br/>• Teramati dalam perilaku nyata di 4 lokus asrama 24 jam.<br/>• Menyatukan keimanan, regulasi diri, & kejujuran otonom."]
        
        DefLama ==>|DIREKONSTRUKSI MENJADI| DefTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Reduksionis (Pihak A):<br/>'Kata Aqidah itu artinya ikatan simpul akal; selama santri yakin dalam pikiran, aqidahnya sudah salim tanpa perlu dituntut konsistensi perilaku!'"]
    --> B1["Tinjauan Leksikografi Lisanul 'Arab & Al-Mufradat Al-Isfahani:<br/>'Aqada adalah ikatan kokoh yang tidak terlepas; Salima bermakna selamat dari segala cacat, penyakit, & kemunafikan."]
    A --> B2["Tinjauan Tafsir QS. Asy-Syu'ara: 88-89:<br/>Qalbun Salim adalah kalbu yang bersih dari syirik, keraguan, riya', kedengkian, dan penghianatan amanah."]
    A --> B3["Tinjauan Hadits Shahih Muslim No. 44:<br/>'Al-Imanu ma waqara fil qalbi wa shaddaqahul 'amal' (Iman adalah yang terhunjam mantap di kalbu dan dibuktikan secara nyata oleh perbuatan anggota badan)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Salimul Aqidah secara leksikal dan teologis adalah ikatan keyakinan murni yang memancarkan keselamatan adab lahir-batin."]
```
...
```mermaid
graph TD
    A["Gugatan Psikologisme Sekuler (Pihak A):<br/>'Karakter jujur dan disiplin itu cukup dibangun dengan pembiasaan sosial sekuler; menyandarkannya pada konsep aqidah dan spiritualitas itu tidak efisien!'"]
    --> B1["Tinjauan Teori Identitas Moral Aquino & Reed (2002):<br/>Internalisasi identitas moral (Moral Identity Centrality) menentukan konsistensi perilaku saat tidak ada pengawas eksternal."]
    A --> B2["Tinjauan Spiritual Self-Concept (Emmons, 1999):<br/>Kesadaran diri spiritual memberikan jangkar transendental yang kebal terhadap tekanan kompromi moral sebaya."]
    A --> B3["Tinjauan Konsep Fitrah & Ma'rifatun Nafs Al-Attas:<br/>Pengenalan diri sejati sebagai hamba Allah adalah fondasi arketipe integritas kemanusiaan."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Salimul Aqidah adalah jangkar identitas diri terdalam (Core Identity) yang menggerakkan moralitas santri secara otonom."]
```
...
```mermaid
flowchart LR
    subgraph DinamikaIdentitasSpiritualTUMBUH["HIERARKI PENGGERAK INTEGRITAS PERILAKU SANTRI"]
        L1["LEVEL 1: KONTROL EKSTERNAL (Rapuh)<br/>Santri taat karena takut rotan / ingin dipuji musyrif.<br/>(Gagal saat berada di ruang privat)."]
        
        L2["LEVEL 2: IDENTITAS SOSIAL KELOMPOK (Kondisional)<br/>Santri taat demi menjaga nama baik angkatan/kamar.<br/>(Rentan kompromi saat kelompok melanggar)."]
        
        L3["LEVEL 3: SALIMUL AQIDAH / SPIRITUAL IDENTITY (Abadi & Stabil)<br/>Santri taat karena sadar hakikat diri sebagai hamba Allah.<br/>(Integritas mutlak di tempat ramai maupun sepi)."]
...
```mermaid
flowchart TD
    subgraph RekonstruksiRuangLingkupAqidah["ELIMINASI DIKOTOMI RUANG DALAM OPERASIONALISASI AQIDAH"]
        RuangLama["PARADIGMA DIKOTOMIS (TRADISIONAL)<br/>• Ruang Masjid/Kelas: Dianggap ruang sakral (Wajib santun & dzikir).<br/>• Ruang Kamar/Kamar Mandi/Dapur: Dianggap ruang duniawi bebas.<br/>• Akibat: Santri berakhlak malaikat di masjid, berakhlak buruk di kamar."]
        
        RuangTUMBUH["PARADIGMA HOLISTIK 24 JAM (TUMBUH)<br/>• Seluruh jengkal bumi pesantren adalah lokus ibadah & muraqabah.<br/>• Menjaga kebersihan ranjang adalah ibadah tauhid.<br/>• Menjaga lisan di ranjang malam disaksikan Allah sama seperti di saf shalat."]
        
        RuangLama ==>|DITRANSFORMASIKAN MENJADI| RuangTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph AlurRekonsiliasiSpiritualNihilisme["ALUR KONSULTASI OPERASIONALISASI AQIDAH"]
        Kasus["1. SANTRI MENGALAMI KELESUAN IMAN / APATI SPIRITUAL ('Saya Belum Ikhlas')"]
        
        Konseling["2. SESI KONSELING ISLAMI PRIVAT (Ruang BK/Musyrif)<br/>• Validasi kegundahan santri tanpa label 'munafik'.<br/>• Membedakan antara Waswas Syaitan vs Keikhlasan Sejati."]
        
        Edukasi["3. EDUKASI GRADUALISME FITRAH (Tadarruj Jenjang J1–J4)<br/>• Menjelaskan bahwa ketaatan raga adalah bejana bagi hadirnya keikhlasan hati.<br/>• Menetapkan target kecil: Dzikir 3 menit ba'da shalat."]
        
        Pendampingan["4. PEER BUDDY & MENTORING SEBAYA<br/>• Didampingi santri Jenjang T4 untuk tilawah bersama."]
        
        Pulih["5. PEMULIHAN KELEZATAN IMAN (Halawatul Iman)<br/>• Santri merasakan ketenteraman batin & aktif beribadah secara sukarela."]
        
        Kasus --> Konseling --> Edukasi --> Pendampingan --> Pulih
    end
```
...
```mermaid
flowchart TD
    subgraph TigaLapisanDefinisiAqidah["TIGA LAPISAN MAKNA SALIMUL AQIDAH TUMBUH"]
        L1["1. LAPISAN TEOLOGIS (THEOLOGICAL CORE)<br/>Keyakinan murni & kokoh pada keesaan Allah SWT (Rububiyyah, Uluhiyyah, Asma wa Shifat), bersih dari syirik besar, syirik kecil (Riya'), dan khurafat."]
        
        L2["2. LAPISAN PSIKOLOGIS (PSYCHO-SPIRITUAL IDENTITY)<br/>Internal Spiritual Locus of Control, kesadaran Muraqabatullah (Ihsan), kebebasan dari kecemasan eksistensial, & ketenteraman tawakkal."]
        
        L3["3. LAPISAN PERILAKU TERAMATI (BEHAVIORAL MANIFESTATION)<br/>Integritas moral otonom di ruang privat, kejujuran akademis, penolakan takhayul/hoaks, & pembuktian adab konsisten 24 jam."]
...
```mermaid
graph LR
    subgraph Lokus24Jam["4 LOKUS OBSERVASI PERILAKU SALIMUL AQIDAH"]
        Lokus1["1. MASJID & RUANG IBADAH<br/>• Hadir sebelum adzan.<br/>• Dzikir ma'tsurat tertib.<br/>• Khusyuk tanpa menoleh."]
        
        Lokus2["2. KAMAR ASRAMA & PRIVAT<br/>• Menjaga barang amanah.<br/>• Tidak ghashab sandal/baju.<br/>• Muraqabah saat sendiri."]
        
        Lokus3["3. KELAS & AKADEMIK<br/>• Kejujuran ujian 100%.<br/>• Nalar kritis sains ayat.<br/>• Adab takdzim pada guru."]
        
        Lokus4["4. RUANG MAYA & GAWAI<br/>• Menjaga pandangan (Iffah).<br/>• Tabayyun anti-hoaks.<br/>• Zero konten terlarang."]
    end
```
