...
```mermaid
flowchart TD
    subgraph RekonstruksiPerilakuAqidah["TRANSFORMASI DARI KESALEHAN PANGGUNG MENUJU INTEGRITAS PRIVAT"]
        PerilakuPanggung["KESALEHAN PANGGUNG (PSEUDO-PIETY)<br/>• Khusyuk di masjid, liar di kamar asrama.<br/>• Normalisasi budaya ghashab & menyepelekan amanah.<br/>• Perilaku jujur hanya jika ada kamera/musyrif."]
        
        PerilakuTUMBUH["MANIFESTASI SALIMUL AQIDAH (AUTHENTIC INTEGRITY)<br/>• Integritas moral mutlak di 4 lokus asrama 24 jam.<br/>• Zero ghashab: Menghormati hak milik orang lain lillaah.<br/>• Muraqabah otonom saat sendirian di titik buta asrama."]
        
        PerilakuPanggung ==>|DIREKONSTRUKSI SECARA ILMIAH MENJADI| PerilakuTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Esoterisme Ekstrem (Pihak A):<br/>'Aqidah itu urusan rohani yang suci di dalam dada; tidak adil menilai aqidah santri hanya dari urusan sepele seperti ghashab sandal atau kerapian kasur!'"]
    --> B1["Tinjauan Tafsir Surah Ibrahim: 24-25:<br/>Kalimat Thayyibah (Tauhid) diumpamakan pohon indah: Akarnya menghunjam kuat di batin, cabangnya menjulang, & BUAHNYA KELUAR SETIAP SAAT (Amal Nyata)."]
    A --> B2["Tinjauan Hadits Shahih Bukhari No. 52:<br/>'Alaa wa inna fil jasadi mudhghah...' (Kebaikan kalbu batin secara mutlak memancarkan kebaikan seluruh anggota badan)."]
    A --> B3["Tinjauan Kitab Al-Fawa'id (Ibnul Qayyim):<br/>Iman tanpa pembuktian perilaku lahiriah adalah pohon kering tanpa buah yang rapuh tumbang diterpa angin."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Perilaku lahiriah di ruang privat adalah cermin validitas dan kemurnian aqidah batiniah."]
```
...
```mermaid
graph TD
    A["Gugatan Skeptisisme Perubahan (Pihak A):<br/>'Menasihati santri agar beraqidah lurus itu cukup dengan ceramah pengajian; tidak perlu merekayasa tata ruang asrama atau teori dorongan perilaku (Nudge)!'"]
    --> B1["Tinjauan Theory of Planned Behavior Icek Ajzen (1991):<br/>Perilaku santri dibentuk oleh Niat (Intention), Sikap (Attitude), Norma Subjektif (Subjective Norms), & Persepsi Kendali Diri (Perceived Behavioral Control)."]
    A --> B2["Tinjauan Nudge Theory Richard Thaler (Nobel Ekonomi 2017):<br/>Arsitektur Pilihan (Choice Architecture) yang ramah & higienis secara halus mengarahkan santri memilih perilaku adab tanpa paksaan fisik."]
    A --> B3["Tinjauan Rekayasa Bi'ah Shalihah Turats:<br/>Para ulama salaf menjauhkan santri dari majelis syubhat & menata lingkungan fisik pondok demi menjaga kesucian kalbu."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Kombinasi niat tauhid internal dengan rekayasa lingkungan Nudge melahirkan manifestasi perilaku adab yang stabil 24 jam."]
```
...
```mermaid
flowchart LR
    subgraph SinergiAjzenThalerTUMBUH["INTEGRASI NIAT TAUHID & REKAYASA NUDGE ASRAMA"]
        NiatTauhid["INTERNAL INTENTION (Ajzen)<br/>Keyakinan Muraqabatullah & Khasyyah"]
        
        NormaKomunal["SUBJECTIVE NORMS<br/>Budaya Asrama Anti-Ghashab & Saling Mengingatkan"]
        
        ArsitekturNudge["NUDGE ARCHITECTURE (Thaler)<br/>Rak Sandar Bernama, Pos Barang Temuan, & Ruang Terang"]
        
        PerilakuNyata["MANIFESTASI PERILAKU ADAB KONSISTEN (J1–J4)"]
        
        NiatTauhid & NormaKomunal & ArsitekturNudge ==> PerilakuNyata
    end
```
...
```mermaid
flowchart TD
    subgraph EmpatLokusAsramaTUMBUH["PEMETAAN MANIFESTASI PERILAKU DI 4 LOKUS ASRAMA 24 JAM"]
        
        Lokus1["1. LOKUS IBADAH (MASJID & HALAQAH)<br/>• Hadir di saf pertama sebelum adzan selesai.<br/>• Dzikir Al-Ma'tsurat ba'da Shubuh & Ashar khusyuk.<br/>• Merapikan mushaf Al-Qur'an & sajadah mandiri."]
        
        Lokus2["2. LOKUS PRIVAT (KAMAR TIDUR & LEMARI)<br/>• Zero ghashab: Menghormati pakaian & sandal teman.<br/>• Menjaga adab tidur sesuai sunnah (Wudhu & Doa).<br/>• Mengembalikan barang temuan ke Pos Lapor Kejujuran."]
        
        Lokus3["3. LOKUS AKADEMIK (KELAS & LABORATORIUM)<br/>• Kejujuran ujian 100% (Zero menyontek saat guru keluar).<br/>• Nalar kritis menelaah ayat kauniyah & sains ciptaan.<br/>• Adab takdzim & santun kepada seluruh ustadz/ustadzah."]
        
        Lokus4["4. LOKUS MAYA & RUANG DIGITAL (GAWAI & LAB KOMPUTER)<br/>• Menjaga pandangan (Ghadhdhul Bashar) dari konten haram.<br/>• Menolak membaca ramalan zodiak/tarot & hoaks agama.<br/>• Literasi kritis menyaring syubhat pemikiran di internet."]
...
```mermaid
flowchart TD
    subgraph AlurPenyelesaianGhashabMassal["PROTOKOL SISTEMIK ELIMINASI BUDAYA GHASHAB"]
        Masalah["1. MASALAH LAPANGAN: Ghashab Sandal Berantai di Masjid Asrama"]
        
        SolusiSistem["2. REKAYASA SISTEM NUDGE (Fasilitas & Lingkungan)<br/>• Rak sandal berkode nama kamar di selasar masjid.<br/>• Pengadaan 'Sandal Inventaris Pinjaman Darurat'."]
        
        PenyadaranTauhid["3. EDUKASI AQIDAH & HAK AMANAH (Penyadaran Kalbu)<br/>• Halaqah bedah Hadits Kezaliman Ghashab (HR. Bukhari).<br/>• Memahamkan bahwa ghashab mengikis kemurnian tauhid."]
        
        ApresiasiPBIS["4. MONITORING FAST-LOGGING & APRESIASI PBIS<br/>• Musyrif memberikan Poin Integritas bagi kamar yang 100% tertib sandal."]
        
        BudayaBaru["5. TERBENTUKNYA BUDAYA ZERO GHASHAB (Kemenangan Adab)<br/>• Santri merasa bangga menjaga hak milik saudaranya lillaahi ta'ala."]
        
        Masalah --> SolusiSistem --> PenyadaranTauhid --> ApresiasiPBIS --> BudayaBaru
    end
```
...
```mermaid
flowchart TD
    subgraph Manifestasi4LokusTUMBUH["MANIFESTASI PERILAKU SALIMUL AQIDAH LINTAS 4 LOKUS 24 JAM"]
        
        subgraph L1_Masjid["1. LOKUS IBADAH & HALAQAH (MASJID)"]
            M1["• Hadir di saf pertama sebelum adzan selesai dikumandangkan."]
            M2["• Membaca Dzikir Al-Ma'tsurat ba'da Shubuh & Ashar dengan khusyuk."]
            M3["• Merapikan mushaf Al-Qur'an, sajadah, & menaruh sandal di rak."]
        end
        
        subgraph L2_Privat["2. LOKUS PRIVAT & KEBUTUHAN (KAMAR TIDUR & LEMARI)"]
            K1["• Zero ghashab: Menghormati pakaian, sandal, & makanan teman."]
            K2["• Menjaga adab tidur sunnah (Wudhu, doa, & lampu padam 22.00)."]
            K3["• Jujur menyerahkan barang temuan ke Pos Lapor Kejujuran."]
        end
        
        subgraph L3_Akademik["3. LOKUS AKADEMIK & NALAR (KELAS & LAB)"]
            A1["• Kejujuran ujian 100% (Zero menyontek meski tanpa pengawas)."]
            A2["• Nalar kritis menelaah ayat kauniyah & sains penciptaan alam."]
            A3["• Adab takdzim, santun, & berterima kasih kepada asatidz."]
        end
        
        subgraph L4_Maya["4. LOKUS DIGITAL & KOMUNIKASI (GAWAI & MEDSOS)"]
            D1["• Digital Muraqabah: Menjaga pandangan dari konten pornografi."]
            D2["• Menolak membaca ramalan zodiak/tarot & menyaring hoaks agama."]
            D3["• Menggunakan media digital untuk kreasi dakwah & literasi ilmiah."]
        end
        
        L1_Masjid <===> L2_Privat <===> L3_Akademik <===> L4_Maya
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolFastLoggingPBIS["ALUR PEMANTAUAN CEPAT PRESENCE WALK PBIS (<30 DETIK)"]
        Walk["1. PRESENCE WALK: Musyrif berkeliling asrama secara hangat & ramah saat jam transisi."]
        
        Observasi["2. OBSERVASI PERILAKU KONKRET: Melihat santri melakukan adab (misal: mengembalikan sandal teman)."]
        
        FastTap["3. FAST-TAP LOGGING DIGITAL (<10 Detik): Memilih nama santri & tap ikon 'Salimul Aqidah - T3 (Zero Ghashab)'. (+ Poin Apresiasi)"]
        
        Penguatan["4. PENGUATAN VERBAL EMPATIK: 'Alhamdulillah, jazakallahu khairan atas kejujuranmu menjaga amanah'. Santri merasa dimuliakan."]
        
        Walk --> Observasi --> FastTap --> Penguatan
    end
```
