...
```mermaid
graph TD
    subgraph Intervensi_Aqidah_PBIS["Intervensi PBIS untuk Salimul Aqidah"]
        Tier1["TIER 1 (Pencegahan Universal 80-90%)<br/>• Kajian Asmaul Husna, Dzikir Al-Ma'tsurat berjamaah & keteladanan musyrif."]
        
        Tier2["TIER 2 (Dukungan Terarah 10-15%)<br/>• Kasus: Santri yang takut hantu berlebihan / terpengaruh ramalan zodiak.<br/>• Tindakan: Mentoring kelompok kecil oleh musyrif senior & doa perlindungan syar'i."]
        
        Tier3["TIER 3 (Intervensi Khusus 1-5%)<br/>• Kasus: Membawa jimat kesaktian / syubhat pemikiran ateisme agresif.<br/>• Tindakan: Konseling tauhid individual dengan Ustadz Pakar Aqidah & dialog ilmiyah mendalam."]
...
* **Level**: Project 3 - `03 Capacity Framework / 04 Salimul Aqidah / ./P3-04-14-Sintesis-dan-Validasi-Salimul-Aqidah.md`**.
