...
```mermaid
flowchart TD
    subgraph TransformasiIntervensiAqidah["TRANSFORMASI PARADIGMA INTERVENSI AQIDAH"]
        PunitifUsir["PARADIGMA PUNITIF & PENGUSIRAN (LAMA)<br/>• Menghakimi, mempermalukan di depan umum, & mengusir santri.<br/>• Dzikir dipaksakan via bentakan & takzir fisik.<br/>• Mengabaikan akar masalah psikologis di balik jimat/keraguan."]
        
        PBISTUMBUH["ARSITEKTUR MULTI-TIER PBIS & DIALOG TERAPEUTIK (TUMBUH)<br/>• Tier 1: Budaya Dzikir Ma'tsurat & Tadabbur Asmaul Husna Indah.<br/>• Tier 2: Mentoring Kelompok Kecil bagi Santri Cemas Mistis.<br/>• Tier 3: Konseling Burhani & Ruqyah Syar'iyyah Terapeutik Bebas Drop-Out."]
        
        PunitifUsir ==>|DIREKONSTRUKSI MENJADI| PBISTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Vonis Kafir Cepat (Pihak A):<br/>'Santri yang ragu aqidahnya atau membawa jimat itu sudah batal Islamnya; harus langsung diusir tanpa perlu diajak dialog atau konseling!'"]
    --> B1["Tinjauan Hadits Pemuda Minta Izin Zina (HR. Ahmad No. 22211):<br/>Rasulullah SAW tidak memukul atau mengusir pemuda tersebut, melainkan mendudukkannya, mengajak dialog sokratik rasional-empatis, & mendoakannya."]
    A --> B2["Tinjauan Fiqh Istithabah (Ibnul Qayyim - Madarijus Salikin):<br/>Istithabah (permintaan taubat) hakikatnya adalah proses edukasi & konseling intensif untuk melenyapkan syubhat batin."]
    A --> B3["Tinjauan Kitab Al-Ibanah (Al-Asy'ari):<br/>Meluruskan aqidah dilakukan dengan burhan naqli & 'aqli yang memuaskan nalar, bukan intimidasi pedang."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Intervensi aqidah wajib mengedepankan dialog sokratik empatis & de-eskalasi terapeutik."]
```
...
```mermaid
graph TD
    A["Gugatan Penyamarataan Hukuman (Pihak A):<br/>'Semua santri yang melanggar aturan dzikir atau membawa barang terlarang harus dihukum sama persis; tidak butuh pembagian Tier atau analisis FBA!'"]
    --> B1["Tinjauan Teori School-Wide PBIS Multi-Tier (Horner & Sugai, 2015):<br/>Kebutuhan pembinaan santri terbagi menjadi Tier 1 (Universal 80-90%), Tier 2 (Targeted 10-15%), & Tier 3 (Intensive 1-5%)."]
    A --> B2["Tinjauan Functional Behavior Assessment (FBA):<br/>Setiap perilaku menyimpang memiliki 'Fungsi' (Function): Mencari Perhatian (Attention), Menghindari Tugas (Escape), atau Rasa Takut (Sensory/Security)."]
    A --> B3["Tinjauan Prinsip Replacement Behavior:<br/>Intervensi berhasil jika kita memberikan Perilaku Pengganti Positif yang memenuhi fungsi kebutuhan santri tersebut."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Arsitektur PBIS & FBA mengubah penanganan aqidah dari reaktif-punitif menjadi preventif-presisi."]
```
...
```mermaid
flowchart LR
    subgraph AlurFBAPenyimpanganAqidah["ALUR FUNCTIONAL BEHAVIOR ASSESSMENT (FBA) AQIDAH"]
        Antecedent["1. ANTECEDENT (Pemicu)<br/>Santri merasa cemas menghadapi ujian / takut tempat gelap."]
        
        Behavior["2. PROBLEM BEHAVIOR<br/>Membawa jimat rajah / membaca ramalan horoskop."]
        
        Function["3. FUNCTION (Fungsi Perilaku)<br/>Mencari Rasa Aman & Jaminan Kepastian (Security Seeking)."]
        
        Replacement["4. REPLACEMENT BEHAVIOR<br/>Membaca Dzikir Ma'tsurat, Doa Nabi SAW, & Belajar Itqan."]
        
        Antecedent --> Behavior --> Function --> Replacement
    end
```
...
```mermaid
flowchart TD
    subgraph HabitLoopDzikirTUMBUH["REKAYASA HABIT LOOP PEMBIASAAN DZIKIR 24 JAM"]
        
        Cue["1. CUE / TRIGGER (Pemicu Alami)<br/>• Suara adzan berkumandang / selesai salam shalat fardhu.<br/>• Melangkah keluar kamar / memegang gagang pintu."]
        
        Routine["2. ROUTINE (Tindakan Adab Otomatis)<br/>• Membaca Dzikir Al-Ma'tsurat Kubra secara tartil & khusyuk.<br/>• Melafalkan doa ma'tsur keluar ruangan."]
        
        Reward["3. REWARD (Penguatan Afektif & Spiritual)<br/>• Ketenangan batin (Thuma'ninah - QS. Ar-Ra'd: 28).<br/>• Fast-Tap Apresiasi PBIS dari Musyrif & Senyuman Hangat."]
...
```mermaid
flowchart TD
    subgraph AlurPenangananKrisisSyubhatTier3["PROTOKOL DE-ESKALASI KRISIS SYUBHAT AQIDAH TIER 3"]
        DeteksiKasus["1. DETEKSI KRISIS: Santri Terpapar Forum Agnostik & Menyebarkan Keraguan"]
        
        DeEskalasiBK["2. DE-ESKALASI PRIVAT (<6 Jam) & AUDIT AKAR MASALAH (FBA)<br/>• Pemanggilan empatis tanpa bentakan; mengidentifikasi dahaga intelektual."]
        
        HalaqahBurhani["3. HALAQAH DIALOG BURHANI TIER 3 (3 Pekan Bersama Pakar)<br/>• Membedah logika epistemologi tauhid vs sains materialisme.<br/>• Menjawab seluruh keraguan nalar secara tuntas & santun."]
        
        ProyekRestorasi["4. PROYEK LITERASI RESTORATIF & TAZKIYAH<br/>• Menyusun karya ilmiah bantahan syubhat & rekonsiliasi ukhuwah."]
        
        PemulihanParipurna["5. PEMULIHAN PARIPURNA (Insan Adabi Berakar Kuat)<br/>• Santri menjadi benteng aqidah intelektual di pesantren."]
        
        DeteksiKasus --> DeEskalasiBK --> HalaqahBurhani --> ProyekRestorasi --> PemulihanParipurna
    end
```
...
```mermaid
flowchart TD
    subgraph PiramidaPBISMultiTierAqidah["ARSITEKTUR MULTI-TIER PBIS SALIMUL AQIDAH TUMBUH"]
        
        Tier1["TIER 1: PENCEGAHAN UNIVERSAL (80-90% SANTRI)<br/>• Budaya Dzikir Ma'tsurat Kubra ba'da Shubuh & Ashar berjamaah.<br/>• Tadabbur Asmaul Husna 5 Menit kamar sebelum tidur.<br/>• Pos Lapor Kejujuran & Apresiasi Fast-Tap Poin PBIS."]
        
        Tier2["TIER 2: DUKUNGAN TERARAH (10-15% SANTRI)<br/>• Kelompok Mentoring Shaja'ah Circle bagi santri cemas mistis.<br/>• Check-in / Check-out harian bersama Musyrif Kamar.<br/>• Dialog Sokratik pemurnian tauhid dari zodiak & mitos."]
        
        Tier3["TIER 3: INTERVENSI INTENSIF & INDIVIDUAL (1-5% SANTRI)<br/>• Konseling Burhani Individual bersama Dewan Pakar Aqidah & BK.<br/>• Ruqyah Syar'iyyah Pedagogis de-eskalasi trauma/histeria.<br/>• Kontrak Restorasi Aqidah & Proyek Literasi Tauhid Khusus."]
...
```mermaid
flowchart TD
    subgraph SOPTataKelolaPembiasaan24Jam["SOP PEMBIASAAN HARIAN SALIMUL AQIDAH ASRAMA 24 JAM"]
        
        Subuh["04.30 - 05.30: SHALAT SUBUH & HALAQAH DZIKIR MA'TSURAT KUBRA BERJAMAAH DI MASJID"]
        
        KamarPagi["06.00 - 06.30: ADAB KAMAR: Merapikan Kasur, Menaruh Sandal di Rak, & Doa Keluar Kamar"]
        
        Kelas["07.00 - 15.00: INTEGRITAS AKADEMIK: Doa Pembuka Belajar, Zero Menyontek, & Sains Kauniyah"]
        
        Ashar["15.30 - 16.15: SHALAT ASHAR & DZIKIR PETANG AL-MA'TSURAT MANDIRI TERPANTAU"]
        
        Malam["19.30 - 21.00: KAJIAN TURATS AQIDAH / HALAQAH DIALOG BURHANI (Sesuai Jenjang)"]
        
        Tidur["21.30 - 22.00: TADABBUR ASMAUL HUSNA 5 MENIT KAMAR, ADAB TIDUR SUNNAH, & LAMPU PADAM"]
        
        Subuh --> KamarPagi --> Kelas --> Ashar --> Malam --> Tidur --> Subuh
    end
```
