...
```mermaid
flowchart TD
    subgraph TransformasiDesainProgramAqidah["TRANSFORMASI DESAIN PROGRAM PEMBINAAN AQIDAH"]
        CeramahMonoton["PROGRAM MONOTON TRADISIONAL<br/>• Ceramah pasif satu arah tanpa dialog.<br/>• Terisolasi dari realitas sains & alam semesta.<br/>• Santri jenuh, pasif, & tidak termotivasi."]
        
        ProgramTUMBUH["EKOSISTEM PROGRAM TERPADU TUMBUH<br/>• Halaqah Subuh Interaktif & Sokratik.<br/>• Rihlah Tafakkur Alam Kauniyah (Experiential Learning).<br/>• Proyek Pekan Literasi Anti-Takhayul & Sains Islam."]
        
        CeramahMonoton ==>|DIREKONSTRUKSI MENJADI| ProgramTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Ruang Kelas Tertutup (Pihak A):<br/>'Belajar aqidah itu cukup duduk diam di masjid membaca kitab matan; tidak perlu keluar asrama untuk tadabbur alam atau program proyek sains!'"]
    --> B1["Tinjauan Tafsir QS. Ali 'Imran: 190–191:<br/>Karakter Ulul Albab adalah mereka yang memadukan Dzikir (Qiyaman wa Qu'udan) dengan Tafakkur Penciptaan Langit & Bumi (Tafakkur Kauniyah)."]
    A --> B2["Tinjauan Hadits Majalisudz Dzikr (HR. Muslim No. 2700):<br/>Halaqah yang dinaungi malaikat & dilimpahi sakinah adalah halaqah yang menghidupkan kalbu melalui tadarrus & tadabbur bersama."]
    A --> B3["Tinjauan Kitab Jami' Bayan al-'Ilmi (Ibnu Abdil Barr):<br/>Majelis para sahabat Nabi SAW penuh dengan dialog tanya-jawab kritis, perumpamaan alam, & penguatan ukhuwah."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Program pembinaan aqidah wajib memadukan dzikir kalbu, dialog nalar, & eksplorasi ayat kauniyah."]
```
...
```mermaid
graph TD
    A["Gugatan Kognitivisme Kering (Pihak A):<br/>'Menanamkan aqidah itu cukup transfer pengetahuan teori; tidak perlu menggunakan siklus pengalaman Kolb atau teori pemodelan Bandura!'"]
    --> B1["Tinjauan Experiential Learning David Kolb (1984):<br/>Pembelajaran sejati bergerak melintasi 4 Siklus: Pengalaman Nyata (Concrete Experience) ➔ Observasi Reflektif (Reflective Observation) ➔ Konseptualisasi Abstrak (Abstract Conceptualization) ➔ Eksperimentasi Aktif (Active Experimentation)."]
    A --> B2["Tinjauan Social Learning Theory Albert Bandura (1977):<br/>Santri menginternalisasi nilai adab melalui Observational Learning (Mengamati Keteladanan Qudwah Guru) & Vicarious Reinforcement."]
    A --> B3["Tinjauan Teori Gamifikasi Pendidikan (Deterding et al.):<br/>Kuis cerdas cermat aqidah & tantangan detektif anti-khurafat meningkatkan retensi belajar hingga 250%."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Sintesis sains belajar Kolb-Bandura menghidupkan program aqidah menjadi transformatif & menyenangkan."]
```
...
```mermaid
flowchart LR
    subgraph SiklusKolbProgramAqidah["SIKLUS EXPERIENTIAL LEARNING PROGRAM AQIDAH TUMBUH"]
        CE["1. PENGALAMAN NYATA (Concrete Experience)<br/>Melihat fenomena alam / simulasi ujian kejujuran."]
        
        RO["2. REFLEKSI BUSTAN (Reflective Observation)<br/>Muhasabah batin: Apa yang dirasakan kalbu?"]
        
        AC["3. KONSEPTUALISASI DALIL (Abstract Conceptualization)<br/>Bedah ayat Al-Qur'an & Kitab Turats Tauhid."]
        
        AE["4. AKSI AMAL NYATA (Active Experimentation)<br/>Komitmen zero-ghashab & istiqamah dzikir mandiri."]
...
```mermaid
flowchart TD
    subgraph KalenderProgramTahunanTUMBUH["INTEGRASI 4 PROGRAM UNGGULAN AQIDAH DALAM KALENDER ASRAMA"]
        
        P1["1. HALAQAH SUBUH AL-MA'TSURAT (HARIAN - 100% SANTRI)<br/>• Pelaksanaan: Setiap hari ba'da Shubuh (04.45 - 05.15) di Masjid.<br/>• Konten: Dzikir berjamaah + Tadabbur 1 Ayat Tauhid Kauniyah."]
        
        P2["2. BEDAH TURATS AQIDAH TEMATIK (PEKANAN / JUMAT MALAM)<br/>• Pelaksanaan: Setiap Malam Sabtu (20.00 - 21.30) di Aula.<br/>• Konten: Bedah Kitab Aqidah Thahawiyyah / Mantiq Burhani vs Syubhat."]
        
        P3["3. RIHLAH TAFAKKUR ALAM KAUNIYAH (SEMESTERAN / MABIT)<br/>• Pelaksanaan: Akhir Semester Ganjil & Genap (2 Hari 1 Malam di Alam).<br/>• Konten: Qiyamul Lail di Bawah Bintang, Observasi Astronomi, & Muhasabah."]
        
        P4["4. PEKAN LITERASI ANTI-KHURAFAT & SAINS ISLAM (TAHUNAN)<br/>• Pelaksanaan: Bulan Rajab / Menyambut Isra Mi'raj (1 Pekan Penuh).<br/>• Konten: Pameran Sains Tauhid, Bedah Mitos, Kuis Cerdas Cermat, & Debat Ilmiah."]
...
```mermaid
flowchart TD
    subgraph AlurResolusiSantriJenuhHalaqah["PROTOKOL TRANSFORMASI KEJENUHAN HALAQAH DZIKIR"]
        Kasus["1. ANOMALI: Santri Melarikan Diri dari Halaqah Dzikir Subuh"]
        
        Investigasi["2. INVESTIGASI EMPATIS & DIALOG SOKRATIK (Musyrif Kamar)<br/>• Menemukan akar kejenuhan kognitif & kepasifan peran."]
        
        Pemberdayaan["3. PEMBERDAYAAN PERAN AKTIF (Leadership Empowerment)<br/>• Menugaskan santri memimpin pembacaan terjemahan & tadabbur makna doa."]
        
        Transformasi["4. REKREASI MAKNA: Dzikir Dirasakan Sebagai Kehormatan, Bukan Beban.<br/>• Santri hadir di saf depan dengan senyum & motivasi intrinsik."]
        
        Kasus --> Investigasi --> Pemberdayaan --> Transformasi
    end
```
...
```mermaid
flowchart TD
    subgraph Arsitektur4ProgramUnggulan["EMPAT PROGRAM UNGGULAN SALIMUL AQIDAH TUMBUH"]
        
        subgraph Program1["1. HALAQAH SUBUH AL-MA'TSURAT (HARIAN)"]
            P1_A["• Format: 30 Menit (Dzikir Ma'tsurat Kubra + 1 Ayat Kauniyah)."]
            P1_B["• Sasaran: 100% Santri (Masjid Asrama)."]
            P1_C["• Output: Hafal matan doa & terbentuknya ketenangan batin pagi."]
        end
        
        subgraph Program2["2. BEDAH TURATS AQIDAH TEMATIK (PEKANAN)"]
            P2_A["• Format: 45 Menit (Bedah Kitab Thahawiyyah + Debat Burhani)."]
            P2_B["• Sasaran: Santri Jenjang J2, J3, & J4 (Aula Pesantren)."]
            P2_C["• Output: Nalar kritis membantah syubhat ateisme/sekularisme."]
        end
        
        subgraph Program3["3. RIHLAH TAFAKKUR ALAM KAUNIYAH (SEMESTERAN)"]
            P3_A["• Format: Mabit 2 Hari 1 Malam di Alam Terbuka (Outdoor Camping)."]
            P3_B["• Sasaran: Seluruh Santri Berjenjang (Kaki Gunung/Pantai)."]
            P3_C["• Output: Pengalaman Awe Transendental & Rasa Takjub Tauhid."]
        end
        
        subgraph Program4["4. PEKAN LITERASI ANTI-KHURAFAT & SAINS ISLAM (TAHUNAN)"]
            P4_A["• Format: Festival 1 Pekan (Pameran Sains, Debat, & Kuis Mantiq)."]
            P4_B["• Sasaran: Seluruh Komunitas Pesantren & Wali Santri."]
            P4_C["• Output: Budaya Bi'ah Shalihah 100% Bersih dari Takhayul & Jimat."]
        end
    end
```
