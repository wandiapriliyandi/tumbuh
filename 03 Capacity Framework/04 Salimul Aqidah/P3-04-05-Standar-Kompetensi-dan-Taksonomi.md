...
```mermaid
flowchart TD
    subgraph TransformasiTaksonomiAqidah["REKONSTRUKSI TAKSONOMI KOMPETENSI AQIDAH"]
        BloomSekuler["TAKSONOMI BLOOM SEKULER (TERFRAGMENTASI)<br/>• Kognitif murni (C1-C6) terpisah dari ruhani.<br/>• Afektif terbatas pada kepatuhan sosial semu.<br/>• Tidak mengakui dimensi Muraqabah & Bashirah."]
        
        TaksonomiTUMBUH["TAKSONOMI FITRAH INTEGRATIF TUMBUH<br/>• Ma'rifatun Nalar (Kognitif Burhani & Ayat Kauniyah).<br/>• Tasydiqul Qalb (Afektif Ruhani: Mahabbah, Khauf, Muraqabah).<br/>• 'Amalul Jawarih (Perilaku Teramati BARS di 4 Lokus 24 Jam)."]
        
        BloomSekuler ==>|DIREKONSTRUKSI MENJADI| TaksonomiTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Dikotomis (Pihak A):<br/>'Standar kompetensi aqidah itu cukup menguji Ma'rifah (pengetahuan dalil); tasydiq dan amal itu wilayah pribadi yang tidak bisa distandarisasi!'"]
    --> B1["Tinjauan Kitab At-Ta'rifat Imam Al-Jurjani:<br/>Al-Iman fil 'urf: At-Tasydiqu bil qalbi wal iqraru bil lisani wal 'amalu bil arkan (Iman adalah kesatuan tak terpisahkan antara pembenaran kalbu, ikrar lisan, & amal perbuatan)."]
    A --> B2["Tinjauan Ihya' 'Ulumiddin (Al-Ghazali):<br/>Tingkatan keyakinan bertingkat: 'Ilmul Yaqin (Nalar Dalil) ➔ 'Ainul Yaqin (Penghayatan Kalbu) ➔ Haqqul Yaqin (Penyatuan Amal & Keikhlasan)."]
    A --> B3["Tinjauan Hadits Nabi SAW (HR. At-Tirmidzi):<br/>'La yastaqiimu imaanu 'abdin hatta yastaqiima qalbuhu...' (Tidak lurus iman seorang hamba sebelum lurus hatinya, & tidak lurus hatinya sebelum lurus lisannya)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Standar kompetensi aqidah wajib mengukur triad integral: Ma'rifah nalar, Tasydiq batin, & 'Amal lahiriah."]
```
...
```mermaid
graph TD
    A["Gugatan Ketidakcocokan Teori Barat (Pihak A):<br/>'Teori perkembangan iman James Fowler dan Taksonomi Bloom itu teori Barat sekuler; tidak boleh digabungkan dengan kurikulum pesantren!'"]
    --> B1["Tinjauan Kaidah Al-Hikmatu Dhaallatul Mu'min:<br/>Sains psikologi perkembangan yang selaras dengan fitrah adalah hikmah yang wajib diambil umat Islam."]
    A --> B2["Tinjauan Stages of Faith James Fowler (1981):<br/>Fowler memetakan perkembangan iman dari Imitatif-Konvensional (Synthetic-Conventional) menuju Iman Otonom (Individuative-Reflective) yang persis dengan progresi Tangga J1 menuju J3."]
    A --> B3["Tinjauan Taksonomi Afektif Krathwohl (1964):<br/>Progresi afektif dari Receiving (Menerima) ➔ Responding (Merespons) ➔ Valuing (Menghargai) ➔ Organizing ➔ Characterization (Internalisasi Karakter Abadi)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Sintesis Bloom-Fowler dengan Taksonomi Fitrah melahirkan matriks standar kompetensi aqidah yang mutakhir & kokoh syar'i."]
```
...
```mermaid
flowchart LR
    subgraph KonvergensiTaksonomiTUMBUH["SINTESIS TAKSONOMI FITRAH SALIMUL AQIDAH"]
        Bloom["BLOOM-KRATHWOHL<br/>(Kognitif & Afektif Internalization)"]
        Fowler["JAMES FOWLER<br/>(Stages of Faith Development)"]
        Turats["TURATS FITRAH<br/>(Ma'rifah ➔ Tasydiq ➔ 'Amal)"]
        
        Bloom & Fowler & Turats ==> TaksonomiTUMBUHCore["STANDAR KOMPETENSI TAKSONOMI AQIDAH BERJENJANG J1–J4"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProgresiTanggaAqidahTUMBUH["PROGRESI CAPAIAN KOMPETENSI AQIDAH J1–J4"]
        J1["JENJANG J1: KEPATUHAN TERBIMBING (TA'ARUF & IMITATIF)<br/>• Scaffolding Musyrif: 80% pendampingan.<br/>• Capaian: Hafal dalil rukun iman, doa harian, & dzikir ma'tsurat.<br/>• Perilaku: Disiplin shalat & kamar karena jadwal asrama."]
        
        J2["JENJANG J2: PEMBIASAAN KONSISTEN (TAFAHUM & PEMAHAMAN)<br/>• Scaffolding Musyrif: 50% pendampingan.<br/>• Capaian: Memahami syarah tauhid, membedakan sunnah vs khurafat.<br/>• Perilaku: Mandiri dzikir pagi-petang, mulai malu berbuat curang."]
        
        J3["JENJANG J3: KEMANDIRIAN STABIL (TA'AWUN & MURAQABAH OTONOM)<br/>• Scaffolding Musyrif: 20% pemantauan mandiri.<br/>• Capaian: Menguasai mantiq burhani bantahan syubhat, tawakkal kokoh.<br/>• Perilaku: Integritas mutlak di ruang privat, zero ghashab & menyontek."]
        
        J4["JENJANG J4: PENGGERAK QUDWAH (TAKAFUL / TAHWIL & KETELADANAN)<br/>• Scaffolding Musyrif: 0% (Otonom Penuh & Menjadi Mitra Musyrif).<br/>• Capaian: Menghayati Maqam Ihsan, membedah kitab turats lanjutan.<br/>• Perilaku: Menjadi teladan adab asrama, mentor adik kelas J1."]
...
```mermaid
flowchart TD
    subgraph AlurRemedialKompetensiAqidah["PROTOKOL REMEDIAL KOMPETENSI SALIMUL AQIDAH"]
        Kasus["1. SANTRI LOLOS KOGNITIF TETAPI GAGAL DI RANAH INTEGRITAS PRIVAT (BOHONG/MALAS)"]
        
        EvaluasiKomposit["2. AUDIT TRIANGULASI KOMPETENSI (Dewan Asatidz & Musyrif)<br/>• Nilai Ujian Tulis: 100 (Lulus Kognitif).<br/>• Observasi Asrama: Jenjang J1 Rapuh (Belum Tuntas Afektif & Amaliyyah)."]
        
        ProgramRemedial["3. PROGRAM REMEDIAL RUHIYAH TIER 2 PBIS (30 Hari)<br/>• Dialog Sokratik Penyadaran Niat bersama Konselor BK.<br/>• Proyek Khidmah Masjid Asrama & Mentoring Khusus bersama Musyrif."]
        
        VerifikasiOtonom["4. UJI INTEGRITAS RUANG PRIVAT (Blindspot Verification)<br/>• Pemantauan konsistensi shalat berjamaah & kejujuran tanpa intervensi fisik."]
        
        KelulusanAdabi["5. PENGESAHAN KELULUSAN INSAN ADABI (Tangga J3)<br/>• Santri menyatukan kecerdasan akal dengan kesucian adab batin."]
        
        Kasus --> EvaluasiKomposit --> ProgramRemedial --> VerifikasiOtonom --> KelulusanAdabi
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturTaksonomiTriDomain["ARSTEKTUR TAKSONOMI TRI-DOMAIN SALIMUL AQIDAH"]
        
        subgraph DomainKognitif["1. RANAH KOGNITIF ('AQLIYYAH)"]
            K1["K1: Menghafal dalil pokok rukun iman & sifat Allah (Remembering)"]
            K2["K2: Memahami makna ayat kauniyah & sunnatullah (Understanding)"]
            K3["K3: Menerapkan kaidah tauhid dalam analisis realitas (Applying)"]
            K4["K4: Menganalisis & membantah syubhat ateisme/khurafat (Analyzing)"]
            K5["K5: Mengevaluasi kemurnian tauhid dalam fenomena modern (Evaluating)"]
        end
        
        subgraph DomainAfektif["2. RANAH AFEKTIF RUHANI (QALBIYYAH)"]
            A1["A1: Merasakan ketenangan saat berdzikir & berdoa (Receiving)"]
            A2["A2: Antusias mengikuti halaqah tadabbur iman (Responding)"]
            A3["A3: Menghargai & mencintai syariat di atas hawa nafsu (Valuing)"]
            A4["A4: Menghadirkan Muraqabatullah saat sendirian di kamar (Organizing)"]
            A5["A5: Mencapai Maqam Ihsan & Keikhlasan Permanen (Characterization)"]
        end
        
        subgraph DomainAmaliyyah["3. RANAH AMALIYYAH (PERILAKU TERAMATI BARS)"]
            P1["P1: Membaca Dzikir Ma'tsurat & doa harian secara tertib"]
            P2["P2: Hadir shalat berjamaah di saf depan sebelum adzan"]
            P3["P3: Menolak menyontek & bersumpah palsu di ruang privat"]
            P4["P4: Membuang jimat & menolak ramalan horoskop secara mandiri"]
            P5["P5: Membimbing & menjadi teladan adab bagi adik kelas (Qudwah)"]
        end
        
        DomainKognitif <===> DomainAfektif <===> DomainAmaliyyah
    end
```
...
```mermaid
graph TD
    subgraph RubrikDeskriptorTaksonomi["DESKRIPTOR CAPAIAN LEVEL TAKSONOMI AQIDAH"]
        L1["LEVEL 1: MEMAHAMI & MENIRU (J1)<br/>Hafal teks dalil tauhid; melaksanakan dzikir bersama dengan pendampingan penuh musyrif."]
        
        L2["LEVEL 2: MENGHAYATI & MEMBIASAKAN (J2)<br/>Paham alasan syar'i; konsisten dzikir mandiri; menolak mitos ramalan atas kesadaran nalar."]
        
        L3["LEVEL 3: MENGINTERNALISASI & MANDIRI (J3)<br/>Muraqabah otonom; integritas moral 100% di ruang privat; tawakkal stabil menghadapi tekanan."]
        
        L4["LEVEL 4: MENGAKTUALISASI & MENGGERAKKAN (J4 - QUDWAH)<br/>Menjadi teladan hidup Maqam Ihsan; membimbing & menginspirasi komunitas asrama menuju tauhid murni."]
