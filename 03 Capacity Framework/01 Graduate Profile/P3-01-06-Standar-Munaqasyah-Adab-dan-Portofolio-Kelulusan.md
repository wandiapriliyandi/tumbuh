...
```mermaid
flowchart TD
    subgraph ModelKelulusanHolistikTUMBUH["4 RUKUN KELULUSAN HOLISTIK PESANTREN TUMBUH"]
        Portofolio["1. PORTOFOLIO ADAB 3 TAHUN (Logbook PBIS)<br/>Konsistensi 10 Muwashafat, catatan refleksi muhasabah malam, rasio kepatuhan adab."]
        
        Mutqin["2. UJIAN MUTQIN TAHFIZH & TURATS<br/>Uji ketahanan hafalan, tasmi' akbar bersanad, & pemahaman kaidah syar'i."]
        
        KaryaTulis["3. KARYA CAPSTONE ILMIAH SANTRI<br/>Riset terapan / karya tulis ilmiah mandiri solusi masalah umat."]
        
        Munaqasyah["4. SIDANG MUNAQASYAH KHIDMAH (T4)<br/>Pertanggungjawaban proyek pengabdian masyarakat di depan Kyai, Penguji, & Wali."]
        
        Portofolio & Mutqin & KaryaTulis & Munaqasyah ==> Ijazah["PENETAPAN KELULUSAN PARIPURNA & PEMBERIAN IJAZAH INSAN ADABI"]
    end
```
...
```mermaid
graph TD
    A["Gugatan Formalitas (Pihak A):<br/>'Kelulusan cukup dengan ujian tulis semester akhir dan hafalan setor sekali; sidang munaqasyah adab berbelit-belit!'"]
    --> B1["Tinjauan Tafsir Surah Al-Anbiya: 47:<br/>'Wa nadha'ul mawaaziinal qistha li-yaumil qiyaamati...' (Penegakan timbangan keadilan hisab yang presisi hingga seberat biji sawi)."]
    A --> B2["Tinjauan Fiqh Syahadah (Persaksian Syar'i):<br/>Ijazah adalah bentuk persaksian; memberikan ijazah adab kepada santri tanpa verifikasi perilaku nyata adalah Syahadatuz Zuur (Persaksian Palsu)."]
    A --> B3["Tinjauan Tradisi Sanad Keilmuan Ulama Salaf:<br/>Pemberian ijazah sanad mensyaratkan Mulazamah Adab dan pengujian integritas moral."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Asesmen kelulusan wajib menguji karakter nyata melalui portofolio longitudinal dan munaqasyah adab."]
```
...
```mermaid
flowchart TD
    subgraph TriangulasiPenilaiMunaqasyah["TRIANGULASI 360 DERAJAT PENILAIAN KELULUSAN"]
        Masyayikh["1. DEWAN MASYAYIKH & PENGUJI AHLI (40%)<br/>Menguji kedalaman turats, keutuhan tahfizh mutqin, & nalar mantiq karya tulis."]
        
        Musyrif["2. MUSYRIF ASRAMA & GURU KELAS (30%)<br/>Memvalidasi rekam jejak portofolio adab, kedisiplinan shalat, & kebersihan kamar."]
        
        Sebaya["3. PENILAIAN REKAN SEBAYA / PEER (15%)<br/>Menilai ukhuwah, kerja sama tim, & ketiadaan perilaku menindas (zero bullying)."]
        
        Wali["4. ORANG TUA & MASYARAKAT (15%)<br/>Menilai konsistensi adab saat liburan & dampak proyek khidmah di masyarakat."]
        
        Masyayikh & Musyrif & Sebaya & Wali ==> SkorAkhir["SKOR INTEGRITAS KELULUSAN INSAN ADABI (KAPPA >= 0.85)"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurMunaqasyahAdabTUMBUH["STANDAR OPERASIONAL PROSEDUR MUNAQASYAH ADAB"]
        Verifikasi["1. VERIFIKASI DESK REVIEW PORTOFOLIO (H-30)<br/>Biro Penjaminan Mutu memeriksa kelengkapan logbook adab, tasmi', & capstone."]
        
        SidangTerbuka["2. PELAKSANAAN SIDANG MUNAQASYAH ADAB (H-14)<br/>Santri mempresentasikan portofolio & khidmah di hadapan Masyayikh & Orang Tua."]
        
        PlenoKelulusan["3. SIDANG PLENO PENETAPAN YUDISIUM ADAB (H-7)<br/>Majelis Masyayikh menetapkan status kelulusan & predikat ijazah."]
        
        WisudaKhidmah["4. PROSESI WISUDA KHIDMAH & PENGUTUSAN DAKWAH (HARI-H)<br/>Pemberian Ijazah Sanad Adab & pembacaan ikrar khidmah peradaban umat."]
        
        Verifikasi --> SidangTerbuka --> PlenoKelulusan --> WisudaKhidmah
    end
```
