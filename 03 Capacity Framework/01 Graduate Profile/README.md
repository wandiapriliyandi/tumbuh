...
Sub-Domain `01 Graduate Profile` menetapkan profil kelulusan paripurna bagi Santri di Tangga T4, profil kompetensi Guru/Musyrif berbasis *Qudwah Hasanah*, kapasitas institusi pesantren sebagai *Learning Organization*, kecakapan abad ke-21 berbasis *Digital Wisdom*, serta standar kelulusan autentik melalui Sidang Munaqasyah Adab:

```mermaid
graph TD
    Profile["SUB-DOMAIN 01: GRADUATE PROFILE (PROFIL KELULUSAN - 8 MONOGRAF)"]
    
    Profile --> Master["P3-01: Graduate Profile TUMBUH Master (Monograf Induk Sub-Domain 01)"]
    Profile --> M1["P3-01-01: Triad Profil Kapasitas (Santri, Musyrif, & Kelembagaan)"]
    Profile --> M2["P3-01-02: Kompetensi Inti 10 Karakter Santri (Taksonomi Muwashafat T4)"]
    Profile --> M3["P3-01-03: Standar Kompetensi Qudwah Musyrif (BARS & Diklat 40 Jam)"]
    Profile --> M4["P3-01-04: Standar Kapasitas Kelembagaan (Learning Org Senge & Sanitasi)"]
    Profile --> M5["P3-01-05: Profil Kesiapan Disrupsi Global (4C, Digital Wisdom, & Wasathiyyah)"]
    Profile --> M6["P3-01-06: Standar Munaqasyah Adab & Portofolio (Sidang Terbuka Khidmah T4)"]
    Profile --> M7["P3-01-07: Sintesis Graduate Profile TUMBUH (Grand Rubrik Kelulusan)"]
```
...
| **02** | [**`P3-01-02-Kompetensi-Inti-10-Karakter-Santri.md`**](./P3-01-02-Kompetensi-Inti-10-Karakter-Santri.md) | Kompetensi Inti 10 Karakter Santri | Taksonomi 10 Muwashafat Hasan Al-Banna & CASEL SEL; deskriptor capaian Tangga T4 Penggerak (10 Catatan Kaki). |
