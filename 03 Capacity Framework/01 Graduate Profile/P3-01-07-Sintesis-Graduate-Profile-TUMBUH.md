...
flowchart TD
    subgraph ArsitekturGraduateProfileTUMBUH["6 PILAR PROFIL KAPASITAS KELULUSAN PESANTREN TUMBUH"]
        ...
        P4["PILAR 4: KAPASITAS LEMBAGA (P3-01-04)<br/>• Pesantren sebagai Learning Organization Senge.<br/>• Iklim Psychological Safety & sanitasi prima."]
        ...
        Pusat["TERWUJUDNYA GENERASI INSAN ADABI YANG KOKOH AKIDAHNYA, LUAS WAWASANNYA, & TINGGI KHIDMAHNYA"]
...
```mermaid
graph TD
    subgraph TriadKelulusanSimbiotik["PERWUJUDAN TRIAD DALAM PROFIL KELULUSAN"]
        Santri["1. SANTRI TUMBUH<br/>• Lulus menyandang predikat Insan Adabi T4.<br/>• Hafalan mutqin, nalar mantiq, & mandiri.<br/>• Siap kuliah di universitas dunia & berkhidmah."]
        
        Musyrif["2. MUSYRIF / ASATIDZ TUMBUH<br/>• Memiliki rekam jejak bimbingan sukses & bersertifikat.<br/>• Bekerja dalam budaya saling asah-asih-asuh.<br/>• Bahagia melihat santri binaannya berhasil."]
        
        Pesantren["3. PESANTREN / LEMBAGA TUMBUH<br/>• Menjadi pusat rujukan mutu pendidikan Islam.<br/>• Jaringan alumni kuat, produktif, & beradab.<br/>• Dipercaya penuh oleh umat & masyarakat dunia."]
...
```mermaid
graph LR
    subgraph JembatanKonseptualGraduateToArchitecture["GERBANG DERIVASI SUB-DOMAIN 01 KE 02"]
        SD01["01 GRADUATE PROFILE (TUNTAS - 7 Monograf)<br/>Menetapkan profil akhir kapasitas 3 entitas (Santri, Guru, Lembaga)."]
        
        SD02["02 CHARACTER ARCHITECTURE (TAHAP BERIKUTNYA)<br/>Membedah arsitektur taksonomi karakter, gradasi 4 level, & psikometri."]
        
        SD01 ==>|MENJADI CETAK BIRU TARGET CAPAIAN BAGI PERANCANGAN STRUKTUR DI| SD02
    end
```
...
```mermaid
flowchart TD
    subgraph ProsedurEvaluasiKelulusanTUMBUH["SOP EVALUASI KELULUSAN SANTRI TUMBUH"]
        AuditPortofolio["1. AUDIT PORTOFOLIO LONGITUDINAL (BULAN KE-34)<br/>Tim penilai memvalidasi skor BARS 10 karakter & logbook PBIS 3 tahun."]
        
        TasmiMutqin["2. UJIAN TASMI' AKBAR TAHFIZH & TURATS (BULAN KE-35)<br/>Ujian kelancaran hafalan sekali duduk di hadapan dewan huffazh bersanad."]
        
        MunaqasyahKhidmah["3. SIDANG MUNAQASYAH KHIDMAH TERBUKA (BULAN KE-36)<br/>Santri mempresentasikan portofolio & proyek khidmah di depan Masyayikh & Wali."]
        
        Yudisium["4. SIDANG PLENO YUDISIUM ADAB & PENGANUGERAHAN IJAZAH<br/>Majelis menetapkan kelulusan Insan Adabi: Mumtaz, Jayyid Jiddan, atau Jayyid."]
        
        AuditPortofolio --> TasmiMutqin --> MunaqasyahKhidmah --> Yudisium
    end
```
