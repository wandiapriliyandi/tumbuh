...
```mermaid
flowchart TD
    subgraph IntegrasiTaksonomiKarakterTUMBUH["INTEGRASI 10 MUWASHAFAT DENGAN 5 CASEL SEL"]
        Muwashafat["10 MUWASHAFAT ISLAMI:<br/>1. Salimul Aqidah<br/>2. Shahihul Ibadah<br/>3. Matinul Khuluq<br/>4. Qawiyyul Jism<br/>5. Mutsaqqaful Fikr<br/>6. Mujahadatun Linafsih<br/>7. Haritsun 'ala Waqtih<br/>8. Munazhzham fi Syu'unih<br/>9. Qadirun 'alal Kasb<br/>10. Nafi'un Lighairih"]
        
        CASEL["5 KOMPETENSI CASEL SEL:<br/>1. Self-Awareness (Kesadaran Diri)<br/>2. Self-Management (Regulasi Diri)<br/>3. Social Awareness (Empati Sosial)<br/>4. Relationship Skills (Ukhuwah & Komunikasi)<br/>5. Responsible Decision-Making (Amanah)"]
        
        Muwashafat <===> CASEL
        
        Output["TAKSONOMI KOMPETENSI INTI SANTRI TUMBUH<br/>(Deskriptor Perilaku Teramati BARS di 4 Lokus Asrama 24 Jam)"]
        Muwashafat & CASEL ==> Output
    end
```
...
flowchart TD
    subgraph TanggaProgresiKarakterTUMBUH["PROGRESI TANGGA TUMBUH J1–J4 DALAM PENGUASAAN KARAKTER"]
        ...
        T3["TANGGA T3: TA'AWUN (INTERNALISASI & KOLABORASI)<br/>• Pendampingan mandiri (20%); santri berinisiatif menjaga adab bersama.<br/>• Mampu membimbing teman sekamar & menyelesaikan perselisihan."]
        
        T4["TANGGA T4: TAKAFUL / TAHWIL (KEMANDIRIAN & TRANSFORMASI)<br/>• Kemandirian penuh (100% otonom); santri menjadi teladan asrama.<br/>• Berinisiatif qiyamul lail mandiri & memimpin adik kelas."]
...
```mermaid
flowchart TD
    subgraph SOPAsesmenKarakterIpsatif["PROTOKOL ASESMEN KARAKTER BARS 24 JAM"]
        Observasi["1. OBSERVASI ALAMI HARIAN (FAST-TAP DIGITAL LOGBOOK)<br/>Musyrif mencatat perilaku teramati santri di 4 lokus asrama dalam <30 detik."]
        ...
        Observasi --> Triangulasi --> EvaluasiIpsatif --> UmpanBalik
    end
```
