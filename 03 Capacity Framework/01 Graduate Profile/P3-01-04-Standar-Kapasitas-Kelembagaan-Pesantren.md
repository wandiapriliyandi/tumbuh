...
```mermaid
flowchart TD
    subgraph ArsitekturKapasitasKelembagaan["4 DIMENSI KAPASITAS KELEMBAGAAN PESANTREN TUMBUH"]
        Governance["1. TATA KELOLA & SOP TERSTANDAR (Governance)<br/>Struktur wewenang jelas, bebas tumpang tindih, manual SOP baku."]
        
        Environment["2. LINGKUNGAN FISIK SEHAT & AMAN (Bi'ah Shalihah)<br/>Sanitasi prima (KM 1:5), air bersih 0 CFU, CPTED bebas blind spots."]
        
        DataPBIS["3. ARSITEKTUR DATA-DRIVEN DIGITAL (Analytics)<br/>Logbook digital realtime (<30 detik), heatmap PBIS, keputusan berbasis data."]
        
        PsychSafety["4. IKLIM KEAMANAN PSIKOLOGIS (Psychological Safety)<br/>Bebas kekerasan fisik/verbal, pelaporan aman, keterbukaan muhasabah."]
        
        Governance <===> Environment
        Environment <===> DataPBIS
        DataPBIS <===> PsychSafety
        PsychSafety <===> Governance
        
        Pusat["PESANTREN SEBAGAI ORGANISASI PEMBELAJAR YANG UNGGUL, AKUNTABEL, & BERKELANJUTAN"]
        
        Governance & Environment & DataPBIS & PsychSafety ==> Pusat
    end
```
...
```mermaid
graph TD
    A["Gugatan Pengelolaan Tradisional (Pihak A):<br/>'Pesantren itu urusan berkah dan dawuh kyai semata; standarisasi SOP dan metrik data kelembagaan justru merusak keikhlasan!'"]
    --> B1["Tinjauan Tafsir Surah An-Nisa: 58:<br/>'Innallaha ya'murukum an tu'addul amanaati ilaa ahliha...' (Kewajiban menunaikan amanah kelembagaan secara profesional kepada ahlinya)."]
    A --> B2["Tinjauan Kaidah Ushul Fiqh:<br/>'Ma la yatimmul wajibu illa bihi fahuwa wajib' (Mewujudkan pembinaan adab santri yang aman menuntut adanya tata kelola yang tertib)."]
    A --> B3["Tinjauan Hadits Nabi SAW:<br/>'Inna Allaha yuhibbu idza 'amila ahadukum 'amalan an yutqinahu' (HR. Al-Baihaqi: Profesionalisme Itqan)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>SOP baku dan sistem data adalah manifestasi nyata dari Itqanul 'Amal dan pemenuhan amanah syar'i."]
```
...
```mermaid
flowchart TD
    subgraph ParameterOperasionalPesantrenTUMBUH["STANDAR BAKU PARAMETER OPERASIONAL KELEMBAGAAN"]
        Sanitasi["1. STANDAR SANITASI: Rasio KM 1:5; air 0 CFU E. coli; inspeksi higienitas pekanan."]
        
        Arsitektur["2. STANDAR RUANG: Ventilasi 10% luas lantai; cahaya 150 lux; bebas area tersembunyi."]
        
        SDM["3. STANDAR MUSYRIF: Rasio pembina santri 1:15; sertifikasi diklat 40 jam; jam kerja sehat."]
        
        Konseling["4. STANDAR BK: Ruang konseling privat; kode etik kerahasiaan; protokol de-eskalasi 3R."]
        
        Sanitasi --> Arsitektur --> SDM --> Konseling
    end
```
