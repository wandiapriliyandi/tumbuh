...
```mermaid
flowchart TD
    subgraph TransformasiPeranMusyrifTUMBUH["TRANSFORMASI PARADIGMA PENGASUHAN MUSYRIF"]
        Lama["PARADIGMA LAMA (TIDAK BERSTANDAR):<br/>• Penjaga malam / satpam peniup peluit.<br/>• Tanpa pelatihan psikologi & konseling.<br/>• Jam kerja 24 jam tanpa libur (Burnout).<br/>• Menangani masalah dengan kekerasan fisik."]
        
        Baru["PARADIGMA TUMBUH (PROFESIONAL & BERADAB):<br/>• Ayah spiritual (In Loco Parentis) & teladan Qudwah.<br/>• Menguasai 4 Domain Kompetensi & De-eskalasi 3R.<br/>• Jam kerja manusiawi, shift bergilir, & gaji layak.<br/>• Penegakan adab restoratif penuh kasih sayang."]
        
        Lama ==>|REFORMASI SISTEMIK TOTAL| Baru
    end
```
...
```mermaid
graph TD
    A["Gugatan Devaluasi Musyrif (Pihak A):<br/>'Musyrif itu bukan guru; mereka cuma bertugas mengawasi anak tidur dan mandi, tidak perlu standar kompetensi adab!'"]
    --> B1["Tinjauan Kitab Adab al-'Alim wal Muta'allim KH. Hasyim Asy'ari:<br/>Pendidik wajib mendudukkan murid pada Manzilah al-Awlad (kedudukan anak kandung), menyayangi kelemahan mereka, dan menolak keras bersikap kasar."]
    A --> B2["Tinjauan Kitab Ihya 'Ulumiddin Imam Al-Ghazali:<br/>Tugas murabbi menyamai tugas orang tua bahkan lebih mulia, karena menjaga keselamatan ruhani dan fitrah santri."]
    A --> B3["Tinjauan Atsar Salafus Shalih:<br/>Imam Malik dan Sufyan Ats-Tsauri mensyaratkan kematangan adab pribadi sebelum seseorang diperkenankan mendidik generasi muda."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Musyrif asrama adalah murabbi ruhani yang memegang amanah fitrah santri, wajib memiliki standar kompetensi mutlak."]
```
...
```mermaid
flowchart TD
    subgraph AlurDeEskalasi3RTUMBUH["ALUR PROTOKOL DE-ESKALASI KRISIS 3R MUSYRIF"]
        Krisis["SANTRI MENGALAMI DISTRES EMOSI / MENGAMUK / BERKELAHI"]
        
        Step1["1. REGULATE (MENENANGKAN AMIGDALA)<br/>• Pisahkan pihak yang berselisih ke ruangan tenang.<br/>• Musyrif berbicara dengan nada suara rendah & tenang.<br/>• Minum air putih & tarik nafas dalam 4-7-8."]
        
        Step2["2. RELATE (MENGHUBUNGKAN EMPATI SISTEM LIMBIK)<br/>• Tatap mata santri dengan hangat tanpa tatapan intimidasi.<br/>• Validasi emosi santri: 'Ustadz ada di sini untuk membantumu.'<br/>• Beri waktu jeda hingga tangis/napas mereda."]
        
        Step3["3. REASON (MENGAKTIFKAN KORTEKS PREFRONTAL NALAR)<br/>• Tanyakan 5 Pertanyaan Restoratif Ishlah.<br/>• Santri menyadari dampak kesalahannya & menyepakati Restitusi 4R.<br/>• Rekonsiliasi jabat tangan ukhuwah."]
        
        Krisis --> Step1 --> Step2 --> Step3
    end
```
...
```mermaid
flowchart TD
    subgraph HakKesejahteraanMusyrifTUMBUH["PIAGAM PERLINDUNGAN KESEJAHTERAAN MUSYRIF"]
        JamKerja["1. SHIFT KERJA BERGILIR & HAK TIDUR SEHAT 7 JAM<br/>Piket jaga malam bergiliran antar-musyrif menjamin hak istirahat optimal."]
        
        LiburMingguan["2. HAK HARI LIBUR MANDIRI (1 HARI PER PEKAN)<br/>Musyrif berhak keluar dari lingkungan asrama untuk rekreasi & silaturahmi."]
        
        SupervisiKlinis["3. SUPERVISI REFLEKTIF MINGGUAN (PEER SUPPORT)<br/>Sesi curhat berkala & bedah kasus santri bersama psikolog/BK pondok."]
        
        KesejahteraanLayak["4. GAJI MEMULIAKAN & JAMINAN KESEHATAN PENUH<br/>Gaji di atas UMK, tunjangan tempat tinggal sehat, & asuransi kesehatan BPJS."]
        
        JamKerja --- LiburMingguan --- SupervisiKlinis --- KesejahteraanLayak
    end
```
