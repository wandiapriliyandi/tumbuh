...
```mermaid
flowchart TD
    subgraph TransformasiTargetKarakter["REKONSTRUKSI SISTEM TARGET CAPAIAN AKHLAK"]
        Kabur["TARGET KABUR-TRADISIONAL<br/>• 'Pokoknya santri harus taat dan shalih'.<br/>• Tidak ada rubrik perilaku terukur.<br/>• Evaluasi subjektif & rentan ketidakadilan musyrif."]
        
        TUMBUH["TARGET CAPAIAN MATINUL KHULUQ TUMBUH<br/>• Taksonomi Tri-Domain Fitrah (Kognitif, Afektif, Konatif).<br/>• Matriks capaian berjenjang J1–J4 yang jelas.<br/>• Evaluasi objektif berbasis bukti perilaku & portofolio."]
...
```mermaid
flowchart LR
    subgraph TuratsTadrijAkhlak["PENTAHAPAN TARGET MORAL DALAM TURATS"]
        Hadits["HR. Abu Dawud (Adab Shalat Santri):<br/>مُرُوا أَوْلَادَكُمْ بِالصَّلَاةِ وَهُمْ أَبْنَاءُ سَبْعٍ...<br/>(Tahap Pembiasaan Lembut -> Tahap Ketegasan Beradab)"] --> Core["Prinsip Tadrij Syar'i:<br/>Dari Ta'dib Awal Menuju Kemandirian Taklif"]
        Zarnuji["Az-Zarnuji (Ta'limul Muta'allim):<br/>Target Awal adalah Pembersihan Niat & Adab Sebaya"] --> Core
        Ghazali["Al-Ghazali (Ihya'):<br/>Riyadhah Jiwa dari Tahap Mujahadah Menuju Maqam Ridha"] --> Core
    end
```
...
```mermaid
flowchart TD
    subgraph TaksonomiTriDomainFitrah["TAKSONOMI TRI-DOMAIN FITRAH MATINUL KHULUQ"]
        Kog["1. DOMAIN KOGNITIF MORAL (MA'RIFATUL KHULUQ)<br/>• Memahami dalil syar'i tentang kejujuran, amanah, & tawadhu'.<br/>• Mampu menganalisis dilema etis & membedakan adab vs kezaliman."]
        
        Afek["2. DOMAIN AFEKTIF SPIRITUAL (SYU'URUL KHULUQ)<br/>• Merasakan keindahan adab & kelezatan berbuat adil.<br/>• Memiliki kepekaan empati terhadap perasaan teman kamar.<br/>• Merasakan rasa bersalah yang konstruktif (Nafs Lawwamah) saat khilaf."]
        
        Kona["3. DOMAIN KONATIF PERILAKU ('AMALUL KHULUQ)<br/>• Eksekusi tindakan moral secara konsisten & spontan.<br/>• Menolak ajakan maksiat & berani membela kebenaran (Upstander).<br/>• Menjadi teladan hidup (Qudwah Hasanah) bagi lingkungan."]
...
```mermaid
flowchart TD
    subgraph Arsitektur24JamAkhlak["AKSELERASI TARGET CAPAIAN DALAM RITME 24 JAM"]
        Pagi["04.00 - 07.00: RITME SPIRITUAL & ADAB PAGI<br/>• Target: Shalat berjamaah khusyuk, sapaan 5S kamar, zikir pagi."]
        
        Siang["07.00 - 15.30: RITME AKADEMIK & INTEGRITAS KELAS<br/>• Target: Kejujuran akademik, menghormati guru, kolaborasi sebaya."]
        
        Sore["15.30 - 18.00: RITME SOSIAL & KEBUGARAN SPORTIF<br/>• Target: Sportivitas olahraga, menjaga lisan, antre kamar mandi tertib."]
        
        Malam["18.00 - 22.00: RITME HALAQAH & MUHASABAH INTROSPEKSI<br/>• Target: Kajian adab kamar, penyelesaian sengketa harian, tidur tepat waktu."]
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiAdab["PROTOKOL REMEDIASI CAPAIAN ADAB TIER 2 (PBIS)"]
        Fase1["1. DIAGNOSTIK KEBUTUHAN EMOSI & PEMETAAN DEFISIT<br/>• Musyrif BK mengidentifikasi akar pemicu agresi (Triggers).<br/>• Penetapan target mikro: 'Mampu jeda 5 detik saat marah & menggunakan lisan baik'."]
        
        Fase2["2. PROGRAM CHECK-IN / CHECK-OUT (CICO) HARIAN<br/>• Santri D memegang kartu refleksi mandiri 3 target adab.<br/>• Mentoring 5 menit setiap pagi & malam bersama Musyrif."]
        
        Fase3["3. LATIHAN DIDAKTIK REGULASI DIRI (EMOTION REGULATION TRAINING)<br/>• Pembelajaran teknik pernapasan relaksasi, wudhu saat marah, & restrukturisasi kognitif."]
        
        Fase4["4. EVALUASI DAN GRADUASI REMEDIASI (30 HARI)<br/>• Pengukuran kemajuan skor rubrik adab lisan.<br/>• Apresiasi keberhasilan & pengembalian ke status pembinaan universal Tier 1."]
...
```mermaid
flowchart TD
    subgraph StrukturCapaianMatinulKhuluq["STRUKTUR TARGET CAPAIAN PEMBELAJARAN (CP-MK)"]
        CP["CAPAIAN PEMBELAJARAN INDUK MATINUL KHULUQ"]
        
        TP1["Target Pilar 1: Shidq (Kejujuran Autentik)<br/>• 0% Toleransi Plagiasi & Kebohongan.<br/>• Kejujuran dalam Kondisi Kritis."]
        
        TP2["Target Pilar 2: Tawadhu' (Kerendahan Hati)<br/>• Eliminasi Bullying & Sarkasme.<br/>• Penghormatan Inklusif Seluruh Santri."]
        
        TP3["Target Pilar 3: Syaja'ah (Keberanian Moral)<br/>• Kemampuan Resisting Peer Pressure.<br/>• Sikap Upstander Membela Korban."]
        
        TP4["Target Pilar 4: Amanah (Tanggung Jawab Sosial)<br/>• Nol Kasus Ghashab & Kerusakan Sarana.<br/>• Akuntabilitas Tugas Kepengurusan."]
...
```mermaid
flowchart LR
    subgraph TargetProgresiJenjang["PETA TARGET CAPAIAN LINTAS JENJANG J1–J4"]
        J1["J1 (KELAS 7): ADAPTASI ADAB DASAR<br/>Target: Mematuhi adab kamar, disiplin 5S, bebas ghashab, mandiri merawat barang pribadi."]
        --> J2["J2 (KELAS 8–9): REGULASI & EMPATI SEBAYA<br/>Target: Mengontrol lisan saat marah, kolaborasi tim asrama, meminta maaf secara jantan."]
        --> J3["J3 (KELAS 10–11): INTEGRITAS & KEBERANIAN MORAL<br/>Target: Kejujuran akademik mutlak, Upstander anti-bullying, panitia acara transparan."]
        --> J4["J4 (KELAS 12): KEPEMIMPINAN QUDWAH<br/>Target: Menjadi role model akhlak pesantren, mentor adik kelas, mediator damai asrama."]
    end
```
...
Penerapan konsep **P3-06-03: TUJUAN DAN TARGET CAPAIAN MATINUL KHULUQ** di ekosistem pesantren TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
