...
```mermaid
flowchart TD
    subgraph TransformasiModelHalaqah["REKONSTRUKSI MODEL HALAQAH ASRAMA"]
        Monolog["HALAQAH MONOLOG TRADISIONAL<br/>• Musyrif mendominasi bicara (One-Way Lecture).<br/>• Santri pasif, mengantuk, & bosan.<br/>• Materi teoritis tanpa aksi nyata di asrama."]
        
        TUMBUH["HALAQAH ADAB DIALOGIS TUMBUH<br/>• Dialog Sokrates & analisis studi kasus dilema etika.<br/>• Santri aktif berdiskusi & berbagi refleksi emosi.<br/>• Menghasilkan komitmen target adab terukur (CICO)."]
        
        Monolog ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsHiwarNabawi["METODE DIALOGIS NABAWI DALAM HALAQAH"]
        HaditsMuflis["HR. Muslim No. 2581:<br/>أَتَدْرُونَ مَا الْمُفْلِسُ؟...<br/>(Metode Pertanyaan Pemantik: Tahukah Kalian Siapa Orang Bangkrut?)"] --> Inti["Al-Hiwar at-Tarbawiy:<br/>Membangkitkan Nalar Kritis & Internalisasi Nilai Moral"]
        HaditsSyajarah["HR. Al-Bukhari No. 61:<br/>Kisah Pohon yang Menyerupai Orang Beriman<br/>(Simulasi Pemecahan Masalah)"] --> Inti
        Zarnuji["Az-Zarnuji (Ta'lim):<br/>Mudzakarah & Munazharah Sebagai Kunci Ilmu"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsKonstruktivismeHalaqah["SINTESIS TEORI PEMBELAJARAN SOSIAL"]
        Vygotsky["Zone of Proximal Development (ZPD) Vygotsky:<br/>• Pembelajaran terjadi melalui interaksi sosial terfasilitasi.<br/>• Scaffolding: Musyrif membimbing santri mencapai kematangan moral."]
        
        Socratic["Socratic Questioning (Paul & Elder):<br/>• Pertanyaan klarifikasi, asumsi dasar, & konsekuensi etis.<br/>• Melatih pertimbangan moral tingkat tinggi (Post-Conventional)."]
        
        CASEL["CASEL SEL Community Circles:<br/>• Ruang aman berbagi emosi & penyelesaian konflik sebaya."]
        
        Vygotsky & Socratic & CASEL ==> HalaqahModel["MODEL HALAQAH MATINUL KHULUQ TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph DinamikaSosialHalaqah["TRANSFORMASI IKLIM SOSIAL KAMAR ASRAMA"]
        TahapA["1. TAHAP PEMBENTUKAN (FORMING):<br/>Membangun rasa aman & kesepakatan norma lingkar adab."]
        TahapB["2. TAHAP TURBULENSI (STORMING):<br/>Membongkar konflik terselubung kamar melalui dialog jujur."]
        TahapC["3. TAHAP PENETAPAN NORMA (NORMING):<br/>Menyepakati piagam ukhuwah kamar (anti-ghashab & saling mengasihi)."]
        TahapD["4. TAHAP KINERJA KOKOH (PERFORMING):<br/>Kamar menjadi lingkungan mandiri, beradab, & saling menjaga."]
...
```mermaid
flowchart TD
    subgraph ProtokolRevitalisasiHalaqah["PROTOKOL REVITALISASI HALAQAH DIALOGIS"]
        Step1["1. UBAH TATA RUANG & ATRIBUT FORUM<br/>• Duduk melingkar di atas karpet bersih; sediakan minuman hangat/snack ringan.<br/>• Musyrif duduk setara tanpa kursi tinggi."]
        
        Step2["2. BUKA DENGAN CHECK-IN EMOSI (EMOTION WEATHER CHECK)<br/>• Setiap santri memilih satu kata cuaca yang menggambarkan perasaannya hari ini."]
        
        Step3["3. GUNAKAN SKENARIO DILEMA ETIS PIHAK KETIGA (NON-PERSONAL)<br/>• Menampilkan video/cerita fiktif dilema moral santri di pondok lain.<br/>• Santri bebas berpendapat tanpa takut dihakimi kesalahannya sendiri."]
        
        Step4["4. REFLEKSI TERTULIS ANONIM & KOMITMEN UKHUWAH<br/>• Santri menuliskan harapan perbaikan kamar pada kartu kertas warna-warni."]
...
```mermaid
flowchart TD
    subgraph KurikulumHalaqah24Pekan["STRUKTUR 4 MODUL KURIKULUM HALAQAH MATINUL KHULUQ"]
        M1["MODUL 1 (PEKAN 1–6): FONDASI KEJUJURAN & INTEGRITAS (ASH-SHIDQ)<br/>• Sesi 1: Menyelaraskan Niat & Menghilangkan Riya'<br/>• Sesi 2: Bahaya Dusta & Dusta Terselubung (Pemberian Alasan Palsu)<br/>• Sesi 3: Kejujuran Akademik & Bahaya Plagiasi/Menyontek<br/>• Sesi 4: Menepati Janji & Disiplin Waktu<br/>• Sesi 5: Keberanian Mengakui Khilaf Pribadi<br/>• Sesi 6: Evaluasi Formatif & Muhasabah Kejujuran"]
        
        M2["MODUL 2 (PEKAN 7–12): KESANTUNAN & ANTI-AROGANSI (AT-TAWADHU')<br/>• Sesi 7: Memuliakan Guru & Adab Bertanya<br/>• Sesi 8: Mengasihi Santri Junior & Menghilangkan Feodalisme<br/>• Sesi 9: Adab Berbicara & Eliminasi Julukan Buruk (Al-Alqab)<br/>• Sesi 10: Mengendalikan Amarah & Seni Mendengarkan Aktif<br/>• Sesi 11: Kerendahan Hati dalam Menerima Kritik<br/>• Sesi 12: Lingkar Restoratif Kamar & Evaluasi Tawadhu'"]
        
        M3["MODUL 3 (PEKAN 13–18): KEBERANIAN MORAL & PENOLAKAN KEZALIMAN (ASY-SYAJA'AH)<br/>• Sesi 13: Berani Berkata Tidak pada Ajakan Maksiat Sebaya<br/>• Sesi 14: Menjadi Upstander Pelindung Kawan yang Dibully<br/>• Sesi 15: Bahaya Menjadi Penonton Pasif (Bystander Effect)<br/>• Sesi 16: Keberanian Menyampaikan Kebenaran Secara Santun<br/>• Sesi 17: Ksatria Meminta Maaf & Memulihkan Dampak Kesalahan<br/>• Sesi 18: Simulasi Role-Playing Mediasi Damai Sengketa"]
        
        M4["MODUL 4 (PEKAN 19–24): AMANAH SOSIAL & KHIDMAH UMMAH (AL-AMANAH)<br/>• Sesi 19: Menjaga Hak Milik Kawan & Eliminasi Ghashab Total<br/>• Sesi 20: Merawat Fasilitas Umum Asrama (Sense of Ownership)<br/>• Sesi 21: Transparansi Pengelolaan Kas Organisasi Santri<br/>• Sesi 22: Servant Leadership: Memimpin dengan Melayani<br/>• Sesi 23: Portofolio Proyek Kebaikan Kamar (Social Action Project)<br/>• Sesi 24: Refleksi Tahunan & Upacara Transisi Kematangan Adab"]
...
```mermaid
flowchart LR
    subgraph StrukturSesiHalaqah["STRUKTUR SESI HALAQAH ADAB 60 MENIT"]
        T1["1. PEMBUKA (10 Menit)<br/>• Doa, Tilawah Khusyuk, & Check-In Emosi Santri."]
        --> T2["2. DIALOG KASUS (25 Menit)<br/>• Pemaparan Nash Turats & Analisis Dilema Etika."]
        --> T3["3. REFLEKSI BATIN (15 Menit)<br/>• Sesi Silent Muhasabah & Penulisan Jurnal Pribadi."]
        --> T4["4. AKSI NYATA (10 Menit)<br/>• Menyepakati Target Perilaku Sepekan (CICO Commitment)."]
    end
```
...
```mermaid
flowchart TD
    subgraph SistemKakakAsuh["SISTEM MENTORSHIP SEBAYA KAKAK ASUH J4–J1"]
        Penetapan["1. PENETAPAN PASANGAN ASUH (1 Santri J4 mendampingi 2 Santri J1)"]
        Pelatihan["2. PELATIHAN MENTOR J4: Keterampilan Mendengarkan Aktif & Pengasuhan Tanpa Kekerasan"]
        Rutinitas["3. AGENDA MINGGUAN KAKAK ASUH:<br/>• Makan Siang Bersama Sepekan Sekali (Nampan Ukhuwah).<br/>• Bimbingan Baca Al-Qur'an & Belajar Malam.<br/>• Mendengarkan Curahan Hati Homesickness Santri J1."]
        Evaluasi["4. SUPERVISI MUSYRIF: Evaluasi Berkala Peran Mentor J4"]
        
        Penetapan --> Pelatihan --> Rutinitas --> Evaluasi
    end
```
...
Penerapan konsep **P3-06-11: PROGRAM PEMBINAAN DAN HALAQAH MATINUL KHULUQ** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
