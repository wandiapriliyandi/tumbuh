...
```mermaid
flowchart TD
    subgraph RekonstruksiSistemDisiplin["REKONSTRUKSI PARADIGMA DISIPLIN ASRAMA"]
        Punitif["DISIPLIN PUNITIF TRADISIONAL<br/>• Rotan, push-up, digundul, & caci maki publik.<br/>• Memicu hormon kortisol & trauma batin.<br/>• Menghasilkan kepatuhan semu & daur ulang kekerasan."]
        
        TUMBUH["DISIPLIN RESTORATIF PBIS TUMBUH<br/>• Intervensi berjenjang berbasis data (Tier 1-2-3).<br/>• Pendekatan Firm & Kind dengan restitusi adab bermakna.<br/>• Membentuk karakter otonom & ukhuwah yang kokoh."]
        
        Punitif ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsTarbiyahNabawiyyah["METODOLOGI KASIH SAYANG & RESTORATIF NABAWI"]
        HaditsRifq["HR. Muslim No. 2593:<br/>إِنَّ الرِّفْقَ لَا يَكُونُ فِي شَيْءٍ إِلَّا زَانَهُ...<br/>(Kelembutan Menghiasi Segala Sesuatu & Kekasaran Merusaknya)"] --> Inti["Prinsip Ishlah Adabi:<br/>Mendidik Jiwa Tanpa Merendahkan Martabat Insan"]
        HaditsMu'awiyah["HR. Muslim No. 537:<br/>Kisah Mu'awiyah bin Al-Hakam Berbicara saat Shalat<br/>'Demi Allah, aku tidak pernah melihat pendidik yang lebih baik dari beliau'"] --> Inti
        Syathibi["Asy-Syathibi (Al-I'tisham):<br/>Kemudahan Syariat dalam Mendidik Ummat"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph NeurosainsDisiplinPositif["DAMPAK NEUROBIOLOGIS PENDEKATAN PENGASUHAN"]
        Kekerasan["HUKUMAN FISIK & BENTAKAN (PUNITIF):<br/>• Lonjakan Hormon Kortisol & Adrenalin secara kronis.<br/>• Pembajakan Amygdala (Fight-or-Flight Hijacking).<br/>• Penurunan Volume Gray Matter di Prefrontal Cortex.<br/>• Akibat: Gangguan belajar, agresi meningkat, & trauma batin."]
        
        PBIS["PENDEKATAN POSITIF RESTORATIF (FIRM & KIND):<br/>• Pelepasan Hormon Oksitosin & Dopamin (Rasa Aman).<br/>• Aktivasi Ventromedial Prefrontal Cortex (vmPFC).<br/>• Stimulasi Neuroplastisitas Pembiasaan Karakter Positif.<br/>• Hasil: Ketenangan batin, refleksi mandiri, & integritas otonom."]
...
```mermaid
flowchart TD
    subgraph AlurPembiasaan24Jam["SIKLUS PEMBIASAAN ADAB ASRAMA 24 JAM"]
        Cues["1. VISUAL & VERBAL CUES (PANDUAN JELAS)<br/>• Poster panduan adab di setiap setting asrama.<br/>• Ekspektasi perilaku diucapkan musyrif dengan jelas."]
        
        Rutinitas["2. STRUCTURED DAILY ROUTINES (RITME TERATUR)<br/>• Rutinitas pagi, halaqah, olahraga, hingga jam tidur.<br/>• Menghilangkan waktu kosong tanpa arah (Idle Time)."]
        
        Apresiasi["3. REINFORCEMENT RATIO 4:1 (APRESIASI DOMINAN)<br/>• Musyrif aktif memberikan apresiasi verbal/badge untuk santri beradab.<br/>• Umpan balik korektif disampaikan secara privat & empatik."]
        
        Refleksi["4. RESTORATIVE REFLECTION (MUHASABAH MALAM)<br/>• 5 menit refleksi kamar tidur sebelum lampu dipadamkan.<br/>• Evaluasi kartu target harian (CICO)."]
        
        Cues --> Rutinitas --> Apresiasi --> Refleksi --> Cues
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolIntervensiTier3Agresi["PROTOKOL RESTORATIF INTENSIF TIER 3"]
        F1["1. PERTOLONGAN PERTAMA & PENGAMANAN LINGKUNGAN<br/>• Tim Medis merawat memar Santri Y; Musyrif mengamankan Santri J ke ruang tenang."]
        
        F2["2. FUNCTIONAL BEHAVIOR ASSESSMENT (FBA) GABUNGAN<br/>• Musyrif BK melakukan asesmen pemicu emosi Santri J & wawancara saksi."]
        
        F3["3. KONFERENSI RESTORATIF KOMUNITAS ASRAMA<br/>• Forum mediasi terfasilitasi: Santri J, Santri Y, Musyrif, dan Wali Santri.<br/>• Santri J mendengarkan dampak luka fisik & rasa takut yang dialami Santri Y.<br/>• Santri J mengakui kesalahan secara kesatria & meminta maaf tulus."]
        
        F4["4. KESEPAKATAN KONTRAK RESTITUSI ADAB (REPARATION PLAN)<br/>• Santri J mengganti biaya pengobatan & membuat karya tulis tentang bahaya amarah.<br/>• Santri J bertugas piket kebersihan area kamar mandi selama 14 hari."]
        
        F5["5. MONITORING BIP & PELATIHAN ANGER MANAGEMENT (30 HARI)<br/>• Sesi bimbingan konseling regulasi emosi 2x sepekan bersama Musyrif BK."]
...
```mermaid
flowchart TD
    subgraph PiramidaMultiTierPBIS["SISTEM INTERVENSI BERJENJANG PBIS MULTI-TIER"]
        Tier3["TIER 3: INTENSIVE RESTORATIVE INTERVENTION (1–5% Santri)<br/>• Functional Behavior Assessment (FBA)<br/>• Behavior Intervention Plan (BIP) Individual<br/>• Konferensi Restoratif Keluarga & Komunitas"]
        
        Tier2["TIER 2: TARGETED INTERVENTION (10–15% Santri)<br/>• Program Check-In / Check-Out (CICO) Harian<br/>• Social Skills & Anger Management Groups<br/>• Mentorship Intensif Santri Jenjang J4"]
        
        Tier1["TIER 1: UNIVERSAL PREVENTION (100% Santri)<br/>• Pengajaran Eksplisit Matriks Adab Seluruh Setting<br/>• Rasio Penguatan Apresiasi Positif 4:1<br/>• Halaqah Adab Tematik & Rutinitas 24 Jam Terstruktur"]
...
```mermaid
flowchart LR
    A["1. Identifikasi Perilaku Target<br/>(Deskripsi spesifik & operasional)"]
    --> B["2. Pengumpulan Data A-B-C<br/>(Waktu, lokasi, pemicu, konsekuensi)"]
    --> C["3. Formulasi Hipotesis Fungsi<br/>(Mencari perhatian / Menghindar)"]
    --> D["4. Desain Perilaku Pengganti (BIP)<br/>(Keterampilan adab pengganti)"]
    --> E["5. Monitoring & Evaluasi 14 Hari<br/>(Penyesuaian strategi berbasis data)"]
```
...
Penerapan konsep **P3-06-10: PROTOKOL INTERVENSI DAN PEMBIASAAN MATINUL KHULUQ** di ekosistem pesantren TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
