...
```mermaid
graph TD
    Domain["3 Domain Kompetensi Matinul Khuluq"]
    
    Domain --> K1["1. Kompetensi Kognitif ('Aqliyyah)<br/>- Memahami adab pergaulan islami, bahaya ghibah/namimah & hak-hak ukhuwah.<br/>- Mengetahui prinsip resolusi konflik damai & langkah-langkah Ishlah."]
    
    Domain --> K2["2. Kompetensi Afektif (Qalbiyyah)<br/>- Menumbuhkan empati mendalam terhadap kesedihan & kesulitan teman.<br/>- Memiliki kepekaan batin (Haya') untuk menjauhi perbuatan tercela."]
    
    Domain --> K3["3. Kompetensi Sosial-Perilaku (Amaliyyah)<br/>- Menggunakan bahasa santun (5S) dalam seluruh interaksi harian.<br/>- Menolak intimidasi senioritas & bersikap adil dalam kehidupan komunal."]
```
