...
```mermaid
flowchart TD
    subgraph RekonstruksiTaksonomiAkhlak["REKONSTRUKSI TAKSONOMI KOMPETENSI ADAB"]
        Sekuler["TAKSONOMI KOGNITIF KERING (BLOOM SEPARATIF)<br/>• Evaluasi berbasis ujian tertulis (Pencil-and-Paper Test).<br/>• Akhlak direduksi menjadi hafalan teori etika.<br/>• Kegagalan memantau integritas privat santri."]
        
        TUMBUH["TAKSONOMI ADAB FITRAH TUMBUH (HOLISTIK)<br/>• Integrasi Cermin Fitrah: Kognisi, Afeksi, & Tindakan 24 Jam.<br/>• Gradasi 4 Level Kematangan Moral (Ta'allum -> Qudwah).<br/>• Asesmen Otentik Formatif & Triangulasi Lapangan PBIS."]
        
        Sekuler ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMaratibTarbiyah["HIERARKI TAZKIYAH & ADAB DALAM TURATS"]
        IbnKhaldun["Ibnu Khaldun (Muqaddimah):<br/>Pembiasaan Adab Lahiriah (Malakah)<br/>Mendahului Pengajaran Teori Kognitif"] --> Inti["Taksonomi Adab Fitrah:<br/>Dari Malakah Dasar Menuju Maqam Insan Adabi"]
        Ghazali["Al-Ghazali (Ihya'):<br/>Tadrij Nafs: Amarah -> Lawwamah -> Muthma'innah"] --> Inti
        Mawardi["Al-Mawardi (Adab Dunya):<br/>Riyadhah Adab dari Taqleed Menuju Bashirah"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph KonvergensiTaksonomiModern["SINTESIS TAKSONOMI PENDIDIKAN MULTIDIMENSI"]
        Krathwohl["Taksonomi Afektif Krathwohl:<br/>Receiving -> Responding -> Valuing -> Organization -> Characterization"]
        Marzano["Taksonomi Marzano:<br/>Retrieval -> Comprehension -> Analysis -> Knowledge Utilization -> Self-System"]
        Fitrah["Taksonomi Fitrah TUMBUH:<br/>1. Ta'allum (Perintisan)<br/>2. Tafahum (Regulasi Diri)<br/>3. Ta'awun (Integritas Otonom)<br/>4. Qudwah (Keteladanan Paripurna)"]
        
        Krathwohl & Marzano ==> Fitrah
    end
```
...
```mermaid
flowchart TD
    subgraph KurikulumTerintegrasi24Jam["TRIAD RUANG BELAJAR MATINUL KHULUQ 24 JAM"]
        Kelas["RUANG KELAS / MADRASAH<br/>• Kompetensi: Kejujuran akademik, adab diskusi santun, menghormati guru, kolaborasi tugas."]
        Masjid["RUANG MASJID / HALAQAH<br/>• Kompetensi: Kekhusyukan ibadah, tawadhu', adab tilawah, mendengarkan nasehat."]
        Asrama["RUANG ASRAMA / KAMAR TIDUR<br/>• Kompetensi: Anti-ghashab, kebersihan bersama, empati teman sekamar, toleransi."]
...
```mermaid
flowchart TD
    subgraph ProtokolAkselerasiTaksonomi["PROTOKOL INTERVENSI PROGRESI MORAL LEVEL 3"]
        TahapA["1. SESI SOCRATIC DIALOGUE (BEDAH DILEMA MORAL)<br/>• Guru & Musyrif membedah hadits 'Melihat Kemungkaran' (HR. Muslim).<br/>• Menyadarkan bahwa diam terhadap kezaliman adalah kelemahan iman."]
        
        TahapB["2. PELATIHAN ASERTIVITAS SOSIAL (SOCIAL ASSERTIVENESS TRAINING)<br/>• Latihan role-playing teknik intervensi aman (Bystander Intervention).<br/>• Belajar cara mengalihkan perhatian pelaku atau melapor secara rahasia."]
        
        TahapC["3. PENUGASAN MENTORING ADIK ASRAMA<br/>• Santri K diberi amanah resmi mendampingi 2 santri baru J1.<br/>• Membangun rasa kepemilikan (Sense of Ownership) dan tanggung jawab proteksi."]
        
        TahapA --> TahapB --> TahapC
    end
```
...
```mermaid
flowchart TD
    subgraph HierarkiTaksonomiFitrah["EMPAT LEVEL TAKSONOMI ADAB FITRAH MATINUL KHULUQ"]
        L4["LEVEL 4: IHSAN & QUDWAH HASANAH (KETELADANAN PARIPURNA)<br/>• Akhlak menjadi karakter alami (Malakah Rasikhah).<br/>• Menjadi teladan hidup & pembimbing kasih sayang bagi lingkungan."]
        
        L3["LEVEL 3: INTERNALISASI & ASY-SYAJA'AH (INTEGRITAS OTONOM)<br/>• Menjaga adab secara mandiri di ruang sepi.<br/>• Berani menolak tekanan buruk sebaya & membela yang tertindas (Upstander)."]
        
        L2["LEVEL 2: HABITUASI & TAFAHUM (REGULASI EMOSI SEBAYA)<br/>• Melatih pengendalian amarah & lisan saat terjadi konflik.<br/>• Membiasakan 5S & berbagi fasilitas kamar tanpa ghashab."]
        
        L1["LEVEL 1: TA'ALLUM & IMTITSAL (PENGENALAN & KEPATUHAN AWAL)<br/>• Mengenal batasan halal-haram adab pergaulan.<br/>• Mematuhi aturan tata tertib asrama di bawah panduan musyrif."]
...
| :--- | :--- | :--- |
| **Pilar 1: Ash-Shidq (Kejujuran)** | **SKD-MK-1.1**<br/>**SKD-MK-1.2**<br/>**SKD-MK-1.3** | Menampilkan konsistensi kejujuran lisan dalam pelaporan kegiatan harian.<br/>Menjunjung tinggi kejujuran akademik (anti-menyontek & anti-plagiasi tugas).<br/>Berani mengakui kesalahan pribadi secara tulus tanpa mencari kambing hitam. |
| **Pilar 2: At-Tawadhu' (Rendah Hati)** | **SKD-MK-2.1**<br/>**SKD-MK-2.2**<br/>**SKD-MK-2.3** | Membiasakan budaya 5S (Senyum, Salam, Sapa, Sopan, Santun) kepada seluruh warga pondok.<br/>Mengeliminasi segala bentuk cemoohan, julukan buruk (*Al-Alqab*), dan sarkasme.<br/>Menghormati keragaman latar belakang santri serta menerima kritik musyawarah. |
| **Pilar 3: Asy-Syaja'ah (Keberanian)** | **SKD-MK-3.1**<br/>**SKD-MK-3.2**<br/>**SKD-MK-3.3** | Menolak dengan tegas ajakan melanggar aturan tata tertib asrama dari teman sebaya.<br/>Mengambil tindakan proaktif (*Upstander*) saat melihat ketidakadilan/perundungan.<br/>Meminta maaf secara jantan dan berinisiatif melakukan restitusi adab. |
| **Pilar 4: Al-Amanah (Tanggung Jawab)** | **SKD-MK-4.1**<br/>**SKD-MK-4.2**<br/>**SKD-MK-4.3** | Menjaga perlengkapan pribadi dan menolak mutlak perilaku *ghashab* barang kawan.<br/>Merawat sarana dan prasarana umum pesantren (kamar mandi, ranjang, perpustakaan).<br/>Menjalankan amanah kepengurusan organisasi santri secara transparan dan akuntabel. |
...
Penerapan konsep **P3-06-05: STANDAR KOMPETENSI DAN TAKSONOMI MATINUL KHULUQ** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
