...
```mermaid
flowchart TD
    subgraph TransformasiParadigmaAkhlak["REKONSTRUKSI PARADIGMA PENGASUHAN AKHLAK PESANTREN"]
        Feodal["PARADIGMA KEPATUHAN FEODAL (PUNITIF)<br/>• Kepatuhan lahiriah berbasis rasa takut (Fear-Driven).<br/>• Feodalisme senioritas & perpeloncoan kamar asrama.<br/>• Hukuman fisik & rasa malu di muka umum (Toxic Shame).<br/>• Hasil: Moralitas terbelah & lingkaran kekerasan berulang."]
        
        TUMBUH["PARADIGMA MATINUL KHULUQ TUMBUH (RESTORATIF)<br/>• Disposisi batin otonom berbasis cinta fitrah (Love & Ihsan).<br/>• Kesetaraan ukhuwah & perlindungan martabat seluruh santri.<br/>• Disiplin Restoratif: Restitusi adab, refleksi, & reintegrasi.<br/>• Hasil: Integritas moral kokoh di ruang ramai maupun privat."]
        
        Feodal ==>|DITRANSFORMASIKAN MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph FondasiTuratsAkhlak["AKAR EPISTEMOLOGIS TURATS MATINUL KHULUQ"]
        A["QS. Al-Qalam: 4<br/>وَإِنَّكَ لَعَلَىٰ خُلُقٍ عَظِيمٍ<br/>(Pujian Keagungan Akhlak Nabawi)"] --> D["Hakikat Matinul Khuluq:<br/>Kapasitas Batin Kokoh, Seimbang, & Mengalir Lembut"]
        B["HR. Ahmad & Al-Bukhari<br/>إِنَّمَا بُعِثْتُ لِأُتَمِّمَ صَالِحَ الْأَخْلَاقِ<br/>(Misi Tunggal Kerasulan)"] --> D
        C["Ihya' 'Ulumiddin (Al-Ghazali)<br/>Riyadhatun Nafs: Keseimbangan<br/>Hikmah, Syaja'ah, 'Iffah, & 'Adalah"] --> D
    end
```
...
```mermaid
flowchart TD
    subgraph NeurosainsKarakter["INTEGRASI NEUROSAINS DAN CASEL SOCIAL EMOTIONAL LEARNING"]
        MN["Mirror Neuron System (MNS)<br/>• Membaca emosi & resonansi afektif sesama.<br/>• Basis empati biologis peneladanan Qudwah."]
        
        VMPFC["Ventromedial Prefrontal Cortex (vmPFC)<br/>• Regulasi penilaian moral & integritas etis.<br/>• Menjembatani dorongan emosi & prinsip adab."]
        
        CASEL["CASEL SEL Framework:<br/>1. Social Awareness (Empati & Penghormatan)<br/>2. Relationship Skills (Komunikasi Positif & Resolusi Konflik)<br/>3. Responsible Decision-Making (Pertimbangan Etis)"]
        
        MN & VMPFC ==> CASEL ==> Akhlak["MATINUL KHULUQ:<br/>Kapasitas Moral Otonom & Kehangatan Relasi Santri"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaLingkunganAsrama["REKAYASA LINGKUNGAN ASRAMA BEBAS BULLYING"]
        ZonaRawan["IDENTIFIKASI TITIK BUTA (HOTSPOTS):<br/>• Kamar mandi asrama & jemuran belakang.<br/>• Lorong lantai atas pasca-jam malam.<br/>• Ruang organisasi tanpa pengawasan musyrif."]
        
        IntervensiFisik["REKAYASA SPASIAL & PENGAWASAN AKTIF:<br/>• Desain pencahayaan terang & layout terbuka.<br/>• Active Supervision: Musyrif hadir berkeliling secara berkala.<br/>• Hilangkan kamar eksklusif pengurus senior."]
        
        KulturUkhuwah["REKAYASA IKLIM SOSIAL (UKHUWAH):<br/>• Sistem Kakak Asuh Terbina (Peer Mentoring Tanpa Perpeloncoan).<br/>• Tradisi makan berjamaah (Nampan Ukhuwah).<br/>• Forum Lingkar Restoratif Mingguan."]
        
        ZonaRawan ==> IntervensiFisik ==> KulturUkhuwah
    end
```
...
```mermaid
flowchart TD
    subgraph AlurRestoratifAkhlak["PROTOKOL LINGKAR RESTORATIF SENGKETA ADAB (ISYHAD ADABI)"]
        Tahap1["1. PRA-KONFERENSI INDIVIDUAL<br/>• Musyrif memanggil Santri A & B: Dialog kesadaran empati, dampak luka batin teman.<br/>• Musyrif memanggil Santri F: Memberikan ruang aman & validasi emosi."]
        
        Tahap2["2. LINGKAR RESTORATIF TERFASILITASI (RESTORATIVE CIRCLE)<br/>• Mempertemukan para pihak dalam suasana tenang & terhormat.<br/>• Santri F menyampaikan perasaannya tanpa rasa takut.<br/>• Santri A & B mendengarkan secara aktif & mengakui kesalahan adab lisan."]
        
        Tahap3["3. KESEPAKATAN RESTITUSI ADAB (ISHLAH AL-BAIN)<br/>• Pelaku meminta maaf tulus secara spesifik.<br/>• Menyusun tindakan perbaikan nyata: Menemani Santri F belajar bersama & membela teman jika ada yang mengejek."]
        
        Tahap4["4. MONITORING DAN REINTEGRASI KAMAR<br/>• Evaluasi harian oleh Musyrif selama 14 hari.<br/>• Penguatan ukhuwah kamar melalui proyek kebersihan bersama."]
...
```mermaid
flowchart TD
    subgraph ArsitekturMatinulKhuluq["EMPAT PILAR DIMENSI KARAKTER MATINUL KHULUQ"]
        P1["PILAR 1: SHIDQUL LISAN WAL QALB (KEJUJURAN INTEGRAL)<br/>• Keselarasan antara ucapan, tindakan, dan niat batin.<br/>• Anti-plagiasi, tidak berdusta, & menepati janji syar'i."]
        
        P2["PILAR 2: TAWADHU' WA HUSNUL MU'AMALAH (KERENDAHAN HATI & KESANTUNAN)<br/>• Bebas dari rasa sombong (Kibr), meremehkan orang lain, & feodalisme.<br/>• Berbicara lembut, murah senyum, memuliakan yang tua & mengasihi yang muda."]
        
        P3["PILAR 3: ASY-SYAJA'AH AL-ADABIYYAH (KEBERANIAN MORAL PRO-SOSIAL)<br/>• Berani membela kebenaran & menolak ajakan maksiat sebaya.<br/>• Berani mengakui kesalahan & membela kawan yang terzalimi."]
        
        P4["PILAR 4: AMANAH WA MAS'ULIYYAH (TANGGUNG JAWAB & AKUNTABILITAS SOSIAL)<br/>• Menjaga barang titipan, fasilitas umum pondok, & hak milik bersama.<br/>• Memenuhi amanah kepengurusan tanpa manipulasi."]
        
        P1 & P2 & P3 & P4 ==> Output["INSAN ADABI BERAKHLAK KOKOH (MATINUL KHULUQ)"]
    end
```
...
```mermaid
flowchart LR
    J1["JENJANG J1 (KELAS 7)<br/>Fase Ta'aruf & Adaptasi Adab Dasar<br/>• Habituasi 5S (Senyum, Salam, Sapa, Sopan, Santun).<br/>• Menghargai privasi kawan kamar."]
    --> J2["JENJANG J2 (KELAS 8–9)<br/>Fase Tafahum & Regulasi Empati Sebaya<br/>• Pengendalian lisan dari ghibah & ejekan.<br/>• Kolaborasi tugas asrama tanpa ghashab."]
    --> J3["JENJANG J3 (KELAS 10–11)<br/>Fase Ta'awun & Keberanian Moral<br/>• Menjadi agen pencegah perundungan (Upstander).<br/>• Menegakkan kejujuran akademik mandiri."]
    --> J4["JENJANG J4 (KELAS 12)<br/>Fase Takaful & Keteladanan Qudwah<br/>• Membimbing adik kelas dengan kasih sayang.<br/>• Kepemimpinan pelayan berwibawa (Servant Leader)."]
```
...
```mermaid
flowchart TD
    subgraph MultiTierPBISAkhlak["ARSITEKTUR MULTI-TIER PBIS UNTUK MATINUL KHULUQ"]
        Tier1["TIER 1: UNIVERSAL PREVENTION (100% SANTRI)<br/>• Matriks Ekspektasi Perilaku di Seluruh Setting Asrama (Kamar, Masjid, Dapur).<br/>• Pengajaran Adab Eksplisit dalam Halaqah Mingguan.<br/>• Sistem Apresiasi Positif: Pengakuan Karakter 'Santri Beradab Minggu Ini'."]
        
        Tier2["TIER 2: TARGETED INTERVENTION (10–15% SANTRI BERISIKO)<br/>• Check-In / Check-Out (CICO) Harian bersama Musyrif Pembimbing.<br/>• Kelompok Bimbingan Keterampilan Sosial & Regulasi Amarah (Social Skills Group).<br/>• Peer Mentoring intensif bersama santri jenjang J4."]
        
        Tier3["TIER 3: INTENSIVE RESTORATIVE INTERVENTION (1–5% SANTRI KASUS KHUSUS)<br/>• Functional Behavior Assessment (FBA) komprehensif oleh Tim Gabungan BK-Musyrif.<br/>• Rencana Dukungan Perilaku Individual (Behavior Intervention Plan - BIP).<br/>• Konferensi Restoratif Keluarga & Kontrak Restitusi Adab Terstruktur."]
