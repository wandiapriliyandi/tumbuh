...
```mermaid
flowchart TD
    subgraph TransformasiDidaktikAkhlak["REKONSTRUKSI METODE PENGAJARAN ADAB"]
        Pasif["DIDAKTIK HAFALAN PASIF TRADISIONAL<br/>• Transfer teks satu arah tanpa diskusi dilema.<br/>• Santri hafal dalil namun bingung bertindak.<br/>• Pembelajaran membosankan & minim relevansi."]
        
        TUMBUH["DIDAKTIK TRANSFORMATIF TUMBUH<br/>• Analisis Dilema Moral Syar'i & Simulasi Sosiodrama.<br/>• Pembelajaran Berbasis Pengalaman 24 Jam.<br/>• Pendidik sebagai figur Qudwah Hasanah hidup."]
...
```mermaid
flowchart LR
    subgraph TuratsMetodologiNabawiy["METODE DIDAKTIK NABAWI DALAM PENGAJARAN ADAB"]
        Amtsal["HR. Al-Bukhari & Muslim:<br/>مَثَلُ الْجَلِيسِ الصَّالِحِ وَالسَّوْءِ كَحَامِلِ الْمِسْكِ وَنَافِخِ الْكِيرِ<br/>(Metode Analogi Visual Penjual Minyak Wangi vs Pande Besi)"] --> Inti["Didaktik Transformatif:<br/>Menyajikan Konsep Abstrak Menjadi Realitas yang Hidup"]
        Kisah["HR. Al-Bukhari (Kisah 3 Orang Terjebak di Gua):<br/>Pembelajaran Nilai Berbasis Narasi Transformatif"] --> Inti
        Ghazali["Al-Ghazali (Ayyuhal Walad):<br/>Ilmu Tanpa Amal adalah Kegilaan"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsDidaktikMoral["SINTESIS DIDAKTIK SAINS PEMBELAJARAN"]
        Blatt["Efek Blatt (Kohlberg & Blatt, 1975):<br/>• Diskusi dilema moral memicu transisi ke tahap penalaran lebih tinggi (+1 Stage).<br/>• Menghancurkan stagnasi pemikiran konvensional."]
        
        Kolb["Experiential Learning Cycle (David Kolb, 1984):<br/>1. Concrete Experience (Pengalaman Nyata Asrama)<br/>2. Reflective Observation (Refleksi Batin)<br/>3. Abstract Conceptualization (Penyelarasan Dalil Syar'i)<br/>4. Active Experimentation (Penerapan Adab Baru)"]
        
        Blatt & Kolb ==> DidaktikIntegratif["METODE DIDAKTIK MATINUL KHULUQ TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaDidaktik24Jam["INTEGRASI DIDAKTIK ADAB KELAS DAN ASRAMA"]
        Kelas["DI KELAS: Pengenalan Konsep, Analisis Dilema Etika, & Simulasi Sosiodrama."]
        Kamar["DI ASRAMA: Praktik Nyata, Observasi Sebaya, & Penegakan Adab Muamalah."]
        Halaqah["DI HALAQAH: Refleksi Pengalaman, Evaluasi CICO, & Penyucian Jiwa (Tazkiyah)."]
        
        Kelas ==>|Diaplikasikan di| Kamar ==>|Dievaluasi di| Halaqah ==>|Disempurnakan di| Kelas
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolFasilitasiDilema["PROTOKOL DIDAKTIK RESOLUSI DILEMA ETIS"]
        Langkah1["1. VALIDASI PERSPEKTIF & DE-POLARISASI<br/>• Guru mengapresiasi niat baik kedua belah pihak (menjaga kawan vs menjaga aturan)."]
        
        Langkah2["2. INTEGRASI KAIDAH USHUL FIQH & HIERARKI KEMUDHARATAN<br/>• Membedah Kaidah Fiqhiyyah: 'Adh-Dhararu Yuzal' & 'Dar'ul Mafasid Muqaddamun 'Ala Jalbil Mashalih'."]
        
        Langkah3["3. FORMULASI SOLUSI RESTORATIF BERTAHAP (TA'DIL AS-SULUK)<br/>• Tahap 1: Menegur & menasihati kawan secara privat dengan kasih sayang (48 Jam).<br/>• Tahap 2: Mengajak kawan menyerahkan gawai secara sukarela kepada musyrif.<br/>• Tahap 3: Melapor musyrif BK untuk perlindungan bersama jika maksiat berlanjut."]
        
        Langkah4["4. SIMULASI ROLE-PLAYING CARA MENASIHATI KAWAN<br/>• Santri berlatih berbicara asertif dan penuh kasih tanpa nada menghakimi."]
...
```mermaid
flowchart TD
    subgraph EmpatModelPedagogiAdab["EMPAT MODEL PEDAGOGI MATINUL KHULUQ"]
        M1["1. MORAL DILEMMA DISCUSSIONS (MDD)<br/>• Membedah kasus ambigu nyata asrama berbasis kaidah syariat.<br/>• Melatih kemampuan pertimbangan etis tingkat tinggi (Post-Conventional)."]
        
        M2["2. RESTORATIVE SOCIODRAMA & ROLE-PLAYING<br/>• Memerankan skenario konflik & latihan de-eskalasi emosi.<br/>• Membangun empati kognitif & afektif terhadap korban kezaliman."]
        
        M3["3. EXPERIENTIAL SERVICE LEARNING (KHIDMAH)<br/>• Proyek aksi nyata: Merawat santri sakit, membersihkan fasilitas, aksi sosial.<br/>• Mengonversi pemahaman teori menjadi tindakan kebaikan nyata."]
        
        M4["4. STRUCTURED LIVING EXEMPLARITY (QUDWAH)<br/>• Keteladanan hidup musyrif & guru yang terstruktur & konsisten.<br/>• Interaksi dialogis harian yang memancarkan kasih sayang & wibawa."]
        
        M1 & M2 & M3 & M4 ==> Puncak["KOMPETENSI ADAB MATINUL KHULUQ PARIPURNA"]
    end
```
...
Penerapan konsep **P3-06-12: METODE PEDAGOGI DAN DIDAKTIK AKHLAK MATINUL KHULUQ** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
