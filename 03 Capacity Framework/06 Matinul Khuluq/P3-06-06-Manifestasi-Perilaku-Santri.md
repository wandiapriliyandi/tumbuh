...
```mermaid
flowchart TD
    subgraph TransformasiObservasiPerilaku["REKONSTRUKSI SISTEM OBSERVASI PERILAKU SANTRI"]
        Subjektif["OBSERVASI SUBJEKTIF-PERSEPTIF<br/>• Pelabelan samar ('nakal', 'bandel', 'alim').<br/>• Terjebak pada Halo Effect & manipulasi kesan.<br/>• Perilaku pasif-agresif & bullying halus luput."]
        
        TUMBUH["OBSERVASI BEHAVIORAL TERSTRUKTUR (TUMBUH)<br/>• Deskriptor perilaku teramati di 5 setting utama.<br/>• Identifikasi dini perilaku defisit (Ghashab, Sarcasm).<br/>• Penguatan perilaku prososial berbasis data PBIS."]
        
        Subjektif ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsManifestasiAkhlak["KORELASI BATIN DAN LAHIR DALAM TURATS"]
        HaditsNu'man["HR. Al-Bukhari & Muslim:<br/>أَلَا وَإِنَّ فِي الْجَسَدِ مُضْغَةً إِذَا صَلَحَتْ صَلَحَ الْجَسَدُ كُلُّهُ...<br/>(Keshalihan Segumpal Darah Memancarkan Keteraturan Raga)"] --> Inti["Al-Atsar al-Khuluqiy:<br/>Perilaku Lahiriah adalah Bukti Autentik Kematangan Batin"]
        Ghazali["Al-Ghazali (Ihya'):<br/>Adab Makan, Berbicara, & Berjalan adalah Cermin Jiwa"] --> Inti
        Muhasibi["Al-Harits Al-Muhasibi (Ri'ayah):<br/>Pengawasan Detil Gerak-Gerik Anggota Badan (Jawarikh)"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsAnalisisPerilaku["SINTESIS ABA DAN EKOLOGI PERILAKU"]
        ABA["Applied Behavior Analysis (ABA):<br/>• Antecedent (Pemicu Setting Asrama)<br/>• Behavior (Perilaku Teramati Santri)<br/>• Consequence (Umpan Balik Restoratif Musyrif)"]
        
        Bronfenbrenner["Ekologi Bronfenbrenner:<br/>• Mikrosistem: Kamar Tidur & Halaqah Sebaya<br/>• Mesosistem: Interaksi Guru-Musyrif-Wali Santri<br/>• Eksosistem: Kebijakan Tata Tertib Pondok"]
        
        ABA & Bronfenbrenner ==> Manifestasi["SISTEM OBSERVASI PERILAKU MATINUL KHULUQ 24 JAM"]
    end
```
...
```mermaid
flowchart TD
    subgraph SettingMikroAsrama["LIMA SETTING KRUSIAL MANIFESTASI ADAB ASRAMA"]
        S1["1. SETTING KAMAR MANDI & JEMURAN<br/>• Pemicu: Waktu sempit, antrean panjang.<br/>• Manifestasi Adab: Antre tertib, hemat air, tidak ghashab sabun/gayung kawan."]
        
        S2["2. SETTING RUANG MAKAN (DAPUR)<br/>• Pemicu: Rasa lapar, perebutan porsi lauk.<br/>• Manifestasi Adab: Mendahulukan kawan (Itsar), makan dengan tenang, membersihkan nampan."]
        
        S3["3. SETTING KAMAR TIDUR ASRAMA<br/>• Pemicu: Kelelahan malam, privasi tertutup.<br/>• Manifestasi Adab: Menghargai istirahat kawan, merapikan kasur, dialog santun tanpa ghibah."]
        
        S4["4. SETTING RUANG KELAS & BELAJAR<br/>• Pemicu: Tekanan nilai, tugas mandiri.<br/>• Manifestasi Adab: Kejujuran ujian, mendengarkan asatidz, kerja sama adil."]
        
        S5["5. SETTING MASJID & HALAQAH<br/>• Pemicu: Ruang suci, ibadah komunal.<br/>• Manifestasi Adab: Tertib shalat saf depan, tawadhu' saat ditegur, menjaga kesucian."]
        
        S1 & S2 & S3 & S4 & S5 --> Terpadu["EKOSISTEM ADAB 24 JAM TERPADU"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolDeeskalasiOlahraga["PROTOKOL DE-ESKALASI AGRESI LAPANGAN OLAHRAGA"]
        L1["1. DE-ESKALASI CEPAT (COOLING-OFF PERIOD)<br/>• Musyrif memisahkan kedua pemain dengan tenang (Firm & Kind).<br/>• Meminta keduanya mengambil wudhu & duduk tenang selama 15 menit."]
        
        L2["2. DIALOG MEDIASI RESTORATIF DI POSKO OLAHRAGA<br/>• Memberikan ruang masing-masing santri menceritakan kejadian secara jujur.<br/>• Santri T menyadari bahwa pelanggaran lisan & dorongan fisiknya mencederai ukhuwah.<br/>• Santri H meminta maaf atas tekelnya yang ceroboh."]
        
        L3["3. TINDAKAN RESTITUSI ADAB SPORTIF (RECONCILIATION)<br/>• Saling berjabat tangan & berpelukan di hadapan seluruh peserta pertandingan.<br/>• Keduanya bertugas bersama merapikan seluruh peralatan bola & lapangan."]
        
        L4["4. REFLEKSI HALAQAH MALAM<br/>• Musyrif mengangkat hikmah sportivitas Nabawi (HR. Muslim: Al-Mu'minul Qawiyy) tanpa mempermalukan pelaku."]
...
| :--- | :--- | :--- |
| **1. Ash-Shidq (Kejujuran)** | • Menyampaikan kronologi kejadian apa adanya tanpa manipulasi.<br/>• Mengakui secara jujur saat belum mengerjakan tugas/hafalan.<br/>• Mengembalikan barang milik orang lain yang ditemukan di posko.<br/>• Menjaga orisinalitas riset dan ujian akademik. | • Berbohong atau mengarang cerita saat diinterogasi musyrif.<br/>• Mencontek, membuka catatan ilegal, atau menyuruh kawan mengerjakan tugas.<br/>• Menyembunyikan barang temuan untuk kepentingan pribadi.<br/>• Mencari pembenaran palsu saat terlambat bangun shalat. |
| **2. At-Tawadhu' (Rendah Hati)** | • Menyapa dan mengucapkan salam 5S dengan senyuman tulus.<br/>• Memanggil nama teman dengan panggilan yang baik dan disukai.<br/>• Mendengarkan kritik teman atau musyrif dengan tenang.<br/>• Rela membersihkan area umum tanpa memandang status kelas. | • Melontarkan ejekan fisik (*Body Shaming*), logat, atau latar belakang keluarga.<br/>• Menyebut kawan dengan julukan hewan atau gelar yang merendahkan.<br/>• Bersikap arogan, menolak ditegur, dan membentak adik kelas.<br/>• Menolak tugas piket karena merasa "sudah senior". |
| **3. Asy-Syaja'ah (Keberanian)** | • Mengatakan "tidak" secara santun saat diajak melanggar tata tertib.<br/>• Menegur atau membela kawan yang sedang diejek (*Upstander*).<br/>• Berani meminta maaf secara terbuka ketika berbuat salah.<br/>• Menyampaikan aspirasi asrama secara santun melalui forum resmi. | • Takut menolak ajakan merokok/gawai karena cemas dikucilkan sebaya.<br/>• Menjadi penonton pasif saat melihat perundungan di kamar tidur.<br/>• Bersikap defensif, lari dari tanggung jawab, atau menyalahkan orang lain.<br/>• Menyebarkan provokasi atau gosip (*Ghibah*) di belakang layar. |
| **4. Al-Amanah (Tanggung Jawab)** | • Menjaga perlengkapan mandi/pakaian pribadi secara rapi.<br/>• Meminjam barang kawan dengan izin resmi dan mengembalikannya utuh.<br/>• Menjaga kebersihan dan fasilitas kamar mandi umum.<br/>• Menyelesaikan tugas organisasi dan keuangan secara transparan. | • Menggunakan sandal, sabun, atau pakaian kawan tanpa izin (*Ghashab*).<br/>• Merusak fasilitas ranjang, lemari, atau mencoret-coret dinding kamar.<br/>• Mengabaikan jadwal piket kamar mandi sehingga kotor dan bau.<br/>• Menggunakan uang kas organisasi santri untuk kepentingan pribadi. |
...
```mermaid
flowchart TD
    subgraph MatriksSettingSpasial["PETA PERILAKU BERDASARKAN SETTING ASRAMA"]
        SettingKamar["KAMAR TIDUR & ASRAMA:<br/>• (+) Merapikan kasur, tidur tepat jam malam, menghargai privasi kawan.<br/>• (-) Begadang tanpa izin, mengacak-acak lemari teman, sarkasme."]
        
        SettingMasjid["MASJID & HALAQAH:<br/>• (+) Datang sebelum azan, tilawah tenang, mendengarkan tausiyah takzim.<br/>• (-) Bercanda saat azan, menduduki tempat orang lain secara paksa."]
        
        SettingDapur["RUANG MAKAN & DAPUR:<br/>• (+) Antre nampan tertib, makan duduk rapi, membersihkan sisa makanan.<br/>• (-) Menyerobot antrean, mengambil lauk melebihi porsi haknya."]
        
        SettingKelas["KELAS & PERPUSTAKAAN:<br/>• (+) Menyimak penjelasan guru, merawat buku, diskusi ilmiah adil.<br/>• (-) Berbisik-bisik saat guru menerangkan, mencorat-coret meja."]
        
        SettingOlahraga["LAPANGAN & AREA TERBUKA:<br/>• (+) Sportivitas tinggi, meminjam alat dengan tertib, bahasa santun.<br/>• (-) Provokasi fisik, cemoohan verbal saat lawan kalah, merusak net/bola."]
        
        SettingKamar ~~~ SettingMasjid ~~~ SettingDapur ~~~ SettingKelas ~~~ SettingOlahraga
    end
```
...
| :--- | :--- | :--- |
| **Jenjang J1 (Kelas 7)** | • Menerapkan adab 5S kepada seluruh ustadz, musyrif, dan santri senior.<br/>• Menata lemari pakaian sendiri dan tidak memakai barang orang lain.<br/>• Tepat waktu bangun Shubuh dan tidur malam secara mandiri. | • Menangis histeris berkepanjangan tanpa mau berinteraksi (*Severe Homesickness*).<br/>• Mengambil sabun/sandal teman tanpa izin (*Micro-Ghashab* awal).<br/>• Berkata bohong karena takut dihukum musyrif. |
| **Jenjang J2 (Kelas 8–9)** | • Menjaga lisan dari umpatan kotor saat bermain atau bercanda.<br/>• Menyelesaikan tugas piket kamar mandi bersama tanpa mengeluh.<br/>• Mengakui kesalahan secara langsung kepada musyrif. | • Menggunakan julukan buruk (*Al-Alqab*) untuk merendahkan kawan sekamar.<br/>• Melakukan aksi boikot sosial (*Silent Treatment*) terhadap santri tertentu.<br/>• Membantah teguran musyrif dengan nada tinggi atau membanting pintu. |
| **Jenjang J3 (Kelas 10–11)** | • Menjunjung kejujuran akademik mutlak (nol toleransi menyontek).<br/>• Berani menegur kawan yang berbuat zalim (*Upstander Action*).<br/>• Mengelola kegiatan ekstrakurikuler dengan laporan terbuka. | • Memanfaatkan status kelas atas untuk menyuruh santri baru secara sepihak.<br/>• Melakukan kecurangan akademik atau plagiasi tugas karya tulis.<br/>• Bersikap apatis dan pura-pura tidak melihat perundungan. |
| **Jenjang J4 (Kelas 12)** | • Menjadi teladan hidup (*Qudwah*) dalam kedisiplinan dan ibadah asrama.<br/>• Membimbing santri junior dengan kelembutan dan perhatian tulus.<br/>• Memediasi dan mendamaikan potensi konflik antar-santri. | • Menunjukkan arogansi senioritas atau menuntut privilese berlebih.<br/>• Membiarkan tradisi perpeloncoan kamar tetap berlangsung.<br/>• Melanggar aturan perizinan pondok dengan dalih "sudah kelas akhir". |
...
Penerapan konsep **P3-06-06: MANIFESTASI PERILAKU SANTRI MATINUL KHULUQ** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
