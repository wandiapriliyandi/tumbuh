...
```mermaid
flowchart TD
    subgraph TransformasiTrajektoriPerkembangan["REKONSTRUKSI TRAJEKTORI PERKEMBANGAN SANTRI"]
        Homogen["PENGASUHAN HOMOGEN-KOLOT<br/>• Aturan & hukuman sama untuk seluruh usia (12–18 tahun).<br/>• Mengabaikan dinamika pubertas & lonjakan hormonal.<br/>• Menghasilkan trauma santri baru & perlawanan santri atas."]
        
        TUMBUH["TRAJEKTORI BERJENJANG J1–J4 (TUMBUH)<br/>• Diferensiasi pendekatan pedagogis sesuai usia perkembangan.<br/>• Pengawalan transisi biososial berbasis sains & Turats.<br/>• Menghantarkan kematangan bertahap menuju Qudwah Hasanah."]
        
        Homogen ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMaratibTaklif["PENTAHAPAN USIA TAKLIF DALAM TURATS"]
        Tamyiz["Marhalatut Tamyiz (Usia 7–10 Tahun):<br/>Pembiasaan Adab & Pembentukan Kesadaran Awal"] --> Taklif["Marhalatul Bulugh wat Taklif (Usia 10–15 Tahun):<br/>Tanggung Jawab Syar'i & Transisi Kematangan Jiwa"]
        Taklif --> Rusyd["Marhalatur Rusyd (Usia 15–18 Tahun):<br/>Kematangan Intelektual, Otonomi Moral, & Khidmah"]
        Rusyd --> Inti["Matinul Khuluq Paripurna"]
    end
```
...
```mermaid
flowchart TD
    subgraph NeurosainsDanPsikologiRemaja["SINTESIS SAINS PERKEMBANGAN REMAJA"]
        Erikson["Teori Psikososial Erikson:<br/>• Usia 12–15: Industry vs Inferiority (Kompetensi Diri)<br/>• Usia 15–18: Identity vs Role Confusion (Identitas Diri)"]
        
        Kohlberg["Teori Moral Kohlberg:<br/>• Pre-Conventional (Takut Hukuman)<br/>• Conventional (Konformitas Sosial)<br/>• Post-Conventional (Prinsip Etika Universal)"]
        
        Neuro["Neurosains Maturasi Otak Remaja:<br/>• Kesenjangan Maturasi: Amygdala/Limbik matang lebih cepat dari Prefrontal Cortex.<br/>• Musyrif berperan sebagai 'External Prefrontal Cortex' yang menenangkan."]
        
        Erikson & Kohlberg & Neuro ==> Trajektori["TRAJEKTORI JENJANG J1–J4 TERPADU"]
    end
```
...
```mermaid
flowchart TD
    subgraph EkologiAsramaPerJenjang["DIFFERENSIASI EKOLOGI ASRAMA J1–J4"]
        AsramaJ1["ASRAMA JENJANG J1 (KELAS 7): 'SARANG AMAN & HANGAT'<br/>• Rasio Musyrif-Santri Rendah (1:10) untuk pendampingan intensif.<br/>• Program 'Masa Ta'aruf & Adaptasi Asrama' tanpa perpeloncoan."]
        
        AsramaJ2["ASRAMA JENJANG J2 (KELAS 8–9): 'ARENA REGULASI SEBAYA'<br/>• Penyaluran energi melalui klub olahraga, seni, & proyek sains.<br/>• Manajemen resolusi konflik kamar terfasilitasi musyrif."]
        
        AsramaJ3["ASRAMA JENJANG J3 (KELAS 10–11): 'INKUBASI OTONOMI MORAL'<br/>• Tata ruang studi mandiri & kebebasan terarah mengelola jadwal.<br/>• Kepanitiaan kegiatan pesantren mandiri."]
        
        AsramaJ4["ASRAMA JENJANG J4 (KELAS 12): 'RUMAH KEPEMIMPINAN QUDWAH'<br/>• Peran sebagai mentor adik asrama & asisten musyrif.<br/>• Forum dialog pemikiran peradaban & persiapan munaqasyah."]
        
        AsramaJ1 --> AsramaJ2 --> AsramaJ3 --> AsramaJ4
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolTransformasiTransisi["PROTOKOL PENDAMPINGAN TRANSISI TRANSFORMATIF TIER 2/3"]
        Aksi1["1. HENTIKAN PENDEKATAN KONFRONTASI INTROVERSIAL<br/>• Menghindari ancaman pengeluaran pondok yang memperkuat mentalitas 'martir geng'."]
        
        Aksi2["2. DIALOG EKSISTENSIAL DEWASA (ADULT-TO-ADULT DIALOGUE)<br/>• Pimpinan pondok & Musyrif Senior mengajak berdiskusi di ruang santai.<br/>• Membicarakan visi hidup, potensi kepemimpinan, & kegelisahan batin mereka."]
        
        Aksi3["3. STRATEGI REDIREKSI ENERGI: AMANAH PROYEK BESAR<br/>• Kelompok tersebut diberi tanggung jawab penuh memimpin 'Pekan Kreasi & Olahraga Akbar Pesantren'.<br/>• Mengubah energi pemberontakan menjadi prestasi kepemimpinan nyata."]
        
        Aksi4["4. KONTRAK INTEGRITAS DAN MENTORSHIP EKSKLUSIF<br/>• Sesi coaching berkala 1-on-1 bersama figur inspirator alumni sukses."]
...
```mermaid
flowchart TD
    subgraph Trajektori4JenjangTUMBUH["TRAJEKTORI EMPAT JENJANG KEMANDIRIAN ADAB (J1–J4)"]
        J1["JENJANG J1: FASE TA'ARUF & ADAPTASI ADAB DASAR (KELAS 7 - USIA 12–13 TAHUN)<br/>• Fokus: Menghargai privasi kamar, habituasi 5S, eliminasi ghashab, mandiri bangun shubuh.<br/>• Peran Musyrif: Pengasuh Hangat & Pemandu Arah (Nurturing Parent)."]
        
        J2["JENJANG J2: FASE TAFAHUM & REGULASI EMOSI SEBAYA (KELAS 8–9 - USIA 13–15 TAHUN)<br/>• Fokus: Mengendalikan amarah, anti-bullying/ejekan, kerja tim asrama, meminta maaf jantan.<br/>• Peran Musyrif: Fasilitator Restoratif & Pelatih Emosi (Emotion Coach)."]
        
        J3["JENJANG J3: FASE TA'AWUN & INTEGRITAS MORAL OTONOM (KELAS 10–11 - USIA 15–17 TAHUN)<br/>• Fokus: Kejujuran akademik mutlak, Upstander anti-kezaliman, kepanitiaan amanah transparan.<br/>• Peran Musyrif: Mitra Dialog Intelektual & Konselor Pembimbing (Mentor & Advisor)."]
        
        J4["JENJANG J4: FASE TAKAFUL & KEPEMIMPINAN QUDWAH (KELAS 12 - USIA 17–18 TAHUN)<br/>• Fokus: Menjadi role model akhlak, mengayomi adik kelas, mediasi damai perselisihan santri.<br/>• Peran Musyrif: Katalisator Pemberdayaan & Penguji Portofolio (Empowerer & Assessor)."]
...
```mermaid
flowchart LR
    subgraph RitesOfPassage["UPACARA TRANSISI KEMATANGAN ADAB SANTRI"]
        T1["TRANSISI J1 -> J2: IKRAR ADAB SEBAYA<br/>Santri menyerahkan portofolio adaptasi dasar & berikrar menjaga lisan."]
        --> T2["TRANSISI J2 -> J3: IKRAR INTEGRITAS MORAL<br/>Santri mempresentasikan karya ilmiah adab & menerima selempang pembelajar mandiri."]
        --> T3["TRANSISI J3 -> J4: AMANAH KHIDMAH QUDWAH<br/>Santri dilantik menjadi mentor resmi adik kelas & penanggung jawab iklim asrama."]
    end
```
