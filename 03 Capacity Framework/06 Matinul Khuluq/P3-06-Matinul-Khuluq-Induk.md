...
```mermaid
flowchart TD
    subgraph Arsitektur14SubModulMatinulKhuluq["ARSITEKTUR LENGKAP 14 SUB-MODUL MATINUL KHULUQ"]
        subgraph FONDASI["1. FONDASI TEORETIS & AKSIOLOGIS"]
            M01["[P3-06-01] Filosofi & Landasan Turats (Khuluqin 'Azhim)"]
            M02["[P3-06-02] Definisi & Konseptualisasi Moral Wholeness"]
            M03["[P3-06-03] Tujuan & Target Capaian Tri-Domain"]
            M04["[P3-06-04] Nilai Inti & Prinsip Aksiologi Syar'i"]
            M05["[P3-06-05] Standar Kompetensi & Taksonomi Fitrah"]
        end
        
        subgraph TRAJEKTORI["2. PERILAKU, RUBRIK, & PROGRESI JENJANG"]
            M06["[P3-06-06] Manifestasi Perilaku Teramati 24 Jam"]
            M07["[P3-06-07] Rubrik Indikator Kinerja 4-Level"]
            M08["[P3-06-08] Tahapan Perkembangan Jenjang J1–J4"]
        end
        
        subgraph PRAKSIS["3. PRAKSIS ASESMEN, INTERVENSI, & DIDAKTIK"]
            M09["[P3-06-09] Pemetaan Asesmen & Triangulasi 360"]
            M10["[P3-06-10] Protokol Intervensi PBIS Multi-Tier"]
            M11["[P3-06-11] Program Pembinaan & Halaqah 24 Pekan"]
            M12["[P3-06-12] Metode Pedagogi & Didaktik Dilema Moral"]
            M13["[P3-06-13] Kompendium Instrumen & Mutaba'ah"]
        end
        
        subgraph VALIDASI["4. PENJAMINAN MUTU & KETAHANAN SISTEM"]
            M14["[P3-06-14] Sintesis Keilmuan, Validasi CFA, & Stress-Test"]
        end
...
```mermaid
flowchart LR
    J1["JENJANG J1 (KELAS 7)<br/>Fase Ta'aruf & Adaptasi<br/>• Habituasi 5S<br/>• Anti-Ghashab Dasar<br/>• Menghargai Privasi Kamar"]
    --> J2["JENJANG J2 (KELAS 8–9)<br/>Fase Tafahum & Regulasi<br/>• Regulasi Lisan & Amarah<br/>• Kolaborasi Kerja Tim<br/>• Meminta Maaf Jantan"]
    --> J3["JENJANG J3 (KELAS 10–11)<br/>Fase Ta'awun & Integritas<br/>• Kejujuran Akademik Mutlak<br/>• Upstander Anti-Bullying<br/>• Kepanitiaan Transparan"]
    --> J4["JENJANG J4 (KELAS 12)<br/>Fase Takaful & Qudwah<br/>• Teladan Hidup Pesantren<br/>• Mentorship Adik Kelas<br/>• Mediator Damai Komunitas"]
```
...
```mermaid
flowchart TD
    subgraph SistemPBIS24Jam["SISTEM DISIPLIN RESTORATIF PBIS MULTI-TIER"]
        T1["TIER 1: UNIVERSAL PREVENTION (100% Santri)<br/>• Rasio Apresiasi Positif 4:1 (Catching Students Being Good).<br/>• Matriks Visual Adab di Seluruh Setting (Kamar, Masjid, Dapur).<br/>• Halaqah Adab Dialogis 24 Pekan."]
        
        T2["TIER 2: TARGETED INTERVENTION (10–15% Santri Berisiko)<br/>• Program Check-In / Check-Out (CICO) Harian bersama Musyrif.<br/>• Kelompok Keterampilan Sosial & Manajemen Amarah.<br/>• Mentorship Khusus bersama Santri Jenjang J4."]
        
        T3["TIER 3: INTENSIVE RESTORATIVE (1–5% Pelanggaran Berat)<br/>• Functional Behavior Assessment (FBA) Komprehensif.<br/>• Rencana Intervensi Perilaku Individual (BIP).<br/>• Konferensi Restoratif Komunitas (Perjanjian Restitusi & Ishlah)."]
