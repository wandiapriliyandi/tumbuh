...
```mermaid
flowchart TD
    subgraph DekonstruksiKonsepAkhlak["DEKONSTRUKSI DEFINISI AKHLAK PESANTREN"]
        Mekanistik["DEFINISI MEKANISTIK-ATOMISTIK<br/>• Akhlak = Sekadar patuh tata tertib formal.<br/>• Santri pasif, takut salah, & patuh semu.<br/>• Moralitas runtuh saat berada di luar kontrol pondok."]
        
        Matin["KONSEPTUALISASI MATINUL KHULUQ TUMBUH<br/>• Akhlak = Disposisi batin integral & otonom.<br/>• Keberanian moral, kejujuran batin, & kepedulian aktif.<br/>• Karakter kokoh seumur hidup di era disrupsi global."]
        
        Mekanistik ==>|DIREKONSTRUKSI MENJADI| Matin
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsKonsepAkhlak["SINTESIS DEFINISI TURATS MATINUL KHULUQ"]
        Hasan["Hasan Al-Bashri:<br/>بَذْلُ النَّدَى وَكَفُّ الْأَذَى وَطَلَاقَةُ الْوَجْهِ<br/>(Memberi Manfaat, Menahan Bahaya, & Wajah Berseri)"] --> Core["Konstruk Matinul Khuluq:<br/>Kekuatan Batin yang Memberi Manfaat & Mengikis Kezaliman"]
        Mawardi["Al-Mawardi (Adab Dunya wad-Din):<br/>Keselarasan Izzah (Kemuliaan Diri) & Tawadhu' (Rendah Hati)"] --> Core
        Ghazali["Al-Ghazali (Ihya' Ulumiddin):<br/>Keseimbangan Daya Nalar, Marah, & Syahwat"] --> Core
    end
```
...
```mermaid
flowchart TD
    subgraph ModelMoralRestBlasi["INTEGRASI EMPAT KOMPONEN REST & IDENTITAS MORAL BLASI"]
        Sensitivitas["1. Moral Sensitivity (Kepekaan Moral)<br/>• Menyadari bahwa suatu tindakan berdampak pada orang lain.<br/>• Membaca luka batin kawan yang dirundung."]
        Penilaian["2. Moral Judgment (Pertimbangan Moral)<br/>• Membedakan mana tindakan adil dan zalim secara rasional.<br/>• Merujuk pada panduan syariat & etika."]
        Motivasi["3. Moral Motivation (Motivasi Moral - Blasi)<br/>• Menjadikan nilai moral sebagai identitas diri utama (Moral Identity).<br/>• Mengutamakan nilai syariat di atas ego pribadi."]
        Karakter["4. Moral Character (Kekuatan Karakter - Matinul Khuluq)<br/>• Eksekusi tindakan moral di tengah tekanan & kesulitan (Courage & Grit)."]
        
        Sensitivitas --> Penilaian --> Motivasi --> Karakter
    end
```
...
```mermaid
flowchart TD
    subgraph TransformasiRuangAsrama["REKAYASA IKLIM ASRAMA PESANTREN"]
        Kandang["MODEL ASRAMA PENGAWASAN PANOPTIKON<br/>• CCTV di setiap jengkal, razia mendadak yang menakutkan.<br/>• Santri merasa dicurigai secara permanen.<br/>• Akibat: Santri berakting alim, moralitas manipulatif."]
        
        Taman["MODEL ASRAMA BI'AH SHALIHAH (TUMBUH)<br/>• Musyrif sebagai teladan hangat, dialogis, & berwibawa.<br/>• Ruang kamar berbasis kepercayaan & akuntabilitas mandiri.<br/>• Akibat: Kesadaran moral tumbuh mekar dari dalam kalbu."]
        
        Kandang ==>|DIREKONSTRUKSI MENJADI| Taman
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolResolusiManipulasi["PROTOKOL INTERVENSI RESTORATIF MANIPULASI ADAB"]
        Langkah1["1. AUDIT FAKTA DAN BUKTI OBJEKTIF<br/>• Pengumpulan data triangulasi tanpa konfrontasi agresif.<br/>• Perlindungan penuh bagi saksi santri J1 (Safe Reporting)."]
        
        Langkah2["2. SESI CONFRONTING WITH COMPASSION (FIRM & KIND)<br/>• Musyrif & Konselor membedah kontradiksi perilaku Santri R.<br/>• Menyadarkan bahaya kemunafikan batin & meruntuhkan tameng ego."]
        
        Langkah3["3. KONTRAK RESTITUSI ADAB & PENCABUTAN SEMENTARA JABATAN<br/>• Santri R dibebastugaskan dari ketua kamar untuk fokus perbaikan diri.<br/>• Melakukan restitusi nyata: Membersihkan kamar mandi sendiri selama 1 bulan & mengembalikan barang."]
        
        Langkah4["4. PEMBINAAN TAZKIYATUN NAFS & REINTEGRASI KEPEMIMPINAN<br/>• Bimbingan intensif pembersihan hati (Ikhlas vs Ujub).<br/>• Evaluasi pemulihan integritas sebelum diberikan amanah baru."]
...
```mermaid
flowchart TD
    subgraph KonstrukPsikometrikAkhlak["STRUKTUR KONSTRUK MULTIDIMENSIONAL MATINUL KHULUQ"]
        Core["INTI MATINUL KHULUQ<br/>(Integritas Fitrah & Cinta Syariat)"]
        
        D1["Dimensi 1: Integritas & Kejujuran (Shidq)<br/>• Kebenaran Lisan<br/>• Kejujuran Akademik<br/>• Transparansi Niat"]
        
        D2["Dimensi 2: Kesantunan & Kehangatan (Tawadhu')<br/>• Adab Berbicara Lembut<br/>• Pemuliaan Senior-Junior<br/>• Bebas Arogansi Diri"]
        
        D3["Dimensi 3: Keberanian Moral (Syaja'ah)<br/>• Resistensi Tekanan Sebaya<br/>• Pembelaan Kawan Tertindas<br/>• Kesatria Mengakui Khilaf"]
        
        D4["Dimensi 4: Amanah Sosial (Mas'uliyyah)<br/>• Penjagaan Fasilitas Umum<br/>• Komitmen Janji & Akad<br/>• Khidmah pada Komunitas"]
...
```mermaid
quadrantChart
    title MATRIKS TIPOLOGI PERILAKU MORAL SANTRI ASRAMA
    x-axis "Kesadaran Moral Rendah" --> "Kesadaran Moral Tinggi"
    y-axis "Keberanian Eksekusi Rendah" --> "Keberanian Eksekusi Tinggi"
    quadrant-1 "TIPE 4: INSAN ADABI (MATINUL KHULUQ PARIPURNA)"
    quadrant-2 "TIPE 3: MORALIS AGRESIF / DOMINAN TANPA ADAB"
    quadrant-3 "TIPE 1: HEDONIS OPURTUNIS / APATIS"
    quadrant-4 "TIPE 2: MORALIS PASIF / PENONTON TAK BERDAYA"
```
...
```mermaid
flowchart TD
    subgraph ProgresiJenjangAdab["TANGGA KEMANDIRIAN ADAB J1–J4"]
        J1["J1: TAHAP ADAPTASI & HABITUASI DASAR (KELAS 7)<br/>• Fokus: Menghargai privasi kamar, disiplin lisan 5S, eliminasi ghashab barang kawan.<br/>• Metode: Pengawasan aktif musyrif & pendampingan kakak asuh."]
        
        J2["J2: TAHAP REGULASI DIRI & EMPATI SEBAYA (KELAS 8–9)<br/>• Fokus: Mengendalikan amarah, menyelesaikan sengketa dengan dialog, kerja tim.<br/>• Metode: Lingkar Restoratif kamar & proyek kolaboratif asrama."]
        
        J3["J3: TAHAP INTEGRITAS & KEBERANIAN MORAL (KELAS 10–11)<br/>• Fokus: Anti-kecurangan akademik, menjadi Upstander pelindung adik kelas.<br/>• Metode: Kajian kitab etika mendalam & kepanitiaan mandiri."]
        
        J4["J4: TAHAP KEPEMIMPINAN QUDWAH & KHIDMAH (KELAS 12)<br/>• Fokus: Menjadi figur teladan asrama, membimbing santri junior, mediasi konflik.<br/>• Metode: Servant leadership asrama & portofolio kelulusan adab."]
...
Penerapan konsep **P3-06-02: DEFINISI DAN KONSEPTUALISASI MATINUL KHULUQ** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
