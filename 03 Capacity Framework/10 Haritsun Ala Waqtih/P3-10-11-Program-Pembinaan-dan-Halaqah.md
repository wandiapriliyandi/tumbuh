...
```mermaid
flowchart TD
    subgraph TransformasiHalaqahWaktu["REKONSTRUKSI METODE HALAQAH MANAJEMEN WAKTU"]
        Omelan["OMELAN REAKTIF MUSYRIF (TRADISIONAL)<br/>• Memarahi santri terlambat tanpa solusi teknis.<br/>• Belajar mandiri tanpa panduan teknik Deep Work.<br/>• Pagi hari panik karena tas tidak disiapkan malam."]
        
        TUMBUH["HALAQAH MANAJEMEN WAKTU APLIKATIF (TUMBUH)<br/>• Silabus Tematik 24 Pekan (Qimatuz Zaman & Pomodoro).<br/>• Workshop Time-Blocking, Matriks Eisenhower, & Deep Work.<br/>• Peer Time Mentorship J4–J1 & Ritual Evening Launchpad."]
        
        Omelan ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMajelisWaktuSalaf["TRADISI MAJELIS ILMU SALAF"]
        Zarnuji["Az-Zarnuji (Ta'limul Muta'allim):<br/>يَنْبَغِي لِطَالِبِ الْعِلْمِ أَنْ يُقَدِّرَ لِنَفْسِهِ تَقْدِيرًا فِي التَّحْصِيلِ لَا يَعْجِزُ عَنْهُ وَلَا يَفْتُرُ<br/>(Seyogianya Pencari Ilmu Menetapkan Target Harian yang Proporsional Tanpa Futur)"] --> Inti["Hakikat Halaqah Waktu:<br/>Menata Target Belajar Harian Menuju Ketuntasan Ilmu"]
        KhatibBaghdadi["Al-Khatib Al-Baghdadi (Al-Jami'):<br/>Adab Menuntut Ilmu di Waktu Sahar (Menjelang Subuh) & Fajar"] --> Inti
        AbuGhuddah["Abu Ghuddah (Qimatuz Zaman):<br/>Kisah Ulama Menyusun Jadwal Belajar Jam per Jam"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsDidaktikTemporal["SINTESIS DIDAKTIK KETERAMPILAN TEMPORAL"]
        SelfEfficacy["Self-Efficacy Theory (Bandura, 1997):<br/>• Mastery Experiences: Keberhasilan mengeksekusi blok Pomodoro 25 menit menumbuhkan rasa percaya diri mengatur waktu."]
        
        ImplementationIntentions["Implementation Intentions (Gollwitzer, 1999):<br/>• Format 'If-Then Planning': 'Jika adzan Subuh berkumandang, maka aku langsung bangkit mengambil air wudhu'."]
        
        PeerMentorship["Peer Time Mentorship Protocol:<br/>• Santri J4 mendampingi santri J1 menata loker & jadwal harian."]
        
        SelfEfficacy & ImplementationIntentions & PeerMentorship ==> ModelHalaqah["MODEL HALAQAH PRODUKTIVITAS TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaSpasialHalaqahWaktu["SETTING RUANG HALAQAH PRODUKTIVITAS"]
        JamAnalog["1. JAM DINDING ANALOG BESAR: Memberikan kesadaran visual pergerakan jarum detik & menit."]
        PapanTarget["2. PAPAN TIME-BLOCKING KOLABORATIF: Menampilkan grafik kemajuan tugas & hafalan pekanan."]
        MejaPomodoro["3. MEJA BELAJAR POMODORO DENGAN TIMER FISIK: Latihan fokus bebas gawai digital."]
        PojokKonsultasi["4. POJOK MENTORSHIP WAKTU KAKAK ASUH: Area privat dialog bimbingan santri J4–J1."]
        
        JamAnalog ~~~ PapanTarget ~~~ MejaPomodoro ~~~ PojokKonsultasi
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolTaskUnpacking["PROTOKOL PENDAMPINGAN WAKTU TIER 2"]
        Step1["1. SESI MAPPING WAKTU BERSAMA KAKAK ASUH J4 (TIME-AUDIT SESSION)<br/>• Kakak asuh J4 mengajak Santri T memetakan seluruh aktivitasnya dalam diagram 24 jam sederhana."]
        
        Step2["2. PENETAPAN JADWAL MIKRO MENCUCI PAKAIAN (LAUNDRY CHUNKING)<br/>• Santri T dilatih mencuci 2 potong pakaian setiap selesai mandi sore (10 menit) agar cucian tidak menumpuk."]
        
        Step3["3. PEMBERIAN JEDA REGULASI NAFAS 15 MENIT BA'DA ASHAR<br/>• Menjadwalkan waktu hening duduk santai di taman asrama untuk menenangkan sistem saraf."]
        
        Step4["4. KEMANDIRIAN & KEBAHAGIAAN HIDUP ASRAMA<br/>• Dalam 2 pekan, rasa panik Santri T lenyap total & ia menikmati seluruh rutinitas asrama dengan ceria."]
...
```mermaid
flowchart TD
    subgraph SilabusHalaqah24PekanWaktu["SILABUS KURIKULUM HALAQAH PRODUKTIVITAS TEMATIK"]
        Blok1["BLOK 1: FONDASI TEOLOGIS & KRONOBIOLOGI (Pekan 1–6)<br/>• Qimatuz Zaman Turats, Ritme Sirkadian, & Sleep Hygiene Fajar."]
        
        Blok2["BLOK 2: TEKNIK EKSEKUSI & ANTI-PROKRASTINASI (Pekan 7–12)<br/>• Teknik Pomodoro 25 Menit, Matriks Eisenhower, & Zero-Taswif."]
        
        Blok3["BLOK 3: DEEP WORK & EFISIENSI TAHFIDZ (Pekan 13–18)<br/>• Deep Work 90 Menit, Muroja'ah Fajar, & Manajemen Waktu Ujian."]
        
        Blok4["BLOK 4: KEPEMIMPINAN WAKTU & BARAKAH (Pekan 19–24)<br/>• Manajemen Riset KTI, Mentorship Adik Kelas, & Waktu Peradaban."]
...
```mermaid
flowchart LR
    Fase1["FASE 1: 15 MENIT<br/>Tadabbur Teks Turats Waktu<br/>• Pembacaan Qimatuz Zaman.<br/>• Bedah hikmah modal umur."]
    --> Fase2["FASE 2: 30 MENIT<br/>Workshop Keterampilan Waktu<br/>• Latihan Pomodoro / Time-Blocking.<br/>• Bedah kasus penundaan tugas."]
    --> Fase3["FASE 3: 15 MENIT<br/>Evaluasi Logbook & Doa Barakah<br/>• Verifikasi jadwal mingguan.<br/>• Doa keberkahan waktu."]
```
...
```mermaid
flowchart TD
    subgraph ModelTimeMentorshipJ4J1["PROGRAM PEER TIME MENTORSHIP"]
        MentorJ4["SANTRI PENGAYOM J4 (KELAS 12)<br/>• Memeriksa kerapian loker & Evening Launchpad adik asuh J1 setiap malam.<br/>• Membangunkan adik asuh pukul 03.45 dengan senyuman hangat.<br/>• Mengajarkan cara membagi waktu mencuci pakaian & belajar madrasah."]
        
        MenteeJ1["SANTRI MENTEE J1 (KELAS 7)<br/>• Memperoleh bimbingan teknis menata jadwal harian asrama.<br/>• Tidak mengalami kebingungan atau panik di pagi hari.<br/>• Meneladani kedisiplinan dan ketenangan kakak asuhnya."]
...
Penerapan konsep **P3-10-11: PROGRAM PEMBINAAN DAN HALAQAH HARITSUN ALA WAQTIH** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
