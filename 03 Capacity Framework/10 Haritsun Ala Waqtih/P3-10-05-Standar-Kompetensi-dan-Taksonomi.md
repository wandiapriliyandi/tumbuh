...
```mermaid
flowchart TD
    subgraph RekonstruksiTaksonomiWaktu["REKONSTRUKSI TAKSONOMI MANAJEMEN WAKTU"]
        Mekanistik["DISIPLIN MEKANISTIK BEL ASRAMA (TRADISIONAL)<br/>• Bergerak hanya saat bel berbunyi atau diteriaki musyrif.<br/>• Tanpa pembentukan kontrol internal fungsi eksekutif otak.<br/>• Santri lulusan mondok kembali malas saat di rumah."]
        
        TUMBUH["TAKSONOMI MANAJEMEN WAKTU FITRAH TUMBUH<br/>• 4 Level: Inqiyad -> Intizham -> Tanzhim Zati -> Barakah/Qudwah.<br/>• Integrasi Taksonomi Krathwohl & Prefrontal Cortex Planning.<br/>• Standarisasi SKI-SKD J1–J4 melahirkan insan mandiri seumur hidup."]
        
        Mekanistik ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMaratibulAmal["TINGKATAN AMAL & WAKTU DALAM TURATS"]
        Qarafi["Al-Qarafi (Al-Furuq):<br/>Membedakan Waktu Wajib Mudhayyaq (Terbatas) vs Waktu Muwassa' (Longgar)"] --> Inti["Taksonomi Waktu Syar'i:<br/>Menata Amal Berdasarkan Skala Prioritas Maqashid"]
        IbnuQayyim["Ibnu Qayyim (Madarijus Salikin):<br/>Tingkatan Ahli Waktu: Orang yang Menjadikan Setiap Detik untuk Kebaikan Tertinggi"] --> Inti
        Syathibi["Asy-Syathibi (Al-Muwafaqat):<br/>Dharuriyyat Didahulukan di Atas Hajiyyat & Tahsiniyyat"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph KonvergensiTaksonomiEksekutif["SINTESIS TAKSONOMI AFEKTIF & FUNGSI EKSEKUTIF"]
        Krathwohl["Taksonomi Afektif Krathwohl (1964):<br/>Receiving -> Responding -> Valuing -> Organization -> Characterization"]
        
        PFC["Executive Functions (Diamond, 2013):<br/>• Inhibitory Control (Menolak Distraksi)<br/>• Working Memory (Mengingat Jadwal)<br/>• Cognitive Flexibility (Menyesuaikan Rencana)"]
        
        Fitrah["Taksonomi Waktu Fitrah TUMBUH:<br/>1. Al-Inqiyad (Penerimaan Jadwal & Kepatuhan Terbimbing)<br/>2. Al-Intizham (Manajemen Tugas Pomodoro & Anti-Taswif)<br/>3. At-Tanzhim az-Zati (Perencanaan Prioritas Otonom & Deep Work)<br/>4. Al-Barakah wal Qudwah (Kepemimpinan Efisiensi & Keteladanan)"]
        
        Krathwohl & PFC ==> Fitrah
    end
```
...
```mermaid
flowchart TD
    subgraph KurikulumWaktu24Jam["INTEGRASI KURIKULUM WAKTU 24 JAM"]
        Kamar["KAMAR TIDUR ASRAMA: Pembiasaan Inqiyad (Tidur tepat waktu 21.30 & bangun fajar 03.45)."]
        Madrasah["KELAS MADRASAH: Pembiasaan Intizham (Tugas selesai tepat waktu & Pomodoro 25 menit)."]
        Perpustakaan["PERPUSTAKAAN & HALAQAH: Pembiasaan Tanzhim Zati (Deep Work riset kitab & tahfidz fajar)."]
        Komunitas["ASRAMA & KEPENGASUHAN: Pembiasaan Qudwah (Mengatur waktu adik kelas & keteladanan)."]
        
        Kamar <==> Madrasah <==> Perpustakaan <==> Komunitas
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolKeteraturanEksekutif["PROTOKOL PENDAMPINGAN EKSEKUTIF TIER 2"]
        StepA["1. TEKNIK VISUAL SCHEDULE & LABELING LOKER PRIBADI<br/>• Musyrif membimbing Santri E menempel jadwal pelajaran visual di pintu loker & membagi pakaian dalam wadah berkode."]
        
        StepB["2. RITUAL PENYIAPAN TAS SEBELUM TIDUR (EVENING LAUNCHPAD RITUAL)<br/>• Santri E dilatih menyiapkan seluruh kitab & seragam esok hari pada pukul 21.00 sebelum tidur malam."]
        
        StepC["3. SISTEM CHECKLIST HARIAN (DAILY TASK CHECKLIST) 3 MIKRO-TARGET<br/>• Santri E mencatat 3 target tugas harian di buku saku mutaba'ah & mencentangnya saat selesai."]
        
        StepD["4. PEMULIHAN KETERTIBAN & PRESTASI TENANG<br/>• Dalam 3 pekan, loker Santri E sangat rapi, tidak pernah tertinggal kitab lagi, & meraih nilai disiplin A."]
...
```mermaid
flowchart TD
    subgraph HierarkiTaksonomiWaktuFitrah["EMPAT LEVEL TAKSONOMI MANAJEMEN WAKTU FITRAH"]
        L4["LEVEL 4: AL-BARAKAH WAL QUDWAH (KEPEMIMPINAN EFISIENSI & KARYA BARAKAH)<br/>• Menghasilkan karya ilmiah riset kitab/hafalan Qur'an dengan efisiensi puncak.<br/>• Menjadi figur teladan ketepatan presisi & mengayomi manajemen waktu adik kelas J1."]
        
        L3["LEVEL 3: AT-TANZHIIM AZ-ZATI (PERENCANAAN PRIORITAS OTONOM & DEEP WORK)<br/>• Mampu menyusun time-blocking mingguan mandiri berbasis Matriks Eisenhower.<br/>• Konsisten qiyamul lail, tahfidz fajar 90 menit tanpa distraksi, & qailulah mandiri."]
        
        L2["LEVEL 2: AL-INTIZHAM AL-KHAFIFI (MANAJEMEN TUGAS POMODORO & ANTI-TASWIF)<br/>• Mampu mengeksekusi teknik Pomodoro 25 menit saat belajar mandiri.<br/>• Menyelesaikan seluruh tugas madrasah tepat waktu tanpa menunda (*Zero Procrastination*)."]
        
        L1["LEVEL 1: AL-INQIYAD AZ-ZAMANI (ADAPTASI JADWAL & KEPATUHAN TERBIMBING)<br/>• Mampu menyesuaikan jam tidur 21.30; bangun subuh tepat waktu mengikuti jadwal asrama.<br/>• Menata loker kamar tidur & hadir di madrasah tanpa terlambat."]
...
| :--- | :--- | :--- |
| **Pilar 1: Disiplin Ibadah Awal Waktu** | **SKD-HW-1.1**<br/>**SKD-HW-1.2**<br/>**SKD-HW-1.3** | Menepati waktu hadir di masjid sebelum/saat adzan berkumandang untuk shalat berjamaah.<br/>Konsisten bangun shalat malam (Tahajjud) mandiri di sepertiga malam terakhir.<br/>Menjaga wirid dzikir pagi-petang (Al-Ma'tsurat) dan tilawah Al-Qur'an harian. |
| **Pilar 2: Pengorganisasian Belajar** | **SKD-HW-2.1**<br/>**SKD-HW-2.2**<br/>**SKD-HW-2.3** | Memecah target hafalan Al-Qur'an menjadi target mikro harian (*Atomic Chunking*).<br/>Menerapkan teknik Pomodoro (25 menit belajar + 5 menit istirahat) saat mengkaji pelajaran.<br/>Menyelesaikan 100% tugas madrasah tepat waktu tanpa menunda (*Zero Taswif*). |
| **Pilar 3: Keseimbangan Sirkadian** | **SKD-HW-3.1**<br/>**SKD-HW-3.2**<br/>**SKD-HW-3.3** | Menjaga jadwal tidur malam tepat waktu pukul 21.30 dengan adab hening total.<br/>Melaksanakan sunnah tidur siang (*Qailulah*) 20–30 menit untuk meregenerasi fokus otak.<br/>Menjaga kebersihan dan penataan loker kamar tidur secara mandiri setiap hari. |
| **Pilar 4: Imunitas Distraksi** | **SKD-HW-4.1**<br/>**SKD-HW-4.2**<br/>**SKD-HW-4.3** | Menolak ajakan mengobrol sia-sia (*Laghwi*) saat jam belajar dan jam istirahat malam.<br/>Mampu melakukan *Deep Work* (fokus intensif 90 menit) tanpa terdistraksi gawai.<br/>Mengalokasikan waktu luang untuk hal produktif (membaca kitab, olahraga, khidmah). |
