...
```mermaid
graph TD
    Domain["3 Domain Kompetensi Haritsun 'Ala Waqtih"]
    
    Domain --> K1["1. Kompetensi Kognitif ('Aqliyyah)<br/>- Memahami konsep Matriks Eisenhower (Penting vs Mendesak).<br/>- Mampu memperkirakan waktu pengerjaan tugas & memecah proyek besar."]
    
    Domain --> K2["2. Kompetensi Afektif (Qalbiyyah)<br/>- Merasakan urgensi hisab waktu & menyesali waktu yang terbuang sia-sia.<br/>- Menghargai waktu orang lain dengan tidak membuat orang menunggu."]
    
    Domain --> K3["3. Kompetensi Perilaku (Amaliyyah)<br/>- Hadir 5 menit lebih awal di seluruh kegiatan (The 5-Minute Early Rule).<br/>- Membuat & mengeksekusi jadwal belajar harian (*Daily Planner*)."]
```
