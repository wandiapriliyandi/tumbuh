...
```mermaid
flowchart TD
    subgraph TransformasiFilosofiWaktu["REKONSTRUKSI FILOSOFI MANAJEMEN WAKTU"]
        KrisisWaktu["PARADIGMA PEMBOROSAN WAKTU (TRADISIONAL)<br/>• Budaya menunda tugas (At-Taswīf) & begadang tak berfaedah.<br/>• Waktu luang dianggap kekosongan tanpa hisab syar'i.<br/>• Jam biologis rusak; santri tidur di jam belajar madrasah."]
        
        TUMBUH["HARITSUN 'ALA WAQTIH TUMBUH<br/>• Waktu sebagai modal utama umur (Ra'sul Mal al-Haqiqi).<br/>• Integrasi Kronobiologi Sirkadian & Deep Work Cal Newport.<br/>• Sistem Time-Blocking 24 jam melahirkan pribadi produktif & barakah."]
        
        KrisisWaktu ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsQimatuzZaman["NILAI WAKTU DALAM KHAZANAH TURATS"]
        AbuGhuddah["Syaikh Abdul Fattah Abu Ghuddah (Qimatuz Zaman):<br/>الْوَقْتُ هُوَ الْحَيَاةُ، وَإِنَّ إِضَاعَتَهُ إِضَاعَةٌ لِلْعُمُرِ وَخَسَارَةٌ لِلْأَبَدِ<br/>(Waktu Adalah Kehidupan Itu Sendiri; Menyia-nyiakannya Adalah Kerugian Abadi)"] --> Inti["Hakikat Haritsun 'Ala Waqtih:<br/>Menjaga Setiap Detik Nafas untuk Kemaslahatan Dunia & Akhirat"]
        IbnuJauzi["Ibnu Al-Jauzi (Shaidul Khatir):<br/>Orang yang Memahami Nilai Waktu Tidak Akan Membiarkan Satu Detik pun Berlalu Tanpa Amal"] --> Inti
        HasanBashri["Hasan Al-Bashri:<br/>Wahai Anak Adam, Sesungguhnya Engkau Adalah Kumpulan Hari-Hari; Setiap Kali Berlalu Satu Hari, Hilanglah Sebagian Dirimu!"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsKronobiologiWaktu["KRONOBIOLOGI & NEUROSAINS MANAJEMEN WAKTU"]
        Melatonin["Fase Malam (21.30 - 03.30):<br/>• Puncak sekresi hormon Melatonin; perbaikan sel otak & konsolidasi memori hafalan."]
        
        Kortisol["Fase Fajar & Pagi (04.00 - 11.00):<br/>• Lonjakan Cortisol Awakening Response (CAR); Prefrontal Cortex berada pada fokus analitis puncak (Prime Cognitive Window)."]
        
        DeepWork["Deep Work Protocol (Cal Newport, 2016):<br/>• Belajar bebas distraksi (Blok 90 menit) melipatgandakan kecepatan memahami ilmu & menghafal Qur'an."]
        
        Melatonin & Kortisol & DeepWork ==> JadwalTUMBUH["RITME WAKTU 24 JAM PESANTREN TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph JadwalHarmonis24Jam["STRUKTUR BLOK WAKTU 24 JAM ASRAMA"]
        B1["04.00 - 06.00: BLOK RUHIYAH & FAJAR (Tahajjud Mandiri, Shalat Subuh, & Ziyadah Tahfidz)."]
        B2["07.00 - 12.00: BLOK AKADEMIK PRIMA (Madrasah Formal, Kajian Turats, & Diskusi Kritis)."]
        B3["12.30 - 13.30: BLOK QAILULAH (Tidur Siang 20 Menit & Pemulihan Energi Seluler)."]
        B4["15.30 - 17.30: BLOK FISIK & SOSIAL (Olahraga Sunnah, Kebersihan Kamar, & Apresiasi)."]
        B5["18.00 - 21.00: BLOK HALAQAH & MUROJAAH (Shalat Maghrib-Isya, Halaqah Tazkiyah, & Belajar Mandiri)."]
        B6["21.30 - 03.30: BLOK REGENERASI SIRKADIAN (Tidur Malam Hening Total Tanpa Gadget/Lampu Terang)."]
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiWaktu["PROTOKOL REMEDIASI PROKRASTINASI TIER 2"]
        Step1["1. TEKNIK PEMEMECAHAN TARGET MIKRO (MICRO-HABIT / ATOMIC SHREDDING)<br/>• Target 1 juz/bulan dipecah menjadi 1 halaman/hari (dibagi 5 waktu shalat = 3 baris ba'da shalat)."]
        
        Step2["2. PENERAPAN BLOK POMODORO TAHDZIB 25-5 MENIT<br/>• Santri F belajar dengan timer 25 menit fokus penuh + 5 menit istirahat nafas hening."]
        
        Step3["3. SISTEM CHECK-IN / CHECK-OUT (CICO) BERSAMA KAKAK ASUH J4<br/>• Santri F melaporkan capaian harian setiap ba'da Isya kepada mentor asuhnya."]
        
        Step4["4. PEMULIHAN RITME SIRKADIAN & HAPUSNYA KEPANIKAN UJIAN<br/>• Dalam 4 pekan, seluruh target hafalan tercapai tanpa begadang; Santri F lulus ujian dengan nilai Mumtaz."]
...
```mermaid
flowchart TD
    subgraph ArsitekturFilosofisWaktu["EMPAT PILAR KAPASITAS HARITSUN 'ALA WAQTIH"]
        P1["PILAR 1: KESADARAN MODAL UMUR (RA'SUL MAL)<br/>• Memandang setiap detik sebagai investasi akhirat yang tidak dapat diulang.<br/>• Eliminasi mutlak budaya laghwi (mengobrol tak berfaedah) & scrolling gawai."]
        
        P2["PILAR 2: KETERATURAN RITME SIRKADIAN (AL-INTIZHAM)<br/>• Keselarasan jam tidur (21.30) & jam bangun fajar (03.45).<br/>• Menghidupkan sunnah Qailulah siang hari untuk menjaga ketajaman nalar."]
        
        P3["PILAR 3: PRIORITAS BERBASIS MAQASHID (AULAWIYYAT)<br/>• Kemampuan membedakan hal mendesak vs penting (Urgent vs Important).<br/>• Mengutamakan kewajiban syar'i & target thalabul 'ilmi di atas kesenangan sesaat."]
        
        P4["PILAR 4: KETEKUNAN FOKUS MENDALAM (DEEP WORK / ITQAN)<br/>• Penguasaan teknik fokus intensif tanpa terdistraksi.<br/>• Penyelesaian tugas tepat waktu tanpa menunda (Zero Procrastination)."]
        
        P1 & P2 & P3 & P4 ==> InsanProduktif["SANTRI PRODUKTIF, DISIPLIN, & PENUH BARAKAH"]
    end
```
