...
```mermaid
flowchart TD
    subgraph TransformasiRubrikWaktu["REKONSTRUKSI SISTEM PENILAIAN DISIPLIN WAKTU"]
        PoinNegatif["SISTEM POIN PELANGGARAN NEGATIF (TRADISIONAL)<br/>• Menghukum keterlambatan tanpa menghargai efisiensi.<br/>• Memicu kecemasan santri & motivasi eksternal semu.<br/>• Tanpa deskriptor kematangan perencanaan mandiri."]
        
        TUMBUH["RUBRIK 4-LEVEL HARITSUN 'ALA WAQTIH TUMBUH<br/>• Deskriptor kriteria faktual 4 pilar (Ibadah, Belajar, Sirkadian, Imunitas).<br/>• Pengukuran berbasis bukti observasi 24 jam & logbook mutaba'ah.<br/>• Uji reliabilitas Cohen's Kappa & penilaian pertumbuhan ipsatif."]
        
        PoinNegatif ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMizanulAwqat["TIMBANGAN WAKTU DALAM TURATS"]
        Ghazali["Al-Ghazali (Ihya' - Kitab Tartibul Aurad):<br/>سَاعَاتُ اللَّيْلِ وَالنَّهَارِ أَرْبَعٌ وَعِشْرُونَ سَاعَةً، فَاجْعَلْ لِكُلِّ سَاعَةٍ مِيزَانًا لَا يَخِفُّ فِي الْقِيَامَةِ<br/>(Waktu Sehari Semalam 24 Jam; Jadikan Setiap Jam Memiliki Timbangan Amal yang Berat)"] --> Inti["Mizanul Awqat:<br/>Rubrik Evaluasi Pemanfaatan Modal Umur Secara Presisi"]
        IbnuJauzi["Ibnu Al-Jauzi (Shaidul Khatir):<br/>Membagi Hari Menjadi Tiga Bagian: Sepertiga Menuntut Ilmu, Sepertiga Ibadah, Sepertiga Hak Tubuh"] --> Inti
        AbuGhuddah["Abu Ghuddah (Qimatuz Zaman):<br/>Hisab Harian Ulama Salaf terhadap Detik-Detik yang Berlalu"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPsikometriWaktu["STANDAR PSIKOMETRI RUBRIK HARITSUN 'ALA WAQTIH"]
        IRR["Inter-Rater Reliability (Cohen's Kappa >= 0.89):<br/>• Kesepakatan penilaian antar-musyrif asrama & guru madrasah.<br/>• Kalibrasi deskriptor perilaku manajemen waktu."]
        
        Brookhart["Analytical Rubric Design (Brookhart, 2018):<br/>• Kriteria kualitatif deskriptif berbasis bukti perilaku faktual teramati."]
        
        Ipsative["Ipsative Assessment Standard (Hughes, 2014):<br/>• Mengukur kemajuan efisiensi waktu santri dibandingkan titik awal dirinya."]
        
        IRR & Brookhart & Ipsative ==> RubrikStandar["RUBRIK HARITSUN 'ALA WAQTIH TERVALIDASI"]
    end
```
...
```mermaid
flowchart TD
    subgraph SistemAsesmenWaktu24Jam["INTEGRASI DATA ASESMEN MANAJEMEN WAKTU"]
        DataMusyrif["1. MUSYRIF ASRAMA: Observasi Shalat Subuh, Jam Tidur 21.30, & Kerapian Loker (35%)."]
        DataGuru["2. GURU MADRASAH: Observasi Ketepatan Masuk Kelas & Pengumpulan Tugas (25%)."]
        DataSantri["3. SANTRI MANDIRI: Logbook Time-Blocking, Rekam Tahajjud, & Pomodoro (20%)."]
        DataPeer["4. ULASAN SEBAYA: Peer Review: Menepati Janji Pertemuan & Bebas Begadang (10%)."]
        DataTahfidz["5. PEMBINA TAHFIDZ: Efisiensi Setoran Ziyadah & Muroja'ah Fajar (10%)."]
        
        DataMusyrif & DataGuru & DataSantri & DataPeer & DataTahfidz ==> Dashboard["DASHBOARD WAKTU SANTRI (INTIZHAM-TUMBUH)"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolKalibrasiDisiplin["PROTOKOL KALIBRASI PENILAIAN WAKTU ASRAMA"]
        P1["1. AUDIT DATA LOGBOOK MUTABA'AH 24 JAM SANTRI H<br/>• Menyatukan data: Santri H produktif luar biasa di siang hari, namun memiliki masalah sleep hygiene malam hari."]
        
        P2["2. FORUM SINKRONISASI KEPENGASUHAN & DEWAN GURU<br/>• Menyepakati diagnosa komprehensif: Santri H berada pada Level 2.75 (Kategori Berkembang Menuju Mandiri)."]
        
        P3["3. INTERVENSI TERARAH PADA AKAR MASALAH (SLEEP HYGIENE KAMAR)<br/>• Musyrif membantu Santri H tidur lebih awal pukul 21.15 agar bangun fajar segar tepat waktu."]
        
        P4["4. HASIL EVALUASI ULANG 30 HARI<br/>• Santri H 100% tepat waktu di masjid Subuh & meraih predikat santri teladan waktu seimbang (Level 3.65)."]
...
```mermaid
flowchart TD
    subgraph ArsitekturRubrik4LevelWaktu["EMPAT TINGKAT KEMATANGAN HARITSUN 'ALA WAQTIH"]
        L1["LEVEL 1: PERINTISAN (EMERGING / PERLU BANTUAN JADWAL)<br/>• Sangat bergantung pada bel asrama/teriakan musyrif; sering masbuk shalat Subuh.<br/>• Menunda mengerjakan tugas (Taswif); loker berantakan; begadang mengobrol."]
        
        L2["LEVEL 2: PEMBIASAAN (DEVELOPING / KETERATURAN TERBIMBING)<br/>• Shalat tepat waktu di masjid; tidur pukul 21.30; menerapkan Pomodoro 25 menit.<br/>• Tugas madrasah selesai di hari yang sama; tertib qailulah siang 20 menit."]
        
        L3["LEVEL 3: PEMANTAPAN (PROFICIENT / MANDIRI & EFISIEN)<br/>• Mampu merancang jadwal time-blocking mingguan mandiri berbasis Eisenhower.<br/>• Deep work tahfidz fajar 90 menit; qiyamul lail mandiri 3x seminggu tanpa alarm."]
        
        L4["LEVEL 4: KETELADANAN (EXEMPLARY / QUDWAH BARAKAH)<br/>• Menghasilkan karya riset ilmiah KTI tepat waktu dengan efisiensi belajar puncak.<br/>• Menjadi teladan presisi waktu asrama & membimbing manajemen waktu adik kelas J1."]
