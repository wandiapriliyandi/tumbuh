...
```mermaid
flowchart TD
    subgraph TransformasiIntervensiWaktu["REKONSTRUKSI SISTEM INTERVENSI DISIPLIN WAKTU"]
        HukumanFisik["HUKUMAN FISIK & KEKERASAN (TRADISIONAL)<br/>• Disiram air dingin saat tidur, dipukul sajadah, dijemur.<br/>• Memicu trauma fajar, stres saraf, & kebencian pada ibadah.<br/>• Akar biologis & psikologis keterlambatan terabaikan."]
        
        TUMBUH["ARSITEKTUR MULTI-TIER PBIS TEMPORAL (TUMBUH)<br/>• Tier 1: Jadwal sirkadian 100% santri & sleep hygiene kamar.<br/>• Tier 2: CICO Prokrastinasi, Pomodoro Circle, & mentor J4.<br/>• Tier 3: Individualized Time Reclamation Plan & kronoterapi.<br/>• 0% kekerasan fisik; penegakan konsekuensi logis bermartabat."]
...
```mermaid
flowchart LR
    subgraph TuratsMetodeDisiplinNabawi["METODE DISIPLIN WAKTU NABAWI"]
        HaditsTarghib["HR. Muslim No. 657:<br/>مَنْ صَلَّى الْبَرْدَيْنِ دَخَلَ الْجَنَّةَ<br/>(Barangsiapa Menjaga Dua Shalat Dingin: Subuh & Ashar Tepat Waktu, Pasti Masuk Surga)"] --> Inti["Hakikat Disiplin Positif Syar'i:<br/>Membangun Motivasi Intrinsik Taqwa Menghormati Waktu"]
        IbnuTaimiyyah["Ibnu Taimiyyah (Majmu' Fatawa):<br/>Ta'dib Harus Ditujukan untuk Memperbaiki Jiwa Bukan Melampiaskan Kemarahan"] --> Inti
        Ghazali["Al-Ghazali (Ihya'):<br/>Kelembutan Membimbing Anak Bangun Fajar dengan Doa & Kasih Sayang"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph PiramidaPBISHaritsunWaqtih["PIRAMIDA PBIS MULTI-TIER HARITSUN 'ALA WAQTIH"]
        T1["TIER 1: PENCEGAHAN UNIVERSAL (80–90% Santri)<br/>• Penataan Jadwal Sirkadian Terpadu 24 Jam & Sleep Hygiene Kamar.<br/>• Isyarat Auditori Presisi (Lonceng Lembut 10 Menit Sebelum Waktu).<br/>• Rasio Apresiasi Positif 4:1 bagi Santri Disiplin di Apel Asrama."]
        
        T2["TIER 2: INTERVENSI WAKTU TERARAH (10–15% Santri)<br/>• Program Check-In / Check-Out (CICO) Manajemen Tugas Madrasah.<br/>• Pomodoro Study Circle bagi Santri yang Mengalami Prokrastinasi.<br/>• Mentorship Bangun Fajar Ramah Bersama Kakak Asuh J4."]
        
        T3["TIER 3: REKLAMASI WAKTU INTENSIF (1–5% Santri)<br/>• Individualized Time Reclamation Plan (ITRP) Konselor BK.<br/>• Terapi Kronoterapi Cahaya (Light Therapy) bagi Sleep Inertia Berat.<br/>• Restrukturisasi Jadwal Belajar Mandiri Terbimbing di Poskestren."]
...
```mermaid
flowchart TD
    subgraph RekayasaFasilitasWaktuPresisi["REKAYASA FASILITAS WAKTU ASRAMA"]
        F1["1. SMART-LIGHTING OTOMATIS: Lampu kamar tidur meredup otomatis pukul 21.30 & menyala hangat pukul 03.45."]
        F2["2. KOTAK DROP-ZONE TUGAS MADRASAH: Tempat pengumpulan tugas terpusat di asrama dengan penanda waktu."]
        F3["3. VISUAL TIMELINE BOARD DI SETIAP LORONG ASRAMA: Menampilkan alur kegiatan 24 jam secara jelas."]
        F4["4. CORNER KHIDMAH WAKTU: Tempat pengerjaan sanksi logis edukatif (misal: merapikan perpustakaan)."]
        
        F1 & F2 & F3 & F4 ==> LingkunganDisiplin["IKLIM ASRAMA 100% TERTIB & BEBAS KEKERASAN"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiSleepInertia["PROTOKOL WAKE-UP SCAFFOLDING TIER 3"]
        StepA["1. PENYESUAIAN WAKTU TIDUR MALAM DENGAN SIKLUS TIDUR 90 MENIT<br/>• Waktu tidur Santri Z dimajukan menjadi pukul 21.00 untuk menjamin 4,5 siklus tidur penuh (6,75 jam)."]
        
        StepB["2. PROTOKOL WAKE-UP BERTAHAP 15 MENIT (GRADUAL LIGHT & SOUND)<br/>• Musyrif menyalakan lampu redup pukul 03.30 & memanggil namanya dengan lembut 15 menit sebelum waktu bangun."]
        
        StepC["3. TERAPI HIDRASI SEGERA 1 GELAS AIR HANGAT<br/>• Santri Z diberikan 1 gelas air hangat saat membuka mata untuk mereaktivasi aliran darah ke otak."]
        
        StepD["4. PEMULIHAN KESADARAN SEGAR & SHALAT DENGAN KHUSYUK<br/>• Dalam 10 hari, gejala sleep inertia hilang 100% & Santri Z mampu bangun segar secara mandiri."]
...
```mermaid
flowchart TD
    subgraph TigaLapisPBISHaritsunWaqtih["SISTEM TIGA LAPIS INTERVENSI PBIS HARITSUN 'ALA WAQTIH"]
        subgraph TIER1["TIER 1: PENCEGAHAN UNIVERSAL (100% SANTRI)"]
            T1A["• Jadwal Sirkadian Terpadu 24 Jam & Sleep Hygiene."]
            T1B["• Lonceng Auditori Presisi 10 Menit Sebelum Waktu."]
            T1C["• Budaya Tidur Siang Sunnah Qailulah 20 Menit."]
            T1D["• Apresiasi 4:1 bagi Santri Tepat Waktu di Apel."]
        end
        
        subgraph TIER2["TIER 2: INTERVENSI TERARAH (10–15% SANTRI BERISIKO)"]
            T2A["• Check-In / Check-Out (CICO) Manajemen Tugas."]
            T2B["• Pomodoro Study Circle bagi Prokrastinasi."]
            T2C["• Mentorship Bangun Fajar Ramah Kakak Asuh J4."]
            T2D["• Sistem Visual Task Checklist & Labeling Loker."]
        end
        
        subgraph TIER3["TIER 3: REKLAMASI WAKTU INTENSIF (1–5% SANTRI KRISIS)"]
            T3A["• Individualized Time Reclamation Plan (ITRP)."]
            T3B["• Terapi Kronoterapi Cahaya bagi Sleep Inertia."]
            T3C["• Konseling Kognitif Perilaku (CBT) Mengatasi Fear of Failure."]
            T3D["• Restrukturisasi Siklus Tidur Terbimbing di Poskestren."]
        end
...
| :--- | :--- | :--- | :--- | :--- |
| **Tier 1 (Universal)** | 100% Seluruh Santri Pondok | • Penegakan jadwal tidur sirkadian pukul 21.30.<br/>• Lonceng presisi 10 menit sebelum waktu shalat/belajar.<br/>• Apresiasi penguatan positif 4:1 di apel asrama.<br/>• Budaya tidur siang Qailulah 20 menit di asrama. | Harian & Berkelanjutan sepanjang tahun | Seluruh Musyrif Asrama, Guru Madrasah, & Wali Kamar |
| **Tier 2 (Targeted)** | 10–15% Santri yang sering terlambat shalat fajar atau menunda tugas | • Program CICO (Check-in pagi & Check-out malam).<br/>• Pomodoro Study Circle 4 pekan di perpustakaan.<br/>• Pendampingan bangun fajar bersama kakak asuh J4.<br/>• Checklist visual 3 mikro-target tugas harian. | 3–6 Pekan (Sesi harian 10 menit CICO) | Musyrif Khusus Waktu, Guru Wali Kelas, & Mentor Sebaya J4 |
| **Tier 3 (Intensive)** | 1–5% Santri yang mengalami sleep inertia berat, prokrastinasi kronis | • Individualized Time Reclamation Plan (ITRP).<br/>• Terapi kronoterapi siklus tidur 90 menit & hidrasi fajar.<br/>• Terapi CBT mengatasi kecemasan gagal tugas (*Fear of Failure*).<br/>• Pendampingan medis Poskestren jika ada sleep apnea. | 4–8 Pekan (Hingga ritme pulih stabil) | Konselor BK, Dokter Poskestren, & Kepala Pengasuhan |
