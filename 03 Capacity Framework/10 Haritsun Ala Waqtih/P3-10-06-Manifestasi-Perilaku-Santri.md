...
```mermaid
flowchart TD
    subgraph TransformasiObservasiWaktu["REKONSTRUKSI OBSERVASI PERILAKU WAKTU"]
        Formalitas["OBSERVASI KETERLAMBATAN GERBANG (TRADISIONAL)<br/>• Hanya mencatat santri yang telat masuk kelas.<br/>• Pemborosan waktu luang & melamun terabaikan.<br/>• Tidak membedakan sibuk pura-pura vs Deep Work nyata."]
        
        TUMBUH["OBSERVASI PERILAKU WAKTU TERPADU 24 JAM (TUMBUH)<br/>• Pemetaan perilaku teramati di 5 setting spasial asrama.<br/>• Deteksi dini prokrastinasi, Active Procrastination, & begadang.<br/>• Monitoring Time-Blocking, Pomodoro, & Qailulah mandiri PBIS."]
        
        Formalitas ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsMubadarahKhairat["DOKTRIN BERSEGERA DALAM TURATS"]
        NashSabiq["QS. Al-Baqarah: 148 & Ali 'Imran: 133:<br/>فَاسْتَبِقُوا الْخَيْرَاتِ... وَسَارِعُوا إِلَىٰ مَغْفِرَةٍ مِّن رَّبِّكُمْ<br/>(Berlomba-lombalah dalam Kebaikan & Bersegeralah Menuju Ampunan)"] --> Inti["Manifestasi Perilaku Haritsun 'Ala Waqtih:<br/>Tindakan Spontan Bersegera Memakmurkan Setiap Detik Waktu"]
        IbnuQayyim["Ibnu Qayyim (Madarijus Salikin):<br/>'At-Taswif (Menunda) Adalah Pasukan Iblis Paling Mematikan'"] --> Inti
        AbuGhuddah["Abu Ghuddah (Qimatuz Zaman):<br/>Ulama Membaca Kitab Saat Menunggu Makanan Matang"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPerilakuWaktu["SINTESIS ABA & MODEL ABC MANAJEMEN WAKTU"]
        Antecedent["Antecedent (Isyarat Waktu):<br/>• Adzan berkumandang, bel kelas madrasah, atau batas waktu tugas."]
        
        Behavior["Behavior (Tindakan Teramati):<br/>• (+) Bersegera mengambil wudhu, memulai Pomodoro, mencuci baju terjadwal.<br/>• (-) Mengobrol santai mengabaikan adzan, scrolling gawai, tidur di jam belajar."]
        
        Consequence["Consequence (Respon Sistem):<br/>• (+) Apresiasi santri paling tepat waktu & token penguatan positif 4:1.<br/>• (-) Bimbingan CICO manajemen waktu & penataan jadwal restoratif."]
...
```mermaid
flowchart TD
    subgraph LimaSettingWaktu["LIMA SETTING KRUSIAL MANAJEMEN WAKTU ASRAMA"]
        S1["1. SETTING KAMAR TIDUR ASRAMA<br/>• Perilaku: Tidur tepat pukul 21.30, bangun fajar 03.45, merapikan loker mandiri."]
        
        S2["2. SETTING MASJID & RUANG DZIKIR<br/>• Perilaku: Hadir sebelum adzan/saat adzan, shaf pertama, tilawah ba'da Subuh."]
        
        S3["3. SETTING KELAS MADRASAH<br/>• Perilaku: Duduk siap belajar 5 menit sebelum guru hadir, tugas selesai tepat waktu."]
        
        S4["4. SETTING KANTIN & RUANG MAKAN<br/>• Perilaku: Makan tertib 20 menit, cuci piring mandiri, tidak nongkrong berlama-lama."]
        
        S5["5. SETTING RUANG BELAJAR MANDIRI / PERPUSTAKAAN<br/>• Perilaku: Deep Work fokus 90 menit tanpa distraksi, eksekusi Pomodoro 25 menit."]
        
        S1 & S2 & S3 & S4 & S5 --> Terpadu["EKOSISTEM ASRAMA PRODUKTIF 24 JAM"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolPengalihanWaktu["PROTOKOL PENGALIHAN PRODUKTIF TIER 2"]
        Step1["1. PEMBUBARAN SANTUN NON-BENTAKAN OLEH MUSYRIF PATROLI<br/>• Musyrif menyapa hangat: 'Assalamu'alaikum, antum luar biasa ceria, mari kita alihkan keceriaan ini ke ruang belajar mandiri'."]
        
        Step2["2. PENUGASAN 'STUDY GROUP BLOCK' DI RUANG PERPUSTAKAAN<br/>• Kelompok Santri P diarahkan belajar bersama di perpustakaan dengan target menyelesaikan tugas matematika 45 menit."]
        
        Step3["3. PEMBERIAN REWARD RESTORATIF 'SHARING WAKTU BERKUALITAS'<br/>• Setelah tugas selesai, mereka diberi waktu 15 menit makan camilan bersama musyrif sambil mendiskusikan kisah ulama."]
        
        Step4["4. PEMBENTUKAN KEBIASAAN DEEP STUDY MALAM MANDIRI<br/>• Dalam 2 pekan, Santri P secara otomatis menuju ruang belajar ba'da Isya & nilai akademiknya melonjak drastis."]
...
| :--- | :--- | :--- |
| **1. Disiplin Ibadah Awal Waktu** | • Hadir di masjid sebelum/tepat saat adzan berkumandang.<br/>• Menempati shaf pertama dan membaca Al-Qur'an sambil menunggu iqamah.<br/>• Bangun qiyamul lail (Tahajjud) mandiri pada pukul 03.45 tanpa diseret.<br/>• Membaca dzikir Al-Ma'tsurat pagi dan petang secara khusyuk dan tertib.<br/>• Menjaga shalat Dhuha dan shalat sunnah Rawatib secara rutin. | • Menunggu iqamah baru berjalan santai menuju masjid (masbuk shalat).<br/>• Mengobrol bercanda di serambi masjid saat adzan berkumandang.<br/>• Sangat sulit dibangunkan subuh; menarik selimut kembali setelah dibangunkan.<br/>• Langsung bubar ba'da shalat tanpa membaca wirid dan doa penutup.<br/>• Malas melaksanakan shalat sunnah dan shalat terburu-buru seperti ayam mematuk. |
| **2. Pengorganisasian Belajar Presisi** | • Menerapkan teknik Pomodoro (25 menit fokus penuh + 5 menit rehat).<br/>• Menyelesaikan tugas madrasah pada hari yang sama tugas diberikan (*Zero Taswif*).<br/>• Menyetorkan hafalan Al-Qur'an fajar secara konsisten dan tepat waktu.<br/>• Menata jadwal belajar mingguan mandiri di meja belajar/buku saku.<br/>• Melakukan review
        RuangKelasMadrasah["RUANG KELAS MADRASAH:<br/>• (+) Hadir 5 menit sebelum bel, fokus penuh, tugas selesai tepat waktu.<br/>• (-) Terlambat masuk kelas, mengantuk di meja, prokrastinasi tugas."]
        
        RuangMakanKantin["RUANG MAKAN & KANTIN:<br/>• (+) Makan tertib 20 menit, antre cepat, cuci piring mandiri.<br/>• (-) Nongkrong berlama-lama, makan terburu-buru karena telat bangun."]
        
        RuangBelajarPerpustakaan["RUANG BELAJAR & PERPUSTAKAAN:<br/>• (+) Deep Work 90 menit, Pomodoro 25 menit, riset kitab terarah.<br/>• (-) Melamun di meja, belajar sambil ngobrol, distraksi kebisingan."]
        
        KamarTidurAsrama ~~~ MasjidRuangIbadah ~~~ RuangKelasMadrasah ~~~ RuangMakanKantin ~~~ RuangBelajarPerpustakaan
    end
```
...
| :--- | :--- | :--- |
| **Jenjang J1 (Kelas 7)** | • Menepati jadwal tidur 21.30 dan bangun subuh 03.45 tanpa menangis.<br/>• Menyiapkan buku dan seragam di loker sebelum tidur malam.<br/>• Mengikuti lonceng pergantian kegiatan asrama secara tertib. | • Mengobrol di kasur hingga larut malam; sangat sulit dibangunkan subuh.<br/>• Menunda mencuci piring dan baju hingga menumpuk di kamar mandi.<br/>• Ketinggalan kitab madrasah karena tidak disiapkan malam hari. |
| **Jenjang J2 (Kelas 8–9)** | • Menerapkan teknik Pomodoro (25-5 menit) saat mengerjakan tugas.<br/>• Mengumpulkan seluruh tugas madrasah di hari yang sama tugas diberikan.<br/>• Menjaga kehadiran shalat berjamaah di masjid tepat waktu. | • Menunda belajar hingga malam menjelang ujian (*Cramming/SKS*).<br/>• Nongkrong berjam-jam di lorong asrama saat jam belajar mandiri.<br/>• Menyerobot antrean kamar mandi karena bangun kesiangan. |
| **Jenjang J3 (Kelas 10–11)** | • Merancang jadwal *Time-Blocking* mingguan mandiri berbasis prioritas.<br/>• Melakukan *Deep Work* hafalan Al-Qur'an 90 menit fajar tanpa distraksi.<br/>• Bangun qiyamul lail (Tahajjud) mandiri 3x seminggu tanpa alarm. | • Menggunakan waktu luang untuk hal tidak produktif (*Laghwi* berlebih).<br/>• Menyelesaikan tugas secara asal-asalan demi cepat selesai.<br/>• Mengabaikan waktu istirahat siang Qailulah hingga kelelahan di malam hari. |
| **Jenjang J4 (Kelas 12)** | • Menjadi teladan (*Qudwah*) utama ketepatan waktu bagi seluruh santri.<br/>• Mengelola waktu penyusunan Karya Tulis Ilmiah (KTI) mandiri secara presisi.<br/>• Membimbing santri junior J1 dalam manajemen waktu belajar asrama. | • Merasa senior dan bebas melanggar jadwal tidur asrama.<br/>• Terlambat mengumpulkan draf karya tulis ilmiah akhir.<br/>• Memberi contoh buruk begadang dan bermalas-malasan kepada junior. |
