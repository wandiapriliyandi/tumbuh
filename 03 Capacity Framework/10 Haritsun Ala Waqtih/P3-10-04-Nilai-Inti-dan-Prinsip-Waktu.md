...
```mermaid
flowchart TD
    subgraph RekonstruksiAksiologiWaktu["REKONSTRUKSI NILAI PENGELOLAAN WAKTU"]
        Krisis["KRISIS NILAI WAKTU TRADISIONAL & SEKULER<br/>• Penyakit ketergesaan kapitalistik (Hurry Sickness).<br/>• Budaya jam karet & normalisasi keterlambatan.<br/>• Waktu dipandang materi tanpa nilai hisab akhirat."]
        
        TUMBUH["EMPAT NILAI INTI HARITSUN 'ALA WAQTIH TUMBUH<br/>• Al-Amanah: Menjaga waktu sebagai titipan hisab Ilahi.<br/>• Al-Istiqamah: Konsistensi amal kontinu tanpa putus.<br/>• Al-Injaz al-Mubarak: Produktivitas nyata pembawa barakah.<br/>• Ar-Ri'ayah: Menjaga hak biologis tidur & kesehatan."]
        
        Krisis ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph EmpatAkarNilaiWaktuTurats["EMPAT AKAR NILAI WAKTU DALAM TURATS"]
        N1["1. AL-AMANAH (QS. Al-Mu'minun: 8)<br/>وَالَّذِينَ هُمْ لِأَمَانَاتِهِمْ وَعَهْدِهِمْ رَاعُونَ<br/>(Menjaga Amanah & Janji Waktu)"]
        N2["2. AL-ISTIQAMAH (HR. Muslim No. 38):<br/>قُلْ آمَنْتُ بِاللَّهِ ثُمَّ اسْتَقِمْ<br/>(Katakan: Aku Beriman, Lalu Istiqamahlah!)"]
        N3["3. AL-INJAZ AL-MUBARAK (HR. Al-Bukhari):<br/>أَحَبُّ الْأَعْمَالِ إِلَى اللَّهِ أَدْوَمُهَا وَإِنْ قَلَّ<br/>(Amal Paling Dicintai: Paling Kontinu Meski Sedikit)"]
        N4["4. AR-RI'AYAH (HR. Al-Bukhari No. 1975):<br/>وَإِنَّ لِجَسَدِكَ عَلَيْكَ حَقًّا، وَإِنَّ لِعَيْنِكَ عَلَيْكَ حَقًّا<br/>(Sesungguhnya Tubuh & Matamu Memiliki Hak Istirahat)"]
        
        N1 & N2 & N3 & N4 --> Puncak["HARITSUN 'ALA WAQTIH PARIPURNA"]
    end
```
...
```mermaid
flowchart TD
    subgraph SainsIntegritasTemporal["SINTESIS ETIKA INTEGRITAS TEMPORAL"]
        Integrity["Temporal Integrity Theory (Schabracq, 2003):<br/>• Kemampuan individu menepati komitmen waktu sebagai fondasi kepercayaan sosial & efisiensi kerja."]
        
        Flow["Flow State Theory (Mihaly Csikszentmihalyi):<br/>• Kenikmatan psikologis puncak saat seseorang fokus penuh pada tugas bermakna tanpa terdistraksi."]
        
        Virtue["Virtue Ethics (Aristoteles - Miskawaih):<br/>• Disiplin waktu sebagai kebajikan karakter internal yang memancarkan keteraturan hidup."]
        
        Integrity & Flow & Virtue ==> NilaiStandar["AKSIOLOGI WAKTU TERPADU TUMBUH"]
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaEkologiNilaiWaktu["PENERAPAN NILAI WAKTU DI ASRAMA"]
        KamarTidur["1. SETTING KAMAR ASRAMA: Praktik Ar-Ri'ayah (Tidur Tepat Pukul 21.30 & Hening Total)."]
        Masjid["2. SETTING MASJID: Praktik Al-Amanah (Hadir di Masjid Sebelum Adzan & Dzikir Khusyuk)."]
        RuangKelas["3. SETTING KELAS MADRASAH: Praktik Al-Istiqamah (Fokus Penuh & Mengerjakan Tugas Tepat Waktu)."]
        Kantin["4. SETTING KANTIN/KOPERASI: Praktik Al-Injaz (Makan Secukupnya & Tidak Menghabiskan Waktu Nongkrong)."]
        
        KamarTidur ~~~ Masjid ~~~ RuangKelas ~~~ Kantin
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRestorasiAmanahMusyrif["PROTOKOL RESTORASI AMANAH WAKTU TIER 2"]
        Fase1["1. DIALOG RESTORATIF BERSAMA KEPALA PENGASUHAN (DIRECT ACCOUNTABILITY)<br/>• Kepala Pengasuhan membedah hadits amanah waktu & dampak keterlambatan terhadap psikologi santri."]
        
        Fase2["2. PERMINTAAN MAAF TERBUKA KEPADA SANTRI ASRAMA (HUMBLE APOLOGY)<br/>• Ustadz T secara ksatria meminta maaf kepada seluruh santri halaqah: 'Ustadz khilaf terlambat, ustadz berjanji hadir 5 menit sebelum waktu'."]
        
        Fase3["3. PENEGAKAN RESTITUSI WAKTU (TIME RESTITUTION)<br/>• Ustadz T mengganti waktu yang hilang dengan memberikan sesi mentoring privat tahfidz tambahan ba'da Subuh."]
        
        Fase4["4. KETELADANAN PRESISI WAKTU BERKELANJUTAN<br/>• Dalam 60 hari, Ustadz T selalu menjadi yang pertama hadir di ruang halaqah & menjadi teladan waktu asrama."]
...
```mermaid
flowchart TD
    subgraph FormulasiEmpatNilaiWaktu["STRUKTUR AKSIOLOGIS EMPAT NILAI WAKTU"]
        Amanah["1. AL-AMANAH AZ-ZAMANIYYAH (INTEGRITAS WAKTU ILIHI)<br/>• Memandang waktu sebagai titipan yang akan dihisab Allah SWT.<br/>• Menepati janji waktu secara presisi & menghormati waktu orang lain."]
        
        Istiqamah["2. AL-ISTIQAMAH (KONSISTENSI AMAL BERKELANJUTAN)<br/>• Membangun rutinitas harian mikro tanpa pernah terputus.<br/>• Menjaga ritme tahfidz fajar & qiyamul lail secara mandiri."]
        
        Injaz["3. AL-INJAZ AL-MUBARAK (PRODUKTIVITAS PEMBAWA BARAKAH)<br/>• Berorientasi pada karya nyata thalabul 'ilmi yang bermanfaat.<br/>• Menghindari budaya menunda tugas (*Taswif*) & obrolan kosong (*Laghwi*)."]
        
        Riayah["4. AR-RI'AYAH AS-SIRKADIYYAH (PENJAGAAN HAK BIOLOGIS RAGA)<br/>• Menjaga jam tidur malam sirkadian (21.30) & menghidupkan Qailulah.<br/>• Menjauhi begadang sia-sia & menjaga kesegaran stamina tubuh."]
        
        Amanah & Istiqamah & Injaz & Riayah ==> Mahkota["HARITSUN 'ALA WAQTIH PARIPURNA"]
    end
```
...
```mermaid
flowchart LR
    J1["J1 (KELAS 7)<br/>Nilai Kepatuhan & Amanah<br/>• Mengikuti lonceng asrama<br/>• Menepati jam tidur 21.30<br/>• Shalat tepat waktu"]
    --> J2["J2 (KELAS 8–9)<br/>Nilai Istiqamah & Injaz<br/>• Menghindari taswif tugas<br/>• Rutin muroja'ah tahfidz<br/>• Membagi waktu mandiri"]
    --> J3["J3 (KELAS 10–11)<br/>Nilai Integritas Otonom<br/>• Deep work fokus 90 menit<br/>• Menolak laghwi kamar<br/>• Menjaga tahajjud mandiri"]
    --> J4["J4 (KELAS 12)<br/>Qudwah Efisiensi & Barakah<br/>• Manajemen KTI mandiri<br/>• Membimbing waktu adik kelas<br/>• Teladan ketepatan presisi"]
```
...
Penerapan konsep **P3-10-04: NILAI INTI DAN PRINSIP HARITSUN ALA WAQTIH** di ekosistem pesantren berbasis sistem TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
