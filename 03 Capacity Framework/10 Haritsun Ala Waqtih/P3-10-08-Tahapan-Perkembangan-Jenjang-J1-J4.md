...
```mermaid
flowchart TD
    subgraph TransformasiTrajektoriWaktu["REKONSTRUKSI TRAJEKTORI MANAJEMEN WAKTU"]
        Seragam["PENYERAGAMAN MEKANISTIK (TRADISIONAL)<br/>• Tuntutan waktu sama rata dari kelas 7 s/d 12.<br/>• Tanpa scaffolding visual bagi santri baru.<br/>• Kelas 12 tidak dilatih otonomi; kaget saat kuliah."]
        
        TUMBUH["TRAJEKTORI WAKTU FITRAH J1–J4 TUMBUH<br/>• J1: Adaptasi sirkadian, lonceng, & rutinitas terbimbing.<br/>• J2: Eliminasi prokrastinasi, Pomodoro, & jadwal cuci.<br/>• J3: Time-blocking mandiri, deep work, & Qailulah.<br/>• J4: Otonomi riset KTI, mentorship adik kelas, & qudwah."]
...
```mermaid
flowchart LR
    subgraph TuratsMaratibTaklifWaktu["TAHAPAN TAKLIF WAKTU DALAM TURATS"]
        HaditsShalat["HR. Abu Dawud No. 495:<br/>مُرُوا أَوْلَادَكُمْ بِالصَّلَاةِ وَهُمْ أَبْنَاءُ سَبْعِ سِنِينَ، وَاضْرِبُوهُمْ عَلَيْهَا وَهُمْ أَبْنَاءُ عَشْرٍ<br/>(Latihlah Anakmu Shalat Sejak 7 Tahun & Tegakkan Disiplin Sejak 10 Tahun)"] --> Inti["Pentahapan Manajemen Waktu Syar'i:<br/>Dari Pembiasaan Terbimbing Menuju Tanggung Jawab Mukallaf Mandiri"]
        Ghazali["Al-Ghazali (Ihya' - Tarbiyatul Aulad):<br/>Membiasakan Anak Bangun Pagi Sejak Dini Agar Menjadi Karakter Otomatis"] --> Inti
        Syathibi["Asy-Syathibi (Al-Muwafaqat):<br/>Taklif Berkembang Seiring Pertumbuhan Akal & Kesiapan Raga"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsMaturasiTemporal["MATURASI NEUROSAINS FUNGSI EKSEKUTIF TEMPORAL"]
        J1PFC["Jenjang J1 (Usia 12–13 Thn):<br/>• Prefrontal Cortex awal; membutuhkan bantuan isyarat visual eksternal (Checklist & Lonceng)."]
        
        J2PFC["Jenjang J2 (Usia 13–15 Thn):<br/>• Peningkatan Working Memory; mampu menerapkan teknik Pomodoro 25 menit secara mandiri."]
        
        J3PFC["Jenjang J3 (Usia 15–17 Thn):<br/>• Pematangan Future Time Perspective; mampu menyusun rencana mingguan berbasis Eisenhower."]
        
        J4PFC["Jenjang J4 (Usia 17–18 Thn):<br/>• Kematangan Executive Function; mampu mengelola proyek jangka panjang (KTI) & time-mastery."]
        
        J1PFC --> J2PFC --> J3PFC --> J4PFC
    end
```
...
```mermaid
flowchart TD
    subgraph RekayasaKurikulumWaktuJ1J4["REKAYASA KURIKULUM WAKTU BERBASIS TAHAPAN USIA"]
        KurikulumJ1["J1: 70% Pembiasaan Rutinitas Sirkadian, Adaptasi Tidur 21.30, & Checklist Visual Loker."]
        KurikulumJ2["J2: 60% Eliminasi Prokrastinasi, Pelatihan Pomodoro, & Manajemen Tugas Madrasah."]
        KurikulumJ3["J3: 70% Perencanaan Prioritas Matriks Eisenhower, Deep Work Fajar 90 Menit, & Tahajjud Mandiri."]
        KurikulumJ4["J4: 80% Manajemen Riset KTI Mandiri, Mentorship Manajemen Waktu Adik Kelas J1, & Qudwah."]
...
```mermaid
flowchart TD
    subgraph ProtokolBackwardPlanning["PROTOKOL REMEDIASI PERENCANAAN MUNDUR TIER 2"]
        Step1["1. TEKNIK BACKWARD TIME-PLANNING (PERENCANAAN DARI HARI-H MUNDUR)<br/>• Santri S dilatih memetakan tanggal ujian akhir & menghitung mundur jumlah pekan yang tersedia."]
        
        Step2["2. PEMBAGIAN BEBAN MATERI KE BLOK BELAJAR HARIAN (CHUNKING MATRIX)<br/>• 5 kitab (total 500 halaman) dipecah menjadi 5 halaman per hari selama 100 hari semester berjalan."]
        
        Step3["3. MONITORING MINGGUAN PROGRESS BOARD BERSAMA PEMBINA ASRAMA<br/>• Santri S menempel grafik kemajuan membaca kitab di meja belajarnya & diverifikasi musyrif setiap Ahad malam."]
        
        Step4["4. HASIL EVALUASI SEMESTER BERIKUTNYA<br/>• Santri S menyelesaikan seluruh bacaan kitab 2 pekan sebelum ujian & meraih peringkat pertama tanpa begadang."]
...
```mermaid
flowchart TD
    subgraph ArsitekturTrajektoriWaktuJ1J4["TRAJEKTORI PERKEMBANGAN WAKTU LENGKAP J1–J4"]
        J1["JENJANG J1: FASE ADAPTASI SIRKADIAN & RUTINITAS TERBIMBING (KELAS 7)<br/>• Karakteristik: Transisi masa kanak-kanak; butuh isyarat lonceng & checklist.<br/>• Target: Adaptasi jam tidur 21.30, bangun fajar 03.45 mandiri, loker tertib."]
        
        J2["JENJANG J2: FASE ELIMINASI PROKRASTINASI & POMODORO (KELAS 8–9)<br/>• Karakteristik: Rentan tergoda nongkrong sebaya; lonjakan hormon pubertas.<br/>• Target: Eksekusi Pomodoro 25 menit, tugas selesai di hari yang sama, antre tertib."]
        
        J3["JENJANG J3: FASE PRIORITAS OTONOM & DEEP WORK (KELAS 10–11)<br/>• Karakteristik: Pematangan nalar prioritas; dorongan kemandirian belajar.<br/>• Target: Time-blocking mingguan mandiri, deep work tahfidz fajar 90 menit, qailulah."]
        
        J4["JENJANG J4: FASE MASTER PRODUKTIVITAS & QUDWAH BARAKAH (KELAS 12)<br/>• Karakteristik: Kematangan fungsi eksekutif penuh; kesiapan hidup mandiri.<br/>• Target: Riset KTI mandiri tuntas tepat waktu, bimbing manajemen waktu adik kelas J1."]
...
```mermaid
flowchart TD
    subgraph UjiKemandirianWaktuTransisi["PROTOKOL EVALUASI TRANSISI MANAJEMEN WAKTU"]
        Uji1["1. AUDIT REKAM KEHADIRAN SHALAT BERJAMAAH & SIRKADIAN (MINIMAL 95% TEPAT WAKTU)"]
        Uji2["2. UJI KETUNTASAN PENGUMPULAN TUGAS MADRASAH & SETORAN TAHFIDZ TANPA TERLAMBAT"]
        Uji3["3. SIDANG PRESENTASI PORTOFOLIO TIME-BLOCKING MINGGUAN MANDIRI (BAGI J3 MENJELANG J4)"]
        Uji4["4. VERIFIKASI KEMAMPUAN MEMBIMBING JADWAL ADIK ASUH J1 (BAGI SANTRI J4)"]
