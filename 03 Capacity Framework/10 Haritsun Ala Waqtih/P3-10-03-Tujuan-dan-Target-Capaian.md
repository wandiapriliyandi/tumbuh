...
```mermaid
flowchart TD
    subgraph TransformasiTargetWaktu["REKONSTRUKSI TARGET CAPAIAN MANAJEMEN WAKTU"]
        Absensi["TARGET ABSENSI PASIF (TRADISIONAL)<br/>• 'Pokoknya hadir di kelas & tidak terlambat'.<br/>• Tanpa pengukuran fokus mendalam & efisiensi tugas.<br/>• Santri kelas 12 masih harus diseret ke masjid."]
        
        TUMBUH["TARGET CAPAIAN HARITSUN 'ALA WAQTIH (TUMBUH)<br/>• Capaian Pembelajaran (CP-HW) berbasis Tri-Domain Fitrah.<br/>• Target Time-Blocking, eliminasi prokrastinasi, & Qailulah.<br/>• Matriks capaian berjenjang J1–J4 melahirkan insan mandiri."]
        
        Absensi ==>|DIREKONSTRUKSI MENJADI| TUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TuratsTargetWaktuSalaf["DISIPLIN WAKTU SALAFUSH SHALIH"]
        KhatibBaghdadi["Al-Khatib Al-Baghdadi (Al-Jami'):<br/>Para Ahli Hadits Membaca Kitab di Sepanjang Perjalanan Berjalan Kaki"] --> Inti["Target Capaian Haritsun 'Ala Waqtih:<br/>Pemanfaatan Setiap Detik Umur Menjadi Karya Peradaban"]
        IbnuAqil["Ibnu 'Aqil Al-Hanbali (Kitab Al-Funun 800 Jilid):<br/>'Aku Tidak Mengizinkan Diriku Menyia-nyiakan Satu Jam Saja dari Umurku!'"] --> Inti
        Nawawi["Imam An-Nawawi:<br/>Menghadiri 12 Majelis Ilmu Setiap Hari Tanpa Pernah Terlambat Satu Menit pun"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph StandarTMBSdanWaktuIslam["SINTESIS KERANGKA KERJA TMBS & TARTIBUL AWQAT"]
        TMBS["TMBS Framework (Macan, 1990):<br/>1. Setting goals and priorities (Penetapan Sasaran & Prioritas)<br/>2. Mechanics of time management (Teknik Time-Blocking & To-Do List)<br/>3. Preference for organization (Keteraturan Jadwal Harian)<br/>4. Perceived control of time (Persepsi Kendali atas Waktu)"]
        
        Tartib["Khazanah Tartibul Awqat Islam:<br/>Shalat Awwalul Waqt, Ziyadah Tahfidz Fajar, Qailulah Siang, & Qiyamul Lail."]
        
        TMBS & Tartib ==> TargetTUMBUH["TARGET KUANTITATIF-KUALITATIF HARITSUN 'ALA WAQTIH"]
    end
```
...
```mermaid
flowchart TD
    subgraph IsyaratWaktuLingkungan24Jam["ISYARAT WAKTU LINGKUNGAN ASRAMA"]
        Lonceng["1. ISYARAT AUDITORI PRESISI (CHIME/ADZAN): Nada lonceng lembut 10 menit sebelum waktu shalat/belajar."]
        JamDinding["2. JAM DINDING ANALOG DI SETIAP RUANG & KAMAR: Membangun kesadaran temporal visual yang konstan."]
        LampuOtomatis["3. LAMPU SMART-LIGHTING OTOMATIS: Lampu redup pukul 21.30 menandai dimulainya jam tidur hening."]
        PapanTarget["4. PAPAN TIME-BLOCKING KAMAR: Menampilkan jadwal giliran piket & target tahfidz mingguan."]
        
        Lonceng ~~~ JamDinding ~~~ LampuOtomatis ~~~ PapanTarget
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolRemediasiSubuh["PROTOKOL RESET SIRKADIAN FAJAR TIER 2"]
        Step1["1. PENEGAKAN SLEEP HYGIENE PROTOCOL KAMAR TIDUR ASRAMA<br/>• Santri B diwajibkan mematikan lampu & bersiap tidur tepat pukul 21.15 (Minum air hangat & membaca doa)."]
        
        Step2["2. MENTORSHIP BANGUN FAJAR BERSAMA KAKAK ASUH J4<br/>• Kakak asuh J4 membangunkan Santri B dengan sapaan hangat pukul 03.45 & mengajaknya cuci muka air dingin."]
        
        Step3["3. AKTIVITAS TERAPI CAHAYA MATAHARI PAGI (LIGHT EXPOSURE)<br/>• Santri B diajak jalan pagi & olahraga peregangan 15 menit ba'da Subuh untuk menekan sekresi melatonin."]
        
        Step4["4. PEMULIHAN RITME BANGUN MANDIRI & PRESTASI TEPAT WAKTU<br/>• Dalam 2 pekan, Santri B mampu bangun mandiri pukul 03.45 tanpa dibangunkan & 100% shalat Subuh di shaf terdepan."]
...
```mermaid
flowchart TD
    subgraph StrukturTargetCPHW["STRUKTUR TARGET CAPAIAN PEMBELAJARAN (CP-HW)"]
        CP["CAPAIAN PEMBELAJARAN INDUK HARITSUN 'ALA WAQTIH"]
        
        T1["Target Pilar 1: Disiplin Ibadah Awal Waktu<br/>• Kehadiran Shalat Berjamaah Tepat Waktu >= 98%.<br/>• Qiyamul Lail Mandiri di Sepertiga Malam."]
        
        T2["Target Pilar 2: Manajemen Belajar Presisi<br/>• Pengumpulan 100% Tugas Madrasah Tepat Waktu.<br/>• Pencapaian Target Hafalan Al-Qur'an Konsisten."]
        
        T3["Target Pilar 3: Keseimbangan Sirkadian<br/>• Tidur Tepat Pukul 21.30 & Qailulah Siang 20 Menit.<br/>• 0% Santri Tertidur di Jam Belajar Madrasah."]
        
        T4["Target Pilar 4: Imunitas Distraksi<br/>• 0% Waktu Terbuang untuk Laghwi/Game Ilegal.<br/>• Penguasaan Teknik Deep Work Fokus Penuh."]
...
```mermaid
flowchart LR
    subgraph TargetProgresiWaktuJ1J4["PETA TARGET CAPAIAN MANAJEMEN WAKTU J1–J4"]
        J1["J1 (KELAS 7): ADAPTASI JADWAL & RUTINITAS ASRAMA<br/>Target: Adaptasi jam tidur 21.30, bangun subuh mandiri, merapikan loker."]
        --> J2["J2 (KELAS 8–9): ELIMINASI PROKRASTINASI & POMODORO<br/>Target: Eksekusi Pomodoro 25 menit, 0% tugas menunda, atur waktu cuci baju."]
        --> J3["J3 (KELAS 10–11): PRIORITAS OTONOM & DEEP WORK<br/>Target: Time-blocking mandiri, deep work tahfidz fajar, konsisten Qailulah."]
        --> J4["J4 (KELAS 12): KEPEMIMPINAN PRODUKTIF & QUDWAH<br/>Target: Manajemen riset ilmiah mandiri, bimbing adik kelas, teladan barakah."]
    end
```
...
| :--- | :--- | :--- |
| **Jenjang J1 (Kelas 7)** | • Mampu menyesuaikan diri dengan jadwal tidur asrama pukul 21.30 dalam 2 pekan.<br/>• Bangun tidur pukul 03.45 dan siap di masjid sebelum adzan Subuh.<br/>• Melaksanakan tidur siang sunnah Qailulah 20 menit secara tertib. | • Mengikuti seluruh jadwal belajar madrasah dan halaqah tanpa terlambat.<br/>• Menata buku pelajaran dan pakaian di loker sesuai jadwal harian.<br/>• Tidak menggunakan waktu istirahat untuk mengobrol hingga melanggar jam tidur. |
| **Jenjang J2 (Kelas 8–9)** | • Menjaga shalat fardhu berjamaah di shaf pertama secara konsisten.<br/>• Menghidupkan shalat Dhuha dan shalat Rawatib ba'diyah/qabliyah.<br/>• Kualitas tidur malam prima (0% catatan mengantuk di kelas pagi). | • Menerapkan teknik Pomodoro (25 menit belajar + 5 menit istirahat) saat belajar mandiri.<br/>• Menyelesaikan tugas madrasah pada hari tugas tersebut diberikan (*Zero Taswif*).<br/>• Mengatur jadwal mencuci pakaian dan kebersihan kamar tanpa menumpuk cucian. |
| **Jenjang J3 (Kelas 10–11)** | • Bangun shalat malam (Tahajjud) mandiri minimal 3x seminggu tanpa alarm/musyrif.<br/>• Memanfaatkan waktu antara Maghrib dan Isya untuk muroja'ah tahfidz intensif.<br/>• Membimbing santri junior J1 dalam disiplin waktu shalat berjamaah. | • Merancang jadwal *Time-Blocking* mingguan mandiri berbasis Matriks Eisenhower.<br/>• Mampu melakukan *Deep Work* (fokus intensif 90 menit) tanpa terdistraksi.<br/>• Memiliki imunitas mutlak menolak ajakan mengobrol sia-sia saat jam belajar. |
| **Jenjang J4 (Kelas 12)** | • Menjadi teladan (*Qudwah*) utama ketepatan waktu bagi seluruh santri asrama.<br/>• Memimpin qiyamul lail berjamaah dan tilawah Al-Qur'an fajar berkah.<br/>• Menampilkan ketenangan batin (*Sakinah*) dalam seluruh aktivitas hidup. | • Mengelola waktu penyusunan karya tulis ilmiah akhir (*KTI Santri*) secara mandiri.<br/>• Mengatur waktu antara belajar ujian akhir, khidmah mengasuh adik kelas, dan istirahat.<br/>• Memiliki efisiensi belajar sangat tinggi yang menghasilkan karya nyata peradaban. |
...
Penerapan konsep **P3-10-03: TUJUAN DAN TARGET CAPAIAN HARITSUN ALA WAQTIH** di ekosistem pesantren TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
