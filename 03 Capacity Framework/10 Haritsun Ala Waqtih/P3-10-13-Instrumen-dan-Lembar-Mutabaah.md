...
```mermaid
flowchart TD
    subgraph TransformasiInstrumentasiWaktu["REKONSTRUKSI INSTRUMENTASI MANAJEMEN WAKTU"]
        TanpaInstrumen["EVALUASI ABSENSI TANPA REKAM OUTPUT (TRADISIONAL)<br/>• Tidak ada logbook time-blocking & rekam Pomodoro.<br/>• Hukuman keterlambatan tanpa formulir restitusi waktu.<br/>• Nilai kedisiplinan hanya berdasarkan impresi musyrif."]
        
        TUMBUH["PAKET INSTRUMEN MASTER WAKTU (TUMBUH)<br/>• LOF-HW: Lembar observasi keteraturan waktu asrama.<br/>• LTB-HW: Logbook time-blocking & Pomodoro tracker mandiri.<br/>• FAR-HW: Formulir audit waktu & restitusi edukatif.<br/>• SPK-HW: Skala persepsi kontrol waktu santri BK."]
...
```mermaid
flowchart LR
    subgraph TuratsJadwalTertulis["TRADISI JADWAL MUTABA'AH SALAF"]
        Ghazali["Al-Ghazali (Bidayatul Hidayah):<br/>Merinci Pembagian Jam Fajar, Dhuha, Zhuhur, Ashar, Maghrib, Isya, & Sepertiga Malam"] --> Inti["Hakikat Mutaba'ah Waktu:<br/>Audit Harian Keteraturan Amal Menuju Ridha Ilahi"]
        IbnuQayyim["Ibnu Qayyim (Zadul Ma'ad):<br/>Petunjuk Nabi SAW dalam Menata Waktu Tidur, Ibadah, & Muamalah"] --> Inti
        AbuGhuddah["Abu Ghuddah (Qimatuz Zaman):<br/>Dokumentasi Jadwal Harian Ulama Salaf Jam per Jam"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsPengukuranWaktu["VALIDITAS INSTRUMEN HARITSUN 'ALA WAQTIH"]
        Construct["Construct Validity (Aiken's V >= 0.95):<br/>• Uji validitas isi oleh pakar manajemen waktu, kronobiologi, & ahli PBIS."]
        
        EMA["Ecological Momentary Assessment (Stone & Shiffman):<br/>• Pencatatan data waktu pada setting nyata 24 jam mengurangi recall bias."]
        
        TimeTracking["Time-Tracking Precision Standard:<br/>• Formulir LTB-HW terstandarisasi teknik Pomodoro & Time-Blocking modern."]
        
        Construct & EMA & TimeTracking ==> InstrumenStandar["PAKET INSTRUMEN WAKTU TERSTANDARISASI"]
    end
```
...
```mermaid
flowchart TD
    subgraph AlurMutabaahWaktu24Jam["ALUR MUTABA'AH MANAJEMEN WAKTU 24 JAM"]
        SantriIsi["1. SANTRI MENGISI LTB-HW: Mencatat jadwal time-blocking, eksekusi Pomodoro, & checklist Evening Launchpad."]
        MusyrifCek["2. MUSYRIF MEMVALIDASI LOF-HW: Memeriksa absensi Subuh, jam tidur 21.30, & paraf mingguan."]
        GuruMadrasah["3. GURU MENGISI REKAM TUGAS: Memverifikasi ketepatan waktu pengumpulan tugas di madrasah."]
...
```mermaid
flowchart TD
    subgraph ProtokolRestorasiWaktuJujur["PROTOKOL RESTORASI KEJUJURAN WAKTU TIER 2"]
        Step1["1. DIALOG RESTORATIF PRIVAT 'WAKTU MILIK ALLAH BUKAN UNTUK CENTANG'<br/>• Musyrif membedah hakikat kejujuran hisab waktu & bahaya kebohongan batin secara hangat."]
        
        Step2["2. RESET TARGET BELAJAR DENGAN SIKLUS POMODORO REALISTIS DI RUANG BELAJAR<br/>• Santri U diarahkan belajar di ruang belajar bersama dengan target 2 siklus Pomodoro (50 menit) nyata."]
        
        Step3["3. MENTORSHIP BELAJAR BERSAMA KAKAK ASUH J4<br/>• Kakak asuh J4 mendampingi Santri U belajar di perpustakaan secara fokus & saling memverifikasi waktu."]
        
        Step4["4. PEMULIHAN KEJUJURAN MANAJEMEN WAKTU & PRESTASI NYATA<br/>• Dalam 3 pekan, Santri U mampu belajar mandiri secara jujur & mencatat logbook waktu apa adanya."]
...
```mermaid
flowchart TD
    subgraph EmpatInstrumenMasterWaktu["EMPAT INSTRUMEN MASTER HARITSUN 'ALA WAQTIH"]
        LOF["1. FORM LOF-HW (LEMBAR OBSERVASI KETERATURAN WAKTU ASRAMA)<br/>• Target: Musyrif Asrama & Guru Madrasah.<br/>• Fungsi: Menilai shalat Subuh, jam tidur 21.30, Evening Launchpad, & ketepatan kelas."]
        
        LTB["2. FORM LTB-HW (LOGBOOK TIME-BLOCKING & POMODORO TRACKER)<br/>• Target: Santri Mandiri.<br/>• Fungsi: Mencatat blok waktu harian, eksekusi Pomodoro, tahfidz fajar, & qailulah."]
        
        FAR["3. FORM FAR-HW (FORMULIR AUDIT WAKTU & RESTITUSI EDUKATIF)<br/>• Target: Dewan Pengasuhan & Guru Wali Kelas.<br/>• Fungsi: Berita acara audit keterlambatan, analisis akar masalah, & pakta restitusi."]
        
        SPK["4. FORM SPK-HW (SKALA PERSEPSI KONTROL WAKTU SANTRI)<br/>• Target: Konselor BK & Psikolog.<br/>• Fungsi: Mengukur tingkat perceived control of time, prokrastinasi, & stres jadwal."]
