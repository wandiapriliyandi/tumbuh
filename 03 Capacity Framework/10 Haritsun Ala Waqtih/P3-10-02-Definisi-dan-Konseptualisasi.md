...
```mermaid
flowchart TD
    subgraph DialektikaManajemenWaktu["DIALEKTIKA KONSEPTUAL PENGELOLAAN WAKTU"]
        KutubA["KUTUB HUSTLE SEKULER (TOXIC PRODUCTIVITY)<br/>• Belajar tanpa tidur, eksploitasi tubuh, mengabaikan ketenangan hati.<br/>• Akibat: Kelelahan saraf (Burnout), stres akut, & hilangnya khusyuk."]
        
        KutubB["KUTUB KEMALASAN FATALISTIK (SLOW LIVING NEGATIF)<br/>• Menunda tugas (Taswif), mengobrol sia-sia (Laghwi), & santai tanpa target.<br/>• Akibat: Kebodohan, hafalan hilang, & penyesalan umur."]
        
        TUMBUH["HARITSUN 'ALA WAQTIH TUMBUH (AL-WASATHIYYAH)<br/>• Manajemen waktu presisi berbasis fungsi eksekutif otak & Maqashid Syari'ah.<br/>• Keseimbangan antara ibadah awal waktu, belajar mendalam, & tidur sirkadian.<br/>• Menghadirkan produktivitas tinggi berbalut keberkahan Ilahi."]
...
```mermaid
flowchart LR
    subgraph TuratsTartibulAwqat["PENAATAN JADWAL WAKTU DALAM TURATS"]
        Ghazali["Al-Ghazali (Ihya' - Tartibul Aurad):<br/>يَنْبَغِي لَكَ أَنْ تُوَزِّعَ أَوْقَاتَكَ، وَتُرَتِّبَ أَوْرَادَكَ، وَتُعَيِّنَ لِكُلِّ وَقْتٍ شُغْلًا لَا تُزَاحِمُهُ فِيهِ<br/>(Bagi Waktumu, Tata Jadwalmu, & Tetapkan Tugas Tertentu pada Setiap Waktu)"] --> Inti["Tartibul Awqat Syar'i:<br/>Struktur Jadwal Presisi Menghilangkan Kesemrawutan Hidup"]
        Zarnuji["Az-Zarnuji (Ta'limul Muta'allim):<br/>Memanfaatkan Waktu Malam & Fajar untuk Menghafal"] --> Inti
        Syathibi["Asy-Syathibi (Al-Muwafaqat):<br/>Menjaga Waktu Bagian dari Menjaga Agama & Akal"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph MatriksPrioritasIslam["MATRIKS PRIORITAS SYAR'I (EISENHOWER-MAQASHID)"]
        K1["KUADRAN 1: MENDESAK & PENTING (DHARURIYYAT)<br/>• Shalat fardhu di awal waktu, ujian madrasah, & kondisi darurat kesehatan asrama."]
        
        K2["KUADRAN 2: TIDAK MENDESAK TAPI SANGAT PENTING (HAJIYYAT / TAHFIDZ)<br/>• Menambah hafalan Qur'an, belajar mendalam (Deep Work), olahraga, & tahajjud."]
        
        K3["KUADRAN 3: MENDESAK TAPI TIDAK PENTING (DISTRAKSI)<br/>• Ajakan mengobrol santri lain saat jam belajar, interupsi kebisingan kamar."]
        
        K4["KUADRAN 4: TIDAK MENDESAK & TIDAK PENTING (LAGHWI / HARAM)<br/>• Scrolling media sosial berjam-jam, game online ilegal, & ghibah kamar tidur."]
        
        K1 & K2 & K3 & K4 ==> Solusi["FOKUS UTAMA SANTRI: KUADRAN 2 (ZONA PRESTASI & BARAKAH)"]
    end
```
...
```mermaid
flowchart TD
    subgraph ZonasiWaktuAsrama["ZONASI WAKTU 24 JAM ASRAMA"]
        Z1["ZONA HENING TOTAL (21.30 - 03.30): Lampu kamar tidur dimatikan, dilarang bersuara keras."]
        Z2["ZONA SPIRITUAL FAJAR (03.45 - 06.00): Masjid & halaqah tahfidz hening berkah."]
        Z3["ZONA AKADEMIK FORMAL (07.00 - 12.00): Ruang kelas madrasah, bebas gawai, fokus ilmu."]
        Z4["ZONA QAILULAH (12.30 - 13.30): Asrama istirahat tidur siang untuk regenerasi otak."]
        Z5["ZONA AKTIF & OLAHRAGA (15.30 - 17.00): Lapangan terbuka, panahan, kebersihan asrama."]
...
```mermaid
flowchart TD
    subgraph ProtokolPemulihanBurnout["PROTOKOL RESTORASI SIRKADIAN TIER 3"]
        TahapA["1. PENGHENTIAN BELAJAR MALAM TOTAL & SLEEP THERAPY (7 HARI)<br/>• Santri K diwajibkan tidur 8 jam penuh (21.00 - 05.00) di bawah pengawasan Poskestren."]
        
        TahapB["2. PSIKOEDUKASI KOGNITIF: 'OTAK MENGHAFAL SAAT TIDUR'<br/>• Konselor memaparkan sains neurobiologi bahwa memori jangka panjang dikonsolidasikan pada fase tidur Non-REM."]
        
        TahapC["3. RESTUKTURISASI JADWAL DENGAN PRINSIP TIME-BLOCKING 90 MENIT<br/>• Belajar dialihkan pada jam-jam prima fajar & pagi; jam malam steril dari buku berat."]
        
        TahapD["4. PEMULIHAN FUNGSI KOGNITIF & PRESTASI STABIL<br/>• Dalam 3 pekan, daya ingat Santri K pulih optimal, ia kembali tenang, & meraih nilai tertinggi tanpa begadang."]
...
```mermaid
flowchart TD
    subgraph EmpatDimensiHaritsunWaqtih["EMPAT DIMENSI OPERASIONAL HARITSUN 'ALA WAQTIH"]
        D1["DIMENSI 1: DISIPLIN IBADAH AWAL WAKTU (AL-INQISYAF AS-SYAR'I)<br/>• Hadir di masjid sebelum adzan/tepat saat adzan berkumandang.<br/>• Menjaga shalat tahajjud mandiri di sepertiga malam terakhir."]
        
        D2["DIMENSI 2: PENGORGANISASIAN TAHFIDZ & TUGAS (AT-TANZHIM AL-AKADEMI)<br/>• Memecah target hafalan menjadi ritme harian (*Atomic Chunking*).<br/>• Menyelesaikan tugas madrasah sebelum batas waktu tanpa menunda (*Zero Procrastination*)."]
        
        D3["DIMENSI 3: KESEIMBANGAN SIRKADIAN & QAILULAH (AR-RAHAH AL-HIKMAH)<br/>• Tidur malam tepat waktu (21.30) untuk mengoptimalkan sekresi melatonin.<br/>• Mengamalkan tidur siang sunnah (*Qailulah*) 20 menit untuk menyegarkan memori."]
        
        D4["DIMENSI 4: IMUNITAS DISTRAKSI DIGITAL & LAGHWI (AL-HIMYAH AL-WAKTIYYAH)<br/>• Kemampuan menolak distraksi gawai, game, & obrolan kosong yang membuang umur.<br/>• Penguasaan teknik fokus mendalam (*Deep Work*) saat mengkaji kitab."]
        
        D1 & D2 & D3 & D4 ==> KonstrukUtuh["KAPASITAS HARITSUN 'ALA WAQTIH PARIPURNA"]
    end
```
...
```mermaid
flowchart LR
    J1["J1 (KELAS 7)<br/>Kepatuhan Jadwal Terbimbing<br/>• Bangun tidur subuh tepat waktu<br/>• Mengikuti lonceng asrama<br/>• Merapikan ranjang mandiri"]
    --> J2["J2 (KELAS 8–9)<br/>Pencegahan Prokrastinasi<br/>• Menyelesaikan tugas tepat waktu<br/>• Menerapkan Pomodoro 25 Menit<br/>• Mengatur waktu cuci baju"]
    --> J3["J3 (KELAS 10–11)<br/>Perencanaan Prioritas Otonom<br/>• Matriks Eisenhower pribadi<br/>• Manajemen tahfidz mandiri<br/>• Konsisten Qailulah & Tahajjud"]
    --> J4["J4 (KELAS 12)<br/>Master Produktivitas & Qudwah<br/>• Deep work riset kitab mandiri<br/>• Manajemen waktu khidmah adik kelas<br/>• Teladan efisiensi & barakah"]
```
...
Penerapan konsep **P3-10-02: DEFINISI DAN KONSEPTUALISASI HARITSUN ALA WAQTIH** di ekosistem pesantren TUMBUH memerlukan pemahaman multidimensional yang memadukan khazanah turats syariat dan konsensus sains pendidikan modern:
