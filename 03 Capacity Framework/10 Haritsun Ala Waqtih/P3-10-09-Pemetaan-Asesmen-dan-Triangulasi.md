...
```mermaid
flowchart TD
    subgraph TransformasiAsesmenWaktu["REKONSTRUKSI SISTEM ASESMEN MANAJEMEN WAKTU"]
        Tunggal["PENILAIAN TUNGGAL ABSENSI GERBANG (TRADISIONAL)<br/>• Hanya mencatat santri yang telat shalat / masuk kelas.<br/>• Prokrastinasi tugas & efisiensi tahfidz luput terpantau.<br/>• Data madrasah, asrama, & tahfidz berjalan terpisah."]
        
        TUMBUH["TRIANGULASI MANAJEMEN WAKTU 360 DERAJAT (TUMBUH)<br/>• Integrasi 5 Sumber: Musyrif, Guru, Tahfidz, Santri Mandiri, Sebaya.<br/>• Early Warning System (EWS) mendeteksi penumpukan tugas & stres tidur.<br/>• Dashboard Intizham-TUMBUH memantau efisiensi waktu 24 jam."]
...
```mermaid
flowchart LR
    subgraph TuratsHisabWaktuDaqiq["KETELITIAN HISTORIS ULAMA TURATS"]
        KhatibBaghdadi["Al-Khatib Al-Baghdadi (Al-Kifayah):<br/>Menolak Riwayat Perawi yang Diketahui Sering Mengabaikan Waktu & Menipu dalam Janji"] --> Inti["Al-Hisabul Daqiq:<br/>Triangulasi Data Keteraturan Hidup Berbasis Bukti Otentik"]
        Bukhari["Imam Al-Bukhari:<br/>Menguji Ketepatan Waktu Guru-Guru Hadits Sebelum Mengambil Riwayat"] --> Inti
        Muhasibi["Al-Muhasibi (Ar-Ri'ayah):<br/>Menghitung Detik Umur yang Dipergunakan untuk Ketaatan vs Kelalaian"] --> Inti
    end
```
...
```mermaid
flowchart TD
    subgraph SainsMTMMManajemenWaktu["SINTESIS MTMM & KRONOMETRI PENDIDIKAN"]
        MTMM["Multi-Trait Multi-Method Matrix (Campbell & Fiske, 1959):<br/>• Menguji konvergensi data disiplin dari metode observasi, self-report, & rekam logbook tugas."]
        
        Chronometry["Educational Chronometry Standards:<br/>• Mengukur rasio efisiensi waktu penyelesaian tugas (Task Completion Time Ratio / TCTR)."]
        
        Dashboard["Intizham-TUMBUH Analytics:<br/>• Algoritma EWS otomatis mendeteksi santri yang terancam gagal ujian karena prokrastinasi."]
        
        MTMM & Chronometry ==> Dashboard
    end
```
...
```mermaid
flowchart TD
    subgraph AliranDataWaktu24Jam["ARSITEKTUR ALIRAN DATA INTIZHAM-TUMBUH"]
        Input1["1. MUSYRIF ASRAMA: Absensi Shalat Subuh, Jam Tidur 21.30, & Kerapian Loker."]
        Input2["2. GURU MADRASAH: Ketepatan Masuk Kelas & Buku Catatan Pengumpulan Tugas."]
        Input3["3. PEMBINA TAHFIDZ: Waktu Setoran Hafalan Fajar & Durasi Muroja'ah."]
        Input4["4. SANTRI MANDIRI: Logbook Time-Blocking, Pomodoro Tracker, & Jurnal Refleksi."]
        Input5["5. ULASAN SEBAYA: Peer Assessment: Menepati Janji Pertemuan & Bebas Begadang."]
        
        Input1 & Input2 & Input3 & Input4 & Input5 ==> Server["ENGINE ANALITIK MANAJEMEN WAKTU (INTIZHAM-TUMBUH)"]
        Server ==> Output1["Rapor Profil Kedisiplinan & Efisiensi Waktu"]
        Server ==> Output2["Early Warning System (EWS) Prokrastinasi bagi Musyrif"]
        Server ==> Output3["Grafik Keseimbangan Ibadah, Belajar, & Tidur Sirkadian"]
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolResolusiProkrastinasi["PROTOKOL PENDAMPINGAN TUGAS TIER 2"]
        StepA["1. FORUM CHECK-IN KEPENGASUHAN & GURU (INTEGRATED INTERVENTION)<br/>• Guru Matematika & Musyrif berdialog ramah membedah hambatan belajar Santri W tanpa hukuman bentakan."]
        
        StepB["2. DEKONSTRUKSI TUGAS DENGAN TEKNIK 'ONE-TASK-AT-A-TIME'<br/>• 8 tugas dipecah menjadi target harian: 2 tugas diselesaikan setiap ba'da Ashar selama 4 hari."]
        
        StepC["3. SESI TUTOR SEBAYA BERSAMA SANTRI J4 DI RUANG PERPUSTAKAAN<br/>• Santri J4 mendampingi Santri W memahami konsep dasar yang membingungkannya dengan penuh kasih sayang."]
        
        StepD["4. AUDIT KETUNTASAN TUGAS & PEMULIHAN KEPERCAYAAN DIRI<br/>• Dalam 5 hari, seluruh 8 tugas tuntas dikumpulkan & Santri W menguasai materi dengan percaya diri tinggi."]
...
```mermaid
flowchart TD
    subgraph LimaPilarTriangulasiWaktu["LIMA PILAR TRIANGULASI MANAJEMEN WAKTU 360 DERAJAT"]
        P1["PILAR 1: MUSYRIF ASRAMA (35% Bobot)<br/>• Observasi Shalat Subuh Tepat Waktu, Jam Tidur 21.30, & Kerapian Loker 24 Jam."]
        
        P2["PILAR 2: GURU MADRASAH (25% Bobot)<br/>• Observasi Ketepatan Masuk Kelas & Ketuntasan Pengumpulan Tugas Madrasah."]
        
        P3["PILAR 3: SANTRI MANDIRI (20% Bobot)<br/>• Logbook Time-Blocking Mingguan, Rekam Pomodoro, & Jurnal Refleksi Waktu."]
        
        P4["PILAR 4: ULASAN SEBAYA (10% Bobot)<br/>• Peer Review: Menepati Janji Pertemuan Belajar & Ketiadaan Begadang Kamar."]
        
        P5["PILAR 5: PEMBINA TAHFIDZ (10% Bobot)<br/>• Catatan Efisiensi Setoran Ziyadah & Muroja'ah Fajar Tepat Waktu."]
        
        P1 & P2 & P3 & P4 & P5 ==> Komposit["SKOR INDEKS HARITSUN 'ALA WAQTIH TERPADU (IK-HW)"]
    end
```
...
| :--- | :--- | :--- | :--- |
| **Jenjang J1 (Kelas 7)** | • Adaptasi jam tidur 21.30 & bangun fajar 03.45.<br/>• Kerapian loker dan kesiapan Evening Launchpad.<br/>• Kepatuhan lonceng madrasah dan asrama. | • Musyrif: Harian.<br/>• Guru: Mingguan.<br/>• Tahfidz: Harian. | Musyrif Kamar J1 & Guru Wali Kelas 7. |
| **Jenjang J2 (Kelas 8–9)** | • Penguasaan teknik Pomodoro 25 menit.<br/>• Ketuntasan pengumpulan tugas madrasah.<br/>• Keteraturan jadwal mencuci pakaian. | • Musyrif: Pekanan.<br/>• Guru: Mingguan.<br/>• Mandiri: Harian. | Musyrif Asrama & Guru Bidang Studi. |
| **Jenjang J3 (Kelas 10–11)** | • Perancangan jadwal *Time-Blocking* mingguan.<br/>• Deep Work tahfidz fajar 90 menit tanpa distraksi.<br/>• Kemandirian bangun qiyamul lail 3x seminggu. | • Mandiri: Harian.<br/>• Musyrif: 2 Pekanan.<br/>• Peer: Bulanan. | Dosen Pembimbing Halaqah & Musyrif J3. |
| **Jenjang J4 (Kelas 12)** | • Manajemen waktu penyusunan riset KTI mandiri.<br/>• Keteladanan ketepatan presisi bagi seluruh asrama.<br/>• Pendampingan jadwal waktu adik kelas J1. | • Komprehensif: 1x per bulan menjelang sidang KTI. | Dewan Pengawas Kepengasuhan & Pembimbing KTI. |
