...
```mermaid
flowchart TD
    subgraph ModelBimbinganTerpadu24Jam["ARSITEKTUR BIMBINGAN TERPADU CROSS-CHARACTER 24 JAM"]
        Masjid["1. ARENA MASJID & HALAQAH<br/>Aktivasi: Salimul Aqidah, Shahihul Ibadah, & Mutsaqqaful Fikr."]
        
        Kelas["2. ARENA KELAS & LABORATORIUM<br/>Aktivasi: Mutsaqqaful Fikr, Haritsun 'Ala Waqtih, & Qadirun 'Alal Kasb."]
        
        Kamar["3. ARENA KAMAR ASRAMA & LORONG<br/>Aktivasi: Munazhzham fi Syuunih, Matinul Khuluq, & Mujahadatun Linafsih."]
        
        Lingkungan["4. ARENA LAPANGAN & MASYARAKAT<br/>Aktivasi: Qawiyyul Jism, Nafi'un Lighairih, & Kepemimpinan Qudwah."]
        
        Masjid <===> Kelas <===> Kamar <===> Lingkungan
    end
```
...
```mermaid
graph TD
    A["Gugatan Segmentasi (Pihak A):<br/>'Karakter itu cukup diajarkan di jam pelajaran adab 2 jam per minggu; tidak perlu seluruh aktivitas asrama dibuatkan kurikulum terpadu!'"]
    --> B1["Tinjauan Sirah Nabawiyyah di Masjid Nabawi & Ash-Shuffah:<br/>Rasulullah SAW mendidik para sahabat Ahlus Shuffah sepanjang 24 jam: saat makan bersama, saat shalat, saat tidur beralas tikar, dan saat berjihad."]
    A --> B2["Tinjauan Kitab Adab an-Nufus (Al-Harits al-Muhasibi):<br/>Penyucian adab menuntut pengawasan muraqabah konstan dalam setiap lintasan tarikan nafas dan aktivitas keseharian."]
    A --> B3["Tinjauan Kaidah Tarbiyah Bil-Qudwah wal-Halaat:<br/>Pendidikan melalui situasi riil dan keteladanan hidup jauh lebih membekas daripada seribu jam ceramah di dalam kelas."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Bimbingan adab wajib menyatu secara organik dalam seluruh siklus kehidupan asrama 24 jam."]
```
...
```mermaid
flowchart TD
    subgraph SegitigaEmasPengasuhanTUMBUH["SEGITIGA EMAS INTEGRASI PEMBINAAN SANTRI"]
        Guru["1. GURU KELAS / ASATIDZ FORMAL<br/>Memantau nalar kognitif, keaktifan dialektis, & kepatuhan tugas akademik."]
        
        Musyrif["2. MUSYRIF / PENGASUH ASRAMA<br/>Memantau adab kamar 24 jam, kedisiplinan shalat, kebersihan 5S, & ukhuwah."]
        
        BK["3. KONSELOR BIMBINGAN KONSELING (BK)<br/>Menangani de-eskalasi emosi, mediasi konflik berat, & terapi psikososial."]
        
        DataSync["DASHBOARD DATA PBIS TERINTEGRASI REALTIME (<30 Detik)"]
...
```mermaid
flowchart TD
    subgraph 4ProgramUnggulanCrossCharacter["4 PROGRAM UNGGULAN ASRAMA PENGUNGKIT MULTI-KARAKTER"]
        P1["1. PROGRAM HALAQAH UKHUWAH KAMAR (HUK)<br/>• Sinergi: Salimul Aqidah + Matinul Khuluq + Mujahadah.<br/>• Lingkaran muhasabah sepekan sekali; saling memaafkan & bedah adab."]
        
        P2["2. PROGRAM GERAKAN ASRAMA BERSIH 5S (GAB-5S)<br/>• Sinergi: Munazhzham + Qawiyyul Jism + Haritsun.<br/>• Inspeksi kilat kamar tiap pagi; sertifikasi kamar higienis bebas scabies."]
        
        P3["3. PROGRAM SANTRI MENTOR SEBAYA (SMS T4)<br/>• Sinergi: Mutsaqqaful Fikr + Nafi'un Lighairih + Qudwah.<br/>• Santri kelas 11-12 membimbing adik kelas tahfizh & adaptasi asrama."]
        
        P4["4. PROGRAM INKUBATOR BISNIS SANTRI (IBS)<br/>• Sinergi: Qadirun 'Alal Kasb + Haritsun + Matinul Khuluq.<br/>• Praktik koperasi & green house hidroponik melatih etos kerja itqan."]
...
```mermaid
flowchart TD
    subgraph SOPPenangananKasusKrisisMultidimensi["SOP PENANGANAN KASUS MULTIDIMENSI (TIER 3)"]
        Insiden["1. TERJADINYA PELANGGARAN BERAT MAJEMUK (Cth: Perkelahian Disertai Merusak Fasilitas)."]
        
        DeEskalasi["2. DE-ESKALASI FISIK & EMOSI (<15 Menit): Pemisahan santri ke ruang konseling tenang; pendinginan emosi."]
        
        FBA["3. FUNCTIONAL BEHAVIOR ASSESSMENT (FBA - 24 Jam): Konselor BK mengidentifikasi akar pemicu (Trigger & Function)."]
        
        KonferensiRestoratif["4. KONFERENSI RESTORATIF TERPADU (48 Jam): Pertemuan Musyrif, Wali Kelas, BK, Santri Pelaku, & Korban."]
        
        RencanaPemulihan["5. PENETAPAN RESTITUSI RESTORATIF: Perbaikan fasilitas rusak + pelayanan khidmah asrama 14 hari + bimbingan spiritual."]
        
        Insiden --> DeEskalasi --> FBA --> KonferensiRestoratif --> RencanaPemulihan
    end
```
