...
```mermaid
flowchart LR
    subgraph SinergiIntelektualVokasionalTUMBUH["SINERGI KECERDASAN INTELEKTUAL & KEMANDIRIAN VOKASIONAL"]
        Fikr["MUTSAQQAFUL FIKR<br/>(Nalar Kritis Mantiq, Literasi Sains, & Fiqh Muamalah)"]
        
        Kasb["QADIRUN 'ALAL KASB<br/>(Kemandirian Finansial, Etos Kerja, & Inovasi Bisnis Halal)"]
        
        Fikr ==>|Menyediakan Analisis Kritis, Tata Kelola Itqan, & Etika Bisnis| Kasb
        Kasb ==>|Menyediakan Kemandirian Dana, Kehormatan Diri, & Sarana Dakwah| Fikr
        
        Pusat["HASIL: ULAMA-ENTREPRENEUR MANDIRI YANG BERWIBAWA, CERDAS, & BERKONTRIBUSI NYATA"]
...
```mermaid
graph TD
    A["Gugatan Asketisme Pasif (Pihak A):<br/>'Santri sejati itu tawakkal total; belajar bisnis dan mencari uang itu merusak niat ikhlas menuntut ilmu!'"]
    --> B1["Tinjauan Tafsir Surah Al-Jumu'ah: 9-10:<br/>'Fa idza qudhiyatish shalaatu fantasyiruu fil ardhi wabtaghuu min fadhlillah' (Perintah menyebar di muka bumi mencari rezeki karunia Allah setelah menunaikan shalat)."]
    A --> B2["Tinjauan Hadits Shahih Al-Bukhari No. 2072:<br/>'Tidak ada makanan yang lebih baik dimakan seseorang daripada makanan dari hasil usaha tangannya sendiri; dan Nabi Daud AS makan dari hasil karyanya.'"]
    A --> B3["Tinjauan Kitab Al-Kasb (Imam Muhammad bin Hasan Asy-Syaibani):<br/>Bekerja mencari nafkah halal berstatus Fardhu 'Ain bagi mukmin yang mampu guna menjaga martabat diri dan keluarga."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Kemandirian vokasional adalah bagian integral dari kesempurnaan syariat Islam."]
```
...
```mermaid
flowchart TD
    subgraph BentengIntegritasDakwah["PERAN KEMANDIRIAN FINANSIAL BAGI INTEGRITAS ILMU"]
        Mandiri["1. KEMANDIRIAN FINANSIAL SANTRI (Qadirun 'Alal Kasb)<br/>Memiliki sumber penghasilan halal dari wirausaha / keahlian profesional."]
        
        Izzah["2. KEHORMATAN & WIBAWA DAKWAH ('Izzatul 'Ilmi)<br/>Tidak bergantung pada amplop donatur atau intervensi penguasa zalim."]
        
        Fatwa["3. KEBERANIAN MENYAMPAIKAN KEBENARAN (Al-Jahru bil Haqq)<br/>Fatwa & nasihat agama disampaikan murni lillahi ta'ala tanpa takut dihentikan donasinya."]
...
```mermaid
flowchart TD
    subgraph PetaJalanSantripreneurTUMBUH["PETA JALAN PENGEMBANGAN VOKASIONAL SANTRI (T1 - T4)"]
        T1["TANGGA T1: KEMANDIRIAN DASAR DOMESTIK (KELAS 7)<br/>• Mandiri mencuci pakaian, menata lemari 5S, & mencatat uang saku harian."]
        
        T2["TANGGA T2: LITERASI FINANSIAL & ETIKA BISNIS (KELAS 8)<br/>• Kajian Fiqh Muamalah dasar, menabung rutin, & magang piket koperasi."]
        
        T3["TANGGA T3: PRAKTIK WIRAUSAHA TERBIMBING (KELAS 9-10)<br/>• Menjalankan proyek bisnis kelompok mini (Teaching Factory/Green House)."]
        
        T4["TANGGA T4: KEPEMIMPINAN INKUBATOR BISNIS (KELAS 11-12)<br/>• Memimpin unit usaha pesantren, mengelola anggaran, & melatih adik kelas."]
