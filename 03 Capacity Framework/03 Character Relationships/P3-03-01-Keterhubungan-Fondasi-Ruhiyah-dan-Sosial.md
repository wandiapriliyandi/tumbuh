...
```mermaid
flowchart LR
    subgraph RantaiKausalitasRuhiyahSosial["RANTAI KAUSALITAS TRANSMISI RUHIYAH KE SOSIAL"]
        Aqidah["1. SALIMUL AQIDAH<br/>(Iman Tauhid & Takut Hisab Akhirat)"]
        
        Ibadah["2. SHAHIHUL IBADAH<br/>(Shalat Khusyuk Mengikis Penyakit Hati)"]
        
        Akhlak["3. MATINUL KHULUQ<br/>(Empati, Memaafkan, & Santun Tutur Kata)"]
        
        Khidmah["4. NAFI'UN LIGHAIRIH<br/>(Aktif Berkorban Melayani Sesama)"]
        
        Aqidah ==>|Mendasari Kekhusyukan| Ibadah
        Ibadah ==>|Memancarkan Welas Asih| Akhlak
        Akhlak ==>|Membuahkan Aksi Nyata| Khidmah
    end
```
...
```mermaid
graph TD
    A["Gugatan Pemisahan Ibadah-Akhlak (Pihak A):<br/>'Shalat itu hubungan vertikal dengan Allah; urusan bergaul dengan teman asrama adalah urusan horizontal yang tidak ada kaitannya dengan sahnya shalat!'"]
    --> B1["Tinjauan Tafsir Surah Al-'Ankabut: 45:<br/>'Innash shalaata tanhaa 'anil fahsyaa-i wal munkar' (Sesungguhnya shalat yang hakiki secara mutlak mencegah perbuatan keji dan munkar)."]
    A --> B2["Tinjauan Tafsir Surah Al-Ma'un: 1-7:<br/>Kecaman keras bagi orang yang shalat namun lalai dari substansinya (Sahun) dan enggan menolong orang lain (Wayamna'unal Ma'un)."]
    A --> B3["Tinjauan Hadits Muflis (Orang Bangkrut - HR. Muslim):<br/>Orang yang datang di hari kiamat membawa pahala shalat/puasa melimpah, namun pahalanya habis dibagi-bagikan kepada orang yang ia caci dan zalimi di dunia."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Ibadah yang tidak menghasilkan akhlak mulia adalah ibadah yang cacat secara esensial di hadapan Allah."]
```
...
```mermaid
flowchart TD
    subgraph DinamikaTazkiyahKeSosial["MEKANISME TRANSMISI RUHANIYAH MENURUT IMAM AL-GHAZALI"]
        Qalb["1. PENYUCIAN KALBU (Tazkiyatul Qalb)<br/>Bebas dari iri (Hasad), sombong (Kibr), & cinta pujian (Riya')."]
        
        Nur["2. PANCARAN CAHAYA HIKMAH (Nurul Hikmah)<br/>Melihat sesama santri sebagai ciptaan Allah yang mulia & patut dikasihi."]
        
        Jawarih["3. GERAKAN ANGGOTA TUBUH (Harakatul Jawarih)<br/>Lisan berbicara santun; tangan sigap membantu mengangkat barang teman."]
...
```mermaid
flowchart TD
    subgraph AlurHalaqahTerpaduRuhiyahSosial["ALUR BIMBINGAN HALAQAH TERPADU ASRAMA"]
        Tahap1["1. TAFAKKUR SHALAT (15 Menit): Membedah makna bacaan shalat 'Iyyaka Na'budu' & 'Assalamu'alaikum' (Menebar Salam Kedamaian)."]
        
        Tahap2["2. AUDIT UKHUWAH KAMAR (15 Menit): Saling mengevaluasi interaksi kamar sepekan; tabayyun & memaafkan kesalahan teman."]
        
        Tahap3["3. AKSI NYATA KHIDMAH (30 Menit): Kerja bakti bersama membersihkan fasilitas umum pondok sebagai bukti kesucian shalat."]
