...
```mermaid
graph TD
    MutabaahForm["Struktur Lembar Mutabaah INSTR-04"]
    MutabaahForm --> SectionIbadah["1. Check-List Ibadah Harian<br/>Sholat 5 Waktu Berjamaah, Sholat Sunnah Rawatib/Tahajjud, & Tilawah Al-Qur'an."]
    MutabaahForm --> SectionHafalan["2. Catatan Muraja'ah & Setoran Hafalan<br/>Jumlah lembar sabaq baru, sabqi, & manzil yang diulang hari ini."]
    MutabaahForm --> SectionRefleksi["3. Refleksi Malam 3-Pertanyaan<br/>Kebaikan yang disyukuri, tantangan emosi, & komitmen perbaikan esok."]
```
