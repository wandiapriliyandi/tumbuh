...
```mermaid
graph TD
    InstCatalog["Katalog 6 Instrumen Asesmen Karakter"]
    InstCatalog --> Form1["1. Lembar Observasi Logbook PBIS Musyrif (INSTR-01)"]
    InstCatalog --> Form2["2. Kartu Check-In / Check-Out Tier 2 CICO (INSTR-02)"]
    InstCatalog --> Form3["3. Form Diagnostik FBA Restoratif (INSTR-03)"]
    InstCatalog --> Form4["4. Jurnal Mutabaah & Self-Refleksi Santri (INSTR-04)"]
    InstCatalog --> Form5["5. Angket Keteladanan Qudwah Sebaya (INSTR-05)"]
    InstCatalog --> Form6["6. Rubrik Portofolio Capaian 10 Muwashafat (INSTR-06)"]
```
