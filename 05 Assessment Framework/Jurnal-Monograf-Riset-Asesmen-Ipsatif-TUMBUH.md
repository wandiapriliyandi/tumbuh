...
```mermaid
graph TD
    AssessmentShift["Pergeseran Paradigma Asesmen Karakter"]
    AssessmentShift --> NormRank["Sistem Ranking Konvensional<br/>(Membandingkan santri satu sama lain -> Memicu Iri Hati & Inferiority Complex)"]
    AssessmentShift --> IpsativeGrowth["Sistem Asesmen Ipsatif TUMBUH<br/>(Membandingkan kemajuan santri dengan baseline dirinya sendiri -> Memicu Growth Mindset)"]
```
