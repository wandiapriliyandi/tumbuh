...
```mermaid
graph TD
    PPRProcess["Alur Sesi Periodic Progress Review (20 Menit)"]
    PPRProcess --> Step1["1. Warm Check-In & Apresiasi Perkelahian (5 Menit)"]
    PPRProcess --> Step2["2. Peninjauan Data Logbook & Jurnal Self-Assessment (7 Menit)"]
    PPRProcess --> Step3["3. Dialog Goal-Setting & Komitmen Dua Arah (8 Menit)"]
```
