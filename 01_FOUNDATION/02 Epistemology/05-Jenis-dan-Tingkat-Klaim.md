...
TUMBUH perlu memberi label pada klaim agar pembaca tahu apa yang sedang dinyatakan dan seberapa jauh pernyataan itu dapat dipertanggungjawabkan.

**Klaim** adalah pernyataan yang menyatakan sesuatu sebagai benar, berlaku, atau layak dipercaya. Dalam epistemologi, membedakan jenis klaim penting karena tidak semua pernyataan dapat diperiksa dengan cara yang sama.

TUMBUH menggunakan beberapa jenis klaim utama:

1. **Normative** — menyatakan nilai, prinsip, atau apa yang seharusnya dilakukan.
2. **Definitional** — menetapkan arti sebuah istilah atau konstruk untuk kebutuhan sistem.
3. **Empirical** — menyatakan sesuatu berdasarkan pengamatan atau penelitian terhadap kenyataan.
4. **Design** — menyatakan keputusan tentang bagaimana sistem dirancang atau dijalankan.
5. **Causal** — menyatakan hubungan sebab-akibat.
