...
```mermaid
flowchart TD
    subgraph ForumSLC["FORUM TRIPARTIT STUDENT-LED CONFERENCE (SLC 20 MENIT)"]
        SantriPresenter["<b>SANTRI (PEMBICARA & PEMIMPIN FORUM)</b><br/>Membuka map portofolio, mempresentasikan grafik radar 10 Muwashafat,<br/>mengakui area yang masih butuh perbaikan, & menetapkan target semester depan"]
        
        Ortu["<b>ORANG TUA (PENDENGAR UTAMA & PENDUKUNG MORAL)</b><br/>Mendengarkan presentasi ananda dengan penuh cinta, memberikan apresiasi hangat, doa berkah, & dukungan"]
