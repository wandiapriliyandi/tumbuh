...
```mermaid
flowchart TD
    Mudir["<b>1. KEPALA PESANTREN / MUDIR MA'HAD</b><br/><i>(Penjaga Visi Luhur, Worldview Islam, Epistemologi Turats, & Pengawas Etik Utama)</i>"]
    
    Kamad["<b>2. KEPALA MADRASAH (MTs / MA - CHIEF OPERATING OFFICER)</b><br/><i>(Pemegang Komando Eksekutif Operasional Terpadu 24 Jam Madrasah & Asrama)</i>"]

    Mudir ==> Kamad

    subgraph Dewan4Pilar["4 PILAR WAKIL KEPALA MADRASAH (WAKAMAD EKOSISTEM TUMBUH)"]
        W1["<b>WAKAMAD KURIKULUM</b><br/>Integrasi Adab RPP, Mutu KBM, Asesmen Ipsatif, & HOTS"]
        W2["<b>WAKAMAD KESISWAAN</b><br/>Musyrif 4 Shift, SW-PBIS Multi-Tier, & Restoratif 3R"]
        W3["<b>WAKAMAD SARPRAS</b><br/>Arsitek Bi'ah Shalihah, CPTED, Kamar 5S, & Sanitasi Sehat"]
        W4["<b>WAKAMAD HUMAS</b><br/>Kemitraan Orang Tua, SLC Tripartit, & Komunikasi Tabayyun"]
    end
