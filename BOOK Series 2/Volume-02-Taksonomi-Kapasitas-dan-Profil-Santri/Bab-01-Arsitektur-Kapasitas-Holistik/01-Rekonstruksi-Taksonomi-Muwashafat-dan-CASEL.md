...
```mermaid
flowchart TD
    subgraph TuratsMuwashafat["10 MUWASHAFAT ISLAM (NILAI AKSIOLOGIS)"]
        M1["Salimul Aqidah & Shahihul Ibadah"]
        M2["Mujahidun Linafsih & Harishun 'ala Waqtih"]
        M3["Matinul Khuluq & Munazzhamun fi Syu'unih"]
        M4["Nafi'un Lighairih & Qadirun 'alal Kasbi"]
        M5["Mutsaqqaful Fikr & Qawiyyul Jism"]
    end

    subgraph CASEL5["5 KOMPETENSI INTI CASEL SEL (INSTRUMEN PSIKOLOGI)"]
        C1["<b>1. Self-Awareness (Kesadaran Diri)</b><br/>Muraqabatullah & kejujuran emosi"]
        C2["<b>2. Self-Management (Regulasi Diri)</b><br/>Mujahadatun Nafs & manajemen waktu"]
        C3["<b>3. Social Awareness (Kesadaran Sosial)</b><br/>Empati, ukhuwah, & pemuliaan sesama"]
        C4["<b>4. Relationship Skills (Keterampilan Relasi)</b><br/>Komunikasi santun & resolusi damai"]
