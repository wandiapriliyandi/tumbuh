...
```mermaid
flowchart TD
    subgraph InsanKamil["TRI-DIMENSI INSAN KAMIL DALAM EKOSISTEM TUMBUH"]
        R["<b>1. DIMENSI RUHIYYAH (SPIRITUAL)</b><br/>• Salimul Aqidah & Shahihul Ibadah<br/>• Tazkiyatun Nafs & Muraqabatullah"]
        
        A["<b>2. DIMENSI AQLIYYAH (INTELEKTUAL)</b><br/>• Mutsaqqaful Fikr & Literasi Turats<br/>• Nalar Kritis, Tabayyun, & Metakognisi"]
