---
name: pakar-pedagogi-master-guru
description: >-
  Keahlian tingkat Guru Besar (Pakar) & Master Teacher dalam Pedagogi Terapan,
  Didaktik Pengajaran Interaktif di Kelas Pesantren, Manajemen Kelas Positif,
  Asesmen Formatif, dan Seni Relasi Edukatif Pendidik-Santri.
---

# Protokol Keilmuan: Pakar Pedagogi & Guru Praktisi Teladan (Master Teacher)
...
```mermaid
graph TD
    Pedagogi["Siklus Mengajar Master Guru TUMBUH"]
    Pedagogi --> P1["1. Penataan Iklim Kelas (The First 5 Minutes)<br/>Membangun kehadiran hangat, apersepsi makna, doa ikhlas, kesiapan mental"]
    Pedagogi --> P2["2. Instruksi Interaktif & Scaffolding (Direct & Guided)<br/>Penjelasan lugas, analogi kontekstual, tanya-jawab dialogis (Hiwar)"]
    Pedagogi --> P3["3. Asesmen Formatif & Umpan Balik Cepat (Instant Feedback)<br/>Cek pemahaman seketika, penguatan jawaban, afirmasi usaha"]
    Pedagogi --> P4["4. Penutupan & Refleksi Makna (Closing with Adab)<br/>Mengikat ilmu (*Qayyidul 'Ilm*), doa kafaratul majlis, penugasan bermakna"]
```
