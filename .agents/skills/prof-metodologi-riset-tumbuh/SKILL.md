---
name: prof-metodologi-riset-tumbuh
description: >-
  Keahlian tingkat Guru Besar (Profesor) dalam Metodologi Riset Pendidikan,
...
# Protokol Keilmuan: Profesor Metodologi Riset & Evaluasi Sistemik
...
```mermaid
graph TD
    Riset["Desain Riset & Evaluasi Sistemik TUMBUH"]
    Riset --> M1["1. Kualitatif-Turats (Hermeneutika & Studi Fenomenologi)<br/>Analisis teks klasik, observasi partisipatif musyrif, studi kasus santri"]
    Riset --> M2["2. Kuantitatif-PBIS (Time-Series & Single-Subject Design)<br/>Data frekuensi insiden, time-sampling observasi perilaku, metrik Tier 1-3"]
    Riset --> M3["3. Psikometrik & Rubrik (Konstruk Kapasitas Santri)<br/>Validitas isi (Aiken's V), reliabilitas antarrater (Cohen's Kappa), Growth Curve"]
    Riset --> M4["4. Diseminasi & Publikasi (Book Series & Policy Briefs)<br/>Sistematika buku 5 Volume dan panduan operasional pesantren"]
```
...
## 4. Langkah Analisis Profesor (Runbook)
