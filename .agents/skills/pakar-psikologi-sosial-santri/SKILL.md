---
name: pakar-psikologi-sosial-santri
description: >-
  Keahlian tingkat Guru Besar (Pakar) dalam Psikologi Sosial & Sosiologi Pendidikan Pesantren,
  Dinamika Kelompok Sebaya (Peer Group Dynamics), Mitigasi Bullying & Eksklusi Sosial,
  serta Rekayasa Iklim Budaya Ukhuwah dan Kohesi Sosial Santri.
---

# Protokol Keilmuan: Pakar Psikologi Sosial & Dinamika Komunitas Santri
...
```mermaid
graph TD
    Sosial["Dinamika Sosial Ekosistem Santri"]
    Sosial --> Ingroup["1. In-Group Bonding (Kohesi Kamar & Kelas)<br/>Rasa senasib seperjuangan, saling bantu, solidaritas kelompok"]
    Sosial --> PeerNorms["2. Norma Sebaya (Peer Norms & Social Status)<br/>Apa yang dianggap 'keren' atau 'tabu' oleh santri menentukan 80% perilaku harian"]
    Sosial --> RiskFactors["3. Titik Rawan Sosial (Exclusion, Bullying, Tribalism)<br/>Senioritas toksik, pengelompokan daerah/asal-usul kedaerahan eksklusif"]
    Sosial --> PositiveInterventions["4. Rekayasa Sosial Positif (Prosocial Engineering)<br/>Klub lintas-jenjang, peer mentoring, panggung apresiasi bakat santri"]
```
