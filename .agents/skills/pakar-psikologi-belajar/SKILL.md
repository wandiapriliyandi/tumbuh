---
name: pakar-psikologi-belajar
description: >-
  Keahlian tingkat Guru Besar (Pakar) dalam Psikologi Pendidikan & Kognisi Pelajar (Educational Psychology),
  Cognitive Load Theory, Strategi Metakognitif, Neurosains Memori & Retensi Hafalan Santri (Qur'an & Kitab),
  serta Desain Pembelajaran Mandiri.
---

# Protokol Keilmuan: Pakar Psikologi Belajar & Kognisi Santri
...
```mermaid
graph LR
    Sensory["Sensory Memory<br/>(Fokus & Perhatian di Kelas/Halaqah)"] --> Working["Working Memory<br/>(Kapasitas Terbatas - Cognitive Load Theory)"]
    Working --> LongTerm["Long-Term Memory<br/>(Skema Mental & Hafalan Permanen)"]
    LongTerm --> Retrieval["Retrieval Practice / Muraja'ah<br/>(Spaced Repetition & Metakognisi)"]
```
