---
name: prof-neurosains-perkembangan
description: >-
  Keahlian tingkat Guru Besar (Profesor) dalam Neurosains Kognitif, Psikologi Perkembangan
...
# Protokol Keilmuan: Profesor Neurosains Kognitif & Psikologi Perkembangan
...
```mermaid
graph TD
    Neuro["Peta Neurokognitif Santri Remaja"]
    Neuro --> PFC["1. Prefrontal Cortex (PFC)<br/>Regulasi emosi, eksekutif kontrol, perencanaan, nalar moral (Belum Matang Penuh)"]
    Neuro --> Limbik["2. Socioemotional / Limbic System (Amygdala)<br/>Sensitivitas tinggi terhadap emosi, reward sosial, peer pressure (Sangat Aktif)"]
    Neuro --> HPA["3. HPA-Axis (Kortisol / Stres)<br/>Kekerasan & ancaman memicu 'Fight-or-Flight', melumpuhkan neuroplastisitas"]
    Neuro --> Dopamin["4. Dopaminergic Circuit (Reward System)<br/>Apresiasi positif & pencapaian mengunci habitus kebaikan"]
```
