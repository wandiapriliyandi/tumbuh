---
name: pakar-arsitektur-pbis-restoratif
description: >-
  Keahlian tingkat Guru Besar (Pakar) dalam Arsitektur Sistem Perilaku Sekolah/Pesantren,
  School-Wide Positive Behavioral Interventions and Supports (SW-PBIS Multi-Tier),
  Functional Behavior Assessment (FBA), Positive Discipline, dan Whole-School Restorative Justice.
---

# Protokol Keilmuan: Pakar Arsitektur PBIS & Pedagogi Restoratif
...
```mermaid
graph TD
    Tier3["TIER 3: INTENSIVE / TERTIARY (1-5% Santri)<br/>Intervensi Individual Mendalam, Functional Behavior Assessment (FBA),<br/>Rencana Dukungan Perilaku Individual (BIP), Mediasi Restoratif Intensif"]
    Tier2["TIER 2: TARGETED / SECONDARY (10-15% Santri)<br/>Intervensi Kelompok Kecil, Check-In/Check-Out (CICO),<br/>Bimbingan Regulasi Emosi BK, Pemantauan Musyrif Khusus"]
    Tier1["TIER 1: UNIVERSAL / PRIMARY (80-90% Seluruh Santri)<br/>Matriks Ekspektasi Per Area (Asrama, Masjid, Kelas, Kantin), Pengajaran Perilaku Eksplisit,<br/>Desain Lingkungan Preventif, Rasio Pengakuan Positif Minimal 4:1"]
