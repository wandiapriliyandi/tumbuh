---
name: pakar-bimbingan-konseling
description: >-
  Keahlian tingkat Guru Besar (Pakar) dalam Bimbingan & Konseling Pesantren (Islamic Counseling),
  Cognitive Behavioral Therapy (CBT), Terapi Naratif Restoratif, De-eskalasi Krisis Emosional Santri,
  dan Manajemen Kasus Khusus (Tier 2 & Tier 3).
---

# Protokol Keilmuan: Pakar Bimbingan & Konseling Pesantren
...
```mermaid
graph TD
    BK["Alur Layanan Bimbingan & Konseling TUMBUH"]
    BK --> L1["1. Konseling Preventif & Pengembangan (Tier 1)<br/>Bimbingan orientasi santri baru, manajemen stres, pemetaan minat-bakat"]
    BK --> L2["2. Konseling Responsif & Kelompok Kecil (Tier 2)<br/>Homesickness berat, penurunan motivasi, friksi pertemanan, problem adaptasi"]
    BK --> L3["3. Konseling Intensif & Terapi Terpadu (Tier 3)<br/>Trauma, kecanduan digital/pornografi, pelanggaran moral berat, mediasi keluarga"]
```
