...
```mermaid
graph TD
    Audit["Matriks Audit Filosofis TUMBUH"]
    Audit --> D1["1. Koherensi Teologis & Turats (Validitas Syar'i)"]
    Audit --> D2["2. Ketepatan Antropologis (Hakikat Fitrah & Jiwa-Raga)"]
    Audit --> D3["3. Kelayakan Perkembangan (Tazkiyah & Fase Tangga T1-T4)"]
    Audit --> D4["4. Integritas Edukatif (Tarbiyah-Ta'dib-Ta'lim & Disiplin Restoratif)"]
    Audit --> D5["5. Kemurnian Qudwah (Kepemimpinan Tanpa Kekerasan)"]
    Audit --> D6["6. Realisme Sunnatullah (Hukum Perubahan & Bi'ah PBIS)"]
```
...
| **Keterukuran Bertahap (Tadarruj)** | *Apakah target pembinaan realistis sesuai tahapan usia remaja (marhalah murahaqah) dan level tangga (T1-T4)?* | Tidak menuntut kesempurnaan instan; terdapat jalur intervensi multi-tier (PBIS Tier 1, 2, 3). |
