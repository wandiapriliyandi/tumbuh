...
```mermaid
flowchart TD
    subgraph RekayasaBiahShalihah["DUA SAYAP REKAYASA BI'AH SHALIHAH PESANTREN"]
        Sosial["1. SAYAP EKOSISTEM SOSIAL-SPIRITUAL<br/>• Kultur sapaan ramah, ukhuwah hangat, & shalat berjamaah.<br/>• Zero Bullying & ketiadaan senioritas feodal.<br/>• Apresiasi perilaku adab melimpah (Rasio 4:1)."]
        
        Fisik["2. SAYAP REKAYASA TATA RUANG FISIK (CPTED)<br/>• Pencahayaan terang di seluruh lorong & sudut asrama.<br/>• Ketiadaan Blindspots; pengawasan alami (Natural Surveillance).<br/>• Fasilitas sanitasi bersih, wangi, & terawat prima."]
        
        Sosial <===> Fisik
        
        Hasil["TERBENTUKNYA ASRAMA SEBAGAI ZONA AMAN, BERSIH, & BERKAH (BI'AH SHALIHAH)"]
...
```mermaid
graph TD
    A["Gugatan Individualistik (Pihak A):<br/>'Kalau santri dasarnya shalih, ditaruh di lingkungan asrama yang kotor dan gelap pun tetap shalih. Tidak perlu renovasi tata ruang mahal-mahal!'"]
    --> B1["Tinjauan Hadits Shahih Muslim 2766:<br/>Ulama memerintahkan pembunuh 100 jiwa untuk pindah dari negerinya yang buruk ke negeri yang shalih sebagai syarat mutlak taubat."]
    A --> B2["Tinjauan Firman Allah QS. Al-Kahf 28:<br/>Perintah Allah untuk bersabar bersama orang-orang yang menyeru Rabb mereka di pagi & petang hari."]
    A --> B3["Tinjauan Sosiologi Ibnu Khaldun (Al-Muqaddimah):<br/>Manusia adalah anak kandung dari adat dan lingkungan sekitarnya (Ibnu Bi'atihi)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Membangun Bi'ah Shalihah adalah kewajiban syar'i primer untuk menjaga keselamatan fitrah santri."]
```
...
```mermaid
graph TD
    subgraph EmpatPilarCPTEDPesantren["4 PILAR ARSITEKTUR CPTED ASRAMA (C. RAY JEFFERY)"]
        P1["1. NATURAL SURVEILLANCE (Pengawasan Alami)<br/>Desain jendela kaca transparan, lampu terang, & lorong lurus bebas sudut buta."]
        
        P2["2. NATURAL ACCESS CONTROL (Kontrol Akses Alami)<br/>Zonasi pintu masuk jelas; pemisahan akses santri, tamu, & area privat asrama."]
        
        P3["3. TERRITORIAL REINFORCEMENT (Penguatan Teritori Adab)<br/>Penetapan batas suci sandal/sepatu, batas adab kamar, & kepemilikan komunal."]
        
        P4["4. MAINTENANCE & MANAGEMENT (Perawatan Prima)<br/>Perbaikan instan fasilitas rusak <24 jam & toilet wangi standar hotel."]
...
```mermaid
graph TD
    subgraph AnalisisHotspotsAsrama["ANATOMI TITIK RAWAN ASRAMA (HOTSPOTS)"]
        Blindspot["SUDUT GELAP / BLINDSPOTS (Lorong Belakang, Bawah Tangga, Kamar Mandi Ujung)"]
        
        Peluang["Ketiadaan Pandangan Musyrif (Anonymity) -> Kontrol Sosial Hilang"]
        
        Pelanggaran["Terjadinya Bullying, Merokok, Ghashab, atau Kekerasan Senior"]
        
        Solusi["REKAYASA FISIK TUMBUH: Pasang Lampu LED 50 Watt, Cermin Cembung, & Patroli Musyrif"]
        
        Blindspot --> Peluang --> Pelanggaran ==> Solusi
    end
```
...
```mermaid
graph LR
    subgraph BrokenWindowsPesantren["BROKEN WINDOWS THEORY (WILSON & KELLING)"]
        Rusak["1 KACA JENDELA PECAH / 1 KERAN TOILET RUSAK DIBIARKAN LAMA"]
        
        Sinyal["Sinyal Bawah Sadar: 'Di tempat ini tidak ada yang peduli pada aturan.'"]
        
        Vandalisme["Vandalisme Meluas, Dinding Dicorat-coret, & Adab Asrama Runtuh"]
        
        SOPRepair["SOP TUMBUH: Perbaikan Total Fasilitas Rusak Maksimal 1x24 Jam"]
        
        Rusak --> Sinyal --> Vandalisme ==> SOPRepair
    end
```
...
```mermaid
graph TD
    subgraph SiklusPatroliHotspots["SOP PATROLI TITIK RAWAN ASRAMA (HOTSPOTS PATROL)"]
        P1["1. PATROLI SUBUH (03.15–04.00)<br/>Menyisir lorong, kamar mandi, & memastikan seluruh santri bangun tanpa kekerasan."]
        
        P2["2. PATROLI SORE/SENJA (17.30–18.30)<br/>Menyisir area jemuran, lapangan, sudut taman, & kamar santri menjelang Maghrib."]
        
        P3["3. PATROLI MALAM (21.30–23.00)<br/>Menyisir bawah tangga, gudang, kantin, & memastikan adab istirahat malam tenang."]
...
```mermaid
graph TD
    subgraph PemetaanHotspotsAsrama["PEMETAAN TITIK RAWAN ASRAMA (HOTSPOTS MATRIX)"]
        H1["1. AREA TOILET & KAMAR MANDI BELAKANG<br/>Tindakan: Pasang exhaust fan wangi, lampu 40W terang, & pintu kokoh."]
        
        H2["2. AREA JEMURAN & LORONG ATAP ASRAMA<br/>Tindakan: Pasang penerangan sensor otomatis & batasi akses di luar jam jemur."]
        
        H3["3. AREA BAWAH TANGGA & GUDANG LOGISTIK<br/>Tindakan: Bersihkan dari tumpukan barang rongsok & pasang pintu terkunci."]
        
        H4["4. AREA LAPANGAN BELAKANG MENJELANG MAGHRIB<br/>Tindakan: Bunyikan bel sentral & musyrif piket menyisir santri ke masjid."]
...
```mermaid
flowchart TD
    Patrol1["1. PERSIAPAN PATROLI & PEMERIKSAAN LOGBOOK PIKET<br/>Musyrif mengenakan seragam rapi, membawa senter kecil, & membuka aplikasi logbook digital."]
    
    Patrol2["2. PENYISIRAN RUTE HOTSPOTS (RUTE 1: LORONG & TOILET)<br/>Memeriksa bilik mandi ujung, memastikan kran air mati, & menyapa santri yang masih di lorong."]
    
    Patrol3["3. PENYISIRAN RUTE HOTSPOTS (RUTE 2: TANGGA, JEMURAN, & GUDANG)<br/>Memastikan lampu menyala terang & tidak ada kerumunan santri di tempat sepi."]
    
    Patrol4["4. PENCATATAN TEMUAN & PENUTUPAN PATROLI<br/>Mencatat temuan fasilitas rusak ke tim sarpras & memastikan seluruh santri tidur tenang."]
