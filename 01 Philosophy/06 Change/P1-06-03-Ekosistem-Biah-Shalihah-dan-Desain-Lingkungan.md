...
```mermaid
graph TD
    subgraph BiahTigaLapis["TIGA LAPISAN BI'AH SHALIHAH (TUMBUH)"]
        Fisik["1. BI'AH MADDIYAH (LINGKUNGAN FISIK)<br/>Tata ruang terang, ventilasi sehat, kebersihan kamar mandi, & penataan rak rapi."]
        Sosial["2. BI'AH IJTIMA'IYYAH (IKLIM BUDAYA SOSIAL)<br/>Ukhuwah hangat, nihil perundungan, bahasa santun, & rasio apresiasi 4:1."]
        Spiritual["3. BI'AH RUHIYYAH (ATMOSFER SPIRITUAL)<br/>Lantunan tilawah Al-Qur'an, adzan awal waktu, dzikir ma'tsurat, & shalat malam."]
...
```mermaid
graph TD
    Hotspots["TITIK RAWAN (HOTSPOTS) DI ASRAMA PESANTREN"]
    
    Hotspots --> Lokasi["LOKASI RAWAN:<br/>• Antrean kamar mandi jam sibuk (04.30 & 16.30)<br/>• Lorong belakang jemuran & gudang gelap<br/>• Bilik kamar tidur setelah lampu dipadamkan"]
    
    Hotspots --> Waktu["WAKTU RAWAN:<br/>• Jeda 15 menit pergantian kelas<br/>• Waktu bebas setelah ashar sebelum maghrib<br/>• Tengah malam pukul 23.00 - 03.00"]
    
    Mitigasi["PROTOKOL PATROLI AKTIF MUSYRIF (Active Supervision):<br/>• Hadir fisik di lorong kamar mandi jam sibuk<br/>• Pencahayaan terang di seluruh area jemuran<br/>• Pengecekan kamar tidur 30 menit setelah jam padam"]
    
    Lokasi -. Dimatangkan .-> Mitigasi
    Waktu -. Dimatangkan .-> Mitigasi
```
