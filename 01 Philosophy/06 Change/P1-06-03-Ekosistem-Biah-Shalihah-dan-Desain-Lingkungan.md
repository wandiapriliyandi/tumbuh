...
```mermaid
flowchart TD
    subgraph TransformasiRekayasaLingkungan["TRANSFORMASI ARSITEKTUR LINGKUNGAN ASRAMA"]
        PolaGelapLama["LINGKUNGAN GELAP & SPIONASE TAJASSUS (LAMA)<br/>• Sudut gelap (Blindspots) memicu perundungan.<br/>• Memakai santri mata-mata mengintai aib teman (Tajassus).<br/>• Menghancurkan kepercayaan sosial & memicu fitnah."]
        
        PolaCPTEDTUMBUH["BI'AH SHALIHAH & ARSITEKTUR CPTED (TUMBUH)<br/>• Terang benderang & Natural Surveillance bebas blindspots.<br/>• Mengharamkan Tajassus; patroli pengayoman publik.<br/>• Lingkungan bersih & sehat (Broken Windows Prevention)."]
        
        PolaGelapLama ==>|DIREKONSTRUKSI MENJADI| PolaCPTEDTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturBiahShalihahTUMBUH["ARSITEKTUR REKAYASA LINGKUNGAN BI'AH SHALIHAH"]
        
        B1_Sayap["1. REKAYASA TATA RUANG CPTED TERANG (Illuminated Architecture)<br/>Pencahayaan 24 jam, eliminasi total sudut gelap (Zero Blindspots), & sirkulasi sehat."]
        
        B2_Sayap["2. PENGAYOMAN PUBLIK BEBAS TAJASSUS (Protective Hotspots Patrol)<br/>Mengharamkan spionase; musyrif berpatroli melindungi keselamatan santri di area publik."]
        
        B3_Sayap["3. KULTUR KEBERSIHAN 5S/5R (Broken Windows Prevention)<br/>Sanitasi wangi, kamar tidur rapi, & fasilitas terawat yang memantik adab kesucian."]
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranBiahShalihah["EMPAT TINGKATAN KESADARAN REKAYASA EKOLOGI BI'AH SHALIHAH (MARATIB AL-IDRAK)"]
        
        E1_Level["TINGKAT 1: KESADARAN PENGGUNAAN FISIK RUANG (Al-Idrak al-Makaniy al-Awwal)<br/>• Mengetahui fungsi ruang asrama & mematuhi batasan jadwal penggunaan fasilitas.<br/>• Menjaga barang pribadi agar tidak tercecer di area publik."]
        
        E2_Level["TINGKAT 2: KESADARAN PEMELIHARAAN & KEBERSIHAN 5S (Al-Idrak an-Nazhafiy)<br/>• Mampu merawat kebersihan kamar, merapikan ranjang, & menghemat air/listrik.<br/>• Menyadari pentingnya pencahayaan terang & kerapian fasilitas bersama."]
        
        E3_Level["TINGKAT 3: KESADARAN PROTEKSI & BI'AH SHALIHAH (Al-Idrak ar-Ri'aiy al-Bi'iy)<br/>• Aktif menjaga suasana lingkungan yang aman, hangat, & ramah adab.<br/>• Berinisiatif melaporkan titik lampu mati & saling melindungi dari potensi perundungan."]
        
        E4_Level["TINGKAT 4: KESADARAN EKOLOGI PERADABAN MADANI PARIPURNA (Al-Idrak al-Bi'iy al-Kamil)<br/>• Puncak kematangan: menyatukan kesucian tauhid, kelestarian alam, & kemuliaan adab.<br/>• Menjadi Live Qudwah perawat ekosistem berkah yang menghadirkan kedamaian semesta."]
...
```mermaid
flowchart TD
    subgraph ProtokolPatroliAsrama["PROTOKOL PATROLI TITIK RAWAN ASRAMA 24 JAM"]
        Pemetaan["1. PEMETAAN TITIK RAWAN: Mengidentifikasi Area Publik Rawan (Lorong Belakang, Tangga, Jemuran)"]
        --> JadwalPatroli["2. PATROLI TERJADWAL: Musyrif Berpatroli di Jam Kritis (17.30–18.15, 21.45–22.30, & 03.45–04.30)"]
        --> SapaanHangat["3. PENDEKATAN PENGAYOMAN: Menyapa Santri dengan Ramah, Menolak Intimidasi & Spionase Tajassus"]
        --> LaporanDigital["4. PENCATATAN LOGBOOK PBIS: Melaporkan Kondisi Keamanan & Kelaikan Fasilitas Real-Time"]
    end
```
