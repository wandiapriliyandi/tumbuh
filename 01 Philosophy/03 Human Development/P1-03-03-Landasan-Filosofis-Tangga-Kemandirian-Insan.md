...
```mermaid
flowchart TD
    subgraph TransformasiGradualismeKemandirian["TRANSFORMASI METODOLOGI PEMBINAAN KEMANDIRIAN"]
        PolaInstanLama["TUNTUTAN INSTAN & RANKING TOKSIK (LAMA)<br/>• Menuntut kemandirian sempurna sejak hari pertama.<br/>• Membandingkan santri (Ranking 1 s/d 30).<br/>• Melahirkan santri putus asa & iri dengki."]
        
        PolaTadarrujTUMBUH["SUNNATUT TADARRUJ & DYNAMIC SCAFFOLDING (TUMBUH)<br/>• Pembinaan bertangga: Adaptasi s/d Transformasi Mandiri.<br/>• Bantuan penuh di awal, dilepas bertahap (Fading Out).<br/>• Asesmen Pertumbuhan Ipsatif: Menghargai kemajuan diri sendiri."]
        
        PolaInstanLama ==>|DIREKONSTRUKSI MENJADI| PolaTadarrujTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph TanggaKemandirianTUMBUH["EMPAT ETAPE TANGGA KEMANDIRIAN ADAB SANTRI"]
        
        E1["ETAPE 1: TA'ARUF & ADAPTASI (Ketergantungan Terbimbing / Full Scaffolding)<br/>• Santri beradaptasi dengan lingkungan baru; membutuhkan bimbingan fisik dekat musyrif.<br/>• Bantuan penuh dalam membangunkan subuh, merapikan loker, & mengenali jadwal."]
        
        E2["ETAPE 2: TA'ALLUM & PEMBIASAAN (Kemandirian Terarah / Guided Autonomy)<br/>• Rutinitas harian mulai terbentuk; bantuan fisik dikurangi menjadi pengingat visual.<br/>• Santri mulai mampu mengatur waktu mandi & belajar dengan bimbingan apresiasi 4:1."]
        
        E3["ETAPE 3: TAFAHHUM & INTERNALISASI (Kemandirian Batin / Internalized Autonomy)<br/>• Memahami nilai & hikmah aturan; disiplin ditegakkan atas dasar kesadaran Muraqabah.<br/>• Santri menjaga ibadah & adab kamar secara mandiri tanpa perlu diawasi musyrif."]
        
        E4["ETAPE 4: TAWAQQUF & TRANSFORMASI (Kepemimpinan Qudwah / Servant Leadership)<br/>• Puncak kemandirian: santri menjadi teladan adab mandiri & membimbing adik kelasnya.<br/>• Mengemban peran Duta Adab & penggerak transformasi peradaban asrama 24 jam."]
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranKemandirian["EMPAT TINGKATAN KESADARAN KEMANDIRIAN (MARATIB AL-IDRAK)"]
        
        K1_Auto["TINGKAT 1: KESADARAN TERBIMBING (Al-Idrak al-Mustarsyid)<br/>• Membutuhkan arahan langkah demi langkah untuk menyelesaikan tugas asrama.<br/>• Merasa nyaman ketika didampingi secara dekat oleh musyrif atau kakak asuh."]
        
        K2_Auto["TINGKAT 2: KESADARAN REGULASI TERARAH (Al-Idrak al-Muwajjah)<br/>• Mampu menjalankan rutinitas asrama dengan pengingat jadwal mandiri.<br/>• Mulai berani mengambil inisiatif kecil membersihkan fasilitas kamar tanpa disuruh."]
        
        K3_Auto["TINGKAT 3: KESADARAN OTONOMI MORAL (Al-Idrak al-Mustaqill)<br/>• Menjalankan seluruh kewajiban adab & ibadah atas dorongan cinta kepada Allah.<br/>• Mampu memecahkan masalah pribadi secara bijak tanpa ketergantungan musyrif."]
        
        K4_Auto["TINGKAT 4: KESADARAN PENGGERAK PERADABAN (Al-Idrak al-Muharrik)<br/>• Puncak kematangan: memiliki kapasitas membimbing & menggerakkan orang lain.<br/>• Menjadi Live Qudwah yang menciptakan iklim ukhuwah & adab di manapun berada."]
        
        K1_Auto ==> K2_Auto ==> K3_Auto ==> K4_Auto
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolAsesmenIpsatif["PROTOKOL ASESMEN PERTUMBUHAN IPSATIF SANTRI"]
        Baseline["1. PENCATATAN BASELINE: Menetapkan Titik Awal Kapasitas Adab & Akademik Santri"]
        --> Pantau["2. PEMANTAUAN PROGRES: Mencatat Kemajuan Personal Mingguan di Logbook PBIS"]
        --> Dialog["3. DIALOG REFLEKSI: Musyrif & Santri Menelaah Grafik Pertumbuhan Diri"]
        --> Apresiasi["4. APRESIASI KEMAJUAN: Merayakan Lompatan Kebaikan Pribadi Tanpa Membandingkan dengan Kawan"]
    end
```
...
```mermaid
flowchart TD
    subgraph EtikaTataKelolaGradualisme["PRINSIP AKSIOLOGIS PENDAMPINGAN GRADUALISME"]
        
        G_E1["1. HAK BERTUMBUH BERTAHAP (Right to Gradual Growth)<br/>• Menghormati ritme perkembangan alami setiap santri tanpa diskriminasi kecepatan.<br/>• Mengharamkan vonis kegagalan dini pada santri yang berproses lambat."]
        
        G_E2["2. PENGURANGAN BANTUAN BERADAB (Graceful Fading Out)<br/>• Musyrif dilarang bersikap overprotektif atau sebaliknya lepas tangan secara tiba-tiba.<br/>• Pendelegasian tanggung jawab dilakukan bertahap seiring kesiapan mental santri."]
        
        G_E3["3. ELIMINASI PERANKINGAN TOKSIK (Abolition of Toxic Ranking)<br/>• Menghapus pengumuman ranking terbuka yang mempermalukan santri peringkat bawah.<br/>• Mengganti raport angka perbandingan dengan Laporan Portofolio Pertumbuhan Karakter."]
