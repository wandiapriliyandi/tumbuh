...
```mermaid
flowchart TD
    subgraph TransformasiLintasanPerkembangan["TRANSFORMASI CARA PANDANG PERKEMBANGAN SANTRI"]
        PolaKakuLama["ADULTOMORFISME KAKU (LAMA)<br/>• Menuntut santri remaja bersikap laksana orang dewasa.<br/>• Menghukum letupan emosi pubertas dengan kekerasan.<br/>• Memperparah stres homesickness & trauma isolasi."]
        
        PolaPeriodisasiTUMBUH["PERIODISASI MARAHIL AL-'UMR & NEUROSAINS (TUMBUH)<br/>• Memahami sunnatullah tahapan Tamyiz, Murahaqah, & Rusyd.<br/>• Musyrif sebagai rem eksternal penuh kasih (Scaffolding).<br/>• Pendampingan Diferensial: Bimbingan hangat & otonomi bertahap."]
        
        PolaKakuLama ==>|DIREKONSTRUKSI MENJADI| PolaPeriodisasiTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturLintasanPerkembanganTUMBUH["ARSITEKTUR EMPAT FASE PERKEMBANGAN SANTRI"]
        
        Fase1["1. FASE TAMYIZ (Fondasi Pembiasaan & Kehangatan Kasih Sayang)<br/>• Usia adaptasi awal: pembiasaan visual konkret, perlindungan fisik, & penanaman adab dasar.<br/>• Fokus: Menghadirkan rasa aman, eliminasi homesickness, & pengenalan ibadah riang."]
        
        Fase2["2. FASE MURAHAQAH AWAL (Navigasi Badai Emosi & Eksplorasi Diri)<br/>• Usia pubertas awal: fluktuasi hormon, pencarian jati diri, & sensitivitas sebaya tinggi.<br/>• Fokus: De-eskalasi emosi, bimbingan konseling sebaya, & penyaluran energi motorik."]
        
        Fase3["3. FASE BULUGH / MURAHAQAH AKHIR (Kemandirian Taklif & Penguatan Nalar)<br/>• Usia taklif syar'i penuh: penguatan nalar mantiq, dialektika dalil, & regulasi moral internal.<br/>• Fokus: Kemandirian ibadah tanpa pengawasan, kajian fiqh muqaran, & portofolio bakat."]
        
        Fase4["4. FASE RUSYD AWAL (Kematangan Hikmah & Kepemimpinan Khidmah)<br/>• Usia kematangan adab: integrasi ilmu-amal, tanggung jawab kepemimpinan asrama, & visi umat.<br/>• Fokus: Servant Leadership (Qudwah), kemandirian finansial dasar, & orientasi peradaban."]
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranPerkembangan["EMPAT TINGKATAN KESADARAN LINTASAN PERKEMBANGAN (MARATIB AL-IDRAK)"]
        
        D1_Level["TINGKAT 1: KESADARAN ADAPTASI SENSORIK (Al-Idrak al-I'tiyadiy)<br/>• Mampu menyesuaikan ritme fisik bangun tidur, makan bersama, & jadwal halaqah.<br/>• Mengatasi keterkejutan transisi dari rumah ke lingkungan asrama 24 jam."]
        
        D2_Level["TINGKAT 2: KESADARAN REGULASI PUBERTAS (Al-Idrak al-Infi'aliy)<br/>• Mengenali perubahan biologis tubuh & mampu menenangkan gejolak emosi diri.<br/>• Mampu memilih pergaulan kawan sebaya yang positif & saling mengingatkan dalam kebaikan."]
        
        D3_Level["TINGKAT 3: KESADARAN TANGGUNG JAWAB TAKLIF (Al-Idrak al-Mukallaf)<br/>• Menghayati status dirinya sebagai mukallaf yang bertanggung jawab penuh di hadapan Allah.<br/>• Mandiri dalam muthala'ah; konsisten menjaga adab syariat tanpa perlu ditegur musyrif."]
        
        D4_Level["TINGKAT 4: KESADARAN KEMATANGAN RUSYD (Al-Idrak ar-Rasyid)<br/>• Puncak kematangan akal budi: memiliki kearifan moral, visi hidup jelas, & jiwa mengayomi.<br/>• Mampu memimpin adik kelas dengan teladan adab luhur; menjadi Live Qudwah peradaban."]
        
        D1_Level ==> D2_Level ==> D3_Level ==> D4_Level
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolMitigasiHomesickness["PROTOKOL MITIGASI HOMESICKNESS SANTRI BARU"]
        Sambut["1. PENYAMBUTAN HANGAT (Hari 1–3): Musyrif Menyambut Ramah, Memperkenalkan Fasilitas & Kawan"]
        --> Dampingi["2. PENDAMPINGAN INTIM (Pekan 1–2): Mengidentifikasi Gejala Menangis/Menyendiri & Dialog Empati"]
        --> Libatkan["3. INTEGRASI AKTIVITAS (Pekan 2–4): Melibatkan Santri dalam Dinamika Kelompok Seru di Asrama"]
        --> Stabil["4. PEMANTAPAN KEMANDIRIAN (Bulan 2): Santri Nyaman, Mandiri, & Merasa Asrama sebagai Rumah Kedua"]
    end
```
