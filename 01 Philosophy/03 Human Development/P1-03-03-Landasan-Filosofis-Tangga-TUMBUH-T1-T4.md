...
```mermaid
graph TD
    T1["T1: TAHAP TA'ARUF & ADAPTASI (Fase Awal)<br/>• Fokus: Orientasi lingkungan aman, pembiasaan ritme dasar, & bonding musyrif.<br/>• Karakteristik: Ketaatan eksternal terbimbing (*Scaffolding*)."]
    
    T2["T2: TAHAP TADRIB & HABITUASI (Fase Pembiasaan)<br/>• Fokus: Pengulangan siklus 66 hari, konsistensi ibadah, & kemandirian kamar.<br/>• Karakteristik: Mulai tumbuh disiplin diri semi-mandiri."]
    
    T3["T3: TAHAP TAFAHUM & INTERNALISASI (Fase Pemahaman Nilai)<br/>• Fokus: Penghayatan hikmah syar'i, regulasi emosi mandiri, & empati ukhuwah.<br/>• Karakteristik: Adab berakar dari kesadaran kalbu internal."]
    
    T4["T4: TAHAP TAHWIL & TRANSFORMASI (Fase Keteladanan)<br/>• Fokus: Kepemimpinan melayani (*Servant Qudwah*), inisiatif kebaikan, & mentor adik kelas.<br/>• Karakteristik: Insan kamil pembawa maslahat (*Nafi'un Lighairihi*)."]
