...
```mermaid
flowchart TD
    subgraph EvolusiSpiritualTUMBUH["ARUS UTAMA EVOLUSI SPIRITUAL SANTRI (TAZKIYATUN NAFS)"]
        Fitrah["FITRAH PRIMORDIAL (QS. Ar-Rum: 30)<br/>Potensi tauhid & moral suci bawaan sejak lahir"]
        
        Hijab["HIJAB & PENYAKIT HATI (Amradh al-Qulub)<br/>Terkontaminasi hawa nafsu, trauma, & salah asuh"]
        
        Takhalliy["1. TAKHALLIY (PEMBERSIHAN)<br/>Mengikis ego, hasad, riya', arogansi, & ghashab"]
        
        Tahalliy["2. TAHALLIY (PENGHIASAN)<br/>Menanamkan disiplin, empati, kejujuran, & ukhuwah"]
        
        Tajalliy["3. TAJALLIY (WATAK KEDUA / SECOND NATURE)<br/>Adab memancar alami, stabil, & mandiri (Insan Kamil)"]
        
        Fitrah --> Hijab ==> Takhalliy ==> Tahalliy ==> Tajalliy
    end
```
...
```mermaid
graph TD
    A["Gugatan Reduksionisme Moral (Pihak A):<br/>'Tazkiyah itu konsep mistis sufi yang pasif; santri cukup diajarkan disiplin militer yang tegas agar tidak melanggar aturan!'"]
    --> B1["Tinjauan Tafsir QS. Asy-Syams 9–10:<br/>Zakka bermakna ganda: Thaharah (pembersihan) & Inma' (penyuburan potensi kebaikan)."]
    A --> B2["Tinjauan Tafsir QS. Al-A'la 14–15:<br/>Keberuntungan sejati (Falah) diraih dengan tazkiyah yang diikuti dzikir & shalat."]
    A --> B3["Tinjauan Psikologi Karakter Kontemporer:<br/>Disiplin koersif hanya menekan perilaku lahiriah; tazkiyah mengubah motif batin terdalam."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Tazkiyah adalah teknologi psiko-spiritual aktif yang menumbuhkan disiplin adab dari dalam jiwa."]
```
...
```mermaid
graph LR
    subgraph DinamikaTriadik["TRIADIK METAMORFOSIS JIWA SANTRI"]
        Takh1["1. TAKHALLIY (تَخَلِّي)<br/>Operasi Bedah Moral:<br/>Menguras racun ego, iri hati (hasad), ghibah, ghashab, & perundungan."]
        
        Tah2["2. TAHALLIY (تَحَلِّي)<br/>Penanaman Benih Adab:<br/>Menyiram jiwa dengan shidq, amanah, ithar (mendahulukan rekan), & sabar."]
        
        Taj3["3. TAJALLIY (تَجَلِّي)<br/>Cahaya Kepribadian:<br/>Refleks akhlak mulia memancar otomatis; terbentuk Insan Kamil yang kokoh."]
...
```mermaid
graph TD
    subgraph GenealogiTuratsRiyadhah["SINTESIS GENEALOGI METODOLOGI PERTUMBUHAN JIWA"]
        Ghazali["IMAM AL-GHAZALI (Ihya 'Ulumiddin)<br/>Karakter mulia dibentuk lewat RIYADHAH (pembiasaan amal kebalikan) hingga menjadi watak kedua."]
        
        IbnQayyim["IBNUL QAYYIM (Madarijus Salikin)<br/>Transformasi jiwa melalui MUJAHADAH 4 tingkatan: belajar hidayah, mengamalkan, mendakwahkan, & bersabar."]
        
        SintesisRiyadhah["SINTESIS METODOLOGI RIYADHAH-MUJAHADAH TUMBUH<br/>Pengasuhan 24 jam sebagai kawah candradimuka latihan disiplin raga & pematangan batin."]
        
        Ghazali & IbnQayyim ==> SintesisRiyadhah
    end
```
...
```mermaid
graph TD
    subgraph SirkuitNeurosainsPembiasaan["KONVERGENSI NEUROSAINS HABIT FORMATION & TAZKIYAH"]
        Hari1["HARI 1–20: FASE MUJAHADAH INTENSIF<br/>dlPFC bekerja ekstra keras menahan impuls limbik (Inhibitory Control). Butuh energi mental tinggi."]
        
        Hari21["HARI 21–65: FASE MIELINISASI JALUR SARAF<br/>Akson saraf membentuk lapisan mielin tebal. Beban kognitif di PFC menurun drastis."]
        
        Hari66["HARI 66+: FASE AUTOMATISASI (WATAK KEDUA)<br/>Kendali perilaku berpindah ke BASAL GANGLIA. Perilaku adab menjadi refleks otomatis & ringan."]
...
```mermaid
graph LR
    subgraph TahapanTransformasi["4 ETAPE TRANSFORMASI MOTIVASI PERILAKU"]
        E1["ETAPE 1: EXTERNAL CONTROL<br/>Keterpaksaan jadwal & bimbingan intensif musyrif."]
        
        E2["ETAPE 2: INTROJECTED REGULATION<br/>Dorongan rasa sungkan & keinginan menjaga nama baik."]
        
        E3["ETAPE 3: IDENTIFIED VALUE<br/>Memahami maslahat & mencintai nilai adab secara sadar."]
        
        E4["ETAPE 4: INTEGRATED / WATAK KEDUA<br/>Adab menyatu dengan jati diri (Insan Beradab & Muraqabah)."]
...
```mermaid
graph TD
    subgraph Jadwal24JamTazkiyah["INTEGRASI TAZKIYAH DALAM RUTINITAS 24 JAM ASRAMA"]
        Pagi["03.30–06.00: TAHALLIY RUHANI<br/>Qiyamul Lail, Subuh Berjamaah, Ma'tsurat, & Penataan Niat"]
        
        Siang["06.00–17.30: RIYADHAH AMALIAH<br/>Sekolah, Halaqah Qur'an, Adab Makan Bersama, & Qailulah"]
        
        Sore["17.30–20.30: UKHUWAH & TA'LIM<br/>Maghrib-Isya Berjamaah, Halaqah Adab Kamar, & Makan Malam"]
        
        Malam["20.30–22.00: TAKHALLIY & MUHASABAH<br/>Belajar Mandiri, Muhasabah Hening Malam, Taubat, & Istirahat Beradab"]
...
| :--- | :--- | :--- | :--- |
| **1. TAKHALLIY (التَّخَلِّي)**<br/>*Pembersihan Jiwa* | Mengikis dan membersihkan penyakit batin (*Amradh al-Qulub*) dan kecenderungan hawa nafsu destruktif. | • Arogansi senioritas<br/>• Budaya *ghashab*<br/>• Hasad & ghibah<br/>• Kemarahan impulsif | • Santri berhenti mengambil barang rekan tanpa izin.<br/>• Mampu menahan diri dari mengolok-olok kekurangan teman.<br/>• Senior tidak menyuruh atau menindas adik kelas.<br/>• Mengakui kesalahan pribadi dengan jujur tanpa melempar kambing hitam.[^38] |
| **2. TAHALLIY (التَّحَلِّي)**<br/>*Penghiasan Adab* | Menghiasi ruang batin dengan kebajikan syar'i dan membiasakan amalan adab secara berulang. | • Kedisiplinan ibadah<br/>• Sikap mendahulukan orang lain (*I'tsar*)<br/>• Santun dalam tutur kata<br/>• Menjaga kebersihan | • Hadir di masjid tepat waktu sebelum adzan berkumandang.<br/>• Mendahulukan rekan saat antre makan atau wudhu.<br/>• Merapikan ranjang dan lemari pribadi setiap pagi.<br/>• Menggunakan tutur bahasa santun (*Qawlan Karima*) kepada musyrif dan teman.[^39] |
| **3. TAJALLIY (التَّجَلِّي)**<br/>*Pemancaran Karakter* | Akhlak mulia telah menghunjam kuat menjadi watak kedua (*Second Nature*) yang memancar tanpa paksaan. | • Integritas moral otonom<br/>• Refleks empati & kepedulian<br/>• Ketenangan jiwa (*Nafs Muthma'innah*) | • Tetap berdisiplin dan beradab saat di rumah atau di luar pesantren.<br/>• Spontan menolong santri yang sakit atau kesulitan tanpa disuruh.<br/>• Bersikap tenang dan pemaaf saat menghadapi perlakuan tidak menyenangkan.<br/>• Menjadi Duta Adab (*Qudwah*) bagi lingkungan sekitarnya.[^40] |
...
```mermaid
graph LR
    subgraph HabitLoopPesantren["INTEGRASI RIYADHAH TURATS & NEUROKOGNITIF HABIT LOOP"]
        Cue["1. ISYARAT / CUE (المُثِيرُ)<br/>Suara adzan, alarm subuh, atau bel halaqah."]
        
        Routine["2. RUTINITAS RIYADHAH (الرِّيَاضَةُ)<br/>Amal ibadah / adab: bangun, wudhu, tilawah, & merapikan kamar."]
        
        Reward["3. REWARD / GANJARAN (الثَّوَابُ & الجَائِزَةُ)<br/>Ketenangan batin (Sakinah), senyuman musyrif, & pahala Allah."]
...
```mermaid
flowchart TD
    subgraph ProtokolMuhasabahMalam["SOP MUHASABAH REFLEKTIF MALAM (21.45–22.00)"]
        Persiapan["1. PERSIAPAN KAMAR (21.45)<br/>Lampu utama dipadamkan; nyalakan lampu tidur redup. Santri duduk melingkar rapi."]
        
        Hening["2. 3 MENIT HENING NAFAS & DZIKIR (21.47)<br/>Menstabilkan detak jantung & menurunkan gelombang otak dari Beta ke Alpha."]
        
        Refleksi["3. PANDUAN REFLEKSI DIRI MUSYRIF (21.50)<br/>Musyrif mengajukan 3 pertanyaan pemantik nurani secara lembut dan tenang."]
        
        Maaf["4. LINGKARAN ISHLAH & SALING MEMAAFKAN (21.55)<br/>Santri saling bersalaman, memaafkan kekhilafan harian, & mendoakan."]
        
        Doa["5. DOA TIDUR BERADAB (22.00)<br/>Membaca doa tidur & adab tidur miring ke kanan sesuai Sunnah."]
        
        Persiapan --> Hening --> Refleksi --> Maaf --> Doa
    end
```
