...
```mermaid
flowchart TD
    subgraph TransformasiTazkiyahJiwa["TRANSFORMASI PARADIGMA PERTUMBUHAN JIWA"]
        PolaMekanisLama["PERTUMBUHAN MEKANIS PASIF (LAMA)<br/>• Diukur hanya dari tinggi fisik & angka hafalan.<br/>• Ibadah dijalankan secara formalistik tanpa ruh.<br/>• Penyakit hati dibiarkan menjangkiti hubungan asrama."]
        
        PolaTazkiyahTUMBUH["TAZKIYATUN NAFS & EVOLUSI JIWA (TUMBUH)<br/>• Thaharah: Pembersihan cermin batin dari ego & maksiat.<br/>• Inma': Penyuburan potensi fitrah & adab kemanusiaan.<br/>• Tajalliy: Karakter mulia memancar otomatis (Second Nature)."]
        
        PolaMekanisLama ==>|DIREKONSTRUKSI MENJADI| PolaTazkiyahTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturEvolusiJiwaTUMBUH["ARSITEKTUR EVOLUSI TAZKIYATUN NAFS SANTRI"]
        
        Takhalliy["1. TAHAP TAKHALLIY (PEMBERSIHAN / DETOKSIFIKASI)<br/>• Mengikis penyakit hati: hasad, riya', ujub, takabur, & kebiasaan ghashab.<br/>• Metode: Taubat Nasuha, Menahan Lisan, & Regulasi Emosi Ammarah."]
        
        Tahalliy["2. TAHAP TAHALLIY (PENGHIASAN / HABITUASI ADAB)<br/>• Menanamkan kebiasaan adab: shalat tepat waktu, jujur, peduli kawan, & hidup bersih.<br/>• Metode: Riyadhah Konsisten 66 Hari, Mielinisasi Saraf, & Penguatan Positif 4:1."]
        
        Tajalliy["3. TAHAP TAJALLIY (PEMANCARAN KARAKTER OTOMATIS)<br/>• Adab memancar alami tanpa keterpaksaan; menikmati manisnya iman & ukhuwah.<br/>• Metode: Qudwah Hasanah, Khidmah Kepemimpinan, & Ihsan Muraqabah."]
        
        Takhalliy ==> Tahalliy ==> Tajalliy ==> Takhalliy
    end
```
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranTazkiyah["EMPAT TINGKATAN KESADARAN PENYUCIAN JIWA (MARATIB AL-IDRAK)"]
        
        Z1_Level["TINGKAT 1: KESADARAN DISIPLIN LAHIRIAH (Al-Idrak azh-Zhahiriy)<br/>• Mengikuti rutinitas ibadah & jadwal asrama secara mekanis tertib.<br/>• Berusaha menjauhi pelanggaran fisik karena mematuhi tata tertib pengurus."]
        
        Z2_Level["TINGKAT 2: KESADARAN MUJAHADAH BATIN (Al-Idrak al-Mujahid)<br/>• Merasakan pergulatan melawan hawa nafsu malas & riya'; aktif melatih diri (Riyadhah).<br/>• Mulai memahami keutamaan menyucikan niat & melatih empati kepada kawan sekamar."]
        
        Z3_Level["TINGKAT 3: KESADARAN KEJERNIHAN KALBU (Al-Idrak an-Naqiy)<br/>• Cermin kalbu jernih dari penyakit hasad & dengki; merasakan manisnya munajat.<br/>• Ikhlas beramal dalam kesendirian; mudah memaafkan kesalahan orang lain."]
        
        Z4_Level["TINGKAT 4: KESADARAN TAJALLIY ADAB PARIPURNA (Al-Idrak al-Muraqqiy)<br/>• Penyatuan sempurna: akhlak mulia memancar otomatis sebagai watak alami sejati.<br/>• Menjadi Live Qudwah yang menyejukkan hati & memimpin transformasi peradaban."]
        
        Z1_Level ==> Z2_Level ==> Z3_Level ==> Z4_Level
    end
```
...
```mermaid
flowchart TD
    subgraph EtikaTataKelolaTazkiyahMaster["PRINSIP AKSIOLOGIS PENGASUHAN TAZKIYATUN NAFS"]
        
        Z_E1["1. PRINSIP BERTAHAP & REALISTIS (Tadarruj fi at-Tazkiyah)<br/>• Menolak pemaksaan target spiritual ekstrem yang memicu burnout santri.<br/>• Pembiasaan dilakukan secara bertahap sesuai kapasitas perkembangan usia."]
        
        Z_E2["2. KETELADANAN MUTLAK ASATIDZ (Live Modeling / Qudwah)<br/>• Guru & musyrif wajib terlebih dahulu mengamalkan adab yang diajarkan.<br/>• Mengharamkan bentakan & kemarahan dalam proses membimbing adab santri."]
        
        Z_E3["3. IKLIM PENYUCIAN AMAN (Psychologically Safe Sanctuary)<br/>• Menyediakan ruang muhasabah malam yang hening & bebas dari intimidasi.<br/>• Melindungi privasi aib batin santri dalam sesi konseling spiritual."]
