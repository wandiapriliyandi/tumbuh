...
**Klasifikasi**: Folder Monograf Riset Tazkiyatun Nafs, Fase Perkembangan Remaja, Jenjang Kemandirian TUMBUH (J1–J4) J1–J4, CASEL SEL, Krisis Pubertas, & Puncak Tahap 7 (8 Berkas Lengkap)

---

## 🏛️ SITEMAP & NAVIGASI SELURUH BERKAS SUB-DOMAIN 03

Sub-Domain `03 Human Development` membedah bagaimana potensi fitrah santri bertumbuh dan berevolusi melalui proses penyucian jiwa (*Tazkiyah*), pentahapan usia biologis (*Marahil al-'Umr*), tangga kemandirian adab (*Jenjang Kemandirian TUMBUH (J1–J4) J1–J4*), kecerdasan sosio-emosional (*CASEL SEL*), transisi baligh, dan puncak aktualisasi insan adabi penggerak peradaban:

```mermaid
graph TD
    HumanDev["SUB-DOMAIN 03: HUMAN DEVELOPMENT (PERKEMBANGAN MANUSIA - 7 MONOGRAF)"]
    
    HumanDev --> Master["P1-03: Human Development TUMBUH Master (Monograf Induk Sub-Domain 03)"]
    HumanDev --> M1["P1-03-01: Tazkiyatun Nafs & Pertumbuhan Jiwa (Takhalliy, Tahalliy, Tajalliy, 66-Hari)"]
    HumanDev --> M2["P1-03-02: Fase & Lintasan Perkembangan Santri (Marahil al-'Umr, Dual-Systems, MTs vs MA)"]
    HumanDev --> M3["P1-03-03: Landasan Filosofis Jenjang Kemandirian TUMBUH (J1–J4) J1–J4 (Tadarruj Syar'i, Scaffolding ZPD)"]
    HumanDev --> M4["P1-03-04: Integrasi CASEL SEL & Adab Nabawi (5 Pilar Emosi, Adab Mu'asyarah, Zero Bullying)"]
    HumanDev --> M5["P1-03-05: Krisis Biososial & Transisi Pubertas Santri (Fiqh Bulugh, HPG Axis, In Loco Parentis)"]
    HumanDev --> M6["P1-03-06: Puncak Aktualisasi Insan Adabi Tahap 7 (Mushlih Peradaban, Maslow Transcendence)"]
    HumanDev --> M7["P1-03-07: Sintesis Human Development & Grand Charter Trajektori Pertumbuhan"]
```
...
| **03** | [**`P1-03-03-Landasan-Filosofis-Tangga-TUMBUH-J1-J4.md`**](./P1-03-03-Landasan-Filosofis-Tangga-TUMBUH-J1-J4.md) | Landasan Filosofis Jenjang Kemandirian TUMBUH (J1–J4) (J1–J4) | Prinsip *Tadarruj Syar'i* (HR. Bukhari 'Aisyah RA), Scaffolding ZPD Lev Vygotsky, 4 etape adaptasi hingga transformasi, dan Asesmen Pertumbuhan Ipsatif non-ranking (37 Catatan Kaki). |
