...
**Klasifikasi**: Folder Monograf Riset Tazkiyatun Nafs, Fase Perkembangan Remaja, Tangga TUMBUH T1–T4, CASEL SEL, Krisis Pubertas, & Puncak Tahap 7 (8 Berkas Lengkap)

---

## 🏛️ SITEMAP & NAVIGASI SELURUH BERKAS SUB-DOMAIN 03

Sub-Domain `03 Human Development` membedah bagaimana potensi fitrah santri bertumbuh dan berevolusi melalui proses penyucian jiwa (*Tazkiyah*), pentahapan usia biologis (*Marahil al-'Umr*), tangga kemandirian adab (*Tangga TUMBUH T1–T4*), kecerdasan sosio-emosional (*CASEL SEL*), transisi baligh, dan puncak aktualisasi insan adabi penggerak peradaban:
...
graph TD
    ...
    HumanDev --> M3["P1-03-03: Landasan Filosofis Tangga TUMBUH T1–T4 (Tadarruj Syar'i, Scaffolding ZPD)"]
...
| **03** | [**`P1-03-03-Landasan-Filosofis-Tangga-TUMBUH-T1-T4.md`**](./P1-03-03-Landasan-Filosofis-Tangga-TUMBUH-T1-T4.md) | Landasan Filosofis Tangga TUMBUH (T1–T4) | Prinsip *Tadarruj Syar'i* (HR. Bukhari 'Aisyah RA), Scaffolding ZPD Lev Vygotsky, 4 etape adaptasi hingga transformasi, dan Asesmen Pertumbuhan Ipsatif non-ranking (37 Catatan Kaki). |
