...
```mermaid
flowchart TD
    subgraph KontinuumPertumbuhanSantriTUMBUH["KONTINUUM 7 TAHAP PERTUMBUHAN SANTRI TUMBUH"]
        T1["TANGGA T1: TA'ARUF (Adaptasi & Pengenalan Adab Dasar)"]
        T2["TANGGA T2: TAFAHUM (Pemahaman Nalar & Regulasi Diri)"]
        T3["TANGGA T3: TA'AWUN (Kolaborasi, Ukhuwah, & Tanggung Jawab)"]
        T4["TANGGA T4: TAKAFUL / TAHWIL (Kemandirian Ibadah & Teladan Asrama)"]
...
```mermaid
graph TD
    A["Gugatan Individualisme Shalih (Pihak A):<br/>'Yang penting santri shalih sendiri, rajin wirid di pojok masjid, tidak perlu ikut campur urusan masyarakat!'"]
    --> B1["Tinjauan Al-Qur'an Surah Hud: 117:<br/>'Wa ma kana Rabbuka liyuhlikal qura bi-zhulmin wa ahluha MUSHLIHUN' (Negeri selamat bukan karena penduduknya shalih individual, melainkan karena ada kaum Mushlihun yang aktif memperbaiki)."]
    A --> B2["Tinjauan Konsep Ta'dib Syed Muhammad Naquib Al-Attas:<br/>Pendidikan Islam bertujuan melahirkan 'Insan Adabi' (Man of Adab) yang adil menata ilmu, diri, dan masyarakatnya."]
    A --> B3["Tinjauan Kitab Al-Insan al-Kamil Abdul Karim Al-Jili:<br/>Tingkat kesempurnaan manusia diukur dari cerminan asma dan sifat kemuliaan Ilahi dalam khidmah kemanusiaan."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Puncak perkembangan santri adalah menjadi Mushlih beradab yang mencerahkan peradaban."]
```
...
```mermaid
graph LR
    subgraph KonvergensiSainsPuncakAktualisasi["KONVERGENSI TEORI PUNCAK PERKEMBANGAN DIRI"]
        Maslow["ABRAHAM MASLOW (SELF-TRANSCENDENCE):<br/>Tingkat tertinggi melampaui aktualisasi ego diri sendiri: mendedikasikan hidup untuk tujuan agung di luar diri demi kemaslahatan sesama."]
        
        Erikson["ERIK ERIKSON (GENERATIVITY VS STAGNATION):<br/>Kematangan jiwa dewasa ditandai oleh dorongan mengasuh, mendidik, mewariskan nilai, & membimbing generasi penerus."]
        
        AlAttas["AL-ATTAS & AL-GHAZALI (INSAN ADABI & KHIDMAH):<br/>Puncak ketaatan hamba adalah menjadi khalifah pemakmur bumi yang menebarkan rahmat bagi semesta alam."]
        
        Maslow <===> Erikson <===> AlAttas
    end
```
...
```mermaid
flowchart TD
    SOP_K1["1. SIDANG MUNAQQASYAH PORTOFOLIO TAHAP 7 (DEWAN MASYAIKH)<br/>Santri mempresentasikan karya tulis riset, hafalan mutqin, & laporan proyek sosial."]
    
    SOP_K2["2. PENUGASAN KHIDMAH LAPANGAN MASYARAKAT (MINIMAL 3–6 BULAN)<br/>Santri diterjunkan ke desa binaan untuk mengajar, berdakwah, & bakti sosial."]
    
    SOP_K3["3. SIDANG PLENO PENETAPAN SYAHADAH INSAN ADABI TUMBUH<br/>Dewan Pengkaji menetapkan predikat kelulusan berdasarkan triangulasi data."]
    
    SOP_K4["4. MAJELIS KHITAMUT TARBIYAH & IKRAR BAI'AT PENGGERAK<br/>Penyematan syahadah, doa keberkahan masyayikh, & pelepasan resmi ke masyarakat."]
    
    SOP_K1 --> SOP_K2 --> SOP_K3 --> SOP_K4
```
