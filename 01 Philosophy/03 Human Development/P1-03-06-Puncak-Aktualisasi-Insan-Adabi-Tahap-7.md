...
```mermaid
flowchart TD
    subgraph TransformasiPuncakAktualisasi["TRANSFORMASI VISI AKHIR LULUSAN SANTRI"]
        PolaPasifLama["KESALEHAN PASIF INDIVIDUAL (LAMA)<br/>• Shalih fi Nafsihi: Hanya memikirkan ibadah sendiri.<br/>• Apatis terhadap problematika sosial & peradaban.<br/>• Lulus sekadar berburu ijazah & gelar formal."]
        
        PolaInsanAdabiTUMBUH["INSAN ADABI & MUSHLIH PERADABAN (TUMBUH)<br/>• Mushlih li Ghairihi: Aktif menggerakkan perbaikan umat.<br/>• Self-Transcendence & Khidmah Kepemimpinan Qudwah.<br/>• Menyatukan Tauhid, Sains Beradab, & Aksi Peradaban."]
        
        PolaPasifLama ==>|DIREKONSTRUKSI MENJADI| PolaInsanAdabiTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturPuncakInsanAdabiTUMBUH["ARSITEKTUR EMPAT PILAR INSAN ADABI PENGGERAK"]
        
        P1_Adab["1. INTEGRITAS TAUHID & MURAQABAH BATIN (Ruhaniyyah)<br/>Keikhlasan total; kemerdekaan jiwa dari perbudakan materi, pujian manusia, & takhta."]
        
        P2_Adab["2. KETAJAMAN NALAR HIKMAH & SAINS (Aqliyyah)<br/>Penguasaan metodologi epistemologi Islam & sains modern; berpikir kritis, analitis, & solutif."]
        
        P3_Adab["3. KEMULIAAN ADAB & KASIH SAYANG SOSIAL (Khuluqiyyah)<br/>Menghiasi diri dengan kerendahan hati, empati tinggi, kedermawanan, & Live Qudwah."]
        
        P4_Adab["4. KEBERANIAN ADVOKASI & KHIDMAH PERADABAN ('Amaliyyah)<br/>Kepemimpinan pelayan (Servant Leadership); aktif membela kaum tertindas & membangun peradaban."]
        
        P1_Adab <===> P2_Adab <===> P3_Adab <===> P4_Adab
    end
```
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranInsanAdabi["EMPAT TINGKATAN KESADARAN AKTUALISASI ADABI (MARATIB AL-IDRAK)"]
        
        A1_Level["TINGKAT 1: KESADARAN KOMPETENSI MANDIRI (Al-Idrak al-Kafa'iy)<br/>• Menguasai disiplin ilmu & keterampilan dasar secara mandiri & tuntas.<br/>• Mampu menyelesaikan seluruh tanggung jawab akademis & ibadah pribadi."]
        
        A2_Level["TINGKAT 2: KESADARAN PENGABDIAN SOSIAL (Al-Idrak al-Khadimiy)<br/>• Menemukan kebahagiaan dalam melayani sesama (Servant Leadership).<br/>• Menginisiasi program-program kebaikan bersama di lingkungan asrama & sekolah."]
        
        A3_Level["TINGKAT 3: KESADARAN MUSHLIH PERADABAN (Al-Idrak al-Ishlahiy)<br/>• Memiliki kepedulian mendalam terhadap masa depan umat & kelestarian alam.<br/>• Berani menyuarakan kebenaran secara santun & mendamaikan berbagai perpecahan."]
        
        A4_Level["TINGKAT 4: KESADARAN INSAN ADABI PARIPURNA (Al-Idrak al-Adabiy al-Kamil)<br/>• Puncak kematangan: manunggalnya Tauhid, Hikmah, Adab, & Khidmah Global.<br/>• Menjadi Live Qudwah peradaban yang memancarkan rahmat bagi semesta alam."]
...
```mermaid
flowchart TD
    subgraph ProtokolKhitamutTarbiyah["PROTOKOL PELEPASAN ALUMNI KHITAMUT TARBIYAH"]
        Sidang["1. SIDANG PORTOFOLIO ADAB: Mempertahankan Karya Tulis Solutif & Rekam Jejak Khidmah"]
        --> Ikrar["2. IKRAR PENGABDIAN UMAT: Mengucapkan Pakta Integritas Penjaga Amanah Peradaban"]
        --> Wisuda["3. WISUDA PENGANUGERAHAN ADAB: Penyematan Syahadah Insan Adabi & Doa Restu Para Masyayikh"]
        --> Mandat["4. PENUGASAN KHIDMAH (1 Tahun): Pengabdian Nyata di Pesantren Pedalaman / Lembaga Sosial"]
    end
```
