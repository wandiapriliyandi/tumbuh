...
```mermaid
flowchart TD
    subgraph TransformasiAntropologiFitrah["TRANSFORMASI CARA PANDANG KODRAT SANTRI"]
        PolaPesimisLama["PARADIGMA REPRESIF / TABULA RASA (LAMA)<br/>• Anak dianggap kertas kosong pasif atau berbakat jahat.<br/>• Pembinaan bertumpu pada rasa takut & hukuman fisik.<br/>• Melahirkan santri hipokrit & trauma psikologis."]
        
        PolaFitrahTUMBUH["ANTROPOLOGI TEISTIK FITRAH (TUMBUH)<br/>• Santri membawa modal suci: Tauhid, Akal, & Moral Bawaan.<br/>• Pelanggaran adalah anomali akibat disfungsi lingkungan.<br/>• Ta'dib Restoratif: Membuka potensi kebaikan & memuliakan fitrah."]
        
        PolaPesimisLama ==>|DIREKONSTRUKSI MENJADI| PolaFitrahTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph EmpatDimensiFitrahTUMBUH["EMPAT DIMENSI FITRAH INSAN PEMBELAJAR"]
        
        F1["1. FITRAH TAUHIDIYYAH (Dimensi Spiritual)<br/>• Kerinduan alami kepada Allah SWT, kesadaran doa, & kebutuhan makna hidup transenden.<br/>• Menolak kehampaan eksistensial; menghadirkan ketenangan jiwa melalui ibadah."]
        
        F2["2. FITRAH 'AQLIYYAH (Dimensi Intelektual)<br/>• Rasa ingin tahu saintifik, daya nalar kritis, logika mantiq, & haus akan kebenaran.<br/>• Membutuhkan stimulus pembelajaran aktif, dialog sokratik, & eksplorasi riset."]
        
        F3["3. FITRAH NAFSIYYAH-WIJDANIYYAH (Dimensi Sosio-Emosional)<br/>• Kebutuhan rasa aman, dicintai, dihargai, empati sosial, & interaksi ukhuwah hangat.<br/>• Terlindungi dari perundungan; membutuhkan pengasuhan penuh kasih sayang."]
        
        F4["4. FITRAH JASADIYYAH-MAHARIYYAH (Dimensi Fisik-Kinestetik)<br/>• Kebutuhan gerak raga, energi vitalitas, kesehatan biologis, & keterampilan motorik.<br/>• Menuntut sirkulasi udara sehat, sanitasi air bersih, nutrisi seimbang, & jam tidur cukup."]
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranFitrah["EMPAT TINGKATAN KESADARAN FITRAH (MARATIB AL-IDRAK)"]
        
        T1_Fitrah["TINGKAT 1: KESADARAN FITRAH INDRAWI (Al-Idrak al-Hissiy)<br/>• Merespons kebutuhan raga fisik & batasan aturan asrama secara tertib.<br/>• Mulai mengenali rutinitas ibadah harian & menjaga kebersihan fasilitas kamar."]
        
        T2_Fitrah["TINGKAT 2: KESADARAN FITRAH NALAR AKTIF (Al-Idrak al-'Aqliy)<br/>• Memahami hikmah di balik adab & larangan maksiat; rasa ingin tahu ilmiah mekar.<br/>• Mandiri dalam mengatur jadwal belajar & menolak godaan perilaku menyimpang."]
        
        T3_Fitrah["TINGKAT 3: KESADARAN FITRAH KALBU MURAQABAH (Al-Idrak al-Wijdaniy)<br/>• Terhubung erat dengan Allah (Muraqabatullah); memiliki empati sosial mendalam.<br/>• Mengikis sifat egois; senang membantu kawan sekamar tanpa pamrih."]
        
        T4_Fitrah["TINGKAT 4: KESADARAN FITRAH INSAN ADABI (Al-Idrak al-Kamil)<br/>• Penyatuan paripurna: seluruh potensi fitrah (Tauhid, Akal, Jiwa, Raga) mekar meyakinkan.<br/>• Menjadi figur teladan hidup (Live Qudwah); memimpin peradaban dengan kasih sayang."]
        
        T1_Fitrah ==> T2_Fitrah ==> T3_Fitrah ==> T4_Fitrah
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolHusnudzanEdukatif["PROTOKOL HUSNUDZAN EDUKATIF PENANGANAN ANOMALI"]
        Kasus["1. TERJADI ANOMALI: Santri Melakukan Pelanggaran Adab di Asrama"]
        Pemisahan["2. PEMISAHAN IDENTITAS: Tegaskan bahwa 'Perilaku yang Salah', Bukan 'Identitas Jiwa Santri'"]
        Identifikasi["3. IDENTIFIKASI AKAR SUMBATAN: Apakah Kelelahan Biologis, Stres Sosial, atau Kurang Paham?"]
        Restitusi["4. RESTITUSI EDUKATIF: Membimbing Santri Memperbaiki Kerusakan & Berlatih Regulasi Diri"]
        Pemulihan["5. PEMULIHAN FITRAH: Memulihkan Harga Diri Santri & Penguatan Afirmasi Positif 4:1"]
        
        Kasus --> Pemisahan --> Identifikasi --> Restitusi --> Pemulihan
    end
```
...
```mermaid
flowchart TD
    subgraph EtikaTataKelolaFitrah["PRINSIP AKSIOLOGIS PENGASUHAN FITRAH ASRAMA 24 JAM"]
        
        E1_Fitrah["1. KEBIJAKAN NOL KEKERASAN (Zero Tolerance for Violence)<br/>• Mengharamkan segala bentuk pemukulan fisik, bentakan kasar, & pemaluan publik.<br/>• Menegakkan sanksi tegas bagi siapapun oknum pengurus yang melakukan kekerasan."]
        
        E2_Fitrah["2. PEMULIAAN LOKUS HIDUP ASRAMA (Sanctuary Environment)<br/>• Menjamin asrama sebagai zona aman, bersih, berventilasi sehat, & nyaman.<br/>• Memenuhi kebutuhan nutrisi otak & jam tidur biologis santri secara penuh."]
        
        E3_Fitrah["3. KULTUR PENGUATAN POSITIF 4:1 (Strength-Based Culture)<br/>• Mengedepankan apresiasi perilaku positif dibanding fokus pada hukuman.<br/>• Rasio minimal 4 apresiasi untuk setiap 1 koreksi edukatif."]
        
        E1_Fitrah <===> E2_Fitrah <===> E3_Fitrah
    end
```
