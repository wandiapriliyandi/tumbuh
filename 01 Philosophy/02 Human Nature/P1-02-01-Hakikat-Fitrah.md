...
```mermaid
flowchart TD
    subgraph AlurOntologiFitrahTUMBUH["ANTROPOLOGI TEISTIK FITRAH EKOSISTEM TUMBUH"]
        Mitsaq["1. MITSAQ AZALI (QS. Al-A'raf: 172)<br/>Perjanjian primordial kesaksian tauhid & ma'rifatullah di alam arwah"]
        
        Kelahiran["2. KELAHIRAN DI ATAS FITRAH (HR. Bukhari 1385)<br/>Anatomi spiritual utuh tanpa cacat dosa; potensi kebajikan intrinsik"]
        
        Biah["3. BI'AH SHALIHAH PESANTREN 24 JAM (TUMBUH)<br/>Ekosistem yang menyuburkan fitrah, Firm & Kind, & restoratif"]
        
        InsanAdabi["4. AKTUALISASI INSAN ADABI / INSAN KAMIL<br/>Lulusan ulul albab yang berdzikir batin, berpikir sains, & mandiri"]
        
        Mitsaq ==> Kelahiran ==> Biah ==> InsanAdabi
    end
```
...
```mermaid
graph TD
    A["Gugatan Pesimisme Moral (Pihak A):<br/>'Santri pada dasarnya malas, licik, dan suka melanggar; jika tidak diancam hukuman keras, fitrahnya tidak ada artinya!'"]
    --> B1["Tinjauan Tafsir QS. Ar-Rum 30:<br/>Fitratallahi allati fatharan naasa 'alaiha (Fitrah tauhid & kebaikan adalah cetak biru asali Ilahi)."]
    A --> B2["Tinjauan Hermeneutika QS. Al-A'raf 172:<br/>Alastu bi Rabbikum Qalu Bala Syahidna (Ruh santri telah mengenal Allah sebelum lahir)."]
    A --> B3["Tinjauan Konsep Ta'dib Al-Attas:<br/>Pendidikan adalah proses Tadzakkur (mengingat kembali) & menumbuhkan kesaksian azali."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Pelanggaran santri adalah anomali permukaan; fitrah asali santri adalah suci dan mulia."]
```
...
```mermaid
graph TD
    subgraph GenealogiTuratsFitrah["GENEALOGI SINTESIS TURATS FITRAH TUMBUH"]
        Taimiyyah["IBN TAIMIYYAH (Dar' Ta'arudh)<br/>Fitrah bersifat AKTIF-POSITIF: memiliki daya tarik bawaan menuju tauhid & kebajikan"]
        
        Ghazali["AL-GHAZALI (Ihya' 'Ulumiddin)<br/>Kalbu santri adalah PERMATA MURNI (Jawharah Nafisah) yang siap menerima ukiran adab"]
        
        Attas["SYED NAQUIB AL-ATTAS (The Nature of Man)<br/>Pendidikan adalah TA'DIB: pengenalan posisi wujud yang adil selaras fitrah"]
        
        Taimiyyah & Ghazali & Attas ==> SintesisTUMBUH["ONTOLOGI INTEGRATIF FITRAH SANTRI TUMBUH"]
    end
```
...
```mermaid
graph TD
    subgraph DekonstruksiOntologiBarat["DEKONSTRUKSI FILSAFAT KODRAT MANUSIA BARAT"]
        Hobbes["THOMAS HOBBES (1651)<br/>Manusia lahir buas (Homo Homini Lupus)<br/>-> Lahir: Kedisiplinan Militeristik, Teror, & Kekerasan"]
        
        Locke["JOHN LOCKE (1690)<br/>Manusia lahir kertas putih (Tabula Rasa)<br/>-> Lahir: Behaviorisme Mekanis Poin Hadiah-Hukuman"]
        
        Augustine["DOKTRIN DOSA ASAL (Original Sin)<br/>Manusia lahir terkutuk mewarisi dosa Adam<br/>-> Lahir: Rasa Bersalah Kronis & Perendahan Diri"]
        
        IslamFitrah["ONTOLOGI FITRAH ISLAM (TUMBUH)<br/>Manusia lahir MULIA (Mukarram), SUCI, membawa modal iman azali & akal potensial<br/>-> Lahir: Tarbiyah & Ta'dib Firm & Kind, Restoratif, & Mulia"]
        
        Hobbes -.->|Ditolak Mutlak| IslamFitrah
        Locke -.->|Ditolak Mutlak| IslamFitrah
        Augustine -.->|Ditolak Mutlak| IslamFitrah
    end
```
...
```mermaid
graph TD
    A["Gugatan Sains Evolusi Sekuler (Pihak A):<br/>'Apakah ada bukti laboratorium sains modern bahwa bayi manusia lahir membawa kompas moral kebaikan?'"]
    --> B1["Riset Yale Infant Cognition Center (Paul Bloom, 2013):<br/>Bayi usia 3-6 bulan secara konsisten memilih boneka penolong (Helper) daripada boneka pengganggu (Hinderer)."]
    A --> B2["Riset Kognisi Anak UC Berkeley (Alison Gopnik, 2009):<br/>The Philosophical Baby: Balita memiliki empati bawaan & rasa keadilan sosial spontan."]
    A --> B3["Tinjauan Neurobiologi Oksitosin & Mirror Neurons:<br/>Otak manusia dirancang secara biologis untuk berkasih sayang & bekerja sama."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Sains kontemporer mengonfirmasi doktrin fitrah Islam (Innate Moral Sense)."]
```
...
```mermaid
graph TD
    subgraph EmpatDimensiFitrahSantri["EMPAT DIMENSI FITRAH INTEGRAL SANTRI TUMBUH"]
        D1["1. FITRAH TAUHIDI (Spiritualitas & Iman)<br/>Kebutuhan batin menyembah Allah, keikhlasan, muraqabah, & doa khusyuk"]
        
        D2["2. FITRAH 'AQLIYAH (Intelektual & Kritis)<br/>Rasa ingin tahu ilmiah, nalar dialektis mantiq, hafalan mutqin, & tadabbur"]
        
        D3["3. FITRAH NAFSIYAH-WIJDANIYAH (Sosio-Emosional)<br/>Kebutuhan relasi aman, disayangi, empati ukhuwah, & regulasi amarah"]
        
        D4["4. FITRAH JASADIYAH-MAHARIYAH (Fisik & Vokasional)<br/>Kebutuhan gerak kinestetik, thaharah higienis, tidur sehat, & keterampilan hidup"]
    end
```
...
```mermaid
graph LR
    subgraph KomparasiOntologiHumanNature["KOMPARASI HAKIKAT KODRAT MANUSIA (HUMAN NATURE)"]
        H["1. HOBBESIANISME<br/>Manusia Lahir Buas (Homo Homini Lupus)<br/>-> Sistem: Teror, Militeristik, & Kekerasan Fisik"]
        L["2. EMPIRISISME LOCKE<br/>Manusia Lahir Kertas Kosong (Tabula Rasa)<br/>-> Sistem: Behaviorisme Mekanis Hadiah-Hukuman"]
        R["3. ROMANTISISME ROUSSEAU<br/>Manusia Lahir Suci Rusak oleh Struktur<br/>-> Sistem: Permisif Tanpa Batasan Aturan"]
        A["4. DOKTRIN DOSA ASAL<br/>Manusia Lahir Terkutuk Mewarisi Dosa Adam<br/>-> Sistem: Rasa Bersalah Kronis & Merendahkan Martabat"]
        I["5. ONTOLOGI FITRAH ISLAM (TUMBUH)<br/>Manusia Lahir MULIA, Suci, Bawa Modal Iman Azali & Akal Potensial<br/>-> Sistem: Tarbiyah & Ta'dib Firm & Kind, Restoratif, & Mulia"]
    end
```
...
```mermaid
flowchart TD
    Incident["SANTRI MELAKUKAN PELANGGARAN ADAB DI ASRAMA"]
    --> Mindset["TAHAP 1: MUSYRIF INTERNAL MINDFRAME (Husnudzan Edukatif)<br/>Menegaskan dalam hati: 'Santri ini hamba Allah yang mulia; perilakunya salah namun fitrahnya suci.'"]
    
    Mindset --> Separate["TAHAP 2: DE-ESKALASI & PEMISAHAN DARI EMOSI MARAH<br/>Duduk sejajar empat mata di ruang konseling pribadi; nada bicara rendah dan tenang."]
    
    Separate --> Diagnose["TAHAP 3: DIAGNOSIS AKAR ANOMALI FITRAH (Rantai 4W 1H)<br/>Memeriksa pemicu lingkungan: apakah kelelahan, lapar, homesick, atau salah pergaulan?"]
    
    Diagnose --> Restitution["TAHAP 4: RESTORASI FITRAH & KONSEKUENSI LOGIS 4R<br/>Membimbing taubat tulus, restitusi perbaikan kerusakan, & pemulihan ukhuwah."]
```
