...
```mermaid
flowchart TD
    subgraph TransformasiDinamikaJiwa["TRANSFORMASI PEMAHAMAN DINAMIKA JIWA SANTRI"]
        PolaVonisLama["VONIS MORAL HITAM-PUTIH (LAMA)<br/>• Menghakimi santri melanggar sebagai 'anak terkutuk'.<br/>• Penanganan dengan kekerasan fisik & bentakan.<br/>• Menghancurkan rasa percaya diri & mematikan taubat."]
        
        PolaTazkiyahTUMBUH["METODOLOGI TAZKIYATUN NAFS & NEUROSAINS (TUMBUH)<br/>• Memahami sunnatullah 3 tingkatan nafs.<br/>• Mengaktivasi Nafs Lawwamah (Regulasi Diri).<br/>• Riyadhah Bertahap Menuju Nafs Muthmainnah."]
        
        PolaVonisLama ==>|DIREKONSTRUKSI MENJADI| PolaTazkiyahTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph TrajektoriTransformasiNafs["TRAJEKTORI DINAMIKA PERTUMBUHAN JIWA SANTRI"]
        
        N1["1. NAFS AMMARAH BIS-SU' (Tahap Dominasi Impulsif)<br/>• Dikendalikan dorongan syahwat, rasa malas, amarah meledak, & haus validasi.<br/>• Intervensi: Struktur jadwal ketat, pengawasan hangat, & pemenuhan hak nutrisi/tidur."]
        
        N2["2. NAFS LAWWAMAH (Tahap Pertarungan Moral & Regulasi Diri)<br/>• Suara hati nurani aktif; merasa bersalah setelah melanggar & rindu bertaubat.<br/>• Intervensi: Muhasabah reflektif, dialog sokratik, & penguatan afirmasi positif 4:1."]
        
        N3["3. NAFS MUTHMAINNAH (Tahap Ketenangan Spiritual & Adab Utuh)<br/>• Kestabilan jiwa paripurna; menikmati ibadah shalat & ukhuwah ikhlas.<br/>• Intervensi: Pembinaan kepemimpinan qudwah & penugasan khidmah umat."]
        
        N1 ==>|Riyadhah & Mujahadah| N2 ==>|Tazkiyah & Istiqamah| N3
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolTazkiyahHarian["PROTOKOL TAZKIYATUN NAFS ASRAMA 24 JAM"]
        Musyarathah["1. MUSYARATHAH (Pagi): Menetapkan Komitmen Niat & Menjaga Adab Hari Itu"]
        --> Muraqabah["2. MURAQABAH (Sepanjang Hari): Menjaga Kesadaran Ditatap Allah dalam Setiap Aktivitas"]
        --> Muhasabah["3. MUHASABAH (Malam): Menghitung Amal Kebaikan & Mengakui Kekhilafan Hari Itu"]
        --> Mu'aqabah["4. MU'AQABAH / RESTITUSI (Malam): Memperbaiki Kerusakan & Menambah Amal Kebaikan"]
        --> Mujahadah["5. MUJAHADAH (Subuh): Melatih Diri Bangun Tahajjud Melawan Rasa Malas"]
    end
```
...
```mermaid
flowchart TD
    subgraph EtikaTataKelolaTazkiyah["PRINSIP AKSIOLOGIS PENGASUHAN DINAMIKA NAFS"]
        
        T1_Nafs["1. VALIDASI PERGULATAN BATIN SANTRI (Empathetic Validation)<br/>• Memahami bahwa berbuat khilaf adalah bagian dari proses belajar kematangan.<br/>• Menolak hukuman pemaluan publik yang merusak harga diri dan mematikan taubat."]
        
        T2_Nafs["2. TERAPI DENGAN LAWANNYA (Treatment by Counter-Action)<br/>• Menangani kemalasan dengan penugasan terstruktur; menangani amarah dengan wudhu & zikir.<br/>• Mengharamkan kekerasan fisik sebagai metode 'pendisiplinan'."]
        
        T3_Nafs["3. KETELADANAN KONTROL EMOSI MUSYRIF (Staff Emotional Regulation)<br/>• Musyrif dilarang menegur santri saat dirinya sendiri sedang dalam keadaan marah.<br/>• Menegakkan sanksi bagi pendidik yang melampiaskan emosi pribadi kepada santri."]
        
        T1_Nafs <===> T2_Nafs <===> T3_Nafs
    end
```
