...
```mermaid
flowchart TD
    subgraph TransformasiMotivasiSantri["TRANSFORMASI MOTIVASI PENGASUHAN SANTRI"]
        PolaTerorLama["KEPATUHAN SEMU BERBASIS TEROR (LAMA)<br/>• Patuh karena takut rotan & bentakan musyrif.<br/>• Melahirkan santri hipokrit & disiplin musiman.<br/>• Ibadah ditinggalkan saat di luar asrama."]
        
        PolaMuraqabahTUMBUH["DISIPLIN INTRINSIK MURAQABAH (TUMBUH)<br/>• Memenuhi Kebutuhan Otonomi, Kompetensi, & Relasi.<br/>• Menghidupkan Radar Ihsan: Merasa Senantiasa Ditatap Allah.<br/>• Disiplin Mandiri & Istiqamah Beradab Seumur Hidup."]
        
        PolaTerorLama ==>|DIREKONSTRUKSI MENJADI| PolaMuraqabahTUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph KontinumMotivasiTUMBUH["KONTINUM PERKEMBANGAN MOTIVASI SANTRI"]
        R1["1. REGULASI EKSTERNAL<br/>Patuh karena takut hukuman atau mengharap hadiah fisik."]
        --> R2["2. REGULASI INTROJEKSI<br/>Patuh demi menghindari rasa bersalah atau gengsi sosial."]
        --> R3["3. REGULASI IDENTIFIKASI<br/>Patuh karena memahami manfaat & nilai rasional aturan."]
        --> R4["4. REGULASI INTEGRATIF / IHSAN<br/>Disiplin menyatu dengan identitas diri & Maqam Muraqabatullah."]
    end
```
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranMotivasi["EMPAT TINGKATAN KESADARAN MOTIVASI INTRINSIK (MARATIB AL-IDRAK)"]
        
        M1_Level["TINGKAT 1: KESADARAN MOTIVASI HETERONOM (Al-Idrak al-Majbur)<br/>• Termotivasi oleh pengawasan lahiriah pengurus & jadwal bel asrama.<br/>• Membutuhkan pengingat visual & instruksi terstruktur untuk memulai tugas."]
        
        M2_Level["TINGKAT 2: KESADARAN OTONOMI LOGIS (Al-Idrak al-Mu'allal)<br/>• Memahami alasan di balik aturan; mampu mengatur waktu muthala'ah mandiri.<br/>• Menolak ajakan melanggar aturan bukan karena takut musyrif, melainkan karena nalar."]
        
        M3_Level["TINGKAT 3: KESADARAN INTEGRITAS MURAQABAH (Al-Idrak al-Muraqib)<br/>• Menghayati pengawasan Allah (Maqam Muraqabah) dalam kesendirian kamar.<br/>• Ikhlas beramal tanpa butuh pujian kawan; memiliki rem moral batin yang kokoh."]
        
        M4_Level["TINGKAT 4: KESADARAN CINTA ILAHIYAH (Al-Idrak al-Mahabbiy)<br/>• Beribadah & beradab didorong oleh rasa cinta mendalam (Mahabbatullah) & kenikmatan ruhani.<br/>• Menjadi Live Qudwah yang menginspirasi sesama kawan untuk istiqamah beradab."]
...
```mermaid
flowchart TD
    subgraph ProtokolHeningMalam["PROTOKOL LINGKARAN MUHASABAH HENING MALAM"]
        Duduk["1. DUDUK MELINGKAR: Santri Sekamar Duduk Bersama Musyrif Pasca-Isya (15 Menit)"]
        Hening["2. KEHENINGAN REFLEKSI: Membimbing Santri Menyadari Pengawasan Allah & Menghitung Amal"]
        SalingMemaafkan["3. ISHLAH UKHUWAH: Saling Meminta Maaf Atas Gesekan Kata atau Sikap Hari Itu"]
        Doa["4. DOA & PENYUCIAN TIDUR: Membaca Doa Tidur & Berniat Bangun Tahajjud lillahi ta'ala"]
        
        Duduk --> Hening --> SalingMemaafkan --> Doa
    end
```
...
```mermaid
flowchart TD
    subgraph EtikaTataKelolaMotivasi["PRINSIP AKSIOLOGIS PENGASUHAN DISIPLIN OTONOM"]
        
        D1_E4["1. PEMBERIAN ALASAN LOGIS BERADAB (Rationale Provision)<br/>• Setiap instruksi atau larangan wajib disertai penjelasan hikmah dan maslahatnya.<br/>• Mengharamkan perintah buta tanpa nalar yang meremehkan akal budi santri."]
        
        D2_E4["2. FASILITASI RUANG OTONOMI TERARAH (Choice Architecture)<br/>• Memberikan ruang bagi santri memilih proyek kebaikan, ekstrakurikuler, & divisi khidmah.<br/>• Melatih santri mengambil keputusan bertanggung jawab sejak dini."]
        
        D3_E4["3. ELIMINASI PENGAWASAN TERRORISTIK (De-Panopticonization)<br/>• Mengganti budaya mata-mata dengan budaya keterbukaan & konseling hangat.<br/>• Menilai pertumbuhan karakter dari konsistensi batin, bukan sandiwara formalitas."]
