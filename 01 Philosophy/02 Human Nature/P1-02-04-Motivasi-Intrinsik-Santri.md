...
```mermaid
flowchart TD
    subgraph DinamikaMotivasiTUMBUH["ARSITEKTUR MOTIVASI INTRINSIK & MURAQABAH"]
        TigaKebutuhan["1. PEMENUHAN 3 KEBUTUHAN DASAR SDT (Deci & Ryan)<br/>Autonomy (Otonomi) + Competence (Kompetensi) + Relatedness (Relasi Aman)"]
        
        Internalisasi["2. KONTINUM INTERNALISASI NILAI (Internalization)<br/>Transformasi aturan luar menjadi nilai kepribadian pribadi (Integrated Regulation)"]
        
        PuncakMuraqabah["3. MAQAM MURAQABATULLAH (Imam Al-Qusyairi & Hadits Ihsan)<br/>Kesadaran konstan bahwa Allah Maha Melihat; lahirnya rasa cinta & malu ilahiah"]
        
        KarakterAbadi["4. DISIPLIN MANDIRI SEUMUR HIDUP (Matinul Khuluq)<br/>Santri istiqamah beradab di pondok, di rumah, hingga terjun di masyarakat"]
        
        TigaKebutuhan ==> Internalisasi ==> PuncakMuraqabah ==> KarakterAbadi
    end
```
...
```mermaid
graph TD
    A["Gugatan Paradigma Pentungan (Pihak A):<br/>'Santri itu kalau tidak ditakut-takuti rotan dan diawasi ketat 24 jam pasti melanggar; pengawasan keras adalah kunci!'"]
    --> B1["Tinjauan Psikologi Perilaku:<br/>Kepatuhan berbasis teror melahirkan Fenomena Panopticon Bentham: taat jika diawasi, liar jika bebas."]
    A --> B2["Tinjauan Bahaya Nifaq Pedagogis:<br/>Santri terlatih berbohong, menyembunyikan pelanggaran, & membenci syariat secara rahasia."]
    A --> B3["Tinjauan Fenomena Post-Pesantren:<br/>Santri yang dididik dengan teror langsung 'balas dendam' meninggalkan shalat saat lulus pondok."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Kepatuhan semu berbasis teror adalah kegagalan fatal pendidikan karakter."]
```
...
```mermaid
graph TD
    subgraph TigaKebutuhanDasarSDT["TIGA KEBUTUHAN PSIKOLOGIS DASAR (Deci & Ryan)"]
        Autonomy["1. AUTONOMY (Otonomi Terarah)<br/>Santri merasa memiliki kehendak bebas & paham alasan mulia di balik aturan syar'i."]
        Competence["2. COMPETENCE (Rasa Mampu & Berdaya)<br/>Santri dibekali keterampilan hidup nyata & diapresiasi kemajuan bertahapnya."]
        Relatedness["3. RELATEDNESS (Keterikatan Relasional Aman)<br/>Santri merasa disayangi musyrif, diterima teman sekamar, & aman dari bullying."]
        
        Autonomy & Competence & Relatedness ==> MekarMotivasi["MEKARNYA MOTIVASI INTRINSIK SEJATI (Intrinsic Motivation)"]
    end
```
...
```mermaid
flowchart TD
    subgraph MaqamMuraqabahIhsan["HIERARKI MAQAM MURAQABATULLAH & IHSAN"]
        Derajat1["1. DERAJAT MUSYAHADAH (Maqam Tertinggi)<br/>'An Ta'budallaha Ka-annaka Taraahu' (Menyembah Allah seakan-akan engkau melihat-Nya)<br/>-> Lahirnya Rindu Mendalam, Kelezatan Ibadah, & Khusyuk Total"]
        
        Derajat2["2. DERAJAT MURAQABAH (Maqam Dasar Ihsan)<br/>'Fa-in Lam Takun Taraahu Fa-innahu Yaraaka' (Jika engkau tak melihat-Nya, Dia pasti melihatmu)<br/>-> Lahirnya Rasa Malu Berbuat Dosa, Kejujuran Hati, & Istiqamah di Tempat Sepi"]
        
        Derajat1 & Derajat2 ==> Transformasi["TRANSFORMASI INTEGRITAS SANTRI: KEJUJURAN SEJATI DI TEMPAT SEPI"]
    end
```
...
```mermaid
graph LR
    subgraph KontinumMotivasiSDT["KONTINUM INTERNALISASI MOTIVASI (Deci & Ryan 2000)"]
        Amotivasi["1. AMOTIVASI<br/>Apatis, menolak aturan, tak berdaya"]
        --> Eksternal["2. REGULASI EKSTERNAL<br/>Patuh hanya demi hindari hukuman/cari reward"]
        --> Introyeksi["3. REGULASI INTROYEKSI<br/>Patuh demi hindari rasa bersalah/gengsi"]
        --> Identifikasi["4. REGULASI IDENTIFIKASI<br/>Mulai sadar nilai kebaikan aturan bagi diri"]
        --> Integrasi["5. REGULASI INTEGRASI<br/>Aturan syar'i menyatu utuh dengan identitas diri"]
        --> Intrinsik["6. MOTIVASI INTRINSIK / MURAQABAH<br/>Ibadah & adab dinikmati dengan penuh cinta & ikhlas"]
    end
```
...
```mermaid
graph TD
    subgraph DialektikaRewardKeikhlasan["DIALEKTIKA REWARD TOKEN VS KEIKHLASAN"]
        Overjustification["OVERJUSTIFICATION EFFECT (Deci, 1971; Lepper, 1973)<br/>Pemberian hadiah materiil/uang berlebih membunuh motivasi intrinsik alami anak."]
        
        BahayaRiya["BAHAYA SYIRIK KHOFI / RIYA' (Turats Tasawuf)<br/>Santri beramal demi mencari poin bintang & pujian manusia, bukan karena Allah."]
        
        SolusiTUMBUH["SOLUSI SINTESIS BERADAB TUMBUH:<br/>1. Apresiasi Sosial Tulus (Bukan Transaksi Materiil)<br/>2. Reward Kejutan Tak Terduga (Unexpected Celebration)<br/>3. Tashihun Niyyah: Menghubungkan Kebaikan dengan Pahala Akhirat"]
        
        Overjustification & BahayaRiya ==> SolusiTUMBUH
    end
```
...
```mermaid
flowchart TD
    A["Gugatan Operasional Asrama (Pihak A):<br/>'Bagaimana menyusun rutinitas asrama 24 jam yang menumbuhkan muraqabah secara nyata?'"]
    --> B1["Pilar 1: Halaqah Tadabbur Asmaul Husna (Al-Bashir, As-Sami', Ar-Raqib, Al-Khabir)."]
    B1 --> B2["Pilar 2: Pembiasaan Dialog Hikmah Syar'i (Didaktik Berbasis Alasan Kebermaknaan)."]
    B2 --> B3["Pilar 3: Lingkaran Muhasabah Hening Malam 10 Menit Sebelum Tidur (The Nightly Circle)."]
    B3 --> C["Titik Temu Konsensus:<br/>Asrama bertransformasi menjadi oase ketenteraman dan integritas jiwa."]
```
...
```mermaid
graph LR
    subgraph KomparasiTigaParadigmaDisiplin["KOMPARASI TIGA PARADIGMA DISIPLIN ASRAMA"]
        T["1. DISIPLIN TEROR (Otoriter Usang)<br/>Pemicu: Takut Cambuk & Malu<br/>Hasil: Kepatuhan Semu & Nifaq"]
        K["2. DISIPLIN TOKEN (Behavioris)<br/>Pemicu: Poin Bintang & Hadiah<br/>Hasil: Transaksional & Riya'"]
        M["3. DISIPLIN MURAQABAH (TUMBUH)<br/>Pemicu: Mahabbah & Muraqabatullah<br/>Hasil: Otonom, Mukhlis, & Seumur Hidup"]
    end
```
...
```mermaid
flowchart TD
    Start["21.15 WIB: SELURUH SANTRI SEKAMAR DUDUK MELINGKAR BERSAMA MUSYRIF DENGAN LAMPU TEMARAM"]
    --> Step1["TAHAP 1: HENING NAPAS & TADZAKKUR (2 MENIT)<br/>Musyrif memandu santri memejamkan mata, mengatur napas tenang, & menghadirkan kesadaran pandangan Allah."]
    
    Step1 --> Step2["TAHAP 2: REFLEKSI NIAT & ISTIGHFAR TULUS (3 MENIT)<br/>Musyrif membimbing santri mengingat kesalahan lisan, mata, & hati hari ini; melafalkan istighfar bersama."]
    
    Step2 --> Step3["TAHAP 3: ISHLAH UKHUWAH KAMAR (3 MENIT)<br/>Saling memaafkan kesalahan antarteman sekamar; musyrif memberikan 1 kalimat mutiara hikmah."]
    
    Step3 --> Step4["TAHAP 4: DOA TIDUR & RESTORASI GELOMBANG ALFA (2 MENIT)<br/>Membaca doa tidur, mematikan lampu kamar, & tidur dalam keadaan suci berwudhu (21.30 WIB)."]
```
