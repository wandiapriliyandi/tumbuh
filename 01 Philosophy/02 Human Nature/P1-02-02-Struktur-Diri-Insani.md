...
```mermaid
graph TD
    subgraph StrukturInsan["ARSITEKTUR PSIKO-SPIRITUAL SANTRI"]
        Ruh["1. AR-RUH (Dimensi Transendental)<br/>Percikan kehidupan suci yang ditiupkan Allah (QS. Al-Hijr: 29)"]
        Qalb["2. AL-QALB (Pusat Kesadaran & Nilai)<br/>Tahta keimanan, ma'rifat, keikhlasan, & pengemudi akhlak"]
        Aql["3. AL-'AQL (Daya Nalar & Pertimbangan)<br/>Alat membedakan maslahat vs mafsadat & menganalisis sunnatullah"]
        Nafs["4. AN-NAFS (Daya Dorong Biologis & Nafsu)<br/>Energi jasmani, syahwat makan/tidur, amarah membela diri"]
...
```mermaid
graph TD
    Kalbu["QALB (Sang Raja Spiritual)"]
    Akal["AQL (Perdana Menteri Logika)"]
    Syahwat["SYAHWAT (Penyedia Suplai Energi)"]
    Ghadhab["GHADHAB (Panglima Pertahanan/Ghirah)"]
    
    Kalbu <-->|Konsultasi Syar'i| Akal
    Akal -->|Instruksi Disiplin| Syahwat
    Akal -->|Instruksi Pengendalian| Ghadhab
    
    Syahwat -. Menyuplai .-> Raga["Aktivitas Ibadah, Belajar, & Kemandirian Hidup"]
    Ghadhab -. Menjaga .-> Raga
```
