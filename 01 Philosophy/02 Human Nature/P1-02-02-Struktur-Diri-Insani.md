...
```mermaid
flowchart TD
    subgraph TransformasiStrukturDiri["TRANSFORMASI ARSITEKTUR PSIKO-SPIRITUAL INSAN"]
        PolaTerbelahLama["PARADIGMA TERBELAH (LAMA)<br/>• Hafalan otak tanpa sentuhan kalbu.<br/>• Asketisme ekstrem: memusuhi kebutuhan biologis jasad.<br/>• Melahirkan santri hipokrit & kelelahan saraf kronis."]
        
        PolaIntegralTUMBUH["ARSITEKTUR EMPAT DAYA TERPADU (TUMBUH)<br/>• Ruh: Kerinduan Ibadah Transendental.<br/>• Qalb: Raja Kesadaran Moral & Emosional.<br/>• 'Aql: Nalar Kritis & Pertimbangan Maslahat.<br/>• Nafs & Jasad: Energi Biologis yang Terbimbing."]
        
        PolaTerbelahLama ==>|DIREKONSTRUKSI MENJADI| PolaIntegralTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph StrukturDiriInsaniTUMBUH["ARSITEKTUR PSIKO-SPIRITUAL STRUKTUR DIRI INSANI"]
        
        Ruh["1. AR-RUH (Percikan Transendental)<br/>• Hakikat metafisik rahasia Allah; sumber kehidupan & kerinduan kembali kepada Al-Khaliq.<br/>• Nutrisi: Dzikir, Munajat Malam, Tilawah Al-Qur'an, & Ibadah Mahdhah."]
        
        Qalb["2. AL-QALB / SANG RAJA (Pusat Kedaulatan Moral & Spiritual)<br/>• Cermin penerima Nurullah, pengendali niat ikhlas, empati kasih sayang, & Heart-Brain Coherence.<br/>• Memutuskan arah tindakan moral; jika baik maka baiklah seluruh jasad."]
        
        Aql["3. AL-'AQL / PERDANA MENTERI (Daya Nalar Kritis & Prefrontal Cortex)<br/>• Menganalisis sebab-akibat, membedakan maslahat vs mafsadat, & menyusun strategi amal.<br/>• Menjadi penasihat setia bagi Al-Qalb untuk menertibkan An-Nafs."]
        
        NafsJasad["4. AN-NAFS & AL-JASAD / TENTARA BIOLOGIS (Sistem Limbik & Raga)<br/>• Daya dorong syahwat (makan, minum, regenerasi) & ghadhab (keberanian & proteksi).<br/>• Nutrisi: Makanan halal-thayyib, olahraga, istirahat cukup 7 jam, & sanitasi bersih."]
        
        Ruh --> Qalb
        Qalb --> Aql
        Aql --> NafsJasad
        NafsJasad -.->|Menyuplai Energi Fisik| Qalb
    end
```
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranStrukturDiri["EMPAT TINGKATAN KESADARAN INTEGRASI DIRI (MARATIB AL-IDRAK)"]
        
        S1_Level["TINGKAT 1: KESADARAN DOMINASI BIOLOGIS (Al-Idrak al-Hissiy-as-Syahwaniy)<br/>• Perilaku didominasi dorongan impulsif nafsu; santri butuh pengawasan fisik ketat.<br/>• Emosi mudah meledak jika keinginan tertunda; mematuhi aturan demi imbalan fisik."]
        
        S2_Level["TINGKAT 2: KESADARAN NALAR REGULASI DIRI (Al-Idrak al-'Aqliy-al-Mundhabith)<br/>• Prefrontal cortex menguat; akal mampu menahan impuls nafsu secara sadar.<br/>• Santri memahami konsekuensi logis pelanggaran & mampu menunda kepuasan (delay of gratification)."]
        
        S3_Level["TINGKAT 3: KESADARAN KOHERENSI QALBU (Al-Idrak al-Qalbiy-al-Muthmainn)<br/>• Qalb memegang kendali penuh; santri menikmati manisnya ibadah & ukhuwah ikhlas.<br/>• Memiliki radar empati yang peka; terhindar dari penyakit hati & ikhlas beramal."]
        
        S4_Level["TINGKAT 4: KESADARAN INTEGRASI PARIPURNA (Al-Idrak ar-Ruhaniy-al-Kamil)<br/>• Manunggalnya Ruh, Qalb, 'Aql, Nafs, & Jasad dalam penghambaan total (Ubudiyyah).<br/>• Memancarkan wibawa Insan Adabi Kamil; menjadi Live Qudwah pembawa rahmat semesta."]
        
        S1_Level ==> S2_Level ==> S3_Level ==> S4_Level
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolHarmonisasiHarian["DISTRIBUSI HARMONISASI EMPAT DAYA JIWA DALAM 24 JAM"]
        
        Pagi_H["04.00–06.00: ASUPAN RUH & QALB<br/>Tahajjud, Subuh Berjamaah, Dzikir Ma'tsurat, & Muhasabah Niat Ikhlas."]
        Siang_H["07.00–14.00: ASUPAN 'AQL & NALAR<br/>Kajian Kitab, Eksperimen Sains, Diskusi Mantiq, & Pemecahan Masalah."]
        Sore_H["15.30–17.30: ASUPAN NAFS & JASAD<br/>Olahraga Raga, Ekstrakurikuler, Keterampilan Mandiri, & Mandi Bersih."]
        Malam_H["18.30–21.30: SINTESIS ADAB & KOHERENSI<br/>Kajian Akhlak, Refleksi Logbook PBIS, & Persiapan Tidur Thuma'ninah."]
        
        Pagi_H --> Siang_H --> Sore_H --> Malam_H --> Pagi_H
    end
```
...
```mermaid
flowchart TD
    subgraph EtikaTataKelolaStrukturDiri["PRINSIP AKSIOLOGIS PENGASUHAN KESEIMBANGAN JIWA-RAGA"]
        
        K1_E2["1. PERLINDUNGAN HAK BIOLOGIS JASAD (Biological Integrity)<br/>• Menjamin hak tidur santri 6,5–7 jam tanpa pemotongan jam tidur untuk hukuman.<br/>• Menjamin asupan gizi seimbang yang mendukung perkembangan saraf otak."]
        
        K2_E2["2. KULTIVASI KETAJAMAN NALAR KRITIS (Intellectual Flourishing)<br/>• Mendorong santri bertanya, berdiskusi, & meneliti tanpa ancaman dibid'ahkan.<br/>• Menyediakan perpustakaan representatif & laboratorium modern."]
        
        K3_E2["3. PEMURNIAN KALBU BERKELANJUTAN (Spiritual Purification)<br/>• Membiasakan kultur saling memaafkan sebelum tidur malam di kamar asrama.<br/>• Konseling batin rutin oleh musyrif untuk membersihkan dendam & kecemasan."]
