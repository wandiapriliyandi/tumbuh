...
```mermaid
flowchart TD
    subgraph TransformasiPotensiAmanah["TRANSFORMASI PANDANGAN POTENSI SANTRI"]
        PolaSeragamLama["JEBAKAN PENYERAGAMAN KAKU (LAMA)<br/>• Ranking tunggal berdasarkan kecepatan hafalan.<br/>• Santri non-akademik tersingkir & merasa rendah diri.<br/>• Melahirkan lulusan berwawasan sempit."]
        
        PolaKekuatanTUMBUH["MANDAT KHILAFAH & BAKAT DIFERENSIAL (TUMBUH)<br/>• Ahsani Taqwim: Setiap santri membawa modal potensi unggul.<br/>• Kurikulum Berbasis Kekuatan (Strength-Based).<br/>• Melahirkan Pemimpin, Saintis, Teknolog, & Negarawan Beradab."]
        
        PolaSeragamLama ==>|DIREKONSTRUKSI MENJADI| PolaKekuatanTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph MandatKhilafahTUMBUH["MANDAT GANDA KHILAFAH SANTRI TUMBUH"]
        
        Mandat1["1. 'IBADATULLAH (PENGHAMBAAN VERTIKAL)<br/>• Menegakkan Tauhid, Shalat Berjamaah, Dzikir Kalbu, & Tazkiyatun Nafs.<br/>• Menjadi Hamba ('Abd) yang Tunduk Total pada Syariat Allah SWT."]
        
        Mandat2["2. 'IMARATUL ARDH (PEMBANGUNAN PERADABAN HORIZONTAL)<br/>• Memakmurkan Bumi, Meneliti Sains Semesta, Berinovasi Teknologi, & Menjaga Keadilan Sosial.<br/>• Menjadi Khalifah yang Menghadirkan Kemaslahatan Rahmatan lil 'Alamin."]
        
        Mandat1 <===>|Manunggal Harmonis Insan Adabi| Mandat2
    end
```
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranMandatAmanah["EMPAT TINGKATAN KESADARAN MANDAT AMANAH (MARATIB AL-IDRAK)"]
        
        P1_Level["TINGKAT 1: KESADARAN AMANAH INDIVIDUAL (Al-Idrak al-Fardiy)<br/>• Bertanggung jawab atas kebersihan loker, pakaian, & perlengkapan pribadi.<br/>• Menjalankan tugas piket asrama saat diawasi oleh musyrif."]
        
        P2_Level["TINGKAT 2: KESADARAN EKSPLORASI BAKAT (Al-Idrak al-Khabir)<br/>• Menemukan keunikan bakat minat diri (Syakilah); tekun mengasah keterampilan.<br/>• Mengembangkan inisiatif belajar mandiri tanpa bergantung pada instruksi guru."]
        
        P3_Level["TINGKAT 3: KESADARAN KONTRIBUSI UKHUWAH (Al-Idrak al-Khidmiy)<br/>• Menggunakan bakatnya untuk melayani & membantu kawan sekamar asrama.<br/>• Membimbing adik kelas; aktif memimpin divisi kebersihan & keamanan kobong."]
        
        P4_Level["TINGKAT 4: KESADARAN KHILAFAH PERADABAN (Al-Idrak al-Hadharat)<br/>• Menghayati peran dirinya sebagai duta pemakmur bumi (Khalifatullah fil Ardh).<br/>• Menghasilkan karya riset & kepemimpinan berwibawa demi kejayaan umat Islam."]
...
```mermaid
flowchart TD
    subgraph ProtokolAmanahAsrama["PROTOKOL PENYALURAN AMANAH SANTRI ASRAMA"]
        Peta["1. ASESMEN KEKUATAN BAKAT: Memetakan Tipologi Potensi Santri Baru"]
        --> Amanah["2. PENETAPAN AMANAH SPESIFIK: Memberikan Tanggung Jawab Nyata Sesuai Bakat"]
        --> Mentoring["3. MENTORING QUDWAH: Musyrif Membimbing & Mendampingi Pelaksanaan Tugas"]
        --> Evaluasi["4. EVALUASI IPSATIF: Menilai Pertumbuhan Pribadi (Bukan Ranking Membandingkan Antar-Santri)"]
    end
```
