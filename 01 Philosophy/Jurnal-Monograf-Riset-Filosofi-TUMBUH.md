...
```mermaid
graph TD
    subgraph Problem_Sistem_Lama["Patologi Sistem Pembinaan Konvensional"]
        P1["1. Paradigma Punitive & Koersif<br/>Mengandalkan bentakan & hukuman fisik/acak"]
        P2["2. Fragmentasi Antar-Unit<br/>Silo antara Kurikulum, Kesiswaan, Musyrif, dan BK"]
        P3["3. Beban Kerja & Burnout Pendidik<br/>Musyrif lelah tanpa SOP & instrumen data"]
        P4["4. Kepatuhan Semu & Relapse Santri<br/>Santri tertib hanya saat diawasi, membangkang saat bebas"]
    end
...
```mermaid
graph TD
    Method["Triangulasi Metodologi Riset TUMBUH"]
    Method --> T1["1. Sumber Naqliyah & Turats Mu'tabar<br/>(Al-Qur'an, Hadits Shahih, Kitab Klasik Al-Ghazali, Ibn Taimiyyah, Ibnul Qayyim)"]
    Method --> T2["2. Sumber Epistemologi Rasional-Kritis<br/>(Critical Realism Roy Bhaskar, Logika Deduktif Aksiomatis, Ta'dib Al-Attas)"]
    Method --> T3["3. Konsensus Sains Empiris Internasional<br/>(Neurosains Remaja, CASEL SEL, SW-PBIS Horner & Sugai, Self-Determination Theory)"]
```
...
graph TD
    subgraph Model_Triad_Simbiotik["Triad Pertumbuhan Simbiotik & Dual-Pillar Pengasuhan TUMBUH"]
        Santri["1. SANTRI BERTUMBUH (Evolusi Fitrah & Adab)<br/>Mekarnya fitrah, regulasi emosi mandiri, & bertumbuh menjadi Santri Penggerak."]
