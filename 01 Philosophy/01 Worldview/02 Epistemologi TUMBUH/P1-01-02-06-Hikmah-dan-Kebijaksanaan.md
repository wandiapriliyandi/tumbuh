...
```mermaid
flowchart TD
    subgraph TransformasiHikmahPesantren["TRANSFORMASI ILMU MENUJU AL-HIKMAH"]
        PolaKognitifKering["INTEKTUALISME KERING (LAMA)<br/>• Hafal banyak dalil tapi akhlak kasar.<br/>• Hukum diterapkan secara kaku & punitif.<br/>• Kelimpahan data tanpa kebijaksanaan batin."]
        
        PolaHikmahTUMBUH["HIKMAH & ADAB PARIPURNA (TUMBUH)<br/>• Menyatukan Ilmu Shahih, Amal Shalih, & Hal Shadiq.<br/>• Ta'dib: Menempatkan segala sesuatu pada maqamnya.<br/>• Pengasuhan 'Firm & Kind': Tegas pada syariat, lembut pada jiwa."]
        
        PolaKognitifKering ==>|DIREKONSTRUKSI MENJADI| PolaHikmahTUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph TigaPilarHikmah["TIGA PILAR INTEGRAL AL-HIKMAH"]
        I["1. 'ILM ASH-SHAHIH<br/>Pemahaman Akal yang Benar & Bersanad"]
        A["2. 'AMAL ASH-SHALIH<br/>Tindakan Nyata yang Selaras dengan Syariat"]
        H["3. HAL ASH-SHADIQ<br/>Kondisi Batin yang Ikhlas & Khusyuk"]
        
        I & A & H ==> HikmahWujud["AL-HIKMAH PARIPURNA<br/>(Kebijaksanaan Hidup Insan Adabi)"]
    end
```
...
```mermaid
flowchart TD
    subgraph TanggaKognisiHikmah["TANGGA TRANSFORMASI DARI DATA MENUJU AL-HIKMAH"]
        
        L1["1. DATA (Al-Bayanat): Fakta Mentah, Angka, & Informasi Berserakan."]
        --> L2["2. INFORMASI (Al-Ma'lumat): Data yang Terstruktur, Diklasifikasi, & Dipahami Maknanya."]
        --> L3["3. ILMU PENGETAHUAN (Al-'Ilm): Pemahaman Konseptual, Analisis Kausalitas, & Integrasi Dalil."]
        --> L4["4. AL-HIKMAH (Kebijaksanaan): Puncak Ilmu yang Berpadu dengan Adab, Amal Shalih, & Keikhlasan Qalbu."]
    end
```
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranHikmah["EMPAT TINGKATAN KESADARAN HIKMAH (MARATIB AL-IDRAK)"]
        
        H1_Level["TINGKAT 1: KESADARAN TERTIB LITERALIS (Al-Idrak azh-Zhahiriy)<br/>• Mengetahui aturan halal-haram secara harfiah; taat pada aturan tertulis.<br/>• Cenderung kaku dalam bersikap; belum memahami fleksibilitas rukhsah syariat."]
        
        H2_Level["TINGKAT 2: KESADARAN MAQASHID LOGIS (Al-Idrak al-Maqashidiy)<br/>• Memahami hikmah di balik perintah syariat; membedakan ushul dan furu'.<br/>• Mulai mampu menyelesaikan masalah dengan mempertimbangkan situasi & kondisi."]
        
        H3_Level["TINGKAT 3: KESADARAN ADAB RESTORATIF (Al-Idrak al-Adabiy)<br/>• Mempraktikkan prinsip 'Firm & Kind' dalam pergaulan asrama 24 jam.<br/>• Mampu menegakkan batasan moral tanpa merendahkan martabat orang lain."]
        
        H4_Level["TINGKAT 4: KESADARAN HIKMAH INSAN ADABI (Al-Idrak al-Hakimiy)<br/>• Penyatuan paripurna: memiliki Firasah Mukmin yang tajam & wibawa keteladanan.<br/>• Menjadi Live Qudwah yang menyebarkan rahmat, mendamaikan sengketa, & memimpin umat."]
        
        H1_Level ==> H2_Level ==> H3_Level ==> H4_Level
    end
```
...
```mermaid
flowchart TD
    subgraph DialektikaFirmKind["DIALEKTIKA PENGASUHAN HIKMAH (FIRM & KIND)"]
        
        Firm["KETEGASAN (AL-HAZM / FIRM)<br/>• Teguh menjaga batas syariat wahyu, jadwal ibadah, & keselamatan asrama.<br/>• Konsisten menegakkan konsekuensi restitutif tanpa kompromi kezaliman."]
        
        Kind["KELEMBUTAN (AR-RIFQ / KIND)<br/>• Penuh kasih sayang, menghargai perasaan santri, & mendengarkan dengan sabar.<br/>• Mengharamkan kekerasan fisik, bentakan kasar, & penghinaan pribadi."]
        
        Firm <===>|Sintesis Harmonis Al-Hikmah| Kind
    end
```
...
```mermaid
flowchart TD
    subgraph EtikaTataKelolaHikmah["PRINSIP AKSIOLOGIS KEPEMIMPINAN PESANTREN 24 JAM"]
        
        L1_E6["1. KETELADANAN NYATA DI ATAS KATA-KATA (Qudwah Hasanah)<br/>• Asatidz dan musyrif terlebih dahulu mengamalkan apa yang diperintahkan.<br/>• Disiplin ditegakkan melalui pancaran keteladanan akhlak (Live Modeling)."]
        
        L2_E6["2. MATRIKS PENEMPATAN MAQAM ADAB (Proper Placement)<br/>• Menempatkan Allah sebagai tujuan, guru dimuliakan, & teman disayangi.<br/>• Menempatkan aturan asrama sebagai instrumen pendidikan yang memuliakan fitrah."]
        
        L3_E6["3. MEDIASI ISHLAH BERHIKMAH (Restorative Peacebuilding)<br/>• Menyelesaikan perselisihan santri berlandaskan kasih sayang & muhasabah batin.<br/>• Mengikis dendam kesumat & merekonstruksi ukhuwah Islamiyyah yang kokoh."]
