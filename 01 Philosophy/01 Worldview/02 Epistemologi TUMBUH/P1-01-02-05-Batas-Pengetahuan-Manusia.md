...
```mermaid
flowchart TD
    subgraph PetaBatasIlmu["PETA TIGA RANAH PENGETAHUAN MANUSIA"]
        R1["1. AL-MA'LUM BI ASY-SYAR'I WAL 'AQL (Wilayah Terbuka & Pasti)<br/>Kewajiban Ibadah, Fiqh Mu'amalah, Kaidah Matematika, & Hukum Fisika"]
        R2["2. AL-MAJHUL AL-MUMKIN (Wilayah Riset Terbuka Masa Depan)<br/>Misteri Medis, Inovasi AI, Eksplorasi Sains, & Psikologi Remaja (Ranah Ijtihad)"]
        R3["3. AL-GHAIB AL-MUTLAQ (Wilayah Tertutup bagi Nalar Mandiri)<br/>Hakikat Dzat Allah, Hakikat Ruh, Waktu Kiamat, & Takdir Azali (Wajib Pasrah Wahyu)"]
        
        R1 --- R2
        R2 --- R3
        R3 ==> Tawadhu["MELAHIRKAN TAWADHU' INTELEKTUAL (EPISTEMIC HUMILITY)"]
    end
```
...
```mermaid
graph TD
    A["Gugatan Humanisme Sekuler (Pihak A):<br/>'Dengan AI & superkomputer kuantum, manusia akan segera mengetahui segala rahasia alam semesta!'"]
    --> B1["Tinjauan Nash QS. Al-Isra' 85:<br/>Wa ma utitum minal 'ilmi illa qalila (Ilmu manusia hanya setetes di lautan samudra Ilahi)."]
    A --> B2["Tinjauan Filsafat Sains Falibilisme:<br/>Setiap penemuan baru sains justru membuka 10 misteri baru yang belum terjawab."]
    A --> B3["Tinjauan Psikologi Ruhani:<br/>Kesadaran keterbatasan ilmu melenyapkan arogansi intelektual santri."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Akal manusia adalah cermin terbatas; hanya Allah SWT yang Maha Mengetahui."]
```
...
```mermaid
graph TD
    A["Gugatan Pencampuran Wilayah (Pihak A):<br/>'Bolehkah santri meneliti kapan kiamat terjadi atau berijtihad mengubah tata cara wudhu?'"]
    --> B1["Tinjauan Ranah 1 (Al-Ma'lum):<br/>Syariat pokok & hukum sains dasar: Wajib dipelajari & diamalkan secara disiplin."]
    A --> B2["Tinjauan Ranah 2 (Al-Majhul al-Mumkin):<br/>Sains terapan, teknologi digital, & metode pengasuhan: Ruang ijtihad & inovasi bebas."]
    A --> B3["Tinjauan Ranah 3 (Al-Ghaib al-Mutlaq):<br/>Rahasia Dzat Allah & takdir azali: Tertutup bagi akal, wajib tunduk pasrah pada wahyu."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Demarkasi Tiga Ranah mencegah bid'ah syariat & memacu kemajuan teknologi."]
```
...
```mermaid
graph TD
    A["Gugatan Gengsi Akademik (Pihak A):<br/>'Seorang guru/ustadz di depan kelas tidak boleh bilang tidak tahu, nanti wibawanya hancur!'"]
    --> B1["Tinjauan Tradisi Imam Malik:<br/>Menjawab 32 pertanyaan dari 48 soal dengan: 'Laa uhsinu / Laa adri' (Saya tidak mengerti)."]
    A --> B2["Tinjauan Atsar Sahabat:<br/>Ibnu Mas'ud: Barang siapa berfatwa atas setiap pertanyaan, ia orang gila."]
    A --> B3["Tinjauan Etika Pembelajaran:<br/>Keberanian berkata 'Wallahu A'lam' menanamkan kejujuran ilmiah & keteladanan adab."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>'Laa Adri' adalah mahkota kejujuran intelektual & separuh dari ilmu sejati."]
```
...
```mermaid
graph TD
    A["Gugatan Fanatisme Mazhab (Pihak A):<br/>'Hanya mazhab fiqh kelompok kami yang masuk surga, mazhab lain sesat & salah!'"]
    --> B1["Tinjauan Kaidah Fiqh Aswaja:<br/>Kullu mujtahidin mushib / Laa yunkaru al-mukhtalafu fihi (Menghargai khilafiyah ijtihadiyah)."]
    A --> B2["Tinjauan Empat Imam Mazhab:<br/>Imam Malik, Abu Hanifah, Asy-Syafi'i, & Ahmad saling menghormati dan mendoakan."]
    A --> B3["Tinjauan Toleransi Ukhuwah (Tasamuh):<br/>Santri diajarkan berpegang teguh pada dalil tanpa mencela mazhab lain."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Tawadhu' Epistemologis melahirkan moderasi beragama (Wasathiyyah) & ukhuwah."]
```
...
```mermaid
flowchart TD
    A["Gugatan Penerapan Keseharian (Pihak A):<br/>'Bagaimana nilai batas ilmu & tawadhu' ini diwujudkan konkret dalam interaksi harian asrama 24 jam?'"]
    --> B1["Dimensi 1: Budaya Akademis Kelas<br/>Ustadz & santri terbiasa berucap 'Wallahu A'lam' & aktif membuka kamus rujukan."]
    B1 --> B2["Dimensi 2: Evaluasi Kepengurusan<br/>Pengurus asrama membuka kotak saran & audit survei kepuasan santri."]
    B2 --> B3["Dimensi 3: Adab Khidmah Lapangan<br/>Santri senior & asatidz ikut menyapu dan melayani makan santri junior."]
    B3 --> C["Titik Temu Konsensus:<br/>Tawadhu' Intelektual mewujud nyata dalam akhlak rendah hati & pelayanan amanah."]
```
...
```mermaid
graph TD
    subgraph TigaRanahEpistemologi["MATRIKS TIGA RANAH PENGETAHUAN MANUSIA (TUMBUH)"]
        R1["1. AL-MA'LUM (WILAYAH PASTI & TERBUKA)<br/>• Objek: Rukun Iman, Fiqh Ibadah, Kaidah Sains Dasar, Logika Mantiq<br/>• Sikap Manusia: Mempelajari, Mengamalkan, & Mematuhi secara Disiplin"]
        
        R2["2. AL-MAJHUL AL-MUMKIN (WILAYAH RISET & INOVASI)<br/>• Objek: Sains Terapan, Teknologi Digital, Psikologi Remaja, SOP Asrama<br/>• Sikap Manusia: Meneliti Bebas, Berijtihad Kritis, & Berinovasi Tanpa Henti"]
        
        R3["3. AL-GHAIB AL-MUTLAQ (WILAYAH RAHASIA ALLAH)<br/>• Objek: Hakikat Dzat Allah, Hakikat Ruh, Waktu Kiamat, Rincian Takdir Azali<br/>• Sikap Manusia: Tunduk Beriman pada Wahyu, Berhenti dari Spekulasi Liar"]
    end
```
