...
```mermaid
flowchart TD
    subgraph TransformasiEpistemologiIslam["TRANSFORMASI EPISTEMOLOGIS PENDIDIKAN PESANTREN"]
        KrisisEpistemis["KRISIS EPISTEMIS TERFRAGMENTASI (LAMA)<br/>• Saintisme sekuler menolak wahyu & nilai transenden.<br/>• Tekstualisme kaku menolak sains empiris & logika.<br/>• Menghukum santri atas dasar firasat subjektif tanpa bukti."]
        
        EpistemologiTUMBUH["EPISTEMOLOGI INTEGRATIF ISLAM (TUMBUH)<br/>• Wahyu Sharih sebagai Pemandu & Hakim Tertinggi.<br/>• Akal Sehat & Indera Sains Meneliti Keteraturan Sunnatullah.<br/>• Qalbu Bersih Mengikat Keikhlasan Niat 24 Jam."]
        
        KrisisEpistemis ==>|DIREKONSTRUKSI MENJADI| EpistemologiTUMBUH
    end
```
...
flowchart TD
    subgraph StrukturHierarkiEpistemologi["STRUKTUR HIERARKIS EMPAT SALURAN PENGETAHUAN TUMBUH"]
        ...
        W1["1. WAHYU ILAHI / AL-KHABAR ASH-SHADIQ (Hakim Tertinggi)<br/>Mewahyukan Hakikat Metafisik, Akidah, Ibadah, & Standar Moralitas Mutlak."]
        
        A1["2. AKAL SEHAT / AL-'AQL AS-SALIM (Penjelas Logika & Metodologi)<br/>Memahami Teks Wahyu, Menimbang Qiyas Mantiqi, & Merancang Solusi Sains."]
        
        H1["3. PANCAINDERA EMPIRIS / AL-HAWAS AS-SALIMAH (Pengumpul Fakta)<br/>Mengamati Ayat Kauniyyah, Riset Medis/Biologi, & Merekam Data PBIS Asrama."]
        
        I1["4. INTUISI QALBU / AL-ILHAM WA AL-BASHIRAH (Pencerah Batin)<br/>Menghadirkan Kepekaan Nurani, Firasat Mukmin, & Mengikat Keikhlasan Niat."]
        
        W1 ==>|Memandu & Menguji| A1
        W1 ==>|Memberi Kerangka Nilai| H1
        W1 ==>|Menimbang Keabsahan| I1
        
        A1 <===>|Analisis Reflektif| H1
        A1 <===>|Harmonisasi Nilai| I1
    end
```
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranEpistemis["EMPAT TINGKATAN KESADARAN EPISTEMIS (MARATIB AL-IDRAK)"]
        
        E1["TINGKAT 1: KESADARAN INDRAWI-TEKSTUAL (Al-Idrak azh-Zhahiriy)<br/>• Menghafal teks wahyu & matan kitab secara harfiah.<br/>• Mengamati data fisik asrama secara kasat mata & mematuhi SOP tertulis."]
        
        E2["TINGKAT 2: KESADARAN NALAR KRITIS-METODOLOGIS (Al-Idrak al-Burhaniy)<br/>• Mampu menalar kaitan logis antara teks syariat dengan fakta sains empiris.<br/>• Menggunakan logika mantiq; menolak hoaks, takhayul, & sesat pikir."]
        
        E3["TINGKAT 3: KESADARAN KEJERNIHAN BASHIRAH (Al-Idrak al-Irfaniy)<br/>• Kalbu terhubung dengan Muraqabatullah melalui tazkiyatun nafs teratur.<br/>• Memiliki radar nurani yang peka terhadap syubhat & kepalsuan niat batin."]
        
        E4["TINGKAT 4: KESADARAN HIKMAH INTEGRATIF ULUL ALBAB (Al-Idrak al-Jami')<br/>• Penyatuan paripurna Wahyu, Nalar, Indera, & Qalbu dalam kepribadian utuh.<br/>• Berdzikir mengingat Allah & berfikir meneliti semesta sembari memimpin peradaban."]
...
```mermaid
flowchart TD
    subgraph EtikaTataKelolaEpistemologi["PRINSIP AKSIOLOGIS PENGASUHAN PESANTREN 24 JAM"]
        
        Q1_E["1. PENILAIAN BERBASIS BUKTI FAKTUAL (Nahnu Nahkumu bizh-Zhawahir)<br/>• Mengharamkan sanksi disiplin atas dasar sangkaan, firasat sepihak, atau mimpi.<br/>• Setiap keputusan pembinaan wajib didukung data objektif logbook perilaku PBIS."]
        
        Q2_E["2. INTEGRASI SAINS & WAHYU DI RUANG KELAS (Tawhidic Pedagogy)<br/>• Mengajarkan sains empiris sebagai sarana mengagumi kebesaran Allah Al-Khaliq.<br/>• Mengajarkan ilmu agama secara rasional, mendalam, dan kontekstual."]
        
        Q3_E["3. PENGASUHAN DENGAN KASIH SAYANG & EMPATI (Rahmatan lil 'Alamin)<br/>• Pendidik menjaga keikhlasan kalbu (Qalbu) sembari menerapkan metodologi ilmiah (Akal).<br/>• Menjamin iklim belajar yang aman, dialogis, dan merangsang nalar kritis santri."]
