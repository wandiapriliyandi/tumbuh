...
```mermaid
flowchart TD
    subgraph TransformasiIntegrasiIlmu["TRANSFORMASI INTEGRASI KEILMUAN PESANTREN"]
        DikotomiLama["DIKOTOMI ILMU TERPISAH (LAMA)<br/>• Ilmu Agama (Akhirat) vs Ilmu Umum (Dunia).<br/>• Sekularisasi terselubung di kelas sains.<br/>• Islamisasi kosmetik: Tempel dalil sepihak."]
        
        IntegrasiTUMBUH["TAUHIDUL HAQIQAH & POHON ILMU (TUMBUH)<br/>• Manunggalnya Ayat Tanziliyyah & Ayat Kauniyyah.<br/>• Filterisasi Syar'i atas Teori Psikologi & Sains Barat.<br/>• Melahirkan Insan Ulul Albab: Saintis Beradab & Bertakwa."]
        
        DikotomiLama ==>|DIREKONSTRUKSI MENJADI| IntegrasiTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph PohonIlmuTUMBUH["ARSITEKTUR POHON ILMU EKOSISTEM TUMBUH"]
        
        Akar["1. AKAR POKOK (AL-USHOOL): TAUHID & AKIDAH ASWAJA<br/>Keyakinan Mutlak bahwa Allah adalah Sumber Segala Wujud & Kebenaran."]
        
        Batang["2. BATANG UTAMA (AS-SAAQ): TAZKIYATUN NAFS & ADAB<br/>Pembersihan Jiwa dari Penyakit Hati & Penegakan Akhlak Kenabian (Qudwah)."]
        
        CabangSyariat["3. CABANG 1 (AL-FURU'): ULUMUS SYARI'AH<br/>Tafsir, Hadits, Fiqh, Ushul Fiqh, Bahasa Arab, & Maqashid Syari'ah."]
        
        CabangSains["4. CABANG 2 (AL-FURU'): SAINS & HUMANITIES<br/>Neurosains, Psikologi Perkembangan, Matematika, Fisika, Biologi, & PBIS."]
        
        Buah["5. BUAH PARIPURNA (ATS-TSAMARAH): INSAN ADABI KAMIL<br/>Lulusan Ulul Albab yang Bertakwa, Saintifik, Beradab, & Memimpin Peradaban."]
        
        Akar --> Batang
        Batang --> CabangSyariat
        Batang --> CabangSains
        CabangSyariat --> Buah
        CabangSains --> Buah
    end
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranIntegratif["EMPAT TINGKATAN KESADARAN INTEGRATIF (MARATIB AL-IDRAK)"]
        
        I1_Level["TINGKAT 1: KESADARAN DUALISME TERPISAH (Al-Idrak al-Munfashil)<br/>• Menganggap ilmu agama & ilmu sains sebagai dua entitas berbeda yang terpisah.<br/>• Belajar sains hanya demi nilai ujian; belajar agama hanya demi ritual ibadah."]
        
        I2_Level["TINGKAT 2: KESADARAN KOMPARASI PARALEL (Al-Idrak al-Muqaran)<br/>• Mulai mencari kecocokan antara ayat Al-Qur'an dan fakta penemuan sains.<br/>• Menyadari bahwa sains membuktikan kebenaran kabar wahyu secara rasional."]
        
        I3_Level["TINGKAT 3: KESADARAN INTEGRATIF ORGANIK (Al-Idrak al-Muttahid)<br/>• Menghayati sains sebagai sarana tadabbur ayat kauniyyah Allah Al-Khaliq.<br/>• Meneliti biologi, fisika, & psikologi dengan niat ibadah & mengagungkan Allah."]
        
        I4_Level["TINGKAT 4: KESADARAN KEMATANGAN TAUHIDUL HAQIQAH (Al-Idrak al-Wahdaniy)<br/>• Penyatuan paripurna: seluruh disiplin ilmu bermuara pada Makrifatullah.<br/>• Menghasilkan karya riset sains yang sarat adab bagi kemaslahatan peradaban umat."]
        
        I1_Level ==> I2_Level ==> I3_Level ==> I4_Level
    end
```
...
```mermaid
flowchart LR
    subgraph ProtokolFilterisasiTeori["PROTOKOL TIGA LANGKAH REKONSTRUKSI TEORI SAINS"]
        L1["LANGKAH 1: DEKONSTRUKSI ASUMSI FILOSOFIS<br/>Membongkar bias ateisme, materialisme, & determinisme mekanistik."]
        --> L2["LANGKAH 2: EKSTRAKSI DATA EMPIRIS OBJEKTIF<br/>Mengambil data faktual, temuan neurobiologi, & instrumen metodologis valid."]
        --> L3["LANGKAH 3: REKONSEPTUALISASI TAUHIDIK<br/>Membingkai ulang data di bawah Maqashid Syari'ah & Konsep Fitrah Insan."]
    end
```
...
```mermaid
flowchart TD
    subgraph EtikaTataKelolaKurikulum["PRINSIP AKSIOLOGIS KURIKULUM PESANTREN 24 JAM"]
        
        U1_E["1. INTEGRASI TOTAL JADWAL 24 JAM (Holistic Curriculum)<br/>• Menyatukan halaqah masjid, kelas sains madrasah, & rutinitas kamar asrama.<br/>• Menghapus pemisahan tanggung jawab antara ustadz kelas & musyrif asrama."]
        
        U2_E["2. PENDIDIKAN SAINS BERJIWA TAUHID (Theistic Science)<br/>• Guru sains memulai pembelajaran dengan mengagungkan nama Allah Sang Pencipta.<br/>• Guru agama mengaitkan hukum fiqh dengan realitas kesehatan & sains fisik."]
        
        U3_E["3. PENGEMBANGAN POTENSI MULTI-TALENTA (Fitrah Flourishing)<br/>• Memfasilitasi santri berkembang menjadi ulama tafsir, dokter, insinyur, atau saintis.<br/>• Setiap profesi diakui sebagai ladang jihad peradaban yang mulia di hadapan Allah."]
