...
```mermaid
flowchart TD
    subgraph TransformasiProsesKognisi["TRANSFORMASI METODOLOGI PEROLEHAN PENGETAHUAN"]
        PolaHafalanKering["HAFALAN MEKANIS PASIF (LAMA)<br/>• Hafalan tanpa pemahaman makna (Rote Learning).<br/>• Beban kognitif berlebih tanpa jeda istirahat.<br/>• Ilmu terpisah dari adab & perilaku asrama."]
        
        PolaKognisiTUMBUH["SIKLUS KOGNISI EMPAT JALUR (TUMBUH)<br/>• Talaqqi: Transmisi Sanad & Otentisitas Teks.<br/>• Nazhar: Nalar Kritis Burhani & Pemetaan Konsep.<br/>• Tajribah & Tazkiyah: Konsolidasi Memori & Adab Qalbu."]
        
        PolaHafalanKering ==>|DIREKONSTRUKSI MENJADI| PolaKognisiTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranKognisi["EMPAT TINGKATAN KESADARAN KOGNISI (MARATIB AL-IDRAK)"]
        
        C1["TINGKAT 1: KESADARAN RESEPTIF LAHIRIAH (Al-Idrak at-Talaqqiy)<br/>• Mampu menerima, menyimak, & menghafal teks matan kitab secara akurat.<br/>• Mengikuti instruksi teknis asrama secara tertib dan patuh."]
        
        C2["TINGKAT 2: KESADARAN ANALITIS-METODOLOGIS (Al-Idrak an-Nazhariy)<br/>• Mampu menguraikan struktur dalil, membedah 'illat hukum, & berpikir logis.<br/>• Menolak logika sesat; mandiri dalam memecahkan soal dan merangkum konsep."]
        
        C3["TINGKAT 3: KESADARAN PRAKSIS ADAB (Al-Idrak al-'Amaliy)<br/>• Mampu menerapkan kaidah ilmu ke dalam perilaku nyata di asrama 24 jam.<br/>• Memiliki inisiatif merawat lingkungan; disiplin adab tanpa perlu diawasi."]
        
        C4["TINGKAT 4: KESADARAN HIKMAH BERKAH ('Ilmun Nafi' & Qudwah)<br/>• Penguasaan ilmu menyatu dengan ketawadhu'an kalbu & keikhlasan total.<br/>• Mampu mengajarkan ilmu dengan bijak; menjadi figur teladan (Live Qudwah)."]
...
```mermaid
flowchart TD
    subgraph EtikaTataKelolaPedagogi["PRINSIP AKSIOLOGIS PEDAGOGI PESANTREN 24 JAM"]
        
        D1_E["1. PERLINDUNGAN KAPASITAS OTAK SANTRI (Cognitive Load Management)<br/>• Membatasi durasi pengajaran fokus maksimal 45 menit diselingi jeda aktif.<br/>• Mengharamkan metode pemaksaan hafalan ekstrem yang merusak kesehatan saraf."]
        
        D2_E["2. DIDAKTIK INTERAKTIF DI KELAS & HALAQAH (Active Learning)<br/>• Mengganti ceramah satu arah dengan diskusi sokratik yang merangsang nalar kritis.<br/>• Membimbing santri mempraktikkan teori secara langsung di ekosistem asrama."]
        
        D3_E["3. INTEGRASI ILMU DENGAN KETELADANAN AKHLAK (Live Modeling)<br/>• Guru dan musyrif menjadi teladan hidup (Qudwah Hasanah) dalam mengamalkan ilmu.<br/>• Evaluasi pembelajaran mencakup aspek kognitif, keterampilan, & kematangan adab."]
