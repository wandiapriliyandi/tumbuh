...
```mermaid
graph TD
    WV["SUB-DOMAIN 01: WORLDVIEW (PANDANGAN HIDUP ISLAM)"]
    
    WV --> Master["P1-01: Worldview TUMBUH Master (Ru'yatul Islam lil-Wujud & 10 Aksioma Fundamental)"]
    ...
    Onto --> O6["P1-01-01-06: Kritik Internal (Uji Demarkasi Ghaib, Problem of Evil, & Ikhtiar)"]
    Onto --> OInduk["P1-01-01: Hakikat Realitas Induk (Monograf Konsolidasi Ontologi)"]
    
    Epist --> E1["P1-01-02-01: Sumber Pengetahuan (Wahyu, Akal, Indera, Ilham Kalbu)"]
    Epist --> E2["P1-01-02-02: Proses Pengetahuan (Talaqqi, Nazhar, Tajribah, Tazkiyah)"]
    Epist --> E3["P1-01-02-03: Validasi Pengetahuan (Kritik Sanad, Koherensi, Korespondensi, & Ta'arudh)"]
    Epist --> E4["P1-01-02-04: Integrasi Pengetahuan (Tauhidul Haqiqah & Pohon Ilmu)"]
    Epist --> E5["P1-01-02-05: Batas Pengetahuan (Tawadhu' Intelektual QS. 17:85)"]
    Epist --> E6["P1-01-02-06: Hikmah Kebijaksanaan (Puncak Adab Meletakkan Sesuatu pada Maqamnya)"]
    Epist --> E7["P1-01-02-07: Sintesis & Kritik Epistemologi (Audit Kualitas Bebas Sinkretisme)"]
    Epist --> EInduk["P1-01-02: Epistemologi TUMBUH Induk (Monograf Konsolidasi Teori Pengetahuan)"]
```
