...
```mermaid
flowchart TD
    subgraph PohonOntologiRealitasTUMBUH["POHON ONTOLOGI REALITAS EKOSISTEM TUMBUH"]
        Akar["AKAR POKOK: ALLAH SWT (Al-Haqq & Wajib al-Wujud)"]
        Batang["BATANG UTAMA: SUNNATULLAH (Keteraturan Kausalitas Fisik & Moral)"]
        CabangGhaib["CABANG 1: 'ALAM MALAKUT (Malaikat, Ruh, Catatan Hisab Akhirat)"]
        CabangSyahadah["CABANG 2: 'ALAM MULK (Fisik, Biologi Otak, Sanitasi, Interaksi Santri)"]
        Buah["BUAH PARIPURNA: INSAN ADABI (Santri Beradab, Sehat Raga, Cerdas Nalar 24 Jam)"]
        
        Akar --> Batang
        Batang --> CabangGhaib
        Batang --> CabangSyahadah
        CabangGhaib --> Buah
        CabangSyahadah --> Buah
    end
```
...
```mermaid
flowchart TD
    subgraph EnamSubModulRealitasTUMBUH["PETA INTEGRASI ENAM SUB-MODUL HAKIKAT REALITAS"]
        M1["P1-01-01-01: Definisi Realitas (Manunggalnya Mulk & Malakut)"]
        M2["P1-01-01-02: Enam Aksioma Metafisik (Fondasi Kepastian Nalar)"]
        M3["P1-01-01-03: Validasi Dalil Naqli (Tahqiq Nash Mutawatir)"]
        M4["P1-01-01-04: Validasi Turats Klasik (Sanad Intelektual 6 Ulama Aswaja)"]
        M5["P1-01-01-05: Sintesis Filosofis (Deklarasi Realisme Teistik vs 4 Mazhab Barat)"]
        M6["P1-01-01-06: Kritik Internal (Uji Falsifikasi & Desakralisasi SOP)"]
        
        MasterDoktrin["MASTER DOKTRIN: P1-01-01 HAKIKAT REALITAS INDUK<br/>(Arsitektur Realisme Teistik Integratif Pesantren 24 Jam)"]
...
```mermaid
flowchart TD
    subgraph MasterArsitekturRealitasTUMBUH["MASTER ARSITEKTUR REALISME TEISTIK INTEGRATIF TUMBUH"]
        
        subgraph FondasiPilar["EMPAT PILAR KONSEPTUAL MASTER DOKTRIN"]
            P1_Induk["1. TAUHID EKSISTENSIAL (Wajib al-Wujud)<br/>Allah SWT adalah Pencipta Tunggal & Sumber Kebenaran Mutlak."]
            P2_Induk["2. KETERPADUAN DUA ALAM (Mulk & Malakut)<br/>Amal Fisik di Asrama Terhubung Langsung dengan Catatan Akhirat."]
            P3_Induk["3. KEPASTIAN KAUSALITAS (Sunnatullah Objektif)<br/>Hukum Biologis, Fisika, & Syariat Bekerja Konstan & Pasti."]
            P4_Induk["4. KARAMAH FITRAH & AKUNTABILITAS (Hisab Adil)<br/>Setiap Santri Mulia & Bertanggung Jawab Penuh atas Perilakunya."]
        end
        
        subgraph ManifestasiEkosistem["MANIFESTASI OPERASIONAL 24 JAM"]
            E1["• Asrama Sehat, Bersih, & Ramah Biologis."]
            E2["• Disiplin Positif Restoratif Multi-Tier (Firm & Kind)."]
            E3["• Triad Pertumbuhan Simbiotik: Santri, Guru, Lembaga."]
        end
        
        FondasiPilar <===> ManifestasiEkosistem
    end
```
