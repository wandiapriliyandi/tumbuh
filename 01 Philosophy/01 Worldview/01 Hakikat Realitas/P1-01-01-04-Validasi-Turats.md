...
```mermaid
flowchart TD
    subgraph MetodologiTurats["METODOLOGI VALIDASI SANAD KEILMUAN TURATS"]
        T1["1. OTORITAS TEKS INDUK (Tahqiq al-Kutub al-Ushul)<br/>Merujuk langsung pada karya primer Kalam, Ushul Fiqh, dan Tasawuf Falsafi."]
        T2["2. KONSISTENSI PARADIGMATIK (Al-Muhafazhah 'alal Ashl)<br/>Menjaga kemurnian prinsip ontologi Islam dari penyimpangan dekonstruksionisme modern."]
        T3["3. DINAMISASI KONTEKSTUAL (Al-Akhdzu bil Jadid al-Ashlah)<br/>Menerjemahkan konsep klasik menjadi regulasi pengasuhan asrama dan PBIS terukur."]
        
        T1 & T2 & T3 ==> RisetTurats["6 INKUIRI GENEALOGIS DIALEKTIS TERBUKA"]
        RisetTurats ==> KodifikasiBakuTurats["MATRIKS BAKU SANAD TURATS (BAGIAN II)"]
    end
```
...
```mermaid
graph TD
    A["Gugatan Keraguan Wujud (Pihak A):<br/>'Jika alam semesta ini wujud majazi/'adam, apakah asrama & fisik santri hanya ilusi?'"]
    --> B1["Tinjauan Misykat al-Anwar:<br/>Wujud majazi bukan ilusi Maya Hinduisme, melainkan wujud nyata yang bergantung pada Allah."]
    A --> B2["Tinjauan Ihya' 'Ulumiddin:<br/>Ketaatan dhohir di alam mulk adalah jembatan pembentukan makrifat malakut."]
    A --> B3["Tinjauan Psikologi Santri:<br/>Kesadaran kefakiran wujud melenyapkan kesombongan raga & jabatan."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Al-Ghazali meletakkan fondasi Aksioma 1 & 2 secara kokoh."]
```
...
```mermaid
graph TD
    A["Gugatan Subjektivisme (Pihak A):<br/>'Kebenaran sains & moral hanyalah kesepakatan sosial masyarakat!'"]
    --> B1["Tinjauan Majmu' al-Fatawa:<br/>Haqa'iq al-Asyya' Tsabitah: Hakikat alam nyata objektif di luar persepsi."]
    A --> B2["Tinjauan Dar' Ta'arudh:<br/>Fitrah akal sehat manusia dirancang Allah untuk menangkap fakta objektif."]
    A --> B3["Tinjauan PBIS Pesantren:<br/>Aturan asrama berpijak pada fakta dampak perilaku, bukan selera musyrif."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Ibn Taimiyyah memvalidasi Aksioma 4 (Sunnatullah) & Aksioma 6 (Hisab)."]
```
...
```mermaid
graph TD
    A["Gugatan Agnostisisme Moral (Pihak A):<br/>'Apakah nilai baik-buruk hanya relatif bagi tiap individu?'"]
    --> B1["Tinjauan Kitab at-Tawhid Al-Maturidi:<br/>Hakikat wujud & nilai moral buruk/baik memiliki status objektif yang tetap."]
    A --> B2["Tinjauan Matan 'Aqa'id an-Nasafiyyah:<br/>'Haqa'iq al-Asyya' Tsabitah' adalah postulat nomor satu akidah Aswaja."]
    A --> B3["Tinjauan Tata Kelola Disiplin:<br/>Kezaliman perundungan tetap haram mutlak, tak bisa dinegosiasi."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Al-Maturidi mengukuhkan Aksioma 3 (Objektivitas Realitas & Moral)."]
```
...
```mermaid
graph TD
    A["Gugatan Dikotomi Syariat vs Sains (Pihak A):<br/>'Pesantren fokus ibadah saja, ilmu fisika & biologi itu urusan sekuler!'"]
    --> B1["Tinjauan Al-Muwafaqat Asy-Syathibi:<br/>Kausalitas fisik & tuntunan syariat adalah dua sayap penjagaan Hifzh an-Nafs."]
    A --> B2["Tinjauan Kaidah Illat Hukum:<br/>Hukum syariat diletakkan untuk mewujudkan kemaslahatan nyata di alam fisik."]
    A --> B3["Tinjauan Arsitektur Sehat Pesantren:<br/>Ventilasi, sanitasi, & gizi adalah implementasi nyata Maqashid Syari'ah."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Asy-Syathibi memvalidasi integrasi Aksioma 4 (Sunnatullah) & Aksioma 5 (Hikmah)."]
```
...
```mermaid
graph TD
    A["Gugatan Ekstremitas Spiritual (Pihak A):<br/>'Santri harus total tajrid tanpa memikirkan bekal hidup atau kesehatan!'"]
    --> B1["Tinjauan Al-Hikam Hikmah 1 & 2:<br/>Iradatuka at-tajrida ma'a iqamatillahi iyyaka fil asbab minasy syahwah al-khafiyyah."]
    A --> B2["Tinjauan Hikmah Maqam:<br/>Santri berada di Maqam Asbab: wajib giat belajar, merawat raga, & berusaha."]
    A --> B3["Tinjauan Bimbingan Jiwa:<br/>Mencegah frustrasi spiritual santri akibat memaksakan tajrid sebelum waktunya."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Ibnu 'Athaillah memvalidasi harmoni ikhtiar kausalitas dan ketundukan tawakal."]
```
...
```mermaid
graph TD
    TuratsMaster["KHAZANAH TURATS ISLAM ASWAJA"]
    
    TuratsMaster --> GZ["Imam Al-Ghazali (Misykat & Ihya')<br/>-> Validasi Aksioma 1 & 2 (Wujud Hakiki vs Majazi)"]
    TuratsMaster --> IT["Syaikhul Islam Ibn Taimiyyah (Dar' Ta'arudh)<br/>-> Validasi Aksioma 4 & 6 (Realisme Fitrah & Kausalitas)"]
    TuratsMaster --> MT["Imam Al-Maturidi & An-Nasafi ('Aqa'id)<br/>-> Validasi Aksioma 3 & 4 (Haqa'iq al-Asyya' Tsabitah)"]
    TuratsMaster --> SY["Imam Asy-Syathibi (Al-Muwafaqat)<br/>-> Validasi Aksioma 4 & 5 (Maqashid Kausalitas & Hifzh an-Nafs)"]
    TuratsMaster --> IA["Imam Ibnu 'Athaillah (Al-Hikam)<br/>-> Validasi Aksioma 2 & 4 (Harmoni Asbab & Tajrid)"]
    TuratsMaster --> AT["Prof. Syed Muhammad Naquib Al-Attas (Prolegomena)<br/>-> Validasi Aksioma 5 & 6 (Hierarki Wujud & Ta'dib)"]
```
