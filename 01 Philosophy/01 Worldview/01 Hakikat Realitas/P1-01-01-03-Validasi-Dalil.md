...
```mermaid
flowchart TD
    subgraph TransformasiHermeneutikaNash["TRANSFORMASI HERMENEUTIKA NASH DI PESANTREN"]
        TekstualisParsial["HERMENEUTIKA TEKSTUALIS PARSIAL (LAMA)<br/>• Memelintir dalil untuk melegitimasi kekerasan fisik.<br/>• Mencatut dalil tawakkal untuk menormalisasi lingkungan kumuh.<br/>• Dikotomi antara dalil wahyu dan keteraturan sains."]
        
        HermeneutikaTUMBUH["HERMENEUTIKA INTEGRATIF ASWAJA (TUMBUH)<br/>• Validasi Sanad Mutawatir 6 Aksioma Metafisik.<br/>• Integrasi Maqashid Syari'ah & Perlindungan Martabat Insan.<br/>• Harmonisasi Wahyu Sharih, Akal Sehat, & Sains Empiris."]
        
        TekstualisParsial ==>|DIREKONSTRUKSI MENJADI| HermeneutikaTUMBUH
    end
```
...
```mermaid
flowchart LR
    subgraph HarmonisasiAkalDanWahyu["HARMONISASI HERMENEUTIS AKAL & WAHYU"]
        WahyuShahih["Wahyu Sharih (Al-Qur'an & Hadits Mutawatir)"]
        AkalSehat["Nalar Kritis Sehat (Mabadi' Aqliyyah & Sains Empiris)"]
        KebenaranHakiki["Satu Kesatuan Kebenaran Objektif (Al-Haqq Al-Wahid)"]
        
        WahyuShahih --> KebenaranHakiki
        AkalSehat --> KebenaranHakiki
    end
```
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranDalil["EMPAT TINGKATAN KESADARAN HERMENEUTIS (MARATIB AL-IDRAK)"]
        
        H1["TINGKAT 1: KESADARAN TEKSTUAL LAHIRIAH (Al-Idrak al-Harfiy)<br/>• Menghafal matan ayat & hadits kunci beserta arti terjemahannya.<br/>• Mematuhi aturan dhohir syariat (kebersihan, wudhu, shalat tepat waktu)."]
        
        H2["TINGKAT 2: KESADARAN LOGIS MAQASHIDIY (Al-Idrak al-Maqashidiy)<br/>• Memahami hikmah hukum syariat & keterkaitannya dengan sains sunnatullah.<br/>• Menolak penafsiran sempit yang melegitimasi lingkungan kumuh / kekerasan."]
        
        H3["TINGKAT 3: KESADARAN RADAR MURAQABAH (Al-Idrak al-Wijdaniy)<br/>• Menjadikan ayat hisab (QS. Az-Zalzalah) sebagai kompas batiniah otomatis.<br/>• Terbebas dari ghibah & perundungan; bersikap jujur tanpa perlu diawasi."]
        
        H4["TINGKAT 4: KESADARAN HIKMAH PERADABAN (Al-Idrak al-Hikmiy)<br/>• Mampu mengartikulasikan dalil syariat secara bijak bagi peradaban.<br/>• Menjadi teladan hidup akhlak nabawi (Live Qudwah) pembawa rahmat umat."]
...
```mermaid
flowchart TD
    subgraph EtikaTataKelolaMaqashid["PRINSIP AKSIOLOGIS PENGASUHAN BERBASIS MAQASHID"]
        
        M1_E["1. PERLINDUNGAN KEHORMATAN INSAN (Hifzh al-'Irdh)<br/>• Mengharamkan ghibah, namimah, dan penelanjangan aib santri di muka umum.<br/>• Bimbingan konseling adab dilakukan di ruang privat yang aman & rahasia."]
        
        M2_E["2. INTEGRITAS SANITASI & KESEHATAN (Hifzh an-Nafs)<br/>• Menjaga kebersihan toilet, air wudhu, dan sirkulasi udara kamar asrama.<br/>• Pemenuhan nutrisi dan waktu tidur sirkadian santri sebagai amanah syar'i."]
        
        M3_E["3. PENEGAKAN KEADILAN RESTORATIF (Hifzh al-'Adalah)<br/>• Penanganan pelanggaran berbasis dialog tabayyun & restitusi perbaikan.<br/>• Eliminasi mutlak impunitas kekerasan senioritas atau musyrif."]
