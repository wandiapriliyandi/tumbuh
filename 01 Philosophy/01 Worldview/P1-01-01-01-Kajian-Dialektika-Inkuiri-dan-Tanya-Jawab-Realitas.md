...
```mermaid
graph LR
    subgraph Inkuiri1["INQUIRY 1: MENGAPA ONTOLOGI ITU KRUSIAL?"]
        Q["GUGATAN:<br/>'Mengapa pesantren butuh rumusan ontologi formal? Bukankah cukup ngaji kitab dan ibadah rutin?'"]
        --> A["TEMUAN RISET:<br/>Tanpa fondasi ontologis yang jernih, pesantren terjebak dalam dualisme semu: hafal dalil tapi abai realitas fisik sanitasi dan psikososial santri."]
    end
```
...
```mermaid
graph TD
    subgraph KomparasiParadigma["KOMPARASI KAUSAL 3 ASUMSI REALITAS TERHADAP OUTPUT PENDIDIKAN"]
        P1["1. ONTO-MATERIALISME SEKULER<br/>*Asumsi*: Manusia cuma mesin biologis.<br/>*Praktik*: Behaviorisme keras, target pasar kerja.<br/>*Output*: Pintar teknis, miskin empati & spiritual."]
        P2["2. ONTO-MISTISISME PASIF<br/>*Asumsi*: Dunia materi adalah ilusi/kotor.<br/>*Praktik*: Abai sanitasi, anti-sains modern.<br/>*Output*: Ahli wirid, gagap teknologi, rentan sakit."]
        P3["3. REALISME INTEGRAL ISLAM (TUMBUH)<br/>*Asumsi*: Harmoni Wujud Mutlak + Ghaib + Syahadah.<br/>*Praktik*: Qudwah, sains adab, PBIS, kesehatan prima.<br/>*Output*: Insan Kamil / Insan Adabi tangguh 24 jam."]
    end
```
...
```mermaid
graph LR
    subgraph AnalisisLinguistik["AKAR SEMANTIK REALITAS DALAM TURATS ISLAM"]
        Wujud["AL-WUJUD (الوجود)<br/>Dari wajada (menemukan/eksis).<br/>Bukan ilusi atau proyeksi."]
        Haqq["AL-HAQIQAH (الحقيقة)<br/>Dari haqqa (pasti, kokoh, benar).<br/>Lawan dari al-Bathil & al-Wahm."]
        
        Wujud & Haqq ==> Def["REALITAS OPERASIONAL TUMBUH:<br/>Segala mawjud haqiqiy (ghaib & syahadah) yang objektif dan independen dari opini."]
    end
```
...
```mermaid
flowchart TD
    subgraph Uji3Unsur["PENGUJIAN DIALEKTIS 3 UNSUR POKOK REALITAS"]
        U1["UNSUR 1: KEBERADAAN (Al-Wujud)<br/>*Uji*: Wujud Khaliq (Wajib) vs Makhluk (Mumkin)."]
        U2["UNSUR 2: OBJEKTIVITAS (Al-Maudhu'iyyah)<br/>*Uji*: Kepastian Sunnatullah Fisik & Moral."]
        U3["UNSUR 3: INDEPENDENSI DARI PERSEPSI<br/>*Uji*: Kebenaran tidak ditentukan oleh suara terbanyak."]
...
```mermaid
flowchart LR
    subgraph DariOntologiKeAksi["TRANSLASI DEFINISI REALITAS KE OPERASIONAL ASRAMA"]
        Onto["Definisi Realitas (Realisme Integral)"]
        
        Onto --> K1["1. Kurikulum Tauhid Kontekstual (Muraqabah Lapangan)"]
        Onto --> K2["2. SOP Sanitasi & Standar Gizi Biologis Santri"]
        Onto --> K3["3. Arsitektur Asrama Terbuka & Ramah Cahaya/Udara"]
        Onto --> K4["4. Sistem Disiplin Restoratif Berbasis Data PBIS"]
    end
```
