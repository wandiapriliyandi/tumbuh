...
```mermaid
graph LR
    subgraph RelasiFeodal["RELASI FEODAL ASIMETRIS (LAMA)"]
        GuruFeodal["Pendidik Penguasa Mutlak"] -- Titah Otoriter & Hukuman Kasar --> SantriBudak["Santri Pasif & Ketakutan Buta"]
    end

    subgraph RelasiQudwah["RELASI QUDWAH-ATTACHMENT (TUMBUH)"]
        MurabbiQudwah["Murabbi sebagai Figur Ayah Spiritual (In Loco Parentis)"] <== Kasih Sayang & Ta'zhim Berkeadilan ==> SantriBerdaya["Santri Beradab, Kritis, & Berjiwa Merdeka"]
    end
```
