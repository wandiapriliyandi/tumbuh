...
flowchart TD
    subgraph ArsitekturSintesisPendidikan["ARSITEKTUR 6 PILAR FILSAFAT PENDIDIKAN TUMBUH"]
        P1["PILAR 1: FALSAFAH TA'DIB (P1-04-01)<br/>• Penanaman Adab Al-Attas.<br/>• Melampaui Tarbiyah Fisik & Ta'lim Kognitif."]
        
        P2["PILAR 2: RELASI MURABBI-SANTRI (P1-04-02)<br/>• Kasih Sayang KH. Hasyim Asy'ari.<br/>• Secure Attachment John Bowlby."]
        
        P3["PILAR 3: DISIPLIN RESTORATIF PBIS (P1-04-03)<br/>• Teologi Ishlah al-Bain & SW-PBIS.<br/>• Konsekuensi Logis 4R & Anti-Kekerasan."]
        
        P4["PILAR 4: DIDAKTIK RAMAH OTAK (P1-04-04)<br/>• 7 Metode Pengajaran Didaktik Nabawi.<br/>• Kelas Bebas Rasa Takut (Threat-Free)."]
        
        P5["PILAR 5: KRITIK FEODALISME (P1-04-05)<br/>• Dekonstruksi Symbolic Violence & Zero Hazing.<br/>• Pemurnian Tawadhu' & Egalitarianisme."]
        
        P6["PILAR 6: DESAIN EKOLOGI 24 JAM (P1-04-06)<br/>• Living Curriculum 24 Jam Bebas Dikotomi.<br/>• Sinergi 4 Lokus Adab & Arsitektur CPTED."]
        ...
        Pusat["EKOSISTEM PESANTREN BI'AH SHALIHAH 24 JAM<br/>(Pencetak Generasi Insan Adabi Khairu Ummah)"]
...
```mermaid
flowchart TD
    subgraph AuditPedagogiAdab["SIKLUS PENJAMINAN MUTU PEDAGOGI PESANTREN"]
        ReviewModul["1. REVIEW MODUL AJAR TA'DIB<br/>Audit integrasi nilai tauhid & metode aktif dalam setiap RPP."]
        
        SupervisiRamah["2. SUPERVISI KLINIKAL KELAS & ASRAMA<br/>Observasi rasio apresiasi 4:1 & ketiadaan intimidasi."]
        
        SurveiKesejahteraan["3. SURVEI KESEJAHTERAAN SANTRI (STUDENT VOICE)<br/>Santri mengevaluasi rasa aman & kehangatan perlakuan guru."]
        
        CoachingMusyrif["4. CLINICAL COACHING & UPGRADING ASATIDZ<br/>Pelatihan berkala didaktik Nabawi & konseling restoratif."]
        
        ReviewModul --> SupervisiRamah --> SurveiKesejahteraan --> CoachingMusyrif --> ReviewModul
    end
```
