...
```mermaid
flowchart TD
    subgraph KrisisLossOfAdab["DEKONSTRUKSI KRISIS LOSS OF ADAB DALAM PENDIDIKAN"]
        Krisis["KERANCUAN SEMANTIK (LOSS OF ADAB)<br/>Pendidikan disamakan dengan transfer kognitif (Ta'lim) atau fasilitas fisik (Tarbiyah)."]
        
        Dampak["DAMPAK SISTEMIK:<br/>Lahir cendekiawan arogan, perundungan di asrama, & hilangnya keberkahan ilmu."]
        
        Solusi["REKONSTRUKSI TA'DIB AL-ATTAS (TUMBUH):<br/>Pendidikan adalah penanaman adab (Ta'dib) yang menyatukan ilmu ('Ilm), amal ('Amal), & keikhlasan (Ikhlas)."]
        
        Krisis ==> Dampak ==> Solusi
    end
```
...
```mermaid
graph TD
    A["Gugatan Penyamarataan Istilah (Pihak A):<br/>'Tarbiyah, Ta'lim, Ta'dib itu sama saja, tidak perlu dibeda-bedakan secara rumit, yang penting santri diajari ngaji!'"]
    --> B1["Tinjauan Leksikografi Bahasa Arab:<br/>Tarbiyah berakar dari raba/rabba (memelihara jasad); hewan dan tumbuhan pun mengalami tarbiyah."]
    A --> B2["Tinjauan Epistemologi Al-Attas:<br/>Ta'lim berpusat pada transmisi informasi ke akal; Ta'dib menanamkan keadilan nilai ke dalam jiwa (Nafs)."]
    A --> B3["Tinjauan Hadits Nabawi:<br/>Nabi SAW tidak bersabda 'Rabbani Rabbi', melainkan 'Addabani Rabbi' (Tuhanku telah mendidik adabku)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Ta'dib adalah konsep payung paling tepat, komprehensif, dan sakral untuk pendidikan Islam sejati."]
```
...
```mermaid
graph TD
    subgraph RekonstruksiAlAttas["FILSAFAT TA'DIB SYED MUHAMMAD NAQUIB AL-ATTAS"]
        AdabDef["HAKIKAT ADAB:<br/>Pengenalan (Ma'rifah) & Pengakuan (I'tiraf) terhadap posisi yang hakiki (The Right Place) dalam tatanan wujud."]
        
        Keadilan["KEADILAN ('ADL):<br/>Menempatkan segala sesuatu pada tempatnya yang tepat sesuai ketentuan Allah SWT."]
        
        InsanAdabi["HASIL TA'DIB: INSAN ADABI (MAN OF ADAB)<br/>Pribadi yang adil kepada Tuhannya, dirinya, sesama manusia, & alam semesta."]
        
        AdabDef --> Keadilan --> InsanAdabi
    end
```
...
```mermaid
graph TD
    subgraph FondasiWahyuTadib["MANDAT WAHYU & HADITS NABAWI TENTANG TA'DIB"]
        Hadits["HADITS NABAWI: Addabani Rabbi fa Ahsana Ta'dibi<br/>(Pendidikan adab Nabi langsung dibimbing & disempurnakan oleh Allah SWT)."]
        
        AyatTadib["QS. AL-BAQARAH: 151: 4 PILAR RISALAH NABAWI<br/>1. Tilawah Ayat (Membacakan Wahyu)<br/>2. Tazkiyah (Menyucikan Jiwa dari Kotoran)<br/>3. Ta'lim al-Kitab (Mengajarkan Syariat)<br/>4. Ta'lim al-Hikmah (Mengajarkan Kebijaksanaan)"]
        
        Hadits <===> AyatTadib
        AyatTadib ==> KurikulumTUMBUH["KURIKULUM TA'DIB NABAWI EKOSISTEM TUMBUH"]
    end
```
...
```mermaid
graph LR
    subgraph DialektikaPendidikan["DEKONSTRUKSI DUA EKSTREM PENDIDIKAN KELIRU"]
        Ekstrem1["EKSTREM 1: INTELEKTUALISME SEKULER KERING<br/>• Hanya mengejar nilai rapor, ranking, & gelar.<br/>• Akal dipuja, kalbu diabaikan.<br/>• Menghasilkan koruptor pintar & arogansi ilmiah."]
        
        Ekstrem2["EKSTREM 2: DOGMATISME ASKETIS PASIF<br/>• Menolak sains & nalar kritis.<br/>• Menuntut kepatuhan buta tanpa boleh bertanya.<br/>• Menghasilkan santri pasif & inferior."]
        
        Wasathiyyah["JALAN TENGAH TUMBUH: TA'DIB INTEGRATIF<br/>• Nalar kritis sains tajam berpadu dengan kalbu suci.<br/>• Berani berpikir merdeka dalam koridor adab syar'i.<br/>• Menghasilkan Ulul Albab yang berdzikir & berpikir."]
        
        Ekstrem1 --> Wasathiyyah
        Ekstrem2 --> Wasathiyyah
    end
```
...
```mermaid
graph TD
    subgraph KurikulumTadib24Jam["ARSITEKTUR KURIKULUM TA'DIB HOLISTIK 24 JAM"]
        Kelas["1. TA'DIB DI RUANG KELAS (07.00–14.00)<br/>Adab menuntut ilmu, mencatat, menghormati guru, & dialog sokratik santun."]
        
        Asrama["2. TA'DIB DI KAMAR & ASRAMA (14.00–21.45)<br/>Adab hidup bersama, menjaga hak privasi teman, kebersihan, & anti-ghashab."]
        
        Masjid["3. TA'DIB DI MASJID & HALAQAH (04.00–06.00 & 18.00–20.00)<br/>Adab munajat, tilawah, tadabbur, dzikir berjamaah, & khusyuk shalat."]
        
        Sosial["4. TA'DIB DI RUANG PUBLIK & DIGITAL (Setiap Waktu)<br/>Adab makan di kantin, olahraga berkeadilan, & etika berkomunikasi santun."]
        
        Kelas --- Asrama --- Masjid --- Sosial
    end
```
...
```mermaid
flowchart TD
    subgraph TataKelolaBudayaTadib["MANAJEMEN STRATEGIS BUDAYA TA'DIB PESANTREN"]
        KulturAsatidz["1. KULTUR ASATIDZ QUDWAH<br/>Guru meneladankan adab sebelum menuntutnya dari santri (Lead by Example)."]
        
        SistemAsrama["2. INFRASTRUKTUR ASRAMA BERKEADILAN<br/>Fasilitas bersih, privasi terjaga, & ketiadaan diskriminasi kelas sosial."]
        
        SOPRestoratif["3. PENEGAKAN ATURAN RESTORATIF<br/>Menangani pelanggaran dengan mendidik kesadaran adab, bukan dendam fisik."]
        
        KulturAsatidz --> SistemAsrama --> SOPRestoratif
    end
```
...
```mermaid
graph TD
    subgraph Matriks5DimensiAdab["5 DIMENSI KURIKULUM TA'DIB ASRAMA PESANTREN"]
        D1["1. ADAB KEPADA ALLAH & RASUL-NYA<br/>Ikhlas niat, khusyuk shalat berjamaah, tadabbur Al-Qur'an, & muraqabah."]
        
        D2["2. ADAB KEPADA GURU & MUSYRIF<br/>Ta'zhim mahabbah, mendengarkan seksama, mendoakan, & bertutur santun."]
        
        D3["3. ADAB KEPADA SESAMA SANTRI<br/>Ukhuwah, ithar (mendahulukan rekan), anti-ghashab, & menjaga aib teman."]
        
        D4["4. ADAB KEPADA DIRI SENDIRI<br/>Menjaga kebersihan diri, istirahat cukup, menjaga lisan, & tidak merendahkan diri."]
        
        D5["5. ADAB KEPADA ILMU & LINGKUNGAN<br/>Menjaga kitab suci, mencatat faedah, merawat fasilitas asrama, & hemat air."]
    end
```
...
```mermaid
flowchart TD
    subgraph StandarPembelajaranTadib["PROTOKOL 4 LANGKAH PEMBELAJARAN BERBASIS TA'DIB"]
        Niat["1. PENATAAN NIAT & THAHARAH BATIN (5 Menit Awal)<br/>Guru dan santri memulai dengan doa, istighfar, & menyucikan niat lillahi ta'ala."]
        
        Koneksi["2. INTEGRASI HIKMAH TAUHID DALAM MATERI<br/>Menghubungkan setiap konsep ilmiah (sains/fiqh/bahasa) dengan keagungan Allah SWT."]
        
        Dialog["3. DIALOG SOKRATIK RAMAH & MERDEKA BERPIKIR<br/>Mendorong santri bertanya kritis tanpa takut salah; guru mengapresiasi rasa ingin tahu."]
        
        Refleksi["4. PENUTUPAN BERADAB & RENCANA AMAL (5 Menit Akhir)<br/>Menyimpulkan hikmah pelajaran, membaca doa kaffaratul majlis, & mencium tangan guru penuh takzim."]
        
        Niat --> Koneksi --> Dialog --> Refleksi
    end
```
