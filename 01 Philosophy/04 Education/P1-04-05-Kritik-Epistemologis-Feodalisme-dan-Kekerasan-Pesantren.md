...
```mermaid
flowchart TD
    subgraph DekonstruksiFeodalismePesantren["DEKONSTRUKSI FEODALISME MENUJU ADAB TAUHID"]
        PolaFeodalLama["FEODALISME & KEKERASAN SIMBOLIK (LAMA):<br/>• Kepatuhan buta tanpa nalar logis.<br/>• Senioritas menindas & sidang kamar gelap.<br/>• Mitos sesat: Pukulan fisik mendatangkan berkah."]
        
        PolaEmansipasiTUMBUH["ADAB TAUHID & KEMERDEKAAN AKAL (TUMBUH):<br/>• Tawadhu' sejati: Rendah hati karena Allah.<br/>• Ukhuwah egaliter: Mengharamkan perpeloncoan 100%.<br/>• Barakah hakiki: Bersumber dari amal shalih & keadilan."]
        
        PolaFeodalLama ==>|DIREKONSTRUKSI MENJADI| PolaEmansipasiTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph PemurnianAdabTUMBUH["DISTINGSI EPISTEMOLOGIS ADAB ISLAMI VS FEODALISME"]
        
        subgraph AdabIslamiAutentik["ADAB ISLAMI AUTENTIK (TAWADHU' HAQIQI)"]
            A1["• Bersumber dari Tauhid & Ikhlas karena Allah SWT."]
            A2["• Guru mengasihi murid; murid menghormati guru."]
            A3["• Menghidupkan Nalar Kritis yang Santun & Berilmu."]
            A4["• Wibawa memancar dari Kesalehan & Qudwah Nyata."]
        end
        
        subgraph FeodalismeOtoritarian["FEODALISME OTORITARIAN (DISTORSI TOKSIK)"]
            F1["• Bersumber dari Relasi Kuasa, Takut Sanksi, & Ghuluw."]
            F2["• Eksploitasi santri sebagai pelayan domestik pribadi."]
            F3["• Membungkam Akal Pikiran melalui Mitos Teror Kualat."]
            F4["• Wibawa ditegakkan lewat Tongkat Rotan & Intimidasi."]
        end
        
        AdabIslamiAutentik <===>|DIPERIKSA & DIMURNIKAN| FeodalismeOtoritarian
    end
```
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranEmansipasiAdab["EMPAT TINGKATAN KESADARAN EMANSIPASI ADAB (MARATIB AL-IDRAK)"]
        
        F1_Eman["TINGKAT 1: KESADARAN KEPATUHAN DOKTRIN (Al-Idrak al-Muqallid)<br/>• Menghormati guru & senior semata-mata karena tradisi yang diwariskan asrama.<br/>• Rentan terjebak dalam rasa takut kualat yang irasional karena belum memahami dalil."]
        
        F2_Eman["TINGKAT 2: KESADARAN KRITIS HUKUM SYARI'AT (Al-Idrak an-Naqid)<br/>• Mampu membedakan perintah guru yang selaras syariat dengan perintah yang melanggar.<br/>• Menolak kekerasan fisik & perpeloncoan dengan berani menyuarakan kebenaran."]
        
        F3_Eman["TINGKAT 3: KESADARAN TAWADHU' TAUHID (Al-Idrak al-Mutawadhi')<br/>• Menghormati guru & ulama atas dasar ketakwaan kepada Allah, bukan rasa takut manusia.<br/>• Rendah hati tanpa merasa rendah diri; beradab penuh takzim dalam dialektika ilmiah."]
        
        F4_Eman["TINGKAT 4: KESADARAN EMANSIPATORIS PARIPURNA (Al-Idrak al-Muharrir al-Kamil)<br/>• Puncak kematangan: membebaskan manusia dari tirani kezaliman menuju keadilan Islam.<br/>• Menjadi Live Qudwah pelindung kaum tertindas; memimpin peradaban santri yang merdeka."]
        
        F1_Eman ==> F2_Eman ==> F3_Eman ==> F4_Eman
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolAntiHazing["PROTOKOL PENCEGAHAN & PENINDAKAN PERPELONCOAN"]
        Larangan["1. LARANGAN MUTLAK: Mengharamkan Sidang Kamar Gelap, Pemukulan, & Tugas Pelayan Domestik"]
        --> Pengawasan["2. PENGAWASAN AKTIF: Musyrif Berpatroli Rutin di Jam-Jam Rawan (Malam & Dini Hari)"]
        --> Sanksi["3. SANKSI TEGAS: Pencopotan Gelar Kepengurusan & Skorsing Pelaku Perpeloncoan"]
        --> Pemulihan["4. REHABILITASI RESTORATIF: Mediasi Rekonsiliasi & Edukasi Ukhuwah bagi Seluruh Kamar"]
    end
```
...
```mermaid
flowchart TD
    subgraph EtikaTataKelolaKesetaraan["PRINSIP AKSIOLOGIS KESETARAAN MARTABAT SANTRI"]
        
        K_E1["1. KESETARAAN HUKUM DI HADAPAN SYARIAT (Equal Dignity Under Sharia)<br/>• Tidak ada kebal hukum bagi anak kiai (Gus/Ning), pengurus senior, atau asatidz.<br/>• Seluruh pelanggaran adab diproses dengan standar keadilan yang sama."]
        
        K_E2["2. KEMERDEKAAN NALAR DIALOGIS (Epistemic Freedom)<br/>• Menjamin kebebasan santri bertanya & menguji argumentasi ilmiah secara santun.<br/>• Mengharamkan vonis kualat untuk membungkam diskusi nalar kitab kuning."]
        
        K_E3["3. UKHUWAH KASIH SAYANG TANPA KASTA (Casteless Brotherhood)<br/>• Senior memposisikan diri sebagai kakak pembimbing yang melindungi adik kelas.<br/>• Menolak tradisi pembedaan fasilitas eksklusif yang memicu kecemburuan."]
