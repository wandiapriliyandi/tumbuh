...
```mermaid
flowchart TD
    subgraph TransformasiParadigmaDisiplin["TRANSFORMASI PARADIGMA DISIPLIN PESANTREN"]
        Retributif["PARADIGMA RETRIBUTIF (LAMA)<br/>• Fokus pada pelanggaran aturan & hukuman fisik.<br/>• Menghasilkan penderitaan, dendam, & kepatuhan semu.<br/>• Korban diabaikan; relasi rusak."]
        
        Restoratif["PARADIGMA RESTORATIF PBIS (TUMBUH)<br/>• Fokus pada pemulihan luka relasi & tanggung jawab adab.<br/>• Menghasilkan kesadaran empati, perbaikan nyata, & ishlah.<br/>• Korban dipulihkan; ukhuwah asrama semakin kokoh."]
        
        Retributif ==>|TRANSFORMASI MUTLAK| Restoratif
    end
```
...
```mermaid
graph TD
    A["Gugatan Militeristik (Pihak A):<br/>'Santri itu kalau melanggar harus dihajar biar kapok! Kalau cuma diajak musyawarah ishlah, aturan pondok jadi diremehkan!'"]
    --> B1["Tinjauan Tafsir QS. Al-Hujurat 9–10:<br/>Perintah tegas Allah untuk melakukan Ishlah bil-'Adl (perdamaian berkeadilan) antarsaudara yang berselisih."]
    A --> B2["Tinjauan Hadits Keutamaan Ishlah:<br/>Rasulullah SAW menegaskan mendamaikan perselisihan lebih utama dari derajat shalat, puasa, & sedekah sunnah."]
    A --> B3["Tinjauan Fiqh Diyat & Restitusi:<br/>Hukum Islam mendahulukan ganti rugi pemulihan hak korban sebelum sanksi pembalasan."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Disiplin Restoratif berakar langsung pada teologi Ishlah al-Bain Al-Qur'an dan Sunnah."]
```
...
```mermaid
graph TD
    subgraph PiramidaPBISTUMBUH["ARSITEKTUR MULTI-TIER PBIS PESANTREN TUMBUH"]
        Tier1["TIER 1: PENCEGAHAN UNIVERSAL (80–90% SANTRI)<br/>• Seluruh santri di asrama & madrasah.<br/>• Pengajaran eksplisit adab harian, matriks harapan perilaku jelas, sapaan hangat, & apresiasi rasio 4:1."]
        
        Tier2["TIER 2: INTERVENSI TARGETED (10–15% SANTRI)<br/>• Santri dengan risiko pelanggaran berulang ringan.<br/>• Sistem Check-in / Check-out (CICO) musyrif, mentoring sahabat sebaya, & kelompok regulasi emosi."]
        
        Tier3["TIER 3: INTERVENSI INTENSIF (1–5% SANTRI)<br/>• Santri dengan kasus krisis / pelanggaran adab berat.<br/>• Functional Behavior Assessment (FBA), rencana dukungan perilaku individual (BIP), & konseling terpadu."]
...
```mermaid
graph LR
    subgraph KomparasiPertanyaan["KOMPARASI PERTANYAAN: INTEROGASI LAMA vs RESTORATIF TUMBUH"]
        Lama["INTEROGASI PUNITIF LAMA:<br/>1. 'Kenapa kamu melanggar aturan?!'<br/>2. 'Siapa yang menyuruhmu?!'<br/>3. 'Kamu tahu hukumannya apa?!'<br/>(Memicu defensif, berbohong, & takut)."]
        
        Baru["5 PERTANYAAN RESTORATIF TUMBUH:<br/>1. 'Apa yang sebenarnya terjadi?'<br/>2. 'Apa yang kamu rasakan saat itu?'<br/>3. 'Siapa yang dirugikan oleh hal ini?'<br/>4. 'Bagaimana perasaan mereka?'<br/>5. 'Bagaimana kamu memperbaikinya?'<br/>(Membangkitkan nurani, empati, & tanggung jawab)."]
        
        Lama ==>|DEKONSTRUKSI TOTAL| Baru
    end
```
...
```mermaid
graph TD
    subgraph SyaratKonsekuensi4R["FORMULA 4R KONSEKUENSI LOGIS BERADAB"]
        R1["1. RELATED (TERKAIT SECARA LOGIS)<br/>Konsekuensi memiliki kaitan langsung dengan perilaku pelanggaran."]
        
        R2["2. RESPECTFUL (DISAMPAIKAN DENGAN SANTUN)<br/>Tanpa amarah, tanpa hinaan martabat, & tanpa mempermalukan di depan umum."]
        
        R3["3. REASONABLE (MASUK AKAL & ADIL)<br/>Proporsional dengan usia santri & tidak melampaui batas kewajaran."]
        
        R4["4. RESTORATIVE (MEMULIHKAN UKHUWAH)<br/>Memperbaiki kerugian korban & mengembalikan kedamaian asrama."]
...
```mermaid
graph TD
    subgraph MatriksResponPelanggaran["ALUR RESPON PELANGGARAN MULTI-TIER ASRAMA"]
        P1["PELANGGARAN RINGAN (TIER 1)<br/>• Terlambat bangun, lupa merapikan kasur, buang sampah kecil.<br/>• Respon: Pengingat ramah musyrif & perbaikan langsung di tempat."]
        
        P2["PELANGGARAN SEDANG (TIER 2)<br/>• Ghashab berulang, bolos halaqah, perselisihan verbal antar-santri.<br/>• Respon: Dialog Restoratif 1-on-1, CICO Mentoring, & Konsekuensi 4R."]
        
        P3["PELANGGARAN BERAT (TIER 3)<br/>• Kekerasan fisik, perundungan sistemik, pencurian, pornografi.<br/>• Respon: Konferensi Restoratif Lengkap, Konseling BK Intensif, & Pemulihan Komunal."]
...
```mermaid
flowchart TD
    subgraph KomitmenAntiPengusiranSepihak["DOKTRIN PERLINDUNGAN & PENDIDIKAN TUNTAS"]
        Masalah["SANTRI MENGALAMI KRISIS PERILAKU BERAT (TIER 3)"]
        
        LangkahLama["RESPON KELIRU LAMA:<br/>Langsung mengeluarkan/drop-out santri secara sepihak (Melempar masalah ke masyarakat)."]
        
        LangkahTUMBUH["RESPON RESTORATIF TUMBUH:<br/>1. Tim Kasus Khusus (BK, Musyrif, Ahli, & Wali Santri).<br/>2. Program Pemulihan Karakter Intensif 90 Hari.<br/>3. Reintegrasi Penuh ke Asrama Tanpa Stigmatisasi."]
        
        Masalah ==> LangkahTUMBUH
        LangkahLama -.->|DIHAPUS 100%| LangkahTUMBUH
    end
```
...
| :--- | :--- | :--- | :--- |
| **Tier 1: Universal**<br/>*(Pencegahan Primer)* | **100% Seluruh Santri**<br/>*(Target 80–90% Stabil)* | • Pembiasaan adab harian dengan kurikulum terstruktur.<br/>• Pemasangan papan panduan visual adab di kamar & lorong.<br/>• Penerapan rasio apresiasi verbal 4:1 oleh seluruh musyrif.<br/>• 3 Jangkar Harian (Sapa Pagi, Makan Nampan, Muhasabah Malam). | Seluruh Wali Kamar, Musyrif Asrama, & Asatidz Madrasah.[^23] |
| **Tier 2: Targeted**<br/>*(Intervensi Sekunder)* | **10–15% Santri**<br/>*(Risiko Pelanggaran Ringan Berulang)* | • Program *Check-In / Check-Out (CICO)* harian bersama musyrif.<br/>• Pendampingan kelompok kecil regulasi emosi & manajemen waktu.<br/>• Pemasangan teman mentor sebaya (*Buddy System*) dari Santri T4.<br/>• Kontrak belajar adab personal mingguan. | Musyrif Senior, Tim Bimbingan Konseling (BK), & Mentor Sebaya.[^24] |
| **Tier 3: Intensive**<br/>*(Intervensi Tersier)* | **1–5% Santri**<br/>*(Kasus Krisis & Pelanggaran Berat)* | • Pelaksanaan *Functional Behavior Assessment (FBA)* mendalam.<br/>• Penyusunan *Behavior Intervention Plan (BIP)* individual.<br/>• Konseling keluarga terpadu (*Family Wraparound Support*).<br/>• Konferensi Restoratif Komunal dan pemantauan 90 hari. | Tim Kasus Khusus PBIS, Kepala Pengasuhan, Psikolog, & Wali Santri.[^25] |
...
```mermaid
flowchart TD
    Tahap1["1. PRA-KONFERENSI (PRE-CONFERENCE)<br/>Fasilitator bertemu terpisah dengan Korban & Pelaku; memastikan kesiapan emosi & ketiadaan intimidasi."]
    
    Tahap2["2. PEMBUKAAN & PENETAPAN KESEPAKATAN BERSAMA<br/>Fasilitator membuka forum dengan doa, menyepakati adab berbicara santun, & menjaga kerahasiaan."]
    
    Tahap3["3. NARASI PELAKU & REFLEKSI NURANI<br/>Pelaku menceritakan kronologi kejadian & menyadari siapa saja yang dirugikan oleh perbuatannya."]
    
    Tahap4["4. SUARA KORBAN & DAMPAK PERASAAN<br/>Korban menyampaikan luka perasaan & kerugian yang dialaminya secara jujur & aman."]
    
    Tahap5["5. PERUMUSAN RENCANA RESTITUSI BERSAMA (AGREEMENT)<br/>Menyepakati tindakan perbaikan nyata (ganti rugi/restitusi) yang wajib dijalankan pelaku."]
    
    Tahap6["6. ISHLAH & PENUTUPAN UKHUWAH<br/>Kedua pihak bersalaman, saling mendoakan, & menandatangani nota kesepahaman ishlah."]
    
    Tahap1 --> Tahap2 --> Tahap3 --> Tahap4 --> Tahap5 --> Tahap6
```
