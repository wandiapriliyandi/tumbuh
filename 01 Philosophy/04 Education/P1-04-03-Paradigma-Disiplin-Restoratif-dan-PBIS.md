...
```mermaid
flowchart TD
    subgraph TransformasiParadigmaDisiplin["TRANSFORMASI SISTEM PENEGAKAN DISIPLIN"]
        PolaRetributifLama["PARADIGMA RETRIBUTIF PUNITIF (LAMA)<br/>• Fokus: Melukai pelaku agar jera.<br/>• Cara: Cambuk, tamparan, botak, & pengarakan.<br/>• Hasil: Dendam batin & ketaatan semu karena takut."]
        
        PolaRestoratifTUMBUH["DISIPLIN RESTORATIF & MULTI-TIER PBIS (TUMBUH)<br/>• Fokus: Memulihkan hak korban & menyadarkan pelaku.<br/>• Cara: Konsekuensi Logis 4R & Konferensi Ishlah.<br/>• Hasil: Taubat nasuha, tanggung jawab moral, & ukhuwah erat."]
        
        PolaRetributifLama ==>|DIREKONSTRUKSI MENJADI| PolaRestoratifTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph PiramidaPBISTUMBUH["PIRAMIDA MULTI-TIER PBIS RESTORATIF PESANTREN"]
        
        Tier3["TIER 3: INTERVENSI INTENSIF INDIVIDUAL (1–5% Santri)<br/>• Functional Behavior Assessment (FBA), Konseling BK Mendalam, & Wraparound Support.<br/>• Penanganan krisis perilaku berat tanpa kekerasan fisik; pemulihan restoratif terpadu."]
        
        Tier2["TIER 2: INTERVENSI KELOMPOK TERARAH (10–15% Santri)<br/>• Check-in / Check-out (CICO) Coaching, Pelatihan Regulasi Emosi, & Mentor Sebaya.<br/>• Pendampingan preventif bagi santri yang mulai menunjukkan penurunan adab."]
        
        Tier1["TIER 1: INTERVENSI UNIVERSAL ASRAMA (80–90% Santri)<br/>• Pembiasaan Adab Kamar 24 Jam, Penguatan Rasio Apresiasi 4:1, & Halaqah Sapa Pagi.<br/>• Lingkungan aman Bi'ah Shalihah yang konsisten & transparan bagi seluruh santri."]
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranDisiplin["EMPAT TINGKATAN KESADARAN PENEGAKAN DISIPLIN (MARATIB AL-IDRAK)"]
        
        D1_Dis["TINGKAT 1: KESADARAN KETAKUTAN SANKSI (Al-Idrak al-Khaufiy)<br/>• Mematuhi aturan semata-mata karena takut ditegur atau mendapatkan sanksi konsekuensi.<br/>• Ketaatan masih bersifat lahiriah & bergantung pada keberadaan sosok musyrif."]
        
        D2_Dis["TINGKAT 2: KESADARAN TANGGUNG JAWAB LOGIS (Al-Idrak al-Mas'ul)<br/>• Memahami relasi sebab-akibat antara perilakunya & dampaknya terhadap kenyamanan kawan.<br/>• Bersedia melakukan restitusi ganti rugi secara sukarela jika melakukan kesalahan."]
        
        D3_Dis["TINGKAT 3: KESADARAN INTEGRITAS ISHLAH (Al-Idrak al-Mushlih)<br/>• Disiplin ditegakkan atas dasar muraqabah batin kepada Allah SWT.<br/>• Aktif menjaga ketertiban asrama; berinisiatif mendamaikan kawan yang berselisih."]
        
        D4_Dis["TINGKAT 4: KESADARAN BUDAYA ADAB RESTORATIF PARIPURNA (Al-Idrak al-Adabiy al-Kamil)<br/>• Puncak kematangan: keadilan, kasih sayang, & kejujuran memancar alami sebagai watak hidup.<br/>• Menjadi Live Qudwah penegak keadilan tanpa amarah; memimpin peradaban santri yang damai."]
        
        D1_Dis ==> D2_Dis ==> D3_Dis ==> D4_Dis
    end
```
