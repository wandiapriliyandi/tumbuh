...
```mermaid
flowchart TD
    subgraph DidaktikNabawiRamahOtak["TRANSFORMASI DIDAKTIK PENGAJARAN KELAS"]
        KelasLama["KELAS MONOLOG PENUH ANCAMAN (LAMA)<br/>• Guru ceramah satu arah 100%.<br/>• Salah membaca langsung dibentak/dihukum.<br/>• Otak panik (Amigdala aktif); hafalan cepat hilang."]
        
        KelasTUMBUH["KELAS DIDAKTIK NABAWI RAMAH OTAK (TUMBUH)<br/>• Pembelajaran aktif, dialog sokratik, & media visual.<br/>• Kesalahan dirayakan sebagai bahan belajar.<br/>• Otak rileks (PFC aktif); pemahaman menghunjam kokoh."]
        
        KelasLama ==>|TRANSFORMASI TOTAL| KelasTUMBUH
    end
```
...
```mermaid
graph TD
    A["Gugatan Monolog Kuno (Pihak A):<br/>'Tradisi mengajar kitab kuning itu guru membaca, santri memaknai dan diam mendengarkan sampai selesai. Metode aktif modern itu bid'ah barat!'"]
    --> B1["Tinjauan Hadits Shahih Bukhari 6417:<br/>Rasulullah SAW menggambar sketsa visual garis di atas tanah untuk memahamkan konsep ajal & angan-angan."]
    A --> B2["Tinjauan Hadits Dialog Sokratik:<br/>Nabi SAW memantik nalar sahabat dengan pertanyaan induktif: 'Atadruna manil muflis?' (Tahukah kalian siapa orang bangkrut?)."]
    A --> B3["Tinjauan Kitab Ar-Rasul al-Mu'allim (Syekh Abdul Fattah Abu Ghuddah):<br/>Ulama mendokumentasikan 40 metode didaktik aktif pengajaran interaktif Rasulullah SAW."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Pembelajaran aktif, dialogis, dan visual adalah Sunnah Nabawiyyah murni yang paling otentik."]
```
...
```mermaid
graph TD
    subgraph NeurosainsKognitifKelas["MEKANISME NEUROSAINS KELAS RAMAH OTAK"]
        Aman["LINGKUNGAN KELAS AMAN SECARA PSIKOLOGIS<br/>(Guru tersenyum, mengapresiasi, & menoleransi salah)."]
        
        PFC["KORTEKS PREFRONTAL (dlPFC) TERAKTIVASI OPTIMAL<br/>Memori kerja aktif, nalar logis tajam, & dopamin dilepaskan."]
        
        Konsolidasi["KONSOLIDASI MEMORI JANGKA PANJANG (HIPOKAMPUS)<br/>Ilmu menyatu dengan struktur kognitif & menjadi pemahaman permanen."]
        
        Aman --> PFC --> Konsolidasi
    end
```
...
```mermaid
graph LR
    subgraph KaganKitabKuning["INTEGRASI STRUKTUR KAGAN DALAM NGAJI KITAB"]
        S1["1. THINK-PAIR-SHARE<br/>Santri merenungkan arti ayat/matan 1 menit -> Diskusi berpasangan 2 menit -> Berbagi ke kelas."]
        
        S2["2. NUMBERED HEADS TOGETHER<br/>Kelompok kecil 4 santri; nomor yang ditunjuk guru menjawab perwakilan tim."]
        
        S3["3. JIGSAW BAHARU<br/>Setiap santri menjadi ahli satu bab kitab kuning -> Kembali ke kelompok asal untuk mengajarkan temannya."]
...
```mermaid
graph TD
    subgraph TransformasiHalaqah["TRANSFORMASI HALAQAH KITAB KUNING"]
        HalaqahLama["HALAQAH MONOLOG LAMA:<br/>Guru membaca & menerjemahkan kata per kata; santri mencatat tanpa tanya; interaksi 1 arah."]
        
        HalaqahTUMBUH["HALAQAH DIALOGIS TUMBUH:<br/>1. Guru membaca matan & memaparkan dalil.<br/>2. Santri menganalisis qawa'id bahasa & illat hukum dalam kelompok.<br/>3. Diskusi Bahtsul Masail solutif terhadap problematika kontemporer.<br/>4. Refleksi tazkiyah hikmah di akhir majelis."]
        
        HalaqahLama ==>|TRANSFORMASI| HalaqahTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ManajemenKelasPositif["3 PILAR MANAJEMEN KELAS POSITIF (TUMBUH)"]
        R1["1. RUTINITAS AWAL & AKHIR KELAS<br/>Greeting di pintu, penataan meja rapi, pembacaan doa niat, & Exit Ticket refleksi."]
        
        R2["2. TANDA ISYARAT TRANSISI NON-VERBAL<br/>Irama tepukan tangan atau lonceng lembut untuk meminta perhatian tanpa berteriak."]
        
        R3["3. ASESMEN FORMATIF OTENTIK NON-STRES<br/>Kuis kilat jempol (Thumbs Up/Down), papan tulis mini santri, & rubrik kemajuan mandiri."]
...
```mermaid
graph TD
    subgraph EkosistemAkademik24Jam["INTEGRASI KELAS & ASRAMA DALAM BUDAYA ILMU"]
        KelasPagi["KELAS FORMAL PAGI (07.00–13.00)<br/>Pendalaman teori, eksperimen sains, & kajian matan kitab kuning aktif."]
        
        AsramaSore["STUDY CLUB ASRAMA SORE (16.00–17.30)<br/>Tutor sebaya, bedah soal bersama Santri T4, & membaca mandiri di perpustakaan."]
        
        MalamRefleksi["HALAQAH REFLEKSI MALAM (20.00–21.30)<br/>Tadabbur makna ayat Al-Qur'an & pengamalan adab dalam kehidupan sehari-hari."]
        
        KelasPagi --- AsramaSore --- MalamRefleksi
    end
```
...
```mermaid
graph TD
    subgraph ProsedurManajemenKelas["SOP TATA KELOLA KELAS POSITIF PESANTREN"]
        P1["1. PROSEDUR AWAL KELAS (0–5 Menit)<br/>• Sapaan pintu masuk (Door Greeting).<br/>• Meja rapi; papan tulis bersih.<br/>• Doa pembuka & penegasan niat thalabul 'ilmi."]
        
        P2["2. PROSEDUR INTI PEMBELAJARAN (5–70 Menit)<br/>• Pola 15-2 (15 menit materi aktif, 2 menit diskusi berpasangan).<br/>• Tanda isyarat hening non-verbal (Angkat Tangan 5 Jari).<br/>• Pendampingan keliling guru (Proximity Control)."]
        
        P3["3. PROSEDUR PENUTUP KELAS (70–80 Menit)<br/>• Pengisian Exit Ticket (1 Hal Baru yang Dipahami & 1 Pertanyaan).<br/>• Perapian meja kursi kelas.<br/>• Doa kaffaratul majlis & salam takzim."]
...
```mermaid
flowchart TD
    Obs1["1. PERENCANAAN MODUL AJAR (RPP BERBASIS TA'DIB)<br/>Guru menyusun modul yang memuat integrasi nilai tauhid, metode aktif, & rubrik asesmen."]
    
    Obs2["2. OBSERVASI KLINIKAL RAMAH DI KELAS<br/>Kepala Madrasah / Master Teacher mengamati interaksi kelas dengan instrumen non-menghakimi."]
    
    Obs3["3. SESI REFLEKSI & COACHING GURU (POST-OBSERVATION)<br/>Mendiskusikan keberhasilan kelas, rasio apresiasi 4:1, & rencana peningkatan didaktik."]
