...
```mermaid
flowchart TD
    subgraph TransformasiAmanahKepemimpinan["TRANSFORMASI PARADIGMA AMANAH KEPEMIMPINAN"]
        PolaOtoriterLama["KEPEMIMPINAN OTORITER EKSPLOITATIF (LAMA)<br/>• Pemimpin minta dilayani; fasilitas mewah pribadi.<br/>• Musyrif dieksploitasi 24 jam nonstop tanpa libur.<br/>• Kelelahan mental (Burnout) melahirkan kekerasan."]
        
        PolaServantTUMBUH["SERVANT LEADERSHIP & TATA KELOLA AMANAH (TUMBUH)<br/>• Sayyidul Qawmi Khadimuhum: Pemimpin adalah pelayan.<br/>• Shift kerja sehat manusiawi & mitigasi burnout.<br/>• Kesejahteraan terjamin: Pengasuhan berlimpah kasih."]
        
        PolaOtoriterLama ==>|DIREKONSTRUKSI MENJADI| PolaServantTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturServantLeadershipTUMBUH["ARSITEKTUR SERVANT LEADERSHIP PESANTREN"]
        
        S1["1. KESADARAN AMANAH TRANSENDENTAL (Stewardship Accountability)<br/>Menghayati jabatan sebagai beban hisab akhirat; menjauhi privilese elitis."]
        
        S2["2. KULTUR KHIDMAH PELAYANAN (Empathetic Service Culture)<br/>Mendahulukan pertumbuhan, kesejahteraan, & keselamatan asatidz dan santri."]
        
        S3["3. PROTEKSI KESEHATAN & SISTEM SEHAT (Occupational Health & Wellness)<br/>Menjamin jam kerja manusiawi, shift asrama seimbang, & kompensasi adil."]
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranServantLeadership["EMPAT TINGKATAN KESADARAN KEPEMIMPINAN PELAYAN (MARATIB AL-IDRAK)"]
        
        S1_Level["TINGKAT 1: KESADARAN AMANAH JABATAN FORMAL (Al-Idrak al-Wilaiy al-Awwal)<br/>• Menyadari beban administratif tugas & mematuhi SOP kepemimpinan lembaga.<br/>• Menghindari penyalahgunaan wewenang karena takut sanksi hukum & audit."]
        
        S2_Level["TINGKAT 2: KESADARAN ADVOKASI & PERLINDUNGAN STAF (Al-Idrak ar-Ri'aiy)<br/>• Memperhatikan beban kerja asatidz & musyrif; memperjuangkan hak libur & fasilitas sehat.<br/>• Mampu mendengar keluh kesah bawahan & memberikan dukungan saat terjadi krisis."]
        
        S3_Level["TINGKAT 3: KESADARAN KHIDMAH TRANSPERSONAL (Al-Idrak al-Khadimiy an-Naqiy)<br/>• Menemukan kebahagiaan sejati dalam melayani orang lain (Growing Others).<br/>• Memimpin dari belakang (*Leading from Behind*); mengutamakan kemaslahatan santri di atas ego."]
        
        S4_Level["TINGKAT 4: KESADARAN KEPEMIMPINAN KHILAFAH PERADABAN (Al-Idrak al-Khalifiy al-Kamil)<br/>• Puncak kematangan: menyatukan Tauhid, Keadilan Syariat, & Khidmah Universal.<br/>• Menjadi Live Qudwah pelayan umat yang melahirkan ribuan kader pemimpin beradab."]
...
```mermaid
flowchart TD
    subgraph ProtokolJamKerjaMusyrif["STANDAR MANAJEMEN SHIFT & MITIGASI BURNOUT MUSYRIF"]
        Shift["1. SISTEM SHIFT DUA MUSYRIF: Setiap Blok Asrama Dikelola oleh Tim Musyrif Bergantian"]
        --> Libur["2. HAK LIBUR MINGGUAN (1 Day-Off per Week): Wajib Libur Keluar Asrama untuk Refreshing Jiwa"]
        --> JamTidur["3. JAMINAN TIDUR SIRKADIAN 7 JAM: Musyrif Memiliki Jadwal Tidur Terlindungi Tanpa Diganggu"]
        --> EvaluasiBK["4. SCREENING KESEHATAN MENTAL BULANAN: Asesmen Maslach Burnout Inventory oleh Konselor Lembaga"]
    end
```
