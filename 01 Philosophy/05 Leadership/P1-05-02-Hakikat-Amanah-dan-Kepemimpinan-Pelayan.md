...
```mermaid
graph TD
    subgraph PiramidaTerbalik["PIRAMIDA KEPEMIMPINAN PELAYAN (SERVANT LEADERSHIP)"]
        Santri["SANTRI & GENERASI UMAT (Fokus Utama Pelayanan)<br/>Mendapatkan perlindungan, kasih sayang, hak asrama sehat, & pengasuhan adab"]
        Musyrif["MUSYRIF & ASATIDZ (Garda Terdepan Khidmah)<br/>Mendampingi 24-jam dengan teladan, kelembutan tegas, & sistem shift sehat"]
        Pimpinan["PIMPINAN PESANTREN & MUDIR (Fondasi Pelayan Tertinggi)<br/>Menyediakan fasilitas, menjamin kesejahteraan staf, & menjaga keadilan SOP"]
