...
```mermaid
flowchart TD
    subgraph DinamikaKonflikPendidikTUMBUH["ARSITEKTUR RESOLUSI KONFLIK INTERNAL PENDIDIK"]
        Perbedaan["PERBEDAAN GAGASAN / PERSENGKETAAN ASATIDZ"]
        
        JalurSalah["JALUR SALAH (FAKSIONALISME TOKSIK):<br/>• Ghibah di belakang & mencari sekutu kubu.<br/>• Membawa masalah ke depan santri / wali santri.<br/>• Perpecahan lembaga & kehancuran marwah pondok."]
        
        JalurSyarie["JALUR TUMBUH (TABAYYUN & ISHLAH SYURA):<br/>• Tabayyun empat mata langsung (QS. 49:6).<br/>• Mediasi IBR terfokus pada kepentingan maslahat santri.<br/>• Majelis Masyayikh mendamaikan secara rahasia & adil."]
        
        Perbedaan -.-> JalurSalah
        Perbedaan ==> JalurSyarie
    end
```
...
```mermaid
graph TD
    A["Gugatan Fanatisme Opini (Pihak A):<br/>'Siapa pun guru yang beda metode dengan saya berarti sesat atau merusak pondok, harus disingkirkan!'"]
    --> B1["Tinjauan Kaidah Emas Imam Asy-Syafi'i:<br/>'Ra'yuna shawabun yahtamilul khatha', wa ra'yu ghairina khatha'un yahtamilush shawab' (Pendapat kita benar namun mengandung kemungkinan salah; pendapat orang lain salah namun mengandung kemungkinan benar)."]
    A --> B2["Tinjauan Al-Qur'an Surah Al-Hujurat: 10:<br/>'Innamal mu'minuna ikhwatun FA ASHLIHU BAINA AKHAWAYKUM' (Kewajiban mendamaikan dua saudara mukmin yang berselisih)."]
    A --> B3["Tinjauan Kitab Adab al-Ikhtilaf Thaha Jabir Al-Alwani:<br/>Membedakan ikhtilaf pemikiran (sah) dengan iftiraq perpecahan hati (haram)."]
    B1 & B2 & B3 --> C["Titik Temu Konsensus:<br/>Perbedaan disikapi dengan lapang dada ilmiah; persaudaraan ukhuwah wajib dijaga di atas segalanya."]
```
...
```mermaid
flowchart TD
    subgraph EmpatTahapProtokolTabayyun["4 TAHAP PROTOKOL TABAYYUN & MEDIASI ASATIDZ"]
        T1["1. TABAYYUN MANDIRI EMPAT MATA (24 JAM PERTAMA)<br/>Pihak yang berselisih bertemu privat tanpa melibatkan pihak lain, saling mendengar tanpa interupsi."]
        
        T2["2. KONSULTASI MEDIASI KEPALA UNIT / MUDIR<br/>Jika belum selesai, mediator netral memfasilitasi dialog IBR di ruangan tertutup."]
        
        T3["3. SIDANG ISHLAH MAJELIS MASYAIKH TERTINGGI<br/>Kasus strategis dibahas secara rahasia oleh dewan sesepuh untuk merumuskan mufakat syar'i."]
...
```mermaid
flowchart TD
    subgraph SOPMediasiIshlahAsatidz["SOP MEDIASI RESTORATIF ASATIDZ"]
        Laporan["1. PENERIMAAN LAPORAN SENGKETA / OBSERVASI KETEGANGAN<br/>Pimpinan atau konselor mendeteksi adanya perselisihan yang mengganggu kinerja."]
        
        PanggilanPrivat["2. PEMANGGILAN TERTUTUP KEDUA BELAH PIHAK<br/>Pertemuan di Ruang Mediasi Khusus yang tenang dan terjamin kerahasiaannya."]
        
        DialogRestoratif["3. DIALOG MEDIASI RESTORATIF 4 LANGKAH<br/>• Tiap pihak menyampaikan pandangan tanpa dipotong.<br/>• Identifikasi akar kepentingan bersama demi santri.<br/>• Penyusunan opsi kesepakatan damai (win-win)."]
        
        Penandatanganan["4. PENANDATANGANAN PAKTA ISHLAH & MONITORING<br/>Pimpinan memantau keharmonisan relasi kerja pasca-mediasi selama 30 hari."]
        
        Laporan --> PanggilanPrivat --> DialogRestoratif --> Penandatanganan
    end
```
