...
```mermaid
flowchart TD
    subgraph ArsitekturResolusiKonflikAsatidz["ARSITEKTUR RESOLUSI KONFLIK INTERNAL PENDIDIK"]
        PolaFaksionalLama["FAKSIONALISME RUANG GURU (LAMA)<br/>• Ghibah, saling sindir, & pembentukan kubu politik.<br/>• Konflik dibawa ke hadapan santri/wali santri.<br/>• Hilangnya keberkahan ilmu & perpecahan pondok."]
        
        PolaIshlahTUMBUH["ADAB IKHTILAF & PROTOKOL ISHLAH (TUMBUH)<br/>• Membedakan ragam gagasan (rahmat) vs perpecahan batin.<br/>• Protokol Tabayyun 4 Tahap Tertutup & Mediasi IBR.<br/>• Ukhuwah pulih: Live Qudwah persaudaraan hakiki."]
        
        PolaFaksionalLama ==>|DIREKONSTRUKSI MENJADI| PolaIshlahTUMBUH
    end
```
...
```mermaid
flowchart TD
    subgraph ArsitekturIshlahAsatidzTUMBUH["ARSITEKTUR MANAJEMEN ISHLAH ASATIDZ"]
        
        I1_Med["1. PENEGAKAN ADAB AL-IKHTILAF (Epistemic Tolerance)<br/>Menghormati keragaman ijtihad pedagogis; mengharamkan vonis sesat/bodoh."]
        
        I2_Med["2. SISTEM MEDIASI SYURA CEPAT & TERTUTUP (Confidential Fast-Track Syura)<br/>Penyelesaian sengketa dalam tempo maksimal 3x24 jam tanpa kebocoran publik."]
        
        I3_Med["3. PAKTA UKHUWAH & REINTEGRASI KALBU (Restorative Brotherhood Pact)<br/>Saling memaafkan, mushafahah, & bersama-sama memimpin shalat jamaah."]
        
        I1_Med <===> I2_Med <===> I3_Med
    end
```
...
```mermaid
flowchart TD
    subgraph TingkatanKesadaranResolusiKonflik["EMPAT TINGKATAN KESADARAN RESOLUSI KONFLIK (MARATIB AL-IDRAK)"]
        
        C1_Level["TINGKAT 1: KESADARAN PENGHINDARAN KONFLIK FORMAL (Al-Idrak al-Ijtinabiy)<br/>• Menahan diri dari pertengkaran fisik karena takut teguran pimpinan lembaga.<br/>• Konflik kerap dipendam dalam hati (perang dingin) tanpa penyelesaian tuntas."]
        
        C2_Level["TINGKAT 2: KESADARAN KOMUNIKASI TABAYYUN LOGIS (Al-Idrak at-Tabayyuniy)<br/>• Mampu berbicara empat mata & mengklarifikasi kesalahpahaman secara jujur.<br/>• Bersedia menggunakan forum mediasi syura untuk mencari titik temu profesional."]
        
        C3_Level["TINGKAT 3: KESADARAN ISHLAH & PEMBERIAN MAAF (Al-Idrak al-Mushlih al-Karim)<br/>• Mengutamakan persaudaraan ukhuwah di atas pembelaan gengsi ego pribadi.<br/>• Mudah memaafkan kekhilafan kawan; berinisiatif meminta maaf terlebih dahulu."]
        
        C4_Level["TINGKAT 4: KESADARAN INTEGRATOR UKHUWAH PARIPURNA (Al-Idrak al-Jami' al-Kamil)<br/>• Puncak kematangan: mampu menjadi juru damai (Mediator Ishlah) bagi seluruh pihak.<br/>• Menjadi Live Qudwah pemersatu umat; mengubah perbedaan menjadi kekuatan peradaban."]
        
        C1_Level ==> C2_Level ==> C3_Level ==> C4_Level
    end
```
...
```mermaid
flowchart TD
    subgraph ProtokolMajelisIshlah["PROTOKOL MEDIASI ISHLAH PENDIDIK"]
        Laporan["1. PENERIMAAN LAPORAN SENGKETA: Majelis Syura Menerima Keluhan Secara Rahasia (Confidential)"]
        --> DengarTerpisah["2. SESI MENDENGAR TERPISAH (Caucus): Mediator Mendengar Pandangan Masing-Masing Pihak"]
        --> TemuDamai["3. SESI MUSYAWARAH TERPADU: Kedua Pihak Dipertemukan dalam Suasana Ukhuwah & Fokus Solusi"]
        --> PiagamIshlah["4. PENANDATANGANAN PIAGAM ISHLAH: Mushafahah, Doa Bersama, & Menutup Masalah Selamanya"]
    end
```
