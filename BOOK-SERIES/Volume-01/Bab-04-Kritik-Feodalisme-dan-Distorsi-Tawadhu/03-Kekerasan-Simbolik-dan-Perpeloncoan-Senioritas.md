...
```mermaid
graph TD
    subgraph BentukSimbolik["ANATOMI EMPAT BENTUK KEKERASAN SIMBOLIK DI ASRAMA"]
        K1["1. MIKROAGRESI VERBAL (Verbal Degradation)<br/>Julukan merendahkan fisik, sindiran tajam, & ejekan aksen daerah."]
        
        K2["2. PERBUDAKAN DOMESTIK (Forced Domestic Labor)<br/>Memaksa junior mencuci baju kotor, memijat, & menyapu kamar senior."]
        
        K3["3. PEMALAKAN TERSAMBUNG (Resource Extortion)<br/>Meminta kiriman makanan/uang saku adik kelas dengan dalih 'khidmah'."]
        
        K4["4. PENGUCILAN SOSIAL (Social Ostracism / Cold Bullying)<br/>Mendiamkan korban berhari-hari & melarang santri lain berteman dengannya."]
    end
```
<div align="center"><sub><b>Gambar 4.3.1:</b> Empat Bentuk Kekerasan Simbolik dan Perundungan Non-Fisik di Asrama Pesantren.</sub></div>
...
```mermaid
graph TD
    RootProt["TIGA PROTOKOL PEMBERANTASAN KEKERASAN SIMBOLIK SISTEM TUMBUH"]
    
    RootProt --> P1["1. Larangan Mutlak Perbudakan Baju & Pijat<br/>Setiap santri wajib mencuci pakaian sendiri; senior dilarang keras menyuruh junior."]
    
    RootProt --> P2["2. Deklarasi Bahasa Kasih (No Body Shaming Policy)<br/>Pelarangan total panggilan nama hewan & celaan fisik; wajib memanggil dengan santun."]
    
    RootProt --> P3["3. Lingkaran Restoratif Asrama (Anti-Ostracism Circle)<br/>Musyrif memantau dinamika sosial kamar & segera memulihkan santri yang terisolasi."]
```
<div align="center"><sub><b>Gambar 4.3.2:</b> Tiga Protokol Pemberantasan Kekerasan Simbolik Ekosistem TUMBUH.</sub></div>
