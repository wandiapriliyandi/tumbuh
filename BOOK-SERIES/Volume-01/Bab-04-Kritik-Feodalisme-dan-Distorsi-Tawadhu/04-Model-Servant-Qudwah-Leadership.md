...
graph TD
    subgraph PiramidaKepemimpinan["TRANSFORMASI REVOLUSIONER MODEL KEPEMIMPINAN SANTRI"]
        Feodal["1. MODEL FEODAL USANG (Piramida Otoriter)<br/>• Pemimpin berada di puncak: Menuntut dilayani, menyuruh, & menghukum.<br/>• Santri junior di dasar: Tertekan, melayani senior, & ketakutan."]
        
        TUMBUH["2. MODEL SERVANT QUDWAH TUMBUH (Piramida Terbalik)<br/>• Pemimpin berada di dasar: Melayani, memfasilitasi, & melindungi adik kelas.<br/>• Santri junior di atas: Bertumbuh aman, didukung, & dimuliakan potensinya."]
    end
```
...
graph TD
    ...
    RootQudwah --> Q1["1. Keteladanan Tindakan (Uswah fi al-'Amal)<br/>Menjadi yang paling awal datang ke masjid, paling rapi menata sandal, & santun bertutur kata."]
    
    RootQudwah --> Q2["2. Mendengar dengan Empati (Active Empathic Listening)<br/>Mendengarkan keluh kesah adik kelas yang homesick tanpa menghakimi atau mengejek."]
    
    RootQudwah --> Q3["3. Melindungi yang Lemah (Ri'ayah adh-Dhu'afa')<br/>Berdiri di garda terdepan melindungi santri baru dari segala bentuk intimidasi."]
    
    RootQudwah --> Q4["4. Membimbing Tanpa Kekerasan (Guidance without Fear)<br/>Mengajarkan keterampilan adab dengan sabar, memperagakan langsung di depan adik kelas."]
    
    RootQudwah --> Q5["5. Kerendahan Hati Pelayan (Tawadhu' al-Khadim)<br/>Tidak merasa lebih mulia dari adik kelas; memandang amanah jabatan sebagai ladang amal."]
```
...
```mermaid
graph LR
    subgraph KaderisasiTUMBUH["TAHAPAN KADERISASI KEPEMIMPINAN SANTRI TUMBUH"]
        K1["Tahap 1: Memimpin Diri Sendiri (Self-Leadership)<br/>Disiplin ibadah & adab mandiri (Tangga T1-T3)"] --> K2["Tahap 2: Kakak Asuh Sekamar (Peer Buddy)<br/>Mendampingi 1 orang adik kelas baru selama 66 hari"]
        K2 --> K3["Tahap 3: Duta Restoratif Asrama (Peer Mediator)<br/>Membantu musyrif memediasi konflik kecil antar-kawan"]
        K3 --> K4["Tahap 4: Pengurus Organisasi Santri (Servant Leader)<br/>Memimpin tata kelola kegiatan santri (**Tahap 7 Penggerak**)"]
    end
```
<div align="center"><sub><b>Gambar 4.4.3:</b> Tahapan Kaderisasi Berjenjang Kepemimpinan Santri dalam Ekosistem TUMBUH.</sub></div>
