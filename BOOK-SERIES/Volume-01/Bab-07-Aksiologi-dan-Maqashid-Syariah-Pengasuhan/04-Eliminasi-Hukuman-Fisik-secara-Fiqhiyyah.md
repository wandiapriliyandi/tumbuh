...
graph TD
    subgraph SyaratFiqih["LIMA SYARAT KETAT 'DHARB AT-TA'DIB' MENURUT JUMHUR FUQAHA"]
        S1["1. HANYA KHUSUS UNTUK URUSAN SHALAT WAJIB (Bukan Urusan Sepele Sandal/Peci)"]
        S2["2. SUDAH MELALUI TAHAP NASIHAT SELAMA 3 TAHUN PENUH (Usia 7 s.d. 10 Tahun)"]
        S3["3. TIDAK BOLEH MEMUKUL WAJAH, KEPALA, ATAU BAGIAN VITAL TUBUH"]
        S4["4. DILARANG KERAS MENINGGALKAN BEKAS MEMAR, LUKA, ATAU PATAH TULANG (Ghayru Mubarrih)"]
        S5["5. DILARANG DILAKUKAN SAAT GURU SEDANG DIKUASAI AMARAH / EMOSI"]
        
        S1 --> S2 --> S3 --> S4 --> S5
    end
```
<div align="center"><sub><b>Gambar 7.4.1:</b> Lima Syarat Ketat 'Dharb at-Ta'dib' Menurut Jumhur Ulama Fiqih Turats.</sub></div>
