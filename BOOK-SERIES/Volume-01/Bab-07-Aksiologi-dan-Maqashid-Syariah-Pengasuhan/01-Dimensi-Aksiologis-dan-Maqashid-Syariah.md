...
```mermaid
graph TD
    subgraph AksiologiMaqashid["PIRAMIDA AKSIOLOGIS MAQASHID SYARI'AH PENGASUHAN PESANTREN"]
        Dharuriyyat["1. TINGKAT DHARURIYYAT (Kebutuhan Pokok Primer)<br/>Perlindungan mutlak atas 5 Hak Asasi Santri (Agama, Jiwa, Akal, Kehormatan, Harta)."]
        
        Hajiyyat["2. TINGKAT HAJIYYAT (Kebutuhan Kenyamanan & Kemudahan)<br/>Fasilitas asrama yang bersih, ventilasi udara sehat, nutrisi bergizi, & jadwal manusiawi."]
        
        Tahsiniyyat["3. TINGKAT TAHSINIYYAT (Penyempurna Keindahan & Kemuliaan Akhlak)<br/>Kehalusan tutur kata, adab makan berjamaah, kerapian busana, & tradisi saling memaafkan."]
        
        Dharuriyyat ==> Hajiyyat ==> Tahsiniyyat
    end
```
<div align="center"><sub><b>Gambar 7.1.1:</b> Tiga Tingkatan Piramida Aksiologis Maqashid Syari'ah dalam Pengasuhan Santri.</sub></div>
