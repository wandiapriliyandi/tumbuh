...
```mermaid
graph TD
    subgraph KeadilanRestoratif["TIGA RUKUN ISHLAH AL-BAIN RESTORATIF SISTEM TUMBUH"]
        R1["1. PENGAKUAN KHILAF & PENYESALAN (I'tiraf & Taubat)<br/>Pelaku secara jujur mengakui kesalahannya & memahami rasa sakit korban."]
        
        R2["2. RESTITUSI & GANTI RUGI NYATA (Dhaman al-Mashalih)<br/>Pelaku memperbaiki barang yang rusak / menggantinya secara adil."]
        
        R3["3. REKONSILIASI & SALING MEMAAFKAN (Tasamuh & Ishlah)<br/>Kedua pihak saling memaafkan, berpelukan, & dipulihkan ukhuwahnya tanpa stigma."]
        
        R1 ==> R2 ==> R3
    end
```
<div align="center"><sub><b>Gambar 7.3.1:</b> Tiga Rukun Ishlah al-Bain dan Keadilan Restoratif Ekosistem TUMBUH.</sub></div>
