...
```mermaid
graph TD
    subgraph TanggaTUMBUH["EMPAT TANGGA METAMORFOSIS ADAB SANTRI (T1 - T4)"]
        T1["TANGGA T1: TAHU & PAHAM ADAB (Cognitive Literacy)<br/>Santri memahami definisi, dalil syariat, & hikmah logis mengapa suatu adab diamalkan."]
        
        T2["TANGGA T2: MAU & TERGERAK BERADAB (Affective Willingness)<br/>Hati santri tergerak, memiliki niat ikhlas, & bersedia mencoba mempraktikkan adab."]
        
        T3["TANGGA T3: MAMPU BERADAB MANDIRI (Procedural Mastery)<br/>Adab menjadi gerak refleks otomatis di basal ganglia tanpa perlu disuruh atau diawasi."]
        
        T4["TANGGA T4: TELADAN & PENGGERAK ADAB (Transformative Leadership)<br/>Santri menjadi teladan (*Qudwah*) yang menginspirasi, melindungi, & mendidik adik kelasnya."]
        
        T1 ==> T2 ==> T3 ==> T4
    end
```
<div align="center"><sub><b>Gambar 6.1.1:</b> Empat Tangga Metamorfosis Pertumbuhan Karakter Santri (T1 s.d. T4) Ekosistem TUMBUH.</sub></div>
