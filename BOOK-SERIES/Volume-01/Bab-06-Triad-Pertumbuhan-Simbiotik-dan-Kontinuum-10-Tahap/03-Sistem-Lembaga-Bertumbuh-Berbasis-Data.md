...
```mermaid
graph TD
    subgraph SiklusDataTUMBUH["SIKLUS PENGAMBILAN KEPUTUSAN BERBASIS DATA PBIS"]
        D1["1. INPUT DATA FAKTUAL (Logbook Digital Musyrif)<br/>Pencatatan insiden perilaku & kestabilan emosi secara objektif real-time."]
        
        D2["2. ANALISIS POLA & TREN (PBIS Analytics Dashboard)<br/>Memetakan waktu rawan (Peak Hours) & lokasi titik panas (Hotspots)."]
        
        D3["3. TINDAKAN PREVENTIF TEPAT SASARAN (Data-Driven Decision)<br/>Menambah pengawasan di jam rawan & memberikan bimbingan konseling terarah."]
        
        D1 ==> D2 ==> D3 ==> D1
    end
```
<div align="center"><sub><b>Gambar 6.3.1:</b> Siklus Pengambilan Keputusan Pengasuhan Berbasis Data PBIS Ekosistem TUMBUH.</sub></div>
...
```mermaid
graph LR
    Musyrif["Musyrif Asrama<br/>(Input Data 16 Jam Asrama)"] --> Dashboard["DASHBOARD PBIS TERPADU<br/>(Analisis Real-Time & Rekomendasi Sistem)"]
    Walas["Wali Kelas Madrasah<br/>(Input Data 8 Jam Kelas)"] --> Dashboard
    Dashboard --> Pimpinan["Pimpinan Pesantren / Kiai<br/>(Keputusan Strategis & Evaluasi Lembaga)"]
```
