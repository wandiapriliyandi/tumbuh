...
graph TD
    subgraph Kontras["JURANG PEMISAH PENDIDIKAN KARAKTER KONVENSIONAL"]
        RuangKelas["SUASANA RUANG KELAS / MADRASAH (07.00 - 15.00)<br/>• Santri duduk rapi mendengarkan ceramah ustadz<br/>• Menghafal matan adab, dalil Al-Qur'an, dan hadits akhlak<br/>• Dinilai dari lembar ujian tulis dan hafalan lisan (Mumtaz)<br/>• Menampilkan kepatuhan pasif di depan guru"]
        
        Jurang["JURANG DISKONEKSI PRAKTIK<br/>(Ilmu hanya tersimpan sebagai hafalan kognitif di kepala,<br/>tidak pernah dilatihkan menjadi gerak refleks tindakan harian)"]
        
        RuangAsrama["SUASANA ASRAMA & KESEHARIAN (15.00 - 07.00)<br/>• Marak saling memakai barang tanpa izin (Ghashab)<br/>• Senioritas menindas junior & perebutan fasilitas kamar mandi<br/>• Lorong asrama kotor & pakaian berserakan<br/>• Kontrol diri lumpuh total tatkala guru tidak berada di dekatnya"]
...
```mermaid
graph TD
    subgraph DinamikaDuaPanggung["DINAMIKA DUA PANGGUNG KEHIDUPAN SANTRI"]
        PanggungDepan["PANGGUNG DEPAN (Front Stage)<br/>Lokasi: Ruang Kelas, Masjid, Ndalem Kiai<br/>• Santri berada di bawah tatapan langsung figur otoritas tinggi.<br/>• Menampilkan performa kesantunan buatan (menunduk, bicara halus).<br/>• Motif: Takut ditegur, menjaga citra diri, dan mengejar nilai raport."]
        
        PanggungBelakang["PANGGUNG BELAKANG (Back Stage)<br/>Lokasi: Kamar Asrama, Lorong Gelap, Antrean Mandi<br/>• Minim pendampingan figur dewasa yang hangat dan bijaksana.<br/>• Berlakunya 'Hukum Rimba': Siapa yang kuat dan senior yang berkuasa.<br/>• Topeng kesantunan dilepas: Muncul perilaku agresif, ghashab, dan ejekan."]
...
```mermaid
graph TD
    Root["LIMA LANGKAH OPERASIONAL REKONSTRUKSI ADAB TUMBUH"]
    
    Root --> L1["1. DESAIN PEMBELAJARAN BERBASIS STUDI KASUS ASRAMA<br/>Menghubungkan teks kitab adab dengan masalah riil kamar mandi, loker, dan kebersihan."]
    
    Root --> L2["2. PROTOKOL HABITUASI NEURO-BEHAVIORAL 66 HARI<br/>Latihan harian konsisten hingga terbentuk sirkuit otomatis di Basal Ganglia."]
    
    Root --> L3["3. RASIO APRESIASI POSITIF 4:1 OLEH MUSYRIF<br/>Memberikan 4 pengakuan kebaikan sebelum menjatuhkan 1 teguran terarah."]
    
    Root --> L4["4. PROTOKOL SERAH-TERIMA 15 MENIT (HANDOVER DUAL-PILLAR)<br/>Sinkronisasi data perilaku santri antara Wali Kelas dan Musyrif Asrama."]
