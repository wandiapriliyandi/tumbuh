...
```mermaid
graph TD
    subgraph DesainHalaqah["REKAYASA HALAQAH BRAIN-FRIENDLY SISTEM TUMBUH"]
        T1["1. INTERVAL FOKUS 25-30 MENIT (Pomodoro Rhythm)<br/>Penyampaian materi padat & interaktif, diselingi tanya jawab & gerak."]
        
        T2["2. MULTI-SENSORY ENCODING (Audio, Visual, & Kinestetik)<br/>Mendengar bacaan ustadz, melihat skema diagram, & memperagakan adab."]
        
        T3["3. METODE REPETISI BERJARAK (Spaced Retrieval / Tikrar Syar'i)<br/>Mengulang hafalan pada interval waktu bertahap untuk retensi seumur hidup."]
        
        T1 ==> T2 ==> T3 ==> HafalAbadi["HAFALAN & PEMAHAMAN KITAB MELEKAT ABADI DI MEMORI"]
    end
```
<div align="center"><sub><b>Gambar 3.5.1:</b> Tiga Pilar Desain Halaqah Pembelajaran Berbasis Cara Kerja Otak Ekosistem TUMBUH.</sub></div>
...
```mermaid
graph LR
    subgraph SiklusHalaqah["SIKLUS HALAQAH 4-TAHAP EKOSISTEM TUMBUH"]
        S1["1. APERSEPSI & KONEKSI (5 Menit)<br/>Membuka dengan studi kasus asrama & membangkitkan rasa ingin tahu."]
        S2["2. TRANSMISI INTI (20 Menit)<br/>Penjelasan fokus, ringkas, & didukung skema visual yang jelas."]
        S3["3. SIMULASI & PRAKTIK (15 Menit)<br/>Santri berpasangan saling menyimak & mendiskusikan penerapan adab."]
        S4["4. KONSOLIDASI & DOA (5 Menit)<br/>Menyimpulkan intisari hikmah & menautkan niat ikhlas lillahi ta'ala."]
        
        S1 --> S2 --> S3 --> S4
    end
```
<div align="center"><sub><b>Gambar 3.5.2:</b> Siklus Empat Tahap Desain Halaqah Interaktif Ekosistem TUMBUH.</sub></div>
