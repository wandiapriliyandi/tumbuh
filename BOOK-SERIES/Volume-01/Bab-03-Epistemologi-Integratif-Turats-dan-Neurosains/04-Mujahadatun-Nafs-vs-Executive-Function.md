...
```mermaid
graph TD
    subgraph SinergiKendali["INTEGRASI MUJAHADATUN NAFS & EXECUTIVE FUNCTION"]
        Dorongan["DORONGAN HAWA NAFSU PRIMITIF (Amigdala / Syahwat)<br/>Ingin marah, membalas dendam, ghashab barang kawan, atau malas mengaji."]
        
        RemMoral["REM MORAL & KENDALI DIRI (PFC / Mujahadatun Nafs)<br/>• Inhibitory Control: Menahan tangan & lisan dari kezaliman.<br/>• Working Memory: Mengingat konsekuensi akhirat & ridha Allah.<br/>• Cognitive Flexibility: Mencari solusi damai tanpa kekerasan."]
        
        Kemenangan["KEMENANGAN KARAKTER ADAB (Insan Kamil)<br/>Santri sabar, pemaaf, amanah, dan memiliki integritas baja."]
        
        Dorongan ==> RemMoral ==> Kemenangan
    end
```
<div align="center"><sub><b>Gambar 3.4.1:</b> Sinergi antara Mujahadatun Nafs Turats dan Kapasitas Executive Function Otak dalam Mengendalikan Impuls.</sub></div>
...
```mermaid
graph TD
    RootWill["MANAJEMEN ENERGI KEMAUAN (WILLPOWER) SISTEM TUMBUH"]
    
    RootWill --> W1["1. Penjadwalan Ritme Sirkadian Seimbang<br/>Menjamin santri tidur 7-8 jam per malam untuk mengisi ulang baterai PFC."]
    
    RootWill --> W2["2. Jeda Rileksasi & Qailulah Siang<br/>Sunnah tidur siang 20-30 menit sebelum dzuhur untuk menyegarkan fokus akal."]
    
    RootWill --> W3["3. Asupan Nutrisi Otak Halal & Thayyib<br/>Makanan bernutrisi seimbang untuk menjaga kestabilan glukosa darah otak."]
```
<div align="center"><sub><b>Gambar 3.4.2:</b> Tiga Pilar Manajemen Energi Kemauan (Willpower) Ekosistem TUMBUH.</sub></div>
