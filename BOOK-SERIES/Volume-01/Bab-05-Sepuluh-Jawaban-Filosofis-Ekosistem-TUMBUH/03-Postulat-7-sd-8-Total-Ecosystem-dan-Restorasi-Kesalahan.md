...
```mermaid
graph TD
    subgraph FondasiEkologisRestoratif["POSTULAT 7 & 8 EKOSISTEM TUMBUH"]
        P7["POSTULAT 7: HAKIKAT LINGKUNGAN ASRAMA (BI'AH SHALIHAH)<br/>Pesantren adalah ekosistem hidup 24 jam di mana setiap ruang, waktu, & interaksi dirancang sadar untuk menumbuhkan adab."]
        
        P8["POSTULAT 8: HAKIKAT KESALAHAN & PELANGGARAN ADAB<br/>Kesalahan diposisikan sebagai peluang pembelajaran moral (*Learning Opportunity*), bukan aib yang dibalas dendam."]
        
        P7 ==> P8
    end
```
<div align="center"><sub><b>Gambar 5.3.1:</b> Postulat 7 (Ekosistem Total) dan Postulat 8 (Restorasi Kesalahan) Sistem TUMBUH.</sub></div>
