...
```mermaid
graph TD
    MethodologyPrinciples["3 Asas Metodologi TUMBUH"]
    MethodologyPrinciples --> ActiveEngagement["1. Active Student Engagement & Inquiry<br/>Metode pembelajaran berfokus pada dialog interaktif, penalar reflektif (*Tafakkur*), & praktik nyata."]
    MethodologyPrinciples --> ScaffoldingGrowth["2. Scaffolding & Growth-Mindset<br/>Pendampingan bertahap dari pemula (T1) hingga mandiri (T4) dengan umpan balik apresiatif 4:1."]
    MethodologyPrinciples --> HumanizedPedagogy["3. Humanized & Compassionate Pedagogy<br/>Pendekatan pengajaran yang menghormati martabat emosional santri (*Tarahum & Qudwah*)."]
```
...
```mermaid
graph LR
    P1000["P10-00 Methods Induk"]
    P1000 --> S01["01 Learning Methods (Sorogan & Bandongan)"]
    P1000 --> S02["02 Mentoring Methods (Suhbah 1-on-1)"]
    P1000 --> S03["03 Coaching Methods (GROW Model)"]
    P1000 --> S04["04 Reflection Methods (Jurnal Refleksi)"]
    P1000 --> S05["05 Habit Formation (Habit Loop 66-Hari)"]
    P1000 --> S06["06 Experiential Learning (Khidmah & Rihlah)"]
    P1000 --> S07["07 Collaborative Learning (Muzakarah & Mayoran)"]
```
